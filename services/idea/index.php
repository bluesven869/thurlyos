...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/services/idea/index.php");
$APPLICATION->SetTitle(GetMessage("SERVICES_TITLE"));
?>
<?$APPLICATION->IncludeComponent("thurly:idea", ".default", array(
	"MESSAGE_COUNT" => "10",
	"COMMENTS_COUNT" => "10",
	...
	"PATH_TO_SMILE" => "/thurly/images/blog/smile/",
	"SET_TITLE" => "Y",
	"SET_NAV_CHAIN" => "Y",
	"BLOG_PROPERTY" => array(
	),
