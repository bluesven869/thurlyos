...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/services/board/my/index.php");
$APPLICATION->SetTitle(GetMessage("SERVICES_TITLE"));
?><?$APPLICATION->IncludeComponent("thurly:iblock.element.add", ".default", Array(
	"NAV_ON_PAGE"	=>	"10",
	"USE_CAPTCHA"	=>	"N",
