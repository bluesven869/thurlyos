...
$authorConfigAttributeValue = htmlspecialcharsbx(\Thurly\Main\Web\Json::encode(array(
...
$toConfigAttributeValue = htmlspecialcharsbx(\Thurly\Main\Web\Json::encode(array(
