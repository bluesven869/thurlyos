...
//		if(ob.Type == 'SequentialWorkflowActivity')
		...
		ob.Table.rows[0].cells[1].innerHTML = '<img src="/thurly/images/1.gif" width="0">';
		...
		begin.innerHTML = '<div style="background: url(/thurly/images/bizproc/beg_bg.gif);"><div style="background: url(/thurly/images/bizproc/beg_r.gif) right top no-repeat;"><div style="background: url(/thurly/images/bizproc/beg_l.gif) left top no-repeat; height: 23px;"><div style="padding-top: 3px; font-size: 12px; color:#194d0b;">'+BPMESS['SEQWF_BEG']+'</div></div></div></div>';
		...
		end.innerHTML = '<div style="background: url(/thurly/images/bizproc/beg_bg.gif);"><div  style="background: url(/thurly/images/bizproc/beg_r.gif) right top no-repeat;"><div style="background: url(/thurly/images/bizproc/beg_l.gif) left top no-repeat; height: 23px;"><div style="padding-top: 3px; font-size: 12px; color:#194d0b;">'+BPMESS['SEQWF_END']+'</div></div></div></div>';
	};
	...
	ob.DrawGroupItem = function (divGroupList, oActivity, bExt, ind)
	{
		...
		if(dCont.activityTemplate['Icon'])
			...
			t.rows[0].cells[0].style.background = 'url(/thurly/images/bizproc/act_icon.gif) 3px 3px no-repeat';
		...
		if(bExt)
		{
			...
			t.rows[0].cells[2].innerHTML = '<img src="/thurly/themes/.default/public/popup/pencil.gif" hspace="2">';
		...
		t.insertRow(-1);
		t.rows[1].insertCell(-1).innerHTML = '<table width="100%" style="border-collapse: collapse" cellpadding="0" cellspacing="0" border="0"><tr><td width="5"></td><td style="border-bottom: 1px #EBEBEB solid; height: 1px; font-size: 1px;"><img src="/thurly/images/1.gif" width="1" height="1"></td><td width="5"></td></tr></table>';
