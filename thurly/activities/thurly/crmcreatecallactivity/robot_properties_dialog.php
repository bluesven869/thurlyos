...
$startInterval = \Thurly\Crm\Automation\Helper::parseDateTimeInterval($dialog->getCurrentValue($map['StartTime']['FieldName']));
$day = $startInterval['d'];
...
<div class="crm-automation-popup-settings">
	<textarea
			name="<?=htmlspecialcharsbx($map['Description']['FieldName'])?>"
