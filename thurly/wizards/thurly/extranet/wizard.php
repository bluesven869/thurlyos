...
<?
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/classes/general/wizard_utils.php");
					...
					if(strpos($defaultTemplateId, "light") === 0)
					{
						...
						if ($defaultThemeId)
						{
							$siteLogo = $this->GetFileContentImgSrc($defaultSiteDocRoot.$defaultSiteFolder."include/company_name.php",
								"/thurly/wizards/thurly/portal/images/templates/light/themes/".$defaultThemeId."/images/".LANGUAGE_ID."/logo.jpg"
							);
						}
					}
					elseif ($defaultTemplateId == "thurlyos")
					{
...
*/
	...
	function OnPostForm()
	{
		...
		elseif ($wizard->GetVar("templateID") == "thurlyos")
		{
