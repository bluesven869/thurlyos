...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/about/life.php");
$APPLICATION->SetTitle(GetMessage("ABOUT_TITLE"));
?>

<?$APPLICATION->IncludeComponent("thurly:news", ".default", Array(
	"IBLOCK_TYPE"	=>	"news",
	"IBLOCK_ID"	=>	"#OUR_LIFE_IBLOCK_ID#",
	"NEWS_COUNT"	=>	"10",
	"USE_SEARCH"	=>	"N",
	"USE_RSS"	=>	"N",
	"USE_RATING"	=>	"N",
	...
	"FORUM_ID"	=>	"#NEWS_COMMENTS_FORUM_ID#",
	"URL_TEMPLATES_READ"	=>	"",
