...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/about/gallery/index.php");
$APPLICATION->SetTitle(GetMessage("ABOUT_TITLE"));
?>

<?$APPLICATION->IncludeComponent("thurly:photogallery", ".default", Array(
	"USE_LIGHT_VIEW"	=>	"Y",
	"IBLOCK_TYPE"	=>	"photos",
	"IBLOCK_ID"	=>	"#PHOTO_COMPANY_IBLOCK_ID#",
	"SEF_MODE"	=>	"Y",
	"SEF_FOLDER"	=>	"#SITE_DIR#about/gallery/",
