...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/workgroups/index.php");
$APPLICATION->SetTitle(GetMessage("WORKGROUPS_TITLE"));

?><?$APPLICATION->IncludeComponent("thurly:socialnetwork_group", ".default", Array(
	...
	"CALENDAR_GROUP_IBLOCK_ID"	=>	"#CALENDAR_IBLOCK_ID#",
