...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/services/help/outlook.php");
$APPLICATION->SetTitle(GetMessage("SERVICES_TITLE"));
?><script type="text/javascript" src="/thurly/templates/learning/js/imgshw.js"></script>
<?=GetMessage("SERVICES_INFO1", array("#SITE#" => "#SITE_DIR#"))?>
<?
if (CModule::IncludeModule("intranet") && CModule::IncludeModule("iblock"))
{
?>
<table style="margin-top:7px;">
	<tr><td><li><a href="javascript:<?echo htmlspecialcharsbx(CIntranetUtils::GetStsSyncURL(array('LINK_URL' => '#SITE_DIR#company/'), 'contacts'))?>"><?=GetMessage("SERVICES_LINK1")?></a></td></tr>
