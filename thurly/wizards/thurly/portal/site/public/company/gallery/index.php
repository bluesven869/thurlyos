...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/company/gallery/index.php");
$APPLICATION->SetTitle(GetMessage("COMPANY_TITLE"));
?>

<?$APPLICATION->IncludeComponent("thurly:photogallery_user", ".default", Array(
	"SECTION_PAGE_ELEMENTS"	=>	"100",
	"ELEMENTS_PAGE_ELEMENTS"	=>	"100",
	"PAGE_NAVIGATION_TEMPLATE"	=>	"",
	"ELEMENTS_USE_DESC_PAGE"	=>	"Y",
	"IBLOCK_TYPE"	=>	"photos",
	"IBLOCK_ID"	=>	"#USER_PHOTOGALLERY_IBLOCK_ID#",
	"GALLERY_GROUPS"	=>	array(
		0	=>	"#WIZARD_PORTAL_ADMINISTRATION_GROUP#",
		1	=>	"1"
	),
	"ONLY_ONE_GALLERY"	=>	"Y",
	"SECTION_SORT_BY"	=>	"ID",
	...
	"CACHE_TYPE"	=>	"A",
	"CACHE_TIME"	=>	"3600",
	"DATE_TIME_FORMAT_SECTION"	=>	"#DATE_TIME_FORMAT#",
	"DATE_TIME_FORMAT_DETAIL"	=>	"#DATE_TIME_FORMAT#",
	"DISPLAY_PANEL"	=>	"N",
	"SET_TITLE"	=>	"Y",
	"USE_RATING"	=>	"N",
	...
	"USE_COMMENTS"	=>	"Y",
	"COMMENTS_TYPE"	=>	"forum",
	"FORUM_ID"	=>	"#PHOTOGALLERY_COMMENTS#",
