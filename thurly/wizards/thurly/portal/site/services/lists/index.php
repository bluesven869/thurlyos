...
CLists::SetPermission('thurly_processes', array(1, WIZARD_PORTAL_ADMINISTRATION_GROUP));

COption::SetOptionString("lists", "livefeed_url", "/bizproc/processes/");
COption::SetOptionString("lists", "livefeed_iblock_type_id", "thurly_processes");

\Thurly\Lists\Importer::installProcesses(LANGUAGE_ID);
