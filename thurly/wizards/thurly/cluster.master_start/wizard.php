...
class CBaseWizardStep extends CWizardStep
{
	...
	function ShowStep()
	{
		...
		$this->content .= "<style>
			li.cluwiz_erli { list-style-image:url(/thurly/themes/.default/images/lamp/red.gif) }
			li.cluwiz_okli { list-style-image:url(/thurly/themes/.default/images/lamp/green.gif) }
...
class Step4 extends CBaseWizardStep
{
	...
	function OnPostForm()
	{
		...
		$this->OpenSite();
		$this->location = '/thurly/admin/cluster_slave_list.php?lang='.LANGUAGE_ID.'&group_id='.$group_id;
	}
}
