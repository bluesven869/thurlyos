...
<body>
<? if (\Thurly\Main\Loader::includeModule('mail')) : ?>
<?=\Thurly\Mail\Message::getQuoteStartMarker(true); ?>
<? endif; ?>
<?
$protocol = \Thurly\Main\Config\Option::get("main", "mail_link_protocol", 'https', $arParams["SITE_ID"]);
...
<table cellpadding="0" cellspacing="0" border="0" align="center" bgcolor="#337e96" style="border-collapse: collapse;mso-table-lspace: 0pt;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;background-color: #337e96;border: none;height: 100%;width: 100%;">
	<tr>
		...
		<td align="left" valign="middle" style="border-collapse: collapse;border-spacing: 0;padding:0;background: url('<?=$serverName?>/thurly/templates/mail_user/images/top-cloud.png') no-repeat center 36px;">
			<div style="padding: 41px 0 24px;max-width: 732px;margin: 0 auto;"><?
				$str24 = '<span style="color: #c2d1d6;">Group</span>';
	
				$companyName = (
					IsModuleInstalled('thurlyos')
						? COption::getOptionString('thurlyos', 'site_title', '')
				...
				$companyName .= (
					IsModuleInstalled('thurlyos')
						? (COption::GetOptionString("thurlyos", "logo24show", "Y") == "Y" ? $str24 : '')
						: $str24
				);
