...
<tr>
	...
	<td align="center" valign="middle" style="border-collapse: collapse;border-spacing: 0;padding: 44px 0 50px;vertical-align: middle;max-width: 693px;"><?
		if (\Thurly\Main\Loader::includeModule('intranet'))
		{
			...
			&nbsp;
			<img height="19" width="101" src="/thurly/templates/mail_user/images/<?=GetMessage('MAIL_USER_THURLY24_IMAGEFILE')?>" alt="<?=GetMessage('MAIL_USER_THURLY24_IMAGEFILE_ALT')?>" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;border: none;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 17px;color: #71a5b6;font-weight: bold;vertical-align: middle;"><?
			?></a><?
		}
		?>
	</td>
...
<?=\Thurly\Mail\Message::getQuoteEndMarker(true); ?>
<? endif; ?>
</body>
</html>
<!-- ***************** END FOOTER  ********************-->