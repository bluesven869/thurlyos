...
{
	$userColor = Thurly\Im\Color::getColorByNumber($arUser['ID']);
		...
		menu: [
			{
				...
				image: "/thurly/templates/mobile_app/images/lenta/menu/blog.png",
				action: function () {
			...
			<?if (IsModuleInstalled("thurlyos") && $USER->CanDoOperation('thurlyos_invite') && $arResult["User"]["ACTIVITY_STATUS"] == "invited") :?>
			{
