...
$APPLICATION->AddHeadString('<script type="text/javascript" src="'
	...
	.'"></script>', true, \Thurly\Main\Page\AssetLocation::AFTER_JS_KERNEL);
...
<?
	...
	if (empty($task['DOCUMENT_ICON']))
	{
		...
		$task['DOCUMENT_ICON'] = '/thurly/templates/mobile_app/images/bizproc/document/bp-'.$moduleIcon.'-icon.png';
	}
	?>
			...
			items: [
				{
					...
					<?=$arResult['currentUserStatus']==0?"image: '/thurly/templates/mobile_app/images/bizproc/check.png',":''?>
					action: function()
					{
						app.loadPageBlank({
				...
				},
				{
					...
					<?=$arResult['currentUserStatus']==1?"image: '/thurly/templates/mobile_app/images/bizproc/check.png',":''?>
					action: function()
					{
						app.loadPageBlank({
				...
				},
				{
					...
					<?=$arResult['currentUserStatus']==2?"image: '/thurly/templates/mobile_app/images/bizproc/check.png',":''?>
					action: function()
					{
						app.loadPageBlank({
