...
class CForumPageTemplate
{
	function GetDescription()
	{
		return array(
			...
			"icon"=>"/thurly/themes/.default/start_menu/forum/forum.gif",
			"modules"=>array("forum"),
			"type"=>"section",
		);
	}
...
';		
		...
		$arThemes = array();
		$dir = $_SERVER["DOCUMENT_ROOT"].BX_ROOT."/components/thurly/forum/templates/.default/themes/";
...
?><?$APPLICATION->IncludeComponent("thurly:forum", ".default", array(
