...
if ($arParams['bAdmin']):
	...
	$INTRANET_TOOLBAR->AddButton(array(
		'ONCLICK' => $APPLICATION->GetPopupLink(array(
			'URL' => "/thurly/admin/iblock_element_edit.php?type=".$arParams['IBLOCK_TYPE']."&lang=".LANGUAGE_ID."&IBLOCK_ID=". $arParams['IBLOCK_ID']."&bxpublic=Y&from_module=iblock",
			'PARAMS' => array(
				'height' => 500,
				'width' => 700,
				'resize' => false
	...
	$INTRANET_TOOLBAR->AddButton(array(
		'HREF' => "/thurly/admin/iblock_element_admin.php?type=".$arParams['IBLOCK_TYPE']."&lang=".LANGUAGE_ID."&IBLOCK_ID=".$arParams['IBLOCK_ID'],
