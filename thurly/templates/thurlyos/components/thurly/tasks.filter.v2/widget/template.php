...
<div class="sidebar-widget sidebar-widget-tasks">
	<div class="sidebar-widget-top">
		...
		<?
		$path = \Thurly\Tasks\Integration\Socialnetwork\UI\Task::getActionPath();
		$url = \Thurly\Tasks\UI\Task::makeActionUrl($path);
		?>

		<a class="plus-icon" href="<?=htmlspecialcharsbx($url) ?>"></a>
	</div>
