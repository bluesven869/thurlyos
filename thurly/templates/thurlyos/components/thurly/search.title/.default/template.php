...
$className =
	!isModuleInstalled("timeman") || (CModule::IncludeModule("thurlyos") && SITE_ID == "ex") ? " timeman-simple" : "";
?>
...
new B24.SearchTitle({
	...
	'USER_URL':  '<?=CUtil::JSEscape(\Thurly\Main\Config\Option::get('socialnetwork', 'user_page', SITE_DIR.'company/personal/', SITE_ID).'user/#user_id#/')?>',
	'GROUP_URL':  '<?=CUtil::JSEscape(\Thurly\Main\Config\Option::get('socialnetwork', 'workgroups_page', SITE_DIR.'workgroups/', SITE_ID).'group/#group_id#/')?>',
