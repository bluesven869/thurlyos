...
$oldItemsSort = CUserOptions::GetOption("thurlyos", "user_menu_items_".SITE_ID);
$oldItemsAdded = CUserOptions::GetOption("thurlyos", "user_added_favorite_items_".SITE_ID);

$defaultItemsId = array_keys($newItems);
$convertMapItems = $arResult["MAP_ITEMS"];

$oldLinksMapping = array();
if (!IsModuleInstalled("thurlyos") && COption::GetOptionString("intranet", "intranet_public_converted", "") == "Y")
{
	$oldLinksMapping = array(
...
{
	$oldItemsAdmin = COption::GetOptionString("thurlyos", "admin_menu_items", "");
