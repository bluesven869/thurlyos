...
{
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/main.user.link/templates/.default/style.css');
		...
		<tr>
			<td colspan="2" width="100%" class="gd-contacts-main"><?
				...
				if (strlen($arUser["PERSONAL_PHOTO"]) <= 0)
				{
					...
					$arImage = CSocNetTools::InitImage($arUser["PERSONAL_PHOTO"], 30, "/thurly/images/socialnetwork/nopic_30x30.gif", 30, $link, true);
					$arUser["PERSONAL_PHOTO"] = $arImage["IMG"];
				}	
				...
				?><script type="text/javascript">
					BX.tooltip(<?=$arUser["ID"]?>, "anchor_<?=$tooltip_id?>");
				</script><?			
			?>
			</td>
		</tr>
...
$APPLICATION->SetAdditionalCSS('/thurly/gadgets/thurly/extranet_contacts/styles.css');
