...
$arComponentProps = CComponentUtil::GetComponentProps("thurly:webdav.list", $arCurrentValues);
...
if($diskEnabled)
{
	...
	$query = \Thurly\Disk\Storage::getList(array("filter"=>array("=ENTITY_TYPE" => Thurly\Disk\ProxyType\Common::className())));
