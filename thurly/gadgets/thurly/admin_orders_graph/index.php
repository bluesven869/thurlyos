...
$imgUrl = "/thurly/admin/sale_stat_graph.php?";
					...
					<tr>
						<td valign="top">
							...
							<tbody>
								...
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=08738C" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L_ALL")?></td>
								</tr>
								<?endif;?>
								<?if($arFields["find_payed"] == "Y"):?>
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=C6B59C" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L_PAYED")?></td>
								</tr>
								<?endif;?>
								<?if($arFields["find_allow_delivery"] == "Y"):?>
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=0000FF" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L_AD")?></td>
								</tr>
								<?endif;?>
								<?if($arFields["find_canceled"] == "Y"):?>
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=FF0000" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L_CANCELED")?></td>
								</tr>
								<?endif;?>
							</tbody>
							</table>
					...
					<tr>
						<td valign="top">
							...
							<tbody>
								...
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=08738C" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L2_ALL")?></td>
								</tr>
								<?endif;?>
								<?if($arFields["find_payed"] == "Y"):?>
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=C6B59C" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L2_PAYED")?></td>
								</tr>
								<?endif;?>
								<?if($arFields["find_allow_delivery"] == "Y"):?>
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=0000FF" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L2_AD")?></td>
								</tr>
								<?endif;?>
								<?if($arFields["find_canceled"] == "Y"):?>
								<tr>
									<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=FF0000" width="45" height="2" style="margin-bottom: 4px;"></td>
									<td nowrap=""><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("GD_ORDERS_L2_CANCELED")?></td>
								</tr>
								<?endif;?>
							</tbody>
							</table>
