...
$APPLICATION->SetAdditionalCSS('/thurly/gadgets/thurly/admin_marketpalce/styles.css');
?>
...
<div class="bx-gadgets-content-layout-perform">
	...
	<div class="bx-gadget-bottom-cont">
		<a class="bx-gadget-button" target="_blank" href="http://marketplace.1c-thurly.ru/">
