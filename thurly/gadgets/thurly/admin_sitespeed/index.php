...
$APPLICATION->SetAdditionalCSS("/thurly/gadgets/thurly/admin_sitespeed/site_speed.css");
?>
...
<div class="bx-gadgets-speed-top" id="speed-top-block">
	<div class="bx-gadgets-title bx-gadgets-title-speed">
		...
		<a href="/thurly/admin/site_speed.php?lang=<?=LANGUAGE_ID?>" class="bx-gadget-text-color" id="site-speed-index-text"></a>
	</div>
...
<script type="text/javascript">
	BX.ready(function() {
		...
		BX.ajax({
			method: "POST",
			dataType: "json",
			url: document.location.protocol + "//www.1c-thurly.ru/buy_tmp/ba.php",
			data : {
