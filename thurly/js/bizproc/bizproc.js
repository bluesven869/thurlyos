...
BizProcActivity = function()
{
	...
	{
		(new BX.CDialog({
			'content_url': "/thurly/admin/"+MODULE_ID+"_bizproc_activity_settings.php?mode=public&bxpublic=Y&lang="+BX.message('LANGUAGE_ID')+"&entity="+ENTITY,
	...
	ob.Draw = function (divC)
	{
		...
		else
		{
			...
			if(ob.Icon)
				...
				act.style.background = 'url(/thurly/images/bizproc/act_icon.gif) left center no-repeat';
		...
		d3.style.background = 'url(/thurly/images/bizproc/act_b.gif)';
		d3.style.height = '4px';
		d3.style.overflowY = 'hidden';
		var d33 = d3.appendChild(document.createElement('DIV'));
		d33.style.background = 'url(/thurly/images/bizproc/act_br.gif) right top no-repeat';
		var d333 = d33.appendChild(document.createElement('DIV'));
		d333.style.background = 'url(/thurly/images/bizproc/act_bl.gif) left top no-repeat';
...
UnknownBizProcActivity = function()
{
	...
	ob.Draw = function (divC)
	{
		...
		var d3 = ob.div.appendChild(document.createElement('DIV'));
		d3.style.background = 'url(/thurly/images/bizproc/act_bt.gif)';
...
BX.Bizproc.cloneTypeControlHtml = function(tableID, wrapperId)
{
	...
	BX.ajax({
		method: 'GET',
		dataType: 'html',
		url: '/thurly/tools/bizproc_get_html_editor.php?site_id='
