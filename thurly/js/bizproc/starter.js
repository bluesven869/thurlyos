;(function()
{
	...
	var Starter = function(config)
	{
		...
		this.ajaxUrl = config.ajaxUrl || '/thurly/components/thurly/bizproc.workflow.start/ajax.php';
	...
	Starter.prototype =
	{
		...
		loadParametersHtml: function(params, callback)
		{
			...
			BX.ajax({
				method: 'POST',
				dataType: 'html',
				url: '/thurly/components/thurly/bizproc.workflow.start/popup.php',
				data: params,
	...
	ParametersFormDecorator.prototype =
	{
		...
		getAjaxUrl: function()
		{
			return this.config.ajaxUrl || '/thurly/components/thurly/bizproc.workflow.start/ajax.php';
		}
	};
