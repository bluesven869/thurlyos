...
Create: function()
{
	...
	//		return BX.loadScript('/thurly/js/intranet/outlook.js', _this.outlookRun);
	//	_this.outlookRun();
	//}, true, 'bxec-outlook');
...
AddItem: function(tbl, name, title, action, bHide, icon)
{
	...
	BX.adjust(cell, {
		...
		html: '<div class="bxec-cm-item"><img class="' + (icon || '') + '" src="/thurly/images/1.gif">' + name + '</div>'
	});
...
AddUsers : function(arUsers, bRequest, bFirst)
{
	...
	for(i = 0; i < l; i++)
	{
		...
		c.appendChild(BX.create('IMG', {props:{src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-g-status ' + cn, title: EC_MESS['GuestStatus_' + status]}}));
		...
		delBut = c.appendChild(BX.create('IMG', {props:{src: '/thurly/images/1.gif', className: 'bxec-iconkit ' + (bDel ? 'bxec-g-del-but' : 'bxec-g-del-but-d'), title: bDel ? EC_MESS.DelGuestTitle : EC_MESS.CantDelGuestTitle, id: 'bxec_del_' + user.id}}));
...
CreatePopup: function()
{
	...
	for (i = 0; i < l; i++)
	{
		...
		if (arMR[i].URL)
			pRow.appendChild(BX.create('A', {props: {href: arMR[i].URL, className: 'bxecplloc-view', target: '_blank', title: EC_MESS.OpenMRPage}, html: '<img src="/thurly/images/1.gif" />'}));
	}
},
...
Build : function()
{
	...
	PrevMonthButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-pr-m-but', title: EC_MESS.ShowPrevMonth}, events: {click: function(){_this.IncreaseCurMonth(-1);}}}));

	NextMonthButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-nx-m-but', title: EC_MESS.ShowNextMonth}, events: {click: function(){_this.IncreaseCurMonth(1);}}}));
...
CreateMonthWin : function()
{
	...
	PrevYearButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-prev-year', title: EC_MESS.ShowPrevYear}}));
	PrevYearButtCell.onclick = function(){_this.MonthWinIncreaseYear(-1);};

	NextYearButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-next-year', title: EC_MESS.ShowNextYear}}));
