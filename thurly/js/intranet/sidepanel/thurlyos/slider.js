...
BX.Intranet.ThurlyOS.Slider = function(url, options)
{
...
BX.Intranet.ThurlyOS.Slider.prototype =
{
	__proto__: BX.SidePanel.Slider.prototype,
	constructor: BX.Intranet.ThurlyOS.Slider,
	...
	{
		var themePicker = BX.getClass("BX.Intranet.ThurlyOS.ThemePicker.Singleton");
		if (!themePicker)
		{
			return;
		}
...
BX.SidePanel.Manager.registerSliderClass("BX.Intranet.ThurlyOS.Slider");
 ...
 * @memberOf BX.ThurlyOS
 * @memberOf top.BX.ThurlyOS
 * @name BX.ThurlyOS#Slider
 * @type BX.SidePanel.Manager
 * @static
 * @readonly
 */
Object.defineProperty(BX.ThurlyOS, "Slider", {
	get: function() {
 ...
 * @memberOf BX.ThurlyOS
 * @memberOf top.BX.ThurlyOS
 * @name BX.ThurlyOS#PageSlider
 * @type BX.SidePanel.Manager
 * @static
 * @readonly
 */
Object.defineProperty(BX.ThurlyOS, "PageSlider", {
	get: function() {
		return BX.SidePanel.Instance;
	}
});
