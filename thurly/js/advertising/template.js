...
BXBannerTemplate.prototype =
{
    ...
    createColorpicker: function (propObj, value, name, tNew, index)
    {
        ...
        var script = BX.create(
            'script',{
                text: "BX.loadScript(\'/thurly/components/thurly/main.colorpicker/templates/.default/script.js\',  function(){window.oBXBannerTemplate.createCPObject(\'"+ind+'_'+name+"\', \'"+color+"\')});"
            }
        );
        return [input, script];
    },
