...
JCEC.prototype.ShowAddEventDialog = function(bShowCalendars)
{
	...
	var b24Limits = BX(this.id + '-thurlyos-limit');
		...
		D = new BX.PopupWindow("BXCAddEvent" + this.id, null, {
			...
			buttons: b24Limits ?
				...
				new BX.PopupWindowButton({
					...
					{
						var
							format = BX.date.convertThurlyFormat(D.CAL.selectTime ? BX.message("FORMAT_DATETIME") : BX.message("FORMAT_DATE")),
