...
BX.SocNetLogDestination.init = function(arParams)
{
	...
	BX.SocNetLogDestination.obPathToAjax[arParams.name] = (!arParams.pathToAjax ? '/thurly/components/thurly/main.post.form/post.ajax.php' : arParams.pathToAjax);
	...
	return BX.create('DIV', {
		...
		children: [
			BX.create('IMG', {
				...
				attrs: {
					src: '/thurly/js/main/core/images/waiter-white.gif'
				}
			}),
			BX.create('DIV', {
				props: {
...
BX.SocNetLogDestination.loadAll = function(params)
{
	...
	{
		BX.ajax({
			url: '/thurly/components/thurly/main.post.form/post.ajax.php',
			method: 'POST',
			dataType: 'json',
			data: {
				'LD_ALL' : 'Y',
