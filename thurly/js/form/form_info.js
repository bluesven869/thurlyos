				...
				switch (func.name)
				{
					case 'ShowInput':
						...
						if (element_index !== false)
						{
							...
							var funcstr = '<img id="' + pMainObj.SetBxTag(false, {tag: "form_question", params: {name:'element_index', value:element_index, additional_params:params}}) + '" src="/thurly/images/form/visual/form_edit_' + __q_obj.type + '.gif"  border="0" />';
							return funcstr;
						}
						else
						{
					...
					default:
						...
						{
							var funcstr = '<img id="' + pMainObj.SetBxTag(false, {tag: "form_api", params: {name: 'METHOD', value: func.name, '1': {name:'INDEX', value:_index}}}) + '" src="/thurly/images/form/visual/form_api_edit_' + func.name.toLowerCase() + '.gif" border="0" />';
						}
						else
						{
							var funcstr = '<img id="' + pMainObj.SetBxTag(false, {tag: "form_api", params: {name: 'METHOD', value: func.name, '1': {name:'INDEX', value:_index}}}) + '" src="/thurly/images/form/visual/form_api_' + func.name.toLowerCase() + '.gif" border="0" />';
						}
						return funcstr;
				}
			}
