...
function __run()
{
	...
	StyleSelectorList.prototype.OpenSubmenu = function (item)
	{
		...
		if (item.id == 'list')
			BX.loadCSS(['/thurly/css/main/font-awesome.css']);
...
*/
	...
	LinkDialog.prototype.GetValues = function()
	{
		...
		else if (type == 'external')
		{
			...
			{
				value.href = '/thurly/redirect.php?event1=' + escape(this.pStatEvent1.value) + '&event2=' + escape(this.pStatEvent2.value) + '&event3=' + escape(this.pStatEvent3.value) + '&goto=' + escape(value.href);
			}
		}
		else if (type == 'anchor')
		{
