...
BXMediaLib.prototype =
{
	...
	BuildCollection: function(oCol, ind)
	{
		...
		if (pCont)
		{
			var
				...
				img = titleDiv.appendChild(BX.create("IMG", {props:{src: '/thurly/images/1.gif', className: 'ml-col-icon'}})),
			...
			if (bDel)
			{
				var del = titleDiv.appendChild(BX.create("IMG", {props: {src: '/thurly/images/1.gif', className: 'ml-col-del', title: ML_MESS.DelCollection}}));
			...
			if (bEdit)
			{
				var edit = titleDiv.appendChild(BX.create("IMG", {props: {src: '/thurly/images/1.gif', className: 'ml-col-edit', title: ML_MESS.EditCollection}}));
	...
	{
		return '/thurly/admin/fileman_medialib.php?sessid=' + this.sessid + '&lang=' + this.oConfig.lang + (action ? '&action=' + action : '');
	},
