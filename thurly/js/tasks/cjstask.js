...
BX.CJSTask = {
	ajaxUrl    : '/thurly/components/thurly/tasks.iframe.popup/ajax.php?SITE_ID=' + BX.message('SITE_ID'),
	sequenceId : 0,
	timers     : {}
};
...
BX.CJSTask.addTimeToDateTime = function(datetime, defaultTime, params)
{
	...
	if(datetime.length > 0)
	{
		...
		datetime = BX.date.format(BX.date.convertThurlyFormat(BX.message('FORMAT_DATETIME')), date);
	}
