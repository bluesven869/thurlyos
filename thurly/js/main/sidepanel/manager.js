...
BX.SidePanel.Manager = function(options)
{
	...
	BX.addCustomEvent("BX.ThurlyOS.PageSlider:close", this.close.bind(this)); //Compatibility
	BX.addCustomEvent("ThurlyOS.Slider:postMessage", this.handlePostMessageCompatible.bind(this)); // Compatibility
};
...
BX.SidePanel.Manager.prototype =
{
	...
	postMessage: function(source, eventId, data)
	{
		...
		sliderWindow.BX.onCustomEvent("ThurlyOS.Slider:onMessage", [slider, data]); //Compatibility
