...
{	
	...
	this.pathToAjax = typeof(pathToAjax) == "string"? pathToAjax: '/thurly/components/thurly/rating.vote/vote.ajax.php';
...
Rating.Vote = function(voteId, button, action)
{
	BX.ajax({
		...
		method: 'POST',
		dataType: 'json',
		data: {'RATING_VOTE' : 'Y', 'RATING_RESULT' : 'Y', 'RATING_VOTE_TYPE_ID' : BXRS[voteId].entityTypeId, 'RATING_VOTE_ENTITY_ID' : BXRS[voteId].entityId, 'RATING_VOTE_ACTION' : action, 'sessid': BX.thurly_sessid()},
...
Rating.List = function(voteId, page, action)
{
	...
	BX.ajax({
		...
		method: 'POST',
		dataType: 'json',
		data: {'RATING_VOTE_LIST' : 'Y', 'RATING_VOTE_LIST_TYPE' : action, 'RATING_VOTE_TYPE_ID' : BXRS[voteId].entityTypeId, 'RATING_VOTE_ENTITY_ID' : BXRS[voteId].entityId, 'RATING_VOTE_LIST_PAGE' : page, 'PATH_TO_USER_PROFILE' : BXRS[voteId].pathToUserProfile, 'sessid': BX.thurly_sessid()},
		onsuccess: function(data)
		{
