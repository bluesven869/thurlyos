...
BX["UI"]["FileInput"] = function(id, uploadParams, elementParams, values, template)
{
	...
	this.uploadParams["urlUpload"] = '/thurly/tools/upload.php?lang=' + BX.message("LANGUAGE_ID");
	this.uploadParams["urlCloud"] = '/thurly/admin/clouds_file_search.php?lang=' + BX.message("LANGUAGE_ID") + '&n=';
...
*/		if (values.length > 0)
	...
	clickCloudPointPath : '/thurly/admin/clouds_file_search.php?lang=' + BX.message("LANGUAGE_ID") + '&n=undefined',
		...
		var iTemplate = [
			...
			'<div class="adm-photoeditor-preview-panel-container adm-photoeditor-preview-panel-container-wait" id="#id#EditorItem"> \
				<div class="adm-photoeditor-preview-panel-container-sub"> \
					<img src="', '/thurly/images/1.gif', '" class="adm-photoeditor-preview-panel-container-space" /> \
