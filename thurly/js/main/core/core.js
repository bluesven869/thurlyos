...
BX.thurly_sessid = function() {return BX.message("thurly_sessid"); };
...
BX.submit = function(obForm, action_name, action_value, onAfterSubmit)
{
	...
	if (obForm.sessid)
		obForm.sessid.value = BX.thurly_sessid();
...
BX.showWait = function(node, msg)
{
	...
	var obMsg = node.bxmsg = document.body.appendChild(BX.create('DIV', {
		...
		style: {
			background: 'url("/thurly/js/main/core/images/wait.gif") no-repeat scroll 10px center #fcf7d1',
	...
	if (type == "icon")
	{
		element = BX.create('IMG', {
			props: {
				src: params.iconSrc
					? params.iconSrc
					: "/thurly/js/main/core/images/hint.gif"
			}
		});
	}
	else if (type == "link")
