...
BX.CAutoSave.prototype.Save = function()
{
	if (this.FORM && BX.isNodeInDom(this.FORM))
	{
		...
		BX.ajax.post(
			'/thurly/tools/autosave.php?bxsender=core_autosave&sessid=' + BX.thurly_sessid(), data, BX.proxy(this._Save, this)
		);
	}
	else
	{
...
BX.CAutoSave.prototype.Reset = function()
{
	...
	{
		BX.ajax.post(
			'/thurly/tools/autosave.php?bxsender=core_autosave&action=reset&sessid=' + BX.thurly_sessid(), {autosave_id: this.FORM_ID }, null
		);
	}
};
