...
{
	return this.addToLinkParam(link, 'sessid', BX.thurly_sessid());
}
...
BX.CViewBlankElement.prototype.saveFile = function(parameters)
{
	...
	else
	{
		...
		uriToDoc = this.addToLinkParam(uriToDoc, 'sessid', BX.thurly_sessid());
	}
...
BX.CViewBlankElement.prototype.renameFile = function(params)
{
	...
	else
	{
		...
		uri = this.addToLinkParam(uri, 'sessid', BX.thurly_sessid());
	}
    	...
    	this.errorDescription = (BX.create('div', {
		    ...
		    children: [
			    ...
			    BX.create('a', {
				    ...
				    events: {
					    click: BX.delegate(function(e){
						    document.location.href = (BX.browser.IsMac()? "http://dl.thurlyos.com/b24/thurlyos_desktop.dmg": "http://dl.thurlyos.com/b24/thurlyos_desktop.exe");
						    return false;
					    }, this)
				    },
...
//params.selfViewer
		...
		children: [
			BX.create('span', {
				...
				children: [
					BX.create('img', {
						props: {
							src: '/thurly/js/main/core/images/yell-waiter.gif'
						}
					})
				]
			}),
	...
	BX.ajax.loadJSON(link, {sessid: BX.thurly_sessid()}, function(response){
			...
			children: [
				BX.create('span', {
					...
					children: [
						BX.create('img', {
							props: {
								src: '/thurly/js/main/core/images/viewer-tick.png'
							}
						})
					]
				}),
...
var CViewerUrlHelper = {
	lastService: null,
	ajaxDocUrl: '/thurly/tools/disk/document.php',
	ajaxUfDocUrl: '/thurly/tools/disk/uf.php',
