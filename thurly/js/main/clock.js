...
//	this.config.AmPmMode = false;
	...
	this.bCreated = false;
	this.DATE_FORMAT = BX.date.convertThurlyFormat(BX.message("FORMAT_DATE"));
}
...
JCClock.prototype = {
	Create: function(cont)
	{
		...
		this.arrowsContDiv.appendChild(BX.create('IMG', {props:{src: '/thurly/images/1.gif', className: 'bxc-min-arr-cont bxc-iconkit-a'}}));
		this.arrowsContDiv.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxc-hour-arr-cont bxc-iconkit-a'}}));
	...
	CreateControls: function()
	{
		...
		if (!this.bInline)
		{
			...
			// Close button
			var closeImg = BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxc-close bxc-iconkit-c', title: this.MESS.Close}});
	...
	CreateSelect: function(arValues, step, title)
	{
		...
		c = r.insertCell(-1);
		c.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxc-slide-up bxc-iconkit-c'}}));
		c.title = this.MESS.Up;
		c.className = 'bxc-pointer';
		c.onmousedown = function(){spinStart(step)};
		c = tbl.insertRow(-1).insertCell(-1);
		c.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxc-slide-down bxc-iconkit-c'}}));
