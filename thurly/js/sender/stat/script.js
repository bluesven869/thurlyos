;(function (window)
{
	...
	* */
	...
	BX.Sender.Statistics.prototype = {
		filters: [],
		blocks: [],
		filterUrl: '/thurly/admin/sender_statistics.php',
		...
		filter: function ()
		{
			...
			queryData.sessid = BX.thurly_sessid();
			BX.ajax({
				url: this.filterUrl,
				method: 'POST',
				data: queryData,
	...
	var postingsStats = function (params)
	{
		this.load = function (params)
		{
			...
			this.instance.filterUrl = '/thurly/admin/sender_mailing_stat.php';
		...
		this.getFilters = function (params)
		{
			...
			popupItems.push({
				...
				onclick: BX.proxy(function() {
					var url = '/thurly/admin/sender_mailing_chain_admin.php';
	...
	BX.Sender.StatisticsBlockClickMap = extendItem({
		...
		reloadFrame: function ()
		{
			...
			source += '&sessid=' + BX.thurly_sessid();
			source += '&r=' + 1*(new Date());
