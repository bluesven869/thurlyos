...
BX.Sale.Admin.OrderBuyer =
{
	...
	{
		window.open(
			'/thurly/admin/user_search.php?lang='+languageId+'&FN='+BX.Sale.Admin.OrderEditPage.formId+'&FC=USER_ID',
			'',
...
//		demanded.push("PROPERTIES");
	...
	updateBuyerProfileLink: function(buyerId)
	{
		if(BX.Sale.Admin.OrderBuyer.isFeatureSaleAccountsEnabled)
			BX("BUYER_USER_NAME").href = "/thurly/admin/sale_buyers_profile.php?lang="+BX.Sale.Admin.OrderEditPage.languageId+"&USER_ID="+buyerId;
		else
			BX("BUYER_USER_NAME").href = "/thurly/admin/user_edit.php?lang="+BX.Sale.Admin.OrderEditPage.languageId+"&ID="+buyerId;
	},
