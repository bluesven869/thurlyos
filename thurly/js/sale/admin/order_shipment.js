				...
				BX.bind(BX("saveCheckBtn"), 'click', BX.delegate(
					function()
					{
						...
						BX.ajax(
						{
							method: 'post',
							dataType: 'json',
							url: '/thurly/admin/sale_order_ajax.php',
							data: subRequest,
...
BX.Sale.Admin.GeneralShipment =
{
	...
	createNewShipment : function()
	{
		...
		window.location = '/thurly/admin/sale_order_shipment_edit.php?lang='+BX.Sale.Admin.OrderEditPage.languageId+'&order_id='+orderId+'&backurl='+encodeURIComponent(window.location.pathname+window.location.search);
	},
