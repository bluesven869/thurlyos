...
BX.Sale.Admin.DiscountPreset.SelectProduct = (function(){
	...
	SelectProduct.prototype.onClickSectionToShowPopup = function(event) {
		...
		var url = '/thurly/admin/cat_section_search.php?land=ru&discount=Y&n=sect_' + sectionNumber;
	...
	SelectProduct.prototype.getParamsByProductId = function(product, iblockId) {
		BX.ajax({
			url: '/thurly/admin/sale_discount_preset_detail.php?' +
	...
	SelectProduct.prototype.onClickAddProduct = function(event) {
		...
		var popup = new BX.CDialog({
			content_url: '/thurly/tools/sale/product_search_dialog.php?' +
			'lang=' + BX.message.LANGUAGE_ID +
			'&LID=' + this.siteId +
			'&caller=preset_edit' +
	...
	SelectProduct.prototype.onClickAddSection = function(event) {
		...
		var url = '/thurly/admin/cat_section_search.php?land=ru&discount=Y&n=sect_stub';
