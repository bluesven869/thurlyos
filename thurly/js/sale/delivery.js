...
;(function(window) {
	...
	BX.Sale.Delivery = {
		...
		ajaxUrl: "/thurly/admin/sale_delivery_ajax.php",
		...
		showGroupsDialog: function(nextUrl, currentGroup)
		{
			var storeForm = new BX.CDialog({
				...
				'content_post': 'currentGroup='+currentGroup+"&action=get_group_dialog_content&selectedGroupId="+currentGroup+"&sessid="+BX.thurly_sessid(),
				'width': 350,
				'height':300,
				'resizable':false,
				'draggable':false
		...
		{
			if(rstrParams.class == '\\Thurly\\Sale\\Delivery\\Restrictions\\ByLocation')
				var width = 1030;
			else
				width = 600;
