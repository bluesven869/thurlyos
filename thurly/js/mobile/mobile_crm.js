...
BX.Mobile.Crm.List = {
	...
	showContextMenu : function(customItems)
	{
		...
		items.push({
			...
			image: "/thurly/js/mobile/images/settings.png",
		...
		items.push({
			...
			image: "/thurly/js/mobile/images/fields.png",
			action: BX.proxy(function()
			{
		...
		items.push({
			...
			image: "/thurly/js/mobile/images/sort.png",
			action: BX.proxy(function()
			{
	...
	EntityEditor.prototype.generateEntityHtml = function(data)
	{
		...
		else if (data.entityType)
		{
			...
			if (data.entityType == "contact")
				imagePath = "/thurly/js/mobile/images/icon-contact.png";
			else if (data.entityType == "company")
				imagePath = "/thurly/js/mobile/images/icon-company.png";
			else if (data.entityType == "lead")
				imagePath = "/thurly/js/mobile/images/icon-lead.png";
			else if (data.entityType == "quote")
				imagePath = "/thurly/js/mobile/images/icon-quote.png";
			else if (data.entityType == "deal")
				imagePath = "/thurly/js/mobile/images/icon-deal.png";
						...
						activeNode = BX.create("div", {
							...
							children: [
								BX.create("img", {attrs:{
									...
									src: "/thurly/js/mobile/images/" + "phone2x.png",
									srcset: "/thurly/js/mobile/images/" + "phone2x.png" + " 2x"
								}}),
								BX.create("span", {attrs:{className: "mobile-grid-field-contact"}, html: multiFields[i].value})
							],
							events: {
								...
								BX.create("a", {
									...
									children: [
										BX.create("img", {attrs:{
											...
											src: "/thurly/js/mobile/images/" + "email2x.png",
											srcset: "/thurly/js/mobile/images/" + "email2x.png" + " 2x"
										}}),
										BX.create("span", {
