...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
	<form method="post" target="_top" action="<?echo $page.(($s=DeleteParam(array("logout", "login"))) == ""? "?login=yes":"?$s&login=yes");?>">
		...
		<tr valign="middle">
			<td align="center" colspan="2"><input type="text" name="USER_LOGIN" maxlength="50" size="15" value="<?echo htmlspecialcharsbx(${COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_LOGIN"})?>"  class="inputtext"></td>
		</tr>
		<tr>
