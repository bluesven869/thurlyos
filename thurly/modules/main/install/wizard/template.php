...
class WizardTemplate extends CWizardTemplate
{
	function GetLayout()
	{
		...
		else
		{
			...
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/install/".LANGUAGE_ID."/logo.png"))
				$logoImage = '<img src="/thurly/images/install/'.LANGUAGE_ID.'/logo.png" alt="" />';
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/install/".LANGUAGE_ID."/logo.gif"))
				$logoImage = '<img src="/thurly/images/install/'.LANGUAGE_ID.'/logo.gif" alt="" />';
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/install/en/logo.gif"))
				$logoImage = '<img src="/thurly/images/install/en/logo.gif" alt="" />';
		}
		...
		else
		{
			...
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/install/".LANGUAGE_ID."/box-new.jpg"))
				$boxImage = '<img src="/thurly/images/install/'.LANGUAGE_ID.'/box-new.jpg" alt="" />';
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/install/".LANGUAGE_ID."/box.jpg"))
				$boxImage = '<img src="/thurly/images/install/'.LANGUAGE_ID.'/box.jpg" alt="" />';
			elseif (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/install/en/box.jpg"))
				$boxImage = '<img src="/thurly/images/install/en/box.jpg" alt="" />';
		}
		...
		$jsCode = "";
		$jsCode = file_get_contents($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/install/wizard/script.js");
...
<html>
	<head>
		...
		<link rel="stylesheet" href="/thurly/images/install/installer_style.css">
...
<body id="thurly_install_template">
