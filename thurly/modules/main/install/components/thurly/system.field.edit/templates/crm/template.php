...
<script type="text/javascript">
	BX.ready(function() {
		BX['<?=$jsObject?>'] = new BX.CrmEntitySelector({
			...
			listPrefix: <?=\Thurly\Main\Web\Json::encode($listPrefix)?>,
			listElement: <?=\Thurly\Main\Web\Json::encode($arResult['ELEMENT'])?>,
			listEntityType: <?=\Thurly\Main\Web\Json::encode($arResult['ENTITY_TYPE'])?>,
			listEntityCreateUrl: <?=\Thurly\Main\Web\Json::encode($arResult['LIST_ENTITY_CREATE_URL'])?>,
