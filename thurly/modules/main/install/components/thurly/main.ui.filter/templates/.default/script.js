;(function() {
	 ...
	 * @param {object} types Field types from Thurly\Main\UI\Filter\Type
	 * @param types.STRING
	 * @param types.SELECT
	 * @param types.DATE
	 ...
	 * @param types.CUSTOM
	 * @param types.ENTITY
	 * @param {object} dateTypes Date field types from Thurly\Main\UI\Filter\DateType
	 ...
	 * @param {object} numberTypes Number field types from Thurly\Main\UI\Filter\NumberType
	 */
