	...
	var repo = {},
		...
		diskController = (function(){
			...
			d.prototype = {
				...
				urlUpload : '/thurly/tools/disk/uf.php?action=uploadFile&ncc=1',
				uploadBase64 : function(fileObj) {
					...
					options.params = { sessid: BX.thurly_sessid() };
				...
				uploadBase64Response : function(fileObj, response) {
					...
					else
					{
						...
						BX.onCustomEvent(fileObj, 'onUploadOk', ['[DISK FILE ID=' + id + ']', {
							...
							iconUrl: "/thurly/components/thurly/mobile.disk.file.detail/images/" + iconUrl + ".png",
							previewImageUrl : '',
							id : id,
							fileId : id,
							xmlID : "0",
