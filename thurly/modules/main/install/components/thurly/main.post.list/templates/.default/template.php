...
\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/components/thurly/main.post.list/templates/.default/scripts_for_form.js");
if (CModule::IncludeModule("im"))
	\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/components/thurly/main.post.list/templates/.default/scripts_for_im.js");
if (!empty($arParams["RATING_TYPE_ID"]))
{
	//http://hg.office.thurly.ru/repos/modules/rev/6377a7cfcd73
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/rating.vote/templates/like/popup.css");
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/rating.vote/templates/like/style.css");
	\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/js/main/rating_like.js");
}
...
if ($arParams["SHOW_POST_FORM"] == "Y")
{
	...
	?>
		<div id="record-<?=$arParams["ENTITY_XML_ID"]?>-0-placeholder" class="blog-comment-edit feed-com-add-block blog-post-edit" style="display:none;"><?
			?><div class="feed-com-avatar feed-com-avatar-<?=($AUTHOR_AVATAR == '/thurly/images/1.gif' ? "N" : "Y")?>"><?
