 ...
 */
\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/components/thurly/main.post.list/templates/.default/script.js");
\Thurly\Main\Page\Asset::getInstance()->addJs($templateFolder."/script.js");
if (!empty($arParams["RATING_TYPE_ID"]))
{
	\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/components/thurly/rating.vote/templates/mobile_comment_like/script_attached.js");
}
...
<?
if (
		\Thurly\MobileApp\Mobile::getApiVersion() >= 10
...
if (\Thurly\MobileApp\Mobile::getApiVersion() >= 10)
{
	?><div class="post-comment-reply"><?
...
<script>
	BX.ready(function(){
		...
		if (!window["FCList"])
			scripts.push('<?=\CUtil::GetAdditionalFileURL("/thurly/components/thurly/main.post.list/templates/.default/script.js", true)?>');
		if (!BX["MPL"])
