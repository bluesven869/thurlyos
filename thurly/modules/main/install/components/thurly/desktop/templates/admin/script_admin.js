function __ShowDesktopSettingsDialog(e)
{
	if(!e)
		...
		(new BX.CAdminDialog({
			...
			'content_url': '/thurly/components/thurly/desktop/admin_settings.php?lang='+language_id+'&bxpublic=Y', 
...
function __ShowDesktopAllSettingsDialog(e)
{
	if(!e)
		...
		(new BX.CDialog({
			...
			'content_url': '/thurly/components/thurly/desktop/admin_settings_all.php?lang='+language_id+'&bxpublic=Y', 
