...
class PageNavigationComponent extends CThurlyComponent
{
	...
	{
		if (!is_object($this->arParams["~NAV_OBJECT"]) || !($this->arParams["~NAV_OBJECT"] instanceof \Thurly\Main\UI\PageNavigation))
		{
			return;
		}
		/** @var \Thurly\Main\UI\PageNavigation $nav */
		...
		$this->arResult["REVERSED_PAGES"] = ($nav instanceof \Thurly\Main\UI\ReversePageNavigation);
	...
	protected function makeUrl()
	{
		...
		{
			$uri = new \Thurly\Main\Web\Uri($this->arParams["~BASE_LINK"]);
		}
		else
		{
