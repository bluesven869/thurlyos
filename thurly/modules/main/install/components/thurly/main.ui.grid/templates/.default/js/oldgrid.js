...
function BxUniversalGrid(table_id)
{
	...
	this.Sort = function(url, by, sort_state, def_order, args)
	{
		...
		BX.ajax.get('/thurly/components'+_this.vars.component_path+'/settings.ajax.php?GRID_ID='+_this.table_id+'&action=savesort&by='+by+'&order='+order+'&sessid='+_this.vars.sessid, function(){
			_this.Reload(url);
		});
	};
	...
	this.SaveColumns = function(columns, callback)
	{
		...
		{
			BX.ajax.get(
				'/thurly/components'+_this.vars.component_path+'/settings.ajax.php',
				{
	...
	this.SetView = function(view_id)
	{
		...
		BX.ajax.get('/thurly/components'+_this.vars.component_path+'/settings.ajax.php?GRID_ID='+_this.table_id+'&action=setview&view_id='+view_id+'&sessid='+_this.vars.sessid, func);
	};
	...
	this.DeleteView = function(view_id)
	{
		...
		BX.ajax.get('/thurly/components'+this.vars.component_path+'/settings.ajax.php?GRID_ID='+this.table_id+'&action=delview&view_id='+view_id+'&sessid='+_this.vars.sessid);
	};
	...
	this.SaveSettings = function(view_id, doReload)
	{
		...
		BX.ajax.post('/thurly/components'+_this.vars.component_path+'/settings.ajax.php', data, handler);
	...
	this.SaveFilterRows = function()
	{
		...
		BX.ajax.get('/thurly/components'+this.vars.component_path+'/settings.ajax.php?GRID_ID='+this.table_id+'&action=filterrows&rows='+sRows+'&sessid='+this.vars.sessid);
	};
	...
	this.SwitchFilter = function(a)
	{
		...
		BX.ajax.get('/thurly/components'+this.vars.component_path+'/settings.ajax.php?GRID_ID='+this.table_id+'&action=filterswitch&show='+(on? 'N':'Y')+'&sessid='+this.vars.sessid);
	};
	...
	this.DeleteFilter = function(filter_id)
	{
		...
		BX.ajax.get('/thurly/components'+this.vars.component_path+'/settings.ajax.php?GRID_ID='+this.table_id+'&action=delfilter&filter_id='+filter_id+'&sessid='+_this.vars.sessid);
	};
	...
	this.SaveFilter = function(filter_id)
	{
		...
		BX.ajax.post('/thurly/components'+_this.vars.component_path+'/settings.ajax.php', data);
