...
use Thurly\Main\UserConsent\Internals\FieldTable;
...
class MainUserConsentEditComponent extends CThurlyComponent
{
	...
	protected function prepareResult()
	{
		...
		if($this->request->isPost() && check_thurly_sessid() && $this->arParams['CAN_EDIT'])
		{
			$this->processPost();
		}
	...
	protected function prepareResultDataProviders()
	{
		...
		$dataProviders = \Thurly\Main\UserConsent\DataProvider::getList();
