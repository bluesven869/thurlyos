...
if(!BXHotKeys)
{
	...
	function CBXHotKeys()
	{
		...
		this.DelAll = function()
		{
			...
			var options_url = '/thurly/admin/hot_keys_act.php?hkaction=delete_all';
			var sParam = "&sessid="+phpVars.thurly_sessid;
		...
		{
			var request = new JCHttpRequest;
			var options_url = '/thurly/admin/hot_keys_act.php?hkaction=set_default';
			var sParam = "&sessid="+phpVars.thurly_sessid;
		...
		{
			var request = new JCHttpRequest;
			var options_url = '/thurly/admin/hot_keys_act.php?hkaction=add';
			var sParam = "&KEYS_STRING="+encodeURIComponent(keysString)+"&CODE_ID="+code_id+"&USER_ID="+_this.uid+"&sessid="+phpVars.thurly_sessid;
		...
		{
			window.open("/thurly/admin/hot_keys_act.php?hkaction=export&sessid="+phpVars.thurly_sessid);
		};
		...
		{
			var formText = 	'<form action="/thurly/admin/hot_keys_act.php?hkaction=import" method="post" enctype="multipart/form-data" target="upload_iframe" id="hk_import_form" name="hk_import_form">'+
							'<input type="hidden" name="sessid" value="'+BX.thurly_sessid()+'">'+
		...
		{
			var request = new JCHttpRequest;
			var options_url = '/thurly/admin/hot_keys_act.php?hkaction=update';
			var sParam = "&KEYS_STRING="+encodeURIComponent(keysString)+"&ID="+hk_id+"&sessid="+phpVars.thurly_sessid;
			request.Post(options_url, sParam);
		};
		...
		this.DeleteBase = function(code_id, hk_id)
		{
			...
			{
				var request = new JCHttpRequest;
				var options_url = '/thurly/admin/hot_keys_act.php?hkaction=delete';
				var sParam = "&ID="+hk_id+"&sessid="+phpVars.thurly_sessid;
				request.Post(options_url, sParam);
