...
BX.CTooltip = function(user_id, anchor, loader, rootClassName, bForceUseLoader, params)
{
	...
	this.ShowTooltip = function()
	{
		...
		_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/thurly/components/thurly/main.user.link/templates/.default/images/cloud-left-top.png', sizingMethod = 'crop' );";
		...
		if (h_mirror && v_mirror)
		{
			...
			_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/thurly/components/thurly/main.user.link/templates/.default/images/cloud-right-bottom.png', sizingMethod = 'crop' );";
		}
		else
		{
			if (h_mirror)
			{
				...
				_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/thurly/components/thurly/main.user.link/templates/.default/images/cloud-right-top.png', sizingMethod = 'crop' );";
			}
			...
			if (v_mirror)
			{
				...
				_this.filterFixed = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/thurly/components/thurly/main.user.link/templates/.default/images/cloud-left-bottom.png', sizingMethod = 'crop' );";
			}
		}
