(function (window)
{
	...
	var compositeMessageIds = ["thurly_sessid", "USER_ID", "SERVER_TIME", "USER_TZ_OFFSET", "USER_TZ_AUTO"];
	var compositeDataFile = "/thurly/tools/composite_data.php";
