...
BXDialogTree.prototype =
{
	...
	{
		this.arIconList = {
			folder : '/thurly/images/main/file_dialog/icons/folder.gif',
			folderopen : '/thurly/images/main/file_dialog/icons/folderopen.gif',
			plus : '/thurly/images/main/file_dialog/icons/plus.gif',
			minus : '/thurly/images/main/file_dialog/icons/minus.gif',
			dot : '/thurly/images/main/file_dialog/icons/dot.gif'
		};
		this.arDirConts = {};
	},
...
BXDialogWindow.prototype =
{
	Init: function()
	{
		...
		this.iconsPath = '/thurly/images/main/file_dialog/icons/types/';
		this.arIcons =
		{
	...
	DisplayElList_detail: function(arElements)
	{
		...
		fill_innerHTML();
		var arr_img = "<img src='/thurly/images/main/file_dialog/arrow_" + (oBXDialogWindow.sort_order == 'asc' ? 'up' : 'down') + ".gif'>";
	...
	OnContextMenu: function(e)
	{
		...
		if (oEl.permission.del || oEl.permission.ren)
		{
			...
			if (oEl.permission.ren)
			{
				arItems.push({
					id : 'rename',
					src : '/thurly/images/main/file_dialog/rename.gif',
			...
			if (oEl.permission.del)
			{
				...
				arItems.push({
					id : 'delete',
					src : '/thurly/images/main/file_dialog/delete.gif',
...
BXDialogTabs.prototype =
{
	...
	DisplayTabs: function()
	{
		...
		{
			var _style = "background-image: url(/thurly/images/main/file_dialog/tabs/tab_icons.gif);";
			oCell.innerHTML = '<img class=" '+className+'" src="/thurly/images/1.gif" height="27px" width="'+width+'px" style="'+_style+'"/>';
		};
