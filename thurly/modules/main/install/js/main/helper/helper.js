...
BX.Helper =
{
	...
	init : function(params)
	{
		...
		{
			if(!!event.origin && event.origin.indexOf('thurly') === -1)
			{
				return;
			}
			...
			{
				if (typeof BX.ThurlyOS.LeftMenuClass === "object")
				{
					if (typeof BX.ThurlyOS.LeftMenuClass.getStructureForHelper === "function")
					{
						var structure = BX.ThurlyOS.LeftMenuClass.getStructureForHelper();
	...
	showAnimatedHero : function() //with finger
	{
		if (!BX.browser.IsIE8())
		{
			BX.load(["/thurly/js/main/helper/runtime.js", "/thurly/js/main/helper/hero_object.js"], function() {
