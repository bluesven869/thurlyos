/***********************************************************
Thurly AJAX library ver 6.5 alpha 
***********************************************************/
...
CAjax.prototype._SetHandler = function(TID)
{
	...
	function __handlerReadyStateChange()
	{
		...
		{
			var status = oAjax.arThreads[TID].httpRequest.getResponseHeader('X-Thurly-Ajax-Status');
...
var jsAjaxUtil = {
	...
	{
		if (
			/\/thurly\/js\/main\/ajax.js$/i.test(script_src)
			||
			/\/thurly\/js\/main\/core\/core.js$/i.test(script_src)
		) return;
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		jsEvent.addEvent(window, 'load', function () 
		{
			...
			if (current_hash.substring(0, 5) == 'view/')
			{
				...
				var url = '/thurly/tools/ajax_redirector.php?hash=' + current_hash; //jsAjaxHistory.urlencode(current_hash);
