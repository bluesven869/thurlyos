...
$APPLICATION->AddHeadString(
	'<link type="text/css" rel="stylesheet" href="/thurly/themes/.default/check-list-style.css">');?>
<style type="text/css">
	.checklist-button-left-corn {background:url('/thurly/js/main/core/images/controls-sprite.png') no-repeat left -328px;}
	.checklist-button-cont{background:url('/thurly/js/main/core/images/controls-sprite.png') repeat-x left -356px;}
	.checklist-button-right-corn {background:url('/thurly/js/main/core/images/controls-sprite.png') no-repeat -6px -328px;}
	.project-checked {background:url("/thurly/themes/.default/images/checklist/checklist-sprite.png") no-repeat 0 -123px; height:11px;top:4px; font-size:1px; left:3px;float:left;width:14px;position:relative;margin-right:10px;}
