...
class SiteSpeed
{
	...
	public static function isRussianSiteManager()
	{
		return
			...
			(
				Directory::isDirectoryExists(Application::getDocumentRoot()."/thurly/modules/main/lang/ru") ||
				Directory::isDirectoryExists(Application::getDocumentRoot()."/thurly/modules/main/lang/ua")
			)
		;
	}
