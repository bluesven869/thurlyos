...
final class Manager
{
	...
	private static function initHandlers()
	{
		...
		$buildInHandlers = array(
			'\Thurly\Main\Service\GeoIp\MaxMind' => 'lib/service/geoip/maxmind.php',
			'\Thurly\Main\Service\GeoIp\Extension' => 'lib/service/geoip/extension.php',
			'\Thurly\Main\Service\GeoIp\SypexGeo' => 'lib/service/geoip/sypexgeo.php'
		);
	...
	private static function isHandlerClassValid($className)
	{
		...
		if(!is_subclass_of($className, '\Thurly\Main\Service\GeoIp\Base'))
			return false;
