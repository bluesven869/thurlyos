 ...
 * @package Thurly\Main\Text
 */
class DateConverterResult
{
	/**
	 * @var \Thurly\Main\Type\DateTime|null
	 */
	private $date = null;
	 ...
	 * @param \Thurly\Main\Type\DateTime $date
	 * @param string $text
	 * @param $type
	 * @param array $metrics
	 * @param array $metricModifier
	 */
	function __construct(\Thurly\Main\Type\DateTime $date, $matchParams, $type = self::TYPE_UNKNOWN, $metrics = Array(), $metricModifier = Array())
	{
		$this->date = $date;
		$this->type = $type;
