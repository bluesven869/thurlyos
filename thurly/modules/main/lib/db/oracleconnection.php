...
class OracleConnection extends Connection
{
	 ...
	 *
	 * @return void
	 * @throws \Thurly\Main\DB\ConnectionException
	 */
	 ...
	 */
	protected function queryInternal($sql, array $binds = null, \Thurly\Main\Diag\SqlTrackerQuery $trackerQuery = null)
	{
	 ...
	 * @return Result
	 */
	protected function createResult($result, \Thurly\Main\Diag\SqlTrackerQuery $trackerQuery = null)
	{
	...
	public function getNextId($name = "")
	{
		...
		if($name == '')
			throw new \Thurly\Main\ArgumentNullException("name");
	 ...
	 *
	 * @return string
	 * @see \Thurly\Main\DB\Connection::getType
	 */
