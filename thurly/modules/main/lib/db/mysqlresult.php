...
{
	/** @var \Thurly\Main\Entity\ScalarField[]  */
	 ...
	 */
	public function __construct($result, Connection $dbConnection, \Thurly\Main\Diag\SqlTrackerQuery $trackerQuery = null)
	{
	 ...
	 *
	 * @return \Thurly\Main\Entity\ScalarField[]
	 */
