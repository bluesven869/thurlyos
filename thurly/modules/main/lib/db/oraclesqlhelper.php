...
class OracleSqlHelper extends SqlHelper
{
	 ...
	 *
	 * @return string
	 * @see \Thurly\Main\DB\SqlHelper::quote
	 */
	 ...
	 *
	 * @return string
	 * @see \Thurly\Main\DB\MssqlSqlHelper::formatDate
	 */
	...
	/**
	 * Converts string into \Thurly\Main\Type\DateTime object.
	 * <p>
	 * Helper function.
	 *
	 * @param string $value Value fetched.
	 *
	 * @return null|\Thurly\Main\Type\DateTime
	 * @see \Thurly\Main\Db\OracleSqlHelper::getConverter
	 */
	...
	/**
	 * Converts string into \Thurly\Main\Type\Date object if string has datetime specific format..
	 * <p>
	 * Helper function.
	 *
	 * @param string $value Value fetched.
	...
	public function getTopSql($sql, $limit, $offset = 0)
	{
		...
		if ($offset > 0 && $limit <= 0)
			throw new \Thurly\Main\ArgumentException("Limit must be set if offset is set");
