...
abstract class SqlHelper
{
	 ...
	 *
	 * @return string
	 * @see \Thurly\Main\DB\SqlHelper::getLeftQuote
	 * @see \Thurly\Main\DB\SqlHelper::getRightQuote
	 */
	 ...
	 * @see \Thurly\Main\Entity\Query::buildGroup
	 * @see \Thurly\Main\Entity\Query::buildOrder
	 *
	 * @param string $fieldName
	 *
	 * @return string
	...
	public function convertToDbDate($value)
	{
		...
		{
			throw new Main\ArgumentTypeException('value', '\Thurly\Main\Type\Date');
		}
	}
