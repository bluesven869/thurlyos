...
use Thurly\Main\Data;
use Thurly\Main\Diag;
...
abstract class Connection extends Data\Connection
{
	...
	/**
	 * @return \Thurly\Main\Db\SqlHelper
	 */
	 ...
	 * @param \Thurly\Main\Diag\SqlTrackerQuery $trackerQuery Debug collector object.
	 *
	 * @return resource
	 * @throws \Thurly\Main\Db\SqlQueryException
	 */
	abstract protected function queryInternal($sql, array $binds = null, \Thurly\Main\Diag\SqlTrackerQuery $trackerQuery = null);
	 ...
	 * @return Result
	 */
	abstract protected function createResult($result, \Thurly\Main\Diag\SqlTrackerQuery $trackerQuery = null);
	 ...
	 * @see \Thurly\Main\Db\SqlHelper->getQueryDelimiter
	 *
	 ...
	 * @param \Thurly\Main\Entity\ScalarField[] $fields Array with columns descriptions.
	 ...
	 *
	 * @return \Thurly\Main\Diag\SqlTracker
	 */
	 ...
	 *
	 * @return null|\Thurly\Main\Diag\SqlTracker
	 */
	 ...
	 * @return void
	 */
	public function setTracker(\Thurly\Main\Diag\SqlTracker $sqlTracker = null)
	{
