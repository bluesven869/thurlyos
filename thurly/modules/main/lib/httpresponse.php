...
class HttpResponse extends Response
{
	...
	/** @var \Thurly\Main\Web\Cookie[] */
	protected $cookies = array();

	/** @var array */
	protected $headers = array();

	/** @var \Thurly\Main\Type\DateTime */
	...
	public function storeCookies()
	{
		...
		{
			/** @var $cookie \Thurly\Main\Web\Cookie */
	...
	protected function createStandardHeaders()
	{
		...
		$this->addHeader("X-Powered-CMS", "Thurly Site Manager (".($key == "DEMO" ? "DEMO" : md5("THURLY".$key."LICENCE")).")");

		if (Config\Option::get("main", "set_p3p_header", "Y") == "Y")
			$this->addHeader("P3P", "policyref=\"/thurly/p3p.xml\", CP=\"NON DSP COR CUR ADM DEV PSA PSD OUR UNR BUS UNI COM NAV INT DEM STA\"");
	}
