...
class Controller implements Errorable, Controllerable
{
	...
	{
		//Thurly\Disk\Internals\Diag::getInstance()->collectDebugInfo(get_called_class());
	}
	...
	{
		//Thurly\Disk\Internals\Diag::getInstance()->logDebugInfo(get_called_class());
	}
	 ...
	 * @see \Thurly\Main\Engine\Controller::getFullEventName.
	 ...
	 * then we use default filters @see \Thurly\Main\Engine\Controller::getDefaultPreFilters() and
	 * @see \Thurly\Main\Engine\Controller::getDefaultPostFilters().
