...
{
	const AJAX_END_POINT = '/thurly/services/main/ajax.php';
	...
	/**
	 * Creates uri for the thurly component which implements @see \Thurly\Main\Engine\Contract\Controllerable
	 * and it's action.
	 *
	 ...
	 * @throws \Thurly\Main\ArgumentOutOfRangeException
	 */
	public function createByThurlyComponent(\CThurlyComponent $component, $action, $params = array())
	{
