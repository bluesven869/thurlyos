...
class OldPage extends \Thurly\Main\Page
{
	...
	public function preInit()
	{
		//! вызывается только для публичных страниц только если prolog.php подключался (нет, если prolog_before.php)
			...
			{
				define("THURLY_STATIC_PAGES", true);
	...
	public function init()
	{
		...
		\CModule::addAutoloadClasses(
			...
			array(
				...
				"Thurly\\Main\\Entity\\Base" => "lib/entity/base.php",
				"Thurly\\Main\\Entity\\DataManager" => "lib/entity/base.php",
				"Thurly\\Main\\Entity\\Field" => "lib/entity/field.php",
				"Thurly\\Main\\Entity\\ScalarField" => "lib/entity/scalarfield.php",
				"Thurly\\Main\\Entity\\IntegerField" => "lib/entity/integerfield.php",
				"Thurly\\Main\\Entity\\FloatField" => "lib/entity/floatfield.php",
				"Thurly\\Main\\Entity\\StringField" => "lib/entity/stringfield.php",
				"Thurly\\Main\\Entity\\TextField" => "lib/entity/textfield.php",
				"Thurly\\Main\\Entity\\BooleanField" => "lib/entity/booleanfield.php",
				"Thurly\\Main\\Entity\\DateField" => "lib/entity/datefield.php",
				"Thurly\\Main\\Entity\\DatetimeField" => "lib/entity/datetimefield.php",
				"Thurly\\Main\\Entity\\EnumField" => "lib/entity/enumfield.php",
				"Thurly\\Main\\Entity\\ExpressionField" => "lib/entity/expressionfield.php",
				"Thurly\\Main\\Entity\\UField" => "lib/entity/ufield.php",
				"WorkgroupEntity" => "lib/workgroup.php",
				"Thurly\\Main\\Entity\\ReferenceField" => "lib/entity/referencefield.php",
				"Thurly\\Main\\Entity\\Query" => "lib/entity/query.php",
				"Thurly\\Main\\Entity\\QueryChain" => "lib/entity/querychain.php",
				"Thurly\\Main\\Entity\\QueryChainElement" => "lib/entity/querychainelement.php",
