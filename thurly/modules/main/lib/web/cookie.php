...
class Cookie
{
	...
	{
		$cookiePrefix = \Thurly\Main\Config\Option::get("main", "cookie_name", "THURLY_SM")."_";
	...
	{
		$cookiesSettings = \Thurly\Main\Config\Configuration::getValue("cookies");
	...
	protected function getCookieDomain()
	{
		...
		$cacheFlags = \Thurly\Main\Config\Configuration::getValue("cache_flags");
		...
		{
			$managedCache = \Thurly\Main\Application::getInstance()->getManagedCache();
