...
use Thurly\Main\Mail\Internal\EventAttachmentTable;
use Thurly\Main\Mail\Internal\EventTable;
use Thurly\Main\Config as Config;
use Thurly\Main\Type as Type;
...
class EventManager
{
	...
	public static function checkEvents()
	{
		...
		$manage_cache = \Thurly\Main\Application::getInstance()->getManagedCache();
