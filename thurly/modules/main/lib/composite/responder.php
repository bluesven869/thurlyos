...
class Responder
{
	...
	private static function isValidRequest()
	{
		...
		if (Helper::isThurlyFolder())
		{
			self::$error = Logger::TYPE_THURLY_FOLDER;
			return false;
		}
	...
	private static function setHeaders($etag, $lastModified, $compositeHeader = false, $contentType = false)
	{
		...
		{
			header("X-Thurly-Composite: Cache (".$compositeHeader.")");
		}
	}
	...
	public static function autoLoad($className)
	{
		...
		if ($className === "Thurly\\Main\\Composite\\Debug\\Logger")
		{
...
class_alias("Thurly\\Main\\Composite\\AbstractResponse", "StaticHtmlCacheResponse");
class_alias("Thurly\\Main\\Composite\\MemcachedResponse", "StaticHtmlMemcachedResponse");
class_alias("Thurly\\Main\\Composite\\FileResponse", "StaticHtmlFileResponse");