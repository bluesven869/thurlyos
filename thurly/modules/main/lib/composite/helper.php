...
class Helper
{
	...
	/**
	 * Returns true if the current request URI has thurly folder
	 *
	 * @return bool
	 */
	public static function isThurlyFolder()
	{
	...
	public static function __callStatic($name, $arguments)
	{
		...
		{
			\Thurly\Main\Composite\Engine::onUserLogin();
		}
		elseif (strtoupper($name) === strtoupper("OnUserLogout"))
		{
			\Thurly\Main\Composite\Engine::onUserLogout();
		}
	}
...
{
	class_alias("Thurly\\Main\\Composite\\Helper", "CHTMLPagesCache");
}