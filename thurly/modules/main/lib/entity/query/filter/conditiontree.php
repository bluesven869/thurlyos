...
use Thurly\Main\Entity\QueryChain;
use Thurly\Main\Entity\Field\IReadable;
...
class ConditionTree
{
	...
	public function getSql($chains)
	{
		...
		foreach ($this->conditions as $condition)
		{
			...
			else
			{
				...
				// final sql
				$sql = call_user_func(
					array('Thurly\Main\Entity\Query\Filter\Operator', $operator),
	 ...
	 *
	 * @param array                                    $values
	 * @param \Thurly\Main\Entity\Field\IReadable|null $field
	 *
	 * @return array
	 */
