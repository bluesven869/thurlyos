...
{
	/**
	 * @param \Thurly\Main\Data\Connection $connection
	 * @param Query                        $query
	 *
	 * @return bool
	 */
	public static function checkQuery(\Thurly\Main\Data\Connection $connection, Query $query)
	{
		// check interface
	...
	public static function relayQuery(\Thurly\Main\Data\Connection $connection, Query $query)
	{
		// prepare select
		$select = array();
