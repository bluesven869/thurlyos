...
class EventResult extends \Thurly\Main\EventResult
{
	/** @var array */
	...
	/**
	 * Sets the array of fields to modify data in the Thurly\Main\Entity\Event
	 * @param array $fields
	 */
	...
	/**
	 * Sets the array of fields names to unset data in the Thurly\Main\Entity\Event
	 * @param array $fields
	 */
