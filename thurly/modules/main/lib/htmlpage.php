	...
	extends Page
{
	...
	protected function getHtmlToSpreadCookiesOverSites()
	{
		...
		if (!empty($params))
		{
			...
			$versionFile = new IO\File(IO\Path::convertRelativeToAbsolute("/thurly/modules/main/classes/general/version.php"));
			...
			if (count($domainList) > 0)
			{
				...
				{
					$uriString = $protocol.$domain."/thurly/spread.php?".$params;
