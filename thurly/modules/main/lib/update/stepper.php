 ...
 * \Thurly\Main\Update\Stepper::bindClass('Thurly\Tasks\Update1701', 'tasks');
 * or
...
\Thurly\Lists\SomePath\EcrmPropertyUpdate::bind();
}
 */
...
HTML;
	...
	public static function execAgent()
	{
		...
		if ($updater->deleteFile === true && \Thurly\Main\ModuleManager::isModuleInstalled("thurlyos") !== true)
		{
	...
	/**
	 * Adds agent for class $className for $moduleId module. Example for updater: \Thurly\Main\Stepper::bindClass('\Thurly\SomeModule\SomeClass', 'somemodule').
	 * @param string $className Class like \Thurly\SomeModule\SomeClass.
