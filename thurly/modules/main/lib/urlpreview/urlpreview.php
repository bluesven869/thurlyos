...
use Thurly\Main\Web\HttpHeaders;
use Thurly\Main\Web\Uri;

class UrlPreview
{
	const SIGN_SALT = 'url_preview';
	const USER_AGENT = 'Thurly link preview';
	...
	protected static function isUrlLocal(Uri $uri)
	{
		...
		$host = \Thurly\Main\Context::getCurrent()->getRequest()->getHttpHost();
	...
	public static function getInnerFrameUrl($id, $provider = '')
	{
		...
		$componentPath = \CComponentEngine::makeComponentPath('thurly:main.urlpreview');
