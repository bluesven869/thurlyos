...
namespace Thurly\Main\PhoneNumber;
...
class Parser
{
	...
	public static function detectCountry()
	{
		...
		{
			$defaultCountry = Option::get("thurlyos", "REG_COUNTRY", "");

			if(!$defaultCountry)
			{
				$portalZone = \CThurlyOS::getPortalZone();
		...
		if(!$defaultCountry)
		{
			...
			$defaultCountry = \Thurly\Main\Service\GeoIp\Manager::getCountryCode();
		}
