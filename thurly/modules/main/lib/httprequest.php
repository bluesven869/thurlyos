...
class HttpRequest extends Request
{
	...
	protected function prepareCookie(array $cookies)
	{
		...
		if ($cookiePrefix === null)
			$cookiePrefix = Config\Option::get("main", "cookie_name", "THURLY_SM")."_";
	...
	public function getScriptFile()
	{
		...
		if($scriptName == "/thurly/urlrewrite.php" || $scriptName == "/404.php" || $scriptName == "/thurly/virtual_file_system.php")
		{
