...
abstract class Application
{
	 ...
	 * LRU cache instance.
	 *
	 * @var \Thurly\Main\Data\LruCache
	 */
	protected $lruCache;

	/**
	 * @var \Thurly\Main\Diag\ExceptionHandler
	 */
	...
	*/
	...
	/**
	 * @return \Thurly\Main\Diag\ExceptionHandler
	 */
	...
	public static function getPersonalRoot()
	{
		...
		return isset($_SERVER["BX_PERSONAL_ROOT"]) ? $_SERVER["BX_PERSONAL_ROOT"] : "/thurly";
	}
