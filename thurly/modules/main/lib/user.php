...
use \Thurly\Main\Search\MapBuilder;
...
class UserTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		...
		return array(
			...
			'INDEX' => array(
				'data_type' => 'Thurly\Main\UserIndex',
	...
	public static function indexRecord($id)
	{
		...
		$intranetInstalled = \Thurly\Main\ModuleManager::isModuleInstalled('intranet');
		...
		if ($intranetInstalled)
		{
			$departmentNames = \Thurly\Main\UserUtils::getDepartmentNames($record['UF_DEPARTMENT']);
