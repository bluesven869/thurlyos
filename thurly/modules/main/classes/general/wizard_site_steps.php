...
class CPackageSelectStructure extends CWizardStep
{
	...
	function DisplayTree(&$arStructure, $systemTree = false)
	{
		...
		foreach ($arStructure as $pageID => $arPage)
		{
			...
			{
				if ($isService)
					$strTree .= '<img src="/thurly/images/main/wizard/service.gif" width="16" height="16" border="0" alt="" />';
				else
					$strTree .= '<img src="/thurly/images/main/wizard/page.gif" width="16" height="16" border="0" alt="" />';
			}
