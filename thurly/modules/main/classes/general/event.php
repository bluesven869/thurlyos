...
class CAllEvent
{
	...
	/**
	 * @deprecated See \Thurly\Main\Mail\Mail::is8Bit()
	 */
	...
	/**
	 * @deprecated See \Thurly\Main\Mail\Mail::encodeMimeString()
	 */
	...
	/**
	 * @deprecated See \Thurly\Mail\Mail::encodeSubject()
	 */
	...
	/**
	 * @deprecated See \Thurly\Main\Mail\Mail::encodeHeaderFrom()
	 */
	...
	/**
	 * @deprecated See \Thurly\Main\Mail\Mail::getMailEol()
	 */
	...
	/**
	 * @deprecated See \Thurly\Main\Mail\Event::handleEvent()
	 */
	...
	public function Add($arFields)
	{
		...
		if ($result->isSuccess())
		{
			...
			if(count($arLID)>0)
			{
				...
				$resultDb = \Thurly\Main\SiteTable::getList(array(
					'select' => array('LID'),
		...
		$resultDb = Mail\Internal\EventMessageTable::getList(array(
			...
			'runtime' => array(
				'EVENT_MESSAGE_TYPE' => array(
					'data_type' => 'Thurly\Main\Mail\Internal\EventType',
					'reference' => array('=this.EVENT_NAME' => 'ref.EVENT_NAME', '=ref.LID' => new \Thurly\Main\DB\SqlExpression('?', LANGUAGE_ID)),
				),
			)
		));
...
class CEventType
{
	...
	public static function GetListEx($arOrder = array(), $arFilter = array(), $arParams = array())
	{
		...
		$query1 = new \Thurly\Main\Entity\Query(Mail\Internal\EventMessageTable::getEntity());
		...
		$query2 = new \Thurly\Main\Entity\Query(Mail\Internal\EventTypeTable::getEntity());
		...
		$query2->registerRuntimeField('EVENT_MESSAGE', array(
			'data_type' => 'Thurly\Main\Mail\Internal\EventMessage',
			'reference' => array('=this.EVENT_NAME' => 'ref.EVENT_NAME'),
		));
