...
class CXMLFileStream
{
	...
	public function findNext()
	{
		...
		while(($xmlChunk = $this->getXmlChunk($bMB)) !== false)
		{
			...
			{
				$error = "";
				$xmlChunk = \Thurly\Main\Text\Encoding::convertEncoding($origChunk, $cs, LANG_CHARSET, $error);
			}
	...
	private function readXml($startPosition, $endPosition)
	{
		...
		{
			$error = "";
			$xmlChunk = \Thurly\Main\Text\Encoding::convertEncoding($xmlChunk, $this->fileCharset, LANG_CHARSET, $error);
		}
