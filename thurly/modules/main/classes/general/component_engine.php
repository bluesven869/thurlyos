...
class CComponentEngine
{
	 ...
	 *
	 * <p>Component name consists of namespace part, separator and name. Example: thurly:news.list</p>
	...
	public function guessComponentPath($folder404, $arUrlTemplates, &$arVariables, $requestURL = false)
	{
		...
		if ($requestURL === false)
			$requestURL = Thurly\Main\Context::getCurrent()->getRequest()->getRequestedPage();
