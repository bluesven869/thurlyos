...
class CBXPunycode
{
	...
	public function IsEncoded($domainName)
	{
		...
		if ($this->encoding != "utf-8")
			$domainName = \Thurly\Main\Text\Encoding::convertEncoding($domainName, $this->encoding, "utf-8");
	...
	public function Decode($domainName)
	{
		...
		if ($this->encoding != "utf-8")
			$domainName = \Thurly\Main\Text\Encoding::convertEncoding($domainName, "utf-8", $this->encoding);
