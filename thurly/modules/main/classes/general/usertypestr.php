 ...
 * @subpackage classes
 */
class CUserTypeString extends \Thurly\Main\UserField\TypeBase
{
...
*/
	 ...
	 * <p>Возвращает html.</p>
	 * <p>Если класс не предоставляет такую функцию,
	 * то менеджер типов вызовет компонент указанный в метаданных свойства или системный thurly:system.field.view</p>
	 * @param array $arUserField Массив описывающий поле.
	...
	public static function GetPublicView($arUserField, $arAdditionalParameters = array())
	{
		...
		foreach ($value as $res)
		{
			...
			$res = \Thurly\Main\Text\HtmlFilter::encode($res);
	 ...
	 * <p>Возвращает html.</p>
	 * <p>Если класс не предоставляет такую функцию,
	 * то менеджер типов вызовет компонент указанный в метаданных свойства или системный thurly:system.field.edit</p>
	 * @param array $arUserField Массив описывающий поле.
...
/*
	public static function onGetPublicView($event)
	{
		...
		{
			$html = "demo string";
			return new \Thurly\Main\EventResult(\Thurly\Main\EventResult::SUCCESS, $html);
		}
	}
*/
