...
class COtherAuthProvider implements IProviderInterface
{
	public function GetFormHtml($arParams=false)
	{
		...
		$arItem = array(
			"ID" => "U".$USER->GetID(),
			"AVATAR" => "/thurly/js/main/core/images/access/avatar-user-auth.png",
		...
		if(!is_array($arParams["other"]) || $arParams["other"]["disabled_cr"] != "true")
		{
			$arItem = array(
				"ID" => "CR",
				"AVATAR" => "/thurly/js/main/core/images/access/avatar-user-author.png",
		...
		if(!is_array($arParams["other"]) || $arParams["other"]["disabled_g2"] != "true")
		{
			$arItem = array(
				"ID" => "G2",
				"AVATAR" => "/thurly/js/main/core/images/access/avatar-user-everyone.png",
