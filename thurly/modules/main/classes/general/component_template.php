...
class CThurlyComponentTemplate
{
	public $__name = "";
	public $__page = "";
	public $__engineID = "";
	...
	/** @var \Thurly\Main\Composite\BufferArea[] */
	 ...
	 * @return null|string
	 *
	 * @see CThurlyComponentTemplate::Init
	 */
	 ...
	 * @return string
	 *
	 * @see CThurlycomponentTemplate::setLanguageId
	 */
	 ...
	 *
	 * @see CThurlyComponentTemplate::Init
	 * @see CThurlyComponentTemplate::ApplyCachedData
	 */
	 ...
	 *
	 * @return void
	 * @see CThurlyComponentTemplate::GetCachedData
	 */
	...
	public function InitTemplateEngines($arTemplateEngines = array())
	{
		...
		\Thurly\Main\Type\Collection::sortByColumn($arBXAvailableTemplateEngines, "sort", "", 200);
	 ...
	 *
	 * @param CThurlyComponent $component Parent component.
	...
	public function Init(&$component, $siteTemplate = false, $customTemplatePath = "")
	{
		...
		if (!($component instanceof cthurlycomponent))
			return false;
	 ...
	 * <li>/thurly/components/&lt;parent template&gt;/&lt;component path&gt;/
	 ...
	 * <li>/thurly/components/&lt;component path&gt;/
	 * </ol>
	 *
	...
	public function __SearchTemplate($customTemplatePath = "")
	{
		...
		if ($parentComponent)
		{
			...
			$arFolders[] = array(
				"path" => "/thurly/components".$parentRelativePath."/templates/".$parentTemplateName.$relativePath,
				"in_theme" => true,
				"site_template" => "",
			);
		}
		...
		$arFolders[] = array(
			"path" => "/thurly/components".$relativePath."/templates",
			"site_template" => "",
		);
	...
	public function IncludeLangFile($relativePath = "", $lang = false, $return = false)
	{
		...
		if($this->__folder <> '')
		{
			...
			{
				\Thurly\Main\Localization\Loc::loadMessages($absPath);
			}
			else
			{
				if ($lang === false)
				...
				$arLangMessages = \Thurly\Main\Localization\Loc::loadLanguageFile($absPath, $lang);
			}
		}
	 ...
	 * @see CThurlycomponentTemplate::EndViewTarget
	 */
	 ...
	 * @return void
	 * @see CMain::ShowViewContent
	 * @see CThurlycomponentTemplate::SetViewTarget
	 */
	 ...
	 * 		'SRC' => '/thurly/images/myicon.gif' // icon image
	 * 	)
	 * );
	 * </code>
	 *
	 ...
	 *
	 * @return void
	 * @see CThurlycomponentTemplate::GetEditAreaId
	 */
	 ...
	 *
	 * @return string
	 * @see CThurlycomponentTemplate::AddEditAction
	 */
	 ...
	 *
	 * @return Thurly\Main\Composite\BufferArea
	 * @see Thurly\Main\Composite\BufferArea
	 */
	public function createFrame($id = null, $autoContainer = true)
	{
		...
		$frame = new Thurly\Main\Composite\BufferArea($id, $autoContainer);
		$this->frames[] = $frame;
