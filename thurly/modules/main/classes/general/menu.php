...
class CMenu
{
	...
	function GetMenuHtmlEx()
	{
		...
		if($APPLICATION->GetShowIncludeAreas())
		{
			...
			{
				$arIcons[] = array(
					"URL"=>"/thurly/admin/fileman_menu_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&back_url=".urlencode($_SERVER["REQUEST_URI"])."&path=".urlencode($this->MenuDir)."&name=".$this->type,
					"ICON"=>"menu-edit",
			...
			{
				$arIcons[] = array(
					"URL"=>"/thurly/admin/fileman_file_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&back_url=".urlencode($_SERVER["REQUEST_URI"])."&full_src=Y&path=".urlencode($this->template),
					"ICON"=>"menu-template",
