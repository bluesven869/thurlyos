...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/wizard_site.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/wizard_site_steps.php");
	...
	<head>
		...
		<style type="text/css">
			...
			.bx-ie9 .step-buttons input {
				border-radius:4px;
				background:url("/thurly/panel/main/images/bx-admin-sprite-small-2.png") repeat-x 0 -3554px;
