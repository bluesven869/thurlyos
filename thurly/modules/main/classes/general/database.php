...
use Thurly\Main;
use Thurly\Main\Data\ConnectionPool;
...
abstract class CAllDatabase
{
	...
	/**
	 * @var integer
	 * @deprecated Use \Thurly\Main\Application::getConnection()->getTracker()->getCounter();
	 **/
	var $cntQuery = 0;
	/**
	 * @var float
	 * @deprecated Use \Thurly\Main\Application::getConnection()->getTracker()->getTime();
	 **/
	var $timeQuery = 0.0;
	/**
	 * @var \Thurly\Main\Diag\SqlTrackerQuery[]
	 * @deprecated Use \Thurly\Main\Application::getConnection()->getTracker()->getQueries();
	 **/
	...
	function DoConnect($connectionName = "")
	{
		...
		if ($app != null)
		{
			...
			if (
				$con
				&& $con->isConnected()
				&& ($con instanceof Thurly\Main\DB\Connection)
