...
window.BXUndoLastChanges = function()
{
	...
	BX.ajax.get(\"/thurly/admin/public_undo.php?undo=".$ID."&".thurly_sessid_get()."\", null, function(result)
	{
...
<?
	...
	public static function Allowed()
	{
		...
		if (self::$bAllowed == null)
		{
			...
			self::$bAllowed = $arOpt['autosave'] != 'N' && $APPLICATION->GetCurPage() != '/thurly/admin/update_system.php';
		}
