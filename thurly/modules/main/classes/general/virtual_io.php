<?
include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/virtual_file.php");
	...
	implements IBXVirtualIO, IBXGetErrors
{
	...
	{
		include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/virtual_io_filesystem.php");
