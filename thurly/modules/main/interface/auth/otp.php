...
$bNeedCaptcha = (CModule::IncludeModule("security") && \Thurly\Security\Mfa\Otp::isCaptchaRequired());
?>
...
?>
		...
		<div class="login-popup-field login-captcha-field">
			...
			<div class="login-input-wrap">
				<span class="login-captcha-wrap" id="captcha_image"><?if($bNeedCaptcha):?><img src="/thurly/tools/captcha.php?captcha_sid=<?=$CAPTCHA_CODE?>" width="180" height="40" alt="CAPTCHA" /><?endif;?></span><input type="text" onfocus="BX.addClass(this.parentNode, 'login-input-active')" onblur="BX.removeClass(this.parentNode, 'login-input-active')" name="captcha_word" class="login-input" tabindex="4" autocomplete="off">
				<div class="login-inp-border"></div>
			</div>
		</div>
<?
