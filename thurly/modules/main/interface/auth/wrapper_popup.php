...
<script type="text/javascript" bxrunfirst="true">
	(new top.BX.CAuthDialog({
		content_url: "/thurly/admin/wizard_install.php",
...
<form action="<?=$APPLICATION->GetCurPageParam(thurly_sessid_get(), Array("sessid"))?>" method="post" name="wizard_reload_form">
...
?>
	...
	<div class="bx-core-popup-auth-field">
		<div class="bx-core-popup-auth-field-caption">
			...
			<img src="/thurly/tools/captcha.php?captcha_sid=<?=$CAPTCHA_CODE?>" width="180" height="40" alt="CAPTCHA" />
		</div>
