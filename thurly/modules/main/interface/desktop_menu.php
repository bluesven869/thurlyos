...
{
	$DESKTOP_CURRENT = $APPLICATION->GetCurPage(true) == "/thurly/admin/index.php" ? intval($_REQUEST['dt_page']) : -1;
		...
		?><div id="adm-submenu-desktop" class="adm-submenu-items-wrap adm-submenu-desktop" style="">
			<div class="adm-submenu-items-block"><?
				foreach ($arUserOptions as $DESKTOP_ID => $arUserOption):
					...
					?><a href="/thurly/admin/?dt_page=<?=$DESKTOP_ID?>" class="adm-submenu-item<?=$desktop_className ? ' '.$desktop_className : ''?>">
