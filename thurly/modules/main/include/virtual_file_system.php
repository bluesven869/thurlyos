...
RewriteRule ^(.*)$ /thurly/virtual_file_system.php [L]
*/
...
if (!defined("BX_UTF"))
{
	$requestUri = \Thurly\Main\Text\Encoding::convertEncoding($requestUri, "utf-8", (defined("BX_DEFAULT_CHARSET")? BX_DEFAULT_CHARSET : "windows-1251"));
}
