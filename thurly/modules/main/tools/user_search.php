...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/admin/user_admin.php");
...
<tr valign="top">
	<td><?echo GetMessage("F_GROUP")?><br><img src="/thurly/images/main/mouse.gif" width="44" height="21" border="0" alt=""></td>
	<td><?
