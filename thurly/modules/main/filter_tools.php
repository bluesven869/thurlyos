...
function ShowFilterLogicHelp()
{
	...
	$str = "";
	if(LANGUAGE_ID == "ru")
		$help_link = "http://dev.1c-thurly.ru/user_help/help/filter.php";
	else
		$help_link = "http://www.thurlysoft.com/help/index.html?page=".urlencode("source/main/help/en/filter.php.html");
	if ($LogicHelp != "Y")
	{
...
';
	...
	{
		$s .= '
	<td width="100%"><img src="/thurly/images/1.gif" width="1" height="18" alt=""></td>
';
	}
	$s .= '
...
<tr>
<td width="6"><img height=6 alt="" src="/thurly/images/admin/mn_ltc.gif" width=6></td>
<td background=/thurly/images/admin/mn_tline.gif><img height=1 alt="" src="/thurly/images/1.gif" width=1></td>
<td width="6"><img height=6 alt="" src="/thurly/images/admin/mn_rtc.gif" width=6></td></tr>
<tr>
<td width="6" background=/thurly/images/admin/mn_lline.gif><img height=1 alt="" src="/thurly/images/1.gif" width=1></td>
...
<td width=13 background="/thurly/images/admin/mn_delim.gif"><img height=1 alt="" src="/thurly/images/1.gif" width=13></td>
<td><font class="submenutext">
';
		continue;
	}
...
<table border="0" cellspacing="0" cellpadding="0">
<tr valign="top">
	<td width="7"><img src="/thurly/images/admin/arr_right'.($menu["WARNING"]<>""? "_red":"").'.gif" alt="" width="7" height="7" border="0" vspace="4"></td>
...
<td width="6" background=/thurly/images/admin/mn_rline.gif><img height=1 alt="" src="/thurly/images/1.gif" width=1></td></tr>
<tr>
<td width="6"><img height=6 alt="" src="/thurly/images/admin/mn_lbc.gif" width=6></td>
<td background=/thurly/images/admin/mn_bline.gif><img height=1 alt="" src="/thurly/images/1.gif" width=1></td>
<td width="6"><img height=6 alt="" src="/thurly/images/admin/mn_rbc.gif" width=6></td></tr>
</table>
';
return $s;
}
