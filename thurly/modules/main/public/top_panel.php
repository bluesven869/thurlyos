...
class CTopPanel
{
	...
	public static function GetStandardButtons()
	{
		...
		if ($bCanCreatePage)
		{
			$defaultUrl = $APPLICATION->GetPopupLink(
				Array(
					"URL"=>"/thurly/admin/public_file_new.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&templateID=".$encSiteTemplateId.
		...
		{
			$defaultUrl = $APPLICATION->GetPopupLink(array(
				"URL"=> "/thurly/admin/public_file_edit.php?lang=".LANGUAGE_ID."&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encRequestUri."&templateID=".$encSiteTemplateId,
				"PARAMS"=>array(
					"width"=>780,
					"height"=>470,
					"resizable"=>true,
			...
			$arMenu[] = Array(
				...
				"ACTION"=> $APPLICATION->GetPopupLink(Array(
					"URL"=>"/thurly/admin/public_file_property.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentFilePath."&back_url=".$encRequestUri,
					"PARAMS" => Array("min_width"=>450, "min_height" => 250))
				),
				"SORT" => 20,
			...
			$arMenu[] = Array(
				...
				"ACTION"=>$APPLICATION->GetPopupLink(Array(
					"URL"=>"/thurly/admin/public_file_edit.php?lang=".LANGUAGE_ID."&noeditor=Y&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encRequestUri,
			...
			if ($USER->CanDoOperation("edit_php"))
			{
				$arMenu[] = Array(
					...
					"ICON"=>"panel-edit-php",
					"ACTION"=>$APPLICATION->GetPopupLink(Array(
						"URL" => "/thurly/admin/public_file_edit_src.php?lang=".LANGUAGE_ID."&path=".$encCurrentFilePath."&site=".SITE_ID."&back_url=".$encRequestUri."&templateID=".$encSiteTemplateId,
		...
		if (CTopPanel::IsCanEditPermission($currentFilePath, $documentRoot, $filemanExists))
		{
			...
			$arMenu[] = Array(
				...
				"ACTION"=>$APPLICATION->GetPopupLink(Array(
					"URL"=>"/thurly/admin/public_access_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentFilePath."&back_url=".$encRequestUri,
					"PARAMS" => Array("min_width"=>450, "min_height" => 250)
				)),
				"SORT" => 30,
		...
		if (CTopPanel::IsCanDeletePage($currentFilePath, $documentRoot, $filemanExists))
		{
			...
			$arMenu[] = array(
				...
				"ACTION" => $APPLICATION->GetPopupLink(array(
					"URL" => "/thurly/admin/public_file_delete.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentFilePath,
					"PARAMS" => Array(
						"min_width"=>250,
						"min_height" => 180,
						'height' => 180,
		...
		if (CTopPanel::IsCanEditSection($currentDirPath, $filemanExists))
		{
			$defaultUrl = 'javascript:'.$APPLICATION->GetPopupLink(array(
					"URL"=>"/thurly/admin/public_folder_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".urlencode($APPLICATION->GetCurDir())."&back_url=".$encRequestUri,
					"PARAMS" => Array("min_width"=>450, "min_height" => 250)
				)
			);
		...
		if (CTopPanel::IsCanEditPermission($currentDirPath, $documentRoot, $filemanExists))
		{
			$arMenu[] = Array(
				...
				"ACTION"=>$APPLICATION->GetPopupLink(Array(
					"URL"=>"/thurly/admin/public_access_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentDirPath."&back_url=".$encRequestUri,
					"PARAMS" => Array("min_width"=>450, "min_height" => 250))
				),
				"SORT"=>30,
		...
		{
			$defaultUrl = $APPLICATION->GetPopupLink(array(
				"URL" => "/thurly/admin/public_structure.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".$encCurrentFilePath."&templateID=".$encSiteTemplateId,
			...
			if($filemanExists)
			{
				...
				$arMenu[] = array(
					...
					"ACTION" => "jsUtils.Redirect([], '".CUtil::JSEscape("/thurly/admin/fileman_admin.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&path=".urlencode($APPLICATION->GetCurDir()))."')",
		...
		if ($USER->CanDoOperation("cache_control"))
		{
			...
			if (!empty($APPLICATION->aCachedComponents))
			{
				$arMenu[] = array(
					...
					"ACTION"=>"jsComponentUtils.ClearCache('component_name=".CUtil::addslashes(implode(",", $APPLICATION->aCachedComponents))."&site_id=".SITE_ID."&".thurly_sessid_get()."');",
		...
		if ($USER->CanDoOperation("edit_php") || $USER->CanDoOperation("lpa_template_edit"))
		{
				...
				if (file_exists($_SERVER['DOCUMENT_ROOT'].$filePath))
				{
					$arMenu[] = array(
						...
						"ACTION"=> $APPLICATION->GetPopupLink(
							array(
								"URL" => "/thurly/admin/public_file_edit_src.php?lang=".LANGUAGE_ID."&path=".urlencode($filePath)."&site=".SITE_ID."&back_url=".$encRequestUri,
								"PARAMS" => array(
									"width" => 770,
									'height' => 470,
									'resize' => true,
			...
			$arSubMenu = array(
				array(
					...
					"ICON"		=>"icon-edit",
					"ACTION"	=> "jsUtils.Redirect([], '/thurly/admin/template_edit.php?lang=".LANGUAGE_ID."&ID=".$encSiteTemplateId."')",
					"DEFAULT"	=>!$bUseSubmenu,
				...
				array(
					...
					"ICON"		=> "icon-edit",
					"ACTION"	=> "jsUtils.Redirect([], '/thurly/admin/site_edit.php?lang=".LANGUAGE_ID."&LID=".SITE_ID."')",
					"DEFAULT"	=> false,
		...
		if ($USER->CanDoOperation("edit_php"))
		{
			...
			$arMenu = array(
				...
				array(
					...
					"CHECKED"=>(!!\Thurly\Main\Data\Cache::getShowCacheStat()),
					"ACTION"=>"jsUtils.Redirect([], '".CUtil::addslashes($APPLICATION->GetCurPageParam("show_cache_stat=".(\Thurly\Main\Data\Cache::getShowCacheStat()? "N" : "Y"), array("show_cache_stat")))."');",
			...
			if(\Thurly\Main\Loader::includeModule("compression") && CCompress::CheckCanGzip() !== 0)
			{
		...
		if($USER->CanDoOperation('manage_short_uri'))
		{
			$url = $APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/short_uri_edit.php?lang=".LANGUAGE_ID."&public=Y&bxpublic=Y&str_URI=".urlencode($APPLICATION->GetCurPageParam("", array("clear_cache", "sessid", "login", "logout", "register", "forgot_password", "change_password", "confirm_registration", "confirm_code", "confirm_user_id", "thurly_include_areas", "show_page_exec_time", "show_include_exec_time", "show_sql_stat", "show_link_stat")))."&site=".SITE_ID."&back_url=".$encRequestUri,
					"PARAMS" => array(
						"width" => 770,
						'height' => 270,
						'resize' => true,
			...
			$APPLICATION->AddPanelButton(array(
				...
				"MENU" => array(
					...
					array(
						...
						"ACTION"=>"jsUtils.Redirect([], '".CUtil::addslashes("/thurly/admin/short_uri_admin.php?lang=".LANGUAGE_ID."")."');",
	...
	public static function ShowPanelScripts($bReturn=false)
	{
		...
		if (!$bReturn)
		{
			...
			$APPLICATION->AddHeadScript('/thurly/js/main/public_tools.js');
		...
		else
		{
			return
				...
				.'
<script type="text/javascript" src="'.CUtil::GetAdditionalFileURL('/thurly/js/main/public_tools.js', true).'"></script>
...
';
	...
	public static function GetPanelHtml()
	{
		...
		$toggleModeSet = false;
		if (isset($_GET["thurly_include_areas"]) && $_GET["thurly_include_areas"] <> "")
		{
			$APPLICATION->SetShowIncludeAreas($_GET["thurly_include_areas"]=="Y");
			$toggleModeSet = true;
		}

		$params = DeleteParam(array("thurly_include_areas", "thurly_show_mode", "back_url_admin"));
		...
		$toggleModeLink = $hrefEnc.'?thurly_include_areas='.($toggleMode ? 'N' : 'Y').($params<>""? "&amp;".htmlspecialcharsbx($params):"");
	...
	';
		$result .= '
				<a id="bx-panel-menu" href="" '.CTopPanel::AddAttrHint(GetMessage('top_panel_start_menu_tooltip_title'), GetMessage('top_panel_start_menu_tooltip')).'><span id="bx-panel-menu-icon"></span><span id="bx-panel-menu-text">'.GetMessage("top_panel_menu").'</span></a><a id="bx-panel-view-tab"><span>'.GetMessage("top_panel_site").'</span></a><a id="bx-panel-admin-tab" href="'.(
						...
						: '/thurly/admin/index.php?lang='.LANGUAGE_ID.'&amp;'
		...
		$arStartMenuParams = array(
			...
			'MENU_URL' => '/thurly/admin/get_start_menu.php?lang='.LANGUAGE_ID.'&back_url_pub='.urlencode($back_url).'&'.thurly_sessid_get(),
	...
	';
		...
		if ($bCanProfile)
		{
			$result .= '<a href="/thurly/admin/user_edit.php?lang='.LANGUAGE_ID.'&ID='.$USER->GetID().'" id="bx-panel-user" '.CTopPanel::AddAttrHint(GetMessage('top_panel_profile_tooltip')).'><span id="bx-panel-user-icon"></span><span id="bx-panel-user-text">'.$userName.'</span></a>';
		}
		else
		{
		...
		$result .= $hkInstance->PrintJSExecs($Execs);
		$Execs = $hkInstance->GetCodeByClassName("bx-panel-small-toggle",GetMessage("top_panel_edit_mode_new_tooltip_title"),'location.href="'.$href.'?thurly_include_areas='.($toggleMode ? 'N' : 'Y').($params<>""? "&".$params:"").'";');
		$result .= $hkInstance->PrintJSExecs($Execs);
