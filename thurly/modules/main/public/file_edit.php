...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/public/file_edit.php");
...
pMainObj.Show(true);
<?if ($bSessIDRefresh):?>
top.BXSetSessionID('<?=CUtil::JSEscape(thurly_sessid())?>');
<?endif;?>
</script>
<?
		}
...
<form action="/thurly/admin/public_file_edit.php" name="editor_form" method="post" enctype="multipart/form-data" target="file_edit_form_target" style="margin: 0px; padding: 0px; ">
<?
if (CAutoSave::Allowed())
{
