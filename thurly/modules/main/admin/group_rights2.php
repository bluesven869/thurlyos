...
if($REQUEST_METHOD=="POST" && strlen($Update)>0 && $USER->IsAdmin() && check_thurly_sessid())
{
...
?>
<tr>
	<td><?=$value["NAME"]." [<a title=\"".GetMessage("MAIN_USER_GROUP_TITLE")."\" href=\"/thurly/admin/group_edit.php?ID=".$value["ID"]."&amp;lang=".LANGUAGE_ID."\">".$value["ID"]."</a>]:"?><?
