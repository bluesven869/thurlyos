...
include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/lang/".LANG."/admin/checklist.php");

$APPLICATION->AddHeadString('<link type="text/css" rel="stylesheet" href="/thurly/themes/.default/check-list-style.css">');
...
<div class="checklist-body-1024">
	<div class="checklist-wrapper checklist-result">
			...
			<a class="checklist-result-back" href="/thurly/admin/checklist.php?lang=<?=LANG;?>"><?=GetMessage("CL_BACK_TO_CHECKLIST");?></a>
		</div>
	</div>
<?endif;?>
	<script type="text/javascript">
				...
				Dialog = new BX.CAdminDialog(
					{
						...
						head: "",
						content_url: "/thurly/admin/checklist_report.php?ACTION=INFO&TEST_ID="+testID+"&ID=<?=$arReportID;?>&lang=<?=LANG;?>&bxpublic=Y",
		...
		function Move(action)
		{
			...
			ShowWaitWindow();
			BX.ajax.post(
				"/thurly/admin/checklist_report.php?bxpublic=Y&ACTION=INFO&TEST_ID="+arStates["POINTS"][current].TEST_ID+"&lang=<?=LANG;?>&ID=<?=$arReportID;?>&<?=thurly_sessid_get()?>",
				data,
				function(data)
				{
