...
if($_REQUEST["action"] <> "" && $editable && check_thurly_sessid())
{
...
if($_SERVER["REQUEST_METHOD"]=="POST" && $_REQUEST["Update"]=="Y" && $editable && check_thurly_sessid())
{
	$aMsg = array();
...
else
{
	...
	if($aUserOpt["sound_login"] == "") $aUserOpt["sound_login"] = "/thurly/sounds/main/thurly_tune.mp3";
}
...
?>
	...
	<tr>
		...
		<td>
			...
			<a href="javascript:if(confirm('<?echo CUtil::addslashes(GetMessage("user_sett_del_links_conf"))?>'))window.location='user_settings.php?action=clear_links&lang=<?echo LANG?>&<?echo thurly_sessid_get()?>';"><?echo GetMessage("user_sett_del_links")?></a>
		</td>
	</tr>
...
CAdminFileDialog::ShowScript(
	...
	(
		...
		"arPath" => Array('PATH' => '/thurly/sounds/main/'),
	...
	<tr>
		...
		<td>
			<div class="adm-list">
				...
				<?if(file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/index.php")):?>
				<div class="adm-list-item">
				...
				<?endif;?>
				<?if(file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/perfmon/install/index.php")):?>
				<div class="adm-list-item">
...
?>
	<tr>
		<td colspan="2"><a href="javascript:if(confirm('<?echo CUtil::addslashes(GetMessage("user_sett_del_pers_conf"))?>'))window.location='user_settings.php?action=clear&lang=<?echo LANG?>&<?echo thurly_sessid_get()?>&tabControl_active_tab=edit2';"><?echo GetMessage("user_sett_del_pers1")?></a></td>
	</tr>
<?if($USER->CanDoOperation('edit_other_settings')):?>
	<tr>
		<td colspan="2"><a href="javascript:if(confirm('<?echo CUtil::addslashes(GetMessage("user_sett_del_common_conf"))?>'))window.location='user_settings.php?action=clear_all&lang=<?echo LANG?>&<?echo thurly_sessid_get()?>&tabControl_active_tab=edit2';"><?echo GetMessage("user_sett_del_common1")?></a></td>
	</tr>
	<tr>
		<td colspan="2"><a href="javascript:if(confirm('<?echo CUtil::addslashes(GetMessage("user_sett_del_user_conf"))?>'))window.location='user_settings.php?action=clear_all_user&lang=<?echo LANG?>&<?echo thurly_sessid_get()?>&tabControl_active_tab=edit2';"><?echo GetMessage("user_sett_del_user1")?></a></td>
	</tr>
<?endif;?>
