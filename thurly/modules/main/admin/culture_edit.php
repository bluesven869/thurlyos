...
if($request->isPost() && ($request["save"] <> '' || $request["apply"] <> '') && $isAdmin && check_thurly_sessid())
{
	$arFields = array(
		"NAME" => $request['NAME'],
...
$aMenu = array(
	array(
		...
		"LINK"	=> "/thurly/admin/culture_admin.php?lang=".LANGUAGE_ID,
...
if($ID > 0 && $isAdmin)
{
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/thurly/admin/culture_edit.php?lang=".LANGUAGE_ID,
		"TITLE"	=> Loc::getMessage("MAIN_NEW_RECORD_TITLE"),
		"ICON"	=> "btn_new"
	);
	$aMenu[] = array(
		"TEXT"	=> Loc::getMessage("MAIN_COPY_RECORD"),
		"LINK"	=> "/thurly/admin/culture_edit.php?lang=".LANGUAGE_ID."&amp;COPY_ID=".$ID,
		"TITLE"	=> Loc::getMessage("MAIN_COPY_RECORD_TITLE"),
		"ICON"	=> "btn_copy"
	);
	$aMenu[] = array(
		"TEXT"	=> Loc::getMessage("MAIN_DELETE_RECORD"),
		"LINK"	=> "javascript:if(confirm('".CUtil::JSEscape(Loc::getMessage("MAIN_DELETE_RECORD_CONF"))."')) window.location='/thurly/admin/culture_admin.php?ID=".$ID."&lang=".LANGUAGE_ID."&".thurly_sessid_get()."&action_button=delete';",
