...
elseif(isset($_REQUEST["table_name"]) && check_thurly_sessid())
{
...
else
{
	...
	{
		if($_REQUEST["check_tables"]=="Y" && check_thurly_sessid())
		{
		...
		elseif($_REQUEST["optimize_tables"]=="Y")
		{
			...
			function Optimize(table_name)
			{
				...
				else
				{
					...
					var url = 'repair_db.php?lang=<?echo LANGUAGE_ID?>&<?echo thurly_sessid_get()?>&table_name='+table_name;
