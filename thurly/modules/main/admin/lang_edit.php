...
$aMenu = array(
	array(
		...
		"LINK"	=> "/thurly/admin/lang_admin.php?lang=".LANGUAGE_ID,
...
if ($ID>0)
{
	...
	$aMenu[] = array(
		...
		"LINK"	=> "/thurly/admin/lang_edit.php?lang=".LANGUAGE_ID,
	...
	if($isAdmin)
	{
		$aMenu[] = array(
			...
			"LINK"	=> "/thurly/admin/lang_edit.php?lang=".LANGUAGE_ID."&amp;COPY_ID=".urlencode($language["LID"]),
			"TITLE"	=> Loc::getMessage("MAIN_COPY_RECORD_TITLE"),
			"ICON"	=> "btn_copy"
		);
		$aMenu[] = array(
			"TEXT"	=> Loc::getMessage("MAIN_DELETE_RECORD"),
			"LINK"	=> "javascript:if(confirm('".Loc::getMessage("MAIN_DELETE_RECORD_CONF")."')) window.location='/thurly/admin/lang_admin.php?ID=".urlencode(urlencode($language["LID"]))."&lang=".LANGUAGE_ID."&".thurly_sessid_get()."&action=delete';",
