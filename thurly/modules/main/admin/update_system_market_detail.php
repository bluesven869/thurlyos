...
{
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["action"] == "load" && check_thurly_sessid())
	{
		if (CUpdateClientPartner::LoadModuleNoDemand($arModule["ID"], $errorMessage, "Y", false))
			LocalRedirect("/thurly/admin/module_admin.php?lang=".LANG."&id=".$arModule["ID"]."&".thurly_sessid_get()."&install=Y");
	}
