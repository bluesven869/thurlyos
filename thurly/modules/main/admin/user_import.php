...
//Download sample
$filename = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/admin/sample.csv";
...
?>
	<tr class="adm-detail-required-field">
		...
		<td>
			...
			?>
			<?if (is_file($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/admin/sample.csv")):?>
...
<?endif?>
	...
	<tr>
		...
		<td>
			...
			&nbsp;<a href="/thurly/admin/ldap_server_edit.php?lang=<?=LANGUAGE_ID?>"><?=GetMessage("USER_IMPORT_NEW_LDAP_SERVER")?></a>
		</td>
	</tr>
	<?endif?>
...
<?elseif ($tabStep == 2 && $dataSource == "ldap"):?>
	...
	<tr class="adm-detail-required-field">
		...
		<td width="50%">
			...
			&nbsp;<a href="/thurly/admin/ldap_server_edit.php?lang=<?=LANGUAGE_ID?>&back_url=<?=urlencode('/thurly/admin/user_import.php?lang='.$lang.'&dataSource=ldap&tabStep=2')?>"><?=GetMessage("USER_IMPORT_NEW_LDAP_SERVER")?></a>
		</td>
	</tr>
	<tr id="predef">
