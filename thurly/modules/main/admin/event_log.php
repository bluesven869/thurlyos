...
while($db_res = $rsData->NavNext(true, "a_"))
{
	...
	{
		$row->AddViewField("GUEST_ID", '<a href="/thurly/admin/hit_list.php?lang='.LANGUAGE_ID.'&amp;set_filter=Y&amp;find_guest_id='.$a_GUEST_ID.'&amp;find_guest_id_exact_match=Y">'.$a_GUEST_ID.'</a>');
	}
	if($a_USER_ID)
	{
