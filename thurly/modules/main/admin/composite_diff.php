...
use Thurly\Main\Composite\Page;
...
$logRecord = LogTable::getList(array(
	"filter" => array(
		"ID" => $logId,
		"TYPE" => \Thurly\Main\Composite\Debug\Logger::TYPE_CACHE_REWRITING
	)
))->fetch();
...
$diff = new \Thurly\Main\Text\Diff();
...
<html>
<head>
	<link rel="stylesheet" href="<?=CUtil::getAdditionalFileURL("/thurly/panel/main/composite.css")?>">
