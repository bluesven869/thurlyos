...
if (in_array($arSmileSet["STRING_ID"], Array('thurly_main')))
{
	CAdminMessage::ShowMessage(array(
		"MESSAGE"=>GetMessage("SMILE_THURLY_SET_WARNING_TITLE"),
		"DETAILS"=>GetMessage("SMILE_THURLY_SET_WARNING_DESC", Array('#LINK_START#' => '<a href="smile_set_edit.php?lang='.LANG.'&GALLERY_ID='.$arSmileSet['PARENT_ID'].'">', '#LINK_END#' => '</a>')),
		"HTML"=>true,
		"TYPE"=>"WARNING",
	));
}
