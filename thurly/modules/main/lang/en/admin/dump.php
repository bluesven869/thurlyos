...
$MESS["DUMP_MAIN_THURLY_CLOUD"] = "Thurly Clouds";
$MESS["DUMP_MAIN_THURLY_CLOUD_DESC"] = "Thurly Cloud Storage";
...
$MESS["DUMP_MAIN_MULTISITE_INFO"] = "If you select multiple sites to archive, the first site will be saved in the archive root, while the public files of the other sites will be saved in <b>/thurly/backup/sites</b>. You will have to move them to their appropriate locations and create symlinks manually when restoring.";
...
$MESS["MAIN_DUMP_SHED_TIME_SET"] = "This option is available only if the system agents use cron. Otherwise, you will have to use your hosting provider's control panel to have the script <b>/thurly/modules/main/tools/backup.php</b> run when required.";
...
$MESS["AUTO_EXEC_FROM_THURLY"] = "using Thurly cloud service";
...
$MESS["DUMP_CHECK_THURLYCLOUD"] = "Check the current task status at <a href=\"#LINK#\">Thurly Cloud service</a>";
$MESS["DUMP_WARN_NO_THURLYCLOUD"] = "Cannot enable auto backup. Please install the cloud service support module or use cron to run agents.";
$MESS["DUMP_SAVED_DISABLED"] = "Auto backup is disabled.<br>Backups can only be created by running /thurly/modules/main/tools/backup.php manually.";
...
$MESS["DUMP_TABLE_BROKEN"] = "The table #TABLE# has been destroyed due to internal MySQL error. Use <a href=\"/thurly/admin/site_checker.php?tabControl_active_tab=edit1\" target=_blank>Site Checker</a> to fully recover the table, or just restore table structure.";
