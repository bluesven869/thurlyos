...
$MESS["CL_REPORT_WARNED2"] = "that the client has been notified that a Thurly advisor will call.";
$MESS["CL_REPORT_CALL_TIME"] = "Time to call";
$MESS["CL_REPORT_CALL_TIME_HINT"] = "specify when a Thurly specialist should call your customer";
...
$MESS["CL_SAVE_SEND_REPORT_CUT"] = "Send to Thurly Inc.";
$MESS["CL_SAVE_SEND_REPORT_HINT"] = "When you check your project in for quality assessment by Thurly Inc., the system sends only the test results and the project owner contacts. If you wish to supply any additional information, please specify it in comments.";
...
$MESS["CL_REPORT_SENDED"] = "Report has been sent to Thurly Inc.";
...
$MESS["CL_MANUAL"] = "<p>Before you release the project, you have to pass various tests: development quality, system parameters and Thurly Framework specification conformity. </p><p>There are <b>mandatory</b> and <b>optional</b> tests. To get your project released, it is sufficient to pass just the mandatory tests. </p><p>Having the optional tests passed will give your project more credit. Some of the tests are automated. </p>";
$MESS["CL_MANUAL2"] = "<p>The project quality assessment is a two-stage process: the Quality Monitor and the Project Owner Survey. The first stage has been successfully passed.</p><p><b>The second stage of project submission to Thurly Inc.: The Project Owner Survey.</b><br>Please specify the project owner contact information.</p><p>We will contact them to ask ten short questions regarding quality management standards, overall project quality and the usability of Thurly software.</p><p><b>Please let them know we are going to call them!</b></p>";
$MESS["CL_MANUAL_MINI"] = "<p>To submit the project to Thurly Inc., you have to pass the remaining mandatory tests. The status of these tests can be \"Failed\" (automated test failed), or \"Pending\" (these need to be checked manually). To pass failed or pending tests, read the test recommendations and investigate the error details. </p>
