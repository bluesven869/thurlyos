...
$MESS["CL_QWE0010"] = "Your version of Thurly Virtual Appliance is up-to-date";
...
$MESS["CL_QP0040"] = "Thurly environment is configured for maximum performance";
...
$MESS["CL_QH0020"] = "Hosting parameters optimized for Thurly environment and project";
...
$MESS["CL_QWE0010_DESC"] = "Your version of Thurly Virtual Appliance is up-to-date.";
$MESS["CL_QWE0020_DESC"] = "No issues have been detected in <a href=\"/thurly/admin/site_checker.php?lang=#LANG#\" target=\"_blank\">System check</a> area on the \"Intranet operability\" tab.";
$MESS["CL_QWE0030_DESC"] = "No issues have been detected in <a href=\"/thurly/admin/site_checker.php?lang=#LANG#\" target=\"_blank\">System check</a> area on the tabs \"Configuration Check\", \"Access Check (full)\".";
...
$MESS["CL_QD0020_DESC"] = "Once the web project design has been approved, the next stage comes: making the design layout. After the design layout has been completed, it is integrated into the Thurly website templates (including the component templates).";
...
$MESS["CL_QD0030_DESC"] = "All menu types set. It is recommended to use the standard cached components (\"thurly:menu\").";
$MESS["CL_QD0040_DESC"] = "Support for website template object editing using Amber technology (without accessing Control Panel).";
$MESS["CL_QD0050_DESC"] = "Breadcrumbs configured. It is recommended to use the standard components (\"thurly:breadcrumb\").";
$MESS["CL_QD0060_DESC"] = "Sitemap generation configured. It is recommended to use the standard components (\"thurly:main.map\").";
...
$MESS["CL_QC0110_DESC"] = "The project's custom Components 2.0 has been designed according to Thurly guidelines.";
$MESS["CL_QC0120_DESC"] = "No PHP warnings (E_WARNING) are issued when generating pages or executing other scripts.";
$MESS["CL_QC0130_DESC"] = "The source code of average or high complexity is wrapped as an individual Thurly platform module.";
...
$MESS["CL_QH0020_DESC"] = "Thurly Web Environment (Windows or Linux), or Thurly Virtual Appliance has been used to configure and optimize the server software and configuration.";
...
$MESS["CL_QH0060_DESC"] = "The server mail subsystem is ready. A test e-mail message has been sent successfully using Thurly API.";
$MESS["CL_QP0010_DESC"] = "Thurly Web Environment (Windows or Linux), or Thurly Virtual Appliance is used for maximum performance. The project uses two-tier frontend-backend configuration.";
...
$MESS["CL_QP0040_DESC"] = "The platform infrastructure is configured for maximum performance. Inspect it here: Settings > Performance > Performance Panel, select the \"Thurly\" tab. Check the \"Recommendation\" column. Carry out all the recommendations. Once you are done with that, the tab name should read \"Thurly (optimum)\".";
...
$MESS["CL_QSEC0030_DESC"] = "Assigned permissions to the user groups; verified the capabilities of members of each user group in Control Panel (\"/thurly/admin\") when authorized. Any excessive permissions must be unavailable.";
...
$MESS["CL_QSEC0060_DESC"] = "Debug mode is off; no errors or warnings are shown: \$DBDebug - disabled (http://www.thurlysoft.com/help/source/main/help/en/developer/general/magic_vars.php.html); inspect at Settings > System Settings > Module Settings > Kernel (Main): \"Error reporting mode\" -> \"None\".";
$MESS["CL_QSEC0070_DESC"] = "System event log is on.";
$MESS["CL_QSEC0080_DESC"] = "Scans your source code for possible vulnerabilities.";
$MESS["CL_QSEC0090_DESC"] = "No issues have been detected in \"Settings > Proactive Protection > <a href=\"/thurly/admin/security_scanner.php\" target=\"_blank\">Security Scanner</a>\" area. Security scan results are not outdated.";
...
$MESS["CL_QJ0040_DESC"] = "Provided techsupport contact information (text and logo). Typically, it is a responsibility of a Thurly Partner to provide techsupport services.";
...
$MESS["CL_NOT_FOUND_BACKUP"] = "Backup is not performed. The folder /thurly/backup does not contain backup files.";
$MESS["CL_FOUND_BACKUP"] = "Backup is online. The folder /thurly/backup has #count# file(s).";
...
$MESS["CL_PHP_NOT_OPTIMAL"] = "PHP configuration  <a href=\"/thurly/admin/perfmon_php.php?lang=#LANG#\" target=\"_blank\">is not optimum.</a>";
...
$MESS["CL_CHECK_PERFOM_FAILED"] = "Project check failed. Please test configuration using <a href=\"/thurly/admin/perfmon_panel.php?lang=#LANG#\" target=\"_blank\">Performance Panel</a>.";
$MESS["CL_CHECK_PERFOM_LOWER_OPTIMAL"] = "The current performance score is below 15. Please optimize the project following the <a href=\"/thurly/admin/perfmon_panel.php?lang=#LANG#\" target=\"_blank\">Performance Panel</a> guidelines.";
...
$MESS["CL_LICENSE_KEY_NONE_ACTIVATE"] = "License key is <a href=\"/thurly/admin/update_system.php?lang=#LANG#\" target=\"_blank\">not activated</a>.";
$MESS["CL_LICENSE_KEY_ACTIVATE"] = "License key is activated.";
$MESS["CL_EMPTY_PASS"] = "Empty database password.";
$MESS["CL_VMTHURLY_ACTUAL"] = "Your version of Thurly Virtual Appliance is up-to-date.";
$MESS["CL_VMTHURLY_NOT_ACTUAL"] = "Your version of Thurly Virtual Appliance needs to be updated.";
$MESS["CL_SITECHECKER_OK"] = "No issues have been detected in <a href=\"/thurly/admin/site_checker.php?lang=#LANG#\" target=\"_blank\">System Check</a> area.";
$MESS["CL_SITECHECKER_NOT_OK"] = "There were issues in <a href=\"/thurly/admin/site_checker.php?lang=#LANG#\" target=\"_blank\">System Check</a> area.";
$MESS["CL_SECURITYSCANNER_OK"] = "No critical issues have been detected.";
$MESS["CL_SECURITYSCANNER_NOT_OK"] = "There were issues in <a href=\"/thurly/admin/security_scanner.php?lang=#LANG#\" target=\"_blank\">Security Scanner</a> area.";
$MESS["CL_SECURITYSCANNER_OLD"] = "<a href=\"/thurly/admin/security_scanner.php?lang=#LANG#\" target=\"_blank\">Security Scanner</a> was last run more than 30 days ago.";
?>