<?
$MESS["INS_TITLE"] = "Thurly Site Manager #VERS# Installation";
$MESS["INS_TITLE2"] = "System Installation";
$MESS["INS_TITLE3"] = "Thurly Site Manager #VERS#";
$MESS["INS_TITLE1"] = "<font class=\"thurlytitle\">Thurly Site Manager #VERS#</font> <font class=\"install\">Installation</font>";
...
$MESS["SC_VMTHURLY"] = "<a href=\"http://www.thurlysoft.com/products/virtual_appliance/\" target=\"_blank\">Server environment</a>";
$MESS["SC_VMTHURLY_RECOMMENDED"] = "Thurly Virtual Appliance version #VER# or higher";
$MESS["SC_VMTHURLY_UNKNOWN"] = "Unknown environment";
$MESS["SC_VMTHURLY_OLD"] = "Legacy appliance version (#VER#)";
$MESS["SC_VMTHURLY_OK"] = "Version is up-to-date";
...
$MESS["SC_WEBSERVER_VER_ER"] = "Your web-server version does not meet the Thurly requirements";
$MESS["SC_WEBSERVER_VER_NONE"] = "Cannot determine your web-server version";
$MESS["SC_PHP_VER_ER"] = "Your PHP version does not meet the Thurly requirements";
...
$MESS["SC_VALUE"] = "Value";
$MESS["SC_DISK_THURLY"] = "Site kernel";
...
$MESS["SC_FTHURLY_NOWRITE"] = "Folder /thurly/ is inaccessible for writing and/or reading";
...
$MESS["INS_DATABASE_MY_DESC"] = "Database name where Thurly will be installed";
...
$MESS["ERR_ALREADY_INST1"] = "The database #DB# already contains \"Thurly Site Manager\" installation. To create a new copy, please enter another value in the \"Database\" field. ";
...
$MESS["GOTO_UPDATES_NOTES"] = "Go to System Update page of the administrative site section. This page allows you to register your copy of the \"Thurly Site Manager\" and update the software modules.";
...
$MESS["GOTO_THURLY"] = "Go to Thurly web site";
...
$MESS["GOTO_IF_ERROR"] = "Should you have any problems installing \"Thurly Site Manager\", please do not hesitate to contact the <a href=\"http://www.thurlysoft.com/support/\" target=\"_blank\">customer support service</a>. Highly qualified specialists of the <a href=\"http://www.thurlysoft.com/\" target=\"_blank\">\"Thurly\"</a> company are always at your service. ";
...
$MESS["IS1_BIT"] = "Thurly Site Manager";
$MESS["IS1_BIT_LOZ"] = "Thank you for choosing Thurly Site Manager";
$MESS["COPYRIGHT"] = "Copyright &copy; 2001-#CURRENT_YEAR# Thurly, Inc.";
$MESS["SUPPORT"] = "<a href=\"https://www.thurlyos.com/\" target=\"_blank\">www.thurlyos.com</a> <span class=\"instal-footer-separator\"></span> <a href=\"http://helpdesk.thurlyos.com/\" target=\"_blank\">Support</a>";
$MESS["SUPPORT_README"] = "<a href=\"/readme.html\" target=\"_blank\">Installation instructions</a> <span class=\"instal-footer-separator\"></span> ";
$MESS["FIRST_PAGE"] = "<font class=\"text\">The setup wizard will test your software compatibility and install Thurly Site Manager.<br><br>After the installation is complete, you can start using your site.<br><br>Using the SiteUpdate system you can update your copy and use the up-to-date version of Thurly Site Manager.<br><br>You can get more details on Thurly Site Manager here: <a href=\"http://www.thurlysoft.com/\" target=\"_blank\">http://www.thurlysoft.com</a><br><br>Should you have any questions on the installation process, please do not hesitate to contact the <a href=\"http://www.thurlysoft.com/support/\" target=\"_blank\">Thurly Helpdesk department</a>.</font>";
$MESS["GO_TO_CONTROL"] = "Manage site";
$MESS["GO_TO_REGISTER"] = "Register product";
$MESS["GO_TO_REGISTER_DESCR"] = "Registering your copy of Thurly Site Manager entitles you to:<ul><li>download and install the latest updates of the system;</li><li>send requests to the Thurly helpdesk service, which will allow you to obtain timely advices on any question regarding the system installation and functioning;</li><li>activate your own account on the Thurly private forum. This will enable you to discuss questions with other users, Thurly partners as well as the Helpdesk staff.</li></ul>";
...
$MESS["SC_DB_VERS_MYSQL_ER"] = "Your MySql version does not meet the Thurly requirements";
...
$MESS["INS_DB_NEW"] = "New";
$MESS["GOTO_THURLY_NOTES"] = "Go to <a href=\"http://www.thurlysoft.com/\" target=\"_blank\">Thurly web site</a> (<a href=\"http://www.thurlysoft.com/\" target=\"_blank\">http://www.thurlysoft.com</a>) and learn the latest news on the product. Please feel free to ask questions on Thurly Site Manager at our <a href=\"http://www.thurlysoft.com/support/forum/index.php?\" target=\"_blank\">forum</a> or use the <a href=\"http://www.thurlysoft.com/support/\" target=\"_blank\">automated Helpdesk service</a>.";
$MESS["POWERED_BY"] = "Powered by \"Thurly\"";
...
$MESS["INST_JAVASCRIPT_DISABLED"] = "JavaScript support is required to install Thurly Site Manager. Apparently, JavaScript is not supported by browser or disabled. Change your browser settings and <a href=\"\">try again</a>.";
$MESS["INS_UTF_PARAMS"] = "UTF-8 Installation of Thurly Site Manager";
$MESS["INST_UTF8_RECOMENDATION1"] = "UTF-8 installation of Thurly Site Manager requires <b>mbstring</b> library with parameters <b>mbstring.func_overload=2</b> and <b>default_charset=UTF-8</b>.";
$MESS["ERR_MBSTRING_EXISTS1"] = "Non UTF-8 installation of Thurly Site Manager requires that you set <b>mbstring.func_overload</b> parameter to 0 (zero). Otherwise, install Thurly Site Manager in UTF-8.";
...
$MESS["ACT_KEY_REQUEST_ERROR"] = "An error occurred while requesting a license key. Please contact our <a href='http://www.thurlysoft.com/support/index.php'>Helpdesk</a>.";
