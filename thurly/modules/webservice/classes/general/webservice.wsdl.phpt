...
class CGenericWSDLTestWS extends IWebService
{
	...
	function GetWebServiceDesc() 
	{
		...
		$wsdesc->wsname = "thurly.wsdl.test1";
	...
	function TestComponent() 
	{
		...
		$request = new CSOAPRequest( "wsTestStart2", "http://thurly.soap/" );
		...
		$request = new CSOAPRequest( "wsTestStart3", "http://thurly.soap/" );
		...
		$request = new CSOAPRequest( "wsTestStart4", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		...
		$request = new CSOAPRequest( "wsTestStartOut1", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		...
		$request = new CSOAPRequest( "wsTestStartOut2", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		$response = $client->send( $request );
		...
		$request = new CSOAPRequest( "wsTestStartOut3", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		$response = $client->send( $request );
		...
		$request = new CSOAPRequest( "wsTestStartOut4", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		$response = $client->send( $request );
		...
		$request = new CSOAPRequest( "wsTestStartOut5", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		$response = $client->send( $request );
		...
		$request = new CSOAPRequest( "wsTestStartOut6", "http://thurly.soap/" );
		$request->addParameter("str1", "qwe");
		$response = $client->send( $request );
