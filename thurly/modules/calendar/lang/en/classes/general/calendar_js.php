...
$MESS["EC_SEC_GOOGLE_HIDE"] = "Disable and hide";
...
<ol>
<li>Open GooglePlay and install ThurlyOS app.</li>
<li>Select the menu Settings > Accounts > \"ThurlyOS\"
If there is no account present, create a new one and select ThurlyOS.
<ul>
	<li>Specify your ThurlyOS's address (e.g. <i>company.thurlyos.ru</i>)</li>
...
Your ThurlyOS calendar is now available in your mobile device's calendar, all events synchronized.</p>";
