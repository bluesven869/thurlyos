...
<div>
	...
	<table class="BXEC-Calendar-week" id="<?=$id?>_scel_table_week" cellPadding="0" cellSpacing="0" style="display:none;">
		<tr class="bxec-days-tbl-title">
			<td class="bxec-pad">
				<div class="bxec-day-t-event-holder"></div><img src="/thurly/images/1.gif" width="40" height="1"/></td>
			<td class="bxec-pad2">
				<img src="/thurly/images/1.gif" width="16" height="1"/>
			</td>
		</tr>
	...
	<table class="BXEC-Calendar-week" id="<?=$id?>_scel_table_day" cellPadding="0" cellSpacing="0" style="display:none;">
		<tr class="bxec-days-tbl-title"><td class="bxec-pad"><div class="bxec-day-t-event-holder"></div><img src="/thurly/images/1.gif" width="40" height="1" /></td></tr>
...
function onPopupTaskDeleted(taskId){BX.onCustomEvent(window, 'onCalendarPopupTaskDeleted', [taskId]);}
	...
	public static function InitJS($config = array(), $data = array(), $additionalParams = array())
	{
		...
		if (\Thurly\Main\Loader::includeModule('thurlyos') && !in_array(\CThurlyOS::getLicenseType(), array('company', 'demo', 'edu', 'bis_inc', 'nfr')))
		{
		...
		$basePath = '/thurly/js/calendar/new/';
		...
		CJSCore::RegisterExt('event_calendar', array(
			...
			'lang' => '/thurly/modules/calendar/classes/general/calendar_js.php',
		...
		$APPLICATION->SetAdditionalCSS("/thurly/js/calendar/cal-style.css");

		/*
		// Add scripts
		$arJS = array(
			'/thurly/js/calendar/cal-core.js',
			'/thurly/js/calendar/cal-dialogs.js',
			'/thurly/js/calendar/cal-week.js',
			'/thurly/js/calendar/cal-events.js',
			'/thurly/js/calendar/cal-controlls.js'
		);

		 //Drag & drop
		$arJS[] = '/thurly/js/main/dd.js';
...
var EC_MESS = {
	...
	public static function GetUserfieldsEditHtml($eventId, $url = '')
	{
		...
		$url = $url.(strpos($url,'?') === false ? '?' : '&').'action=userfield_save&bx_event_calendar_request=Y&'.thurly_sessid_get();
?>
...
<?
	...
	public static function CheckThurlyOSLimits($params)
	{
		global $APPLICATION;
		$result = !CCalendar::IsThurlyOS() || CThurlyOSBusinessTools::isToolAvailable(CCalendar::GetCurUserId(), "calendar");
		if (!$result)
		{
			?><div id="<?=$params['id']?>-thurlyos-limit" class="bxec-b24-limit-wrap"><?
			$APPLICATION->IncludeComponent("thurly:thurlyos.business.tools.info", "", array("SHOW_TITLE" => "Y"));
			?></div><?
		}
		return $result;
	}
