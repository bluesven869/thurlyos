<?
namespace Thurly\Calendar\Update;

use Thurly\Calendar\Sync\GoogleApiSync;

/**
 * Class MigrateFromCaldav
 * @package Thurly\Calendar\Update
 */
final class MigrateFromCaldav
{
	...
	public static function doMigration()
	{
		...
		if (!\Thurly\Main\Loader::includeModule('dav') || !$canDoMigration)
		{
			\CCalendar::ClearCache();
			\CAgent::RemoveAgent("Thurly\\Calendar\\Update\\MigrateFromCaldav::doMigration();", "calendar");
			return null;
		}
		else
		{
			...
			return "Thurly\\Calendar\\Update\\MigrateFromCaldav::doMigration();";
		}
	}
}