...
$faceidCloudResponse = \Thurly\FaceId\FaceId::getUsageStats();
...
if (!empty($faceidCloudResponse['status']['exists']))
{
	...
	$expDate = \Thurly\Main\Type\DateTime::createFromTimestamp($faceidCloudResponse['status']['balance_expire_ts']);
...
<tr>
	...
	<td width="60%"><input type="text" name="PUBLIC_URL" value="<?=htmlspecialcharsbx(\Thurly\FaceId\Http::getServerAddress())?>" /></td>
</tr>
