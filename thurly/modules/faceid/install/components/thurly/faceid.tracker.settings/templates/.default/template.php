	...
	<div class="ftr-set-inner-wrap">
		...
		<div class="ftr-set-footer-btn">
			<?if ($arResult['CAN_EDIT']):?>
				<span class="webform-button webform-button-accept" onclick="BX.submit(BX('fts_config_edit_form'))">
					<span class="webform-button-left"></span><span class="webform-button-text"><?=Loc::getMessage("FACEID_FTS_CONFIG_EDIT_SAVE")?></span><span class="webform-button-right"></span>
				</span>
			<?endif?>
			<a href="<?=$arResult['PATH_TO_FTRACKER']?>" class="webform-small-button-link"><?= Loc::getMessage("FACEID_FTS_TO_FTRACKER") ?></a>
		</div>
	</div>
</div>
