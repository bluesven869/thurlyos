...
<div class="b24-time-container <?=\Thurly\Main\Context::getCurrent()->getLanguage() != 'ru'? "b24-time-multilang" : '' ?>">
...
<? if (\Thurly\Main\Config\Option::get('faceid', 'user_index_processing', 0)): ?>
...
<? elseif (\Thurly\Main\Config\Option::get('faceid', 'user_indexed', 0)): ?>
    <!-- index is ready -->
...
<div id="faceid-tms-index" class="b24-time-container b24-time-centering-text-block" style="display: none">
    ...
    <? if (\Thurly\Main\Loader::includeModule('thurlyos')): ?>
        <div class="b24-time-desc-block b24-time-desc-text-small b24-time-desc-block-red b24-time-desc-warning">
            ...
            <div><?= Loc::getMessage("FACEID_TMS_START_WARN_2", array('T_URL' => \CThurlyOS::PATH_LICENSE_ALL))?></div>
        </div>
    <? endif ?>
</div>
