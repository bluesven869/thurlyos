...
function initFaceidUpdater($copyFiles = false)
{
	...
	include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/update_class.php");
	$updater = new CUpdater();
	$updater->Init($curPath = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/faceid/", $DBType, $updaterName = "", $curDir = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/faceid/module_updater.php", "faceid", $copyFiles? "ALL": "DB");
