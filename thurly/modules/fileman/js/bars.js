...
function BXToolbarSet(pColumn, pMainObj, bVertical)
{
	...
	if(bVertical)
	{
		...
		pColumn.innerHTML = '<img src="/thurly/images/1.gif" width="1" height="0">';
...
function BXToolbar(pMainObj, title, dx, dy)
{
	...
	cellIcons.appendChild(pMainObj.CreateElement("IMG", {"src": "/thurly/images/fileman/htmledit2/toolbarleft.gif", "title": title, "alt": title}));
	...
	cellIcons.unselectable = "on";
	cellIcons.style.width = "0%";
	cellIcons.appendChild(pMainObj.CreateElement("IMG", {"src": "/thurly/images/fileman/htmledit2/toolbarright.gif", "title": title, "alt": title}));
	cellIcons.onmousedown = function(e){obj.MouseDown(e); return false;};
	...
	*/
		...
		if(bVertical)
		{
			...
			ct.appendChild(pMainObj.CreateElement("IMG", {"src": "/thurly/images/fileman/htmledit2/toolbartop.gif", "title": title, "alt": title}));
			ct.style.width = "0%";
			...
			for(i=0; i<ar.length; i++)
			{
				...
				ct.style.backgroundImage = "url(/thurly/images/fileman/htmledit2/toolbarbg_vert.gif)";
				if(ct.pObj.onToolbarChangeDirection)
					ct.pObj.onToolbarChangeDirection(bVertical);
			}
			ct = this.pIconsTable.insertRow(-1).insertCell(0).appendChild(pMainObj.CreateElement("IMG", {"src": "/thurly/images/fileman/htmledit2/toolbarbottom.gif", "title": title, "alt": title}));
		}
		else
		{
			...
			ct2.appendChild(pMainObj.CreateElement("IMG", {"src": "/thurly/images/fileman/htmledit2/toolbarleft.gif", "title": title, "alt": title}));
			ct2.style.width = "0%";
			ct2.style.height = "0%";
			...
			for(i=0; i<ar.length; i++)
			{
				...
				ct2.style.width = "0%";
				ct2.style.backgroundImage = "url(/thurly/images/fileman/htmledit2/toolbarbg.gif)";
			...
			ct2.innerHTML = ' ';
			ct2.style.width = "100%";
			r.insertCell(-1).appendChild(pMainObj.CreateElement("IMG", {"src": "/thurly/images/fileman/htmledit2/toolbarright.gif", "title": title, "alt": title}));
		}
	}
...
function BXTaskbarSet(pColumn, pMainObj, iNum)
{
	...
	pColumn.innerHTML = '<img src="/thurly/images/1.gif" width="1" height="1" border="0">';
	...
	//this.pMoveColumn.innerHTML='<img src="/thurly/images/1.gif" alt="" border=0 width="6" height="4">';
...
BXTaskbarSet.prototype.Show = function ()
{
	...
	{
	case 0:
		this.pMoveImg.src="/thurly/images/fileman/htmledit2/splitterh-r.gif";
		this.pMoveColumn.style.backgroundImage = "url(/thurly/images/fileman/htmledit2/splitterhbg-r.gif)";
		break;
	case 1:
		this.pMoveImg.src="/thurly/images/fileman/htmledit2/splitterv-r.gif";
		this.pMoveColumn.style.backgroundImage = "url(/thurly/images/fileman/htmledit2/splittervbg-r.gif)";
		break;
	case 2:
		this.pMoveImg.src="/thurly/images/fileman/htmledit2/splitterv.gif";
		this.pMoveColumn.style.backgroundImage = "url(/thurly/images/fileman/htmledit2/splittervbg.gif)";
		break;
	case 3:
		this.pMoveImg.src="/thurly/images/fileman/htmledit2/splitterh.gif";
		this.pMoveColumn.style.backgroundImage = "url(/thurly/images/fileman/htmledit2/splitterhbg.gif)";
		break;
	}
...
BXTaskbar.prototype.Create = function(pMainObj, title, dx, dy)
{
	...
	//cellTitle.innerHTML = '<table cellpadding=0 cellspacing=0 border=0 width="100%" class="bxedtaskbartitletext"><tr><td width="99%" id = "text" nowrap unselectable="on">'+title+'</td><td width="0%" id="sep">&nbsp;</td><td width="1%" id="button"><img src="/thurly/images/fileman/htmledit2/taskbarx.gif" width="17" height="17"/></td></table>';
	...
	c.style.width = "1%";
	c.id = "button";
	c.innerHTML = '<img src="/thurly/images/fileman/htmledit2/taskbarx.gif" width="17" height="17"/>';
...
function BXComponentsTaskbar()
{
	...
	BXComponentsTaskbar.prototype.__OpenBlock = function (name)
	{
		...
		c.style.width = '0%';
		var im_l = c.appendChild(this.pMainObj.CreateElement("IMG", {'src': '/thurly/images/fileman/htmledit2/tscomp-lt-o.gif', 'width': '20', height: '20'}));
		...
		c.style.backgroundImage = 'url(/thurly/images/fileman/htmledit2/tscomp-ct-bg.gif)';

		c = rowTitle.insertCell(-1);
		c.style.width = '0%';
		var im_r = c.appendChild(this.pMainObj.CreateElement("IMG", {'src': '/thurly/images/fileman/htmledit2/tscomp-rt-o.gif', 'width': '5', height: '20'}));
		...
		c.appendChild(this.pMainObj.CreateElement("IMG", {'src': '/thurly/images/fileman/htmledit2/tscomp-lb.gif', 'width': '20', height: '4'}));

		c = rowBottom.insertCell(-1);
		c.style.backgroundImage = 'url(/thurly/images/fileman/htmledit2/tscomp-cb.gif)';
		c.appendChild(this.pMainObj.CreateElement("IMG", {'src': '/thurly/images/1.gif', 'width': '4', height: '4'}));

		c = rowBottom.insertCell(-1);
		c.appendChild(this.pMainObj.CreateElement("IMG", {'src': '/thurly/images/fileman/htmledit2/tscomp-rb.gif', 'width': '4', height: '4'}));

		this.pCellComp.appendChild(this.pMainObj.CreateElement("IMG", {'src': '/thurly/images/1.gif', 'width': '4', height: '4'}));
	...
	BXComponentsTaskbar.prototype.Hide = function (bHide)
	{
		if(!bHide)
		{
			...
			this.im_r.src = '/thurly/images/fileman/htmledit2/tscomp-rt-o.gif';
			this.im_l.src = '/thurly/images/fileman/htmledit2/tscomp-lt-o.gif';
		}
		else
		{
			this.hidden = true;
			...
			this.im_r.src = '/thurly/images/fileman/htmledit2/tscomp-rt-c.gif';
			this.im_l.src = '/thurly/images/fileman/htmledit2/tscomp-lt-c.gif';
		}
	}
}
