...
arButtons['Fullscreen']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/fullscreen.gif',		'name': 'Fullscreen', 	'title': 'Fullscreen', 'codeEditorMode': true, 'handler': function() {
...
arButtons['Cut']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/cut.gif',	'name': BX_MESS.Cut, 	'cmd': 'Cut'}];
arButtons['Copy']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/copy.gif',	'name': BX_MESS.Copy, 'cmd': 'Copy'}];
arButtons['Paste']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/paste.gif',	'name': BX_MESS.Paste, 'cmd': 'Paste'}];

arButtons['RemoveFormat']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/removeformat.gif',	'name': BX_MESS.RemoveFormat, 'cmd': 'RemoveFormat'}];
arButtons['Undo']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/undo.gif',	'name': 'Undo', 'title': BX_MESS.Undo, 'cmd': 'Undo'}];
arButtons['Redo']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/redo.gif',	'name': 'Redo', 'title': BX_MESS.Redo, 'cmd': 'Redo'}];
arButtons['borders']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/borders.gif',	'name': BX_MESS.BordersTitle, 'handler': function (){this.pMainObj.ShowTableBorder(!this.pMainObj.bTableBorder);this.Check(this.pMainObj.bTableBorder);}}];
arButtons['spellcheck']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/spellcheck.gif', 'name': BX_MESS.Spellcheck, 'handler': function (){}}];
arButtons['find']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/find.gif',	'name': BX_MESS.Find}];
arButtons['replace']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/replace.gif',	'name': BX_MESS.Replace}];

arButtons['pastetext']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/pastetext.gif', 'name': BX_MESS.PasteAsText,
				'handler': function ()
				{
					if(BXIsIE())
...
arButtons['pasteword']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/pasteword.gif', 'name': BX_MESS.PasteAsWord,
				'handler': function ()
				{
					this.bNotFocus = true;
					this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['new']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/new.gif', 'codeEditorMode': true, 'name': BX_MESS.TBNewPage,
							'handler': function ()
							{
...
arButtons['settings']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/settings.gif', 'name': BX_MESS.TBSettings}];
arButtons['exit']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/exit.gif', 'codeEditorMode': true, 'name': BX_MESS.TBExit,
							'handler': function ()
							{
...
arButtons['saveas']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/saveas.gif', 'codeEditorMode': true, 'name': BX_MESS.TBSaveAs}];

arButtons['save']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/save.gif', 'codeEditorMode': true, 'name': BX_MESS.TBSave,
							'handler': function ()
							{
...
arButtons['pageprops']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/pageprops.gif', 'codeEditorMode': true, 'name': BX_MESS.TBProps,
							'handler': function ()
							{
								if(this.pMainObj.bNotSaved)
								{
...
arButtons['insertrow']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/insertrow.gif','name': BX_MESS.TBInsRow, 'handler': function (){this.pMainObj.TableOperation('insertrow');}}];
arButtons['deleterow']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/deleterow.gif','name': BX_MESS.TBDelRow, 'handler': function (){this.pMainObj.TableOperation('deleterow');}}];
arButtons['insertcolumn']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/insertcolumn.gif','name': BX_MESS.TBInsCol, 'handler': function (){this.pMainObj.TableOperation('insertcolumn');}}];
arButtons['deletecolumn']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/deletecolumn.gif','name': BX_MESS.TBDelCol, 'handler': function (){this.pMainObj.TableOperation('deletecolumn');}}];
arButtons['insertcell']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/insertcell.gif','name': BX_MESS.TBInsCell, 'handler': function (){this.pMainObj.TableOperation('insertcell');}}];
arButtons['deletecell']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/deletecell.gif','name': BX_MESS.TBDellCell, 'handler': function (){this.pMainObj.TableOperation('deletecell');}}];
arButtons['mergecell']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/mergecell.gif','name': BX_MESS.TBMergeCell, 'handler': function (){this.pMainObj.TableOperation('mergecell');}}];
arButtons['splitcell']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/splitcell.gif','name': BX_MESS.TBSplitCell, 'handler': function (){this.pMainObj.TableOperation('splitcell');}}];

arButtons['table']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/instable.gif',
...
arButtons['tableprop']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/instable.gif','name': BX_MESS.TBTableProp, 'title': BX_MESS.TBTableProp,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['CreateLink']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/link.gif', 'name': BX_MESS.TBLink, 'title': BX_MESS.TBLink,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['deletelink']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/dellink.gif',	'name': BX_MESS.TBDelLink, 'cmd': 'Unlink',
							'handler': function()
							{
...
arButtons['anchor']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/anchor.gif',	'name': 'Anchor', 'title': BX_MESS.TBAnchor,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['image']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/image.gif',	'name': BX_MESS.TBImg,
							'handler': function ()
							{
								this.bNotFocus = true;
								this.pMainObj.CreateCustomElement("BXDialog",
...
arButtons['BackColor']	=	['BXColorPicker', {'title': 'Background color', 'icon': '/thurly/images/fileman/htmledit2/bgcolor.gif',
...
arButtons['ForeColor']	=	['BXColorPicker', {'title': 'Foreground Color', 'icon': '/thurly/images/fileman/htmledit2/fgcolor.gif',
			'onChange': function (color)
			{
...
arButtons['Bold']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/bold.gif',	'name': BX_MESS.TBBold,  'cmd': 'Bold'}];
arButtons['Italic']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/italic.gif',	'name': BX_MESS.TBItalic,  'cmd': 'Italic'}];
arButtons['Underline']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/under.gif',	'name': BX_MESS.TBUnderline, 'cmd': 'Underline'}];
arButtons['Outdent']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/deindent.gif','name': BX_MESS.TBOutdent, 'cmd': 'Outdent'}];
arButtons['Indent']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/inindent.gif','name': BX_MESS.TBIndent, 'cmd': 'Indent'}];
arButtons['JustifyLeft']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/left.gif','name': BX_MESS.TBJLeft, 'cmd': 'JustifyLeft'}];
arButtons['JustifyCenter']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/center.gif',	'name': BX_MESS.TBJCent, 'cmd': 'JustifyCenter'}];
arButtons['JustifyRight']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/right.gif',	'name': BX_MESS.TBJRig, 'cmd': 'JustifyRight'}];
arButtons['JustifyFull']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/justify.gif',	'name': BX_MESS.TBJFull, 'cmd': 'JustifyFull'}];
arButtons['InsertOrderedList']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/numlist.gif',	'name': BX_MESS.TBOList, 'cmd': 'InsertOrderedList'}];
arButtons['InsertUnorderedList']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/bullist.gif',	'name': BX_MESS.TBUnOList, 'cmd': 'InsertUnorderedList'}];
arButtons['InsertHorizontalRule']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/hr.gif','name': BX_MESS.TBHr, 'cmd': 'InsertHorizontalRule'}];
...
arButtons['source']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/text.gif',	'codeEditorMode': true, 'name': BX_MESS.TBSrc, 't': 'code', 'OnChangeView': __BXSrcBtn, 'handler': function (){this.pMainObj.SetView('code');}}];
arButtons['wysiwyg']	=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/wysiwyg.gif',	'codeEditorMode': true, 'name': BX_MESS.TBWysiwyg, 't': 'html', 'OnChangeView': __BXSrcBtn, 'handler': function (){this.pMainObj.SetView('wysiwyg');}}];
arButtons['split']		=	['BXButton', {'src': '/thurly/images/fileman/htmledit2/split.gif',	'codeEditorMode': true, 'name': BX_MESS.TBSplitmode, 't': 'split', 'OnChangeView': __BXSrcBtn, 'handler': function (){this.pMainObj.SetView('split');}}];
...
/*
arButtons['insrow']	=	['BXTButton', '/thurly/images/fileman/htmledit2/insrow.gif', ''];
arButtons['delrow']	=	['BXTButton', '/thurly/images/fileman/htmledit2/delrow.gif', ''];
arButtons['inscol']	=	['BXTButton', '/thurly/images/fileman/htmledit2/inscol.gif', ''];
arButtons['delcol']	=	['BXTButton', '/thurly/images/fileman/htmledit2/delcol.gif', ''];
arButtons['inscell']	=	['BXTButton', '/thurly/images/fileman/htmledit2/inscell.gif', ''];
arButtons['delcell']	=	['BXTButton', '/thurly/images/fileman/htmledit2/delcell.gif', ''];
arButtons['mergecell']	=	['BXTButton', '/thurly/images/fileman/htmledit2/mrgcell.gif', ''];
arButtons['splitcell']	=	['BXTButton', '/thurly/images/fileman/htmledit2/spltcell.gif', ''];
...
var BXShowComponentPanel = function (bNew, pTaskbar, pElement)
{
	...
	//////////
	var sURL = '/thurly/admin/fileman_get_xml.php?op=componentconfig&lang='+BXLang+'&site='+BXSite+'&templateID='+templateID+'&path='+arSettings["SCRIPT_NAME"];
...
*/
	...
	if(tProp.rows.length>0 && (arTemplate = pTaskbar.pMainObj.FindComponentByPath(arSettings["SCRIPT_NAME"])))
	{
		...
		cell.noWrap = true;
		cell.insertBefore(pTaskbar.pMainObj.CreateElement("IMG", {'src': '/thurly/images/fileman/htmledit2/info.gif', 'title': arTemplate['FULL_PATH'], 'align': 'right', 'width': '16', 'height':'16'}), cell.childNodes[0]);
	}
