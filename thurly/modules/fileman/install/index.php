...
Class fileman extends CModule
{
	...
	function InstallDB()
	{
		...
		if (!$DB->Query("SELECT 'x' FROM b_medialib_collection", true))
			$errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/db/".$DBType."/install.sql");
		...
		RegisterModuleDependences("main", "OnUserTypeBuildList", "fileman", "\\Thurly\\Fileman\\UserField\\Address", "getUserTypeDescription", 154);

		require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/tasks/install.php");
	...
	function UnInstallDB()
	{
		...
		//{
		$errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/db/".$DBType."/uninstall.sql");
		if (!empty($errors))
		{
			$APPLICATION->ThrowException(implode("", $errors));
			return false;
		...
		UnRegisterModuleDependences("main", "OnUserTypeBuildList", "fileman", "\\Thurly\\Fileman\\UserField\\Address", "getUserTypeDescription");

		require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/tasks/uninstall.php");
	...
	function InstallFiles()
	{
		...
		{
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/images", $_SERVER["DOCUMENT_ROOT"]."/thurly/images", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/images/1.gif", $_SERVER["DOCUMENT_ROOT"]."/thurly/images/");
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/themes", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/components", $_SERVER["DOCUMENT_ROOT"]."/thurly/components", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/js", $_SERVER["DOCUMENT_ROOT"]."/thurly/js", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/tools", $_SERVER["DOCUMENT_ROOT"]."/thurly/tools", true, true);
		}
		return true;
	}
	...
	{
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/themes/.default/", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes/.default");//css
		DeleteDirFilesEx("/thurly/themes/.default/icons/fileman/");//icons
		DeleteDirFilesEx("/thurly/images/fileman/");//images
		DeleteDirFilesEx("/thurly/js/fileman"); // JS
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/tools", $_SERVER["DOCUMENT_ROOT"]."/thurly/tools"); // tools
		return true;
	}
	...
	function DoInstall()
	{
		...
		if ($FM_RIGHT!="D")
		{
			...
			$APPLICATION->IncludeAdminFile(GetMessage("FILEMAN_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/step1.php");
		}
	}
	function DoUninstall()
	{
		...
		if ($FM_RIGHT!="D")
		{
			...
			$APPLICATION->IncludeAdminFile(GetMessage("FILEMAN_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/fileman/install/unstep1.php");
		}
	}
