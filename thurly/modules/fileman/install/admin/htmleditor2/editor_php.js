var
	one_gif_src = '/thurly/images/1.gif',
	image_path = '/thurly/images/fileman/htmledit2',
	c2wait_path = image_path + '/c2waiter.gif',
	global_iconkit_path = image_path + '/_global_iconkit.gif',
	settings_page_path = '/thurly/admin/fileman_manage_settings.php?sessid=' + BX.thurly_sessid(),
	editor_action_path = '/thurly/admin/fileman_editor_action.php?sessid=' + BX.thurly_sessid(),
	editor_dialog_path = '/thurly/admin/fileman_editor_dialog.php',
	flash_preview_path = '/thurly/admin/fileman_flash_preview.php',
	manage_snippets_path = '/thurly/admin/fileman_manage_snippets.php?lang=' + window.BXLang + '&site=' + window.BXSite + '&sessid=' + BX.thurly_sessid(),
...
BXHTMLEditor.prototype.LoadComponents2 = function(oCallBack)
{
	...
	lc.Send('/thurly/admin/fileman_load_components2.php?lang='+BXLang+'&site='+BXSite+'&load_tree=Y');
};
...
BXHTMLEditor.prototype.SystemParse_ex = function(sContent)
{
	...
	if (this.limit_php_access)
	{
		...
		sContent = sContent.replace(/#PHP(\d{4})#/ig, function(s, s1){
			return "<img src=\"/thurly/images/fileman/htmledit2/php.gif\" id=\"" + _this.SetBxTag(false, {tag: 'php_disabled', params: {value: s1}}) + "\" border=\"0\"/>";});
	}
	...
	if(arScripts.length > 0)
	{
		...
		for(i = 0; i < arScripts.length; i++)
		{
			...
			else if(!this.pMainObj.limit_php_access || (this.pMainObj.limit_php_access && !this.pMainObj.pComponent2Taskbar))
			{
				...
				newstr += str.substr(plast, arScript[0] - plast) + '<img id="' + id + '" src="/thurly/images/fileman/htmledit2/php.gif" border="0"/>';
			}
			else
			{
				if (window.BS_MESS)
