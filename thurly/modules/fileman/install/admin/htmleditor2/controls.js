...
BXDialog.prototype = {
	_Create: function()
	{
		...
		var
			addUrl = (this.params.PHPGetParams ? this.params.PHPGetParams : '') + '&mode=public' + '&sessid=' + BX.thurly_sessid() + (this.not_use_default ? '&not_use_default=Y' : ''),
			handler = this.handler ? '/thurly/admin/' + this.handler : editor_dialog_path,
