...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/map.yandex.search/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/thurly/components/thurly/map.yandex.search/settings/settings_load.js"></script>
<script type="text/javascript">
jsUtils.loadCSSFile('/thurly/components/thurly/map.yandex.search/settings/settings.css');
