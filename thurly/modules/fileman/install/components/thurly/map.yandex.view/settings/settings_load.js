...
var jsYandexCE = {
	...
	init: function(map)
	{
		...
		BX.loadCSS([
			'/thurly/components/thurly/map.yandex.system/templates/.default/style.css',
			'/thurly/components/thurly/map.yandex.view/settings/settings_iframe.css'
		]);
		BX.loadScript('/thurly/components/thurly/main.colorpicker/templates/.default/script.js', function() {
