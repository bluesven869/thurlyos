...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/map.yandex.view/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/thurly/components/thurly/map.yandex.view/settings/settings_load.js"></script>
<script type="text/javascript">
BX.loadCSS('/thurly/components/thurly/map.yandex.view/settings/settings.css');
...
$APPLICATION->IncludeComponent('thurly:map.yandex.system', '', array(
	'KEY' => $_REQUEST['KEY'],
