...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/map.google.search/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/thurly/components/thurly/map.google.search/settings/settings_load.js"></script>
<script type="text/javascript">
BX.loadCSS('/thurly/components/thurly/map.google.search/settings/settings.css');
...
<?
$APPLICATION->IncludeComponent('thurly:map.google.system', '', array(
	'KEY' => $_REQUEST['KEY'],
