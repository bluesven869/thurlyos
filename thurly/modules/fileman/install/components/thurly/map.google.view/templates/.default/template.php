...
{
	echo '<img src="/thurly/components/thurly/map.google.view/templates/.default/images/preview.png" border="0" />';
}
else
{
	$arTransParams = array(
	...
	$APPLICATION->IncludeComponent('thurly:map.google.system', '.default', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
	?>
		</div>
	</div>
