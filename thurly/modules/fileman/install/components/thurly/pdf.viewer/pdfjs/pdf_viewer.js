...
function scrollIntoView(element, spot) {
  ...
  if (!parent) {
    //console.error('offsetParent is not set -- cannot scroll'); /* thurly change*/
    return;
  }
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = window.pdfJsPathToWorker; /* thurly change */
...
var PDFViewerApplication = {
  ...
  get loadingBar() {
    var bar = new _ui_utils.ProgressBar('#loadingBar' + window.pdfJsViewerId); /* thurly change */
  ...
  bindEvents: function bindEvents() {
    ...
    //eventBus.on('documentproperties', webViewerDocumentProperties); /* thurly change */
...
{
  var HOSTED_VIEWER_ORIGINS = ['null']; /* thurly change */
...
function webViewerInitialized() {
  ...
  var params = [];
  //var params = (0, _ui_utils.parseQueryString)(queryString); /* thurly change */
...
var DEFAULT_URL = 'about:blank'; /* thurly change */
;
...
/* thurly change : add viewerId to each document.getElementById */
...
function webViewerLoad() {
	/* thurly change: pass viewerId, clear overlayManager.active */
...
document.addEventListener('PdfJsChangeSource', webViewerLoad, true); /* thurly change */
  ...
  _createClass(PDFViewer, [{
    ...
    value: function _setCurrentPageNumber(val) {
      ...
      if (!(0 < val && val <= this.pagesCount)) {
        //console.error('PDFViewer._setCurrentPageNumber: "' + val + '" is out of bounds.'); /* thurly change */
        return;
      }
      var arg = {
        source: this,
...
function renderProgress(index, total, l10n) {
  var progressContainer = document.getElementById('printServiceOverlay' + window.pdfJsViewerId); /* thurly change */
