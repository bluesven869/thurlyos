...
CComponentUtil::__IncludeLang(BX_PERSONAL_ROOT."/components/thurly/player", "player_playlist_edit.php");
...
if (!window.style_2 || !window.style_2.parentNode)
	window.style_2 = jsUtils.loadCSSFile("/thurly/components/thurly/player/js/playlist_edit.css");
</script>
<script type="text/javascript" src="/thurly/js/main/dd.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/main/dd.js')?>"></script>
<script type="text/javascript" src="/thurly/components/thurly/player/js/playlist_edit.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/player/js/playlist_edit.js')?>"></script>
<?
