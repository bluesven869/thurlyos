...
BXFMSearch.prototype = {
	...
	Request : function(action, postParams, callBack, bShowWaitWin)
	{
		...
		var actionUrl = '/thurly/admin/fileman_admin.php?lang=' + this.lang + "&fu_action=" + action + "&site=" + this.site + "&" + this.sessid_get + "&fu_site=" + this.oSiteSel.value;
...
BXFMServerPerm.prototype = {
	...
	Request : function(action, postParams, callBack, bShowWaitWin)
	{
		...
		if (bShowWaitWin)
			BX.showWait();
		return BX.ajax.post('/thurly/admin/fileman_server_access.php?lang=' + this.Params.lang + "&fu_action=" + action + "&site=" + this.Params.site + "&" + this.Params.sessid_get, postParams || {},
			function(result)
			{
				if (bShowWaitWin)
					BX.closeWait();
...
BXFMPack.prototype =
{
				...
				if (_this.bStopPacking)
				{
					if (_this.bPack && !window.BXFM_archiveExists)
					{
						var fileID = _this.GetFileName(postParams.packTo),
							...
							deleteFileUrl = "/thurly/admin/fileman_admin.php?action=delete&ID="
	...
	Request : function(action, postParams, callBack, bShowWaitWin)
	{
		...
		var actionUrl = '/thurly/admin/fileman_admin.php?lang=' + this.lang
