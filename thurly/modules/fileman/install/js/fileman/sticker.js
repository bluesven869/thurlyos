function BXSticker(Params, Stickers, MESS)
{
	...
	this.oneGifSrc = '/thurly/images/1.gif';
	this.colorSchemes = [
...
BXSticker.prototype = {
	...
	Request : function(action, postParams, callBack, bShowWaitWin)
	{
		...
		var actionUrl = '/thurly/admin/fileman_stickers.php?sticker_action=' + action + "&" + this.sessid_get + '&site_id=' + this.Params.site_id;
	...
	{
		var strDate = BX.date.format(BX.date.convertThurlyFormat(BX.message('FORMAT_DATETIME')));
...
BXStickerList.prototype = {
	Show: function(type)
	{
		...
		var Config = {
			content_url: '/thurly/admin/fileman_stickers.php?sticker_action=show_list&' + this.BXSticker.sessid_get + '&cur_page=' + encodeURIComponent(this.BXSticker.Params.pageUrl) + '&type=' + type + '&site_id=' + this.BXSticker.Params.site_id,
