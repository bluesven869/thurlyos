...
function fetchPropsHelp($componentName_)
{
	...
	CComponentUtil::__IncludeLang("/thurly/components/".$componentName, "/help/.tooltips.php", $lang);
	$path = $_SERVER["DOCUMENT_ROOT"]."/thurly/components/".$componentName."/help/.tooltips.php";
	$arTooltips = array();
	if(file_exists($path))
		include($path);
