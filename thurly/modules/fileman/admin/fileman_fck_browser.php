...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/include/prolog_popup_admin.php");
...
$file_name = "";
$strWarning = "";
if($REQUEST_METHOD=="POST" && strlen($saveimg)>0 && check_thurly_sessid())
{
...
{
	var src;
	src = "/thurly/admin/workflow_get_file.php?cash=Y&did=<?=intval($DOCUMENT_ID)?>&wf_path=<?=urlencode($WF_PATH)?>&fname="+strPath;
	imageupload.url.value=strPath;
	if(imageupload.preview)
...
<td valign="top" width="98%" align="center">
	...
	<img src="/thurly/images/1.gif" width="100" name="preview">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td width="100%"><input class="typeinput" type="text" name="url" size="40" value=""><img src="/thurly/images/1.gif" width="2" height="1" border=0 alt=""><input class="button" type="button" name="bSelect" onclick="SelectImage(imageupload.url.value)" value="<?=GetMessage('FILEMAN_SELECT_IMAGE')?>"></font></td>
	</tr>
	<tr>
