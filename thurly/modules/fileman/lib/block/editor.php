...
HTML
	...
	public function __construct($params)
	{
		$this->id = $params['id'];
		$this->url = $params['url'];
		$this->previewUrl = isset($params['previewUrl']) ? $params['previewUrl'] : '/thurly/admin/fileman_block_editor.php?action=preview';
		$this->saveFileUrl = isset($params['saveFileUrl']) ? $params['saveFileUrl'] : '/thurly/admin/fileman_block_editor.php?action=save_file';
	...
	public function getDefaultToolList()
	{
		...
		$resultList[] = array(
			...
			'HTML' => '<input type="hidden" data-bx-editor-tool-input="item" value="">'
				. \Thurly\Main\UI\FileInput::createInstance((array(
	...
	public function show()
	{
		\CJSCore::RegisterExt('block_editor', array(
			'js' => array(
				'/thurly/js/main/core/core_dragdrop.js',
				'/thurly/js/fileman/block_editor/dialog.js',
				'/thurly/js/fileman/block_editor/helper.js',
				'/thurly/js/fileman/block_editor/editor.js',
			),
			'css' => '/thurly/js/fileman/block_editor/dialog.css',
			'lang' => '/thurly/modules/fileman/lang/' . LANGUAGE_ID . '/js_block_editor.php',
		));
	 ...
	 * @return string
	 * @deprecated
	 * @see \Thurly\Fileman\Block\Content\Engine::fillHtmlTemplate
	 */
