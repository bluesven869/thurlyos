 ...
 */
namespace Thurly\Fileman\Block;

use Thurly\Main\Event;
use Thurly\Main\EventResult;
use Thurly\Main\Localization\Loc;
use Thurly\Main\SiteTable;
use Thurly\Main\Mail\EventMessageCompiler;
use \Thurly\Main\Web\DOM\StyleInliner;
...
class EditorMail
{
	...
	public static function createInstance($params)
	{
		...
		{
			$params['previewUrl'] = '/thurly/admin/fileman_block_editor.php?action=preview_mail';
		}
		if (!isset($params['saveFileUrl']))
		{
			$params['saveFileUrl'] = '/thurly/admin/fileman_block_editor.php?action=save_file';
		}

		$editor = new Editor($params);

		$editor->componentsAsBlocks = array(
			'thurly:sale.basket.basket.small.mail' => array('NAME' => Loc::getMessage('BLOCK_EDITOR_BLOCK_COMPONENT_BASKET_NAME')),
			'thurly:sale.personal.order.detail.mail' => array('NAME' => Loc::getMessage('BLOCK_EDITOR_BLOCK_COMPONENT_ORDER_NAME')),
			'thurly:catalog.top.mail' => array('NAME' => Loc::getMessage('BLOCK_EDITOR_BLOCK_COMPONENT_CATALOG_NAME')),
			'thurly:sale.discount.coupon.mail' => array('NAME' => Loc::getMessage('BLOCK_EDITOR_BLOCK_COMPONENT_COUPON_NAME')),
			'thurly:bigdata.recommends.mail' => array('NAME' => Loc::getMessage('BLOCK_EDITOR_BLOCK_COMPONENT_BIGDATA_NAME')),
		);
	...
	public static function show(array $params)
	{
		...
		\CJSCore::RegisterExt('block_editor_mail', array(
			'js' => array('/thurly/js/fileman/block_editor/mail_handlers.js'),
						...
						<tbody>
							<tr>
								<td valign="top" class="bxBlockPadding bxBlockContentImage" style="text-align: center">
									<a href="#">
										<img align="center" data-bx-editor-def-image="1" src="/thurly/images/fileman/block_editor/photo-default.png" class="bxImage">
									</a>
								</td>
							</tr>
						</tbody>
									...
									<tbody>
										<tr>
											<td valign="top" class="bxBlockPadding bxBlockContentImage">
												<a href="#">
													<img align="left" data-bx-editor-def-image="1" src="/thurly/images/fileman/block_editor/photo-default.png" class="bxImage">
												</a>
											</td>
										</tr>
									</tbody>
						...
						<td valign="top" class="bxBlockInn bxBlockInnImageText">
							...
							<tbody>
								<tr>
									<td valign="top" class="bxBlockPadding bxBlockContentImage">
										<a href="#">
											<img data-bx-editor-def-image="1" src="/thurly/images/fileman/block_editor/photo-default.png" class="bxImage">
										</a>
									</td>
								</tr>
							</tbody>
