 ...
 * @deprecated
 */
class Geo extends \Thurly\Main\UserField\TypeBase
{
...
<?
	...
	protected function showAdminEdit($arUserField, $arHtmlControl, $multiple = false)
	{
		...
		$APPLICATION->IncludeComponent('thurly:map.google.edit', '', array(
...
<?
	...
	public static function getPublicView($arUserField, $arAdditionalParameters = array())
	{
		...
		$APPLICATION->IncludeComponent('thurly:map.google.view', '', array(
			'MAP_ID' => $mapId,
			'MAP_WIDTH' => '100%',
