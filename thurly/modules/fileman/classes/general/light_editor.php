...
class CLightHTMLEditor // LHE
{
	function Init(&$arParams)
	{
		...
		$basePath = '/thurly/js/fileman/light_editor/';
		...
		//Messages
		$langPath = $_SERVER['DOCUMENT_ROOT'].'/thurly/modules/fileman/lang/'.LANGUAGE_ID.'/classes/general/light_editor_js.php';
		if(!file_exists($langPath))
			$langPath = $_SERVER['DOCUMENT_ROOT'].'/thurly/modules/fileman/lang/en/classes/general/light_editor_js.php';
		...
		$this->JSConfig = array(
			...
			'oneGif' => '/thurly/images/1.gif',
			'imagePath' => '/thurly/images/fileman/light_htmledit/'
		);
	...
	function BuildSceleton()
	{
		...
		?>
		<?/* <img src="/thurly/images/1.gif" width="300" height="1" id="bxlhe_ww_<?=$this->Id?>" />*/?>
<div class="bxlhe-frame" id="bxlhe_frame_<?=$this->Id?>" style="width:<?=$width.$widthUnit?>; height:<?=$height.$heightUnit?>;"><table class="bxlhe-frame-table" cellspacing="0" style="height:<?=$height.$heightUnit?>; width: 100%;">
		...
		<?if ($this->bResizable):?>
		<tr><td class="lhe-resize-row" style="height: 3px;"><img id="bxlhe_resize_<?=$this->Id?>" src="/thurly/images/1.gif"/></td></tr>
		<?endif;?>
</table></div>
		<?
	}
