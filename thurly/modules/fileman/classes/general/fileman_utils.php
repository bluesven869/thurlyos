...
class CFilemanUtils
{
	function InitScript($Params)
	{
		...
		?>
		<script type="text/javascript" src="/thurly/js/fileman/fileman_utils.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/fileman/fileman_utils.js')?>"></script>
...
<?
	...
	function Search($file)
	{
		...
		$this->Result[] = array(
			...
			'type_src' => "/thurly/images/fileman/types/".($bIsDir ? "folder" : CFileMan::GetFileTypeEx($file)).".gif",
...
function InitTranslitInputs(params)
{
	...
	if (params.bLinkInputs)
	{
		...
		var
			pLink1 = BX.create("IMG", {props: {src: "/thurly/images/1.gif", className: "bxfm-linked", title: params.linkedTitle}}),
			pLink2 = BX.create("IMG", {props: {src: "/thurly/images/1.gif", className: "bxfm-linked", title: params.linkedTitle}});
