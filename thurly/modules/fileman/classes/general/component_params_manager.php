...
class CComponentParamsManager
{
	...
	public static function Init($config = array())
	{
		...
		$APPLICATION->AddHeadScript('/thurly/js/fileman/comp_params_manager/component_params_manager.js');
		$APPLICATION->SetAdditionalCss('/thurly/js/fileman/comp_params_manager/component_params_manager.css');

		if (!isset($config['requestUrl']))
		{
			$config['requestUrl'] = '/thurly/admin/fileman_component_params.php';
		}
	...
	public static function FetchHelp($componentName, $lang = false)
	{
		...
		$filePath = "/thurly/components/".$cName;
