		...
		if (strlen($strWarn) <= 0)
		{
			...
			window.<?= $arConfig['event']?> = function(bLoadJS)
			{
				...
				if (!window.BXMediaLib)
				{
					...
					{
						// Append CSS
						BX.loadCSS("/thurly/js/fileman/medialib/medialib.css");

						var arJS = [];
						if (!window.jsAjaxUtil)
							arJS.push("/thurly/js/main/ajax.js?v=<?= filemtime($_SERVER["DOCUMENT_ROOT"].'/thurly/js/main/ajax.js')?>");
						if (!window.jsUtils)
							arJS.push("/thurly/js/main/utils.js?v=<?= filemtime($_SERVER["DOCUMENT_ROOT"].'/thurly/js/main/utils.js')?>");
						if (!window.CHttpRequest)
							arJS.push("/thurly/js/main/admin_tools.js?v=<?= filemtime($_SERVER["DOCUMENT_ROOT"].'/thurly/js/main/admin_tools.js')?>");

						arJS.push("/thurly/js/fileman/medialib/common.js?v=<?= filemtime($_SERVER["DOCUMENT_ROOT"].'/thurly/js/fileman/medialib/common.js')?>");
						arJS.push("/thurly/js/fileman/medialib/core.js?v=<?= filemtime($_SERVER["DOCUMENT_ROOT"].'/thurly/js/fileman/medialib/core.js')?>");
						BX.loadScript(arJS);
					}
...
?>
BX.loadScript("/thurly/js/main/file_dialog.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/main/file_dialog.js')?>");
<?
		}
	}
...
<?
	...
	public static function BuildDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxmedialib'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/thurly/images/1.gif" /></td><td class="ml-diad-title" id="ml_diag_title"><?=GetMessage('ML_MEDIALIB')?></td><td id="bxml_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/thurly/images/1.gif"></td></tr></table>
		</td></tr>
		...
		<div class="ml-buttons-cont" id="ml_but_cont">
			<table><tr>
				<td class="ml-left">
				<?if (!$Params['bReadOnly']):?>
				<a id="ml_add_collection" href="javascript:void(0)" title="<?=GetMessage('ML_ADD_COLLECTION_TITLE')?>" class="ml-add-el-link"><img src="/thurly/images/1.gif" /><?=GetMessage('ML_ADD_COLLECTION')?></a>

				<a id="ml_add_item" href="javascript:void(0)" title="<?=GetMessage('ML_ADD_ELEMENT_TITLE')?>" class="ml-add-el-link"><img src="/thurly/images/1.gif" /><?=GetMessage('ML_ADD_ELEMENT')?></a>
				<?endif;?>
				</td><td class="ml-right">
	...
	public static function BuildAddCollectionDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_coll'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/thurly/images/1.gif" /></td><td class="ml-diad-title"><span id="mlsd_coll_title"></span></td><td id="mlsd_coll_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/thurly/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
	...
	public static function BuildAddItemDialogAdmin($Params)
	{
		...
		<table>
		<tr><td class="ml-content-cell">
<form name="ml_item_form" action="/thurly/admin/fileman_medialib.php?action=edit_item&<?=thurly_sessid_get()?>" onsubmit="return parent.oBXMediaLib.EditItemDialogOnsubmit();" method="post" enctype="multipart/form-data"><table class="mlsd-ifrm-tbl">
		<tr><td colSpan="2">
		...
		<tr><td><b><label for="mlsd_item_name"><?=GetMessage('ML_NAME')?>:</label></b><br /><input type="text" id="mlsd_item_name" name="item_name"/></td>
			...
			<div class="mlsd-prev-cont"><span id="mlsd_no_preview"><?= GetMessage('ML_NO_PREVIEW')?></span><img id="mlsd_item_thumb" src="/thurly/images/1.gif" /></div>
	...
	public static function BuildAddItemDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_item'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/thurly/images/1.gif" /></td><td class="ml-diad-title"><span id="mlsd_item_title"></span></td><td id="mlsd_item_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/thurly/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
...
<style>
	...
	div.mlsd-ch-col{float: left; border: 1px solid #6E8C9B; width: 80px; height: 20px; padding: 0px; overflow: hidden; margin: 2px; position: relative; background: url(/thurly/images/fileman/medialib/group_bg.gif) repeat-x scroll left top;}
	div.mlsd-ch-col span{white-space: nowrap; font-size: 12px !important; display: block; margin: 2px 0 0 2px;}
	div.mlsd-ch-col img.ml-col-del{width: 17px; height: 18px; background-image: url(/thurly/images/fileman/medialib/iconkit.gif); position: absolute; display: none; background-position: 0px -60px; top: 1px; right: 1px; cursor: pointer;}
...
<?
	...
	public static function BuildViewItemDialog($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_view_item'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/thurly/images/1.gif" /></td><td class="ml-diad-title"><?= GetMessage('ML_VIEW_ITEM')?></td><td id="mlsd_viewit_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/thurly/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
			...
			<div id="mlsd_item_cont" class="mlvi-img-cnt"><?/*<img id="mlsd_viewit_img" src="/thurly/images/1.gif" />*/?></div>
		</td></tr>
		<tr><td class="ml-buttons-cell">
	...
	public static function BuildChangeType($Params)
	{
		...
		<td class="ml-title-cell">
			<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('mlsd_change_type'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="ml-iconkit ml-dd-dot" src="/thurly/images/1.gif" /></td><td class="ml-diad-title"><?= GetMessage('ML_CHANGE_TYPE_DIALOG')?></td><td id="mlsd_chtype_close" class="ml-close" title="<?=GetMessage('ML_CLOSE')?>"><img src="/thurly/images/1.gif"></td></tr></table>
		</td></tr>
		<tr><td class="ml-content-cell">
			<table class="mlsd-fields-tbl">
				<tr>
	...
	public static function ShowJS()
	{
		...
		if (!window.jsUtils)
			BX.loadScript('/thurly/js/main/utils.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/main/utils.js')?>');

		if (!window.CHttpRequest && top.CHttpRequest)
			window.CHttpRequest = top.CHttpRequest;
		if (!window.CHttpRequest)
			BX.loadScript('/thurly/js/main/admin_tools.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/main/admin_tools.js')?>');

		if (!window.jsAjaxUtil && top.jsAjaxUtil)
			window.jsAjaxUtil = top.jsAjaxUtil;
		if (!window.jsAjaxUtil)
			BX.loadScript('/thurly/js/main/ajax.js?v=<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/main/ajax.js')?>');
		<?
	}
	...
	public static function GetTypes($arConfigTypes = array(), $bGetEmpties = false)
	{
		...
		if (!self::$bCache || !isset($arMLTypes))
		{
			...
			while($arRes = $res->Fetch())
			{
				...
				$typeIcon = "/thurly/images/fileman/medialib/type_".strtolower($arRes["CODE"]).".gif";
				if (!file_exists($_SERVER['DOCUMENT_ROOT'].$typeIcon))
					$typeIcon = "/thurly/images/fileman/medialib/type_default.gif";
			...
			else if (strpos($item['CONTENT_TYPE'], 'video') !== false || in_array($ext, $videoExt))
			{
				...
				$APPLICATION->IncludeComponent(
					...
					array(
						...
						"FILE_DESCRIPTION" => "",
						//"SKIN_PATH" => "/thurly/components/thurly/player/mediaplayer/skins",
						//"SKIN" => "thurly.swf",
						"WMODE" => "transparent",
