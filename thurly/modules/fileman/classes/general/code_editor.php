...
class CCodeEditor // CE
{
	public static function Show($params)
	{
		...
		$APPLICATION->AddHeadScript('/thurly/js/fileman/code_editor/code-editor.js');
		$APPLICATION->SetAdditionalCSS('/thurly/js/fileman/code_editor/code-editor.css');
		...
		<script>
			...
			BX.ready(function()
			{
				...
				{
					BX.loadScript('/thurly/js/fileman/code_editor/code-editor.js?<?= @filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/fileman/code_editor/code-editor.js')?>', codeEditorLoaded);
					BX.loadCSS('/thurly/js/fileman/code_editor/code-editor.css');
				}
				else
				{
					codeEditorLoaded();
	...
	{
		$langPath = $_SERVER['DOCUMENT_ROOT'].'/thurly/modules/fileman/lang/'.LANGUAGE_ID.'/classes/general/code_editor_js.php';
		if(file_exists($langPath))
			include($langPath);
		else
			$langPath = $_SERVER['DOCUMENT_ROOT'].'/thurly/modules/fileman/lang/en/classes/general/code_editor_js.php';
