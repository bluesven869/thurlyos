...
class AdvertisingBanner extends \CThurlyComponent
{
	...
	public function onPrepareComponentParams($params)
	{
		...
		if ($params['CACHE_TYPE'] == 'Y' || ($params['CACHE_TYPE'] == 'A' && Thurly\Main\Config\Option::get('main', 'component_cache_on', 'Y') == 'Y'))
		{
						...
						if (count($this->arResult['BANNERS']) == 0)
						{
							foreach ($templateProps['PROPS'] as $k => $v)
							{
								...
								$APPLICATION->IncludeComponent(
									'thurly:advertising.banner.view',
									$templateProps['NAME'],
									array(
										'PROPS' => $v,
