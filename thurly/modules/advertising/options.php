...
if ($REQUEST_METHOD=="GET" && $ADV_RIGHT=="W" && strlen($RestoreDefaults)>0 && check_thurly_sessid())
{
...
if($REQUEST_METHOD=="POST" && strlen($Update.$Apply)>0 && $ADV_RIGHT>="W" && check_thurly_sessid())
{
