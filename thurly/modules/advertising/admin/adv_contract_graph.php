			...
			<tr valign="center">
				...
				?>
					...
					if ($arrS["COUNTER_TYPE"]=="DETAIL") :
						echo "[<a href='/thurly/admin/adv_contract_edit.php?ID=".$arrS["ID"]."&lang=".LANGUAGE_ID."&action=view' title='".GetMessage("AD_CONTRACT_VIEW")."'>".$arrS["ID"]."</a>] ".$arrS["NAME"];
					else :
...
<tr>
	<td nowrap valign="top"><span class="required">*</span><?=GetMessage("AD_F_CONTRACTS")?>:<br><img src="/thurly/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td nowrap><?
