...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/advertising/admin/adv_stat_list.php");
include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/advertising/colors.php");
...
if (!function_exists("ImageCreate")) :
	...
	echo BeginNote();
		...
		if ($isAdmin)
			echo "&nbsp;&nbsp;[<a href='/thurly/admin/settings.php?lang=".LANGUAGE_ID."&mid=advertising' title='".GetMessage("AD_SET_EDIT")."'>".GetMessage("AD_EDIT")."</a>]";
	echo EndNote()
	?>	
	<div class="graph">
	<table border="0" cellspacing="2" cellpadding="10" class="graph">
		<tr>
			<td><img src="/thurly/admin/adv_graph.php?<?=GetFilterParams($FilterArr)?>&lang=<?=LANGUAGE_ID?>" width="<?=$width?>" height="<?=$height?>"></td>
		</tr>
		<tr>
			<td>
			<table cellpadding="3" cellspacing="1" border="0" class="list-table">
				...
				<tr valign="center">
					<?if (in_array("visitor", $arShow)):?>
						<td align="center" style="vertical-align:middle;" width="0%"><div style="background-color: <?="#".$arrS["COLOR_VISITOR"]?>"><img src="/thurly/images/1.gif" width="45" height="2" border=0></div></td>
					<?endif;?>
					<?if (in_array("ctr", $arShow)):?>
						<td align="center" style="vertical-align:middle;" width="0%"><div style="background-color: <?="#".$arrS["COLOR_CTR"]?>"><img src="/thurly/images/1.gif" width="45" height="2" border=0></div></td>
					<?endif;?>
					<?if (in_array("show", $arShow)):?>
						<td align="center" style="vertical-align:middle;" width="0%"><div style="background-color: <?="#".$arrS["COLOR_SHOW"]?>"><img src="/thurly/images/1.gif" width="45" height="2" border=0></div></td>
					<?endif;?>
					<?if (in_array("click", $arShow)):?>
						<td align="center" style="vertical-align:middle;" width="0%"><div style="background-color: <?="#".$arrS["COLOR_CLICK"]?>"><img src="/thurly/images/1.gif" width="45" height="2" border=0></div></td>
					<?endif;?>
					<?
					switch ($arrS["TYPE"]) :
						case "GROUP" :
							?>
							<td nowrap width="100%"><img src="/thurly/images/1.gif" width="3" height="1"><?
						...
						case "BANNER" :
							...
							<td nowrap width="100%"><img src="/thurly/images/1.gif" width="3" height="1"><?
								if ($arrS["COUNTER_TYPE"]=="DETAIL") :
									echo '[<a href="/thurly/admin/adv_banner_edit.php?ID='.$arrS["ID"].'&lang='.LANGUAGE_ID.'&action=view" title="'.GetMessage("AD_BANNER_VIEW").'">'.$arrS["ID"].'</a>] '.htmlspecialcharsEx($arrS["NAME"]);
								else :
...
<tr>
	<td nowrap valign="top"><span class="required">*</span><?=GetMessage("AD_F_WHAT_TO_SHOW")?>:<br><img src="/thurly/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td valign="top"><?
		$arr = array(
			"reference" => array(
...
<tr>
	<td nowrap valign="top"><span class="required">*</span><?=GetMessage("AD_F_BANNERS")?>:<br><img src="/thurly/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td valign="top"><?
...
<?if (count($group_ref_id)>0):?>
<tr>
	<td nowrap valign="top"><?=GetMessage("AD_F_GROUPS")?>:<br><img src="/thurly/images/advertising/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td valign="top"><?
