...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	$row->AddViewField("BANNER_COUNT", '<a href="/thurly/admin/adv_banner_list.php?find_type_sid[]='.$f_SID.'&set_filter=Y" title="'.GetMessage("ADV_BANNER_LIST").'">'.$f_BANNER_COUNT.'</a>');
