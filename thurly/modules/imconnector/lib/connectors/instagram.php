...
class Instagram
{
	...
	{
		if(Loader::includeModule('imconnector') && defined('\Thurly\ImConnector\Library::ID_INSTAGRAM_CONNECTOR') && Connector::isConnector(Library::ID_INSTAGRAM_CONNECTOR, true))
		{
		...
		return '\Thurly\ImConnector\Connectors\Instagram::initializeReceiveMessages();';
	}
