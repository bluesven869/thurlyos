...
use \Thurly\ImOpenLines\Network,
	\Thurly\ImOpenLines\LiveChatManager;
...
class Connector
{
	...
	public static function getListConnector($reduced = false, $customConnectors = true)
	{
		...
		// disabled in b24.ua
		if(!Loader::includeModule('thurlyos') || \CThurlyOS::getPortalZone() !== 'ua')
	...
	{
		$components = array(
			'livechat' => 'thurly:imconnector.livechat',
			'viber' => 'thurly:imconnector.viber',
			'telegrambot' => 'thurly:imconnector.telegrambot'
		);

		// disabled in b24.ua
		if(!Loader::includeModule('thurlyos') || \CThurlyOS::getPortalZone() !== 'ua')
			$components["vkgroup"] = 'thurly:imconnector.vkgroup';

		$components = array_merge($components, array(
			'facebook' => 'thurly:imconnector.facebook',
			'facebookcomments' => 'thurly:imconnector.facebookcomments',
			'instagram' => 'thurly:imconnector.instagram',
			'network' => 'thurly:imconnector.network',
			'botframework' => 'thurly:imconnector.botframework',
		));
