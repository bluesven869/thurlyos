...
use \Thurly\ImConnector\Output,
	\Thurly\ImConnector\Status,
	\Thurly\ImConnector\Library,
	\Thurly\ImConnector\Connector;

class ImConnectorTelegrambot extends CThurlyComponent
{
	private $cacheId;
	...
	public function constructionForm()
	{
		...
		$this->arResult["URL"]["INDEX"] = $APPLICATION->GetCurPageParam($this->pageId . "=index", array($this->pageId, "open_block"));
		$this->arResult["URL"]["MASTER"] = $APPLICATION->GetCurPageParam($this->pageId . "=master", array($this->pageId, "open_block"));
		$this->arResult["URL"]["MASTER_NEW"] = $APPLICATION->GetCurPageParam($this->pageId . "=master_new", array($this->pageId, "open_block"));
