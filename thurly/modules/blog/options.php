...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/blog/options.php");

CModule::IncludeModule('blog');

if ($REQUEST_METHOD=="GET" && strlen($RestoreDefaults)>0 && $BLOG_RIGHT=="W" && check_thurly_sessid())
{
...
$strWarning = "";
if ($REQUEST_METHOD=="POST" && strlen($Update)>0 && $BLOG_RIGHT=="W" && check_thurly_sessid() && strlen($use_sonnet_button) <= 0)
{
