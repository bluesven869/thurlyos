...
{      
	$row =& $lAdmin->AddRow($f_ID, $arBlog, "/thurly/admin/blog_blog_edit.php?ID=".$f_ID."&lang=".LANGUAGE_ID, GetMessage("BLB_UPDATE_ALT"));

	$row->AddField("ID", '<a href="/thurly/admin/blog_blog_edit.php?ID='.$f_ID.'&lang='.LANGUAGE_ID.'" title="'.GetMessage("BLB_UPDATE_ALT").'">'.$f_ID.'</a>');
	...
	if(IntVal($f_OWNER_ID) > 0)
		$row->AddField("OWNER_INFO", "<a href=\"/thurly/admin/user_edit.php?ID=".$f_OWNER_ID."&lang=".LANG."\">[".$f_OWNER_ID."] ".$f_OWNER_NAME." ".$f_OWNER_LAST_NAME." (".$f_OWNER_LOGIN.")</a>");
	...
	$row->AddField("GROUP_ID", "<a href=\"/thurly/admin/blog_group_edit.php?ID=".$f_GROUP_ID."&lang=".LANG."\">[".$f_GROUP_SITE_ID."] ".$f_GROUP_NAME."</a>");
