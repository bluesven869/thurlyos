		...
		if ($postId > 0)
		{
			...
			else
			{
				...
				if ($fields = $res->fetch())
				{
					...
					if ($postFields['DATE_CREATE'] instanceof \Thurly\Main\Type\DateTime)
					{
						$postFields['DATE_CREATE'] = $postFields['DATE_CREATE']->toString();
					}
					if ($postFields['DATE_PUBLISH'] instanceof \Thurly\Main\Type\DateTime)
					{
