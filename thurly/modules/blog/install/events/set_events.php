...
{
	$lid = $lang["LID"];
	IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/blog/install/events.php", $lid);
	...
	if(count($arSites) > 0)
	{
		...
		$emess->Add(array(
			...
			"EMAIL_TO" => "#EMAIL_TO#",
			"SUBJECT" => "#POST_TITLE#",
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:socialnetwork.blog.post.mail\",\"\",Array(\"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"RECIPIENT_ID\" => \"{#RECIPIENT_ID#}\",\"POST_ID\" => \"{#POST_ID#}\",\"URL\" => \"{#URL#}\"));?>",
			"BODY_TYPE" => "html",
		...
		$emess->Add(array(
			...
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:socialnetwork.blog.post.comment.mail\",\"\",Array(\"COMMENT_ID\" => \"{#COMMENT_ID#}\",\"RECIPIENT_ID\" => \"{#RECIPIENT_ID#}\",\"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"POST_ID\" => \"{#POST_ID#}\",\"URL\" => \"{#URL#}\"));?>",
			"BODY_TYPE" => "html",
			"SITE_TEMPLATE_ID" => "mail_user"
		));
		...
		$emess->Add(array(
			...
			"EMAIL_TO" => "#EMAIL_TO#",
			"SUBJECT" => "#POST_TITLE#",
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:socialnetwork.blog.post_share.mail\",\"\",Array(\"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"RECIPIENT_ID\" => \"{#RECIPIENT_ID#}\",\"POST_ID\" => \"{#POST_ID#}\",\"URL\" => \"{#URL#}\"));?>",
			"BODY_TYPE" => "html",
			"SITE_TEMPLATE_ID" => "mail_user"
		));
