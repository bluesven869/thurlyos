...
if (!$this->__component->__parent || empty($this->__component->__parent->__name) || $this->__component->__parent->__name != "thurly:blog"):
	...
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/blog/templates/.default/styles/additional.css');
endif;
?>
		...
		<div class="blog-post-field blog-post-field-category blog-edit-field blog-edit-field-tags">
			...
			<span><?
					if(IsModuleInstalled("search"))
					{
						...
						$APPLICATION->IncludeComponent("thurly:search.tags.input", ".default", $arSParams);
					}
					else
					{
