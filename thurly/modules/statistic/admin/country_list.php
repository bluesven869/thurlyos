...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/statistic/prolog.php");
...
<?if($found):?>
	...
	<table border="0" cellspacing="1" cellpadding="0" align="center">
		<tr>
			<td valign="center">
				<img src="/thurly/admin/country_graph.php?find_data_type=<?=$find_data_type?><?=GetFilterParams($FilterArr)?>&width=<?=$width?>&height=<?=$height?>&lang=<? echo LANG?>" width="<?=$width?>" height="<?=$height?>"></td>
			</td>
		</tr>
	</table>
	</div>
...
<table cellspacing=0 cellpadding=10 class="graph" align="center">
	<tr>
		<td valign="center"><img src="/thurly/admin/country_diagram.php?<?=GetFilterParams($FilterArr)?>&lang=<?=LANG?>&find_data_type=<?=$find_data_type?>" width="<?=$diameter?>" height="<?=$diameter?>"></td>
		<td valign="center">
			<table cellpadding=2 cellspacing=0 border=0 class="legend">
				...
				<tr>
					...
					?><a href="/thurly/admin/session_list.php?lang=<?=LANGUAGE_ID?>&amp;find_country_id=<?echo urlencode($id)?>&amp;find_country_id_exact_match=Y&amp;find_date1=<?echo urlencode($arFilter["DATE1"])?>&amp;find_date2=<?echo urlencode($arFilter["DATE2"])?>&amp;set_filter=Y"><?=$counter?></a><?
					elseif ($find_data_type=="NEW_GUESTS") :
					?><a href="/thurly/admin/guest_list.php?lang=<?=LANGUAGE_ID?>&amp;find_country_id=<?echo urlencode($id)?>&amp;find_country_id_exact_match=Y&amp;find_sess2=1&amp;find_period_date1=<?echo urlencode($arFilter["DATE1"])?>&amp;find_period_date2=<?echo urlencode($arFilter["DATE2"])?>&amp;set_filter=Y"><?=$counter?></a><?
					elseif ($find_data_type=="HITS") :
					?><a href="/thurly/admin/hit_list.php?lang=<?=LANGUAGE_ID?>&amp;find_country_id=<?echo urlencode($id)?>&amp;find_country_id_exact_match=Y&amp;find_date1=<?echo urlencode($arFilter["DATE1"])?>&amp;find_date2=<?echo urlencode($arFilter["DATE2"])?>&amp;set_filter=Y"><?=$counter?></a><?
					elseif ($find_data_type=="C_EVENTS") :
					?><a href="/thurly/admin/event_list.php?lang=<?=LANGUAGE_ID?>&amp;find_country_id=<?echo urlencode($id)?>&amp;find_country_id_exact_match=Y&amp;find_date1=<?echo urlencode($arFilter["DATE1"])?>&amp;find_date2=<?echo urlencode($arFilter["DATE2"])?>&amp;set_filter=Y"><?=$counter?></a><?
					endif;
					?>)</td>
					<td class="number" nowrap><?
					$flag = "/thurly/images/statistic/flags/".strtolower($id).".gif";
...
<table cellspacing=0 cellpadding=10 class="graph" align="center">
	<tr>
		<td valign="center"><img src="/thurly/admin/country_diagram.php?<?=GetFilterParams($FilterArr)?>&lang=<?=LANGUAGE_ID?>&find_data_type=<?=$find_data_type?>&diagram_type=TOTAL" width="<?=$diameter?>" height="<?=$diameter?>"></td>
		<td valign="center">
			<table cellpadding=2 cellspacing=0 border=0 class="legend">
				<?
				...
				<tr>
					...
					<td  nowrap>(<?
					if ($find_data_type=="SESSIONS") :
					?><a href="/thurly/admin/session_list.php?lang=<?=LANGUAGE_ID?>&find_country_id=<?echo urlencode($id)?>&find_country_id_exact_match=Y&set_filter=Y"><?=$counter?></a><?
					elseif ($find_data_type=="NEW_GUESTS") :
					?><a href="/thurly/admin/guest_list.php?lang=<?=LANGUAGE_ID?>&find_country_id=<?echo urlencode($id)?>&find_country_id_exact_match=Y&find_sess2=1&set_filter=Y"><?=$counter?></a><?
					elseif ($find_data_type=="HITS") :
					?><a href="/thurly/admin/hit_list.php?lang=<?=LANGUAGE_ID?>&find_country_id=<?echo urlencode($id)?>&find_country_id_exact_match=Y&set_filter=Y"><?=$counter?></a><?
					elseif ($find_data_type=="C_EVENTS") :
					?><a href="/thurly/admin/event_list.php?lang=<?=LANGUAGE_ID?>&find_country_id=<?echo urlencode($id)?>&find_country_id_exact_match=Y&set_filter=Y"><?=$counter?></a><?
					endif;
					?>)</td>
					<td class="number" nowrap><?
					$flag = "/thurly/images/statistic/flags/".strtolower($id).".gif";
...
?>
<tr valign="top">
	<td valign="top"><?echo GetMessage("STAT_F_COUNTRY_ID")?>:<br><img src="/thurly/images/statistic/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td><?
