...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	$arActions[] = array(
		...
		"ACTION"=>$lAdmin->ActionRedirect("/thurly/admin/adv_analysis.php?find_data_type=EVENT_SUMMA&find_events[]=".$f_ID."&set_filter=Y")
	);
...
$aContext[] =
	array(
		...
		"LINK"=>"/thurly/admin/event_diagram_list.php?lang=".LANGUAGE_ID."&set_default=Y",
		"TITLE"=>GetMessage("STAT_DIAGRAM"),
	);
$aContext[] =
	array(
		"TEXT"=>GetMessage("STAT_GRAPH_FULL_S"),
		"LINK"=>"/thurly/admin/event_graph_list.php?lang=".LANGUAGE_ID."&set_default=Y",
