...
if (strlen($find_adv_str)>0) :
	...
	echo "<img src=\"/thurly/images/1.gif\" width=\"1\" height=\"5\" border=\"0\" alt=\"\"><br>(".$arr[$find_adv_data_type].")<br></p>";
endif;
$s = "";
...
if (strlen($site_id)>0)
	$show_site_id = "[<a target=\"_blank\" href=\"".htmlspecialcharsbx("/thurly/admin/site_edit.php?LID=".urlencode($site_id)."&lang=".LANGUAGE_ID)."\">".htmlspecialcharsbx($site_id)."</a>]&nbsp;";
else
	$show_site_id = "";
?>
