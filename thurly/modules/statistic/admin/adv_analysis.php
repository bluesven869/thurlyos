...
<td valign="center" class="graph"><?
	...
	?><img class="graph" src="/thurly/admin/adv_analysis_graph.php?rand=<?=rand()?>&find_data_type=<?=$find_data_type?><?=GetFilterParams($FilterArr)?>&width=<?=$width?>&height=<?=$height?>&lang=<?=LANGUAGE_ID?>" width="<?=$width?>" height="<?=$height?>">
</td>
</tr>
</table>
</div>
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddViewField("COLOR", "&nbsp;<img src=\"/thurly/admin/graph_legend.php?color=".$f_CLR."\" width=\"45\" height=\"2\">&nbsp;");
	$row->AddViewField("ADV", "[<a href=\"/thurly/admin/adv_list.php?lang=".LANG."&amp;find_id=".$f_ID."&amp;find_id_exact_match=Y&amp;set_filter=Y\">".$f_ID."</a>]&nbsp;".$f_R1."&nbsp;/&nbsp;".$f_R2);
	$row->AddViewField("PERCENT", $q."%");
	$row->AddViewField("COUNTER", "<a href=\"/thurly/admin/adv_dynamic_list.php?lang=".LANG."&amp;find_adv_id=".$f_ID."&amp;find_adv_id_exact_match=Y&amp;find_date1=".urlencode($find_date1)."&amp;find_date2=".urlencode($find_date2)."&amp;set_filter=Y\">".$f_SM."</a>");
}
...
<tr valign="top">
	<td width="0%" nowrap valign="top"><?
		echo GetMessage("STAT_F_SELECT_ADV")?>:<br><img src="/thurly/images/statistic/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td width="100%" nowrap><?
