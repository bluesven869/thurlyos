...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if (strlen($f_FIRST_SITE_ID)>0):
		$str .= "[<a title=\"".GetMessage("STAT_SITE")."\" href=\"/thurly/admin/site_edit.php?LID=".$f_FIRST_SITE_ID."&lang=".LANGUAGE_ID."\">".$f_FIRST_SITE_ID."</a>]&nbsp;";
	endif;
	...
	if (strlen($f_LAST_SITE_ID)>0):
		$str .= '[<a title="'.GetMessage("STAT_SITE").'" href="/thurly/admin/site_edit.php?LID='.$f_LAST_SITE_ID.'&lang='.LANGUAGE_ID.'">'.$f_LAST_SITE_ID.'</a>]&nbsp;';
	endif;
