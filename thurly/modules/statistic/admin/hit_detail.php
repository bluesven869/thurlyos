...
<table cellspacing="0" cellpadding="0" border="0" class="internal">
	...
	<tr>
		...
		<td><?if (strlen($f_SITE_ID)>0):?>[<a title="<?=GetMessage("STAT_SITE")?>" href="/thurly/admin/site_edit.php?LID=<?=$f_SITE_ID?>&amp;lang=<?=LANGUAGE_ID?>"><?=$f_SITE_ID?></a>]&nbsp;<?endif;?><?echo StatAdminListFormatURL($arRes["URL"], array(
			"new_window" => true,
