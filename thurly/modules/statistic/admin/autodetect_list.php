...
if($STAT_RIGHT >= "W" && check_thurly_sessid())
{
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddViewField("COUNTER","<a title=\"".GetMessage("STAT_SESS_LIST")."\" href=\"/thurly/admin/session_list.php?lang=".LANGUAGE_ID."&find_user_agent=".urlencode("\"".str_replace(array("\\", "\'", "\""), "_", $f_USER_AGENT)."\"")."&set_filter=Y\">$f_COUNTER</a>");
