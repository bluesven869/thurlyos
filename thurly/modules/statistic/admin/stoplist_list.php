...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if (strlen($f_SITE_ID)>0) :
		$row->AddViewField("SITE_ID", '<a href="/thurly/admin/site_edit.php?LID='.$f_SITE_ID.'&lang='.LANGUAGE_ID.'">'.$f_SITE_ID.'</a>');
...
<tr valign="top">
	<td valign="top"><?=GetMessage("STAT_F_SITE")?>:<br><img src="/thurly/images/statistic/mouse.gif" width="44" height="21" border=0 alt=""></td>
	<td><?
	$ref = array();
	$ref_id = array();
