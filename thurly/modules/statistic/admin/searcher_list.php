...
if(($arID = $lAdmin->GroupAction()) && $STAT_RIGHT=="W" && check_thurly_sessid())
{
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if ($STAT_RIGHT>="W")
		$arActions[] = array("ICON"=>"delete", "TITLE"=>GetMessage("STAT_DELETE_SEARCHER"), "ACTION"=>"javascript:if(confirm('".GetMessageJS("STAT_CONFIRM")."')) window.location='?lang=".LANGUAGE_ID."&action=delete&ID=$f_ID&".thurly_sessid_get()."'", "TEXT"=>GetMessage("STAT_DELETE"));
