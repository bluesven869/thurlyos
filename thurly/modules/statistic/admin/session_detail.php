...
<table cellspacing="0" cellpadding="0" border="0" class="internal">
	...
	<tr>
		...
		<td><?if (strlen($f_FIRST_SITE_ID)>0):?>[<a title="<?=GetMessage("STAT_SITE")?>" href="/thurly/admin/site_edit.php?LID=<?=$f_FIRST_SITE_ID?>&lang=<?=LANGUAGE_ID?>"><?=$f_FIRST_SITE_ID?></a>]&nbsp;<?endif;?>&nbsp;<?echo StatAdminListFormatURL($arRes["URL_TO"], array(
			"new_window" => true,
	...
	<tr>
		...
		<td><?if (strlen($f_LAST_SITE_ID)>0):?>[<a title="<?=GetMessage("STAT_SITE")?>" href="/thurly/admin/site_edit.php?LID=<?=$f_LAST_SITE_ID?>&lang=<?=LANGUAGE_ID?>"><?=$f_LAST_SITE_ID?></a>]&nbsp;<?endif;?>&nbsp;<?echo StatAdminListFormatURL($arRes["URL_LAST"], array(
			"new_window" => true,
