...
elseif (!$message)
{
	...
	if (strlen($s)>0)
	{
		...
		?>
		<?if($context=="tab"):?>
		<a href="/thurly/admin/adv_dynamic_list.php?lang=<?=LANG?>&amp;find_adv_id=<?=$ADV_ID?>&amp;set_default=Y"><?=GetMessage("STAT_ALL_DYNAMICS")?></a><br>
		<a href="/thurly/admin/adv_graph_list.php?lang=<?=LANG?>&amp;ADV_ID=<?=$ADV_ID?>"><?=GetMessage("STAT_ALL_GRAPHICS")?></a><br>
		<?endif;?>
		<div class="graph">
			...
			<td valign="center">
				<table cellpadding="3" cellspacing="1" border="0" class="legend">
					...
					<tr>
						...
						<td><img src="/thurly/admin/graph_legend.php?color=<?=$arrColor["HITS"]?>&dash=Y" width="45" height="2"></td>
						<td  nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("STAT_HITS")?></td>
					</tr>
					<?endif;?>
					...
					<tr>
						...
						<td valign="center"><img src="/thurly/admin/graph_legend.php?color=<?=$arrColor["SESSIONS"]?>&dash=Y" width="45" height="2"></td>
						<td  nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("STAT_SESSIONS")?></td>
					</tr>
					<?endif;?>
					...
					<tr>
						...
						<td><img src="/thurly/admin/graph_legend.php?color=<?=$arrColor["GUESTS"]?>&dash=Y" width="45" height="2"></td>
						<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("STAT_GUESTS")?></td>
					</tr>
					<?endif;?>
					...
					<tr>
						...
						<td><img src="/thurly/admin/graph_legend.php?color=<?=$arrColor["HOSTS"]?>&dash=Y" width="45" height="2"></td>
						<td  nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("STAT_HOSTS")?></td>
					</tr>
					<?endif;?>
					<?if ($find_new_guests=="Y"):?>
					<tr>
						...
						<td></td>
						<td  nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("STAT_NEW_GUESTS")?></td>
					</tr>
					<?endif;?>
				</table>
			</td>
			...
			<table cellspacing="0" cellpadding="0" class="graph" border="0" align="center"><tr>
				...
				<td valign="center">
					<table cellpadding="3" cellspacing="1" border="0" class="legend">
						...
						?>
						<tr>
							<td valign="center"><img src="/thurly/admin/graph_legend.php?color=<?=$color?>" width="45" height="2"></td>
							<td valign="center"><img src="/thurly/admin/graph_legend.php?color=<?=$color?>&dash=Y" width="45" height="2"></td>
							<td  nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?
							$events = CStatEventType::GetByID($eid);
							$arEvent = $events->GetNext();
							echo "[<a href=\"/thurly/admin/event_type_list.php?lang=".LANG."\">".$arEvent["ID"]."</a>] ".$arEvent["EVENT"];
							?></td>
						</tr>
						<?}?>
					</table>
...
$aContext = array(
	array(
		...
		"ICON" => "btn_list",
		"LINK" => "/thurly/admin/adv_list.php?lang=".LANG,
	),
);
...
if (!$message)
{
	$aContext[] = array(
		...
		//"ICON" => "btn_list",
		"LINK" =>"/thurly/admin/adv_dynamic_list.php?lang=".LANG."&find_adv_id=".$ADV_ID."&find_date1=".urlencode($arFilter["DATE1"])."&find_date2=".urlencode($arFilter["DATE2"])."&set_filter=Y",
	);
}
