...
if($_REQUEST["table_id"] == "adv"):
	...
	<tr>
		...
		<th><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/session_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_date1' => $now_date,
				'find_date2' => $now_date,
				'find_adv_back' => 'N',
	...
	while ($arAdv = $rsAdv->GetNext()):
		?><tr>
			<td>[<a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/adv_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_id' => $arAdv["ID"],
			...
			<td align="right"><?
				if (intval($arAdv["SESSIONS_TODAY"]) > 0):
					?><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/session_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
...
elseif($_REQUEST["table_id"] == "event"):
	...
	<tr>
		...
		<th><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/event_list.php", array(
			'lang' => $_REQUEST["lang"],
			'find_date1' => $now_date,
			'find_date2' => $now_date,
			'set_filter' => 'Y',
		...
		?><tr>
			<td><?
				...
				if ($dynamic_days >= 2 && function_exists("ImageCreate")):?>
					<a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/event_graph_list.php", array(
						'lang' => $_REQUEST["lang"],
			...
			<td align="right"><?
				if (intval($arEvent["TODAY_COUNTER"]) > 0):
					?><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/event_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
...
elseif($_REQUEST["table_id"] == "referer"):
	...
	<tr>
		...
		<th><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/referer_list.php", array(
			'lang' => $_REQUEST["lang"],
	...
	while ($arReferer = $rsReferers->GetNext()):
		?><tr>
			<td><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/referer_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_site_id' => $_REQUEST["site_id"],
			...
			<td align="center">
				<?if(intval($arReferer["TODAY_REFERERS"]) > 0):?>
					<a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/referer_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
...
elseif($_REQUEST["table_id"] == "phrase"):
	...
	<tr>
		...
		<th><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/phrase_list.php", array(
			'lang' => $_REQUEST["lang"],
			'find_site_id' => $_REQUEST["site_id"],
			'find_date1' => $now_date,
			'find_date2' => $now_date,
	...
	while ($arPhrase = $rsPhrases->Fetch()):
		?><tr>
			<td><a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/phrase_list.php", array(
				'lang' => $_REQUEST["lang"],
				'find_site_id' => $_REQUEST["site_id"],
			...
			<td align="center">
				<?if(intval($arReferer["TODAY_PHRASES"]) > 0):?>
					<a href="<?echo htmlspecialcharsbx(CHTTP::urlAddParams("/thurly/admin/phrase_list.php", array(
						'lang' => $_REQUEST["lang"],
						'find_site_id' => $_REQUEST["site_id"],
						'find_date1' => $now_date,
						'find_date2' => $now_date,
