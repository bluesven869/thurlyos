...
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (192,'N','ThurlySM','ThurlySM','N','Y');
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (193,'N','ThurlySiteLoader','ThurlySiteLoader','N','Y');
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (194,'N','Thurly: Sitemanager Updater','ThurlySMUpdater','N','Y');
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (195,'N','Thurly: Sitemanager RSS','ThurlySMRSS','N','Y');
...
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (216,'N','ThurlyControllerMember','ThurlyControllerMember','N','Y');
insert into b_stat_searcher (ID,SAVE_STATISTIC,NAME,USER_AGENT,DIAGRAM_DEFAULT,CHECK_ACTIVITY) values (217,'N','ThurlyCloud','ThurlyCloud','N','N');
