...
/*.
	...
	require_module 'thurly_main';
	require_module 'thurly_statistic_include';
.*/
...
class CCity
{
	...
	*/
	...
	public static function FindFiles($type = 'country', $path = '/thurly/modules/statistic/ip2country')
	{
		$arFiles = array();
