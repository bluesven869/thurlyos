...
//	ClearVars();
	if(!check_thurly_sessid() || !CModule::IncludeModule("iblock"))
		return;
	...
	else
	{
		?>
		<script>
		window.location='/thurly/admin/module_admin.php?step=3&lang=<?=LANGUAGE_ID."&id=wiki&install=y&".thurly_sessid_get()?>';
		</script>
		<?
	}
