...
if(CModule::IncludeModule('fileman')):
	...
	function CustomizeLightEditorForWiki()
	{
		...
		window.LHEButtons['Category'] = {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/category.gif',
			id : 'Category',
		...
		window.LHEButtons['ImageUpload'] = {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/image.gif',
			id : 'ImageUpload',
		...
		window.LHEButtons['ImageLink'] = {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/image_upload.gif',
			id : 'ImageLink',
		...
		window.LHEButtons['Signature']	= {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/signature.gif',
			id : 'Signature',
		...
		window.LHEButtons['intenalLink'] = {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/link.gif',
			id : 'intenalLink',
		...
		window.LHEButtons['externalLink'] = {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/external_link.gif',
			id : 'externalLink',
		...
		window.LHEButtons['nowiki'] = {
			src : '/thurly/components/thurly/wiki.edit/templates/.default/images/wcode/nowiki.gif',
			id : 'nowiki',
