...
global $MESS;
include(GetLangFileName($GLOBALS['DOCUMENT_ROOT'].'/thurly/modules/wiki/lang/', '/options.php'));
...
function RestoreDefaults()
{
	if(confirm('<?echo AddSlashes(GetMessage('MAIN_HINT_RESTORE_DEFAULTS_WARNING'))?>'))
		window.location = "<?echo $APPLICATION->GetCurPage()?>?RestoreDefaults=Y&lang=<?echo LANG?>&mid=<?echo rawurlencode($mid)."&".thurly_sessid_get();?>";
}
</script>
