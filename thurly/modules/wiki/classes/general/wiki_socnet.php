...
class CWikiSocnet
{
	...
	static function OnParseSocNetComponentPath(&$arUrlTemplates, &$arCustomPagesPath, $arParams)
	{
		...
		if(!$base_path)
		{
			if(file_exists($_SERVER['DOCUMENT_ROOT'].'/thurly/php_interface/wiki/'.SITE_ID.'/group_index.php'))
				$base_path = '/thurly/php_interface/wiki/'.SITE_ID.'/';
			elseif(file_exists($_SERVER['DOCUMENT_ROOT'].'/thurly/php_interface/wiki/group_index.php'))
				$base_path = '/thurly/php_interface/wiki/';
			else
				$base_path = '/thurly/modules/wiki/socnet/';
		}
	...
	{
		$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/themes/.default/wiki_sonet_log.css');
		...
		$arResult = array(
			...
			"CACHED_CSS_PATH" => array("/thurly/themes/.default/wiki_sonet_log.css")
		);
		...
		else
		{
			...
			{
				$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/wiki.show/templates/.default/style.css');
				$arResult["CACHED_CSS_PATH"][] = "/thurly/components/thurly/wiki.show/templates/.default/style.css";
