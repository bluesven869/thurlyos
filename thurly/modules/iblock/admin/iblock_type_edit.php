...
if($back_url=='')
	$back_url = '/thurly/admin/iblock_type_admin.php?lang='.$lang;
...
if(strlen($ID)>0)
{
	...
	$aMenu[] = array(
		...
		"LINK" => "javascript:if(confirm('".GetMessageJS("IBTYPE_E_DEL_CONF")."')) window.location='/thurly/admin/iblock_type_admin.php?ID=".$ID."&action=delete&lang=".LANGUAGE_ID."&".thurly_sessid_get()."';",
		"ICON" => "btn_delete"
		);
}
