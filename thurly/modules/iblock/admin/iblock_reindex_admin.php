...
if ($usePageNavigation)
{
	$countQuery = new Main\Entity\Query(\Thurly\Iblock\IblockTable::getEntity());
...
$rsIBlocks = new CAdminResult(\Thurly\Iblock\IblockTable::getList($getListParams), $sTableID);
if ($usePageNavigation)
{
