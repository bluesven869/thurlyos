...
class CIBlockSectionPropertyLink
{
		...
		if ($sectionProperty)
		{
			...
			if (is_array($ar))
			{
				...
				if (strlen($strUpdate) > 0)
				{
					...
					{
						\Thurly\Iblock\PropertyIndex\Manager::markAsInvalid($arUpdate["IBLOCK_ID"]? $arUpdate["IBLOCK_ID"]: $ar["IBLOCK_ID"]);
					}
				}
			}
		}
	...
	public static function DeleteByIBlock($IBLOCK_ID)
	{
		...
		\Thurly\Iblock\PropertyIndex\Manager::deleteIndex($IBLOCK_ID);
