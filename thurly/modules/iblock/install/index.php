...
class iblock extends CModule
{
	...
	function InstallDB()
	{
		...
		{
			$this->errors = $DB->RunSQLBatch($_SERVER['DOCUMENT_ROOT']."/thurly/modules/iblock/install/db/".$DBType."/install.sql");
		}
		...
		RegisterModuleDependences("sender", "OnConnectorList", "iblock", "\\Thurly\\Iblock\\SenderEventHandler", "onConnectorListIblock");
	...
	function UnInstallDB($arParams = array())
	{
		...
		if(!array_key_exists("savedata", $arParams) || ($arParams["savedata"] != "Y"))
		{
			...
			$this->errors = $DB->RunSQLBatch($_SERVER['DOCUMENT_ROOT']."/thurly/modules/iblock/install/db/".$DBType."/uninstall.sql");
		...
		UnRegisterModuleDependences("sender", "OnConnectorList", "iblock", "\\Thurly\\Iblock\\SenderEventHandler", "onConnectorListIblock");
	...
	function InstallFiles()
	{
		...
		{
			CopyDirFiles($_SERVER['DOCUMENT_ROOT'].'/thurly/modules/iblock/install/admin', $_SERVER['DOCUMENT_ROOT']."/thurly/admin");
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/js", $_SERVER["DOCUMENT_ROOT"]."/thurly/js/", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/images", $_SERVER["DOCUMENT_ROOT"]."/thurly/images/iblock", true, true);
			if(file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/public/rss.php"))
				@copy($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/public/rss.php", $_SERVER["DOCUMENT_ROOT"]."/thurly/rss.php");
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/themes", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/components", $_SERVER["DOCUMENT_ROOT"]."/thurly/components", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/gadgets", $_SERVER["DOCUMENT_ROOT"]."/thurly/gadgets", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/panel", $_SERVER["DOCUMENT_ROOT"]."/thurly/panel", true, true);
		}
		return true;
	}
	...
	function UnInstallFiles()
	{
		if($_ENV["COMPUTERNAME"]!='BX')
		{
			DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
			DeleteDirFilesEx("/thurly/images/iblock/");//images
			DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/public/", $_SERVER["DOCUMENT_ROOT"]."/thurly/");
			DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/themes/.default/", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes/.default");//css
			DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/panel/iblock/", $_SERVER["DOCUMENT_ROOT"]."/thurly/panel/iblock/");//css sku
			DeleteDirFilesEx("/thurly/themes/.default/icons/iblock/");//icons
			DeleteDirFilesEx("/thurly/js/iblock/");//javascript
		}
		return true;
	}
	...
	function DoInstall()
	{
		...
		$step = IntVal($step);
		if($step<2)
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/step1.php");
		elseif($step==2)
		{
			if($this->InstallDB())
			{
			...
			$obModule = $this;
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/step2.php");
		}
	}
	...
	function DoUninstall()
	{
		...
		$step = IntVal($step);
		if($step<2)
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/unstep1.php");
		elseif($step==2)
		{
			...
			$this->UnInstallFiles();
			$obModule = $this;
			$APPLICATION->IncludeAdminFile(GetMessage("IBLOCK_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/install/unstep2.php");
		}
	}
