...
JCIBlockProperty.prototype.ShowPropertyDialog = function ()
{
	...
	if (!!target && target.hasAttribute('data-propid'))
	{
		...
		(new BX.CAdminDialog({
			'title': this.TITLE,
			'content_url': '/thurly/admin/iblock_edit_property.php?lang='+this.LANG+'&propedit='+ID+'&bxpublic=Y&receiver='+this.OBJNAME,
...
JCIBlockGroupField.prototype.preparePost = function()
{
	...
	values[values.length] = {name : 'sessid', value : BX.thurly_sessid()};
