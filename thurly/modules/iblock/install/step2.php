...
include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/include.php");
...
if($obModule->errors===false)
{
	if(($news == "Y") && CheckIBlockType("news", "N"))
	{
		...
		while($site = $sites->Fetch())
		{
			...
			{
				$source = $_SERVER['DOCUMENT_ROOT']."/thurly/modules/iblock/install/public/news/";
	...
	if(($catalog == "Y") && CheckIBlockType("catalog", "Y"))
	{
		...
		while($site = $sites->Fetch())
		{
			...
			{
				$source = $_SERVER['DOCUMENT_ROOT']."/thurly/modules/iblock/install/public/catalog/";
