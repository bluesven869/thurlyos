...
if ($ElementID > 0)
{
	...
	{
		?><?$APPLICATION->IncludeComponent("thurly:catalog.store.amount", ".default", array(
	...
	if (!empty($arRecomData))
	{
		...
		{
			?><?$APPLICATION->IncludeComponent("thurly:catalog.bigdata.products", "", array(
		...
		if (($arRecomData['IBLOCK_LINK'] != '' || $arRecomData['ALL_LINK'] != ''))
		{
			...
			$APPLICATION->IncludeComponent(
				"thurly:catalog.recommended.products",
				"",
				array(
	...
	{
		?><?$APPLICATION->IncludeComponent("thurly:sale.recommended.products", ".default", array(
			"ID" => $ElementID,
			"TEMPLATE_THEME" => (isset($arParams['TEMPLATE_THEME']) ? $arParams['TEMPLATE_THEME'] : ''),
