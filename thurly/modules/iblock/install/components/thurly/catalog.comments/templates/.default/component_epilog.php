...
if (isset($templateData['BLOG_USE']) && $templateData['BLOG_USE'] == 'Y')
{
	...
	else
	{
		...
		$APPLICATION->SetAdditionalCSS('/thurly/components/thurly/blog/templates/.default/style.css');
		$APPLICATION->SetAdditionalCSS('/thurly/components/thurly/blog/templates/.default/themes/green/style.css');
