...
//include js
$APPLICATION->AddHeadString('<script type="text/javascript" src="/thurly/components/thurly/player/wmvplayer/silverlight.js?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/player/wmvplayer/silverlight.js').'"></script>', true);
$APPLICATION->AddHeadString('<script type="text/javascript" src="/thurly/components/thurly/player/wmvplayer/wmvplayer.js?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/player/wmvplayer/wmvplayer.js').'"></script>', true);
$APPLICATION->AddHeadString('<script type="text/javascript" src="/thurly/components/thurly/player/mediaplayer/flvscript.js?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/player/mediaplayer/flvscript.js').'"></script>', true);
CUtil::InitJSCore();
