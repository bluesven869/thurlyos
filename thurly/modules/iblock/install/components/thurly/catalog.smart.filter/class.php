...
CThurlyComponent::includeComponentClass("thurly::news.base");
class CThurlyCatalogSmartFilter extends CThurlyNewsBase
*/
class CThurlyCatalogSmartFilter extends CThurlyComponent
{
	public $IBLOCK_ID = 0;
	...
	/** @var \Thurly\Iblock\PropertyIndex\Facet **/
	...
	public function executeComponent()
	{
		...
		{
			$currencyList = \Thurly\Currency\CurrencyTable::getList(array(
		...
		$this->facet = new \Thurly\Iblock\PropertyIndex\Facet($this->IBLOCK_ID);
	...
	public function fillItemValues(&$resultItem, $arProperty, $flag = null)
	{
		...
		{
			$error = "";
			$utf_id = \Thurly\Main\Text\Encoding::convertEncoding($url_id, LANG_CHARSET, "utf-8", $error);
	...
	*/
	...
	{
		$error = "";
		$searchValue = \Thurly\Main\Text\Encoding::convertEncoding($lookupValue, LANG_CHARSET, "utf-8", $error);
		if (!$error)
		{
