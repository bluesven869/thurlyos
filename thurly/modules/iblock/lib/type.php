 ...
 * <li> LANG_MESSAGE reference to {@link \Thurly\Iblock\TypeLanguageTable}
 * </ul>
 *
...
class TypeTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'LANG_MESSAGE' => array(
				'data_type' => 'Thurly\Iblock\TypeLanguage',
	 ...
	 *
	 * @param \Thurly\Main\Entity\Event $event Contains information about iblock type being deleted.
	 *
	 * @return \Thurly\Main\Entity\EventResult
	 */
	public static function onDelete(\Thurly\Main\Entity\Event $event)
	{
