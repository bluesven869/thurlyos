...
abstract class BaseValues
{
	 ...
	 *
	 * @return \Thurly\Iblock\InheritedProperty\BaseValues|null
	 */
	...
	public function queryValues()
	{
		...
		{
			$templates[$CODE]["VALUE"] = \Thurly\Iblock\Template\Engine::process($this->createTemplateEntity(), $row["TEMPLATE"]);
		}
		return $templates;
	}
