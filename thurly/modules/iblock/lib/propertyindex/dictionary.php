...
class Dictionary
{
	 ...
	 *
	 * @return array[]\Thurly\Main\Entity\Validator\Base
	 */
	public static function validateValue()
	{
		return array(
			new \Thurly\Main\Entity\Validator\Length(null, 2000),
		);
	}
	...
	public function create()
	{
		...
		$connection->createTable($this->getTableName(), array(
			"ID" => new \Thurly\Main\Entity\IntegerField("ID", array(
				'primary' => true,
				'unique' => true,
				'required' => true,
			)),
			"VALUE" => new \Thurly\Main\Entity\StringField("VALUE", array(
				'required' => true,
