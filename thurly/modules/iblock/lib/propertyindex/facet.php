...
class Facet
{
	...
	/** @var \Thurly\Iblock\PropertyIndex\Dictionary */
	protected $dictionary = null;
	/** @var \Thurly\Iblock\PropertyIndex\Storage  */
	 ...
	 *
	 * @return \Thurly\Iblock\PropertyIndex\Storage
	 */
	 ...
	 *
	 * @return \Thurly\Iblock\PropertyIndex\Dictionary
	 */
	 ...
	 *
	 * @return \Thurly\Main\DB\Result|false
	 */
			...
			if (empty($where))
			{
				$sqlUnion[] = "
					SELECT
						...
						".($connection instanceof \Thurly\Main\DB\MysqlCommonConnection
	 ...
	 *
	 * @return \Thurly\Iblock\PropertyIndex\Facet
	 */
