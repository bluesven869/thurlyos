...
$element = new \Thurly\Iblock\Template\Entity\Element(0);
...
for ($i = 0; $i < 5; $i++)
{
	...
	$arSkuCollection[$i]["NAME"] = \Thurly\Iblock\Template\Engine::process(
		$sku
...
*/
namespace Thurly\Iblock\Template;
/**
 * Class Engine
 * Provides interface for templates processing.
 * @package Thurly\Iblock\Template
 */
class Engine
{
	/**
	 ...
	 * &#123;
	 * 	$e = new \Thurly\Iblock\Template\Entity\Element(6369);
	 * 	echo "<pre>", print_r(\Thurly\Iblock\Template\Engine::process($e, "Name: {=this.Name}. Code:{=this.code}"), 1), "</pre>";
	 * &#125;
	 * </code>
	 *
