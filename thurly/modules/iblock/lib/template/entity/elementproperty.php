 ...
 * @subpackage iblock
 */
namespace Thurly\Iblock\Template\Entity;
...
class ElementProperty extends Base
{
	...
	public function setFields(array $fields)
	{
		...
		{
			$properties = array();
			$propertyList = \Thurly\Iblock\PropertyTable::getList(array(
				"select" => array("*"),
...
class ElementPropertyEnum extends LazyValueLoader
{
	...
	protected function load()
	{
		$enumList = \Thurly\Iblock\PropertyEnumerationTable::getList(array(
			"select" => array("VALUE"),
...
class ElementPropertyElement extends LazyValueLoader
{
	...
	protected function load()
	{
		$elementList = \Thurly\Iblock\ElementTable::getList(array(
			"select" => array("NAME"),
			"filter" => array("=ID" => $this->key),
		));
...
class ElementPropertySection extends LazyValueLoader
{
	...
	protected function load()
	{
		$sectionList = \Thurly\Iblock\SectionTable::getList(array(
			"select" => array("NAME"),
			"filter" => array("=ID" => $this->key),
		));
