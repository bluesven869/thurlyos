 ...
 * @subpackage iblock
 */
namespace Thurly\Iblock\Template\Functions;
/**
 * Class Fabric
 ...
 *
 * @package Thurly\Iblock\Template\Functions
 */
class Fabric
{
	...
	public static function createInstance($functionName, $data = null) //todo rename createInstance
	{
		...
		{
			$event = new \Thurly\Main\Event("iblock", "OnTemplateGetFunctionClass", array($functionName));
			$event->send();
			if ($event->getResults())
			{
...
class FunctionBase
{
	 ...
	 *
	 * @param \Thurly\Iblock\Template\Entity\Base $entity This object.
	 * @param array[]\Thurly\Iblock\Template\NodeBase $parameters Parsed and prepared list of parameters.
	 *
	 * @return array
	 */
	public function onPrepareParameters(\Thurly\Iblock\Template\Entity\Base $entity, array $parameters)
	{
		$arguments = array();
		/** @var \Thurly\Iblock\Template\NodeBase $parameter */
