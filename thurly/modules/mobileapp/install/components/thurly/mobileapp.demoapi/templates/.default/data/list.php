...
use Thurly\MobileApp\Data\Lists;
...
{
	case "recursive":
		$nextTableUrl = "/thurly/components/thurly/mobileapp.demoapi/templates/.default/data/list.php?listType=recursive";
		$list->addItems("elements", array(
			array(
				"ID" => 1,
				"IMAGE"=>"/thurly/components/thurly/mobileapp.demoapi/templates/.default/img/attach-2-icon.png",
	...
	case "simple_alphabet":
		$list->addItems("elements", array(
			array(
				"ID" => 1,
				"IMAGE"=>"/thurly/components/thurly/mobileapp.demoapi/templates/.default/img/addition-icon.png",
	...
	case "simple":
		$list->addItems("elements", array(
			array(
				"ID" => 1,
				"IMAGE"=>"/thurly/components/thurly/mobileapp.demoapi/templates/.default/img/laboratory-icon.png",
		...
		foreach ($sections as $section)
		{
			for ($i = 0; $i < $countInSection; $i++)
			{
				$list->addItem("category", array(
					...
					"IMAGE"=>"/thurly/components/thurly/mobileapp.demoapi/templates/.default/img/".$sectionNumber.".png",
