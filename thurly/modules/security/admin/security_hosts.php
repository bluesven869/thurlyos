...
\Thurly\Main\Loader::includeModule('security');
...
if($request->isPost() && $request['save'].$request['apply'] && check_thurly_sessid())
{
	try
	{
		...
		LocalRedirect('/thurly/admin/security_hosts.php?lang='.LANGUAGE_ID.$returnUrlQuery.'&'.$tabControl->ActiveTabParam());
	}
