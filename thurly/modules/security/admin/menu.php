...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/prolog.php");
...
if($USER->CanDoOperation('view_event_log'))
{
	$aMenu["items"][] = array(
		...
		"url" => "/thurly/admin/event_log.php?lang=".LANGUAGE_ID."&set_filter=Y&find_type=audit_type_id&find_audit_type[]=SECURITY_VIRUS&find_audit_type[]=SECURITY_FILTER_SQL&find_audit_type[]=SECURITY_FILTER_XSS&find_audit_type[]=SECURITY_FILTER_XSS2&find_audit_type[]=SECURITY_FILTER_PHP&find_audit_type[]=SECURITY_REDIRECT&find_audit_type[]=SECURITY_HOST_RESTRICTION&mod=security",
...
)
{
	$aMenu["items"][] = array(
		...
		"url" => "/thurly/admin/security_otp.php?lang=".LANGUAGE_ID,
