...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_REQUEST["save"].$_REQUEST["apply"].$_REQUEST["frame_siteb"] !="" && $canWrite && check_thurly_sessid())
{
	...
	LocalRedirect("/thurly/admin/security_frame.php?lang=".LANGUAGE_ID.$returnUrl."&".$tabControl->ActiveTabParam());
}
