...
use Thurly\Main\Security\Sign\TimeSigner;
use Thurly\Main\Security\Random;
use Thurly\Security\Codec\Base32;
...
class Otp
{
	...
	protected static $typeMap = array(
		self::TYPE_HOTP => '\Thurly\Security\Mfa\HotpAlgorithm',
		self::TYPE_TOTP => '\Thurly\Security\Mfa\TotpAlgorithm',
	);
	 ...
	 *
	 * @param \Thurly\Main\Context $context Application context.
	 * @return \Thurly\Main\Context
	 */
	public function setContext(\Thurly\Main\Context $context)
	{
	...
	public function getUserLogin()
	{
		...
		{
			$this->userLogin = \Thurly\Main\UserTable::query()
	...
	protected function getDefaultIssuer()
	{
		...
		{
			return Option::get('security', 'otp_issuer', 'Thurly');
		}
	}
