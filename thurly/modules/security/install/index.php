...
Class security extends CModule
{
	...
	function InstallDB($arParams = array())
	{
		...
		{
			$this->errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/db/".strtolower($DB->type)."/install.sql");
		}
		...
		else
		{
			...
			if(!COption::GetOptionString("security", "ipcheck_disable_file"))
				COption::SetOptionString("security", "ipcheck_disable_file", "/thurly/modules/ipcheck_disable_".md5(mt_rand()));
	...
	function UnInstallDB($arParams = array())
	{
		...
		{
			$this->errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/db/".strtolower($DB->type)."/uninstall.sql");
			$this->UnInstallTasks();
		}
	...
	function InstallEvents()
	{
		...
		if($ar["C"] <= 0)
		{
			include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/events.php");
		}
		return true;
	}
	...
	function InstallFiles($arParams = array())
	{
		...
		{
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/otp", $_SERVER["DOCUMENT_ROOT"]."/thurly/otp", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/js/security", $_SERVER["DOCUMENT_ROOT"]."/thurly/js/security", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/images", $_SERVER["DOCUMENT_ROOT"]."/thurly/images/security", false, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/themes", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/components", $_SERVER["DOCUMENT_ROOT"]."/thurly/components", True, True);
		}
		return true;
	}
	...
	{
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/admin/", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/otp/", $_SERVER["DOCUMENT_ROOT"]."/thurly/otp");
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/js/security/", $_SERVER["DOCUMENT_ROOT"]."/thurly/js/security");
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/themes/.default/", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes/.default");
		DeleteDirFilesEx("/thurly/themes/.default/icons/security/");
		DeleteDirFilesEx("/thurly/images/security/");
	...
	function DoInstall()
	{
		...
		if($SEC_RIGHT >= "W")
		{
			...
			if($step < 2)
			{
				$APPLICATION->IncludeAdminFile(GetMessage("SEC_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/step1.php");
			}
			elseif($step==2)
			{
				if($this->InstallDB())
				...
				$APPLICATION->IncludeAdminFile(GetMessage("SEC_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/step2.php");
			}
		}
	}
	...
	function DoUninstall()
	{
		...
		if($SEC_RIGHT >= "W")
		{
			...
			if($step < 2)
			{
				$APPLICATION->IncludeAdminFile(GetMessage("SEC_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/unstep1.php");
			}
			elseif($step == 2)
			{
				...
				$this->UnInstallFiles();
				$GLOBALS["errors"] = $this->errors;
				$APPLICATION->IncludeAdminFile(GetMessage("SEC_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/security/install/unstep2.php");
			}
		}
	}
