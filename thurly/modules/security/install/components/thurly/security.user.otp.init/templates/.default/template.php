...
<div id="user-otp-container" class="bx-otp-wrap-container <?=LANGUAGE_ID?>" style="padding-top: 0; max-width:1300px;">
	...
	<div class="bx-otp-section bx-otp-step-1 /*amination1s1s*/">
		...
		<ul class="bx-otp-section-market-list">
			<li class="bx-otp-section-market-icon-Apple"><a href="https://itunes.apple.com/<?=(LANGUAGE_ID == "ru" || LANGUAGE_ID == "ua" ? "ru" : "en")?>/app/thurlyos-otp/id929604673?mt=8" target="_blank"></a></li>
			<li class="bx-otp-section-market-icon-Google"><a href="https://play.google.com/store/apps/details?id=com.thurlysoft.otp" target="_blank"></a></li>
			...
			<div class="bx-otp-section-col ">
				<h4 class="bx-otp-section-title-small"><?=GetMessage("SECURITY_OTP_HAND_TYPE")?></h4>
						<span class="bx-otp-section-desc">
							...
							<b><?
							if ($arResult['TYPE'] === \Thurly\Security\Mfa\Otp::TYPE_TOTP):
								echo getMessage('SECURITY_OTP_CODE_INFO_TOTP');
							elseif ($arResult['TYPE'] === \Thurly\Security\Mfa\Otp::TYPE_HOTP):
