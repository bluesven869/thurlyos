...
BX.Security.UserEdit.Otp = (function getUserOtp(BX)
{
	...
	{
		var defaults = {
			'actionUrl': '/thurly/admin/security_otp.ajax.php?lang=' + BX.message('LANGUAGE_ID'),
	...
	var RecoveryCodes = function(userId, options)
	{
		var defaults = {
			'actionUrl': '/thurly/admin/security_otp.ajax.php?lang=' + BX.message('LANGUAGE_ID'),
			'publicUrl': '/thurly/admin/security_otp_recovery_codes.php?lang=' + BX.message('LANGUAGE_ID'),
			'ui': {
