...
$MESS["SECURITY_SITE_CHECKER_SESSION_DIR_RECOMMENDATION"] = "Configure access permissions correctly, or change the directory. Another option is to store sessions in database: <a href=\"/thurly/admin/security_session.php\">Session protection</a>.";
...
$MESS["SECURITY_SITE_CHECKER_COLLECTIVE_SESSION_RECOMMENDATION"] = "Change the directory or store sessions in database: <a href=\"/thurly/admin/security_session.php\">Session protection</a>.";
...
$MESS["SECURITY_SITE_CHECKER_THURLY_TMP_DIR"] = "Temporary files are kept in the project root directory";
$MESS["SECURITY_SITE_CHECKER_THURLY_TMP_DIR_DETAIL"] = "Saving temporary files created by CTempFile to the root folder is not recommended.";
$MESS["SECURITY_SITE_CHECKER_THURLY_TMP_DIR_RECOMMENDATION"] = "Define a constant \"BX_TEMPORARY_FILES_DIRECTORY\" in \"thurly/php_interface/dbconn.php\" and specify a required path.<br>
Follow these steps:<br>
1. Pick a name for your temp directory and create it. For example, \"/home/thurly/tmp/www\":
<pre>
mkdir -p -m 700 /home/thurly/tmp/www
</pre>
2. Define the constant to let the system know you want to save temporary files to that folder:
<pre>
define(\"BX_TEMPORARY_FILES_DIRECTORY\", \"/home/thurly/tmp/www\");
</pre>";
$MESS["SECURITY_SITE_CHECKER_THURLY_TMP_DIR_ADDITIONAL"] = "Current directory: #DIR#";
?>