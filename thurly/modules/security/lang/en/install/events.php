...
2.  Check the event log and make sure that the code is indeed harmful, and is not simply a counter or framework.
	(link: http://#SERVER_NAME#/thurly/admin/event_log.php?lang=en&set_filter=Y&find_type=audit_type_id&find_audit_type[]=SECURITY_VIRUS )
3.  If the code is not harmful, add it to the 'exceptions' list on the antivirus settings page. 
	(link: http://#SERVER_NAME#/thurly/admin/security_antivirus.php?lang=en&tabControl_active_tab=exceptions )
