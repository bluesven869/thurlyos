	...
	extends CSecurityBaseTest
{
	...
	protected $tests = array(
		...
		"thurlyTempPath" => array(
			"method" => "checkThurlyTempPath"
		)
	);
...
HTACCESS;
	 ...
	 * @return string
	 */
	protected function checkThurlyTempPath()
	{
		...
		{
			$this->addUnformattedDetailError(
					"SECURITY_SITE_CHECKER_THURLY_TMP_DIR",
					CSecurityCriticalLevel::MIDDLE,
					getMessage("SECURITY_SITE_CHECKER_THURLY_TMP_DIR_ADDITIONAL", array(
							"#DIR#" => $path
					))
			);
