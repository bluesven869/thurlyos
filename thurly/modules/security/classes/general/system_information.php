...
class CSecuritySystemInformation
{
	...
	/**
	 * Return information about environment, such as ThurlyVM version
	 *
	 * @return array
	 */
	...
	{
		return array(
			"vm_version" => static::getThurlyVMVersion()
		);
	}

	/**
	 * Return ThurlyVM version
	 *
	 * @return string
	 */
	protected static function getThurlyVMVersion()
	{
		$result = getenv('THURLY_VA_VER');
		if(!$result)
			$result = "";
		return $result;
	}
