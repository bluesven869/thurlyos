...
$aAdd = array(
	array(
		...
		"ACTION" => "window.location='".addslashes("/thurly/admin/xdi_lf_scheme_edit.php")."?lang=".LANGUAGE_ID."&TYPE=POST';"
	),
	array(
		"TEXT" => GetMessage("LFP_SCHEME_LIST_RSS"),
		"TITLE" => GetMessage("LFP_SCHEME_LIST_RSS"),
		"ACTION" => "window.location='".addslashes("/thurly/admin/xdi_lf_scheme_edit.php")."?lang=".LANGUAGE_ID."&TYPE=RSS';"
	)
);
...
if (IsModuleInstalled("webservice"))
	$aAdd[] = array(
		...
		"ACTION" => "window.location='".addslashes("/thurly/admin/xdi_lf_scheme_edit.php")."?lang=".LANGUAGE_ID."&TYPE=XML';"
	);
