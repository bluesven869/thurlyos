...
class ServersData
{
	...
	protected static function getBxInfo($hostname)
	{
		...
		else
		{
			...
			{
				throw new \Thurly\Scale\ServerBxInfoException($actRes["get_bx_info"]["ERROR"], $hostname);
			}
		}
	...
	/**
	 * @param string $hostname Server hostname.
	 * @return bool|string - Version of thurly environment.
	 * @throws \Thurly\Main\ArgumentNullException
	 */
	...
	public static function getGraphCategories($hostname)
	{
		...
		foreach($roles as $roleId => $role)
			$result = array_merge($result, \Thurly\Scale\RolesData::getGraphsCategories($roleId));
