...
if(\Thurly\Scale\Helper::checkBxEnvVersion())
{
	if(\Thurly\Scale\Monitoring::isEnabled())
	{
		...
		$graphs = \Thurly\Scale\GraphData::getList();

		foreach($serversList as $hostname => $server)
		{
			$graphCategories[$hostname] = \Thurly\Scale\ServersData::getGraphCategories($hostname);
		...
		<div class="adm-scale-page-wrap" id="adm-scale-page-wrap">
			<div class="adm-scale-blocks-wrapper" id="adm-scale-blocks-wrapper">
				<?if(\Thurly\Scale\Monitoring::isDatabaseCreated($serverHostname)):?>
