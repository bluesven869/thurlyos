...
$actionsDefinitions = array(
	...
	"MYSQL_ADD_SLAVE" => array(
		...
		"PAGE_REFRESH" => "Y",
		"MODIFYERS" => array(
			"\\Thurly\\Scale\\ActionModifyer::mysqlAddSlave",
			"\\Thurly\\Scale\\ActionModifyer::checkExtraDbExist",
		)
	),
	...
	"SET_EMAIL_SETTINGS" => array(
		...
		"PAGE_REFRESH" => "Y",
		"MODIFYERS" => array(
			"\\Thurly\\Scale\\ActionModifyer::emailSettingsModifier",
		),
		"USER_PARAMS" => array(
			"SITE_NAME" => array(
	...
	"CHANGE_PASSWD_THURLY" => array(
		"START_COMMAND_TEMPLATE" => "sudo -u root /opt/webdir/bin/wrapper_ansible_conf -a bx_passwd -u thurly -H ##SERVER_PARAMS:hostname## -P ##USER_PARAMS:NEW_PASSWD## -o json",
		"NAME" => Loc::getMessage("SCALE_ADEF_CHANGE_PASSWD_THURLY"),
		"USER_PARAMS" => array(
			"NEW_PASSWD" => array(
				"NAME" => Loc::getMessage("SCALE_ADEF_CHPASS_UP_NEW_PASS"),
				"TYPE" => "PASSWORD",
	...
	"SITE_CREATE_LINK" => array(
		...
		"USER_PARAMS" => array(
			...
			"KERNEL_SITE" => array(
				...
				"TYPE" => "DROPDOWN",
				"VALUES" => \Thurly\Scale\SitesData::getKernelsList()
			)
		),
		"MODIFYERS" => array(
			"\\Thurly\\Scale\\ActionModifyer::siteCreateLinkModifier"
		)
	),
	...
	"SPHINX_ADD_ROLE" => array(
		...
		"CODE_PARAMS" => array(
			"DB_NAME" => 'return \Thurly\Main\Application::getConnection()->getDbName();'
		)
	),
	...
	"CREATE_PULL_NET_IFACE" => array(
		...
		"USER_PARAMS" => array(
			"NET_IFACE" => array(
				...
				"TYPE" => "DROPDOWN",
				"VALUES" => \Thurly\Scale\Helper::getNetworkInterfaces()
			)
		)
	),
