...
<table class="mail-grid"   width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td>
			...
			<table class="mail-grid-cell"   width="192" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
					<td data-bx-block-editor-place="leftBodyCenter">
						<!-- content -->
										...
										<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
											...
											<tr>
												<td valign="top" class="bxBlockPadding bxBlockContentImage" style="text-align: center">
													<a href="#">
														<img align="center" src="/thurly/images/sender/preset/blocked1/choco.jpg" class="bxImage">
													</a>
												</td>
											</tr>
											</tbody>
			...
			<table class="mail-grid-cell"   width="448" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
					<td data-bx-block-editor-place="rightBodyCenter">
						<!-- content -->
												...
												<td valign="top" class="bxBlockContentImageGroup">
													<table align="left" border="0" cellpadding="0" cellspacing="0" width="260">
														...
														<tr>
															<td valign="top" class="bxBlockPadding bxBlockContentImage">
																<a href="#">
																	<img align="left" data-bx-editor-def-image="0" src="/thurly/images/sender/preset/blocked1/choco.jpg" class="bxImage">
																</a>
															</td>
														</tr>
														</tbody>
													...
													<table align="left" border="0" cellpadding="0" cellspacing="0" width="260">
														...
														<tr>
															<td valign="top" class="bxBlockPadding bxBlockContentImage">
																<a href="#">
																	<img align="left" data-bx-editor-def-image="0" src="/thurly/images/sender/preset/blocked1/ocean.jpg" class="bxImage">
																</a>
															</td>
														</tr>
														</tbody>
...
<table class="mail-grid"   width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
	<tr>
		<td>
			...
			<table class="mail-grid-cell" width="192" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
					<td data-bx-block-editor-place="leftBodyBottom">
						<!-- content -->
						<div data-bx-block-editor-block-type="image">
							<table border="0" cellpadding="0" cellspacing="0" width="100%" class="bxBlockImage">
								<tbody class="bxBlockOut">
									...
									<td valign="top" class="bxBlockInn bxBlockInnImage">
										<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
											...
											<tr>
												<td valign="top" class="bxBlockPadding bxBlockContentImage" style="text-align: center">
													<a href="#">
														<img align="center" src="/thurly/images/sender/preset/blocked1/ocean.jpg" class="bxImage">
													</a>
												</td>
											</tr>
											</tbody>
			...
			<table class="mail-grid-cell"   width="448" border="0" cellspacing="0" cellpadding="0" align="left">
				<tr>
					<td data-bx-block-editor-place="rightBodyBottom">
						<!-- content -->
						<div data-bx-block-editor-block-type="text">
							<table border="0" cellpadding="0" cellspacing="0" width="100%" class="bxBlockText">
								<tbody class="bxBlockOut">
