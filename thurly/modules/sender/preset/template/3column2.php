				...
				<tr>
					<td style="padding:5px;" align="middle">
						...
						<table cellpadding="0">
							<tr>
								<td style="padding:5px;vertical-align: top;">
									<img width="100%" src="/thurly/images/sender/preset/default_wide.png" style="max-width:100%;height: auto;">
								</td>
							</tr>
						</table>
						...
						<table cellpadding="0">
							<tr>
								<td style="vertical-align: top;">
									<div class="bx-text-33" style="float: left;width: 33%;text-align:left">
										<div style="padding: 5px;">
											<img height="auto" style="max-width:100%;height:auto;" src="/thurly/images/sender/preset/default_cube.png"><br><br>
											<b>Lorem ipsum</b>
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse</p>
										</div>
									</div>
