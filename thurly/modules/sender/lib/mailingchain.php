...
class MailingChainTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'ATTACHMENT' => array(
				'data_type' => 'Thurly\Sender\MailingAttachmentTable',
 ...
 */
	...
	public static function prepareReSendErrorRecipients($id)
	{
		...
		\Thurly\Main\Application::getConnection()->query($updateSql);
	...
	public static function getDefaultEmailFromList()
	{
		...
		$siteEmailDb = \Thurly\Main\SiteTable::getList(array('select'=>array('EMAIL')));
