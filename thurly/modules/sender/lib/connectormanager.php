...
class ConnectorManager
{
	...
	{
		$data['CONNECTOR'] = 'Thurly\Sender\SenderConnectorContact';
	...
	{
		$data['CONNECTOR'] = 'Thurly\Sender\SenderConnectorRecipient';
	...
	public static function onConnectorList($data)
	{
		$data['CONNECTOR'] = array(
			'Thurly\Sender\SenderConnectorUnSubscribers'
		);
	 ...
	 *
	 * @param array
	 * @return \Thurly\Sender\Connector|null
	 */
	 ...
	 *
	 * @param array|null
	 * @return \Thurly\Sender\Connector[]
	 */
	...
	public static function getConnectorClassList(array $endpointList = null)
	{
		...
		foreach ($event->getResults() as $eventResult)
		{
			...
			if($eventResultParameters && array_key_exists('CONNECTOR', $eventResultParameters))
			{
				...
				{
					if(!is_subclass_of($connectorClassName,  '\Thurly\Sender\Connector'))
					{
						continue;
					}
