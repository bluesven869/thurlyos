...
class MailBlockBase
{
	...
	public static function getList()
	{
		...
		foreach(\Thurly\Sender\PostingRecipientTable::getPersonalizeList() as $arPersonalizeBlock)
		{
			$resultListPersonal[] = array(
	...
	public static function getById($blockName)
	{
		...
		$fullPathOfFile = \Thurly\Main\Loader::getLocal(static::LOCAL_DIR_BLOCK . bx_basename($blockName) . '.html');
		if ($fullPathOfFile)
		{
