...
if($REQUEST_METHOD=="POST" && strlen($Update.$Apply.$RestoreDefaults)>0 && $POST_RIGHT=="W" && check_thurly_sessid())
{
	...
	CAgent::RemoveAgent( \Thurly\Sender\MailingManager::getAgentNamePeriod(), "sender");
