...
use \Thurly\Sender\Internals\CounterCalculation;
...
if($REQUEST_METHOD == "POST" && $POST_RIGHT=="W" && check_thurly_sessid())
{
...
<script type="text/javascript">
	...
	function MoveProgress()
	{
		...
		var url = '/thurly/admin/sender_convert.php?lang=<?echo LANGUAGE_ID?>&<?echo thurly_sessid_get()?>';
		ShowWaitWindow();
