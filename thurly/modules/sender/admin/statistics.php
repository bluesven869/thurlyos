...
use Thurly\Sender\Stat\Statistics;
...
$showLastPostingHtml = function (array $chain)
{
	...
	<div class="bx-sender-releases-item">
		<p class="bx-sender-releases-item-info">
			...
			<a href="/thurly/admin/sender_mailing_chain_admin.php?MAILING_ID=<?=htmlspecialcharsbx($chain['MAILING_ID'])?>&lang=<?=LANGUAGE_ID?>" class="bx-sender-releases-section">
				<?=htmlspecialcharsbx($chain['MAILING_NAME'])?>
			</a>
		</p>
		<a href="/thurly/admin/sender_mailing_stat.php?MAILING_ID=<?=htmlspecialcharsbx($chain['MAILING_ID'])?>&ID=<?=htmlspecialcharsbx($chain['ID'])?>&lang=<?=LANGUAGE_ID?>" class="bx-sender-releases-title">
			...
			<div data-bx-block="ChainList" class="bx-sender-last-postings bx-sender-block-top-padding">
				...
				<div data-bx-view-data="" class="bx-sender-releases">
					...
					<div class="bx-sender-new-releases">
						<a href="/thurly/admin/sender_mailing_wizard.php?IS_TRIGGER=N&lang=ru" class="adm-btn adm-btn-save bx-sender-btn">
