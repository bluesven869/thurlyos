 ...
 * <li> FROM_CONTROLLER_MEMBER reference to {@link \Thurly\Controller\MemberTable}
 * <li> TO_CONTROLLER_MEMBER reference to {@link \Thurly\Controller\MemberTable}
...
class AuthLogTable extends Main\Entity\DataManager
{
	 ...
	 * 
	 * @return boolean
	 * @see \Thurly\Controller\AuthLogTable::logSiteToControllerAuth
	 * @see \Thurly\Controller\AuthLogTable::logControllerToSiteAuth
	 * @see \Thurly\Controller\AuthLogTable::logSiteToSiteAuth
	 */
	 ...
	 * @throws \Exception
	 * @see \Thurly\Controller\AuthLogTable::isEnabled
	 */
	...
	private static $agentName = "\\Thurly\\Controller\\AuthLogTable::cleanupAgent";
