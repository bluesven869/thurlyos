...
use \Thurly\Controller\GroupMapTable;

if (!$USER->CanDoOperation("controller_auth_view") || !\Thurly\Main\Loader::includeModule("controller"))
{
...
$nav = new \Thurly\Main\UI\AdminPageNavigation("nav-controller-group-map");
