...
//**********************************************************************/
//define("US_KERNEL_PATH", "/thurly/clients");
define("US_CALL_TYPE", "KERNEL");
//define("US_SAVE_UPDATERS_DIR", "/thurly/clients/updaters");
...
if (!$USER->CanDoOperation("controller_member_updates_run")  || !check_thurly_sessid())
{
...
if ($queryType == "M")
{
	...
	if (StrLen($errorMessage) <= 0)
	{
		...
		{
			CUpdateClient::ClearUpdateFolder($_SERVER["DOCUMENT_ROOT"]."/thurly/updates/".$temporaryUpdatesDir);
			CUpdateClient::AddMessage2Log("Finish - NOUPDATES", "STEP");
			echo "FIN";

			if (file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/controller/classes/general/update_db_updater.php"))
			{
				copy($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/controller/classes/general/update_db_updater.php", $_SERVER["DOCUMENT_ROOT"].US_SHARED_KERNEL_PATH."/modules/main/classes/general/update_db_updater.php");
			}
