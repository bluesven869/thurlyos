...
use \Thurly\Controller\AuthLogTable;

if (!$USER->CanDoOperation("controller_auth_log_view") || !\Thurly\Main\Loader::includeModule("controller"))
{
...
$nav = new \Thurly\Main\UI\AdminPageNavigation("nav-controller-auth-log");
\Thurly\Main\Application::getConnection()->startTracker();
\Thurly\Main\Application::getConnection()->getTracker()->startFileLog("/tmp/debug03.log");
...
\Thurly\Main\Application::getConnection()->getTracker()->stopFileLog();
