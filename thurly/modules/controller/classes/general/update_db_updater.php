...
define("US_SAVE_UPDATERS_DIR", "/thurly/updaters");
...
if (!function_exists("DBUpdaterCheckUpdates"))
{
	...
	function DBUpdaterCheckUpdates($US_HOST_PROCESS_MAIN)
	{
		...
		if (!file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/versions.php"))
			return array();
		$arVersions = array();
		include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/versions.php");
