...
<?
class ExtranetWizardTemplate extends CWizardTemplate
{
	function GetLayout()
	{
		...
		if (file_exists($_SERVER["DOCUMENT_ROOT"].$wizardPath."/images/".LANGUAGE_ID."/logo.png"))
			$logoImage = '<img src="'.$wizardPath.'/images/'.LANGUAGE_ID.'/logo.png" alt="" />';
		elseif (file_exists($_SERVER["DOCUMENT_ROOT"].$wizardPath."/images/".LANGUAGE_ID."/logo.gif"))
