...
Class extranet extends CModule
{
	...
	function DoInstall()
	{
		...
		else
		{
			...
			$APPLICATION->IncludeAdminFile(GetMessage("EXTRANET_INSTALL_TITLE"), $DOCUMENT_ROOT."/thurly/modules/extranet/install/step1.php");
		}
...
/*
		// there is UF_PUBLIC user field creation in the thurly:extranet wizard
...
*/
	...
	function InstallFiles($arParams = array())
	{
		...
		{
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/components", $_SERVER["DOCUMENT_ROOT"]."/thurly/components", True, True);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/gadgets", $_SERVER["DOCUMENT_ROOT"]."/thurly/gadgets", True, True);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/wizards", $_SERVER["DOCUMENT_ROOT"]."/thurly/wizards", True, True);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/services", $_SERVER["DOCUMENT_ROOT"]."/thurly/services", true, true);
		}
	...
	function InstallEvents()
	{
		...
		if($ar["C"] <= 0)
		{
			include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/events/set_events.php");
		}
		return true;
	}
	...
	function DoUninstall()
	{
		...
		$step = IntVal($step);
		if($step<2)
			$APPLICATION->IncludeAdminFile(GetMessage("EXTRANET_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/unstep1.php");
		elseif($step==2)
		{
			$APPLICATION->ResetException();
			...
			$APPLICATION->IncludeAdminFile(GetMessage("EXTRANET_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/install/unstep2.php");
		}
	}
	...
	{
		DeleteDirFilesEx("/thurly/wizards/thurly/extranet/");
		return true;
	}
