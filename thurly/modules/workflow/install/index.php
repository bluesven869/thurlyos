...
Class workflow extends CModule
{
	...
	function workflow()
	{
		...
		$this->MODULE_CSS = "/thurly/modules/workflow/workflow.css";
	}
	...
	function InstallDB($arParams = array())
	{
		...
		if($bDBInstall)
		{
			$this->errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/db/".$DBType."/install.sql");
		}
	...
	function UnInstallDB($arParams = array())
	{
		...
		{
			$this->errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/db/".$DBType."/uninstall.sql");
		}
	...
	function InstallEvents()
	{
		...
		if($ar["C"] <= 0)
		{
			include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/events/set_events.php");
		}
		return true;
	}
	...
	function InstallFiles($arParams = array())
	{
		...
		{
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin", true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/images", $_SERVER["DOCUMENT_ROOT"]."/thurly/images/workflow", true, true);
		}
		return true;
	}
	...
	{
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
		DeleteDirFilesEx("/thurly/images/workflow/");
		return true;
	}
	...
	function DoInstall()
	{
		...
		if($WORKFLOW_RIGHT == "W")
		{
			...
			if($step < 2)
			{
				$APPLICATION->IncludeAdminFile(GetMessage("FLOW_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/step1.php");
			}
			elseif($step == 2)
			{
				if($this->InstallDB())
				...
				$APPLICATION->IncludeAdminFile(GetMessage("FLOW_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/step2.php");
			}
		}
	}
	...
	function DoUninstall()
	{
		...
		if($WORKFLOW_RIGHT == "W")
		{
			...
			if($step < 2)
			{
				$APPLICATION->IncludeAdminFile(GetMessage("FLOW_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/unstep1.php");
			}
			elseif($step == 2)
			{
				...
				$this->UnInstallFiles();
				$GLOBALS["errors"] = $this->errors;
				$APPLICATION->IncludeAdminFile(GetMessage("FLOW_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/workflow/install/unstep2.php");
			}
		}
	}
