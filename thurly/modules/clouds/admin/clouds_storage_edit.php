	...
	if(isset($_REQUEST["save"]) || isset($_REQUEST["apply"]))
	{
		...
		if($res > 0)
		{
			if(isset($_REQUEST["apply"]))
				LocalRedirect("/thurly/admin/clouds_storage_edit.php?ID=".$res."&lang=".LANGUAGE_ID."&".$tabControl->ActiveTabParam());
			else
				LocalRedirect("/thurly/admin/clouds_storage_list.php?lang=".LANGUAGE_ID);
		}
		else
		{
...
function editAddRule()
{
	...
	var oCell4 = oRow.insertCell(3); oCell4.innerHTML = '<img src="/thurly/themes/.default/images/actions/delete_button.gif" onclick="editDeleteRule(this) "/>';
...
?>
	...
	?>
			<tr>
				...
				<td><img src="/thurly/themes/.default/images/actions/delete_button.gif" onclick="editDeleteRule(this)" /></td>
			</tr>
	<?
		$ii++;
	}
