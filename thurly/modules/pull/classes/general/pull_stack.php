...
class CAllPullStack
{
	...
	public static function AddByChannel($channelId, $params = Array())
	{
		...
		if (CPullOptions::GetQueueServerStatus())
		{
			...
			$res = CPullChannel::Send($channelId, \Thurly\Pull\Common::jsonEncode($arData), $options);
	...
	{
		return \Thurly\Pull\Event::add($userId, $arMessage, $channelType);
	}

	public static function AddByUsers($users, $arMessage, $channelType = 'private')
	{
		return \Thurly\Pull\Event::add($users, $arMessage, $channelType);
	}
