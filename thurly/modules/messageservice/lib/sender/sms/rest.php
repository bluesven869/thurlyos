...
use Thurly\MessageService\Internal\Entity\RestAppLangTable;
use Thurly\MessageService\Internal\Entity\RestAppTable;
use Thurly\MessageService\Sender;
use Thurly\MessageService\Sender\Result;
use Thurly\Rest\Sqs;
...
class Rest extends Sender\Base
{
	...
	public function sendMessage(array $messageFields)
	{
		...
		$auth = $messageFields['AUTHOR_ID'] > 0 ? array(
			...
			\Thurly\Rest\OAuth\Auth::PARAM_LOCAL_USER => $messageFields['AUTHOR_ID'],
