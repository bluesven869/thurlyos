...
namespace Thurly\MessageService\Sender;
...
abstract class BaseConfigurable extends Base
{
	...
	{
		return '/messageservice/configs/sms/?provider='.$this->getId();
	}
	...
	{
		$id = $this->getId();
		return $this->getHostUrl().'/thurly/tools/messageservice/callback_'.$id.'.php';
	}
	 ...
	 * @see \Thurly\Disk\UrlManager::getHostUrl
	 */
