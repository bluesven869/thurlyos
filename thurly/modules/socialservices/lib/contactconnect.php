 ...
 * </ul>
 *
 * @package Thurly\Socialservices
 **/

class ContactConnectTable extends Main\Entity\DataManager
{
	const TYPE_PORTAL = 'P'; // thurlyos portal
	...
	public static function getMap()
	{
		return array(
			...
			'CONTACT' => array(
					'data_type' => 'Thurly\Socialservices\ContactTable',
					'reference' => array('=this.CONTACT_ID' => 'ref.ID'),
			),
			'LINK' => array(
					'data_type' => 'Thurly\Socialservices\UserLinkTable',
