...
$arClasses = array(
	...
	"CThurlyOSNetOAuthInterface" => "classes/general/thurlyosnet.php",
	"CSocServThurlyOSNet" => "classes/general/thurlyosnet.php",
	"CThurlyOSNetTransport" => "classes/general/thurlyosnet.php",
	"CThurlyOSNetPortalTransport" => "classes/general/thurlyosnet.php",
	...
	"CSocServThurlyOAuth" => "classes/general/thurlyos.php",
	"CThurlyOAuthInterface" => "classes/general/thurlyos.php",
	"CThurlyPHPAppTransport" => "classes/general/thurlyos.php",
	...
	"CThurlyServiceOAuthInterface" => "classes/general/thurlyservice.php",
	"CThurlyServiceTransport" => "classes/general/thurlyservice.php",
	"CThurlySeoOAuthInterface" => "classes/general/thurlyseo.php",
	"CThurlySeoTransport" => "classes/general/thurlyseo.php",
);

CModule::AddAutoloadClasses("socialservices", $arClasses);

$arJSDescription = array(
	'js' => '/thurly/js/socialservices/ss_timeman.js',
	'css' => '/thurly/js/socialservices/css/ss.css',
	'rel' => array('popup', 'ajax', 'fx', 'ls', 'date', 'json'),
	'lang' => '/thurly/modules/socialservices/lang/'.LANGUAGE_ID.'/js_socialservices.php'
	);
