...
class CSocServOdnoklassniki extends CSocServAuth
{
	...
	public function GetSettings()
	{
		return array(
			...
			array("note"=>GetMessage("socserv_odnoklassniki_form_note", array('#URL#'=>\CHTTP::URN2URI("/thurly/tools/oauth/odnoklassniki.php")))),
		);
	}
	...
	public function getUrl($location = 'opener', $addScope = null, $arParams = array())
	{
		...
		if(IsModuleInstalled('thurlyos') && defined('BX24_HOST_NAME'))
		{
			...
			$state = \CHTTP::URN2URI("/thurly/tools/oauth/odnoklassniki.php")."?state=";
		...
		else
		{
			...
			$redirect_uri = \CHTTP::URN2URI("/thurly/tools/oauth/odnoklassniki.php");
