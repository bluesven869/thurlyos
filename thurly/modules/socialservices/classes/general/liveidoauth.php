...
class CSocServLiveIDOAuth extends CSocServAuth
{
	...
	const CONTROLLER_URL = "https://www.thurlyos.ru/controller";
	...
	public function GetSettings()
	{
		return array(
			...
			array("note"=>GetMessage("socserv_liveid_form_note", array('#URL#'=>\CHTTP::URN2URI("/thurly/tools/oauth/liveid.php")))),
		);
	}
	...
	public function getUrl($location = 'opener', $addScope = null, $arParams = array())
	{
		...
		if(IsModuleInstalled('thurlyos') && defined('BX24_HOST_NAME'))
		{
			...
			$state = \CHTTP::URN2URI("/thurly/tools/oauth/liveid.php")."?state=";
		...
		else
		{
			...
			$redirect_uri = \CHTTP::URN2URI("/thurly/tools/oauth/liveid.php");
...
class CLiveIDOAuthInterface
{
	...
	protected function deleteStorageTokens()
	{
		...
		if(is_object($USER) && $USER->IsAuthorized())
		{
			...
			{
				\Thurly\Socialservices\UserTable::delete($accessToken['ID']);
			}
		}
	}
}
