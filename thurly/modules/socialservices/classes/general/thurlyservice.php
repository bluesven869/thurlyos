...
class CThurlyServiceOAuthInterface extends CSocServOAuthTransport
{
	const SERVICE_ID = "thurlygeneric";
...
class CThurlyServiceTransport
{
	...
	public function call($methodName, $additionalParams = null, $licenseCheck = false)
	{
		...
		{
			throw new \Thurly\Main\SystemException("No client credentials");
		}
	}
