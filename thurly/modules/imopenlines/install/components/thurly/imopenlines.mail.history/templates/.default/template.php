...
<?foreach($arResult['TEMPLATE_MESSAGES'] as $id => $message):?>
	...
	<tr>
		...
		<td style="width: 50px; text-align: right;"><img src="<?=($message['AVATAR']? $message['AVATAR']: $arResult['TEMPLATE_SERVER_ADDRESS'].'/thurly/components/thurly/imopenlines.mail.history/templates/.default/images/default_avatar.png')?>" alt="" width="34" height="34" style="border-radius: 50%; width: 34px; height: 34px"></td>
	</tr>
	<tr>
		<td colspan="3" style="height: 6px;"></td>
	</tr>
	<?} else {?>
	<tr>
		<td style="width: 50px; text-align: left;"><img src="<?=($message['AVATAR']? $message['AVATAR']: $arResult['TEMPLATE_SERVER_ADDRESS'].'/thurly/components/thurly/imopenlines.mail.history/templates/.default/images/default_avatar.png')?>" alt="" width="34" height="34" style="border-radius: 50%; width: 34px; height: 34px"></td>
		<td>
...
<div style="width: 100%;margin-bottom: 10px;"><span style="color: #A3ACB2; font-weight: 300; font-size: 11px; line-height: 15px; font-family: Helvetica, Arial, sans-serif;"><?=$mess['IMOL_MAIL_DONT_REPLY']?></span></div>