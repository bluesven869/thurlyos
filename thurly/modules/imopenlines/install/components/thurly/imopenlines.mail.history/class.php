...
class ImOpenlinesMailHistoryComponent extends CThurlyComponent
{
	...
	public function executeComponent()
	{
		...
		{
			$this->arResult['TEMPLATE_MESSAGES'] = \Thurly\ImOpenLines\Mail::prepareSessionHistoryForTemplate($this->arParams['TEMPLATE_SESSION_ID']);
		...
		{
			$this->arResult['TEMPLATE_MESSAGES'] = \Thurly\ImOpenLines\Mail::prepareOperatorAnswerForTemplate($this->arParams['TEMPLATE_SESSION_ID']);
			if (!$this->arResult['TEMPLATE_MESSAGES'])
			{
				\Thurly\Main\Mail\EventMessageThemeCompiler::stop();
				return false;
