...
class BotcontrollerIframeQuick extends CThurlyComponent
{
	public function executeComponent()
	{
		...
		$listDataManager = new \Thurly\ImOpenlines\QuickAnswers\ListsDataManager($this->arResult['IMOP_ID']);
	...
	{
		$uri = new \Thurly\Main\Web\Uri($this->arResult['PATH']);
