...
use Thurly\ImOpenlines\Model\RoleAccessTable;
use Thurly\ImOpenlines\Model\RolePermissionTable;
use Thurly\ImOpenlines\Model\RoleTable;
...
class RoleManager
{
	...
	public static function getUserPermissions($userId)
	{
		...
		if(\Thurly\ImOpenLines\Common::hasAccessForAdminPages())
