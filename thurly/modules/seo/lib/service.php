...
{
	define('SEO_SERVICE_URL', THURLY_CLOUD_ADV_URL);
}
...
class Service
{
	...
	const REDIRECT_URI = "/thurly/tools/seo_client.php";
	...
	protected static function setAccessSettings(array $accessParams)
	{
		...
		if($result->isSuccess())
		{
			static::clearAuth(Thurly::ENGINE_ID, true);
			static::$engine = null;
		}
	}

	/**
	 * @return \Thurly\Seo\Engine\Thurly
	 */
	public static function getEngine()
	{
		if(!static::$engine && Loader::includeModule("socialservices"))
		{
			static::$engine = new Thurly();
		}
