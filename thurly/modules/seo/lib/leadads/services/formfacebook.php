...
class FormFacebook extends Form
{
	...
	public function add(array $data)
	{
		...
		$privacyPolicy['url'] = 'http://www.1c-thurly.ru/download/files/manuals/ru/privacy.htm';
		$contextCard = [
