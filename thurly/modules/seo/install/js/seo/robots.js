...
var tmpWindow = null;
var arStandardDisallow = ['*/index.php', '/thurly/', '/*show_include_exec_time=', '/*show_page_exec_time=',
	'/*show_sql_stat=', '/*thurly_include_areas=', '/*clear_cache=', '/*clear_cache_session=', '/*ADD_TO_COMPARE_LIST',
...
var arStandardAllow = ['/thurly/components/', '/thurly/cache/', '/thurly/js/', '/thurly/templates/', '/thurly/panel/'];
