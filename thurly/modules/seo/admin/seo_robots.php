...
$dbSites = Thurly\Main\SiteTable::getList(
	array(
...
$bVendor = COption::GetOptionString('main', 'vendor', '') == '1c_thurly';
...
if($_SERVER['REQUEST_METHOD'] == 'POST' && check_thurly_sessid() && strlen($_POST["save"]) > 0)
{
...
CJSCore::RegisterExt('seo_robots', array(
	'js' => '/thurly/js/seo/robots.js',
	'css' => '/thurly/panel/seo/robots.css',
...
$APPLICATION->addHeadScript('/thurly/js/main/file_dialog.js');
