...
$APPLICATION->SetAdditionalCSS('/thurly/panel/seo/seo.css');
...
$aMenu[] = array(
	...
	"LINK"	=> "/thurly/admin/seo_search_yandex.php?lang=".LANGUAGE_ID,
	"ICON"	=> "btn_list",
);
...
{
	BX.ajax.loadJSON(
		'/thurly/tools/seo_yandex.php?action='+action+'&domain=<?=urlencode($arDomain['DOMAIN'])?>&dir=<?=urlencode($arDomain['SITE_DIR'])?>&<?=thurly_sessid_get()?>',
		function(res)
		{
