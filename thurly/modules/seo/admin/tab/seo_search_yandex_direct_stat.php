...
?>
		<div class="seo-adv-block seo-adv-block-gray seo-adv-block-no-title">
			...
			<div class="seo-adv-block-text"><?=Loc::getMessage('SEO_YANDEX_STATS_NO_START_DATE')?> <a href="/thurly/admin/seo_yandex_direct_edit.php?lang=<?=LANGUAGE_ID?>&ID=<?=$banner["CAMPAIGN_ID"]?>"><?=Loc::getMessage('SEO_YANDEX_STATS_NO_START_DATE_SET')?></a></div>
		</div>
<?
...
?>
			...
			<div style="margin-top: 15px;">
				<a href="/thurly/admin/seo_search_yandex_direct_banner_edit.php?lang=<?=LANGUAGE_ID?>&ID=<?=$banner['ID']?>&tabControl_active_tab=edit_stats"><?=Loc::getMessage('SEO_YANDEX_STATS_BANNER_STATS')?></a><br />
				<a href="/thurly/admin/seo_search_yandex_direct_edit.php?lang=<?=LANGUAGE_ID?>&ID=<?=$banner['CAMPAIGN_ID']?>&tabControl_active_tab=edit_stats"><?=Loc::getMessage('SEO_YANDEX_STATS_CAMPAIGN_STATS')?></a><br />
			</div>
		</td>
	</tr>
</table>
