 ...
 * @global Thurly\Seo\Engine\YandexDirect $engine
 */
...
<script type="text/javascript">
	function makeNewAuth()
	{
		...
		BX.ajax.loadJSON('/thurly/tools/seo_yandex_direct.php?action=nullify_auth&sessid=' + BX.thurly_sessid(), function(){
	...
	function registerClient()
	{
		...
		BX.ajax.loadJSON('/thurly/tools/seo_yandex_direct.php?action=register&sessid=' + BX.thurly_sessid(), function(result)
		{
			if(result['result'])
			{
				BX.reload();
