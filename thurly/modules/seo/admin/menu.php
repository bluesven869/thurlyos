...
{
	if(\Thurly\Main\ModuleManager::isModuleInstalled('seo'))
	{
...
//		not show Yandex services on portal
		if ($bShowYandexServices)
		{
			...
			{
				if(\Thurly\Main\Loader::includeModule('seo'))
				{
					...
					while($campaign = $dbRes->fetch())
					{
						...
						|| (
							$GLOBALS["APPLICATION"]->GetCurPage() == '/thurly/admin/seo_search_yandex_direct_banner_edit.php'
