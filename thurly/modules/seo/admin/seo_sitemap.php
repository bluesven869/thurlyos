...
BX.runSitemap = function(ID, value, pid, NS)
{
	...
	BX.ajax.post('/thurly/admin/seo_sitemap_run.php', {
		lang:'<?=LANGUAGE_ID?>',
		action: 'sitemap_run',
		ID: ID,
		value: value,
...
{
	window.tbl_sitemap.GetAdminList('/thurly/admin/seo_sitemap.php?lang=<?=LANGUAGE_ID?>');
};
</script>
...
<?
if(isset($_REQUEST['run']) && check_thurly_sessid())
{
