...
if ($arParams['FORUM_ID'] > 0)
{
	if ($arParams['MINIMAL'])
	{
		?><script type="text/javascript">
			...
			{
				BX.loadCSS('<?=CUtil::GetAdditionalFileURL('/thurly/components/thurly/forum.comments/templates/.default/style.css', true)?>');
				BX.loadScript('<?=CUtil::GetAdditionalFileURL('/thurly/components/thurly/forum.comments/templates/.default/script.js', true)?>');
			}
			else
			{
	...
	$APPLICATION->IncludeComponent("thurly:forum.comments", ".default", array(
		...
		"PATH_TO_SMILE" => "/thurly/images/forum/smile/",
