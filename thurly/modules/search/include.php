...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/search/tools/stemming.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/search/tools/tags.php");
