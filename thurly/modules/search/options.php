	...
	1 => array(
		...
		"OPTIONS" => Array(
			...
			"full_text_engine" => Array(GetMessage("SEARCH_OPTIONS_FULL_TEXT_ENGINE"), Array("select", array(
				"thurly" => GetMessage("SEARCH_OPTIONS_FULL_TEXT_ENGINE_THURLY"),
				"sphinx" => GetMessage("SEARCH_OPTIONS_FULL_TEXT_ENGINE_SPHINX"),
			))),
			"letters" => Array(GetMessage("SEARCH_OPTIONS_LETTERS"), Array("text", 45), "thurly"),
