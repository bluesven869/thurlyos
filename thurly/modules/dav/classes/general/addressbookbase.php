		...
		if (!empty($map['IMG']))
		{
			...
			else if (intval($map['IMG']) > 0)
			{
				$arTempFile = CFile::ResizeImageGet(
					$map['IMG'],
					array("width" => \Thurly\Main\Config\Option::get("dav", "vcard_image_width", 400), "height" => \Thurly\Main\Config\Option::get("dav", "vcard_image_width", 400)),
					BX_RESIZE_IMAGE_PROPORTIONAL,
					false,
					false,
					true,
					\Thurly\Main\Config\Option::get("dav", "vcard_image_quality", 60)
				);
			}
