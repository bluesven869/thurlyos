...
abstract class CDavExchangeClient
{
	...
	private $userAgent = 'Thurly Exchange client';
	...
	public static function InitUserEntityLoadMessages($key, $defaultMessage = "")
	{
		...
		while ($arLang = $dbLang->Fetch())
		{
			...
			$fn = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/dav/lang/".$lid."/options.php";
			$fnDef = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/dav/lang/en/options.php";
			if (file_exists($fn))
				include($fn);
					...
					else
					{
						...
						else
						{
							...
							$arFields = array(
								...
								"WORK_FAX" => "345737365",
								"WORK_COMPANY" => "Thurly",
								"WORK_WWW" => "http://www.1c-thurly.com",
