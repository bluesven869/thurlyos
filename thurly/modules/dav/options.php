					...
					if (!function_exists("__load_exchange_use_login_messages"))
					{
						function __load_exchange_use_login_messages()
						{
							...
							while ($arLang1 = $dbLang1->Fetch())
							{
								...
								$fn1 = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/dav/lang/".preg_replace("/[^a-z0-9]/i", "", $arLang1["LID"])."/options.php";
								$fnDef1 = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/dav/lang/en/options.php";
								if (file_exists($fn1))
									include($fn1);
