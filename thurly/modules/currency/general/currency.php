...
*/
	 ...
	 * @see \Thurly\Currency\CurrencyManager::getBaseCurrency
	 *
	 * @return string
	 */
	 ...
	 * @see \Thurly\Currency\CurrencyTable::getList
	 *
	 * @param string &$by
	 * @param string &$order
	 * @param string $lang
	...
	public static function __GetList(&$by, &$order, $lang = LANGUAGE_ID)
	{
		...
		$currencyIterator = Currency\CurrencyTable::getList(array(
			...
			'runtime' => array(
				'RT_LANG' => array(
					'data_type' => 'Thurly\Currency\CurrencyLang',
					'reference' => array(
	...
	/**
	 * @deprecated deprecated since currency 16.5.0
	 * @see \Thurly\Currency\CurrencyManager::getInstalledCurrencies
	 *
	 * @return array
	 */
	...
	/**
	 * @deprecated deprecated since currency 16.5.0
	 * @see \Thurly\Currency\CurrencyManager::clearCurrencyCache
	 *
	 * @return void
	 */
	...
	/**
	 * @deprecated deprecated since currency 16.5.0
	 * @see \Thurly\Currency\CurrencyManager::clearTagCache
	 *
	...
	/**
	 * @deprecated deprecated since currency 16.0.0
	 * @see \Thurly\Currency\CurrencyManager::updateBaseRates
	 *
	 * @param string $currency
	 * @return void
	 */
	...
	public static function initCurrencyBaseRateAgent()
	{
		if (!ModuleManager::isModuleInstalled('thurlyos'))
		{
			$agentIterator = CAgent::GetList(
				array(),
				array('MODULE_ID' => 'currency','=NAME' => '\Thurly\Currency\CurrencyManager::currencyBaseRateAgent();')
			);
			if ($agentIterator)
			{
	...
	/**
	 * @deprecated deprecated since currency 16.0.0
	 * @see \Thurly\Currency\CurrencyManager::updateBaseCurrency
	 *
	 * @param string $currency
	 * @return bool
	 */
