...
while ($arRes = $currencyIterator->Fetch())
{
	...
	$urlEdit = '/thurly/admin/currency_edit.php?lang='.LANGUAGE_ID.'&ID='.$arRes['CURRENCY'];
...
$aContext = array(
	array(
		...
		"LINK" => "/thurly/admin/currency_add_from_classifier.php?lang=".LANGUAGE_ID,
		"TITLE" => GetMessage("currency_add_from_classifier_title")
	),
	array(
		"ICON" => "btn_new",
		"TEXT" => GetMessage("currency_add"),
		"LINK" => "/thurly/admin/currency_edit.php?lang=".LANGUAGE_ID,
