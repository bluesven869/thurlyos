...
while ($rate = $rateIterator->Fetch())
{
	$editUrl = "/thurly/admin/currency_rate_edit.php?ID=".$rate['ID']."&lang=".LANGUAGE_ID.GetFilterParams("filter_");
...
$aContext = array(
	array(
		...
		"LINK"=>"/thurly/admin/currency_rate_edit.php?lang=".LANGUAGE_ID.GetFilterParams("filter_"),
