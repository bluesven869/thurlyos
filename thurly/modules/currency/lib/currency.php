 ...
 * <li> CREATED_BY_USER reference to {@link \Thurly\Main\UserTable}
 * <li> MODIFIED_BY_USER reference to {@link \Thurly\Main\UserTable}
 * <li> LANG_FORMAT reference to {@link \Thurly\Currency\CurrencyLangTable}
 * <li> CURRENT_LANG_FORMAT reference to {@link \Thurly\Currency\CurrencyLangTable} with current language (LANGUAGE_ID)
 * </ul>
 *
 * @package Thurly\Currency
 **/
class CurrencyTable extends Main\Entity\DataManager
{
	 ...
	 * @see \Thurly\Currency\CurrencyManager::currencyBaseRateAgent();
	 *
	 * @return string
	 */
