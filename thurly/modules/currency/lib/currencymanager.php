...
class CurrencyManager
{
	...
	public static function getBaseCurrency()
	{
		...
		{
			/** @var \Thurly\Main\Data\ManagedCache $managedCache */
	...
	public static function getInstalledCurrencies()
	{
		...
		{
			$thurlyos = Main\ModuleManager::isModuleInstalled('thurlyos');
	...
	public static function currencyBaseRateAgent()
	{
		...
		return '\Thurly\Currency\CurrencyManager::currencyBaseRateAgent();';
	}
