...
$arJSDescription = array(
	'js' => '/thurly/js/catalog/sub_generator.js',
	'css' => '/thurly/panel/catalog/sub-generator.css',
	'lang' => '/thurly/modules/catalog/lang/'.LANGUAGE_ID.'/tools/iblock_subelement_generator.php'
);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !$bReadOnly && check_thurly_sessid())
{
