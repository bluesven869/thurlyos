...
<? if (!empty($arResult['ITEMS'])): ?>
	<div class="bx_item_list_recommended col1 <? echo $templateData['TEMPLATE_CLASS']; ?>">
	<div class="bx_item_list_title"><? echo GetMessage('CATALOG_RECOMMENDED_PRODUCTS_HREF_TITLE') ?>:</div>
