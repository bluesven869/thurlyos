...
JCIBlockGenerator.prototype.addPropertyImages = function()
{
	...
	BX.ajax.post('/thurly/tools/catalog/iblock_subelement_generator.php', postData, BX.proxy(this.fPropertyImagesResult, this));
};
...
JCIBlockGenerator.prototype.fIblockInputGet = function(propertyId)
{
	...
	BX.ajax({
		'method': 'POST',
		'dataType': 'html',
		'url': '/thurly/tools/catalog/iblock_subelement_generator_ajax.php',
