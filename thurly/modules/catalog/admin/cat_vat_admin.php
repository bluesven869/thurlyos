...
while ($arVAT = $dbResultList->Fetch())
{
	...
	$arActions[] = array(
		...
		"ACTION" => $lAdmin->ActionRedirect("/thurly/admin/cat_vat_edit.php?ID=".$arVAT['ID']."&lang=".LANGUAGE_ID."&".GetFilterParams("filter_").""),
		"DEFAULT" => true
	);
...
if (!$bReadOnly)
{
	$aContext = array(
		array(
			...
			"ICON" => "btn_new",
			"LINK" => "/thurly/admin/cat_vat_edit.php?lang=".LANGUAGE_ID,
