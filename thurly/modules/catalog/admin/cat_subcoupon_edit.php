...
{
	if (!empty($_REQUEST['dontsave']) && check_thurly_sessid())
	{
		?><script type="text/javascript">
		top.BX.closeWait(); top.BX.WindowManager.Get().AllowClose(); top.BX.WindowManager.Get().Close();
		</script><?
...
if (!$boolMulti)
{
	...
	$tabControl->Begin(array(
		"FORM_ACTION" => '/thurly/admin/cat_subcoupon_edit.php?lang='.LANGUAGE_ID,
	));
...
else
{
	...
	$tabControl->EndEpilogContent();
	$tabControl->Begin(array(
		"FORM_ACTION" => '/thurly/admin/cat_subcoupon_edit.php?lang='.urlencode(LANGUAGE_ID),
	));
