...
if (!(false == B_ADMIN_SUBCOUPONS_LIST && $bCopy))
{
	...
	{
		$edit_url = '/thurly/admin/cat_subcoupon_edit.php?ID='.$arCouponDiscount['ID'].'&DISCOUNT_ID='.$intDiscountID.'&lang='.LANGUAGE_ID.'&TMP_ID='.$strSubTMP_ID;
		...
		$arActions[] = array(
			...
			"ACTION"=>"(new BX.CAdminDialog({
				'content_url': '/thurly/admin/cat_subcoupon_edit.php?ID=".$arCouponDiscount['ID']."&DISCOUNT_ID=".$intDiscountID."&lang=".LANGUAGE_ID."&TMP_ID=".$strSubTMP_ID."',
...
function ShowNewCoupons(id, multi)
{
	...
	(new BX.CAdminDialog({
		'content_url': '/thurly/admin/cat_subcoupon_edit.php',
