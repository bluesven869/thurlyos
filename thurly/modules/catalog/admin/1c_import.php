...
if($type=="sale")
{
	$APPLICATION->IncludeComponent("thurly:sale.export.1c", "", Array(
...
elseif($type=="catalog")
{
	$APPLICATION->IncludeComponent("thurly:catalog.import.1c", "", Array(
...
{
	$APPLICATION->IncludeComponent("thurly:catalog.import.hl", "", Array(
		"INTERVAL" => COption::GetOptionString("catalog", "1C_INTERVAL", "-"),
		"GROUP_PERMISSIONS" => explode(",", COption::GetOptionString("catalog", "1C_GROUP_PERMISSIONS", "")),
		"FILE_SIZE_LIMIT" => COption::GetOptionString("catalog", "1C_FILE_SIZE_LIMIT", 200*1024),
		"USE_CRC" => COption::GetOptionString("catalog", "1C_USE_CRC", "Y"),
...
{
	$APPLICATION->IncludeComponent("thurly:catalog.export.1c", "", Array(
