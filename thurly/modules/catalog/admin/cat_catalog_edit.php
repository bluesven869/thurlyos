...
)
{
	...
	if($strWarning === "")
	{
		...
		LocalRedirect("/thurly/admin/cat_catalog_edit.php?lang=".LANGUAGE_ID."&IBLOCK_ID=".$IBLOCK_ID."&".$tabControl->ActiveTabParam());
	}
}
...
$tabControl->Begin(array(
	"FORM_ACTION" => "/thurly/admin/cat_catalog_edit.php?lang=".LANGUAGE_ID."&IBLOCK_ID=".$IBLOCK_ID,
));
