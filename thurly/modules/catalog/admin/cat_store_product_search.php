...
ClearVars("s_");
$APPLICATION->AddHeadScript('/thurly/js/catalog/catalog_menu.js');
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_REQUEST["BARCODE_AJAX"]) && $_REQUEST["BARCODE_AJAX"] === 'Y' && check_thurly_sessid())
{
