...
while ($arDiscount = $dbResultList->Fetch())
{
	...
	$row->AddViewField("ID", '<a href="/thurly/admin/cat_discount_coupon_edit.php?lang='.LANGUAGE_ID.'&ID='.$arDiscount["ID"].'">'.$arDiscount["ID"].'</a>');
	...
	$arActions[] = array(
		...
		"ACTION" => $lAdmin->ActionRedirect("/thurly/admin/cat_discount_coupon_edit.php?ID=".$arDiscount['ID']."&lang=".LANGUAGE_ID.GetFilterParams("filter_", false).""),
		"DEFAULT" => true
	);
