...
?><tr>
	...
	echo GetIBlockDropDownListEx(
		...
		"ClearSelected(); BX('id_ifr').src='/thurly/tools/catalog_export/yandex_util.php?IBLOCK_ID=0&'+'".thurly_sessid_get()."';",
		"ClearSelected(); BX('id_ifr').src='/thurly/tools/catalog_export/yandex_util.php?IBLOCK_ID='+this[this.selectedIndex].value+'&'+'".thurly_sessid_get()."';",
...
<tr>
	...
	<td width="60%">
		<b><? echo htmlspecialcharsbx(COption::GetOptionString("catalog", "export_default_path", "/thurly/catalog_export/"));?></b><input type="text" name="SETUP_FILE_NAME" value="<?echo (strlen($SETUP_FILE_NAME)>0) ? htmlspecialcharsbx($SETUP_FILE_NAME) : "ebay_product_feed_".mktime().".xml" ?>" size="50" />
	</td>
</tr>
<?
