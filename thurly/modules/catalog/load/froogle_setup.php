...
?><tr>
	...
	echo GetIBlockDropDownListEx(
		...
		"ClearSelected(); BX('ifr').src='/thurly/tools/catalog_export/froogle_util.php?IBLOCK_ID=0&'+'".thurly_sessid_get()."';",
		"ClearSelected(); BX('ifr').src='/thurly/tools/catalog_export/froogle_util.php?IBLOCK_ID='+this[this.selectedIndex].value+'&'+'".thurly_sessid_get()."';",
...
<tr>
	...
	<td width="60%">
		...
		<iframe src="/thurly/tools/catalog_export/froogle_util.php?IBLOCK_ID=<?=intval($IBLOCK_ID)?>&<? echo thurly_sessid_get(); ?>" id="ifr" name="ifr" style="display:none"></iframe>
	</td>
</tr>
<tr>
