...
class CAllCatalogProduct
{
	...
	/**
	 * @deprecated deprecated since catalog 17.0.11
	 * @see \Thurly\Catalog\Product\Price\Calculation::setConfig()
	 *
	...
	/**
	 * @deprecated deprecated since catalog 17.0.11
	 * @see \Thurly\Catalog\Product\Price\Calculation::getConfig()
	 *
	 * @return null|string
	 */
	 ...
	 * @see \Thurly\Catalog\ProductTable::isExistProduct()
	 *
	 * @param int $intID
	 * @return bool
	 */
...
//		$boolDiscountVat = ('N' != COption::GetOptionString('catalog', 'discount_vat', 'Y'));
	...
	public static function GetOptimalPriceList(array $products, $arUserGroups = array(), $renewal = "N", $priceList = array(), $siteID = false, $needCoupons = true)
	{
		...
		\Thurly\Main\Type\Collection::sortByColumn($priceList, 'BASKET_CODE');
	 ...
	 * @see \Thurly\Catalog\ProductTable::getPaymentPeriods
	 *
				...
				$row = Sale\Internals\DiscountEntitiesTable::getList(array(
					...
					'runtime' => array(
						new Main\Entity\ReferenceField(
							'ACTIVE_DISCOUNT',
							'Thurly\Sale\Internals\Discount',
