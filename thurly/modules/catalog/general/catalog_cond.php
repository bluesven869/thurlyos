	...
	public static function GetControls($strControlID = false)
	{
		...
		$arControlList = array(
			'CondIBElement' => array(
				...
				'JS_VALUE' => array(
					'type' => 'multiDialog',
					'popup_url' =>  '/thurly/admin/cat_product_search_dialog.php',
					'popup_params' => array(
						'lang' => LANGUAGE_ID,
			...
			'CondIBIBlock' => array(
				...
				'JS_VALUE' => array(
					'type' => 'popup',
					'popup_url' =>  '/thurly/admin/cat_iblock_search.php',
					'popup_params' => array(
						'lang' => LANGUAGE_ID,
						'discount' => 'Y'
					),
			...
			'CondIBSection' => array(
				...
				'JS_VALUE' => array(
					'type' => 'popup',
					'popup_url' =>  '/thurly/admin/iblock_section_search.php',
					'popup_params' => array(
						'lang' => LANGUAGE_ID,
						'discount' => 'Y',
						'simplename' => 'Y'
						...
						if (isset($arProp['USER_TYPE']) && !empty($arProp['USER_TYPE']))
						{
							switch ($arProp['USER_TYPE'])
							{
								...
								case 'directory':
									...
									$arValue = array(
										'type' => 'lazySelect',
										'load_url' => '/thurly/tools/catalog/get_property_values.php',
										'load_params' => array(
											'lang' => LANGUAGE_ID,
						...
						if (!$boolUserType)
						{
							switch ($arProp['PROPERTY_TYPE'])
							{
								...
								case 'E':
									...
									$arValue = array(
										'type' => 'popup',
										'popup_url' =>  '/thurly/admin/iblock_element_search.php',
										'popup_params' => array(
											'lang' => LANGUAGE_ID,
