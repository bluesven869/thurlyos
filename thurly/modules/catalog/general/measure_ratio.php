...
class CCatalogMeasureRatioAll
{
	 ...
	 * @see \Thurly\Catalog\MeasureRatioTable::add
	 * Attention! Method \Thurly\Catalog\MeasureRatioTable::add very strict checks the input parameters.
	 *
	...
	/**
	 * @deprecated deprecated since catalog 16.0.13
	 * @see \Thurly\Catalog\MeasureRatioTable::update
	 * Attention! Method \Thurly\Catalog\MeasureRatioTable::update very strict checks the input parameters.
	 *
	...
	/**
	 * @deprecated deprecated since catalog 16.0.13
	 * @see \Thurly\Catalog\MeasureRatioTable::delete
	 *
