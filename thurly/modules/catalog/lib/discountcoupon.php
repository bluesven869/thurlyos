 ...
 * <li> DISCOUNT reference to {@link \Thurly\Catalog\DiscountTable}
 * </ul>
 *
		...
		else
		{
			...
			$result = new Main\EventResult(
				...
				array(
					...
					'getData' => array('\Thurly\Catalog\DiscountCouponTable', 'getData'),
					'isExist' => array('\Thurly\Catalog\DiscountCouponTable', 'isExist'),
					'saveApplied' => array('\Thurly\Catalog\DiscountCouponTable', 'saveApplied'),
				),
				'catalog'
			);
		}
