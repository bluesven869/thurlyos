 ...
 * <li> IBLOCK_ELEMENT reference to {@link \Thurly\Iblock\ElementTable}
...
class SubscribeTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'PRODUCT' => array(
				'data_type' => 'Thurly\Catalog\ProductTable',
	...
	public static function runAgentToSendNotice($productId)
	{
		...
		if (!static::$agentNoticeCreated)
		{
			...
			\CAgent::AddAgent(
				'\Thurly\Catalog\SubscribeTable::sendNotice();',
				'catalog',
				'N',
	...
	public static function runAgentToSendRepeatedNotice($productId)
	{
		...
		if (!static::$agentRepeatedNoticeCreated)
		{
			...
			\CAgent::AddAgent(
				'Thurly\Catalog\SubscribeTable::sendRepeatedNotice();',
				'catalog',
				'N',
				static::AGENT_INTERVAL,
				'',
	...
	public static function sendNotice()
	{
		if(static::checkLastUpdate())
			return '\Thurly\Catalog\SubscribeTable::sendNotice();';
	...
	{
		if(static::checkLastUpdate())
			return 'Thurly\Catalog\SubscribeTable::sendRepeatedNotice();';
