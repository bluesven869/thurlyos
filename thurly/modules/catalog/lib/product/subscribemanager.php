<?php
namespace Thurly\Catalog\Product;

use Thurly\Catalog\ProductTable;
use Thurly\Catalog\SubscribeAccessTable;
...
class SubscribeManager
{
	...
	public function addSubscribe(array $subscribeData)
	{
		...
		$resultObject = ProductTable::getList(array(
			'select' => array(
				'SUBSCRIBE',
				'USER_CONTACT' => 'Thurly\Catalog\SubscribeTable:PRODUCT.USER_CONTACT',
				'CONTACT_TYPE' => 'Thurly\Catalog\SubscribeTable:PRODUCT.CONTACT_TYPE',
				'DATE_TO' => 'Thurly\Catalog\SubscribeTable:PRODUCT.DATE_TO',
			),
			'filter' => array(
	...
	public function checkAccessToSubscription($subscribeId)
	{
		...
		$resultObject = SubscribeTable::getList(array(
			'select' => array(
				'USER_ID',
				'TOKEN' => 'Thurly\Catalog\SubscribeAccessTable:SUBSCRIBE.TOKEN',
			),
