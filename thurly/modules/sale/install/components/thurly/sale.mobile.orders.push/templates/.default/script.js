__thurlySalePush = function(params) {

	for(var key in params)
		this[key] = params[key];
};

__thurlySalePush.prototype.close = function()
{
		app.closeController({drop: true});
};

__thurlySalePush.prototype.getSubs = function()
{
...
__thurlySalePush.prototype.save = function()
{
