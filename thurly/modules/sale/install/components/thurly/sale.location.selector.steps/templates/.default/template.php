...
<?else:?>
	...
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_pager.js')?>
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_combobox.js')?>
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_chainedselectors.js')?>
