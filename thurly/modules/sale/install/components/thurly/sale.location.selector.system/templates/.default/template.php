...
<?else:?>
	...
	<?CJSCore::Init();?>
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_widget.js')?>
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_etc.js')?>
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_autocomplete.js');?>
	<?$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/sale/core_ui_itemtree.js');?>

	<?// to be able to launch this outside the admin section?>
	<?$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/panel/main/adminstyles_fixed.css');?>
	<?$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/panel/main/admin.css');?>
	<?$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/panel/main/admin-public.css');?>
									...
									<script type="text/html" data-template-id="bx-ui-slss-dropdown-item">
										<tr class="adm-list-table-row">
											...
											<td class="adm-list-table-cell">
												<span class="adm-list-table-link">{{display}}&nbsp;<span class="adm-list-table-loc-type">({{type}})</span>&nbsp;&nbsp;<a href="/thurly/admin/sale_location_node_edit.php?lang=<?=LANGUAGE_ID?>&id={{value}}" target="_blank" class="adm-list-table-loc-id">id: {{value}}</a></span>
								...
								<tbody class="bx-ui-slss-selected-groups">
									<script type="text/html" data-template-id="bx-ui-slss-selected-group">
										<tr class="adm-list-table-row">
											...
											<td class="adm-list-table-cell">
												<span class="adm-list-table-link">{{name}}&nbsp;&nbsp;<a href="/thurly/admin/sale_location_node_edit.php?lang=<?=LANGUAGE_ID?>&id={{id}}" target="_blank" class="adm-list-table-loc-id">id: {{id}}</a></span>
											</td>
										</tr>
									</script>
								</tbody>
