...
use \Thurly\Main\SystemException as SystemException;
use \Thurly\Main\Loader as Loader;
if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die();

Loc::loadMessages(__FILE__);

class CSaleBusinessValueMail extends CThurlyComponent
{
	protected function getBusinessValueByOrderId($orderId, $providerCode, $fieldCode, $fieldGroup = null)
	{
		...
		$order = \Thurly\Sale\Order::loadByAccountNumber($orderId);
		...
		$providerList = \Thurly\Sale\BusinessValue::getProviders();
