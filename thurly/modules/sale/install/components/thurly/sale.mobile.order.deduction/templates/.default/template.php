...
<script type="text/javascript">
	...
	var bsmode = new __ThurlySaleMODE(jsParams);
	...
	BX.addCustomEvent('onThurlySaleMOSResult', function(params) { bsmode.setProductStores(params);});
	BX.addCustomEvent('onThurlySaleMOBResult', function(params) { bsmode.setProductBarcodes(params); });
	BX.addCustomEvent("onThurlySaleMOSLoaded", function (params) {
		app.onCustomEvent('onThurlySaleMOSGetInfo', bsmode.getProductStores(params.productId) );
	});
	BX.addCustomEvent("onThurlySaleMOBLoaded", function (params) {
		app.onCustomEvent('onThurlySaleMOBGetInfo', bsmode.getProductInfo(params.productId) );
	});
