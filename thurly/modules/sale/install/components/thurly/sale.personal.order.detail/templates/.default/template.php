...
{
	Asset::getInstance()->addJs("/thurly/components/thurly/sale.order.payment.change/templates/.default/script.js");
	Asset::getInstance()->addCss("/thurly/components/thurly/sale.order.payment.change/templates/.default/style.css");
}
											...
											<div class="col-md-12 col-sm-12 col-xs-12 sale-order-detail-payment-options-methods">
												<div class="row sale-order-detail-payment-options-methods-information-block">
													...
													<span class="sale-order-detail-payment-options-methods-image-element"
														  style="background-image: url('<?=strlen($payment['PAY_SYSTEM']["SRC_LOGOTIP"]) ? htmlspecialcharsbx($payment['PAY_SYSTEM']["SRC_LOGOTIP"]) : '/thurly/images/sale/nopaysystem.gif'?>');"></span>
													</div>
