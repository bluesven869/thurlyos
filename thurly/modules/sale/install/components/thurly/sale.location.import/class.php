...
use Thurly\Sale\Location\Admin\TypeHelper;
use Thurly\Sale\Location\Admin\ExternalServiceHelper;

use Thurly\Sale\Location\Import;
use Thurly\Sale\Location\Search\Finder;

Loc::loadMessages(__FILE__);

class CThurlySaleLocationImportComponent extends CThurlyComponent
{
