...
use Thurly\Sale\Discount\Gift\RelatedDataTable;
...
class CSaleGiftSectionComponent extends CCatalogViewedProductsComponent
{
	...
	private function getGiftData()
	{
		...
		$query = new \Thurly\Main\Entity\Query(RelatedDataTable::getEntity());
		...
		while($row = $dbResult->fetch())
		{
			...
			list($productElementIds, $productSectionIds) = Thurly\Sale\Discount\Gift\RelatedDataTable::getGiftsData($discounts[$row['ID']]);
