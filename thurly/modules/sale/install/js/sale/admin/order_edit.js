			...
			children: [
				BX.create('span',{
					style: {
						...
						left:"85%",
						position: "fixed",
						background: 'url("/thurly/panel/main/images/submenu-bg.png") repeat 0 0',
						padding: "15px",
						borderRadius: "5px",
						fontSize: "14px",
	...
	changeCancelBlock: function(orderId, params)
	{
		...
		if(params.CANCELED == "Y")
		{
			newBlockContent = '<div class="adm-s-select-popup-element-selected-bad">' +
				...
				'<a href="/thurly/admin/user_edit.php?lang='+BX.Sale.Admin.OrderEditPage.languageId+'&ID='+params.EMP_CANCELED_ID+'">'+
