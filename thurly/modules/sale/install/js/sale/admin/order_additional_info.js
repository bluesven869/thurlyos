...
BX.Sale.Admin.OrderAdditionalInfo =
{
	...
	{
		window.open(
			'/thurly/admin/user_search.php?lang='+languageId+'&FN='+formName+'&FC=RESPONSIBLE_ID',
			'',
	...
	changePerson: function()
	{
		...
		if(node)
			node.href = '/thurly/admin/user_edit.php?lang='+BX.Sale.Admin.OrderEditPage.languageId+'&ID='+responsibleId;
