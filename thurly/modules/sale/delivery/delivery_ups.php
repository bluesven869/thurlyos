...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/sale/delivery/delivery_ups.php');
		...
		$arConfig = array(
			...
			"CONFIG" => array(
				"zones_csv" => array(
					...
					"DEFAULT" => "/thurly/modules/sale/delivery/ups/ru_csv_zones.csv",
					"GROUP" => "tariff_tables",
				),
				...
				"export_csv" => array(
					...
					"DEFAULT" => "/thurly/modules/sale/delivery/ups/ru_csv_export.csv",
					"GROUP" => "tariff_tables",
				),
			),
		);
