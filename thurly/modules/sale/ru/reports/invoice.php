...
/*
Скопируйте этот файл в папку /thurly/admin/reports и измените по своему усмотрению
...
<!-- REPORT BODY -->
<!-- ИЗМЕНИТЕ ЭТОТ ТЕКСТ НА РЕАЛЬНЫЕ ДАННЫЕ ПОСЛЕ КОПИРОВАНИЯ В ПАПКУ /thurly/admin/reports -->
<p><b>ПОСТАВЩИК:</b>
...
<p><b>ЗАКАЗЧИК: </b>
<!-- ИЗМЕНИТЕ КЛЮЧИ МАССИВА $arOrderProps НА РЕАЛЬНЫЕ ПОСЛЕ КОПИРОВАНИЯ В ПАПКУ /thurly/admin/reports -->
<?
if(empty($arParams))
{
		...
		foreach ($arBasketOrder as $arBasket)
		{
			...
			<tr valign="top">
				...
				<td align="right" bgcolor="#ffffff" style="border: 1pt solid #000000; border-right:none; border-top:none;">
					<?echo Thurly\Sale\BasketItem::formatQuantity($arQuantities[$mi]); ?>
				</td>
				<td align="right" bgcolor="#ffffff" style="border: 1pt solid #000000; border-right:none; border-top:none;">
