...
$MESS["SWMPP_DDESCR"] = "Оплата через WebMoney с помощью сервиса Click&Buy Merchant Interface <a href=\"https://merchant.webmoney.ru/conf/guide_pci.asp\" target=\"_blank\">https://merchant.webmoney.ru/conf/guide_pci.asp</a>. Перед использованием необходимо скопировать файл /thurly/modules/sale/payment/webmoney_pci/result.php куда-либо в публичную часть сайта и задать путь к нему в соответствующем свойстве.";
