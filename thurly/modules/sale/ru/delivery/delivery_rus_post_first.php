...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/sale/delivery/delivery_rus_post_first.php');
...
class CDeliveryRusPostFirst
{
	...
	public static function getTarifNumFromCsv(array $arShopLocation)
	{
		...
		$dbRes = \Thurly\Sale\Location\LocationTable::getById($arShopLocation["REGION_ID"]);
