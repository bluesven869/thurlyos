...
Loader::registerAutoLoadClasses(
	'sale',
	array(
		'Thurly\\Sale\\Delivery\\Pecom\\Request' => 'ru/delivery/pecom/request.php',
		'Thurly\\Sale\\Delivery\\Pecom\\Adapter' => 'ru/delivery/pecom/adapter.php',
		'Thurly\\Sale\\Delivery\\Pecom\\Calculator' => 'ru/delivery/pecom/calculator.php',
		'Thurly\\Sale\\Delivery\\Pecom\\Location' => 'ru/delivery/pecom/location.php'
	)
);

use Thurly\Sale\Delivery\Pecom\Adapter;
use Thurly\Sale\Delivery\Pecom\Request;
use Thurly\Sale\Delivery\Pecom\Calculator;
use Thurly\Sale\Delivery\Pecom\Location;

IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/sale/delivery/delivery_pecom.php');
...
class CDeliveryPecom
{
	...
	protected static function getRequestSelfSentDate($shipmentId)
	{
		...
		if(!isset($result[$shipmentId]))
		{
			...
			$dbRes = \Thurly\Sale\Internals\OrderDeliveryReqTable::getList(array(
	...
	public function processAdditionalInfoShipmentEdit(Shipment $shipment, array $requestData)
	{
		...
		$dt = new \Thurly\Main\Type\DateTime();
		...
		$res = \Thurly\Sale\Internals\OrderDeliveryReqTable::add(
			array(
