<?
namespace Thurly\Sale\Delivery\Pecom;
...
use Thurly\Sale\Delivery\ExternalLocationMap;

Loader::registerAutoLoadClasses(
	'sale',
	array(
		'Thurly\\Sale\\Delivery\\Pecom\\Replacement' => 'ru/delivery/pecom/replacement.php'
	)
);

/**
 * Class Location
 * @package Thurly\Sale\Delivery\Pecom
 */
class Location extends ExternalLocationMap
{
	const EXTERNAL_SERVICE_CODE = 'PECOM';
	const CSV_FILE_PATH = '/thurly/modules/sale/ru/delivery/pecom/location.csv';
