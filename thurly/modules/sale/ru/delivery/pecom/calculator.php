...
class Calculator
{
	...
	protected function parseCalcResult($jsonInfo)
	{
		...
		if(is_array($arInfo) && !empty($arInfo))
		{
			if(strtolower(SITE_CHARSET) != 'utf-8')
				$arInfo = \Thurly\Main\Text\Encoding::convertEncodingArray($arInfo, 'UTF-8', SITE_CHARSET);
	...
	protected static function send($strParams)
	{
		...
		$jsnData = $http->post("http://www.pecom.ru/thurly/components/pecom/calc/ajax.php", $strParams);
