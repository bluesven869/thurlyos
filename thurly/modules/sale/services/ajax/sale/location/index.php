...
if(!isset($arResult["ERROR"]) && check_thurly_sessid())
{
	...
	switch ($action)
	{
		case "getRegionList":
			...
			$arResult["DATA"] = \Thurly\Sale\SalesZone::getRegions($countryIds, $lang);
		...
		case "getCityList":
			...
			$arResult["DATA"] = \Thurly\Sale\SalesZone::getCities($countryIds, $regionIds, $lang);
			break;
	}
}
else
