...
use Thurly\Sale\Location\Search;
...
final class LocationTable extends Tree
{
	...
	*
	* @return Thurly\Main\DB\Result location
	*/
	...
	*	</ul>
	*
	* @return \Thurly\Main\Entity\AddResult the result of add operation
	*/
	...
	*	</ul>
	*
	* @return \Thurly\Main\Entity\UpdateResult the result of update operation
	*/
	...
	*/
	...
	public static function getMap()
	{
		return array(
			...
			'NAME' => array(
				'data_type' => 'Thurly\Sale\Location\Name\Location',
				'reference' => array(
			...
			'DEFAULT_SITE' => array(
				'data_type' => 'Thurly\Sale\Location\DefaultSite',
				'reference' => array(
			...
			'DEFAULT_SORT' => array(
				'data_type' => 'Thurly\Sale\Location\DefaultSiteTable',
				'reference' => array(
					'=this.CODE' => 'ref.LOCATION_CODE'
				)
			),
	...
	public static function getListFast($parameters = array())
	{
		...
		return \Thurly\Sale\Location\Search\Finder::find($parameters, array('USE_INDEX' => false, 'USE_ORM' => false));
	}
}
