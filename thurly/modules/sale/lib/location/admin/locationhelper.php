...
namespace Thurly\Sale\Location\Admin;
...
final class LocationHelper extends NameHelper
{
	...
	*/
	public function getEntityRoadMap()
	{
		return array(
			'main' => array(
				'name' => 'Thurly\Sale\Location\Location',
				'pages' => array(
					'list' => array(
			...
			'name' => array(
				'name' => 'Thurly\Sale\Location\Name\Location',
				'pages' => array(
					'list' => array(
			...
			'external' => array(
				'name' => 'Thurly\Sale\Location\External',
				'pages' => array(
					'detail' => array(
	...
	{
		return \Thurly\Main\Config\Option::get('sale', 'sale_locationpro_import_performed', '') == 'Y';
	}
	...
	public static function getLocationSubMenu()
	{
		...
		if(!$id)
		{
			...
			if($page == '/thurly/admin/'.self::LIST_PAGE_URL || $page == '/thurly/admin/'.self::EDIT_PAGE_URL)
			{
				$requiredToShow = true;
	...
	public static function getLocationsByZip($zip, $parameters = array())
	{
		...
		return \Thurly\Sale\Location\ExternalTable::getList($parameters);
	}
