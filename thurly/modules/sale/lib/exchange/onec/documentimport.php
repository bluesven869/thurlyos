...
class DocumentImport
{
    ...
    {
        return Main\Localization\Loc::loadLanguageFile($_SERVER["DOCUMENT_ROOT"].'/thurly/components/thurly/sale.export.1c/component.php');
    }
        ...
        foreach(static::getFieldsInfo() as $k=>$v)
        {
            switch($k)
            {
                ...
                case 'AGENT':
                    ...
                    $mess = Main\Localization\Loc::loadLanguageFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/sale/general/export.php');
