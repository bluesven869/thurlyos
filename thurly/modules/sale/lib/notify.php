...
class Notify
{
	...
	public static function sendOrderNew(Internals\Entity $entity)
	{
		...
		{
			throw new Main\ArgumentTypeException('entity', '\Thurly\Sale\Order');
		}
	...
	public static function sendShipmentStatusChange(Internals\Entity $entity)
	{
		...
		{
			throw new Main\ArgumentTypeException('entity', '\Thurly\Sale\Shipment');
		}
		...
		$statusData = Internals\StatusTable::getList(array(
								 ...
								 'filter' => array(
									 ...
									 '=Thurly\Sale\Internals\StatusLangTable:STATUS.LID' => $siteData['LANGUAGE_ID'],
	...
	public static function sendPrintableCheck(Internals\Entity $entity)
	{
		...
		{
			throw new Main\ArgumentTypeException('entity', '\Thurly\Sale\Payment');
		}
