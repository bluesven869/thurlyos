		...
		if ($systemShipment->needReservation() && $canReserve)
		{
			...
			)
			{
				Internals\ActionEntity::add(
					...
					Internals\ActionEntity::ACTION_ENTITY_SHIPMENT_COLLECTION_RESERVED_QUANTITY,
					array(
						'METHOD' => 'Thurly\Sale\ShipmentCollection::updateReservedFlag',
...
//			}
	...
	public function createClone(\SplObjectStorage $cloneEntity)
	{
		...
		/** @var \Thurly\Sale\Delivery\Services\Manager $deliveryService */
	...
	{
		return array(
			'PROVIDER_BASKET_ITEM_WRONG_AVAILABLE_QUANTITY' => array('\Thurly\Sale\Shipment', "fixReserveErrors"),
			'SALE_PROVIDER_RESERVE_SHIPMENT_ITEM_WRONG_AVAILABLE_QUANTITY' => array('\Thurly\Sale\Shipment', "fixReserveErrors"),
			'PROVIDER_UNRESERVE_SHIPMENT_ITEM_WRONG_AVAILABLE_QUANTITY' => array('\Thurly\Sale\Shipment', "fixReserveErrors"),
			'SALE_PROVIDER_RESERVE_SHIPMENT_ITEM_QUANTITY_NOT_ENOUGH' => array('\Thurly\Sale\Shipment', "fixReserveErrors"),

			'SALE_PROVIDER_SHIPMENT_SHIPPED_LESS_QUANTITY' => array('\Thurly\Sale\Shipment', "fixShipErrors"),
			'SALE_PROVIDER_SHIPMENT_SHIPPED_MORE_QUANTITY' => array('\Thurly\Sale\Shipment', "fixShipErrors"),
			'DDCT_DEDUCTION_QUANTITY_STORE_ERROR' => array('\Thurly\Sale\Shipment', "fixShipErrors"),
			'SALE_PROVIDER_SHIPMENT_QUANTITY_NOT_ENOUGH' => array('\Thurly\Sale\Shipment', "fixShipErrors"),
			'DDCT_DEDUCTION_QUANTITY_ERROR' => array('\Thurly\Sale\Shipment', "fixShipErrors"),
		);
	}
