...
namespace Thurly\Sale\Company\Inputs;
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/lib/internals/input.php");

use Thurly\Sale\Internals\CompanyLocationTable;
	...
	public static function getEditHtml($name, array $input, $values = null)
	{
		...
		$result = '
			<script>
				...
				{
					BX.loadScript("/thurly/js/sale/core_ui_etc.js", bxInputcompanyLocMultiStep2CB);
					BX.loadScript("/thurly/js/sale/core_ui_autocomplete.js", bxInputcompanyLocMultiStep2CB);
					BX.loadScript("/thurly/js/sale/core_ui_itemtree.js", bxInputcompanyLocMultiStep2CB);
				};

				BX.loadScript("/thurly/js/sale/core_ui_widget.js", bxInputcompanyLocMultiStep2);
