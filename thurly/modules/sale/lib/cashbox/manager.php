...
use Thurly\Sale\Cashbox\Internals\CashboxConnectTable;
use Thurly\Sale\Cashbox\Internals\CashboxTable;
use Thurly\Sale\Cashbox\Internals\CashboxZReportTable;
...
final class Manager
{
	...
	const CACHE_ID = 'THURLY_CASHBOX_LIST';
	const TTL = 31536000;
	const CHECK_STATUS_AGENT = '\Thurly\Sale\Cashbox\Manager::updateChecksStatus();';
	...
	public static function getConnectionLink()
	{
		...
		return sprintf('%s://%s%s/thurly/tools/sale_check_print.php?hash=%s', $scheme, $domain, $port, static::generateHash());
	}
	...
	public static function add(array $data)
	{
		...
		if (is_subclass_of($data['HANDLER'], '\Thurly\Sale\Cashbox\ICheckable'))
		{
