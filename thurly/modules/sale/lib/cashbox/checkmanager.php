...
final class CheckManager
{
	...
	{
		$checkList = array(
			'\Thurly\Sale\Cashbox\SellCheck',
			'\Thurly\Sale\Cashbox\SellReturnCashCheck',
			'\Thurly\Sale\Cashbox\SellReturnCheck'
		);
		...
		if (Manager::isSupportedFFD105())
		{
			$checkList = array_merge(
				$checkList,
				array(
					'\Thurly\Sale\Cashbox\AdvancePaymentCheck',
					'\Thurly\Sale\Cashbox\AdvanceReturnCheck',
					'\Thurly\Sale\Cashbox\AdvanceReturnCashCheck',
					'\Thurly\Sale\Cashbox\CreditPaymentCheck',
					'\Thurly\Sale\Cashbox\CreditCheck',
					'\Thurly\Sale\Cashbox\CreditReturnCheck',
				)
			);
		}
