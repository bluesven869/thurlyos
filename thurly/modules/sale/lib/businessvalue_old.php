...
use	Thurly\Sale\Internals\Input,
	Thurly\Sale\Internals\BusinessValueTable,
	Thurly\Sale\Internals\BusinessValueCodeTable,
	Thurly\Sale\Internals\BusinessValueGroupTable,
	Thurly\Sale\Internals\BusinessValueParentTable,
	Thurly\Sale\Internals\BusinessValueCodeParentTable,
	Thurly\Sale\Internals\BusinessValuePersonDomainTable,

	Thurly\Sale\Order,
	Thurly\Sale\Payment,
	Thurly\Sale\Shipment,
	Thurly\Sale\Internals\CompanyTable,

	Thurly\Sale\Internals\OrderTable,
	Thurly\Sale\Internals\PaymentTable,
	Thurly\Sale\Internals\ShipmentTable,
	Thurly\Sale\Internals\OrderPropsValueTable,
	Thurly\Sale\Internals\PersonTypeTable,
...
final class BusinessValueOld
{
	...
	static function import1CProfiles()
	{
		...
		return BusinessValue::install('1C_INTEGRATION', '/thurly/modules/sale/1c_integration_codes.php', array(
	...
	{
		var_dump(\Thurly\Sale\BusinessValue::install('BASIC', null, array(
			'PERSON_DOMAIN' => array(
		...
		var_dump(\Thurly\Sale\BusinessValue::install('OTHER', null, array(
			'PERSON_DOMAIN' => array(
				1 => BusinessValue::INDIVIDUAL_DOMAIN,
				2 => BusinessValue::ENTITY_DOMAIN,
			),
		...
		var_dump(\Thurly\Sale\BusinessValue::install('COMMON', null, array(
			'PERSON_DOMAIN' => array(
				1 => BusinessValue::INDIVIDUAL_DOMAIN,
				2 => BusinessValue::ENTITY_DOMAIN,
			),
	...
	{
		var_dump(BusinessValue::install('PAYSYSTEM_WEBMONEY', '/thurly/modules/sale/lib/payment_system_webmoney.php', array(
			'GROUPS' => array(
		...
		var_dump(BusinessValue::install('PAYSYSTEM_SBERBANK', '/thurly/modules/sale/lib/payment_system_sberbank.php', array(
			'GROUPS' => array(
				'COMPANY' => array('SORT' => 100),
				'CLIENT'  => array('SORT' => 200),
			),
