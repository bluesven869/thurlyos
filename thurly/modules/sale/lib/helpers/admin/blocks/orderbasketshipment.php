...
class OrderBasketShipment extends OrderBasket
{
	...
	public function prepareData(array $inParams = array())
	{
		...
		{
			/** @var \Thurly\Sale\Shipment $systemShipment */
	...
	/**
	 * @param \Thurly\Sale\ShipmentItemCollection $shipmentItemCollection
	 * @return array
	...
	public function getProductsInfo($shipmentItemCollection)
	{
		...
		foreach($shipmentItemCollection as $item)
		{
			...
			if ($basketItem)
			{
				...
				{
					/** @var \Thurly\Sale\ShipmentItemCollection $systemShipmentItemCollection */
				...
				/** @var \Thurly\Sale\ShipmentItemStore $barcode */
				...
				/** @var \Thurly\Sale\BasketPropertyItem $property */
	...
	public function getScripts($recoveryData = array())
	{
		if(!static::$jsInited)
		{
			\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/js/sale/admin/order_basket.js");
	...
	public static function updateData(Order &$order, &$shipment, $shipmentBasket)
	{
		...
		foreach ($shipmentItemCollection as $shipmentItem)
		{
			...
			/** @var \Thurly\Sale\ShipmentItemStore $shipmentItemStore */
		...
		foreach ($shippingItems as $shippingItem)
		{
			...
			if (!empty($shippingItem['BARCODE']) && self::$useStoreControl)
			{
				...
				/** @var \Thurly\Sale\ShipmentItemStoreCollection $shipmentItemStoreCollection */
				$shipmentItemStoreCollection = $shipmentItem->getShipmentItemStoreCollection();
				if (!$basketItem->isBarcodeMulti())
				{
					/** @var Result $r */
