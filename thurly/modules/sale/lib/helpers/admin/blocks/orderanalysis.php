...
use Thurly\Main;
use Thurly\Sale\Company;
use Thurly\Sale\Delivery\Requests\ShipmentTable;
					...
					<div class="adm-bus-orderdocs-threelist-block-top<?=$selectPayment === null ? ' adm-bus-orderdocs-threelist-block-children-open' : ''?>">
						...
						<div class="adm-bus-orderdocs-threelist-block-content">
							<div class="adm-bus-orderdocs-threelist-block-title">
								<a class="adm-bus-orderdocs-threelist-block-title-link fwb" href="/thurly/admin/sale_order_edit.php?lang=ru&ID=<?=$orderId;?>">
							...
							<div class="adm-bus-orderdocs-threelist-block-content">
								<div class="adm-bus-orderdocs-threelist-block-title">
									<?if ($isPayment):
										...
										<?endif?>
											<? if ($isAllowCompany): ?>
											<a href="/thurly/admin/sale_order_payment_edit.php?order_id=<?=$orderId?>&payment_id=<?=$documentId?>" class="adm-bus-orderdocs-threelist-block-title-link">
									...
									?>
										...
										<?endif?>
										<? if ($isAllowCompany): ?>
										<a href="/thurly/admin/sale_order_shipment_edit.php?order_id=<?=$orderId?>&shipment_id=<?=$documentId?>"
			...
			?>
				<div class="adm-bus-orderdocs-threelist-block-children" style="padding-left: 60px;">
					<div class="adm-bus-orderdocs-threelist-block-img adm-bus-orderdocs-threelist-block-img-doc_shipping"></div>
						<div class="adm-bus-orderdocs-threelist-block-content">
							<div class="adm-bus-orderdocs-threelist-block-title">
								<a href="/thurly/admin/sale_delivery_request_view.php?lang=<?=LANGUAGE_ID?>&ID=<?=$request['REQUEST_ID']?>" class="adm-bus-orderdocs-threelist-block-title-link">
		...
		<?if ($userName) :?>
			<div class="adm-bus-orderdocs-threelist-block-responsible-block">
				...
				<a class="adm-bus-orderdocs-threelist-block-responsible-name"
				   href="/thurly/admin/user_edit.php?ID=<?=$userId?>"><?=htmlspecialcharsbx($userName)?></a>
			</div>
		<?endif;?>
		<?
	}
