...
class OrderInfo
{
	...
	{
		\Thurly\Main\Page\Asset::getInstance()->addJs("/thurly/js/sale/admin/order_info.js");
	...
	protected static function getPaymentsInfo(Order $order)
	{
		...
		/** @var $payment \Thurly\Sale\Payment  */
	...
	protected static function getShipmentsInfo(Order $order)
	{
		...
		foreach($shipments as $shipment)
		{
			...
			/** @var \Thurly\Sale\Delivery\Services\Base  $deliveryService */
