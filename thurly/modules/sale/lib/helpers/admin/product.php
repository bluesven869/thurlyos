...
use Thurly\Iblock\PropertyTable;
...
class Product
{
	...
	private function completeResultData()
	{
		...
		foreach($this->resultData as $productId => $productData)
		{
			...
			$this->resultData[$productId]["PRODUCT_PROVIDER_CLASS"] = '\Thurly\Catalog\Product\CatalogProvider';
	...
	{
		$dbRes = \Thurly\Catalog\MeasureRatioTable::getList(array(
			'select' => array('*'),
