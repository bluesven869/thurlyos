...
class EntityMarker
{
	...
	{
		return array(
			static::ENTITY_TYPE_ORDER => '\Thurly\Sale\Order',
			static::ENTITY_TYPE_BASKET_ITEM => '\Thurly\Sale\BasketItem',
			static::ENTITY_TYPE_SHIPMENT => '\Thurly\Sale\Shipment',
			static::ENTITY_TYPE_PAYMENT => '\Thurly\Sale\Payment',
			static::ENTITY_TYPE_PROPERTY_VALUE => '\Thurly\Sale\PropertyValue',
		);
	}
