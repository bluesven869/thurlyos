...
class Manager
{
	...
	public static function archiveOnAgent($limit, $maxTime = null)
	{
		...
		{
			\CAgent::AddAgent("\\Thurly\\Sale\\Archive\\Manager::archiveOnAgent(".$limit.",".$maxTime.");", "sale", "N", 24*60*60, "", "Y");
		}

		return "\\Thurly\\Sale\\Archive\\Manager::archiveOnAgent(".$limit.",".$maxTime.");";
	}
	...
	public static function returnArchivedOrder($id)
	{
		...
		$recoveryName = "\\Thurly\\Sale\\Archive\\Recovery\\Version" . $orderFields['VERSION'];
