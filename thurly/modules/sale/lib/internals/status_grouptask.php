...
class StatusGroupTaskTable extends Main\Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			new Main\Entity\ReferenceField('STATUS', 'Thurly\Sale\Internals\StatusTable',
				array('=this.STATUS_ID' => 'ref.ID'),
				array('join_type' => 'LEFT')
			),

			new Main\Entity\ReferenceField('GROUP', 'Thurly\Main\GroupTable',
				array('=this.GROUP_ID' => 'ref.ID'),
				array('join_type' => 'INNER')
			),

			new Main\Entity\ReferenceField('TASK', 'Thurly\Main\TaskTable',
