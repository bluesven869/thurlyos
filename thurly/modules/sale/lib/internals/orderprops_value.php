...
class OrderPropsValueTable extends DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'VALUE' => array(
				'data_type' => 'string',
				'validation'              => array('Thurly\Sale\Internals\OrderPropsTable', 'getValueValidators'),
				'save_data_modification'  => array('Thurly\Sale\Internals\OrderPropsTable', 'getValueSaveModifiers'),
				'fetch_data_modification' => array('Thurly\Sale\Internals\OrderPropsTable', 'getValueFetchModifiers'),
			),
			'CODE' => array(
				'data_type' => 'string',
