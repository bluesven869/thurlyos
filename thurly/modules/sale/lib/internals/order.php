...
class OrderTable extends Main\Entity\DataManager
{
	...
	public static function getMap()
	{
		...
		return array(
			...
			new Main\Entity\ReferenceField(
				'STATUS',
				'Thurly\Sale\Internals\StatusLang',
				array(
			...
			new Main\Entity\ReferenceField(
				'SHIPMENT',
				'Thurly\Sale\Internals\Shipment',
				array(
					'=ref.ORDER_ID' => 'this.ID',
				)
			),
			...
			new Main\Entity\ReferenceField(
				'PROPERTY',
				'Thurly\Sale\Internals\OrderPropsValue',
				array(
					'=ref.ORDER_ID' => 'this.ID',
				),
				array('join_type' => 'INNER')
			...
			new Main\Entity\ReferenceField(
				'ORDER_COUPONS',
				'Thurly\Sale\Internals\OrderCoupons',
				array(
					'=ref.ORDER_ID' => 'this.ID',
				),
			...
			new Main\Entity\ReferenceField(
				'ORDER_DISCOUNT_DATA',
				'Thurly\Sale\Internals\OrderDiscountData',
				array(
					'=ref.ORDER_ID' => 'this.ID',
