...
class EventActions
{
	...
	const ENTITY_ORDER = '\Thurly\Sale\Order';
	const ENTITY_SHIPMENT = '\Thurly\Sale\Shipment';
	const ENTITY_PAYMENT = '\Thurly\Sale\Payment';
	...
	public static function getEventNotifyMap()
	{
		return array(
			static::EVENT_ON_ORDER_SAVED => array(
				...
				"METHOD" => array('\Thurly\Sale\Notify', "sendOrderNew"),
			),
			static::EVENT_ON_ORDER_CANCELED => array(
				"ENTITY" => static::ENTITY_ORDER,
				"METHOD" => array('\Thurly\Sale\Notify', "sendOrderCancel"),
			),
			static::EVENT_ON_ORDER_PAID => array(
				"ENTITY" => static::ENTITY_ORDER,
				"METHOD" => array('\Thurly\Sale\Notify', "sendOrderPaid"),
			),

			static::EVENT_ON_ORDER_STATUS_CHANGE => array(
				"ENTITY" => static::ENTITY_ORDER,
				"METHOD" => array('\Thurly\Sale\Notify', "sendOrderStatusChange"),
			),
			static::EVENT_ON_SHIPMENT_TRACKING_NUMBER_CHANGE => array(
				"ENTITY" => static::ENTITY_SHIPMENT,
				"METHOD" => array('\Thurly\Sale\Notify', "sendShipmentTrackingNumberChange"),
			),
			static::EVENT_ON_SHIPMENT_ALLOW_DELIVERY => array(
				"ENTITY" => static::ENTITY_SHIPMENT,
				"METHOD" => array('\Thurly\Sale\Notify', "sendShipmentAllowDelivery"),
			),
			static::EVENT_ON_SHIPMENT_STATUS_CHANGE => array(
				"ENTITY" => static::ENTITY_SHIPMENT,
				"METHOD" => array('\Thurly\Sale\Notify', "sendShipmentStatusChange"),
			),

			static::EVENT_ON_ORDER_STATUS_ALLOW_PAY_CHANGE => array(
				"ENTITY" => static::ENTITY_ORDER,
				"METHOD" => array('\Thurly\Sale\Notify', "sendOrderAllowPayStatusChange"),
			),

			static::EVENT_ON_CHECK_PRINT => array(
				"ENTITY" => static::ENTITY_PAYMENT,
				"METHOD" => array('\Thurly\Sale\Notify', "sendPrintableCheck"),
			),
