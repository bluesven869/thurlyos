...
abstract class Base
{
	 ...
	 * @return float
	 * @deprecated
	 * use \Thurly\Sale\Delivery\ExtraServices\Base::getPriceShipment()
	 */
	...
	{
		return $this->className == '\Thurly\Sale\Delivery\ExtraServices\Store';
	}
	 ...
	 * @return float
	 * @deprecated
	 * use \Thurly\Sale\Delivery\ExtraServices\Base::getCostShipment()
	 */
