...
namespace Thurly\Sale\Delivery\ExtraServices;
...
use Thurly\Sale\Internals\ShipmentExtraServiceTable;
...
class Manager
{
	...
	const STORE_PICKUP_CODE = 'THURLY_STORE_PICKUP';
	const STORE_PICKUP_CLASS = '\Thurly\Sale\Delivery\ExtraServices\Store';
	...
	public static function initClassesList()
	{
		...
		$classes = array(
			'\Thurly\Sale\Delivery\ExtraServices\Enum' => 'lib/delivery/extra_services/enum.php',
			'\Thurly\Sale\Delivery\ExtraServices\Store' => 'lib/delivery/extra_services/store.php',
			'\Thurly\Sale\Delivery\ExtraServices\String' => 'lib/delivery/extra_services/string.php',
			'\Thurly\Sale\Delivery\ExtraServices\Quantity' => 'lib/delivery/extra_services/quantity.php',
			'\Thurly\Sale\Delivery\ExtraServices\Checkbox' => 'lib/delivery/extra_services/checkbox.php'
		);

		\Thurly\Main\Loader::registerAutoLoadClasses('sale', $classes);
		Services\Manager::getHandlersList();
		unset($classes['\Thurly\Sale\Delivery\ExtraServices\Store']);
	...
	public function addItem($params, $currency, $value = null, array $additionalParams = array())
	{
		...
		if(!($item instanceof Base))
			throw new SystemException("Class ".$params["CLASS_NAME"].' must extends \Thurly\Sale\Delivery\ExtraServices\Base');
	 ...
	 * @deprecated
	 * @use \Thurly\Sale\Delivery\ExtraServices\Manager::getTotalCostShipment()
	 */
...
\Thurly\Sale\Delivery\ExtraServices\Manager::initClassesList();