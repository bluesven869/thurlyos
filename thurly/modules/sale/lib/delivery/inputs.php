...
namespace Thurly\Sale\Delivery\Inputs;
...
use Thurly\Sale\Delivery\DeliveryLocationTable;
...
class Period extends Input\Base
{
	...
	protected static function checkArgs(array $input, array $values)
	{
		...
		if(!isset($values["FROM"]) || !isset($values["TO"]) || !isset($values["TYPE"]))
			throw new \Thurly\Main\ArgumentException("Wrong argument structure!", "values");
...
class LocationMulti extends Input\Base
{
	public static function getViewHtml(array $input, $value = null)
	{
		...
		$res = \Thurly\Sale\Delivery\DeliveryLocationTable::getConnectedLocations(
			$input["DELIVERY_ID"],
			array(
	...
	public static function getEditHtml($name, array $input, $values = null)
	{
		...
		$APPLICATION->IncludeComponent(
			"thurly:sale.location.selector.system",
			"",
			array(
				"ENTITY_PRIMARY" => $input["DELIVERY_ID"],
				"LINK_ENTITY_NAME" => \Thurly\Sale\Delivery\Services\Manager::getLocationConnectorEntityName(),
				"INPUT_NAME" => $name
			),
			false
		);
		...
		$result = '
			<script type="text/javascript">				
				...
				{				
					BX.loadScript("/thurly/components/thurly/sale.location.selector.system/templates/.default/script.js", function(){
				...
				{									
					BX.load([
						"/thurly/js/sale/core_ui_etc.js", 
						"/thurly/js/sale/core_ui_autocomplete.js", 
						"/thurly/js/sale/core_ui_itemtree.js"
						], 
						bxInputdeliveryLocMultiStep3
					);
				};

				BX.loadScript("/thurly/js/sale/core_ui_widget.js", bxInputdeliveryLocMultiStep2);
			...
			<link rel="stylesheet" type="text/css" href="/thurly/panel/main/adminstyles_fixed.css">
			<link rel="stylesheet" type="text/css" href="/thurly/panel/main/admin.css">
			<link rel="stylesheet" type="text/css" href="/thurly/panel/main/admin-public.css">
			<link rel="stylesheet" type="text/css" href="/thurly/components/thurly/sale.location.selector.system/templates/.default/style.css">
		'.
		$result;
		ob_end_clean();
		return $result;
...
class ProductCategories extends Input\Base
{
	...
	protected static function getCategoriesList($ids)
	{
		...
		$res = \Thurly\Iblock\SectionTable::getList(array(
			'filter' => array(
				'ID' => $ids
			),
