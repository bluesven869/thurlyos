...
class Manager extends \Thurly\Sale\Services\Base\RestrictionManager
{
	...
	{
		return  array(
			'\Thurly\Sale\Delivery\Restrictions\BySite' => 'lib/delivery/restrictions/bysite.php',
			'\Thurly\Sale\Delivery\Restrictions\ByPrice' => 'lib/delivery/restrictions/byprice.php',
			'\Thurly\Sale\Delivery\Restrictions\ByWeight' => 'lib/delivery/restrictions/byweight.php',
			'\Thurly\Sale\Delivery\Restrictions\ByMaxSize' => 'lib/delivery/restrictions/bymaxsize.php',
			'\Thurly\Sale\Delivery\Restrictions\ByLocation' => 'lib/delivery/restrictions/bylocation.php',
//			'\Thurly\Sale\Delivery\Restrictions\PersonType' => 'lib/delivery/restrictions/bypersontype.php', //will be moved
			'\Thurly\Sale\Delivery\Restrictions\ByPaySystem' => 'lib/delivery/restrictions/bypaysystem.php',
			'\Thurly\Sale\Delivery\Restrictions\ByPersonType' => 'lib/delivery/restrictions/bypersontype.php',
			'\Thurly\Sale\Delivery\Restrictions\ByDimensions' => 'lib/delivery/restrictions/bydimensions.php',
			'\Thurly\Sale\Delivery\Restrictions\ByPublicMode' => 'lib/delivery/restrictions/bypublicmode.php',
			'\Thurly\Sale\Delivery\Restrictions\ByProductCategory' => 'lib/delivery/restrictions/byproductcategory.php'
		);
	}
	...
	{
		class_alias('Thurly\Sale\Delivery\Restrictions\ByPersonType', 'Thurly\Sale\Delivery\Restrictions\PersonType');
	 ...
	 */
	public static function getRestrictedIds(\Thurly\Sale\Shipment $shipment = null, $restrictionMode)
	{
		$result = array();
			...
			$dbRes = ServiceRestrictionTable::getList(array(
				'runtime' => array(
					new \Thurly\Main\Entity\ReferenceField(
						'DELIVERY_SERVICE',
						'\Thurly\Sale\Delivery\Services\Table',
						array(
	...
	protected static function isClassValid($className)
	{
		...
		if(!is_subclass_of($className, 'Thurly\Sale\Delivery\Restrictions\Base'))
			return false;
