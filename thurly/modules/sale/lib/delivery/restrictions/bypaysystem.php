...
use Thurly\Sale\Internals\PaySystemInner;
...
class ByPaySystem extends Base
{
	...
	public static function prepareData(array $deliveryIds)
	{
		...
		self::$preparedData = \Thurly\Sale\Internals\DeliveryPaySystemTable::prepareData($deliveryIds, DeliveryPaySystemTable::ENTITY_TYPE_DELIVERY);
	}
} 