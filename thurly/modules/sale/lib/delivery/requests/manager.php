<?
namespace Thurly\Sale\Delivery\Requests;

use Thurly\Main;
use Thurly\Sale\Order;
use Thurly\Sale\ResultWarning;
...
/**
 * Class Manager
 * @package Thurly\Sale\Delivery\Requests
...
final class Manager
{
	...
	public static function initJs()
	{
		\CJSCore::RegisterExt('sale_delivery_requests', array(
			'js' => '/thurly/js/sale/delivery_request.js',
			'lang' => '/thurly/modules/sale/lang/' . LANGUAGE_ID . '/admin/js/sale_delivery_requests.php',
			'rel' => array('core', 'ajax')
		));
