...
class Xml2Array
{
	...
	public static function convert($xmlData, $convertCharset = true)
	{
		...
		if($convertCharset && strtolower(SITE_CHARSET) != 'utf-8')
			$xmlData = \Thurly\Main\Text\Encoding::convertEncoding($xmlData, SITE_CHARSET, 'UTF-8');
		...
		if(strtolower(SITE_CHARSET) != 'utf-8')
			$result = \Thurly\Main\Text\Encoding::convertEncoding($result, 'UTF-8', SITE_CHARSET);
