...
class CatalogSectionTab
{
	...
	function OnInit($args)
	{
		...
		$res = \Thurly\Sale\TradingPlatformTable::getList(array(
		...
		if(!empty(self::$tabHandlers))
		{
			...
			$result =  array(
				...
				"GetTabs" => array("\\Thurly\\Sale\\TradingPlatform\\CatalogSectionTab", "GetTabs"),
				"ShowTab" => array("\\Thurly\\Sale\\TradingPlatform\\CatalogSectionTab", "ShowTab"),
				"Action" => array("\\Thurly\\Sale\\TradingPlatform\\CatalogSectionTab", "Action"),
				"Check" => array("\\Thurly\\Sale\\TradingPlatform\\CatalogSectionTab", "Check"),
			);
		}
