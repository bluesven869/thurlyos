...
//		todo: translate to other language
		if (defined('LANG') && LANG != 'ru')
		{
			...
			$resultHtml .= '<img src="/thurly/images/sale/vk/vk_only_russian.png" alt="">';
			$resultHtml .= EndNote();
			$resultHtml .= '</td></tr>';
...
//		if we not have exports profiles - we cant sdave settings
		...
		if (empty($exports))
			return
				'<tr><td colspan="2">' .
				Loc::getMessage("SALE_VK_NEED_EXPORT_PROFILE", array('#A1' => '/thurly/admin/sale_vk_export_list.php')) .
				'</td></tr>';
