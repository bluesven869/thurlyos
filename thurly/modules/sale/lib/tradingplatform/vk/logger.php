...
//			check if need download log file
			if (strlen($result) > 0)
			{
				...
				{
					$href = '/thurly/admin/sale_vk_export_edit.php' . '?ID=' . $this->exportId . '&lang=' . LANG . '&download_log=Y';
...
//				get iblock id fore create link to edit
				...
				$href = "/thurly/admin/cat_product_edit.php";
...
//				get iblock id fore create link to edit
				...
				$resItem = $resItem->Fetch();
				$href = "/thurly/admin/cat_section_edit.php";
...
//				'IGNORE' => true,
			...
			"5" => array(
				"MESSAGE" => Loc::getMessage("SALE_VK_ERROR__WRONG_ACCESS_TOKEN", array(
					'#A1' => '<a href="/thurly/admin/sale_vk_export_edit.php?ID=' . $this->exportId . '&lang=' . LANG . '&tabControl_active_tab=vk_settings">',
					'#A2' => '</a>',
				)),
				"CRITICAL" => true,
				"CODE" => "5",
