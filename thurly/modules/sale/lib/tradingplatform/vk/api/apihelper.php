...
namespace Thurly\Sale\TradingPlatform\Vk\Api;
...
use Thurly\Sale\TradingPlatform\Vk\Logger;
use Thurly\Sale\TradingPlatform\Vk\Vk;
 ...
 * @package Thurly\Sale\TradingPlatform\Vk\Api
 */
class ApiHelper
{
	private $vk;
...
//			todo: photo mapping. po odnomu, navernoe, ved timer
	...
	private function uploadHttp($uploadServer, $params)
	{
		...
		$http->setHeader('Content-length', \Thurly\Main\Text\BinaryString::getLength($data));
			...
			$groupsSelector.=
				'<span style="padding-left:10px">
					<a href="https://vk.com/club'. $selectedValue .'" id="vk_export_groupselector__link">
						<img src="/thurly/images/sale/vk/vk_icon.png">
					</a>
				</span>';
		}
