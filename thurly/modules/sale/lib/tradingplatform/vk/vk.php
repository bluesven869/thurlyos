...
//		check UPDATE or ADD
	...
	{
		RegisterModuleDependences('main', 'OnEventLogGetAuditTypes', 'sale', '\Thurly\Sale\TradingPlatform\Vk\Vk', 'OnEventLogGetAuditTypes');
...
//		adding new PLATFORM
		$tptAddRes = TradingPlatformTable::add(array(
			...
			"CATALOG_SECTION_TAB_CLASS_NAME" => '\Thurly\Sale\TradingPlatform\Vk\CatalogSectionTabHandler',
			"CLASS" => '\Thurly\Sale\TradingPlatform\Vk\Vk',
		));
