...
use Thurly\Sale\TradingPlatform\Ebay\Feed\Manager;
...
class Helper
{
	...
	{
		return 	$_SERVER["DOCUMENT_ROOT"]."/thurly/tradingplatforms/ebay/sftp";
	}
	 ...
	 * RegisterModuleDependences('main', 'OnEventLogGetAuditTypes', 'sale', 'Thurly\Sale\TradingPlatform\Ebay\Ebay', 'OnEventLogGetAuditTypes');
	 */
	...
	/**
	 * @param string $siteId
	 * @return \Thurly\Sale\TradingPlatform\Sftp
