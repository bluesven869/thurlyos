...
namespace Thurly\Sale\TradingPlatform\Ebay\Api;

use Thurly\Main\Text\Encoding;
use Thurly\Sale\TradingPlatform\Xml2Array;
use Thurly\Sale\TradingPlatform\Ebay\CategoryTable;
...
class Categories extends Entity
{
	...
	protected function getMappedCategories()
	{
		...
		foreach($settings[$this->siteId]["IBLOCK_ID"] as $iblockId)
			$iblocksIds[] = \Thurly\Sale\TradingPlatform\Ebay\MapHelper::getCategoryEntityId($iblockId);
