...
class Results extends DataProcessor
{
	...
	public function process($data)
	{
		...
		if(isset($data["XML"]))
		{
			...
			\Thurly\Sale\TradingPlatform\Ebay\Feed\ResultsTable::update($data["RESULT_ID"], $fields);
		}
		...
		if(strlen($message) > 0)
		{
			if(strtolower(SITE_CHARSET) != 'utf-8')
				$message = \Thurly\Main\Text\Encoding::convertEncoding($message, 'UTF-8', SITE_CHARSET);
