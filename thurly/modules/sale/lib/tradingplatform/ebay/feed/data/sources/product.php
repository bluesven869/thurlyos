...
namespace Thurly\Sale\TradingPlatform\Ebay\Feed\Data\Sources;
	...
	implements \Iterator
{
	...
	{
		$this->ebay = \Thurly\Sale\TradingPlatform\Ebay\Ebay::getInstance();
		...
		{
			$this->productFeeds[] = \Thurly\Catalog\ExportOfferCreator::getOfferObject(
				array(
					"IBLOCK_ID" => $iblockId,
	...
	{
		$result = array();
		$catMapEntId = \Thurly\Sale\TradingPlatform\Ebay\MapHelper::getCategoryEntityId($iblockId);
