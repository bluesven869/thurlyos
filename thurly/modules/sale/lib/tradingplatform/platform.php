...
use Thurly\Sale\TradingPlatformTable;
...
abstract class Platform
{
	...
	/**
	 * @param $code
	 * @return \Thurly\Sale\TradingPlatform\Platform
	...
	public static function setShipmentTableOnAfterUpdateEvent()
	{
		...
		$eventManager->registerEventHandler(
			...
			'sale',
			'\Thurly\Sale\TradingPlatform\Helper',
	...
	{
		$eventManager = EventManager::getInstance();
		$eventManager->registerEventHandlerCompatible("main", "OnAdminIBlockSectionEdit", "sale", "\\Thurly\\Sale\\TradingPlatform\\CatalogSectionTab", "OnInit");
	}
	
	protected function unSetCatalogSectionsTabEvent()
	{
		$eventManager = EventManager::getInstance();
		$eventManager->unRegisterEventHandler("main", "OnAdminIBlockSectionEdit", "sale", "\\Thurly\\Sale\\TradingPlatform\\CatalogSectionTab", "OnInit");
	}
