...
use Thurly\Main,
	...
	Thurly\Sale\Discount\RuntimeCache;
...
class Discount
{
	...
	protected function fillEmptyOrderData()
	{
		...
		if ($this->isOrderExists())
		{
			...
			/** @var \Thurly\Sale\PropertyValueCollection $shipmentCollection */
			$propertyCollection = $order->getPropertyCollection();
			/** @var \Thurly\Sale\PropertyValue $orderProperty */
	 ...
	 *
	 * @internal
	 * @param array $coupons			Coupons list from \Thurly\Sale\DiscountCouponsManager::getForApply.
	 * @return array
	 */
