...
//				}
	...
	public static function getConsumers()
	{
		if (! self::$consumers)
		{
			...
			{
//				// TODO remove
//				if (! ($handler['TO_NAME'] == 'Thurly\Sale\BusinessValueHandlers::getConsumers'
////					|| $handler['TO_NAME'] == 'Thurly\Sale\BusinessValueConsumer1C::getConsumers'
//				))
//					continue;
										...
										elseif ($property->getPropertyId() == $propertyId)
										{
											...
											)
											{
												if($propertyField['TYPE'] == "LOCATION")
												{
													...
													$row = \Thurly\Sale\Location\LocationTable::getList(array(
