...
abstract class SelectProductPreset extends BasePreset
{
	protected function init()
	{
		...
		\CJSCore::RegisterExt('select_product_preset', array(
			'js' => '/thurly/js/sale/admin/discountpreset/select_product_preset.js',
			'lang' => '/thurly/modules/sale/lang/' . LANGUAGE_ID . '/admin/js/discountpreset/select_product_preset.php',
			'rel' => array('core'),
		));
