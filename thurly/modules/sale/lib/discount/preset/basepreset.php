...
namespace Thurly\Sale\Discount\Preset;
...
use Thurly\Sale\Internals\DiscountGroupTable;
			...
			<table width="100%" border="0" cellspacing="7" cellpadding="0">
				...
				<tr>
					<td class="adm-detail-content-cell-l" style="width:40%;">
						<script type="text/javascript">BX.ready(function(){BX.hint_replace(BX("tr_HELP_notice"), \'<img style="padding-left: 16px;" width="545" height="353" src="/thurly/images/sale/discount/' . $hintLastDiscountImageName . '" alt="">\');})</script>
				...
				<tr>
					<td class="adm-detail-content-cell-l" style="width:40%;">
						<script type="text/javascript">BX.ready(function(){BX.hint_replace(BX("tr_HELP_notice2"), \'<img style="padding-left: 16px;" width="545" height="353" src="/thurly/images/sale/discount/' . $hintLastDiscountImageName . '" alt="">\');})</script>
