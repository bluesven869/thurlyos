...
namespace Thurly\Sale\Discount;
...
final class CumulativeCalculator
{
	...
	private function sumOrders($filter, $orderType)
	{
		...
		{
			/** @var \Thurly\Sale\Archive\Manager $provider */
			$provider = '\Thurly\Sale\Archive\Manager';
		}
		elseif ($orderType === self::TYPE_ORDER_NON_ARCHIVED)
		{
			/** @var \Thurly\Sale\Order $provider */
			$provider = '\Thurly\Sale\Order';
		}
