...
class Basket extends BasketBase
{
	...
	public static function deleteOldAgent($days, $speed = 0)
	{
		...
		$speed = intval($speed);
		$result = "\\Thurly\\Sale\\Basket::deleteOldAgent(".intval(Main\Config\Option::get("sale", "delete_after", "30")).");";
	...
	public function getListOfFormatText()
	{
		...
		foreach ($this->collection as $basketItem)
		{
			...
			/** @var \Thurly\Sale\BasketPropertiesCollection $basketPropertyCollection */
			if ($basketPropertyCollection = $basketItem->getPropertyCollection())
			{
				$basketItemDataProperty = "";
				/** @var \Thurly\Sale\BasketPropertyItem $basketPropertyItem */
