...
use	Thurly\Sale\Internals\Input,
	Thurly\Sale\Internals\OrderPropsGroupTable,
	Thurly\Main\ArgumentOutOfRangeException,
	Thurly\Main\Entity,
	...
	extends Internals\EntityCollection
{
	...
	static function initJs()
	{
		...
		\CJSCore::RegisterExt('SaleOrderProperties', array(
			'js'   => '/thurly/js/sale/orderproperties.js',
			'lang' => '/thurly/modules/sale/lang/'.LANGUAGE_ID.'/lib/propertyvaluecollection.php',
			'rel'  => array('input'),
		));
