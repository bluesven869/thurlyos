...
use Thurly\Sale\Internals\PaySystemErrLogTable;
...
class ErrorLog
{
	...
	{
		return file_put_contents($_SERVER['DOCUMENT_ROOT'].'/thurly/modules/sale/payment_log.txt', self::convertArrayToString($fields), FILE_APPEND);
	}
