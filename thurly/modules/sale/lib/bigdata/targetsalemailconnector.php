...
class TargetSaleMailConnector extends \Thurly\Sender\Connector
{
	...
	public function getData()
	{
		...
		{
			$response = \Thurly\Sale\Bigdata\Cloud::getPotentialConsumers($productId);
	...
	public function getForm()
	{
		...
		<script>
			...
			function AddProductSearch_%CONNECTOR_NUM%()
			{
				var productPopup = new BX.CDialog({
					content_url: '/thurly/tools/sale/product_search_dialog.php?lang=".LANGUAGE_ID."&caller=sender_target_sale&func_name=catchProduct_%CONNECTOR_NUM%',
		...
		if ($this->getFieldValue('PRODUCTS'))
		{
			...
			$result = \Thurly\Iblock\ElementTable::getList(array(
