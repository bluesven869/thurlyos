...
namespace Thurly\Sale\Compatible;
...
//	const EVENT_COMPATIBILITY_ON_BASKET_ = "OnSaleCancelOrder";
	...
	public static function registerEvents()
	{
		...
		$eventManager->registerEventHandler('sale', 'OnSaleOrderBeforeSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderBeforeSaved');
		...
		$eventManager->registerEventHandler('sale', 'OnSaleOrderEntitySaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderSave');

		$eventManager->registerEventHandler('sale', 'OnSaleOrderSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderSaved');

		$eventManager->registerEventHandler('sale', 'OnSaleBasketItemBeforeSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onBasketItemBeforeChange');

		$eventManager->registerEventHandler('sale', 'OnSaleBasketItemEntitySaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onBasketItemChange');

		$eventManager->registerEventHandler('sale', 'OnShipmentTrackingNumberChange', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onShipmentTrackingNumberChange');

		$eventManager->registerEventHandler('sale', 'OnSaleBeforeStatusOrderChange', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onSaleBeforeStatusOrderChange');

		$eventManager->registerEventHandler('sale', 'OnSaleStatusOrderChange', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onSaleStatusOrderChange');

		$eventManager->registerEventHandler('sale', 'OnSaleOrderStatusChangeSendEmail', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onSaleOrderStatusChangeSendEmail');

		$eventManager->registerEventHandler('sale', 'OnSaleOrderSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderNewSendEmail');

		RegisterModuleDependences("sale", "OnOrderNewSendEmail", "sale", "\\Thurly\\Sale\\Compatible\\EventCompatibility", "onCallOrderNewSendEmail");

		$eventManager->registerEventHandler('sale', 'OnBeforeSaleBasketItemEntityDeleted', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'OnBeforeBasketDelete');

		$eventManager->registerEventHandler('sale', 'OnSaleBasketItemDeleted', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'OnBasketDelete');

		$eventManager->registerEventHandler('sale', 'OnShipmentAllowDelivery', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onShipmentAllowDelivery');

		RegisterModuleDependences("sale", "OnOrderCancelSendEmail", "sale", "\\Thurly\\Sale\\Compatible\\EventCompatibility", "onCallOrderCancelSendEmail");

		$eventManager->registerEventHandler('sale', 'OnSaleOrderSaved', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleOrderAddEvent');
		
		$eventManager->registerEventHandler('sale', 'OnSaleStatusOrderChange', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleStatusOrderHandlerEvent');
		
		$eventManager->registerEventHandler('sale', 'OnShipmentAllowDelivery', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleDeliveryOrderHandlerEvent');
		
		$eventManager->registerEventHandler('sale', 'OnShipmentDeducted', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleDeductOrderHandlerEvent');
		
		$eventManager->registerEventHandler('sale', 'OnSaleOrderCanceled', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleCancelOrderHandlerEvent');
		
		$eventManager->registerEventHandler('sale', 'OnSaleOrderPaid', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSalePayOrderHandlerEvent');
		
		UnRegisterModuleDependences("sale", "OnBasketOrder", "sale", "\\Thurly\\Sale\\Product2ProductTable", "onSaleOrderAdd", 100);
		UnRegisterModuleDependences("sale", "OnSaleStatusOrder", "sale", "\\Thurly\\Sale\\Product2ProductTable", "onSaleStatusOrderHandler", 100);
		UnRegisterModuleDependences("sale", "OnSaleDeliveryOrder", "sale", "\\Thurly\\Sale\\Product2ProductTable", "onSaleDeliveryOrderHandler", 100);
		UnRegisterModuleDependences("sale", "OnSaleDeductOrder", "sale", "\\Thurly\\Sale\\Product2ProductTable", "onSaleDeductOrderHandler", 100);
		UnRegisterModuleDependences("sale", "OnSaleCancelOrder", "sale", "\\Thurly\\Sale\\Product2ProductTable", "onSaleCancelOrderHandler", 100);
		UnRegisterModuleDependences("sale", "OnSalePayOrder", "sale", "\\Thurly\\Sale\\Product2ProductTable", "onSalePayOrderHandler", 100);
	...
	public static function unRegisterEvents()
	{
		...
		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderBeforeSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderBeforeSaved');
		...
		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderEntitySaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderSave');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onOrderSaved');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleBasketItemBeforeSaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onBasketItemBeforeChange');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleBasketItemEntitySaved', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onBasketItemChange');

		$eventManager->unRegisterEventHandler('sale', 'OnShipmentTrackingNumberChange', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onShipmentTrackingNumberChange');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleBeforeStatusOrderChange', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onSaleBeforeStatusOrderChange');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleStatusOrderChange', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onSaleStatusOrderChange');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderStatusChangeSendEmail', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onSaleOrderStatusChangeSendEmail');
		...
		UnRegisterModuleDependences("sale", "OnOrderNewSendEmail", "sale", "\\Thurly\\Sale\\Compatible\\EventCompatibility", "onCallOrderNewSendEmail");

		$eventManager->unRegisterEventHandler('sale', 'OnBeforeSaleBasketItemEntityDeleted', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'OnBeforeBasketDelete');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleBasketItemDeleted', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'OnBasketDelete');

		$eventManager->unRegisterEventHandler('sale', 'OnShipmentAllowDelivery', 'sale', '\Thurly\Sale\Compatible\EventCompatibility', 'onShipmentAllowDelivery');

		UnRegisterModuleDependences("sale", "OnOrderCancelSendEmail", "sale", "\\Thurly\\Sale\\Compatible\\EventCompatibility", "onCallOrderCancelSendEmail");

		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderSaved', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleOrderAddEvent');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleStatusOrderChange', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleStatusOrderHandlerEvent');

		$eventManager->unRegisterEventHandler('sale', 'OnShipmentAllowDelivery', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleDeliveryOrderHandlerEvent');

		$eventManager->unRegisterEventHandler('sale', 'OnShipmentDeducted', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleDeductOrderHandlerEvent');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderCanceled', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSaleCancelOrderHandlerEvent');

		$eventManager->unRegisterEventHandler('sale', 'OnSaleOrderPaid', 'sale', '\Thurly\Sale\Product2ProductTable', 'onSalePayOrderHandlerEvent');
