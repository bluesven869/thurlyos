...
use	Thurly\Main\Entity,
	Thurly\Main\Entity\Query,
	Thurly\Main\Entity\Field,
	Thurly\Main\Entity\ReferenceField,
	Thurly\Main\Entity\ExpressionField,
...
final class Test
{
	...
	static function run()
	{
		foreach (glob($_SERVER['DOCUMENT_ROOT'].'/thurly/modules/sale/lib/compatible/tests/*.test.php') as $filename)
		{
			include $filename;
		}
	}
