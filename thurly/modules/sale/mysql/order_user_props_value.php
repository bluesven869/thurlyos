<?
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/general/order_user_props_value.php");
...
class CSaleOrderUserPropsValue extends CAllSaleOrderUserPropsValue
{
	function GetList($arOrder = array(), $arFilter = array(), $arGroupBy = false, $arNavStartParams = false, $arSelectFields = array())
	{
		...
		$sale15converted = \Thurly\Main\Config\Option::get('main', '~sale_converted_15', 'N') == 'Y';
