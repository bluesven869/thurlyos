...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/thurly/admin/sale_tax.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
			...
			"ICON" => "btn_new",
			"LINK" => "/thurly/admin/sale_tax_edit.php?lang=".LANG.GetFilterParams("filter_")
		);

	$aMenu[] = array(
			"TEXT" => GetMessage("STEN_DELETE_TAX"),
			"ICON" => "btn_delete",
			"LINK" => "javascript:if(confirm('".GetMessage("STEN_DELETE_TAX_CONFIRM")."')) window.location='/thurly/admin/sale_tax.php?action=delete&ID[]=".$ID."&lang=".LANG."&".thurly_sessid_get()."#tb';",
		);
}
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/thurly/admin/sale_tax.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
?>
