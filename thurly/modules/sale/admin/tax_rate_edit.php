...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/thurly/admin/sale_tax_rate.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
			...
			"ICON" => "btn_new",
			"LINK" => "/thurly/admin/sale_tax_rate_edit.php?lang=".LANG.GetFilterParams("filter_")
		);

	$aMenu[] = array(
			"TEXT" => GetMessage("STREN_DELETE_RATE"),
			"ICON" => "btn_delete",
			"LINK" => "javascript:if(confirm('".GetMessage("STREN_DELETE_RATE_CONFIRM")."')) window.location='/thurly/admin/sale_tax_rate.php?action=delete&ID[]=".$ID."&lang=".LANG."&".thurly_sessid_get()."#tb';",
		);
}
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/thurly/admin/sale_tax_rate.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
?>
