...
use Thurly\Sale\Location\Migration;
...
include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/lib/location/migration/migration.php");
...
<?else:?>
	...
	<style>
		...
		.bx-ui-state-running .bx-ui-loc-m-loader{
			background: url(/thurly/panel/main/images/filter-active-waiter.gif) 0px 0px no-repeat scroll;
			width: 20px;
			height: 20px;
			display: inline;
			padding: 2px 10px;
