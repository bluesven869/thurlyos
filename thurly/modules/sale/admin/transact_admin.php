...
while ($arTransact = $dbTransactList->NavNext(true, "f_"))
{
	...
	$fieldValue  = "[<a href=\"/thurly/admin/user_edit.php?ID=".$f_USER_ID."&lang=".LANG."\" title=\"".GetMessage("STA_USER_INFO")."\">".$f_USER_ID."</a>] ";
	...
	if (IntVal($arTransact["ORDER_ID"]) > 0)
		$fieldValue = "<a href=\"/thurly/admin/sale_order_view.php?ID=".$arTransact["ORDER_ID"]."&lang=".LANG."\" title=\"".GetMessage("STA_ORDER_VIEW")."\">".$arTransact["ORDER_ID"]."</a>";
	else
		$fieldValue = "&nbsp;";
	...
	if (in_array("DESCR", $arVisibleColumns))
	{
		...
		if (IntVal($arTransact["EMPLOYEE_ID"]) > 0)
		{
			...
			{
				$fieldValue .= "[<a href=\"/thurly/admin/user_edit.php?ID=".$arTransact["EMPLOYEE_ID"]."&lang=".LANG."\" title=\"".GetMessage("STA_USER_INFO")."\">".$arTransact["EMPLOYEE_ID"]."</a>] ";
