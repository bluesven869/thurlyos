...
$lang = \Thurly\Main\Application::getInstance()->getContext()->getLanguage();
	...
	foreach ($ids as $id)
	{
		...
		switch ($_REQUEST['action'])
		{
			case "delete":
				...
				$dbRes = \Thurly\Sale\Internals\OrderTable::getList(array(
					'select' => array('ID'),
					'filter' => array(
						'LOGIC' => 'OR',
	...
	<tr>
		...
		<td>
			<div style="width: 100%; margin-left: 12px">
				<?$APPLICATION->IncludeComponent("thurly:sale.location.selector.search"/*.\Thurly\Sale\Location\Admin\LocationHelper::getWidgetAppearance()*/, "", array(
						"ID" => "",
