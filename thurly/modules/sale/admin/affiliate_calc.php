...
if ($REQUEST_METHOD=="GET" && strlen($Update)>0 && $saleModulePermissions>="W" && check_thurly_sessid())
{
	...
	if (StrLen($errorMessage) <= 0)
	{
		...
		LocalRedirect("/thurly/admin/sale_affiliate_calc.php?lang=".LANG."&".$urlParams);
	}
}
	...
	<tr>
		...
		<td width="60%" valign="top">
			...
			if (!$bFilteredList)
			{
				...
				echo "<br>";
				echo str_replace("#LINK2#", "</a>", str_replace("#LINK1#", "<a href=\"/thurly/admin/sale_affiliate.php?lang=".LANG."\">", GetMessage("SAC_ALL_AFFILIATES_HINT")));
			}
			?>
		</td>
	</tr>
