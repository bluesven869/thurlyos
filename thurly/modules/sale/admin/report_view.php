...
<style type="text/css">
	a.webform-field-textbox-clear {
		background: url("/thurly/js/main/core/images/controls-sprite.png") no-repeat scroll -23px 0px transparent;
		cursor: pointer;
		display: block;
		width: 7px;
		height: 7px;
			...
			<div>
				<input type="hidden" name="ID" value="<?=$ID?>" />
						...
						<table cellspacing="0" id="adm-report-chfilter-examples-custom" class="adm-filter-content-table" style="display: none;">
							...
							<!-- person type example -->
							<tr class="chfilter-field-Thurly\Sale\Internals\Order:USER.PERSON_TYPE_ID adm-report-chfilter-control" callback="RTFilter_chooseBoolean">
								<td class="adm-filter-item-left">%TITLE% "%COMPARE%":</td>
								<td class="adm-filter-item-center">
									<div class="adm-filter-alignment">
										<div class="adm-filter-box-sizing">
							...
							<!-- status example -->
							<tr class="chfilter-field-\Thurly\Sale\Internals\StatusLang adm-report-chfilter-control" callback="RTFilter_chooseBoolean">
								<td class="adm-filter-item-left">%TITLE% "%COMPARE%":</td>
								<td class="adm-filter-item-center">
									<div class="adm-filter-alignment">
										<div class="adm-filter-box-sizing">
							...
							<script type="text/javascript">
								...
								function onChangeSiteFilter()
								{
									...
									if (siteSelect && siteSelect.value && filterContainer)
									{
										...
										{
											BX.showWait();
											url = '/thurly/admin/sale_report_view.php?lang=<?=LANGUAGE_ID?>&ID=<?=$ID?>&<?=thurly_sessid_get()?>'+
							...
							<!-- Group example -->
							<tr class="chfilter-field-\Thurly\Main\Group adm-report-chfilter-control" callback="RTFilter_chooseGroup">
								<td class="adm-filter-item-left">%TITLE% "%COMPARE%":</td>
								<td class="adm-filter-item-center">
									<div class="adm-filter-alignment">
										<div class="adm-filter-box-sizing">
							...
							<!-- User example -->
							<tr class="chfilter-field-\Thurly\Main\User adm-report-chfilter-control" callback="RTFilter_chooseSALEUSER">
								<td class="adm-filter-item-left">%TITLE% "%COMPARE%":</td>
								<td class="adm-filter-item-center">
									<div class="adm-filter-alignment">
										<div class="adm-filter-box-sizing">
							...
							<!-- SaleSection example -->
							<tr class="chfilter-field-\Thurly\Sale\Internals\Section adm-report-chfilter-control" callback="RTFilter_chooseBoolean">
								<td class="adm-filter-item-left">%TITLE% "%COMPARE%":</td>
								<td class="adm-filter-item-center">
									<div class="adm-filter-alignment">
										<div class="adm-filter-box-sizing">
							...
							<tr class="chfilter-field-\Thurly\Iblock\Section adm-report-chfilter-control" callback="RTFilter_chooseBoolean">
								<td class="adm-filter-item-left">%TITLE% "%COMPARE%":</td>
								<td class="adm-filter-item-center">
									<div class="adm-filter-alignment">
										<div class="adm-filter-box-sizing">
							...
							<script type="text/javascript">
								...
								BX.ready(
									function ()
									{
										...
										temp[i++] = BX.findChildren(BX('report-rewrite-filter'), { className:'chfilter-field-\\Thurly\\Main\\User' }, true);
							...
							<script type="text/javascript">
								...
								BX.ready(
									function ()
									{
										var controls = BX.findChildren(BX('report-rewrite-filter'), {className:'chfilter-field-\\Thurly\\Main\\Group'}, true);
										if (controls != null)
										{
											for (i in controls)
											{
