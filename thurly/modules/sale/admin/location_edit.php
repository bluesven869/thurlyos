...
if(CSaleLocation::isLocationProEnabled())
	LocalRedirect('/thurly/admin/sale_location_node_edit.php'.($ID ? '?id='.$ID : ''));
...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/thurly/admin/sale_location_admin.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
			...
			"ICON" => "btn_new",
			"LINK" => "/thurly/admin/sale_location_edit.php?lang=".LANG.GetFilterParams("filter_")
		);

	$aMenu[] = array(
			"TEXT" => GetMessage("SLN_DELETE_LOCATION"),
			"ICON" => "btn_delete",
			"LINK" => "javascript:if(confirm('".GetMessage("SLN_DELETE_LOCATION_CONFIRM")."')) window.location='/thurly/admin/sale_location_admin.php?action=delete&ID[]=".$ID."&lang=".LANG."&".thurly_sessid_get()."#tb';",
		);
}
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/thurly/admin/sale_location_admin.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
?>
