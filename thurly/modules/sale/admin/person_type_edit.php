...
if ($REQUEST_METHOD=="POST" && strlen($Update)>0 && $saleModulePermissions>="W" && check_thurly_sessid())
{
	...
	{
		if (strlen($apply) <= 0)
			LocalRedirect("/thurly/admin/sale_person_type.php?lang=".LANG.GetFilterParams("filter_", false));
		else
			LocalRedirect("/thurly/admin/sale_person_type_edit.php?ID=".$ID."&lang=".LANG.GetFilterParams("filter_", false));
...
$aMenu = array(
	array(
		...
		"LINK" => "/thurly/admin/sale_person_type.php?lang=".LANG.GetFilterParams("filter_"),
		"ICON" => "btn_list"
	)
);
...
if ($ID > 0 && $saleModulePermissions >= "W")
{
	...
	$aMenu[] = array(
		...
		"LINK" => "/thurly/admin/sale_person_type_edit.php?lang=".LANG.GetFilterParams("filter_"),
		"ICON" => "btn_new"
	);

	$aMenu[] = array(
		"TEXT" => GetMessage("SPTEN_DELETE_PERSON_TYPE"), 
		"LINK" => "javascript:if(confirm('".GetMessage("SPTEN_DELETE_PERSON_TYPE_CONFIRM")."')) window.location='/thurly/admin/sale_person_type.php?ID=".$ID."&action=delete&lang=".LANG."&".thurly_sessid_get()."#tb';",
		"WARNING" => "Y",
		"ICON" => "btn_delete"
	);
}
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/thurly/admin/sale_person_type.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
?>
