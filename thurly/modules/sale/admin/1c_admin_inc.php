...
while ($arPaySystem = $dbPaySystems->Fetch())
{
	...
	if($arPaySystem["ID"] != Thurly\Sale\PaySystem\Manager::getInnerPaySystemId())
	{
...
$deliveryList = \Thurly\Sale\Delivery\Services\Manager::getActiveList();
...
if($REQUEST_METHOD=="POST" && strlen($Update)>0 && $CAT_RIGHT>="W" && check_thurly_sessid())
{
