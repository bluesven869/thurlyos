...
$catalogInstalled = \Thurly\Main\ModuleManager::isModuleInstalled('catalog');
if ($catalogInstalled)
{
...
if ($APPLICATION->GetGroupRight("sale")!="D")
{
	...
	/* Converter Begin */
	if (Thurly\Main\Config\Option::get("main", "~sale_converted_15", 'Y') == 'N')
	{
...
)
{
	...
	if ($APPLICATION->GetGroupRight("sale") == "W")
	{
		if (Thurly\Main\Config\Option::get("main", "~sale_converted_15", 'Y') != 'N')
		{
			...
			{
				$deliveryMenu = new \Thurly\Sale\Delivery\Menu();
