...
.adm-c-bigdata-container{
	border-radius:5px;
	background:#fff url(/thurly/images/sale/bigdata/bg3.png) repeat-x top center;
}

.adm-c-bigdata-title-box{
	padding-top:140px;
	background:url(/thurly/images/sale/bigdata/h2.png) no-repeat center 70px;
}
...
.adm-c-bigdata-mac{
	...
	background:url(/thurly/images/sale/bigdata/mac.png) no-repeat center;
}
...
.adm-c-bigdata-blocks-content{
	...
	background:url(/thurly/images/sale/bigdata/widg.png) no-repeat center 15px;
}
	...
	<div class="adm-c-bigdata-activate">
		...
		<div class="adm-c-bigdata-activate-content">
			...
			<?
				...
				elseif (!$installed)
				{
					$goUrl = 'https://dev.1c-thurly.ru/learning/course/index.php?COURSE_ID=42&LESSON_ID=5367';
				}
			?>
