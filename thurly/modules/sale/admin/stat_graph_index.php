...
<tr>
	<td valign="top" class="graph">
		<img class="graph" src="/thurly/admin/sale_stat_graph.php?<?=GetFilterParams($arFilterFields)?>&amp;width=<?=$width?>&amp;height=<?=$height?>&amp;lang=<?=LANG?>&amp;rand=<?=rand()?>&amp;mode=count" width="<?=$width?>" height="<?=$height?>">
	</td>
</tr>
<tr>
	<td valign="top">
	<table cellpadding="2" cellspacing="0" border="0" class="legend">
		<?if ($find_all=="Y"):?>
		<tr>
			<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[0]?>" width="45" height="2"></td>
			<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_COUNT")?></td>
		</tr>
		<?endif;?>
		<?if ($find_payed=="Y"):?>
		<tr>
			<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[1]?>" width="45" height="2"></td>
			<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_PAYED")?></td>
		</tr>
		<?endif;?>
		<?if ($find_allow_delivery=="Y"):?>
		<tr>
			<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[2]?>" width="45" height="2"></td>
			<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_ALLOW_DELIVERY")?></td>
		</tr>
		<?endif;?>
		<?if ($find_canceled=="Y"):?>
		<tr>
			<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[3]?>" width="45" height="2"></td>
			<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_CANCELED")?></td>
		</tr>
		<?endif;?>
		<?
		$i = 4;
		foreach($arStatus as $k => $v)
		{
			if (${"find_status_".$k} == "Y"):?>
			<tr>
				<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[$i]?>" width="45" height="2"></td>
				<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=$v?></td>
			</tr>
			<?endif;
			$i++;
		}
