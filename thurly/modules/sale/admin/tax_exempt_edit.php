...
$aMenu = array(
		array(
				...
				"ICON" => "btn_list",
				"LINK" => "/thurly/admin/sale_tax_exempt.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
...
?>
	...
	<tr>
		<td width="40%" valign="top">
			<?echo GetMessage("F_TAX_LIST");?>:<br><img src="/thurly/images/sale/mouse.gif" width="44" height="21" border="0" alt="">
		</td>
...
$tabControl->Buttons(
		array(
				...
				"back_url" => "/thurly/admin/sale_tax_exempt.php?lang=".LANG.GetFilterParams("filter_")
			)
	);
?>
