...
$pathToSettings = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/handlers/paysystem/".$handler."/settings/refund.php";
if (Thurly\Main\IO\File::isFileExists($pathToSettings))
{
