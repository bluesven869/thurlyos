...
if(IsModuleInstalled("catalog"))
{
	$aSTabs[] = array(
		...
		"FILE" => $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/catalog/admin/1c_admin.php",
	...
	$aSTabs[] = array(
		...
		"FILE" => $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/catalog/admin/1ce_admin.php",
	);
}
if(IsModuleInstalled("sale"))
{
	$aSTabs[] = array(
		...
		"FILE" => $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/admin/1c_admin_inc.php",
	);
	/*$aSTabs[] = array(
		"DIV" => "edit_sale_profile",
		"TAB" => GetMessage("MAIN_1C_SALE_PROFILE_TAB"),
		"TITLE" => GetMessage("MAIN_1C_SALE_PROFILE_TITLE"),
		"FILE" => $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/admin/1c_admin_profile.php",
	);*/
	$aSTabs[] = array(
		"DIV" => "edit_sale_bizval",
		"TAB" => GetMessage("MAIN_1C_SALE_PROFILE_TAB"),
		"TITLE" => GetMessage("MAIN_1C_SALE_PROFILE_TITLE"),
		"FILE" => $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/sale/admin/1c_admin_bizval.php",
	);
}
