...
?>
	<tr>
		<td colspan="2"><input type="submit" onclick="WizardWindow.Open('thurly:sale.locations', '<?=thurly_sessid()?>');" class="adm-btn-save" value="<?=GetMessage('LOCA_LOADING_WIZARD')?>"></td>
	</tr>
<?
$tabControl->EndTab();
?>
