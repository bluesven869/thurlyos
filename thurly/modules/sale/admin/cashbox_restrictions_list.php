<?
namespace Thurly\Sale\Cashbox\AdminPage\Restrictions
{
	use Thurly\Main\Application;
	use Thurly\Main\Loader;
	use Thurly\Main\Localization\Loc;
	use Thurly\Sale\Internals\Input;
	use Thurly\Sale\Cashbox\Restrictions\Manager;
	...
	$lAdmin = new \CAdminSubList($tableId, $oSort, '/thurly/admin/sale_cashbox_restriction_list.php?ID='.$id);
