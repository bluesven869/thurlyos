...
$statusesList = \Thurly\Sale\OrderStatus::getStatusesUserCanDoOperations($USER->GetID(), array('delete'));
...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_REQUEST["archive"]=="Y" && check_thurly_sessid())
{
...
else
{
	...
	<form method="GET" action="<?echo $APPLICATION->GetCurPage()?>?lang=<?echo htmlspecialcharsbx(LANG)?>" id="archiveForm">
		...
		if($saleModulePermissions >= "W")
		{
			...
			<?
			$shopList = array();
			$siteList = \Thurly\Main\SiteTable::getList();
