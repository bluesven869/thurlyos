...
\Thurly\Main\Page\Asset::getInstance()->addString('<link rel="stylesheet" type="text/css" href="/thurly/css/sale/ebay.css">');
		...
		<div class="adm-detail-content">
			...
			<div class="ebay-info-container">
				<div class="ebay-info">
					...
					<img src="/thurly/images/sale/ebay/ebay.png" alt="">
			...
			<div class="ebay-advantages">
				<div class="ebay-advantages-container">
					<img src="/thurly/images/sale/ebay/ebay-img.jpg" alt="">
			...
			<div class="ebay-conditions">
				<div class="ebay-conditions-item">
					<div class="ebay-icon-container">
						<img src="/thurly/images/sale/ebay/ebay-img1.png" alt="">
					</div>
					<span><?=Loc::getMessage('SALE_EBAY_SALE_RUS')?>!</span>
				</div>
				<div class="ebay-conditions-item">
					<div class="ebay-icon-container">
						<img src="/thurly/images/sale/ebay/ebay-img2.png" alt="">
					</div>
					<span><?=Loc::getMessage('SALE_EBAY_EXPORT')?>!</span>
				</div>
				<div class="ebay-conditions-item">
					<div class="ebay-icon-container">
						<img src="/thurly/images/sale/ebay/ebay-img3.png" alt="">
					</div>
					<span><?=Loc::getMessage('SALE_EBAY_PART_OF_THURLY')?>!</span>
				</div>
			</div>
			<div class="ebay-start">
				...
				<div class="ebay-start-btn-container">
					<a href="/thurly/admin/sale_ebay_wizard.php?lang=<?=LANGUAGE_ID?>" class="ebay-start-btn"><?=Loc::getMessage('SALE_EBAY_START')?></a>
				</div>
			</div>
		</div>
	</div>
