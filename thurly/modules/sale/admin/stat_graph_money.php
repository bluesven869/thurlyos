...
<tr>
	<td valign="top" class="graph">
		<img class="graph" src="/thurly/admin/sale_stat_graph.php?<?=GetFilterParams($arFilterFields)?>&amp;width=<?=$width?>&amp;height=<?=$height?>&amp;lang=<?=LANG?>&amp;rand=<?=rand()?>&amp;mode=money" width="<?=$width?>" height="<?=$height?>">
	</td>
</tr>
<tr>
	<td valign="top">
	<table cellpadding="2" cellspacing="0" border="0" class="legend">
		...
		foreach($arCurrencyInfo as $k => $v)
		{
			...
			<tr>
				...
				<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_COUNT")?> (<?=$v?>)</td>
			</tr>
			<?endif;
			$i++;
			if (${"find_payed_".$k}=="Y"):?>
			<tr>
				<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[$i]?>" width="45" height="2"></td>
				<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_PAYED")?> (<?=$v?>)</td>
			</tr>
			<?endif;
			$i++;
			...
			<tr>
				<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[$i]?>" width="45" height="2"></td>
				<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_ALLOW_DELIVERY")?> (<?=$v?>)</td>
			</tr>
			<?endif;
			$i++;
			...
			<tr>
				<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[$i]?>" width="45" height="2"></td>
				<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=GetMessage("SALE_CANCELED")?> (<?=$v?>)</td>
			</tr>
			<?endif;?>
			<?
			$i++;
			foreach($arStatus as $k1 => $v1)
			{
				...
				<tr>
					<td valign="center"><img src="/thurly/admin/sale_graph_legend.php?color=<?=$arColor[$i]?>" width="45" height="2"></td>
					<td nowrap><img src="/thurly/images/1.gif" width="3" height="1"><?=$v1?> (<?=$v?>)</td>
				</tr>
				<?endif;
				$i++;
			}
