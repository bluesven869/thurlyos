...
while ($arCCard = $dbResultList->NavNext(true, "f_"))
{
	...
	$row->AddField("ID", "<a href=\"/thurly/admin/sale_status_edit.php?ID=".$f_ID."&lang=".LANG.GetFilterParams("filter_")."\" title=\"".GetMessage("SALE_EDIT_DESCR")."\">".$f_ID."</a>");
	...
	$row->AddField("NOTIFY", $f_NOTIFY == 'Y'
		? '<a href="/thurly/admin/message_admin.php?find_event_type=SALE_STATUS_CHANGED_'.$f_ID.'" target="_blank">'.GetMessage('SSAN_NOTIFY_Y').'</a>'
