...
$APPLICATION->SetAdditionalCSS("/thurly/panel/sale/preset.css");

$presetManager = \Thurly\Sale\Discount\Preset\Manager::getInstance();
	...
	elseif($_GET['from_list'] === 'preset')
	{
		$contextMenuItems = array(
			array(
				...
				"LINK" => "/thurly/admin/sale_discount_preset_list.php?lang=".LANGUAGE_ID.GetFilterParams("filter_"),
				"ICON" => "btn_list"
			)
		);
	}
