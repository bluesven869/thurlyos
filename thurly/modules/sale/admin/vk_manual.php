...
if (defined('LANG') && LANG != 'ru')
{
	...
	echo '<img src="/thurly/images/sale/vk/vk_only_russian.png" alt="">';
	echo EndNote();
}
else
{
	...
	<tr>
		<td>
			<div style="max-width: 950px;">
				...
				<img src="/thurly/images/sale/vk/vk_man_4.png" alt="">
	...
	<tr>
		<td>
			<div style="max-width: 950px;">
				...
				<img src="/thurly/images/sale/vk/vk_man_5.png" alt="">
				...
				<img src="/thurly/images/sale/vk/vk_man_6.png" alt="">
	...
	<tr>
		<td>
			<div style="max-width: 950px;">
				...
				<img src="/thurly/images/sale/vk/vk_man_9.png" alt="">
	...
	<tr>
		<td>
			<div style="max-width: 950px;">
				...
				<img src="/thurly/images/sale/vk/vk_man_10.png" alt="">
				<p><?= Loc::getMessage("SALE_VK_MANUAL__FEATURES_14") ?></p>
				<p><?= Loc::getMessage("SALE_VK_MANUAL__FEATURES_15") ?></p>
				<img src="/thurly/images/sale/vk/vk_man_11.png" alt="">
			</div>
		</td>
	</tr>
