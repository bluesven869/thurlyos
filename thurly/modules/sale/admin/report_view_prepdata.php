...
if (!$fCriticalError)
{
	...
	$arParams = array(
		...
		'PATH_TO_REPORT_CONSTRUCT' => '/thurly/admin/sale_report_construct.php?lang='.LANG,
		'PATH_TO_REPORT_VIEW' => '/thurly/admin/sale_report_view.php',
		'REPORT_ID' => $ID,
		'ROWS_PER_PAGE' => 50,
	...
	$arRepParams = array();
	if (!($arRepParams = Thurly\Report\ReportTable::getById($ID)->fetch()))
	{
