...
In the SOAP parameters, specify the web service URL for your web store. The page must include the component \"thurly:sale.order.payment.receive\". The option \"Use Signature\" must not be checked.
";
