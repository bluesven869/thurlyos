...
$MESS["SALE_QH_DESCRIPTION"] = "<div class='adm-info-message'>
	...
	<ol>
		...
		<li>Create a page to receive notifications from the payment system and add the <strong>thurly:sale.order.payment.receive</strong> component to it.</li>
		<li>Configure the <strong>thurly:sale.order.payment.receive</strong> for use with this payment system.</li>
