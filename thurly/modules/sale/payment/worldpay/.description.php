...
$psDescription .= "To use this feature you should copy file <nobr>/thurly/modules/sale/payment/worldpay/result.php</nobr> to file <nobr>/thurly/php_interface/include/sale_payment/worldpay_res.php</nobr><br>";
...
$psDescription .= "You should use the string like <nobr>http://your_site/thurly/php_interface/include/sale_payment/worldpay_res.php?server_responce=Y</nobr><br>";
