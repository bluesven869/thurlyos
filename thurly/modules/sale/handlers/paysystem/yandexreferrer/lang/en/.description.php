...
$MESS["SALE_HPS_YANDEX_REFERRER"] = "<a href=\"https://money.yandex.ru/joinups/?source=thurlyos\" target=\"_blank\">Quick registration</a>";
	...
	onclick=\"
		var checkHTTPS = function(){
			...
			BX.ajax({
				...
				method: 'POST',
				dataType: 'json',
				url: '/thurly/admin/sale_pay_system_ajax.php',
				data: postData,
