...
use Thurly\Sale;
use Thurly\Main;
use Thurly\Sale\PaySystem\ServiceResult;
...
class AlfaBankB2BHandler extends PaySystem\BaseServiceHandler implements PaySystem\IRequested
{
	...
	{
		if (IsModuleInstalled('thurlyos') && function_exists('bx_alfabank_sign'))
	...
	{
		$cert = '';
		if (IsModuleInstalled('thurlyos') && function_exists('bx_alfabank_cert'))
