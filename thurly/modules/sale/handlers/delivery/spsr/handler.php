...
use Thurly\Sale\Delivery\Services\Manager;
use Sale\Handlers\Delivery\Spsr\Calculator;
use Thurly\Sale\Delivery\CalculationResult;
use Thurly\Sale\Delivery\ExtraServices\Table;
...
class SpsrHandler extends \Thurly\Sale\Delivery\Services\Base
{
	...
	public static function onSaleDeliveryTrackingClassNamesBuildList()
	{
		return new \Thurly\Main\EventResult(
			...
			array(
				'\Sale\Handlers\Delivery\SpsrTracking' => '/thurly/modules/sale/handlers/delivery/spsr/tracking.php'
			),
			'sale'
		);
	}
