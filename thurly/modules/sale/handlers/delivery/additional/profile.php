...
use Thurly\Sale\Delivery\Requests\Result;
...
class AdditionalProfile extends \Thurly\Sale\Delivery\Services\Base
{
	...
	protected function 	inheritParams()
	{
		...
		$parentES = \Thurly\Sale\Delivery\ExtraServices\Manager::getExtraServicesList($this->parentId);
	...
	/**
	 * @return \Thurly\Sale\Delivery\Services\Base|\Sale\Handlers\Delivery\SpsrHandler Parent sevice.
	 */
