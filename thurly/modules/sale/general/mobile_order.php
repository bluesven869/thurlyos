...
class CSaleMobileOrderUtils
{
	...
	function getMobileReports()
	{
		...
		define('PATH_TO_MOBILE_REPORTS', '/thurly/admin/mobile/sale_reports_view.php');
		...
		$dbRepList = Thurly\Report\ReportTable::getList(array(
	...
	function buildSaleAdminMobileMenu()
	{
		$items = array(
			array(
				...
				"data-url" => "/thurly/admin/mobile/sale_orders_list.php?lang=".LANGUAGE_ID,
			...
			array(
				...
				"data-url" => "/thurly/admin/mobile/sale_orders_list.php?lang=".LANGUAGE_ID."&action=get_filtered&filter_name=waiting_for_pay",
				"data-pageid" => "orders_waiting_for_pay",
			),
			array(
				"text" => GetMessage("SMOB_WAITING_FOR_DELIVERY"),
				"data-url" => "/thurly/admin/mobile/sale_orders_list.php?lang=".LANGUAGE_ID."&action=get_filtered&filter_name=waiting_for_delivery",
				"data-pageid" => "orders_waiting_for_delivery",
			)
		);

		if (\Thurly\Main\ModuleManager::isModuleInstalled("pull"))
		{
			$items[] = array(
				"text" => GetMessage("SMOB_PUSH_SETTINGS"),
				"data-url" => "/thurly/admin/mobile/sale_orders_push.php?lang=".LANGUAGE_ID,
	...
	function makeDetailClassFromOrder($arOrder)
	{
		...
		$productListReturn = $GLOBALS["APPLICATION"]->IncludeComponent(
			'thurly:sale.mobile.product.list',
			'.default',
	...
	{
		$dbRes = \Thurly\Sale\Internals\OrderPropsValueTable::getList(array(
