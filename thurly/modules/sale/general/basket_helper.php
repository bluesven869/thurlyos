...
class CSaleBasketHelper
{
	...
	*/
	...
	public static function getVat(array $basketItemData)
	{
		...
		{
			$vat = \Thurly\Sale\PriceMaths::roundPrecision(($basketItemData['PRICE'] * $basketItemData['QUANTITY'] * $basketItemData['VAT_RATE']));
		}
		else
		{
			$vat = \Thurly\Sale\PriceMaths::roundPrecision(($basketItemData['PRICE'] * $basketItemData['QUANTITY'] * $basketItemData['VAT_RATE'] / ($basketItemData['VAT_RATE'] + 1)));
		}
	...
	public static function formatQuantity($quantity)
	{
		...
		{
			return \Thurly\Sale\BasketItem::formatQuantity($quantity);
		}
