...
{
	const SELF_ENTITY_NAME = 		'Thurly\Sale\Location\Group';
	const CONN_ENTITY_NAME = 		'Thurly\Sale\Location\GroupLocation';
	const LOCATION_ENTITY_NAME = 	'Thurly\Sale\Location\Location';
	const NAME_ENTITY_NAME = 		'Thurly\Sale\Location\Name\Group';
