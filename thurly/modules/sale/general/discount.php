...
class CAllSaleDiscount
{
		...
		if ($isOrderConverted != 'N')
		{
			...
			if (!empty($modeParams))
			{
				Sale\Discount\Actions::setUseMode(
					...
					array(
						'USE_BASE_PRICE' => \Thurly\Main\Config\Option::get('sale', 'get_discount_percent_from_base_price'),
	...
	* @see \Thurly\Sale\Internals\DiscountTable::delete
	*/
	...
	/*
	* @deprecated deprecated since sale 14.11.0
	* @see \Thurly\Sale\Internals\DiscountGroupTable::updateByDiscount
	*/
