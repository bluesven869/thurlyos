...
class CSaleLang
{
	function Add($arFields)
	{
		try
		{
			return Thurly\Sale\Internals\SiteCurrencyTable::add($arFields)->isSuccess();
		}
		catch (Exception $e)
		{
			return false;
	...
	function Update($siteId, $arFields)
	{
		...
		{
			unset($arFields["LID"]);
			return Thurly\Sale\Internals\SiteCurrencyTable::update($siteId, $arFields)->isSuccess();
		}
		else
			die("h3jg53jh2g3jh6g");
	}
	...
	{
		return Thurly\Sale\Internals\SiteCurrencyTable::delete($siteId)->isSuccess();
	}

	public static function GetByID($siteId)
	{
		return Thurly\Sale\Internals\SiteCurrencyTable::getCurrency($siteId);
	}
	 ...
	 * @see \Thurly\Sale\Internals\SiteCurrencyTable::getSiteCurrency
	 *
	...
	public static function OnBeforeCurrencyDelete($currency)
	{
		...
		if (Thurly\Sale\Internals\SiteCurrencyTable::getList(array(
			'select' => array('*'),
