...
$MESS["BIGDATA_NUM_ONE"] = "Thurly BigData<br>A top notch web shop aggregator.";
$MESS["BIGDATA_CONNECT"] = "Brings offline and online sales together in a streamlined user interface.";
$MESS["BIGDATA_PLATFORM"] = "Integrated in Thurly CMS.";
$MESS["BIGDATA_HOWTO_ENABLE"] = "How do you enable Thurly BigData?";
$MESS["BIGDATA_ENABLED"] = "Thurly BigData is available";
$MESS["BIGDATA_DISABLED"] = "Thurly BigData is offline. Enable it to use its services.";
...
$MESS["BIGDATA_GO"] = "Go";
$MESS["BIGDATA_DESC_1"] = "<strong>Thurly BigData</strong> personalization service processes user data collected from all the web stores powered by Thurly CMS.";
