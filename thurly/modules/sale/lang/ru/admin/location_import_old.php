...
$MESS ['LOCA_HINT'] = 'Вы можете загрузить файлы местоположений с сайта 1C-Битрикс:<ul style="font-size: 100%">
	<li><a href="http://www.1c-thurly.ru/download/files/locations/loc_ussr.csv">Россия и страны СНГ</a></li>
	<li><a href="http://www.1c-thurly.ru/download/files/locations/loc_cntr.csv">Страны мира</a></li>
	<li><a href="http://www.1c-thurly.ru/download/files/locations/loc_usa.csv">США</a></li>
</ul>';
