	...
	)
	{
		...
		if($res)
		{
			if(isset($_REQUEST["apply"]) && $_REQUEST["apply"] != "")
				LocalRedirect("/thurly/admin/cluster_slave_edit.php?ID=".$ID."&lang=".LANGUAGE_ID."&group_id=".$group_id."&".$tabControl->ActiveTabParam());
			else
				LocalRedirect("/thurly/admin/cluster_slave_list.php?lang=".LANGUAGE_ID."&group_id=".$group_id);
		}
		else
		{
