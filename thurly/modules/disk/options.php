...
if(\Thurly\Main\Loader::includeModule('disk'))
{
	...
	$arDefaultValues['default']['default_viewer_service'] = \Thurly\Disk\Configuration::getDefaultViewerServiceCode();
...
if(\Thurly\Main\Loader::includeModule('transformer'))
{
...
if($_SERVER["REQUEST_METHOD"]=="POST" && ($_POST['Update'] || $_POST['Apply'] || $_POST['RestoreDefaults'])>0 && check_thurly_sessid())
{
