...
class TmpFile extends Model
{
	...
	public function append($fileContent, array $params)
	{
		...
		if($this->isCloud())
		{
			return $this->appendContentCloud($fileContent, $params['startRange'], $params['endRange'], $params['fileSize']);
		}
		else
		{
			return $this->appendContentNonCloud($fileContent, $params['startRange'], $params['endRange'], $params['fileSize']);
		}
	}
