...
use Thurly\Disk\View\VersionViewManager;
...
final class Version extends Internals\Model
{
	...
	public function getView()
	{
		if(!$this->view)
		{
			...
			{
				$this->view = new View\Document($this->getName(), $this->getFileId(), $this->getViewId());
			}
			elseif(TypeFile::isVideo($this->name))
			{
				$this->view = new View\Video($this->getName(), $this->getFileId(), $this->getViewId());
			}
			else
			{
				$this->view = new View\Base($this->getName(), $this->getFileId(), $this->getViewId());
			}
		}
