...
use Thurly\Main\Entity\UpdateResult;
...
class ObjectTable extends DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'STORAGE' => array(
				'data_type' => '\Thurly\Disk\Internals\StorageTable',
				'reference' => array(
			...
			'LOCK' => array(
				'data_type' => '\Thurly\Disk\Internals\ObjectLockTable',
				'reference' => array(
					'=this.ID' => 'ref.OBJECT_ID'
				)
			),
			'TTL' => array(
				'data_type' => '\Thurly\Disk\Internals\ObjectTtlTable',
				'reference' => array(
					'=this.ID' => 'ref.OBJECT_ID'
				)
			),
			...
			'RECENTLY_USED' => array(
				'data_type' => '\Thurly\Disk\Internals\RecentlyUsedTable',
				'reference' => array(
					'=this.ID' => 'ref.OBJECT_ID'
				),
				'join_type' => 'INNER',
