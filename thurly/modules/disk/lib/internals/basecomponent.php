...
abstract class BaseComponent extends \CThurlyComponent
{
	...
	protected function resolveAction()
	{
		...
		$action = $this->request->getQuery($this->actionPrefix);
