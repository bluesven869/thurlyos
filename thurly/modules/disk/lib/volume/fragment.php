...
class Fragment
{
	...
	public function getTitle()
	{
		...
		if ($this->title == '')
		{
			/** @var \Thurly\Disk\Volume\IVolumeIndicator $class * /
	 ...
	 * @return \Thurly\Disk\Storage|null
	 */
	public function getStorage()
	{
		if (!$this->storage instanceof \Thurly\Disk\Storage && $this->storageId > 0)
		{
	...
	/**
	 * Returns disk folder.
	 * @return \Thurly\Disk\Folder|null
	 */
	public function getFolder()
	{
		if (!$this->folder instanceof \Thurly\Disk\Folder && $this->folderId > 0)
		{
	...
	/**
	 * Returns disk file.
	 * @return \Thurly\Disk\File|null
	 */
	public function getFile()
	{
		if (!$this->file instanceof \Thurly\Disk\File && $this->fileId > 0)
		{
