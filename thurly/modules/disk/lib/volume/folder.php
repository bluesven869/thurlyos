...
use Thurly\Disk\Internals\ObjectPathTable;
...
class Folder extends Volume\Base implements Volume\IVolumeIndicatorLink, Volume\IVolumeIndicatorParent, Volume\IDeleteConstraint
{
	 ...
	 * @return self
	 */
	public function recalculatePercent($totalSizeIndicator = '\\Thurly\\Disk\\Volume\\Storage\\Storage', $excludeSizeIndicator = null)
	{
	...
	public static function getParents(Volume\Fragment $fragment)
	{
		...
		$parents = \Thurly\Disk\CrumbStorage::getInstance()->getByObject($folder);
