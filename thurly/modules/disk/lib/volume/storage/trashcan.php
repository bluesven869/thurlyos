...
class TrashCan extends Volume\Storage\Storage
{
	 ...
	 * @return self
	 */
	public function recalculatePercent($totalSizeIndicator = '\\Thurly\\Disk\\Volume\\Module\\Disk', $excludeSizeIndicator = null)
	{
	...
	public static function getUrl(Volume\Fragment $fragment)
	{
		...
		if (
			...
			$testUrl == \Thurly\Disk\ProxyType\Base::SUFFIX_TRASHCAN_LIST ||
