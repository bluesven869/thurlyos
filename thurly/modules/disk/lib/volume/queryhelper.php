...
class QueryHelper
{
	...
	public static function prepareInsert(array $columns, array $selectFields = array())
	{
		...
		{
			$columns['CREATE_TIME'] = new \Thurly\Main\Type\DateTime();
		}
	...
	public static function prepareFolderTreeQuery($parentId)
	{
		...
		$subQuery
			...
			->addFilter('=folder.ID', new \Thurly\Main\DB\SqlExpression('disk_internals_object_path_folder.REAL_OBJECT_ID'))// not link
