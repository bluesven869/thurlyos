...
class Folder extends BaseObject
{
	 ...
	 * @param array $rights Rights (@see \Thurly\Disk\RightsManager).
	...
	public function markDeleted($deletedBy)
	{
		...
		foreach ($objectIterator as $objectRow)
		{
			...
			if($object instanceof Folder)
			{
				...
				/** @see \Thurly\Disk\Folder::markDeletedNonRecursiveInternal */
	...
	public function restore($restoredBy)
	{
		...
		foreach ($objectIterator as $objectRow)
		{
			...
			if($object instanceof Folder)
			{
				/** @see \Thurly\Disk\Folder::restoreNonRecursive */
	...
	public function deleteTree($deletedBy)
	{
		...
		foreach ($objectIterator as $objectRow)
		{
			...
			if($object instanceof Folder)
			{
				/** @see \Thurly\Disk\Folder::deleteNonRecursive */
				$success = $object->deleteNonRecursive($deletedBy);
			}
			elseif($object instanceof File)
			{
				/** @see \Thurly\Disk\File::delete */
