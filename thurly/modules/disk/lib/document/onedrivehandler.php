...
use Thurly\Disk\Document\Upload\OneDriveResumableUpload;
...
class OneDriveHandler extends DocumentHandler
{
	...
	public function createFile(FileData $fileData)
	{
		...
		/** @see \Thurly\Disk\Document\OneDriveHandler::getSharedLink() */
	 ...
	 *
	 * @param array $currentMetadata Metadata (@see \Thurly\Disk\Document::getFileMetadata());
