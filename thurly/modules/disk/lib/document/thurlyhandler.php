...
class ThurlyHandler extends DocumentHandler implements IViewer
{
	const ERROR_METHOD_IS_NOT_SUPPORTED = 'DISK_THURLY_HANDLER_22001';
	const ERROR_NO_VIEW = 'DISK_THURLY_HANDLER_22002';
	const ERROR_NO_VIEW_SEND_TO_TRANSFORM = 'DISK_THURLY_HANDLER_22003';
	...
	{
		return Loc::getMessage('DISK_THURLY_HANDLER_NAME');
	}
	...
	public function createBlankFile(FileData $fileData)
	{
		$this->errorCollection->add(array(
			new Error(Loc::getMessage('DISK_THURLY_HANDLER_ERROR_METHOD_IS_NOT_SUPPORTED', array('#NAME#' => $this->getName())), self::ERROR_METHOD_IS_NOT_SUPPORTED)
		));
		return null;
	}
