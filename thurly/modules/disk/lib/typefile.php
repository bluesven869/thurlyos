...
final class TypeFile
{
	...
	public static function reindexTypeFile($startFileId = 0)
	{
		...
		$fileTableName = \Thurly\Main\FileTable::getTableName();
		$diskFileTableName = \Thurly\Disk\Internals\ObjectTable::getTableName();
		...
		$updateQuery = "
			...
			WHERE 
				...
				AND o.TYPE = ". \Thurly\Disk\Internals\ObjectTable::TYPE_FILE. " 
