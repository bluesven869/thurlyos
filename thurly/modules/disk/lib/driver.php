...
use Thurly\Disk\ThurlyOSDisk\SubscriberManager;
use Thurly\Disk\Document\DocumentHandlersManager;
use Thurly\Disk\Internals\DeletedLogManager;
...
use Thurly\Disk\Search\IndexManager;
use Thurly\Disk\Security\FakeSecurityContext;
use Thurly\Disk\Uf\UserFieldManager;
...
final class Driver implements IErrorable
{
	 ...
	 *
	 * @param \Thurly\Disk\BaseObject|BaseObject $object Target object.
	 * @return array
	 */
	 ...
	 * @return void
	 */
	public function cleanCacheTreeThurlyDisk(array $storageIds)
	{
	...
	public function sendEvent($userIds, $command, array $data = array())
	{
		...
		\Thurly\Pull\Event::add(array_unique($userIds), $message);
	}
