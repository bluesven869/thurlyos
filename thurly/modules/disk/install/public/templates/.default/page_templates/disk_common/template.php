...
class CDiskCommonStoragePageTemplate
{
	public static function getDescription()
	{
		return array(
			...
			"icon"=>"/thurly/templates/.default/page_templates/disk_common/images/icon_webdav.gif",
			"modules"=>array("disk",),
			"type"=>"section",
		);
	}
	...
	public static function getFormHtml()
	{
		...
		do {
			...
			$dbRes = Thurly\Disk\Storage::getList(array("filter"=>array("NAME" => $libName, "=ENTITY_TYPE" => Thurly\Disk\ProxyType\Common::className())));
...
';
	...
	public static function getContent($arParams)
	{
		...
		return '<?require($_SERVER["DOCUMENT_ROOT"]."/thurly/header.php");
