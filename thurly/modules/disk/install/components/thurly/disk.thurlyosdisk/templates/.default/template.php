...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/file.php");
?>
<script type="text/javascript">
	...
	BX.addCustomEvent(window, "onMessengerWindowInit", function (MW, BXIM)
	{
		...
		ThurlyDisk.init({
			...
			pathToImages : "/thurly/components/thurly/disk.thurlyosdisk/templates/.default/images",
	...
	<div id="disk-wrap" class="wrap">
		<div class="header">
			...
			<div class="header_section_two">
				...
				<a onclick="ThurlyDisk.bxim.desktop.browse(ThurlyDisk.bxim.desktop.getCurrentUrl() + '<?= $personalLibIndex; ?>');" href="javascript:void(0);" class="b24"><span class="icon"></span><?=GetMessage("WD_DISK_OPEN_THURLY24")?></a>
			</div>
				...
				<div class="mrGraf">
					...
					<div class="legend_container">
						...
						<div id="disk-connect-button" style="text-align: center">
							...
							<input type="submit" id="disk_disconnectbutton" onclick="ThurlyDisk.switchOn(true);" class="disk-connectbutton small" value="<?=GetMessage("WD_DISK_ATTACH")?>">
						</div>
					...
					<div id="disk-change-target-folder" style="font-size: 13px;margin-top: 21px;padding: 14px 0 12px 39px;"><?= GetMessage('WD_DISK_CHANGE_TARGET_DIR_TEXT', array('#PATH#' => '<span id="attach_disk_path"></span>', '#LINK#' => '<a href="javascript:void(0);" onclick="ThurlyDisk.changeTargetFolder(); return false;">', '#END_LINK#' => '</a>')); ?></a></div>
