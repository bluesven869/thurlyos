...
class CDiskFolderToolbarComponent extends DiskComponent
{
	...
	protected function processActionDefault()
	{
		...
		if($this->isFolderList() && $folder->canAdd($securityContext) && !$this->isArchivedGroupStorage())
		{
			...
			if(\Thurly\Disk\Configuration::canCreateFileByCloud())
			{
				...
				{
					$defaultDocumentHandler = \Thurly\Disk\Driver::getInstance()->getDocumentHandlersManager()->getDefaultServiceForCurrentUser();
	...
	protected function isArchivedGroupStorage()
	{
		...
		if(!$this->storage->getProxyType() instanceof Thurly\Disk\ProxyType\Group)
		{
			return $this->isArchivedGroupStorage;
		}
