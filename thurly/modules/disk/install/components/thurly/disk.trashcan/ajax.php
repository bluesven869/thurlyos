...
class DiskTrashCanAjaxController extends \Thurly\Disk\Internals\Controller
{
	...
	protected function processActionCalculate()
	{
		...
		$countQuery = new Thurly\Main\Entity\Query(FolderTable::getEntity());
		$totalCount = $countQuery
			...
			->addSelect(new \Thurly\Main\Entity\ExpressionField('CNT', 'COUNT(1)'))
