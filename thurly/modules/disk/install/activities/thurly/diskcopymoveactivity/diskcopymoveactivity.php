	...
	extends CBPActivity
{
	...
	public function Execute()
	{
		...
		if (!$operator)
			$operator = \Thurly\Disk\SystemUser::SYSTEM_USER_ID;

		foreach ((array) $this->SourceId as $sourceId)
		{

			$sourceObject = \Thurly\Disk\BaseObject::loadById($sourceId);
			...
			$isFolder = ($sourceObject instanceof \Thurly\Disk\Folder);
