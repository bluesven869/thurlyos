...
CJSCore::RegisterExt('voximplant', array(
	'js' => '/thurly/js/voximplant/voximplant.js',
	'lang' => '/thurly/modules/voximplant/lang/'.LANGUAGE_ID.'/install/js/common.php',
));

CJSCore::RegisterExt('voximplant_transcript', array(
	'js' => '/thurly/js/voximplant/transcript.js',
	'lang' => '/thurly/modules/voximplant/lang/'.LANGUAGE_ID.'/install/js/transcript.php',
));
?>