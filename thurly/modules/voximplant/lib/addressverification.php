...
class AddressVerification
{
	...
	public function setFilledByUser($userId)
	{
		...
		\Thurly\Main\Config\Option::set('voximplant', 'address_verification_filled_by', $userId);
	}
	...
	{
		$lastFilledBy = (int)\Thurly\Main\Config\Option::get('voximplant', 'address_verification_filled_by');
