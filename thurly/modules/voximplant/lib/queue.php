...
use Thurly\Voximplant\Model\QueueUserTable;
...
class Queue
{
	...
	public function findUsages()
	{
		...
		$usedIvrList = array();
		$ivrCursor = \Thurly\Voximplant\Model\IvrActionTable::getList(array(
			'select' => array(
				'*',
				'IVR_ID' => 'ITEM.IVR.ID',
			...
			'filter' => array(
				'=ACTION' => \Thurly\Voximplant\Ivr\Action::ACTION_QUEUE
			)
		));
