...
class ConfigTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'DATE_DELETE' => new Entity\DatetimeField('DATE_DELETE', array(
				'title' => Loc::getMessage('INCOMING_CONFIG_ENTITY_DATE_DELETE_FIELD'),
			)),
			'TO_DELETE' => new Entity\BooleanField('TO_DELETE', array(
				'values' => array('N', 'Y'),
