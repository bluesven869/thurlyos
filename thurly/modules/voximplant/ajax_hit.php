...
if($_SERVER["REQUEST_METHOD"] == "POST" && array_key_exists("IM_AJAX_CALL", $_REQUEST) && $_REQUEST["IM_AJAX_CALL"] === "Y" && $_POST['IM_PHONE'] == 'Y')
{
	...
	if (check_thurly_sessid())
	{
		...
		{
			$_POST['PARAMS'] = CUtil::JsObjectToPhp($_POST['PARAMS']);
			\Thurly\Voximplant\Rest\Helper::startCall($_POST['PARAMS']['NUMBER'], $userId, $_POST['PARAMS']['LINE_ID'], $_POST['PARAMS']['PARAMS']);
		}
		...
		{
			$params =  \Thurly\Main\Web\Json::decode($_POST['PARAMS']);
