	...
	<div class="tel-inner-left">
		...
		if($arResult['SHOW_LINES'])
		{
			$APPLICATION->IncludeComponent(
				"thurly:voximplant.regular_payments", 
				"", 
				Array(
			...
			$APPLICATION->IncludeComponent("thurly:voximplant.sip_payments", "", array());
		}
		?>
	</div>
...
<? if($arResult['SHOW_STATISTICS'] && count($arResult['STATISTICS']) > 0): ?>
	<div class="tel-inner-right">
		...
		<?if ($arResult['RECORD_LIMIT']['ENABLE'] && CModule::IncludeModule('thurlyos')):?>
		<?
