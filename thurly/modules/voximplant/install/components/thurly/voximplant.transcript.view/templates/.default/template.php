		...
		<div class="vox-transcript-dialog" data-role="dialog">
			<? foreach ($arResult['LINES'] as $line): ?>
				<div class="vox-transcript-line-container" data-text="<?= htmlspecialcharsbx($line['MESSAGE'])?>">
					<div class="vox-transcript-avatar <?=($line['SIDE'] == \Thurly\Voximplant\Transcript::SIDE_CLIENT ? 'vox-transcript-avatar-left' : 'vox-transcript-avatar-right')?>">
						<? if($line['SIDE'] == \Thurly\Voximplant\Transcript::SIDE_CLIENT && $arResult['CLIENT']['PHOTO'] != ''): ?>
							<div class="vox-transcript-avatar-icon" style="background-image: url(<?=$arResult['CLIENT']['PHOTO']?>)"></div>
						<? elseif($line['SIDE'] == \Thurly\Voximplant\Transcript::SIDE_USER && $arResult['USER']['PHOTO'] != ''): ?>
					...
					<div class="vox-transcript-line">
						<div class="vox-transcript-line-message">
							<div class="vox-transcript-line-message-wrap <?=($line['SIDE'] == \Thurly\Voximplant\Transcript::SIDE_CLIENT ? 'vox-transcript-line-message-incoming' : 'vox-transcript-line-message-outgoing' )?>">
								<div class="vox-transcript-line-message-header">
									<div class="vox-transcript-line-message-name">
										<? if($line['SIDE'] == \Thurly\Voximplant\Transcript::SIDE_CLIENT): ?>
