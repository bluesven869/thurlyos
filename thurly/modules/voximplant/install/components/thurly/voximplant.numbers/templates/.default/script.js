		...
		BX.ready(function(){
			...
			BX.bind(BX('option_btn'), 'click', function() {
				...
				BX.ajax({
					...
					data: {sessid : BX.thurly_sessid(), portalNumber : BX('option_form').elements.portalNumber.value},
					dataType: 'json',
					onsuccess: function()
					{
		...
		var tableChilds = [
			...
			BX.create('tr', {
				children: [
					BX.create('td', {
						children: [
							BX.create('input', { attrs : {"type": "hidden", "name": "sessid", "value": BX.thurly_sessid()}}),
