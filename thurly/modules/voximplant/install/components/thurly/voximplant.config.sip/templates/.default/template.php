...
CJSCore::RegisterExt('voximplant_config_sip', array(
	'js' => '/thurly/components/thurly/voximplant.config.sip/templates/.default/template.js',
	'lang' => '/thurly/components/thurly/voximplant.config.sip/templates/.default/lang/'.LANGUAGE_ID.'/template.php',
));
CJSCore::Init(array('voximplant_config_sip'));

if(IsModuleInstalled('rest'))
	\Thurly\Main\Page\Asset::getInstance()->addCss('/thurly/components/thurly/rest.marketplace/templates/.default/style.css');
?>
<div class="">
	<div class="tel-sip-header-container">
		...
		<? endif ?>
		<div id="header-connector" class="tel-sip-header-block tel-sip-header-block-inactive">
	...
	<? endif ?>
	<div id="detail-connector" class="tel-set-item-group" style="display: none">
		<div>
			<div class="tel-set-text-block">
