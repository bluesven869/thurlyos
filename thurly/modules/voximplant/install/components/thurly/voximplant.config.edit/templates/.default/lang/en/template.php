<?
$MESS["VI_CONFIG_NEW_RENT"] = "Congratulations! The phone number has been connected to your ThurlyOS!";
...
$MESS["VI_CONFIG_EDIT_SIP_HEADER_PROCESSING_TIP"] = "Incoming call will be forwarded to an employees whose internal extention is listed in the To: SIP header of the INVITE query";
$MESS["VI_CONFIG_EDIT_EXT_NUM_PROCESSING"] = "Extension number processing";
$MESS["VI_CONFIG_EDIT_EXT_NUM_PROCESSING_TIP"] = "An incoming call can be re-routed to a particular ThurlyOS user if the client enters the corresponding extension number. You can configure extension numbers for ThurlyOS users in their profiles.";
...
$MESS["VI_CONFIG_EDIT_EXT_NUM_PROCESSING_OMITTED_CALL"] = "If ThurlyOS user does not answer &nbsp; &mdash; &nbsp;";
...
$MESS["VI_CONFIG_EDIT_CRM_FORWARD"] = "Direct incoming calls to the responsible ThurlyOS user if caller is identified";
$MESS["VI_CONFIG_EDIT_CRM_CHECKING_OMITTED_CALL"] = "If the responsible ThurlyOS user does not answer &nbsp; &mdash; &nbsp;";
...
$MESS["VI_CONFIG_EDIT_CRM_TRANSFER_CHANGE"] = "Automatically change ThurlyOS user responsible for the lead when manually forwarding a call";
...
$MESS["VI_CONFIG_SIP_OUT"] = "To call from ThurlyOS via your telephony provider, please provide your IP-PBX data:";
...
$MESS["VI_CONFIG_SIP_C_STATUS_SUCCESS_DESC"] = "Connection has been completed. Your ThurlyOS can now accept incoming calls.";
...
$MESS["VI_CONFIG_SIP_C_CONFIG"] = "Please specify connection parameters to call and accept calls in your ThurlyOS using your cloud provider:";
...
$MESS["VI_CONFIG_TEST_TITLE"] = "Virtual number for your ThurlyOS is: #NUMBER#";
