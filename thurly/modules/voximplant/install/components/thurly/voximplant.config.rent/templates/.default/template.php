...
CJSCore::RegisterExt('voximplant_config_rent', array(
	'js' => '/thurly/components/thurly/voximplant.config.rent/templates/.default/template.js',
	'lang' => '/thurly/components/thurly/voximplant.config.rent/templates/.default/lang/'.LANGUAGE_ID.'/template.php',
));
...
<?else:?>
	...
	<?foreach ($arResult['LIST_RENT_NUMBERS'] as $id => $config):?>
		<div class="tel-set-num-block" id="phone-confing-<?=$id?>">
			...
			<a class="webform-button tel-set-inp-upload-document" href="<?=CVoxImplantMain::GetPublicFolder()?>configs.php"><span class="webform-button-left"></span><span class="webform-button-text"><?=GetMessage('VI_CONFIG_RENT_PHONE_DOCS')?></span><span class="webform-button-right"></span></a>
			<?endif;?>
			&nbsp;
