...
class LogIndex
{
	...
	public static function getEntitiesName($entityCodesList = array())
	{
		...
		{
			$renderPartsUser = new \Thurly\Socialnetwork\Livefeed\RenderParts\User($renderOptions);
		}
		if ($renderPartsSonetGroup === false)
		{
			$renderPartsSonetGroup = new \Thurly\Socialnetwork\Livefeed\RenderParts\SonetGroup($renderOptions);
		}
		if ($renderPartsDepartment === false)
		{
			$renderPartsDepartment = new \Thurly\Socialnetwork\Livefeed\RenderParts\Department($renderOptions);
		}
	...
	public static function getDiskUFFileNameList($valueList = array())
	{
		...
		)
		{
			...
			foreach($valueList as $value)
			{
				...
				{
					$file = \Thurly\Disk\File::loadById($realValue, array('STORAGE'));
