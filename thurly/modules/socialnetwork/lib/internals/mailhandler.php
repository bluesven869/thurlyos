...
namespace Thurly\Socialnetwork\Internals;
 ...
 *
 * Class MailHandler
 * @package Thurly\Socialnetwork\Internals
 */
final class MailHandler
{
	 ...
	 * @return int|false
	 */
	public static function handleReplyReceivedLogEntry(\Thurly\Main\Event $event)
	{
		global $USER, $DB;
		...
		$siteId = \Thurly\Socialnetwork\Util::getSiteIdByLogId($logEntry["ID"]);
		...
		{
			if (\Thurly\Socialnetwork\ComponentHelper::canAddComment($logEntry, $commentEvent))
			{
				$fields = array(
				...
				{
					\Thurly\Disk\Uf\FileUserType::setValueForAllowEdit("SONET_COMMENT", true);
				}
				...
				{
					\Thurly\Socialnetwork\ComponentHelper::addLiveComment(
						$comment,
						$logEntry,
						$commentEvent,
						array(
