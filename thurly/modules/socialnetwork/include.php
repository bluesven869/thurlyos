...
use Thurly\Socialnetwork\Integration;
...
)
{
	...
	IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/socialnetwork/install/js/log_destination.php');

	CJSCore::RegisterExt('socnetlogdest', array(
		'js' => '/thurly/js/socialnetwork/log-destination.js',
		'css' => '/thurly/js/main/core/css/core_finder.css',
...
if(
	...
	\Thurly\Main\Config\Option::get('disk', 'disk_allow_video_transformation', 'N') == 'Y'
)
{
	$transformationLimit = \Thurly\Main\Config\Option::get('disk', 'disk_max_size_for_video_transformation', 300) * 1024 * 1024;
}
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/socialnetwork/install/js/video_recorder.php');
CJSCore::RegisterExt('videorecorder', array(
	'js' => '/thurly/js/socialnetwork/video_recorder.js',
	'css' => '/thurly/js/socialnetwork/css/video_recorder.css',
	'lang_additional' => array(
...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/socialnetwork/install/js/comment_aux.php');
CJSCore::RegisterExt('comment_aux', array(
	'js' => '/thurly/js/socialnetwork/comment_aux.js',
	'lang_additional' => array(
...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/socialnetwork/install/js/render_parts.php');
CJSCore::RegisterExt('render_parts', array(
	'js' => '/thurly/js/socialnetwork/render_parts.js',
	'lang_additional' => array(
...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/socialnetwork/install/js/content_view.php');
CJSCore::RegisterExt('content_view', array(
	'js' => '/thurly/js/socialnetwork/content_view.js',
	'css' => '/thurly/js/socialnetwork/css/content_view.css',
	'lang_additional' => array(
...
{
	$livefeedProvider = new \Thurly\Socialnetwork\Livefeed\BlogPost;
...
class CSocNetUpdater
{
	...
	{
		include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/socialnetwork/updtr".$version.".php");
	}
}
