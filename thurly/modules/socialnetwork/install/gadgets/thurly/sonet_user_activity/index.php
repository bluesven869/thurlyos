...
if(strlen($arGadgetParams["LIST_URL"])>0):
	...
	?>
	<div align="right"><a href="<?=$list_url?>"><?echo GetMessage("GD_ACTIVITY_MORE")?></a> <a href="<?=$list_url?>"><img width="7" height="7" border="0" src="/thurly/images/socialnetwork/icons/arrows.gif" /></a>
	<br />
	</div><?
endif?>