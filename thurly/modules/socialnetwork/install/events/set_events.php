...
{
	$lid = $lang["LID"];
	IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/socialnetwork/install/events.php", $lid);
	...
	if(count($arSites) > 0)
	{
		...
		$emess->Add(array(
			...
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:socialnetwork.log.entry.mail\",\"\",array(\"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"RECIPIENT_ID\" => \"{#RECIPIENT_ID#}\",\"LOG_ENTRY_ID\" => \"{#LOG_ENTRY_ID#}\",\"URL\" => \"{#URL#}\"));?>",
			"BODY_TYPE" => "html",
		...
		$emess->Add(array(
			...
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:socialnetwork.log.entry.mail\",\"\",array(\"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"RECIPIENT_ID\" => \"{#RECIPIENT_ID#}\",\"LOG_ENTRY_ID\" => \"{#LOG_ENTRY_ID#}\",\"COMMENT_ID\" => \"{#COMMENT_ID#}\",\"URL\" => \"{#URL#}\"));?>",
			"BODY_TYPE" => "html",
			"SITE_TEMPLATE_ID" => "mail_user"
		));
	}
