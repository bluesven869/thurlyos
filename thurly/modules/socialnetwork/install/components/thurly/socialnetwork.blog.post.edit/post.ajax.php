...
if (check_thurly_sessid())
{
	...
	else
	{
		...
		elseif(isset($_POST["thurly_processes"]))
		{
			if(CModule::IncludeModule('lists'))
			{
				...
				while($list = $lists->fetch())
				{
					if(CLists::getLiveFeed($list['ID']))
					{
						...
						{
							$listData[$list['ID']]['PICTURE'] = '<img src="/thurly/images/lists/default.png" width="36" height="30" border="0" />';
							$listData[$list['ID']]['PICTURE_SMALL'] = '<img src="/thurly/images/lists/default.png" width="19" height="16" border="0" />';
						}
					}
				}
