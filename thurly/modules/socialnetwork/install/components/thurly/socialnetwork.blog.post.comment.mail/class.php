...
class CThurlySocialnetworkBlogPostCommentMailComponent extends CThurlyComponent
{
	...
	private function obtainDataComment()
	{
		...
		{
			if (!in_array($arResult["COMMENT"]["AUTHOR_ID"], $this->authorIdList))
			{
				$this->authorIdList[] = $arResult["COMMENT"]["AUTHOR_ID"];
			}
