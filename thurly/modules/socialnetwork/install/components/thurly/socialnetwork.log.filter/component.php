...
if ($USER->IsAuthorized())
{
	...
	{
		\Thurly\Socialnetwork\LogViewTable::set($USER->GetID(), 'tasks', ($_GET["set_expert_mode"] == "Y" ? "N" : "Y"));
...
foreach($arResult["PresetFilters"] as $presetFilter)
{
	...
	{
		$renderPartsUser = new \Thurly\Socialnetwork\Livefeed\RenderParts\User(array('skipLink' => true));
