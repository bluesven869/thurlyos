...
else
{
	...
	$isCompositeMode = defined("THURLY24_INDEX_COMPOSITE");
	...
	?><script>
		...
		lentaMenuItems.actions = [
			...
			if (
				...
				&& class_exists('\Thurly\Socialnetwork\LogViewTable') // socialnetwork 16.5.0
			)
			{
				?>
				{
			...
			)
			{
				...
				$APPLICATION->IncludeComponent(
					...
					array(
						...
						'CALLBACK' => array(
							'select' => 'ThurlyLFFilterDestinationSelectorManager.onSelect',
							'unSelect' => '',
							'openDialog' => '',
							'closeDialog' => '',
							'openSearch' => ''
				...
				BX.ready(
					function()
					{
						ThurlyLFFilterDestinationSelector.create(
