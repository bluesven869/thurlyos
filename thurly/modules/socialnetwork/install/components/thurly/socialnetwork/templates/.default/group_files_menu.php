...
if ($arParams["SHOW_WEBDAV"] == "Y")
{
	...
	include_once($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/components/thurly/webdav/templates/.default/informer.php");
}
...
?><?$result = $APPLICATION->IncludeComponent("thurly:webdav.menu", ".default", Array(
