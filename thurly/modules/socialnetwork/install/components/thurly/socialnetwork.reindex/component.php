...
if($_GET["index"] == "y" && check_thurly_sessid())
{
...
var url_template = <?echo CUtil::PhpToJSObject($APPLICATION->GetCurPageParam(thurly_sessid_get()."&index=y&step=#step#&last_id=#last_id#&cnt=#cnt#", array("step", "last_id", "cnt", "sessid", "index")));?>;
var continue_url = '';
var continue_item = '';
