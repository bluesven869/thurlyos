function fasessid(href)
{
	if (typeof href == "string")
		href += (href.indexOf("?") < 0 ? "?" : "&") + "sessid=" + BX.thurly_sessid();
	else if (BX.type.isDomNode(href))
		href.href += (href.href.indexOf("?") < 0 ? "?" : "&") + "sessid=" + BX.thurly_sessid()
	return href;
}
function forumActionComment(link, action)
{
	...
	href += ((href.indexOf('?') > -1) ? '&' : '?') + 'AJAX_CALL=Y&sessid=' + phpVars.thurly_sessid;
