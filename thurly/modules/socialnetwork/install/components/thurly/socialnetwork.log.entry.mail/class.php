...
use Thurly\Socialnetwork\ComponentHelper;

if (!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED !== true) die();

require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/components/thurly/socialnetwork.log.entry/include.php");

class CThurlySocialnetworkLogEntryMailComponent extends CThurlyComponent
{
	...
	private function obtainDataLogEntry()
	{
		...
		if ($this->logEntryId > 0)
		{
			...
			{
				$siteId = \Thurly\Socialnetwork\Util::getSiteIdByLogId($this->logEntryId);
