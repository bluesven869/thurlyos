...
$davEnabled = \Thurly\Main\Loader::includeModule('dav');
...
if ($arParams["SEF_MODE"] == "Y")
{
	...
	if($diskEnabled)
	{
		...
		$engine->setResolveCallback(array(\Thurly\Disk\Driver::getInstance()->getUrlManager(), "resolveSocNetPathComponentEngine"));
	}
...
//	$componentPage = CComponentEngine::ParseComponentPath($arParams["SEF_FOLDER"], $arUrlTemplates, $arVariables);
	...
	\Thurly\Socialnetwork\ComponentHelper::setComponentOption(
		array(
			array(
...
/********************************************************************
				Search Index
********************************************************************/
if(check_thurly_sessid() || $_SERVER['REQUEST_METHOD'] == "PUT")
{
...
)
{
	...
	{
		\Thurly\Socialnetwork\ComponentHelper::checkProfileRedirect(intval($arResult["VARIABLES"]["user_id"]));
	}
...
Thurly\Main\UrlPreview\Router::setRouteHandler(
		...
		'socialnetwork',
		'\Thurly\Socialnetwork\Ui\Preview\Post',
		array(
				'postId' => '$post_id',
				'userId' => '$user_id',
