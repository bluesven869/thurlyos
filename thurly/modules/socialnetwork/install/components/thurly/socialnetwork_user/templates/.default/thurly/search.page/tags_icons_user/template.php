...
$APPLICATION->IncludeComponent("thurly:search.tags.cloud", ".default", $arCloudParams, $component);

?><br /><div class="search-page">
<form action="" method="get" name="sonet_content_search_form" id="sonet_content_search_form">
	<?

	$params_to_kill = array("q", "how", "where", "tags", "clear_cache", "thurly_include_areas", "show_include_exec_time", "show_page_exec_time", "thurly_show_mode");
