		...
		<form method="post" name="form1" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
			<table class="sonet-subscribe-form" cellspacing="0" cellpadding="0">
				<tr>
					...
					<table width="100%">
					<tr>
						<td class="subscribe-header-left"><img src="/thurly/images/1.gif" width="2" height="29"></td>
						<td class="subscribe-header-center"><b><?
						echo GetMessage("SONET_C3_ENTITY_TITLE_".$arParams["ENTITY_TYPE"]);
						?></b></td>
						<td class="subscribe-header-right"><img src="/thurly/images/1.gif" width="2" height="29"></td>
					</tr>
					</table>
					</td>
				</tr>			
