...
var sonetChatSessid = '<?= thurly_sessid_get() ?>';
...
<script type="text/javascript" src="/thurly/components/thurly/player/mediaplayer/flvscript.js<?echo (strpos($_SERVER["HTTP_USER_AGENT"], "Opera") !== false? '':'?v='.filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/player/mediaplayer/flvscript.js'))?>"></script>
...
width="1" height="1"
id="socnet_player">
	<param name=movie value="/thurly/components/thurly/player/mediaplayer/player">
	<param name=quality value="high">
	<param name=swLiveConnect value="true">
	<param name=allowScriptAccess value="always">
	<param name="FlashVars" value="file=/thurly/sounds/socialnetwork/incoming_message.mp3&controlbar=none&autostart=false&bufferlength=10">

	<embed type="application/x-shockwave-flash"
	pluginspage="http://www.macromedia.com/go/getflashplayer"
	width="1" height="1"
	id="socnet_player_embed"
	src="/thurly/components/thurly/player/mediaplayer/player"
	flashvars="file=/thurly/sounds/socialnetwork/incoming_message.mp3&controlbar=none&autostart=false&bufferlength=10">
	</embed>
</object>
</div>
</div>
