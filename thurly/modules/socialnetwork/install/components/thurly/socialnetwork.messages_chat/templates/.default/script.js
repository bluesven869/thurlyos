...
function sonet_play_sound(snd)
{
	...
	var file;
	if(snd == 'system')
		file = '/thurly/sounds/socialnetwork/system_message.mp3';
	else
		file = '/thurly/sounds/socialnetwork/incoming_message.mp3';
...
{
	sonetChatXmlHttpOpt.open("get",	'/thurly/admin/user_options.php?'+'&p[0][c]='+category+
