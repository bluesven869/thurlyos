...
<div style="display:none;">
	<form action="/thurly/urlrewrite.php" <?
...
?>
	...
	<?$APPLICATION->IncludeComponent("thurly:main.post.form", "", $formParams, false, Array("HIDE_ICONS" => "Y"));?>
<?
...
BX.ready(function(){
	...
	window["SBPC"] = {
		...
		actionUrl : '<?=(
			$arParams["SEF"] == "Y"
				? '/thurly/urlrewrite.php?SEF_APPLICATION_CUR_PAGE_URL='.str_replace("%23", "#", urlencode($arResult["urlToPost"]))
