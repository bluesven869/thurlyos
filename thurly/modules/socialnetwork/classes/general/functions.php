...
class CSocNetTextParser
{
	...
	function convert_emoticon($code = "", $image = "", $description = "", $servername = "")
	{
		...
		return '<img src="'.$servername.'/thurly/images/socialnetwork/smile/'.$image.'" border="0" alt="smile'.$code.'" title="'.$description.'" />';
	}
...
class CSocNetTools
{
	...
	public static function InitGlobalExtranetArrays($SITE_ID = SITE_ID)
	{
		...
		)
		{
			...
			{
				$GLOBALS["arExtranetGroupID"] = \Thurly\Socialnetwork\ComponentHelper::getExtranetSonetGroupIdList();
				$GLOBALS["arExtranetUserID"] = \Thurly\Socialnetwork\ComponentHelper::getExtranetUserIdList();
			}
		}
	}
