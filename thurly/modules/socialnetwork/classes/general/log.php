...
class CAllSocNetLog
{
	...
	function InitUserTmp($userID, $arParams, $bCurrentUserIsAdmin = "unknown", $bRSS = false)
	{
		...
		if ($arUser = $dbUser->Fetch())
		{
			...
			$arImage = CSocNetTools::InitImage($arUser["PERSONAL_PHOTO"], 100, "/thurly/images/socialnetwork/nopic_user_100.gif", 100, $pu, $canViewProfile);
	...
	function InitGroupTmp($groupID, $arParams, $bRSS = false)
	{
		...
		if ($arGroup)
		{
			...
			$arImage = CSocNetTools::InitImage($arGroup["IMAGE_ID"], 100, "/thurly/images/socialnetwork/nopic_group_100.gif", 100, $pu, true);
