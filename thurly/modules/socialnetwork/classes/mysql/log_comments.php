<?
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/socialnetwork/classes/general/log_comments.php");

use Thurly\Socialnetwork\Item\LogIndex;
use Thurly\Socialnetwork\LogIndexTable;
use Thurly\Socialnetwork\Item\LogComment;
use Thurly\Socialnetwork\LogTagTable;
use Thurly\Socialnetwork\Util;
...
class CSocNetLogComments extends CAllSocNetLogComments
{
	...
	function Add($arFields, $bSetSource = false, $bSendEvent = true, $bSetLogUpDate = true)
	{
		...
		)
		{
			...
			\Thurly\Socialnetwork\Util::processEqualityFieldsToInsert($arFields1, $arInsert);
	...
	function Update($ID, $arFields, $bSetSource = false)
	{
		...
		$arFields1 = \Thurly\Socialnetwork\Util::getEqualityFields($arFields);
		...
		)
		{
			...
			\Thurly\Socialnetwork\Util::processEqualityFieldsToUpdate($arFields1, $strUpdate);
