...
else
{
	...
	{
		$bVarsFromForm = true;
		if ($_SERVER['REQUEST_METHOD'] == 'POST' && check_thurly_sessid() && (isset($_POST['save']) || isset($_POST['continue']) || $bAjaxSubmit) && $arResult["IS_EDIT_PERMITTED"])
		{
		...
		/*	if ($bAjaxSubmit)
			{
				...
				echo \Thurly\Main\Web\Json::encode($arResponse);
				CMain::FinalActions();
				die();
			}*/
