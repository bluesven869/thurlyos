...
if($comm)
{
	...
	if($commOwnerTypeID === CCrmOwnerType::Company)
	{
		...
		if($arCompany)
		{
			...
			$arFields['CLIENT_IMAGE_URL'] = SITE_DIR.'thurly/templates/mobile_app/images/crm/no_company_big.png?ver=1';
	...
	elseif($commOwnerTypeID === CCrmOwnerType::Contact)
	{
		...
		if($arContact)
		{
			...
			$arFields['CLIENT_IMAGE_URL'] = SITE_DIR.'thurly/templates/mobile_app/images/crm/no_contact_big.png?ver=1';
	...
	elseif($commOwnerTypeID === CCrmOwnerType::Lead)
	{
		...
		if($arLead)
		{
			...
			$arFields['CLIENT_IMAGE_URL'] = SITE_DIR.'thurly/templates/mobile_app/images/crm/no_lead_big.png?ver=1';
...
$serviceURLTemplate = ($arParams["SERVICE_URL_TEMPLATE"]
	...
	: '#SITE_DIR#thurly/components/thurly/mobile.crm.activity.edit/ajax.php?site_id=#SITE#&sessid=#SID#'
);
