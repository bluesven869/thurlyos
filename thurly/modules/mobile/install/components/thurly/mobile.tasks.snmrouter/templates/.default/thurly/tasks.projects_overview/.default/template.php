...
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("page", "tasks.projects");
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("MobileAPIVersion", CMobile::getApiVersion());
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("MobilePlatform", CMobile::getPlatform());
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("version", "v1.3");
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("LanguageId", LANGUAGE_ID);
\Thurly\Main\Page\Asset::getInstance()->addJs(SITE_TEMPLATE_PATH.'/tasks/logic.js');
\Thurly\Main\Page\Asset::getInstance()->addJs($templateFolder.'/../../tasks.list.controls/.default/script.js');
...
<script>
	BX.ready(function(){
		...
		app.hidePopupLoader();
		var res = new BX.Mobile.Tasks.View.Thurly.taskgroups({scope: BX('tasks-all-items')}),
