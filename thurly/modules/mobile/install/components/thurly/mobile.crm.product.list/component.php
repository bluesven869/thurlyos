...
foreach ($arProducts as &$item)
{
	...
	$arResult['ITEMS'][$item['ID']] = array(
		...
		"ONCLICK" => $arResult['LIST_MODE'] == "SELECTOR"
			? 'BX.Mobile.Crm.ProductList.onSelectItem(\''.CUtil::JSEscape($arParams["ON_PRODUCT_SELECT_EVENT_NAME"]).'\', '.CUtil::PhpToJSObject($itemData).', \''.CUtil::JSEscape($arParams["PAGEID_PRODUCT_SELECTOR_BACK"]).'\')'
