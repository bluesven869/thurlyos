...
elseif (is_array($events))
{
	...
	$iconEvent = '/thurly/templates/mobile_app/images/calendar/event.png';
	$iconMeeting = '/thurly/templates/mobile_app/images/calendar/meeting.png';
	$iconInviting = '/thurly/templates/mobile_app/images/calendar/meeting-q.png';
