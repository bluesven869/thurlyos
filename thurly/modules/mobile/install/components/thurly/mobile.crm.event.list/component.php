...
if ($entityTypeID == CCrmOwnerType::Invoice)
{
	...
	$dbRes = $event->GetList(array('date_create' => 'desc'), $arFilter, false, $arNavParams, array(), array());
...
$arResult['SERVICE_URL'] = SITE_DIR.'thurly/components/thurly/mobile.crm.event.list/ajax.php?siteID='.SITE_ID.'&'.thurly_sessid_get();
//<-- NEXT_PAGE_URL, SEARCH_PAGE_URL, SERVICE_URL
