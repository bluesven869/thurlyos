...
use Thurly\Main\Page\AssetShowTargetType;
...
\Thurly\Main\Data\AppCacheManifest::getInstance()->setManifestCheckFile(SITE_DIR . "mobile/");
if(CModule::IncludeModule("mobile"))
{
	CJSCore::Init(array("mobile_ui"));
}

define("MOBILE_MODULE_VERSION", "18");
...
<head>
	...
	if ($USER->IsAuthorized())
	{
		\Thurly\Main\Page\Asset::getInstance()->addString(
			...
			$unique = false,
		\Thurly\Main\Page\AssetLocation::AFTER_JS,
		\Thurly\Main\Page\AssetMode::ALL
		);
	}
