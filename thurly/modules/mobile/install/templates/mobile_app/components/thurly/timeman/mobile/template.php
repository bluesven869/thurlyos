...
if ($request->getQuery("report") == "Y")
{
	if ($arResult["START_INFO"]["ID"] > 0)
	{
		...
		\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("page", "timeman.report");
...
{
	\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("page", "timeman.edit");
...
else
{
	...
	\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("page", "timeman.view");
	$feedFrame = $this->createFrame()->begin();
?>
<script>
