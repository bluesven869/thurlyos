...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/include.php");

IncludeModuleLangFile(__FILE__);

if($REQUEST_METHOD=="POST" && check_thurly_sessid())
{
	...
	else if (isset($_POST["convert_button"]))
	{
		...
		while ($site = $rsSite->Fetch())
		{
			...
			{
				$lang = in_array(LANGUAGE_ID, array("ru", "en", "de")) ? LANGUAGE_ID : \Thurly\Main\Localization\Loc::getDefaultLang(LANGUAGE_ID);
				if (file_exists($_SERVER['DOCUMENT_ROOT']."/thurly/wizards/thurly/extranet/site/public/".$lang."/"))
				{
					CopyDirFiles(
						$_SERVER['DOCUMENT_ROOT']."/thurly/wizards/thurly/extranet/site/public/".$lang."/.top.menu_ext.php",
			...
			{
				require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/classes/general/wizard_util.php");

				/*======== timeman ====*/
				if (file_exists($_SERVER['DOCUMENT_ROOT']."/thurly/wizards/thurly/portal/site/public/timeman/"))
				{
					CopyDirFiles(
						$_SERVER["DOCUMENT_ROOT"]."/thurly/wizards/thurly/portal/site/public/timeman/",
					...
					CUrlRewriter::Update(array("ID" => 'thurly:meetings'), array(
				...
				/*======== bizproc ====*/
				if (file_exists($_SERVER['DOCUMENT_ROOT']."/thurly/wizards/thurly/portal/site/public/bizproc/"))
				{
					CopyDirFiles(
						$_SERVER["DOCUMENT_ROOT"]."/thurly/wizards/thurly/portal/site/public/bizproc/",
					...
					CUrlRewriter::Update(array("ID" => 'thurly:lists', "CONDITION" => '#^'.$site['DIR'].'services/processes/#'), array(
				...
				/*======== calendar ====*/
				if (file_exists($_SERVER['DOCUMENT_ROOT']."/thurly/wizards/thurly/portal/site/public/calendar/"))
				{
					CopyDirFiles(
						$_SERVER["DOCUMENT_ROOT"]."/thurly/wizards/thurly/portal/site/public/calendar/",
				...
				/*======== disk ====*/
				if (file_exists($_SERVER['DOCUMENT_ROOT']."/thurly/wizards/thurly/portal/site/public/docs/"))
				{
					CopyDirFiles(
						$_SERVER["DOCUMENT_ROOT"]."/thurly/wizards/thurly/portal/site/public/docs/.left.menu_ext.php",
				...
				CopyDirFiles(
					$_SERVER["DOCUMENT_ROOT"]."/thurly/wizards/thurly/portal/site/public/company/personal/.left.menu_ext.php",
			...
			if (isset($_POST["int_convert_public_index"]))
			{
				...
				if (file_exists($indexPath))
				{
					...
					if ($content && strpos($content, "thurly:socialnetwork.log.ex") !== false)
					{
						CopyDirFiles(
						...
						CopyDirFiles(
							$_SERVER["DOCUMENT_ROOT"]."/thurly/wizards/thurly/portal/site/public/index_b24.php",
							$_SERVER['DOCUMENT_ROOT'].$site['DIR'].'index.php',
							true,
							true
						);
