...
class CIntranetTasksWS extends IWebService
{
	...
	function UpdateListItems($listName, $updates)
	{
		...
		//CModule::IncludeModule('socialnetwork');
		//include($_SERVER['DOCUMENT_ROOT'].BX_PERSONAL_ROOT.'/components/thurly/intranet.tasks/init.php');
		//include($_SERVER['DOCUMENT_ROOT'].BX_PERSONAL_ROOT.'/components/thurly/intranet.tasks/action.php');
	...
	function GetWebServiceDesc()
	{
		...
		$wsdesc->wsname = "thurly.webservice.intranet.tasks";
