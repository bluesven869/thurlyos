...
class CEventCalendar
{
	function Init($arParams)
	{
		...
		$this->outerUrl = $GLOBALS['APPLICATION']->GetCurPageParam('', array("action", "bx_event_calendar_request", "clear_cache", "thurly_include_areas", "thurly_show_mode", "back_url_admin", "SEF_APPLICATION_CUR_PAGE_URL"), false);
		...
		if (!class_exists('CUserOptions'))
			include_once($_SERVER['DOCUMENT_ROOT']."/thurly/modules/main/classes/".$GLOBALS['DBType']."/favorites.php");
	}
	...
	function Show($Params)
	{
		...
		$JSConfig = Array(
			...
			'planner_js_src' => '/thurly/js/intranet/event_calendar/planner.js?v='.filemtime($_SERVER['DOCUMENT_ROOT']."/thurly/js/intranet/event_calendar/planner.js"),
		...
		if (CEventCalendar::IsCalDAVEnabled() && $this->ownerType == "USER")
		{
			...
			if ($this->ownerType == 'USER')
			{
				...
				$JSConfig['caldav_link_one'] = (CMain::IsHTTPS() ? "https://" : "http://").$_SERVER["SERVER_NAME"]."/thurly/groupdav.php/".SITE_ID."/".$login."/calendar/#CALENDAR_ID#/";
			}
			else if ($this->ownerType == 'GROUP')
			{
				$JSConfig['caldav_link_one'] = (CMain::IsHTTPS() ? "https://" : "http://").$_SERVER["SERVER_NAME"]."/thurly/groupdav.php/".SITE_ID."/group-".$this->ownerId."/calendar/#CALENDAR_ID#/";
			}
		...
		$APPLICATION->AddHeadString('<link rel="stylesheet" type="text/css" href="'.CUtil::GetAdditionalFileURL("/thurly/js/intranet/event_calendar/event_calendar.css").'">');
	...
	function AppendJS($Params)
	{
		...
		// Add scripts
		$arJS = array(
			'/thurly/js/intranet/event_calendar/core.js',
			'/thurly/js/intranet/event_calendar/dialogs.js',
			'/thurly/js/intranet/event_calendar/week.js',
			'/thurly/js/intranet/event_calendar/events.js',
			'/thurly/js/intranet/event_calendar/controlls.js'
		);
		$arJS[] = '/thurly/js/main/utils.js';

		$arCSS = array();
		if (!$USER->IsAuthorized()) // For anonymus  users
		{
			$arCSS[] = '/thurly/themes/.default/pubstyles.css';
		}
	...
	function Request($action)
	{
		...
		else
		{
			...
			{
				echo '<!--BX_EC_DUBLICATE_ACTION_REQUEST'.thurly_sessid().'-->';
				return;
			}
	...
	function GetCalendars($arParams = array())
	{
		...
		{
			$outerUrl = $GLOBALS['APPLICATION']->GetCurPageParam('', array("action", "bx_event_calendar_request", "clear_cache", "thurly_include_areas", "thurly_show_mode", "back_url_admin", "SEF_APPLICATION_CUR_PAGE_URL"), false);
		}
	...
	{
		$res = 'BEGIN:VCALENDAR
PRODID:-//Thurly//Thurly Calendar//EN
VERSION:2.0
CALSCALE:GREGORIAN
METHOD:PUBLISH
...
X-WR-CALDESC:'.$this->_ICalPaste($arCal['DESCRIPTION'])."\n";
	...
	for ($i = 0, $l = count($arItems); $i < $l; $i++)
	{
		...
		$uid = md5(uniqid(rand(), true).$event['ID']).'@thurly';
		$period = '';
		$per = $event['PERIOD'];
		if($per)
		{
...
<tr><td class="bxec-calendar-title bxec-cal-title-str"><img id="<?=$id?>_cal_bar_fliper" class="bxec-iconkit bxec-hide-arrow" src="/thurly/images/1.gif"/><nobr><?=GetMessage('EC_T_CALENDARS')?></nobr>
</td>
<td class="bxec-calendar-title bxec-cal-title-ch"><img id="<?=$id?>_cal_bar_check" class="bxec-iconkit bxec-cal-bar-check" src="/thurly/images/1.gif"/></td>
</tr>
<tr><td colSpan="2"><div class="bxec-calendar-cont" id="<?=$id?>_calendar_div"></div>
<?if(!$arParams['bReadOnly']):?>
<a id="<?=$id?>_add_calendar_link" class="bxec-add-calendar-link" href="javascript:void(0);" title="<?=GetMessage('EC_ADD_CAL_TITLE')?>"><img class="bxec-iconkit bxec-addcal" src="/thurly/images/1.gif"/><?=GetMessage('EC_ADD_CAL')?></a>
<? if ($bCalDAV):?>
<a id="<?=$id?>_external" class="bxec-add-calendar-link" href="javascript:void(0);" title="<?=GetMessage('EC_MANAGE_CALDAV_TITLE')?>"><img class="bxec-iconkit bxec-addcal" src="/thurly/images/1.gif"/><?=GetMessage('EC_MANAGE_CALDAV')?></a>
<?endif;?>
<?endif;?>
</td></tr>
</table>
...
<table class="bxec-calendar-bar">
<tr><td class="bxec-calendar-title bxec-cal-title-str"><img id="<?=$id?>_sp_cal_bar_fliper" class="bxec-iconkit bxec-hide-arrow" src="/thurly/images/1.gif"/><nobr><?=GetMessage('EC_T_SP_CALENDARS')?></nobr></td>
<td class="bxec-calendar-title bxec-cal-title-ch"><img id="<?=$id?>_sp_cal_bar_check" class="bxec-iconkit bxec-cal-bar-check" src="/thurly/images/1.gif"/></td>
</tr>
<tr><td colSpan="2"><div class="bxec-calendar-cont" id="<?=$id?>_sp_calendar_div"></div>
	<table class="bxec-add-cal-link-tbl"><tr><td><a id="<?=$id?>_sp_add_calendar" class="bxec-add-calendar-link" href="javascript:void(0);" title="<?=GetMessage('EC_ADD_EX_CAL_TITLE')?>"><img class="bxec-iconkit bxec-addcal-sp" src="/thurly/images/1.gif"/><?=GetMessage('EC_ADD_EX_CAL')?></a></td><td align="right"><img id="<?=$id?>_export_sp_cals" class="bxec-iconkit bxec-export-sp" src="/thurly/images/1.gif" title="<?=GetMessage('EC_EXPORT_SP_CALS')?>"/></td></tr></table>
</td></tr>
</table>
<?endif;?>
...
<td class="bxec-main">
	...
	<table class="BXEC-Calendar-week" id="<?=$id?>_scel_table_week">
		<tr class="bxec-days-tbl-title"><td class="bxec-pad"><div class="bxec-day-t-event-holder"></div><img src="/thurly/images/1.gif" width="40" height="1"/></td><td class="bxec-pad2"><img src="/thurly/images/1.gif" width="16" height="1"/></td></tr>
	...
	{
		require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/tools/clock.php");
...
<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_edit_ed_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif" /></td><td class="bxec-edit-ed-title"><div id="<?=$id?>_edit_ed_d_title"><?=GetMessage('EC_T_EDIT_EVENT')?></div></td><td id="<?=$id?>_edit_ed_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
</td>
...
<div class="bxec-d-cont"  id="<?=$id?>_edit_ed_d_tabcont">
	...
	<div id="<?=$id?>_ed_tab_cont_0" class="bxec-d-cont-div">
		<table>
			...
			<?$APPLICATION->IncludeComponent("thurly:main.calendar", "",
			Array(
				"FORM_NAME" => "bxec_edit_ed_form_".$id,
	...
	<div id="<?=$id?>_ed_tab_cont_2" class="bxec-d-cont-div" style="padding: 5px 8px;">
		...
		<a id="<?=$id?>_planner_link" href="javascript:void(0);" title="<?=GetMessage('EC_PLANNER_TITLE')?>" class="bxex-planner-link"><img src="/thurly/images/1.gif" /><?=GetMessage('EC_PLANNER2')?></a>
		</div>
		...
		$APPLICATION->IncludeComponent(
			"thurly:socialnetwork.user_search_input",
			".default",
			array(
				"NAME" => "guest_search",
				"TEXT" => "size='25'",
		...
		<a id="<?=$id?>_add_from_group" href="javascript:void(0);" title="<?=GetMessage('EC_ADD_GROUP_MEMBER_TITLE')?>" class="bxex-add-ex-link"><img src="/thurly/images/1.gif" /><?=GetMessage('EC_ADD_GROUP_MEMBER')?></a>
		<?endif;?>
		<a id="<?=$id?>_add_from_struc" href="javascript:void(0);" title="<?=GetMessage('EC_ADD_MEMBERS_FROM_STR_TITLE')?>" class="bxex-add-ex-link"><img src="/thurly/images/1.gif" /><?=GetMessage('EC_ADD_MEMBERS_FROM_STR')?></a>
		<?endif;?>
		</div>
...
<a id="<?=$id?>_edit_ed_delete" href="javascript:void(0);" title="<?=GetMessage('EC_T_DELETE_EVENT')?>"><img class="bxec-iconkit bxec-delevent" src="/thurly/images/1.gif" /><?=GetMessage('EC_T_DELETE')?></a>
...
<div id="bxec_add_ed_<?=$id?>" class="bxec-add-ed bxec-dialog"><table cellPadding="0" cellSpacing="0" class="bxec-add-ed-frame">
	...
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_add_ed_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-add-ed-title bxec-ed-lp"><?=GetMessage('EC_T_NEW_EVENT')?></td><td id="<?=$id?>_add_ed_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td>
...
<div id="bxec_view_ed_<?=$id?>" class="bxec-view-ed bxec-dialog"><table class="bxec-view-ed-frame"  id="<?=$id?>_view_ed_tbl">
	<tr><td class="bxec-title-cell">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_view_ed_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-view-ed-title"><?=GetMessage('EC_T_VIEW_EVENT')?></td><td id="<?=$id?>_view_ed_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td>
	...
	<a id="<?=$id?>_view_ed_edit" href="javascript:void(0);"><img class="bxec-iconkit bxec-edevent" src="/thurly/images/1.gif" /><?=GetMessage('EC_T_EDIT')?></a>
	<a id="<?=$id?>_view_ed_delete" href="javascript:void(0);"><img class="bxec-iconkit bxec-delevent" src="/thurly/images/1.gif" /><?=GetMessage('EC_T_DELETE')?></a>
...
<div id="bxec_edcal_<?=$id?>" class="bxec-dialog bxec-edcal"><table class="bxec-edcal-frame">
	<tr><td class="bxec-title-cell" colSpan="2">
	<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_edcal_<?=$id?>'));" cellPadding="0" cellSpacing="0"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-edcal-title" id="<?=$id?>_edcal_d_title"></td><td id="<?=$id?>_edcal_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td>
	...
	<a id="<?=$id?>_edcal_delete" href="javascript:void(0);"><img class="bxec-iconkit bxec-delcal" src="/thurly/images/1.gif" /><?=GetMessage('EC_T_DELETE_CALENDAR')?></a></div>
...
<div id="bxec_excal_<?=$id?>" class="bxec-excal bxec-dialog"><table class="bxec-excal-frame">
	<tr><td class="bxec-title-cell" colSpan="2">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_excal_<?=$id?>'));" ><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-excal-title" id="<?=$id?>_excal_dial_title"></td><td id="<?=$id?>_excal_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td></tr>
...
?>
	...
	<tr><td class="bxec-title-cell" colSpan="2">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_sprpose_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-sprpose-title"><?=GetMessage('EC_T_SUPERPOSE_TITLE')?></td><td id="<?=$id?>_sprpose_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td></tr>
	<tr><td colSpan="2" class="bxec-ed-lp" style="padding-left: 10px;">
...
<?
	...
	{
		$GLOBALS['APPLICATION']->IncludeComponent('thurly:intranet.user.search', '', array(
			'SHOW_INPUT' => 'N',
			'SHOW_BUTTON'=>'N',
...
<div id="bxec_plan_<?=$id?>" class="bxec-dialog bxec-edcal"><table class="bxec-edcal-frame">
	<tr><td class="bxec-title-cell" colSpan="2">
	<table onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_plan_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-edcal-title"><?=GetMessage('EC_PLANNER2')?></td><td id="<?=$id?>_plan_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td>
	...
	<table style="width: 630px">
		<tr>
			...
			<td>
				...
				<img src="/thurly/images/1.gif" class="bxecpl-lock-dur" id="<?=$id?>_pl_dur_lock" title="<?=GetMessage('EC_EVENT_DUR_LOCK')?>"/>
			</td>
		</tr>
		<tr>
	...
	<div id="<?=$id?>_plan_grid_cont" class="bxec-plan-grid-cont"><table class="bxec-plan-grid-tbl">
			...
			<tr>
				...
				<td><div class="bxec-grid-cont"><div class="bxec-gacc-cont"></div>
					<div class="bxecp-selection" id="<?=$id?>_plan_selection"  title="<?=GetMessage('EC_PL_EVENT')?>"><img src="/thurly/images/1.gif" class="bxecp-sel-left" title="<?=GetMessage('EC_PL_EVENT_MOVE_LEFT')?>" /><img src="/thurly/images/1.gif" class="bxecp-sel-right" title="<?=GetMessage('EC_PL_EVENT_MOVE_RIGHT')?>" /><img src="/thurly/images/1.gif" class="bxecp-sel-mover" title="<?=GetMessage('EC_PL_EVENT_MOVE')?>" /></div>
				</div>
	...
	<div id="<?=$id?>_plan_bottom_cont" class="bxec-plan-bottom-cont">
		...
		<?if (!$arParams['bExtranet']):?>
		<?if($arParams['ownerType'] == 'GROUP'):?>
		<a id="<?=$id?>_planner_add_from_group" href="javascript:void(0);" title="<?=GetMessage('EC_ADD_GROUP_MEMBER_TITLE')?>" class="bxex-add-ex-link"><img src="/thurly/images/1.gif" /><?=GetMessage('EC_ADD_GROUP_MEMBER')?></a>
		<?endif;?>
		<a id="<?=$id?>_planner_add_from_struc" href="javascript:void(0);" title="<?=GetMessage('EC_ADD_MEMBERS_FROM_STR_TITLE')?>" class="bxex-add-ex-link"><img src="/thurly/images/1.gif" /><?=GetMessage('EC_ADD_MEMBERS_FROM_STR')?></a>
		<?endif;?>
		</div>
	</div>
...
<div id="bxec_uset_<?=$id?>" class="bxec-dialog bxec-edcal"><table class="bxec-edcal-frame">
	<tr><td class="bxec-title-cell" colSpan="2">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_uset_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-edcal-title"><?= GetMessage('EC_USER_SET')?></td><td id="<?=$id?>_uset_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td>
	...
	<a id="<?=$id?>_uset_clear" href="javascript:void(0);" title="<?=GetMessage('EC_CLEAR_SET_TITLE')?>"><img class="bxec-iconkit bxec-delevent" src="/thurly/images/1.gif" /><?=GetMessage('EC_CLEAR_SET')?></a>
	</div>
...
<div id="bxec_cdav_<?=$id?>" class="bxec-dialog bxec-edcal"><table class="bxec-edcal-frame">
	<tr><td class="bxec-title-cell">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_cdav_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-edcal-title"><?= GetMessage('EC_CALDAV_TITLE')?></td><td id="<?=$id?>_cdav_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td></tr>
...
<div id="bxec_mobile_<?=$id?>" class="bxec-dialog bxec-edcal"><table class="bxec-edcal-frame">
	<tr><td class="bxec-title-cell">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_mobile_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-edcal-title"><?= GetMessage('EC_MOBILE_HELP_TITLE')?></td><td id="<?=$id?>_mobile_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td></tr>
...
<div id="bxec_csort_<?=$id?>" class="bxec-dialog bxec-edcal"><table class="bxec-edcal-frame">
	<tr><td class="bxec-title-cell" colSpan="2">
	<table cellPadding="0" cellSpacing="0" onmousedown="jsFloatDiv.StartDrag(arguments[0], document.getElementById('bxec_csort_<?=$id?>'));"><tr><td style="width: 10px; padding-left: 3px;"><img class="bxec-iconkit bxec-dd-dot" src="/thurly/images/1.gif"></td><td class="bxec-edcal-title"><?= GetMessage('EC_USER_SET')?></td><td id="<?=$id?>_csort_close" class="bxec-close" title="<?=GetMessage('EC_T_CLOSE')?>"><img class="bxec-iconkit" src="/thurly/images/1.gif"></td></tr></table>
	</td>
	<tr><td>
...
?>
	...
	function CheckMR($Params)
	{
		...
		if ($Params['regularity'] == "NONE")
		{
			...
			include_once($_SERVER['DOCUMENT_ROOT']."/thurly/components/thurly/intranet.reserve_meeting/init.php");
