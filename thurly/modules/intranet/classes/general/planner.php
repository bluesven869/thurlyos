...
class CIntranetPlanner
{
	...
	public static function initScripts($arData)
	{
		...
		\Thurly\Main\Page\Asset::getInstance()->addJsKernelInfo('calendar_planner_handler', array('/thurly/js/calendar/core_planner_handler.js'));
		\Thurly\Main\Page\Asset::getInstance()->addCssKernelInfo('calendar_planner_handler', array('/thurly/js/calendar/core_planner_handler.css'));
