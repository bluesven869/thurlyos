...
$MESS["SERVICES_INFO"] = "<div> Contents:
  ...
  <p><b>Thurly Intranet</b> includes the following two modules that enable
  ...
  <ul>
    ...
    <li>The <b>Business Process</b> module supports simple, step-by-step
      ...
      editions. The full version, which provides tools to create new processes, is included in <b>Thurly Intranet:
 ...
 <img border='1' alt='Example: process with statuses' title='Example: process with statuses' src='#SITE#images/en/bp/3.png' />
  ...
  <p>The most common business processes are included in junior editions (<b>Thurly Intranet: Office Edition</b> and <b>Thurly Intranet: Extranet Edition</b>) as read-only constructions. You can
  configure them to handle the required documents, but cannot change the logic.
  The <b>Thurly Intranet:
 ...
 <img border='1' src='#SITE#images/en/bp/11.png' alt='Business processes page' title='Business processes page' />
  ...
  editor included only in the <b>Thurly Intranet:
