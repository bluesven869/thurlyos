...
<li>All essentials are always handy</li>
<li>Personalize your most used tool (CRM, Tasks or Activity Stream) adaptable to match different client groups</li>
<li>The work area extended by 20 percent: collapse the left menu when you don't use it</li>
<li>Unified top menu navigation: menus of the second tier share common structure</li>
<li>Find pages by name faster using the search bar</li>
</ul>";
...
$MESS["INTRANET_PUBLIC_CONVERT_BUTTON"] = "Convert Now";
$MESS["INTRANET_PUBLIC_CONVERT_FINISH"] = "Conversion has been completed.";
$MESS["INTRANET_PUBLIC_SKIP_CONVERT_BUTTON"] = "Don't convert";
$MESS["INTRANET_PUBLIC_SKIP_CONVERT_FINISH"] = "Conversion was canceled";
?>