...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public_thurlyos/company/structure.php");
$APPLICATION->SetTitle(GetMessage("TITLE1"));
?>

<?$APPLICATION->IncludeComponent("thurly:intranet.structure", ".default", Array(
