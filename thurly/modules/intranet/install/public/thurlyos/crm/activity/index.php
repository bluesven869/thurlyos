...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public_thurlyos/crm/activity/index.php");
$APPLICATION->SetTitle(GetMessage("TITLE"));
if (CModule::IncludeModule("crm")):
	$APPLICATION->IncludeComponent("thurly:crm.activity",
		"",
		array(
			'SEF_MODE' => 'Y',
