...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public_thurlyos/crm/company/index.php");
$APPLICATION->SetTitle(GetMessage("TITLE")/*"Компании"*/);
