...
$APPLICATION->SetPageProperty("title", htmlspecialcharsbx(COption::GetOptionString("main", "site_name", "ThurlyOS")));
...
if (CModule::IncludeModule("thurlyos") && CThurlyOS::isInvitingUsersAllowed() && CModule::IncludeModule("intranet"))
{
	$APPLICATION->AddViewContent(
		...
		"<div class=\"invite-employees-button\" onclick=\"".CIntranetInviteDialog::ShowInviteDialogLink()."\">".
			"<span class=\"invite-employees-link\">".GetMessage("THURLY24_INVITE_ACTION")."</span>".
...
{
	$APPLICATION->IncludeComponent("thurly:intranet.ustat.status", "", array(),	false);
}

$APPLICATION->IncludeComponent(
	"thurly:calendar.events.list",
	"widget",
	array(
		"CALENDAR_TYPE" => "user",
		"B_CUR_USER_LIST" => "Y",
...
$APPLICATION->IncludeComponent(
	"thurly:intranet.structure.birthday.nearest",
	"widget",
	array(
		"NUM_USERS" => "4",
		"NAME_TEMPLATE" => "",
		...
		"CACHE_TYPE" => "A",
		"CACHE_TIME" => "3600",
		"DATE_FORMAT" => (LANGUAGE_ID == "de") ? "j. F" : "j F",
		"DATE_FORMAT_NO_YEAR" => (LANGUAGE_ID == "de") ? "j. F" : "j F",
		"SHOW_YEAR" => "N",
...
$APPLICATION->IncludeComponent(
	"thurly:intranet.thurlyos.banner",
	"",
	array(),
	null,
	array("HIDE_ICONS" => "N")
