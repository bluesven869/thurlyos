...
<div class="search-page">
	<?if($arParams["SHOW_TAGS_CLOUD"] == "Y")
	{
		...
		$APPLICATION->IncludeComponent("thurly:search.tags.cloud", ".default", $arCloudParams, $component, array("HIDE_ICONS" => "Y"));
	}
	?>
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?if($arItem["USER"]):?>
				...
				<?$APPLICATION->IncludeComponent("thurly:intranet.system.person", "modern", array(
					"USER" => $arItem["USER"],
		...
		<?else:?>
			<div class="search-item">
				<h4><a href="<?echo $arItem["URL"]?>"><img src="<?echo $arItem["ICON"]?>"> <span><?echo $arItem["TITLE_FORMATED"]?></span></a></h4>
				...
				<div class="search-item-meta">
					<?if (
						...
						&& (true/*TODO*/ || $arParams["SHOW_RATING"] == "Y")
					):?>
					...
					$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"PATH_TO_USER_PROFILE" => '/company/personal/user/#USER_ID#/' /*TODO*/
						),
						$component,
						array("HIDE_ICONS" => "Y")
					);?>
