BX.namespace("BX.ThurlyOS");

BX.ThurlyOS.SlidingPanel = function(options)
{
...
BX.ThurlyOS.SlidingPanel.prototype = {
...
BX.ThurlyOS.GroupPanel = function(options)
{
	...
	BX.ThurlyOS.SlidingPanel.apply(this, arguments);
	...
	BX.addCustomEvent("BX.ThurlyOS.Map:onBeforeOpen", closeImmediately);
	BX.addCustomEvent("BX.ThurlyOS.LeftMenuClass:onDragStart", closeImmediately);
	BX.addCustomEvent("BX.ThurlyOS.LeftMenuClass:onMenuToggle", closeImmediately);
};

BX.ThurlyOS.GroupPanel.prototype = Object.create(BX.ThurlyOS.SlidingPanel.prototype);
BX.ThurlyOS.GroupPanel.prototype.constructor = BX.ThurlyOS.GroupPanel;
BX.ThurlyOS.GroupPanel.prototype.super = BX.ThurlyOS.SlidingPanel.prototype;

BX.ThurlyOS.GroupPanel.prototype.setContent = function()
{
	this.container.appendChild(this.content);
};

BX.ThurlyOS.GroupPanel.prototype.animateStep = function(state)
{
...
BX.ThurlyOS.GroupPanel.prototype.open = function()
{
	BX.onCustomEvent("BX.ThurlyOS.GroupPanel:onBeforeOpen", [this]);
...
BX.ThurlyOS.GroupPanel.prototype.close = function()
{
	this.menu.innerHTML = BX.message("menu_show");
	this.super.close.apply(this, arguments);
};

BX.ThurlyOS.GroupPanel.prototype.onTrasitionEnd = function()
{
...
BX.ThurlyOS.GroupPanel.prototype.onMenuClick = function(event)
{
	if (this.isOpen)
	{
		this.close();
...
BX.ThurlyOS.GroupPanel.prototype.onFilterClick = function(event)
{
...
BX.ThurlyOS.GroupPanel.prototype.onItemsClick = function(event)
{
...
BX.ThurlyOS.GroupPanel.prototype.animateStart = function(star)
{
...
BX.ThurlyOS.GroupPanel.prototype.animateCounter = function(positive)
{
...
BX.ThurlyOS.GroupPanel.prototype.saveFilter = function(filter)
{
...
BX.ThurlyOS.Map = function(options)
{
...
BX.ThurlyOS.Map.prototype = Object.create(BX.ThurlyOS.SlidingPanel.prototype);
BX.ThurlyOS.Map.prototype.constructor = BX.ThurlyOS.Map;
BX.ThurlyOS.Map.prototype.super = BX.ThurlyOS.SlidingPanel.prototype;

BX.ThurlyOS.Map.prototype.setContent = function()
{
	this.container.appendChild(this.content);
};

BX.ThurlyOS.Map.prototype.animateStep = function(state)
{
...
BX.ThurlyOS.Map.prototype.open = function()
{
	BX.onCustomEvent("BX.ThurlyOS.Map:onBeforeOpen", [this]);

	this.menu.classList.add("sitemap-menu-open");
	this.super.open.apply(this, arguments);
};

BX.ThurlyOS.Map.prototype.close = function()
{
	this.menu.classList.remove("sitemap-menu-open");
	this.super.close.apply(this, arguments);
};

BX.ThurlyOS.Map.prototype.onMenuClick = function(event)
{
	if (this.isOpen)
	{
		this.close();
