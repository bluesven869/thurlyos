...
if (!$arResult["FatalError"])
{
	...
	if(!IsModuleInstalled("thurlyos") && CModule::IncludeModule("socialnetwork") && $USER->IsAdmin($USER->GetID())
	)
	{
...
{
	$arResult["IS_OTP_RECOVERY_CODES_ENABLE"] = \Thurly\Security\Mfa\Otp::isRecoveryCodesEnabled();
}
?>