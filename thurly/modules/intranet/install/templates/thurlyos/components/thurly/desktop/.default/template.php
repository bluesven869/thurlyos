...
if(!defined("BX_GADGET_DEFAULT"))
{
	...
	?><script type="text/javascript">
		...
		var bxsessid = '<?=CUtil::JSEscape(thurly_sessid())?>';
	...
	{
		?><script type="text/javascript" src="/thurly/components/thurly/desktop/script.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/desktop/script.js');?>"></script><?
	}
}
...
if ($arResult["PERMISSION"] > "W")
{
	...
	$gadgetButtons .= '<script type="text/javascript">new BXGadget(\'desktop-actions\', {});</script>';
		...
		$gadgetButtons .= '
			<div class="sidebar-block sidebar-help-block">
				...
				<div class="sidebar-block-inner">
					...
					<div class="sidebar-help-content">'.GetMessage("CMDESKTOP_DEMO_DATA_BLOCK_DESC", Array("#LINK_TO_WIZARD#" => "/thurly/admin/wizard_install.php?lang=".LANGUAGE_ID."&wizardSiteID=".SITE_ID."&wizardName=thurly:portal_clear&".thurly_sessid_get())).'</div>
				</div>
