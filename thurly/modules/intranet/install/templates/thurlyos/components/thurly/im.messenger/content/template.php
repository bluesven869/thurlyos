				...
				<div class="bx-im-fullscreen-popup-logo">
					<?if (IsModuleInstalled("thurlyos")):?>
						<span><?
							...
							<?else:?>
								<?=htmlspecialcharsbx(COption::GetOptionString("thurlyos", "site_title", ""))?> <?if(COption::GetOptionString("thurlyos", "logo24show", "Y") !=="N"):?>Group<?endif?>
							<?endif?>
						</span>
					<?else:
						...
						?><span>
							...
							<?else:?>
								<?=htmlspecialcharsbx(COption::GetOptionString("main", "site_name", ""));?> Group
							<?endif?>
						</span>
					<?endif?>
				</div>
				...
				<span class="bx-im-fullscreen-apps">
					...
					<span class="bx-im-fullscreen-apps-buttons" id="im-workarea-apps">
						<span class="bx-im-fullscreen-apps-buttons-group">
							<a href="http://dl.thurlyos.com/b24/thurlyos_desktop.exe" class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-windows" target="_blank"></a>
							<span class="bx-im-fullscreen-apps-buttons-delimiter"></span>
							<a href="http://dl.thurlyos.com/b24/thurlyos_desktop.dmg" class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-osx" target="_blank"></a>
							<span class="bx-im-fullscreen-apps-buttons-delimiter"></span>
							<a href="https://github.com/buglloc/brick/" class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-linux" target="_blank"></a>
						</span>
						<span class="bx-im-fullscreen-apps-buttons-group">
							<a href="https://play.google.com/store/apps/details?id=com.thurlyos.android" class="bx-im-fullscreen-app-icon bx-im-fullscreen-app-googleplay" target="_blank"></a>
							<span class="bx-im-fullscreen-apps-buttons-delimiter"></span>
