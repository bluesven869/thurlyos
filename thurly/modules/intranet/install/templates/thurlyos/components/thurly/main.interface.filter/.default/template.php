...
<script type="text/javascript">
	var B24SidebarFilter = {
		...
		init : function(bindElement)
		{
			...
			this.popup = new BX.PopupWindow("b24-sidebar-filter", bindElement, {
				content : BX("sidebar-filter"),
				...
				events: {
					onPopupClose: BX.proxy(function(popupWindow) {
						BX.removeClass(popupWindow.bindElement, "webform-small-button-active");
		...
		show : function(bindElement)
		{
			...
			if (BX.hasClass(bindElement, "webform-small-button-active"))
			{
				this.popup.close();
				BX.removeClass(bindElement, "webform-small-button-active");
				this.adjustGanttHeight();
			}
			else
			{
...
<div class="sidebar-block sidebar-block-popup" id="sidebar-filter" style="display: none;">
