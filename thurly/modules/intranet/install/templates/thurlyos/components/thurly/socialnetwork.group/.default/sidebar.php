	...
	<? if ($arResult["Owner"]):
		...
		<div class="socialnetwork-group-users">
			<div class="socialnetwork-group-users-inner socialnetwork-group-owner">
				<div class="socialnetwork-group-title"><?=GetMessage($arResult['Group']['PROJECT'] == 'Y' ? "SONET_C6_OWNER_PROJECT" : "SONET_C6_OWNER")?></div>
	...
	if ($arResult["Moderators"]["List"]):
		...
		<div class="socialnetwork-group-users socialnetwork-group-moderator">
			<div class="socialnetwork-group-users-inner">
				<div class="socialnetwork-group-title"><?=GetMessage($arResult['Group']['PROJECT'] == 'Y' ? "SONET_C6_ACT_MOD1_PROJECT" : "SONET_C6_ACT_MOD1")?>
			...
			<div class="socialnetwork-group-users-inner">
				<div class="socialnetwork-group-title">
					...
					)
					{
						?><a
							class="socialnetwork-group-title-link dashed"
							href="<?=htmlspecialcharsbx($arResult["Urls"]["Edit"].(strpos($arResult["Urls"]["Edit"], "?") !== false ? "&" : '?')."tab=invite")?>"
