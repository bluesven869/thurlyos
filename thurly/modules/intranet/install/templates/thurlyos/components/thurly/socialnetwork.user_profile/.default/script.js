...
BX.Socialnetwork.User.Profile = (function()
{
	...
	Profile.prototype.showExtranet2IntranetForm = function(userId, email)
	{
		...
		window.ThurlyOSExtranet2IntranetForm = BX.PopupWindowManager.create("BXExtranet2Intranet", null, {
			autoHide: false,
			zIndex: 0,
			offsetLeft: 0,
			offsetTop: 0,
			...
			events: {
				onAfterPopupShow: function()
				{
					...
					BX.ajax.post(
						'/thurly/tools/b24_extranet2intranet.php',
						{
		...
		ThurlyOSExtranet2IntranetForm.show();
	};
