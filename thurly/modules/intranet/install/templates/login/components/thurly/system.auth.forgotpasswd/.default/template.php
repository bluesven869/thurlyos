...
if ($forgetLogin)
	$APPLICATION->IncludeComponent("thurly:thurlyos.auth.forgotlogin", "", array());
else
{
?>
...
<?if ($arResult["USE_CAPTCHA"]):?>
			<div class="login-item">
				...
				<img src="/thurly/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" />
			</div>
			<div class="login-item">
