...
if ($arResult['REQUIRED_BY_MANDATORY'] === true) {
	$APPLICATION->IncludeComponent(
		"thurly:security.auth.otp.mandatory",
		"",
		array(
...
<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
	...
	<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
		<div class="log-header-additional-wrap" style="width:50%;">
			<noindex>
				<?if (!IsModuleInstalled("thurlyos")):?><a href="<?=$arResult["AUTH_LOGIN_URL"]?>" rel="nofollow" class="log-header-additional-text"><?echo GetMessage("AUTH_OTP_AUTH_BACK")?></a><?endif?>
			</noindex>
		</div>
	<?endif?>
	...
	<div class="">
		...
		<div class="login-item">
			...
			<div style="display:inline-block; vertical-align: middle;margin-left:10px" ><img src="/thurly/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" /></div>
		</div>
		<?endif;?>
	</div>
