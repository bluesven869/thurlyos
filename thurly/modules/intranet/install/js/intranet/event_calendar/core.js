...
BuildButtonsCont : function()
{
	...
	if (!this.bReadOnly)
	{
		this.ButtonsCont.appendChild(BX.create('IMG', {
			props: {src: '/thurly/images/1.gif', className: 'bxec-panel-but bxec-add-new-but', title: EC_MESS.AddNewEvent},
		...
		{
			this.ButtonsCont.appendChild(BX.create('IMG', {
				props: {src: '/thurly/images/1.gif', className: 'bxec-panel-but bxec-add-pl-but', title: EC_MESS.AddNewEventPl},
		...
		{
			this.ButtonsCont.appendChild(BX.create('IMG', {
				props: {src: '/thurly/images/1.gif', className: 'bxec-panel-but bxec-user-set-but', title: EC_MESS.UserSettings},
...
DisplayCalendarElement : function(el, bChecked, bSuperpose)
{
	...
	var
		...
		pEl = pCont.appendChild(BX.create('DIV', {
			...
			html: '<table class="bxec-tbl"><tr><td class="' + (bActive ? 'bxec-cal-menu' : 'bxec-cal-menu-dis')+ '"><img class="bxec-iconkit" src="/thurly/images/1.gif"/></td><td class="bxec-title"><nobr>' + el.NAME + '</nobr></td><td><img class="bxec-iconkit" src="/thurly/images/1.gif"/></td></tr></table>'
		}));
...
{
	return BX.create("IMG", {props: {src: '/thurly/images/1.gif'}, style: {width: width + 'px', height: '1px'}});
},
