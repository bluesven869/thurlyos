...
AddGuests: function(arGuests, bFirst, bTimeout)
{
	...
	if (l > 0)
	{
		...
		for (i = 0; i < l; i++)
		{
			...
			c1.innerHTML = '<img src="/thurly/images/1.gif"/>';
			c1.onclick = function()
			{
			...
			pDel = c2.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', title: bDel ? EC_MESS.DelGuestTitle : EC_MESS.CantDelGuestTitle, className: 'bxecp-del' + (bDel ? '' : ' bxecp-del-d')}}));
...
BuildGridTitle: function()
{
	...
	for (i = 0; i < l; i++)
	{
		...
		c_day.innerHTML = '<img src="/thurly/images/1.gif" class="day-t-left"/><div></div><img src="/thurly/images/1.gif" class="day-t-right"/>';
...
AddMR: function(ind)
{
	...
	var pDel = this.MRControll.pLocName.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', title: EC_MESS.FreeMR, className: 'bxecp-del'}}));
