...
JCEC.prototype.ShowSelectTimeNotifier = function(P, bShow)
{
	...
	oTab.pSTNotifier.innerHTML = '<img class="bxec-iconkit" src="/thurly/images/1.gif">' + innnerHTML;
...
{
	this.Tabs[tabId].oCurTimePointer = {pWnd : BX.create('DIV', {props: {className: 'bxec-time-pointer'}, html: '<img class="bxec-iconkit" src="/thurly/images/1.gif">'})};
}
...
JCEC.prototype.BuildDaySelector = function()
{
	...
	var but = PrevDayButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-pr-m-but', title: EC_MESS.ShowPrevDay}}));
	but.onclick = function(){_this._IncreaseCurDay(-1);};

	but = NextDayButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-nx-m-but', title: EC_MESS.ShowNextDay}}));
	but.onclick = function(){_this._IncreaseCurDay(1);};
...
JCEC.prototype.BuildWeekSelector = function()
{
	...
	var but = PrevWeekButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-pr-m-but', title: EC_MESS.ShowPrevWeek}}));
	but.onclick = function(){_this._IncreaseCurWeek(-1);};

	but = NextWeekButtCell.appendChild(BX.create('IMG', {props: {src: '/thurly/images/1.gif', className: 'bxec-iconkit bxec-nx-m-but', title: EC_MESS.ShowNextWeek}}));
	but.onclick = function(){_this._IncreaseCurWeek(1);};
