...
{
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/intranet.ustat/style.css');
	$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/main/amcharts/3.0/amcharts.js');
	$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/main/amcharts/3.0/serial.js');
}

use Thurly\Intranet\UStat\UStat;
...
<? endif ?>
	...
	chart.pathToImages = "/thurly/js/main/amcharts/3.0/images/";
	...
	graph2.customBullet = BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/bullet-blue.png?1407');
	graph2.lineColor = '#aee5f5';
	graph2.balloonText = '<?=CUtil::JSEscape(str_replace("\n", " ", htmlspecialcharsbx($arResult['USERS_INFO'][$arParams['USER_ID']]['FULL_NAME'])))?>11: [[value]]';
	...
	graph3.customBullet = BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/bullet-gray.png?1407');
	...
	graph4.customBullet = BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/bullet-green.png?1407');
	...
	graph5.customBullet = BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/bullet-brown.png?1407');
					...
					<tr>
						<td class="pulse-info-cell pulse-info-cell-top">
							...
							$APPLICATION->IncludeComponent(
								"thurly:intranet.user.selector.new", ".default", array(
									"MULTIPLE" => "N",
...
var pulse_loading = {
	...
	img_create: function()
	{
		var img,
			img_list_src = [
				'/thurly/components/thurly/intranet.ustat/images/pulse-close-btn.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-sidebar-grey.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-sidebar-blue.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-sidebar-percent-bg.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-light-grey.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-light-blue.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-blue-big.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-blue-normal.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-percent-bar-bg.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-percent-bar-shadow.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-involve-strip.gif',
				'/thurly/components/thurly/intranet.ustat/images/pulse-num-dark-grey.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-percent-bg.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-sprite.png',
				'/thurly/components/thurly/intranet.ustat/images/pulse-main-bg.png'
			];
