...
// call API
$rawData = \Thurly\Intranet\UStat\UStat::getUsersGraphData(
...
// company average
$companyAverageData = \Thurly\Intranet\UStat\UStat::getDepartmentAverageGraphData(
...
// department average
$usersDepartments = \Thurly\Intranet\UStat\UStat::getUsersDepartments();
$userDepartments = $usersDepartments[$arParams['USER_ID']];
$userDepartmentId = current($userDepartments);

$departmentAverageData = \Thurly\Intranet\UStat\UStat::getDepartmentAverageGraphData(
...
$maxUsersActivity = \Thurly\Intranet\UStat\UStat::getMaxUserActivity($fromDate, $toDate, $interval);
...
if ($arParams['USER_ID'] != $USER->getId())
{
	...
	$selfData = \Thurly\Intranet\UStat\UStat::getUsersGraphData(
