...
<div class="b24-app-block b24-app-desktop">
	...
	<div class="b24-app-block-content">
		<a href="http://dl.thurlyos.com/b24/thurlyos_desktop.dmg" target="_blank" style="width: 33%;" class="b24-app-block-content-apps">
			<span class="b24-app-icon b24-app-icon-macos"></span>
			<span>Mac OS</span>
		</a>
		<a href="http://dl.thurlyos.com/b24/thurlyos_desktop.exe" target="_blank" style="width: 37%;" class="b24-app-block-content-apps b24-app-block-separate">
