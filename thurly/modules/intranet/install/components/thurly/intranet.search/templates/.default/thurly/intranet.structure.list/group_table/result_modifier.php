...
$dbRes = CIBlockSection::GetList(Array("left_margin"=>"asc"), array('IBLOCK_ID' => COption::GetOptionInt('intranet', 'iblock_structure')),
			false, 
			array('UF_HEAD')
		);
	...
	if ($arResult['bAdmin']):
		...
		$INTRANET_TOOLBAR->AddButton(array(
			'ONCLICK' => $APPLICATION->GetPopupLink(array(
				'URL' => "/thurly/admin/user_edit.php?lang=".LANGUAGE_ID."&bxpublic=Y&from_module=main".$current_dep,
				'PARAMS' => array(
					'height' => 500,
					'width' => 900,
					'resize' => false
		...
		{
			$INTRANET_TOOLBAR->AddButton(array(
				'HREF' => "/thurly/admin/user_import.php?lang=".LANGUAGE_ID,
		...
		$INTRANET_TOOLBAR->AddButton(array(
			'HREF' => "/thurly/admin/user_admin.php?lang=".LANGUAGE_ID,
