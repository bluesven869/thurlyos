...
function openIntranetUStat()
{
	...
	BX.loadScript('/thurly/js/main/amcharts/3.0/amcharts.js', function(){
		BX.loadScript('/thurly/js/main/amcharts/3.0/serial.js', function(){
			reloadIntranetUstat({});
		});
	});
}
...
var pulse_loading = {
	...
	img_create: function()
	{
		var img,
			img_list_src = [
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-close-btn.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-sidebar-grey.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-sidebar-blue.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-sidebar-percent-bg.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-light-grey.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-light-blue.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-blue-big.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-blue-normal.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-percent-bar-bg.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-percent-bar-shadow.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-involve-strip.gif?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-num-dark-grey.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-percent-bg.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-sprite.png?1407'),
				BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-main-bg.png?1407')
			];
	...
	show: function()
	{
		...
		if(!this.first_show){
			...
			this.waiter_gif_timeout = setTimeout(function(){
				_this.waiter_gif.setAttribute('src', BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-waiter.gif?1407'))
			}, 1000);
		}
	...
	load_start : function(){
		...
		this.waiter_gif_timeout = setTimeout(function(){
			_this.waiter_gif.setAttribute('src', BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/pulse-waiter.gif'))
		}, 1000);
