...
$arFilterValues = $APPLICATION->IncludeComponent("thurly:intranet.structure.selector", "sections", $arParams, $component);
...
function SetHead(id)
{
	var url = '/thurly/tools/intranet_set_head.php?SECTION_ID=<?echo $current_section?>&USER_ID=' + parseInt(id) + '&<?echo thurly_sessid_get()?>';
	BX.ajax.get(url);
}
...
if ($arFilterValues[$arParams['FILTER_NAME'].'_UF_DEPARTMENT']):
	$APPLICATION->IncludeComponent("thurly:intranet.structure.list", "list", $arParams, $component);
endif;
?>