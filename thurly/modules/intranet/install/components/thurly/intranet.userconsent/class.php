...
class IntranetUserConsentComponent extends CThurlyComponent
{
	...
	protected function initParams()
	{
		...
		$this->arParams['SEF_FOLDER'] = isset($this->arParams['SEF_FOLDER']) ? $this->arParams['SEF_FOLDER'] : '/settings/configs/userconsent/';
		...
		$arDefaultUrlTemplates404 = array(
			...
			"add" => "edit/0/",
			"edit" => "edit/#id#/",
			"consents" => "consents/#id#/?AGREEMENT_ID=#id#&apply_filter=Y",
		);
		...
		else
		{
			...
			elseif (isset($_REQUEST['consents']))
			{
				$componentPage = 'consents';
			}
		}
		...
		$this->arResult = array_merge(
			array(
				...
				'AGREEMENT_ID' => isset($arVariables['id']) ? strval($arVariables['id']) : '',
