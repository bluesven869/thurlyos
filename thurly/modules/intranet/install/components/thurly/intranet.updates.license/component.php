...
//license key
if($_SERVER["REQUEST_METHOD"]=="POST" && check_thurly_sessid() && isset($_POST["LICENSE_BUTTON"]))
{
...
//coupon
if($_SERVER["REQUEST_METHOD"]=="POST" && check_thurly_sessid() && isset($_POST["ACTIVATE_COUPON_BUTTON"]))
{
...
if ($arResult["NEED_ACTIVATE"] && $_SERVER["REQUEST_METHOD"]=="POST" && check_thurly_sessid() && isset($_POST["ACTIVATE_BUTTON"]))
{
