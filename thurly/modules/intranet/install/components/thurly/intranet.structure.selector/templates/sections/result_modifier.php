...
{
	$arParams['addUrl'] = "/thurly/admin/iblock_section_edit.php?lang=".LANGUAGE_ID."&bxpublic=Y&from_module=intranet&type=".COption::GetOptionString('intranet', 'iblock_type')."&IBLOCK_ID=".COption::GetOptionInt('intranet', 'iblock_structure');
	...
	$arParams['editAllUrl'] = "/thurly/admin/iblock_section_admin.php?lang=".LANGUAGE_ID."&type=".COption::GetOptionString('intranet', 'iblock_type')."&IBLOCK_ID=".COption::GetOptionInt('intranet', 'iblock_structure')."&find_section_section=".intval($current_section);
}
...
if ($GLOBALS['APPLICATION']->GetShowIncludeAreas() && $GLOBALS['USER']->IsAdmin())
{
		...
		$arIcons = array(
			array(
				'URL' => "javascript:".$GLOBALS['APPLICATION']->GetPopupLink(
					array(
					'URL' => "/thurly/admin/iblock_section_edit.php?lang=".LANGUAGE_ID."&bxpublic=Y&from_module=intranet&type=".COption::GetOptionString('intranet', 'iblock_type')."&IBLOCK_ID=".COption::GetOptionInt('intranet', 'iblock_structure')."&ID=".$current_section."&back_url=".urlencode($_SERVER["REQUEST_URI"]),
						'PARAMS' => array(
							'width' => 700,
							'height' => 500,
							'resize' => false,
	...
	$arIcons[] = array(
			'URL' => "javascript:".$GLOBALS['APPLICATION']->GetPopupLink(
				array(
					'URL' => "/thurly/admin/iblock_section_edit.php?lang=".LANGUAGE_ID."&bxpublic=Y&from_module=intranet&type=".COption::GetOptionString('intranet', 'iblock_type')."&IBLOCK_ID=".COption::GetOptionInt('intranet', 'iblock_structure')."&IBLOCK_SECTION_ID=".$current_section."&back_url=".urlencode($_SERVER["REQUEST_URI"]),
					'PARAMS' => array(
						'width' => 700,
						'height' => 500,
						'resize' => false,
