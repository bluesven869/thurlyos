...
if ($calendar2)
{
	...
	if ($type)
	{
		...
		{
			return $APPLICATION->IncludeComponent("thurly:calendar.events.list", "", array(
				"CALENDAR_TYPE" => $type,
		...
		{
			return $APPLICATION->IncludeComponent("thurly:calendar.grid", "", Array(
				"CALENDAR_TYPE" => $type,
...
if ($arParams['EVENT_LIST_MODE'] == 'Y')
{
	return $APPLICATION->IncludeComponent("thurly:intranet.event_list", ".default", array(
		"B_CUR_USER_LIST" => $arParams['B_CUR_USER_LIST'],
