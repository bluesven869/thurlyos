...
<form name="configPostForm" id="configPostForm" method="POST" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
	...
	if ($arResult["IS_SCALE_AVAILABLE"])
	{
		...
		<tr>
			...
			<span onclick="BX.ThurlyOS.Configs.Vm.submitForm(this)" class="webform-button webform-button-create">
...
<script>
	...
	BX.ready(function(){
		BX.ThurlyOS.Configs.Vm.init(<?=CUtil::PhpToJSObject($arJSParams)?>);
	});
</script>