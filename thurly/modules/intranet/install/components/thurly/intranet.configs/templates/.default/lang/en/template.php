...
$MESS["CONFIG_CLIENT_LOGO_DESCR"] = "Your logo must be a <b>PNG</b> file.<br/>Maximum dimensions are 222px by 55px.";
...
<br/><br/>They will still have to use OTP when logging in to ThurlyOS.
...
Employees who do not have a suitable mobile device must be equipped with special hardware - eToken Pass. There is a range of vendors you can get them from, for example:
...
$MESS["CONFIG_MARKETPLACE_TITLE"] = "Migrate data to ThurlyOS from other systems";
...
$MESS["CONFIG_ALLOW_INVITE_USERS"] = "Allow everyone to invite new users to this ThurlyOS account";
...
";
$MESS["CONFIG_NETWORK_AVAILABLE"] = "Allow users of my ThurlyOS communicate in global ThurlyOS Network";
...
$MESS["CONFIG_NETWORK_AVAILABLE_TITLE"] = "Available only in commercial plans of ThurlyOS";
$MESS["CONFIG_NETWORK_AVAILABLE_TEXT_NEW"] = "Communication in ThurlyOS.Network is available to commercial ThurlyOS users only.<br/><br/>
Here are the advantages of connecting ThurlyOS.Network:<br/>
<ul>
...
<li>Seamless communications between users in different ThurlyOS accounts</li>
</ul>
<b>All ThurlyOS.Network tools are available starting with ThurlyOS Plus at #PRICE# a month.</b>";
$MESS["CONFIG_DISK_LIMIT_LOCK_POPUP_TITLE"] = "Available only in extended ThurlyOS.Drive";
...
$MESS["CONFIG_NAME_CHANGE_INFO"] = "Note: you can change your ThurlyOS address only once.";
$MESS["CONFIG_DISK_LOCK_POPUP_TITLE"] = "Available only in advanced ThurlyOS Drive";
...
$MESS["CONFIG_NAME_GOOGLE_API_KEY_FIELD"] = "Google Maps API for ThurlyOS integration key";
