...
class CIntranetMailConfigHomeComponent extends CThurlyComponent
{
	...
	public function executeComponent()
	{
		...
		$APPLICATION->setTitle(getMessage(isModuleInstalled('thurlyos') ? 'INTR_MAIL_B24_PAGE_TITLE' : 'NTR_MAIL_PAGE_TITLE'));
	...
	private function executeHomePage($page)
	{
		...
		{
			$this->arParams['CRM_AVAILABLE'] = $USER->isAdmin() || $USER->canDoOperation('thurlyos_config')
		...
		if ($component->initComponent('thurly:intranet.mail.config.domain'))
