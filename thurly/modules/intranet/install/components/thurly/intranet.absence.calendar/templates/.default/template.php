	...
	if ($arParams['bAdminX'])
	{
		$GLOBALS['INTRANET_TOOLBAR']->AddButton(array(
			'ONCLICK' => $APPLICATION->GetPopupLink(
				array(
					'URL' => '/thurly/admin/iblock_data_export.php?lang='.LANGUAGE_ID.'&bxpublic=Y',
					'PARAMS' => array(
						'height' => 300,
						'width' => 800
					),
...
jsBXAC.Init(
	{
		'LOADER': '/thurly/components/thurly/intranet.absence.calendar/ajax.php',
...
?>
</div><div id="bx_calendar_control_datepicker" style="display: none"><input type="hidden" id="bx_goto_date" name="bx_goto_date" value="<?echo ConvertTimeStamp();?>" /><img src="/thurly/js/main/core/images/calendar-icon.gif" class="calendar-icon" onclick="BX.calendar({node:this, field:'bx_goto_date', bTime: false, callback: jsBXAC.InsertDate});" onmouseover="BX.addClass(this, 'calendar-icon-hover');" onmouseout="BX.removeClass(this, 'calendar-icon-hover');" border="0"/></div>
