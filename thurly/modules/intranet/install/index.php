...
Class intranet extends CModule
{
	...
	function InstallDB()
	{
		...
		if (!$DB->Query("SELECT 'x' FROM b_intranet_sharepoint ", true))
			$errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"].'/thurly/modules/'.$this->MODULE_ID.'/install/db/'.strtolower($DB->type).'/install.sql');
		...
		// activity pulse
		RegisterModuleDependences("crm", "OnAfterCrmContactAdd", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onAfterCrmContactAddEvent");
		RegisterModuleDependences("crm", "OnAfterCrmCompanyAdd", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onAfterCrmCompanyAddEvent");
		RegisterModuleDependences("crm", "OnAfterCrmLeadAdd", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onAfterCrmLeadAddEvent");
		RegisterModuleDependences("crm", "OnAfterCrmDealAdd", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onAfterCrmDealAddEvent");
		RegisterModuleDependences("crm", "OnAfterCrmAddEvent", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onAfterCrmAddEventEvent");
		RegisterModuleDependences("sale", "OnOrderAdd", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onOrderAddEvent");
		RegisterModuleDependences("sale", "OnOrderUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onOrderUpdateEvent");
		RegisterModuleDependences("catalog", "OnProductAdd", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onProductAddEvent");
		RegisterModuleDependences("catalog", "OnProductUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\CrmEventHandler", "onProductUpdateEvent");
		RegisterModuleDependences("webdav", "OnAfterDiskFileAdd", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFileAddEvent");
		RegisterModuleDependences("webdav", "OnAfterDiskFileUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFileUpdateEvent");
		RegisterModuleDependences("webdav", "OnAfterDiskFolderAdd", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFolderAddEvent");
		RegisterModuleDependences("webdav", "OnAfterDiskFolderUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFolderUpdateEvent");
		RegisterModuleDependences("webdav", "OnAfterDiskFirstUsageByDay", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFirstUsageByDayEvent");
		RegisterModuleDependences("disk", "OnAfterDiskFileAdd", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFileAddEvent");
		RegisterModuleDependences("disk", "OnAfterDiskFileUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFileUpdateEvent");
		RegisterModuleDependences("disk", "OnAfterDiskFolderAdd", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFolderAddEvent");
		RegisterModuleDependences("disk", "OnAfterDiskFolderUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFolderUpdateEvent");
		RegisterModuleDependences("disk", "OnAfterDiskFirstUsageByDay", "intranet", "\\Thurly\\Intranet\\UStat\\DiskEventHandler", "onAfterDiskFirstUsageByDayEvent");
		RegisterModuleDependences("im", "OnAfterMessagesAdd", "intranet", "\\Thurly\\Intranet\\UStat\\ImEventHandler", "onAfterMessagesAddEvent");
		RegisterModuleDependences("im", "OnCallStart", "intranet", "\\Thurly\\Intranet\\UStat\\ImEventHandler", "onCallStartEvent");
		RegisterModuleDependences("main", "OnAddRatingVote", "intranet", "\\Thurly\\Intranet\\UStat\\LikesEventHandler", "onAddRatingVoteEvent");
		RegisterModuleDependences("mobileapp", "OnMobileInit", "intranet", "\\Thurly\\Intranet\\UStat\\MobileEventHandler", "onMobileInitEvent");
		RegisterModuleDependences("blog", "OnPostAdd", "intranet", "\\Thurly\\Intranet\\UStat\\SocnetEventHandler", "onPostAddEvent");
		RegisterModuleDependences("blog", "OnCommentAdd", "intranet", "\\Thurly\\Intranet\\UStat\\SocnetEventHandler", "onCommentAddEvent");
		RegisterModuleDependences("tasks", "OnTaskAdd", "intranet", "\\Thurly\\Intranet\\UStat\\TasksEventHandler", "onTaskAddEvent");
		RegisterModuleDependences("tasks", "OnTaskUpdate", "intranet", "\\Thurly\\Intranet\\UStat\\TasksEventHandler", "onTaskUpdateEvent");
		RegisterModuleDependences("tasks", "OnTaskElapsedTimeAdd", "intranet", "\\Thurly\\Intranet\\UStat\\TasksEventHandler", "onTaskElapsedTimeAddEvent");
		RegisterModuleDependences("tasks", "OnAfterCommentAdd", "intranet", "\\Thurly\\Intranet\\UStat\\TasksEventHandler", "onAfterCommentAddEvent");
		...
		RegisterModuleDependences("main", "OnApplicationsBuildList", "main", '\Thurly\Intranet\OutlookApplication',	"OnApplicationsBuildList", 100, "modules/intranet/lib/outlookapplication.php");
		RegisterModuleDependences("main", "OnApplicationsBuildList", "main", '\Thurly\Intranet\PublicApplication',	"OnApplicationsBuildList", 100, "modules/intranet/lib/publicapplication.php");
		...
		$eventManager->registerEventHandler('main', 'onApplicationScopeError', 'intranet', '\Thurly\Intranet\PublicApplication', 'onApplicationScopeError');
		
		// for main user online status
		$eventManager->registerEventHandlerCompatible('main', 'onUserOnlineStatusGetCustomOfflineStatus', 'intranet', '\Thurly\Intranet\UserAbsence', 'onUserOnlineStatusGetCustomOfflineStatus');
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockElementAdd', 'intranet', '\Thurly\Intranet\UserAbsence', 'onAfterIblockElementModify');
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockElementUpdate', 'intranet', '\Thurly\Intranet\UserAbsence', 'onAfterIblockElementModify');
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockElementDelete', 'intranet', '\Thurly\Intranet\UserAbsence', 'onAfterIblockElementModify');

		// for main user index rebuild
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockSectionUpdate', 'intranet', '\Thurly\Intranet\Integration\Main', 'onAfterIblockSectionUpdate');
		
		CAgent::AddAgent('\\Thurly\\Intranet\\UStat\\UStat::recountHourlyCompanyActivity();', "intranet", "N", 60);
		CAgent::AddAgent('\\Thurly\\Intranet\\UStat\\UStat::recount();', "intranet", "N", 3600);

		if (!file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/thurlyos"))
		{
		...
		\Thurly\Intranet\Internals\UserSubordinationTable::reInitialize();
		\Thurly\Intranet\Internals\UserToDepartmentTable::reInitialize();
	...
	function InstallEvents()
	{
		...
		if($ar["C"] <= 0)
		{
			include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/events.php");
		}
		return true;
	}
	...
	function InstallFiles()
	{
		...
		{
			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/components",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/components",
				true, true
			);

			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/gadgets",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/gadgets",
				true, true
			);

			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/admin",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/admin",
				true, true
			);

			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/js",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/js",
				true, true
			);

			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/themes",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/themes",
				true, true
			);

			// here: set access rights for all of the services
			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/tools",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/tools",
				true, true
			);

			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/images",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/images",
				true, true
			);

			CopyDirFiles(
				$_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/services",
				$_SERVER["DOCUMENT_ROOT"]."/thurly/services",
				true, true
			);
		}
	...
	function InstallUserFields()
	{
		...
		$arMess = self::__GetMessagesForAllLang($strPath2Lang,'/install/property_names.php',array('UF_PHONE_INNER','UF_1C','UF_INN','UF_DISTRICT','UF_SKYPE','UF_TWITTER','UF_FACEBOOK','UF_LINKEDIN','UF_XING','UF_WEB_SITES','UF_SKILLS','UF_INTERESTS','UF_DEPARTMENT'));
	...
	function DoInstall()
	{
		...
		if (IntVal($arCurPhpVer[0]) < 5)
		{
			...
			$APPLICATION->IncludeAdminFile(GetMessage("INTR_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/install/step1.php");
		}
		else
		{
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("INTR_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/".$this->MODULE_ID."/install/del_denied.php");
	}
