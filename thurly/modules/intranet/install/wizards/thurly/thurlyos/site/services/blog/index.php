...
$arBlogPosts = array(
	array(
		"TITLE" => GetMessage("BLOG_DEMO_MESSAGE_TITLE3"),
		"DETAIL_TEXT" => GetMessage("BLOG_DEMO_MESSAGE_BODY3"),
	...
	array(
		"TITLE" => GetMessage("BLOG_DEMO_MESSAGE_TITLE2"),
		"DETAIL_TEXT" => GetMessage("BLOG_DEMO_MESSAGE_BODY2"),
		"DETAIL_TEXT_TYPE" => "text",
		"BLOG_ID" => $blogID,
		"AUTHOR_ID" => 1,
		"VIEWS" => 5,
	...
	array(
		"TITLE" => GetMessage("BLOG_DEMO_MESSAGE_TITLE1"),
		"DETAIL_TEXT" => GetMessage("BLOG_DEMO_MESSAGE_BODY1"),
		"DETAIL_TEXT_TYPE" => "text",
		"BLOG_ID" => $blogID,
		"AUTHOR_ID" => 1,
		"VIEWS" => 5,
...
foreach($arBlogPosts as $arBlogPostFields)
{
	...
	{
		$parserBlog = new blogTextParser(false, "/thurly/images/socialnetwork/smile/");
