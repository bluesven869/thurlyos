...
if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)
	...
	CopyDirFiles($WIZARD_SERVICE_ABSOLUTE_PATH."/smiles_install/icons/", $_SERVER['DOCUMENT_ROOT'].'/thurly/images/main/icons/3/', true, true);
	CopyDirFiles($WIZARD_SERVICE_ABSOLUTE_PATH."/smiles_install/icons/", $_SERVER['DOCUMENT_ROOT'].'/thurly/images/main/icons/4/', true, true);
	CopyDirFiles($WIZARD_SERVICE_ABSOLUTE_PATH."/smiles_install/smiles/", $_SERVER['DOCUMENT_ROOT'].'/thurly/images/main/smiles/3/', true, true);
	CopyDirFiles($WIZARD_SERVICE_ABSOLUTE_PATH."/smiles_install/smiles/", $_SERVER['DOCUMENT_ROOT'].'/thurly/images/main/smiles/4/', true, true);
