...
{
	$iblockXMLFile = $WIZARD_SERVICE_RELATIVE_PATH."/xml/".\Thurly\Main\Localization\Loc::getDefaultLang(LANGUAGE_ID)."/departments.xml";
}
...
if($iblockID == false)
{
	...
	if ($ID > 0)
	{
		$arDepartmentSections = array(		
			...
			array(
				"NAME" => GetMessage("iblock_dep_name4"),
				"IBLOCK_ID" => $iblockID,
				"IBLOCK_SECTION_ID" => $ID
			),
			array(
