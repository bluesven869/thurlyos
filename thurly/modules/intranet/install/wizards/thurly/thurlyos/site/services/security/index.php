...
$thurlyosOptions = array(
	"redirect_sid" => md5(mt_rand()),
...
foreach($thurlyosOptions as $key => $value)
{
	COption::SetOptionString("security", $key, $value);
}

Thurly\Security\Mfa\Otp::setMandatoryRights(array("G1", "G11"));
...
/*
if (!\Thurly\Main\ModuleManager::isModuleInstalled("thurlyos") && \Thurly\Main\Loader::includeModule("security"))
{
