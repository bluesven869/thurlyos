...
COption::SetOptionString("main", "vendor", (LANGUAGE_ID == "ru"? "1c_thurly_portal":"thurly_portal"));
...
COption::SetOptionString("search", "exclude_mask", "/thurly/*;/upload/*;");
...
/*
//Пока решили отключить на КПшках журнал
...
COption::SetOptionString("main", 'CAPTCHA_arTTFFiles', 'thurly_captcha.ttf');
...
\Thurly\Main\Config\Option::set('bizproc', 'delay_min_limit', 600);
...
if (IsModuleInstalled("thurlyos"))
{
	...
	COption::SetOptionString("thurlyos", "admin_limits_enabled", "Y");
	COption::SetOptionString("thurlyos", "absence_limits_enabled", "Y");
}
\Thurly\Main\Config\Option::set('crm', 'crm_lead_enabled_show', "Y");

// mail
\Thurly\Main\Config\Option::set('intranet', 'path_mail_config', WIZARD_SITE_DIR.'company/personal/mail/?config', WIZARD_SITE_ID);
\Thurly\Main\Config\Option::set('intranet', 'path_mail_manage', WIZARD_SITE_DIR.'company/personal/mail/manage/', WIZARD_SITE_ID);
