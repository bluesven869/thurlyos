...
\Thurly\Main\Config\Option::set('tasks', 'task_list_enable_gantt_hint', 'N');

// create default task template for each new user
\Thurly\Intranet\Integration\Tasks::createDemoTemplates();

// create demo data for the portal owner
\Thurly\Intranet\Integration\Tasks::createDemoTasksForUser(1);
?>