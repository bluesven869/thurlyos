...
CopyDirFiles(
	$_SERVER['DOCUMENT_ROOT']."/thurly/modules/intranet/install/templates/thurlyos/",
	WIZARD_SITE_ROOT_PATH."/thurly/templates/thurlyos/",
	$rewrite = true,
	$recursive = true,
...
if ($arSite = $obSite->Fetch())
{
	...
	if (!$found)
	{
		...
		$arTemplates[] = array('CONDITION' => "CSite::InDir('/thurly/tools/b24_emailrequest.php')", 'SORT' => 190, 'TEMPLATE' => 'login');
	}
	...
	if (!$foundLanding)
		$arTemplates[]= Array("CONDITION" => "preg_match('#/sites/site/[\\d]+/view/[\\d]+/#', \$GLOBALS['APPLICATION']->GetCurPage(0))", "SORT" => 1, "TEMPLATE" => "landing24");
