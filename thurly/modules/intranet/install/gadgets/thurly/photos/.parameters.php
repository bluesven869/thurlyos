...
$arComponentProps = CComponentUtil::GetComponentProps("thurly:photogallery.detail.list.ex", $arCurrentValues);
$arComponentProps2 = CComponentUtil::GetComponentProps("thurly:photogallery", $arCurrentValues);
