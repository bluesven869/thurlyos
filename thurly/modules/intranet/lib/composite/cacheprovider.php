<?
namespace Thurly\Intranet\Composite;

use Thurly\Main\Config\Option;
use Thurly\Main\Data\StaticCacheProvider;
use Thurly\Main\Data\StaticHtmlCache;
...
class CacheProvider extends StaticCacheProvider
{
	...
	public static function deleteUserCache($userId = false, $sendHeader = true)
	{
		...
		if ($userId > 0)
		{
			...
			if ($sendHeader === true)
			{
				header("X-Thurly-Composite-Delete:".md5(\CHTMLPagesCache::getHttpHost().$privateKey));
			}
		}
	}
	...
	public static function deleteAllCache()
	{
		...
		header("X-Thurly-Composite-Delete:All");
	}
}
