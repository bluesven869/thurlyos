...
namespace Thurly\Intranet\Integration\Templates\ThurlyOS;

use Thurly\Intranet\Composite\CacheProvider;
...
class ThemePicker
{
	...
	public static function getInstance()
	{
		...
		{
			$templateId = defined("SITE_TEMPLATE_ID") ? SITE_TEMPLATE_ID : "thurlyos";
	...
	public static function isAdmin()
	{
		...
		return
			...
			(Loader::includeModule("thurlyos") && \CThurlyOS::isPortalAdmin($GLOBALS["USER"]->getID()))
		;
	}

	public static function isAvailable()
	{
		return !Loader::includeModule("thurlyos") || \Thurly\ThurlyOS\Release::isAvailable("17.5.0");
	}
	...
	public function showHeadAssets()
	{
		...
		Asset::getInstance()->addString(
			"<script>BX.Intranet.ThurlyOS.ThemePicker.Singleton = new BX.Intranet.ThurlyOS.ThemePicker($options);</script>",
			false,
	...
	public function create(array $fields)
	{
		...
		if (isset($fields["bgImage"]["tmp_name"]) && strlen($fields["bgImage"]["tmp_name"]) > 0)
		{
			...
			$imageId = \CFile::saveFile($fields["bgImage"], "thurlyos");
			if (!$imageId)
			{
	...
	{
		return "/thurly/tools/intranet_theme_picker.php";
	}
	...
	{
		return "thurlyos_theme_".$this->getTemplateId()."_".$this->getSiteId();
	}

	public function getDefaultThemeOptionName()
	{
		return "thurlyos_default_theme_".$this->getTemplateId()."_".$this->getSiteId();
	}

	public function getCustomThemesOptionName()
	{
		return "thurlyos_custom_themes_".$this->getTemplateId();
	}

	public function getLastThemesOptionName()
	{
		return "thurlyos_last_themes_usage".$this->getTemplateId();
	}

	public function getHintOptionName()
	{
		return "thurlyos_themes_show_hint";
	}
