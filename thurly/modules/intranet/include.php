...
CJSCore::RegisterExt('intranet_structure', array(
	'js' => '/thurly/js/intranet/structure.js',
	'lang' => '/thurly/modules/intranet/lang/'.LANGUAGE_ID.'/js_core_intranet_structure.php',
	'rel' => array('ajax', 'popup')
));

CJSCore::RegisterExt('planner', array(
	'js' => '/thurly/js/intranet/core_planner.js',
	'css' => '/thurly/js/intranet/core_planner.css',
	'lang' => '/thurly/modules/intranet/lang/'.LANGUAGE_ID.'/js_core_intranet_planner.php',
	'rel' => array('date')
));

CJSCore::RegisterExt("intranet_notify_dialog", array(
	"js" => "/thurly/js/intranet/notify_dialog/notify_dialog.js",
	"css" => "/thurly/js/intranet/notify_dialog/notify_dialog.css",
	"lang" => "/thurly/modules/intranet/lang/".LANGUAGE_ID."/install/js/notify_dialog.php",
	"rel" => array("popup")
));

CJSCore::RegisterExt("intranet_userfield_employee", array(
	"js" => "/thurly/js/intranet/userfieldemployee.js",
	"css" => "/thurly/js/intranet/userfieldemployee.css",
	"rel" => array('ui'),
));

CJSCore::RegisterExt("intranet_theme_picker", array(
	"js" => array("/thurly/js/intranet/theme_picker/theme_picker.js"),
	"css" => "/thurly/js/intranet/theme_picker/theme_picker.css",
	"lang" => "/thurly/modules/intranet/install/js/theme_picker.php",
...
CJSCore::RegisterExt(
	...
	array(
		"js" => array(
			"/thurly/js/intranet/sidepanel/thurlyos/slider.js"
		),
		"css" => "/thurly/js/intranet/sidepanel/css/slider.css",
		"rel" => array("sidepanel"),
		"bundle_js" => "sidepanel_thurlyos",
		"bundle_css" => "sidepanel_thurlyos",
	)
);
