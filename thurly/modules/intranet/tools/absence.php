...
if(!CModule::IncludeModule('iblock'))
{
	echo GetMessage("INTR_ABSENCE_THURLY24_MODULE");
}
else
{
	if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET["action"]) && $_GET["action"] == "delete" && check_thurly_sessid())
	{
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							...
							<td>
								...
								$APPLICATION->IncludeComponent("thurly:main.calendar","",Array(
									"SHOW_INPUT" => "Y",
									"FORM_NAME" => "",
