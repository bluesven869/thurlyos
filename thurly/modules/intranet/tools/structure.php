...
if(!CModule::IncludeModule('iblock'))
{
	echo GetMessage("INTR_STRUCTURE_THURLY24_MODULE");
}
else
{
	$ID = 1;
	...
	if($_SERVER["REQUEST_METHOD"] === "GET" && check_thurly_sessid() && $_GET["action"] = "delete_department" && CIBlockSectionRights::UserHasRightTo($iblockID, intval($_GET['dpt_id']), 'section_delete'))
	{
