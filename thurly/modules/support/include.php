...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/support/errors.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/support/support_tools.php");
