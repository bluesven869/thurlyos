	...
	<tr>
		<td> 
			<table cellpadding="1" cellspacing="0" border="0">
				<tr>
					<td valign="center" nowrap><img src="/thurly/admin/ticket_graph.php?<?=GetFilterParams($arFilterFields)?>&width=<?=$width?>&height=<?=$height?>&lang=<?echo LANG?>" width="<?=$width?>" height="<?=$height?>"></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td> 
			<table cellpadding="3" cellspacing="1" border="0" class="legend">
				<?if ($find_open=="Y"):?>
				<tr>
					<td valign="center"><img src="/thurly/admin/ticket_graph_legend.php?color=<?=$arrColor["OPEN_TICKET"]?>" width="45" height="2"></td>
					<td nowrap><?=GetMessage("SUP_OPEN_TICKET")?></td>
				</tr>
				<?endif;?>
				<?if ($find_close=="Y"):?>
				<tr>
					<td valign="center"><img src="/thurly/admin/ticket_graph_legend.php?color=<?=$arrColor["CLOSE_TICKET"]?>" width="45" height="2"></td>
					<td nowrap><?=GetMessage("SUP_CLOSE_TICKET")?></td>
				</tr>
				<?endif;?>
				<?if ($find_all=="Y"):?>
				<tr>
					<td valign="center"><img src="/thurly/admin/ticket_graph_legend.php?color=<?=$arrColor["ALL_TICKET"]?>" width="45" height="2"></td>
					<td nowrap><?=GetMessage("SUP_ALL_TICKET")?></td>
				</tr>
				<?endif;?>
				<?if ($find_mess=="Y"):?>
				<tr>
					<td valign="center"><img src="/thurly/admin/ticket_graph_legend.php?color=<?=$arrColor["MESSAGES"]?>" width="45" height="2"></td>
					<td nowrap><?=GetMessage("SUP_MESSAGES")?></td>
				</tr>
				<?endif;?>
				<?if ($find_overdue_mess=="Y"):?>
				<tr>
					<td valign="center"><img src="/thurly/admin/ticket_graph_legend.php?color=<?=$arrColor["OVERDUE_MESSAGES"]?>" width="45" height="2"></td>
...
<table cellspacing=0 cellpadding=10 class="graph">
	<tr>
		<td valign="top"><img src="/thurly/admin/ticket_diagram_time.php?<?=GetFilterParams($FilterArr1)?>&diameter=<?=$diameter?>&lang=<?=LANG?>" width="<?=$diameter?>" height="<?=$diameter?>"></td>
		<td valign="top">
				...
				<tr>
					...
					<td valign="center">
						<table cellspacing=0 cellpadding=0>
							<tr>
								<td style="background-color: <?="#".$color?>"><img src="/thurly/images/1.gif" width="12" height="12" border=0></td>
							</tr>
						</table>
					</td>
					<td align="right" nowrap><?echo sprintf("%01.2f", $procent)."%"?></td>
					<td  nowrap><a href="/thurly/admin/ticket_list.php?<?=GetFilterParams($FilterArr1)?>&find_close=Y&lang=<?=LANG?>&<?echo $f?>&set_filter=Y"><?=$counter?></a></td>
...
<table cellspacing=0 cellpadding=10 class="graph">
	<tr>
		<td valign="top"><img src="/thurly/admin/ticket_diagram_mess.php?<?=GetFilterParams($FilterArr1)?>&diameter=<?=$diameter?>&lang=<?=LANG?>" width="<?=$diameter?>" height="<?=$diameter?>"></td>
		<td valign="top">
			<table cellpadding=2 cellspacing=0 border=0 class="legend">
				<?
				$s = GetFilterParams($FilterArr);
				...
				<tr>
					...
					<td align="right" nowrap><?echo sprintf("%01.2f", $procent)."%"?></td>
					<td  nowrap><img src="/thurly/images/1.gif" width="3" height="1"><a href="/thurly/admin/ticket_list.php?<?=GetFilterParams($FilterArr1)?>&find_close=Y&lang=<?=LANG?>&<?echo $f?>&set_filter=Y"><?=$counter?></a></td>
