...
class CAllTicketReminder
{
	...
	function SupportDeadline($arrTicket)
	{
		...
		IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/support/classes/general/messages.php", $arSite["LANGUAGE_ID"]);
	...
	function SupportDeadlineNotify($arrTicket0)
	{
		...
		$arFields_notify = array(
			...
			"SOURCE"					=> $sourceName,
			"ADMIN_EDIT_URL"			=> "/thurly/admin/ticket_edit.php",
