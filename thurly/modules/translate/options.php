...
if ($_SERVER["REQUEST_METHOD"] == "GET" && $TRANS_RIGHT=="W" && strlen($RestoreDefaults)>0 && check_thurly_sessid())
{
...
$arAllOptions = array(
	array("INIT_FOLDERS", GetMessage("TRANS_INIT_FOLDERS"), "/thurly/", array("text", 50)),
...
if($_SERVER["REQUEST_METHOD"]=="POST" && strlen($Update.$Apply.$RestoreDefaults)>0 && $TRANS_RIGHT=="W" && check_thurly_sessid())
{
