	...
	if($strError == '')
	{
		...
		if ($strError == '')
		{
			if(isset($_REQUEST['apply']))
			{
				...
				LocalRedirect("/thurly/admin/translate_edit_php.php?lang=".LANGUAGE_ID.'&file='.$file);
			}
			else
			{
				LocalRedirect("/thurly/admin/translate_list.php?lang=".LANGUAGE_ID."&path=/".implode("/",$arPath)."/"."&".thurly_sessid_get());
			}
		}
		else
		{
...
$aMenu[] = Array(
	...
	"LINK"	=> "/thurly/admin/translate_show_php.php?lang=".LANGUAGE_ID."&file=$file&".thurly_sessid_get(),
...
$tabControl->Buttons(
	array(
		"disabled" => $only_read,
		"back_url" => "/thurly/admin/translate_list.php?lang=".LANGUAGE_ID."&path=/".implode("/",$arPath)."/"."&".thurly_sessid_get()
	)
);
$tabControl->End();
?>
