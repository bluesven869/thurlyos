...
Class compression extends CModule
{
	...
	function DoInstall()
	{
		...
		$this->InstallDB();
		$APPLICATION->IncludeAdminFile(GetMessage("COMPRESS_INSTALL_TITLE"), $DOCUMENT_ROOT."/thurly/modules/compression/install/step.php");
	}
	...
	function DoUninstall()
	{
		global $DOCUMENT_ROOT, $APPLICATION;
		$this->UnInstallDB();
		$APPLICATION->IncludeAdminFile(GetMessage("COMPRESS_UNINSTALL_TITLE"), $DOCUMENT_ROOT."/thurly/modules/compression/install/unstep.php");
	}
}
?>