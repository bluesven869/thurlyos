...
if($MOD_RIGHT>="W" && check_thurly_sessid())
{
...
function StartSMTPD()
{
	...
	BX.ajax({
		'url':'/thurly/admin/mail_smtpd_manager.php',
		'method':'POST',
		'data' : 'action=start&sessid=' + BX.thurly_sessid(),
		'dataType': 'json',
		'timeout': 5,
		'async': false,
		'start': true,
...
function Stats(norefresh)
{
	...
	BX.ajax({
		'url':'/thurly/admin/mail_smtpd_manager.php',
		'method':'POST',
		'data' : 'action=stats&sessid=' + BX.thurly_sessid(),
		'dataType': 'json',
		'timeout': 10,
		'async': false,
		'start': true,
...
function StopSMTPD()
{
	...
	BX.ajax({
		'url':'/thurly/admin/mail_smtpd_manager.php',
		'method':'POST',
		'data' : 'action=stop&sessid=' + BX.thurly_sessid(),
		'dataType': 'json',
		'timeout': 10,
		'async': true,
		'start': true
