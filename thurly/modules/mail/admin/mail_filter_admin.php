...
$arSubMenu[] = array(
	...
	"ACTION"	=> "window.location='/thurly/admin/mail_filter_edit.php?filter_type=&lang=".LANG."';"
);
...
while($ar = $res->ExtractFields("a_"))
{
	$arSubMenu[] = array(
	"TEXT"	=> $a_NAME,
	"ACTION"	=> "window.location='/thurly/admin/mail_filter_edit.php?filter_type=".$a_ID."&lang=".LANG."';"
	);
}
