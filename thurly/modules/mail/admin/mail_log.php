...
$nav = new Thurly\Main\UI\AdminPageNavigation('nav-mail-log');

$log = Thurly\Mail\MailLogTable::getList(array(
	'select'      => array(
...
$lAdmin->setNavigation($nav, Thurly\Main\Localization\Loc::getMessage("MAIL_LOG_NAVIGATION"));
