...
if($ID>0)
{
	...
	if ($MOD_RIGHT=="W")
	{
		$aMenu[] = array(
			...
			"LINK"=>"javascript:if(confirm('".GetMessage("MAIL_FLT_EDT_DEL_CONFIRM")."'))window.location='mail_filter_admin.php?action=delete&ID=".$ID."&lang=".LANG."&".thurly_sessid_get()."';",
		);
	}
}
...
<?
$tabControl->Buttons(Array("disabled"=>$MOD_RIGHT<"W", "back_url" =>"/thurly/admin/mail_filter_admin.php?lang=".LANG));
$tabControl->End();
?>
