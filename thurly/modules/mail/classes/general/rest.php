...
class CMailRestService extends IRestService
{
	...
	public static function mailserviceList($arParams)
	{
		...
		while ($row = $result->fetch())
		{
			...
			$row['ICON'] = Thurly\Mail\MailServicesTable::getIconSrc($row['NAME'], $row['ICON']);
	...
	public static function mailserviceGet($arParams)
	{
		...
		if ($data = $result->fetch())
		{
			...
			$data['ICON'] = Thurly\Mail\MailServicesTable::getIconSrc($data['NAME'], $data['ICON']);
		}
	...
	public static function mailserviceUpdate($arParams)
	{
		...
		$result = Thurly\Mail\MailServicesTable::update($arParams['ID'], $arFields);
	...
	public static function mailserviceDelete($arParams)
	{
		...
		$result = Thurly\Mail\MailServicesTable::delete($arParams['ID']);
