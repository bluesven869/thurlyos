...
class User
{
	...
	public static function login()
	{
		...
		$handler = $eventManager->addEventHandlerCompatible('main', 'OnUserLoginExternal', array('\Thurly\Mail\User', 'onLoginExternal'));
	...
	public static function getDefaultEmailFrom($serverName = false)
	{
		...
		{
			if(preg_match("/\\.thurlyos\\.([a-z]+|com\\.br)$/i", BX24_HOST_NAME))
			{
