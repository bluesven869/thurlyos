...
class Helper
{
	...
	public static function syncMailboxAgent($id)
	{
		...
		return sprintf('Thurly\Mail\Helper::syncMailboxAgent(%u);', $id);
	}
	...
	public static function resyncDomainUsersAgent()
	{
		...
		return 'Thurly\Mail\Helper::resyncDomainUsersAgent();';
	}
	...
	public static function syncMailbox($id, &$error)
	{
		...
		else
		{
			...
			\Thurly\Main\Config\Option::set('mail', 'last_mail_sync', time(), $mailbox['LID']);
			\Thurly\Main\Config\Option::set('mail', 'last_mail_check_success', $result ? 'Y' : 'N', $mailbox['LID']);
		}
