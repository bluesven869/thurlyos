...
class MailServicesTable extends Entity\DataManager
{
	...
	public static function checkFields(Entity\Result $result, $primary, array $data)
	{
		...
		{
			$selectResult = \Thurly\Main\SiteTable::getByPrimary($data['SITE_ID']);
	...
	public static function getIconSrc($serviceName, $iconId = null)
	{
		...
		{
			$icons = array(
				'thurlyos'    => '/thurly/images/mail/mailservice-icon/' . Localization\Loc::getMessage('mail_mailservice_thurlyos_icon'),
				'gmail'       => '/thurly/images/mail/mailservice-icon/post-gmail-icon.png',
				'icloud'      => '/thurly/images/mail/mailservice-icon/post-icloud-icon.png',
				'outlook.com' => '/thurly/images/mail/mailservice-icon/post-outlook-icon.png',
				'office365'   => '/thurly/images/mail/mailservice-icon/post-office360-icon.png',
				'yahoo'       => '/thurly/images/mail/mailservice-icon/post-yahoo-icon.png',
				'aol'         => '/thurly/images/mail/mailservice-icon/post-aol-icon.png',
				'yandex'      => '/thurly/images/mail/mailservice-icon/post-yandex-icon.png',
				'mail.ru'     => '/thurly/images/mail/mailservice-icon/post-mail-icon.png',
				'ukr.net'     => '/thurly/images/mail/mailservice-icon/post-ukrnet-icon.png',
				'exchange'    => '/thurly/images/mail/mailservice-icon/post-exchange-icon.png',
				'other'       => '/thurly/images/mail/mailservice-icon/post-imap-icon.png',
			);
