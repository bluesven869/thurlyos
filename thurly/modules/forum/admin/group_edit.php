...
if ((array_key_exists("save", $_POST) || array_key_exists("apply", $_POST)) && $forumPermissions == "W" && check_thurly_sessid())
{
	...
	{
		BXClearCache(true, "thurly/forum/group/");
...
$aMenu = array(
	array(
		...
		"LINK" => "/thurly/admin/forum_group.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_list"));
...
if ($ID > 0 && $forumPermissions == "W")
{
	...
	$aMenu[] = array(
		...
		"LINK" => "/thurly/admin/forum_group_edit.php?PARENT_ID=".$ID."&lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_new");
	$aMenu[] = array(
		"TEXT" => GetMessage("FGN_COPY_GROUP"),
		"LINK" => "/thurly/admin/forum_group_edit.php?".($ID > 0 ? "COPY_ID=".$ID."&" : "")."lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_copy");
	$aMenu[] = array(
		"TEXT" => GetMessage("FGN_DELETE_GROUP"), 
		"LINK" => "javascript:if(confirm('".GetMessage("FGN_DELETE_GROUP_CONFIRM")."')) window.location='/thurly/admin/forum_group.php?action=delete&ID[]=".$ID."&lang=".LANG."&".thurly_sessid_get()."#tb';",
		"ICON" => "btn_delete");
}
...
$tabControl->Buttons(
	array(
		...
		"back_url" => "/thurly/admin/forum_group.php?lang=".LANG."&".GetFilterParams("filter_", false)
		)
	);
$tabControl->End();
