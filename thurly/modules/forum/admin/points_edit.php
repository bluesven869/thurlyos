...
$bInitVars = false;
if ($REQUEST_METHOD=="POST" && $forumPermissions=="W" && (!empty($save) || !empty($apply)) && check_thurly_sessid())
{
	$arFields = array(
...
$aMenu = array(
	array(
		...
		"LINK" => "/thurly/admin/forum_points.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_list",
	)
);
...
if ($ID > 0 && $forumPermissions == "W")
{
	...
	$aMenu[] = array(
		...
		"LINK" => "/thurly/admin/forum_points_edit.php?lang=".LANG."&".GetFilterParams("filter_", false),
		"ICON" => "btn_new",
	);

	$aMenu[] = array(
		"TEXT" => GetMessage("FPN_DELETE_POINT"),
		"LINK" => "javascript:if(confirm('".GetMessage("FPN_DELETE_POINT_CONFIRM")."')) window.location='/thurly/admin/forum_points.php?action=delete&ID[]=".$ID."&lang=".LANG."&".thurly_sessid_get()."#tb';",
		"ICON" => "btn_delete",
	);
}
...
$tabControl->Buttons(
	array(
		...
		"back_url" => "/thurly/admin/forum_points.php?lang=".LANG."&".GetFilterParams("filter_", false)
	)
);
$tabControl->End();
?>
