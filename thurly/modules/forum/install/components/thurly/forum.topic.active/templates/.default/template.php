...
<?
$APPLICATION->IncludeComponent("thurly:forum.interface", "filter_simple",
	array(
		"FORM_METHOD_GET" => 'Y',
		"HEADER" => array(
...
?>
							<span class="forum-footer-option  forum-footer-markread  forum-footer-markread-topics forum-footer-option-first">
								<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("ACTION=SET_BE_READ&".thurly_sessid_get()."&TID=".implode(",", $arTopics), $arParamKill)
...
?>
							<span class="forum-footer-option forum-footer-markread  forum-footer-markread-forums">
								<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("ACTION=SET_BE_READ&".thurly_sessid_get()."&FID=".$GLOBALS["find_forum"], $arParamKill)
...
?>
							<span class="forum-footer-option  forum-footer-markread  forum-footer-markread-topics">
								<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("ACTION=SET_BE_READ&".thurly_sessid_get()."&FID=all", $arParamKill)
