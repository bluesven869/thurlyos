...
\Thurly\Main\Loader::registerAutoLoadClasses(
	"forum",
	array(
		"thurly\\forum\\internals\\basetable" => "lib/internals/basetable.php",
		"thurly\\forum\\comments\\comment" => "lib/comments/comment.php",
		"thurly\\forum\\comments\\entity" => "lib/comments/entity.php",
		"thurly\\forum\\comments\\eventmanager" => "lib/comments/eventmanager.php",
		"thurly\\forum\\comments\\feed" => "lib/comments/feed.php",
		"thurly\\forum\\comments\\taskentity" => "lib/comments/taskentity.php",
		"thurly\\forum\\comments\\user" => "lib/comments/user.php",
...
\Thurly\Forum\Comments\EventManager::init();
...
function ForumPrintIconsList($num_cols, $value = "")
{
	...
	$arSmile[] = array('TYPING' => '', 'IMAGE' => '/thurly/images/1.gif', 'NAME' => '', 'CLASS' => 'forum-icon-empty');
	$strPath2Icons = "/thurly/images/forum/icon/";
...
function ForumPrintSmilesList($num_cols, $strLang = false)
{
	...
	$strPath2Icons = "/thurly/images/forum/smile/";
...
//		}
	...
	else // If user is not authorized that get info from cookies only
	{
		...
		{
			$forum_cookie = COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_FORUM_GUEST";
...
//		It need to save info about visited topics for GUEST in cookies
		if (!isset($_SESSION["FORUM"]["GUEST_TID"]) || !is_array($_SESSION["FORUM"]["GUEST_TID"]))
		{
			...
			$topic_cookie = COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_FORUM_GUEST_TID";
...
?>
	...
	LHEButtons['ForumVideo'] = {
		id : 'ForumInputVideo',
		src : '/thurly/components/thurly/forum/templates/.default/images/bbcode/font_video.gif',
			...
			obj: {
				Parse: function(sName, sContent, pLEditor)
				{
					sContent = sContent.replace(/\[VIDEO\s*?width=(\d+)\s*?height=(\d+)\s*\]((?:\s|\S)*?)\[\/VIDEO\]/ig, function(str, w, h, src)
					{
						...
						return '<img id="' + pLEditor.SetBxTag(false, {tag: "forumvideo", params: {value : src}}) + '" src="/thurly/images/1.gif" class="bxed-video" width=' + w + ' height=' + h + ' title="' + BX.message.Video + ": " + src + '" />';
					});
					return sContent;
				},
			...
			OnSave: function()
			{
				...
				else if(pLEditor.sEditorMode == 'html') // WYSIWYG
				{
					pLEditor.InsertHTML('<img id="' + pLEditor.SetBxTag(false, {tag: "forumvideo", params: {value : src}}) +
							'" src="/thurly/images/1.gif" class="bxed-video" width=' + w + ' height=' + h +
