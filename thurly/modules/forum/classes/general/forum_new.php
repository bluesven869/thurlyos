...
/***************** Cleaning cache/**********************************/
	...
	public static function InitReadLabels($ID, $arUserGroups) // out-of-date function
	{
		...
		$read_forum_cookie = COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_FORUM_0";
		...
		$read_forum_cookie1 = COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_FORUM_".$ID;
	...
	public static function ShowPanel($FID, $TID=0, $bGetIcons=false)
	{
		...
		if ($module_permission > "D")
		{
			$arButtons[] = array(
				...
				"IMAGE" => "/thurly/images/forum/toolbar_button1.gif",
				"ACTION" => "jsUtils.Redirect(arguments, '/thurly/admin/forum_admin.php')");
				...
				CForumNew::CanUserUpdateForum($FID, $USER->GetUserGroupArray(), $USER->GetID()))
			{
				$arButtons[] = array(
					...
					"IMAGE" => "/thurly/images/forum/toolbar_button2.gif",
					"ACTION" => "jsUtils.Redirect(arguments, '/thurly/admin/forum_edit.php?ID=".intVal($FID)."')");
			}
		}
		if (!empty($arButtons))
		{
			$arButton = array(
				"SRC" => "/thurly/images/forum/toolbar_button1.gif",
