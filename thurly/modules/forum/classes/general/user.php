...
/***************** Cleaning cache/**********************************/
		...
		if (!array_key_exists("INTERESTS", $fields) || $DB->type != "oracle")
		{
			...
			$fields["LAST_VISIT"] = new \Thurly\Main\DB\SqlExpression($helper->getCurrentDateTimeFunction());
			$fields["DATE_REG"] = new \Thurly\Main\DB\SqlExpression($helper->getCurrentDateTimeFunction());
