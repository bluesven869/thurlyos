...
class TopicHandler extends \Thurly\Replica\Client\BaseHandler
{
	...
	{
		\Thurly\Replica\Db\Operation::writeInsert($this->tableName, array('ID'), array('ID' => $id));
	}
	...
	{
		\Thurly\Replica\Db\Operation::writeUpdate($this->tableName, array('ID'), array('ID' => $id));
	}
	...
	{
		\Thurly\Replica\Db\Operation::writeDelete($this->tableName, array('ID'), array('ID' => $id));
	}
