...
namespace Thurly\Forum\Comments;
...
abstract class BaseObject
{
	...
	/* @var \Thurly\Forum\Comments\User */
	protected $user;
	/* @var \Thurly\Forum\Comments\Entity */
	protected $entity;
	/** @var array */
	protected $forum;
	/** @var array */
	...
	public function getEntity()
	{
		...
		if (! $this->entity instanceof Entity)
			throw new SystemException("Entity Class does not descended from \\Thurly\\Forum\\Comments\\Entity.");
	...
	{
		$this->user = new \Thurly\Forum\Comments\User($userId);
		return $this->user;
	}
	/**
	 * @return User
