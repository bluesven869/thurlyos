...
$arFilter = array(
	...
	if ($arInfoRecalc["STATUS"] == "DONE")
	{
		...
		BXClearCache(true, "/thurly/photogallery/".$arParams["IBLOCK_ID"]."/user/data/".$arResult["GALLERY"]["CREATED_BY"]."/");
		BXClearCache(true, "/thurly/photogallery/".$arParams["IBLOCK_ID"]."/gallery/".$arResult["GALLERY"]["~CODE"]."/");
