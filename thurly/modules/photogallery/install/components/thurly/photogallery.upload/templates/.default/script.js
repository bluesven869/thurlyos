			...
			if (!this.pImgInput)
			{
				...
				this.pImgInput.onchange = function()
				{
					...
					_this.pImgForm = BX.create("FORM", {
						...
						style: {display: "none"},
						children : [
							BX.create('INPUT', { props : { type : "hidden", name : "sessid", value : BX.thurly_sessid() } } ),
				...
				{
					if (_this.watermarkPreview.src != "/thurly/images/1.gif")
					{
				...
				{
					_this.watermarkPreview.src = '/thurly/images/1.gif';
					_this.watermarkPreviewCont.style.display = "none";
					_this.setWMFile('', 0, 0);
				};
			}
