...
$arParams["ACTION_URL"] = CHTTP::urlDeleteParams($arParams["ACTION_URL"], array("clear_cache", "thurly_include_areas", "thurly_show_mode", "back_url_admin", "bx_photo_ajax", "change_view_mode_data", "sessid", "load_comments"));
...
if (!empty($arParams["ADDITIONAL_SIGHTS"]))
{
	...
	if (empty($arParams["PICTURES_SIGHT"]) && !empty($arParams["PICTURES"]))
	{
		if ($GLOBALS["USER"]->IsAuthorized())
		{
			...
			if ($_REQUEST["PICTURES_SIGHT"] && check_thurly_sessid() && $arTemplateParams["sight"] != $_REQUEST["PICTURES_SIGHT"]):
