...
if ($_REQUEST["AJAX"] == "Y" && check_thurly_sessid())
{
	$result = array();
	$iCount = 300;
	$arFilter = array(
...
PhotoGalleryRecalc.prototype.Step = function(bContinue)
{
	...
	var url = '/thurly/components/thurly/photogallery_user/templates/.default/galleries_recalc.php';
	var res = {'IBLOCK_ID' : '<?=$arParams["IBLOCK_ID"]?>', 'AJAX' : 'Y', 'sessid' : phpVars.thurly_sessid, 'ID' : iPhotoGalleryRecalcIndex};
	if (bContinue === false)
	{
		res['start'] = 'Y';
	}
