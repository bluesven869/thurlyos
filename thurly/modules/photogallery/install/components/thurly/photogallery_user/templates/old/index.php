			...
			<td id="photo-main-td-left">
				<div id="photo-main-div-best">
					<?$element_id = $APPLICATION->IncludeComponent(
						"thurly:photogallery.detail.list",
						"simple",
						Array(
...
?>
				<?$APPLICATION->IncludeComponent("thurly:photogallery.interface", "bookmark",
					Array(
						"DATA" => array(
							array(
								"HEADER" => array(
...
ob_start();
?>
				<?$APPLICATION->IncludeComponent("thurly:search.tags.cloud", ".default",
						Array(
...
?>
			<td id="photo-main-td-middle-left">
				<?$APPLICATION->IncludeComponent("thurly:photogallery.interface",
					"bookmark",
					Array("DATA" => array(
						array(
							"HEADER" => array(
...
?>
				...
				<div id="photo-main-galleries">
					<?$APPLICATION->IncludeComponent("thurly:photogallery.gallery.list",
						"ascetic",
						Array(
							"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
							"IBLOCK_ID" => $arParams["IBLOCK_ID"],
