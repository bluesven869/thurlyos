...
$GLOBALS['APPLICATION']->AddHeadScript('/thurly/components/thurly/photogallery.section.list/templates/.default/script.js');
?>
<style>
...
<form method="post" action="<?= POST_FORM_ACTION_URI?>" name="form_photo" id="form_photo" class="photo-form">
	...
	<tr>
		...
		<?$GLOBALS["APPLICATION"]->IncludeComponent("thurly:system.field.edit",
