...
/***************** BASE ********************************************/
	...
	$arParams["ACTION_URL"] = CHTTP::urlDeleteParams(htmlspecialcharsback(POST_FORM_ACTION_URI), array("clear_cache", "thurly_include_areas", "thurly_show_mode", "back_url_admin", "bx_photo_ajax", "change_view_mode_data", "sessid"));
	$arParams["ACTION_URL"] = $arParams["ACTION_URL"].(strpos($arParams["ACTION_URL"], "?") === false ? "?" : "&")."bx_photo_ajax=Y&sessid=".thurly_sessid();
			...
			while ($res = $db_res->GetNext())
			{
				...
				if ($arParams["PERMISSION"] >= "W")
				{
					...
					$res["~DROP_LINK"] = CComponentEngine::MakePathFromTemplate($arParams["~SECTION_EDIT_URL"],
						...
						(strpos($arParams["~SECTION_EDIT_URL"], "?") === false ? "?" : "&").thurly_sessid_get()."&edit=Y";
...
$arResult["SECTION"]["~DROP_LINK"] = CComponentEngine::MakePathFromTemplate(
	...
	$arResult["SECTION"]["~DROP_LINK"] .= (strpos($arResult["SECTION"]["~DROP_LINK"], "?") === false ? "?" : "&").thurly_sessid_get()."&edit=Y";
