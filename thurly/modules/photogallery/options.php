...
if ($RIGHTS > "D"):
	...
	while($res = $db_res->Fetch())
		$arLangs[$res["LID"]] = $res;
	//*****************************************************************************************************************
	if($REQUEST_METHOD == "POST" && ($save!="" || $apply!="") && ($RIGHTS>="W") && check_thurly_sessid())
	{
		$arSights = array();
		...
		if($apply!="")
			LocalRedirect("/thurly/admin/settings.php?&lang=".LANG."&back_url=".urlencode($back_url)."&mid=photogallery");
		elseif($back_url)
			LocalRedirect($back_url);
		else
			LocalRedirect("/thurly/admin/settings.php?lang=".LANG);
	}
	//*****************************************************************************************************************
...
?>
<a href="/thurly/admin/fileman_file_upload.php?path=/thurly/modules/photogallery/fonts/"><?=GetMessage("P_UPLOAD")?></a>
</td></tr>
...
<?=str_replace(
	array(
		...
		"#FILEMAN_FILE_UPLOAD#"),
	array(
		"/thurly/admin/fileman_admin.php?site=&path=/thurly/modules/photogallery/fonts/",
		"/thurly/admin/fileman_file_upload.php?path=/thurly/modules/photogallery/fonts/"),
