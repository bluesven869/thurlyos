...
namespace Thurly\Rest\UserField;


use Thurly\Main\EventManager;
use Thurly\Rest\Api\UserFieldType;
		...
		if(static::$descriptionCache === null)
		{
			...
			foreach($placementHandlerList as $placementInfo)
			{
				static::$descriptionCache[static::getUserTypeId($placementInfo)] = array(
					...
					'CLASS_NAME' => '\Thurly\Rest\UserField\Type',
					'DESCRIPTION' => $placementInfo['TITLE'],
					'BASE_TYPE' => \CUserTypeManager::BASE_TYPE_STRING,
					'VIEW_CALLBACK' => array('\Thurly\Rest\UserField\Type', 'getPublicView'),
					'EDIT_CALLBACK' => array('\Thurly\Rest\UserField\Type', 'getPublicEdit'),
				);
			}
		}
