...
class EventTable extends Main\Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'REST_APP' => array(
				'data_type' => 'Thurly\Rest\AppTable',
			 ...
			 */
			'APP' => array(
				'data_type' => 'Thurly\ThurlyOS\AppsTable',
				'reference' => array('=this.APP_ID' => 'ref.ID'),
			),
		);
	}
	 ...
	 * @deprecated
	 *
	 * Use \Thurly\Rest\HandlerHelper::checkCallback
	 */
	public static function checkCallback($eventCallback, $appInfo, $checkInstallUrl = true)
	{
		return \Thurly\Rest\HandlerHelper::checkCallback($eventCallback, $appInfo, $checkInstallUrl);
	}
