...
namespace Thurly\Rest\Engine;

use Thurly\Main\Engine;
use Thurly\Main\Engine\Controller;
use Thurly\Main\Engine\Crawler;
use Thurly\Main\Engine\Resolver;
...
class RestManager extends \IRestService
{
	...
	{
		return \Thurly\Main\Config\Option::get('rest', 'rest_server_path', '/rest');
	}
	...
	private function registerAutoWirings(\CRestServer $restServer, $start)
	{
		...
		/** @see \Thurly\Main\UI\PageNavigation */
		Engine\Binder::registerParameter(
			'\\Thurly\\Main\\UI\\PageNavigation',
