...
use Thurly\Rest\OAuth\Auth;
use Thurly\Rest\OAuthService;
use Thurly\Rest\Sqs;
...
class Sender
{
	...
	public static function bind($moduleId, $eventName)
	{
		...
		$eventManager->registerEventHandler($moduleId, $eventName, "rest", "\\Thurly\\Rest\\Event\\Callback", $moduleId.'__'.ToUpper($eventName));
	}
	...
	{
		$eventManager = EventManager::getInstance();
		$eventManager->unRegisterEventHandler($moduleId, $eventName, "rest", "\\Thurly\\Rest\\Event\\Callback", $moduleId.'__'.ToUpper($eventName));
