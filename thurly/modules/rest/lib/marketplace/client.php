...
class Client
{
	...
	protected static $buyLinkList = array(
		'thurlyos' => '/settings/order/make.php?limit=#NUM#&module=#CODE#',
		'ru' => 'https://marketplace.1c-thurly.ru/tobasket.php?ID=#CODE#&limit=#NUM#&b24=y',
		'en' => 'https://store.thurlyos.com/tobasket.php?ID=#CODE#&limit=#NUM#&b24=y',
		'de' => 'https://store.thurlyos.de/tobasket.php?ID=#CODE#&limit=#NUM#&b24=y',
		'ua' => 'https://marketplace.1c-thurly.ua/tobasket.php?ID=#CODE#&limit=#NUM#&b24=y',
	);
	...
	public static function getBuyLink($num, $appCode)
	{
		...
		{
			$linkTpl = static::$buyLinkList['thurlyos'];
		}
		else
		{
	...
	public static function getTagByPlacement($placement)
	{
		...
		{
			if(substr($placement, 0, 4) === 'CRM_' || $placement === \Thurly\Rest\Api\UserFieldType::PLACEMENT_UF_TYPE)
			{
