...
class AppTable extends Main\Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'LANG' => array(
				'data_type' => 'Thurly\Rest\AppLangTable',
				'reference' => array(
					'=this.ID' => 'ref.APP_ID',
	...
	{
		// for compatibility purpose module_id is thurlyos here
		foreach(GetModuleEvents('thurlyos', 'OnAfterAppPaid', true) as $event)
		{
	...
	protected static function getLicenseLanguage()
	{
		if(static::$licenseLang === null)
		{
			...
			{
				static::$licenseLang = \CThurlyOS::getLicensePrefix();
			}
			else
			{
