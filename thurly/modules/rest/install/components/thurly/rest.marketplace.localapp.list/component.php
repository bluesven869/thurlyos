...
$filter = array('=STATUS' => \Thurly\Rest\AppTable::STATUS_LOCAL);

$nav = new \Thurly\Main\UI\PageNavigation("nav-app");
...
while($app = $dbApp->fetch())
{
	$data = array(
		"ID" => $app["ID"],
		"NAME" => \Thurly\Main\Text\Converter::getHtmlConverter()->encode($app["APP_NAME"]),
