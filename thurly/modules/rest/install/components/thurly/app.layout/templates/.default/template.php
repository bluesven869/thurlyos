...
?>
	<input type="hidden" name="PLACEMENT_OPTIONS" value="<?=htmlspecialcharsbx(\Thurly\Main\Web\Json::encode($arParams['~PLACEMENT_OPTIONS']))?>">
<?
endif;
?>
</form>
...
BX.rest.AppLayout.set(
	...
	'<?=$arResult['APP_SID']?>',
	{
		...
		ajaxUrl: '/thurly/components/thurly/app.layout/lazyload.ajax.php',
		controlUrl: '/thurly/tools/rest_control.php',
...
if($arParams['POPUP'] && $arParams['PLACEMENT'] === \Thurly\Rest\PlacementTable::PLACEMENT_DEFAULT):
?>
BX.rest.AppLayout.get('<?=$arResult['APP_SID']?>').denyInterface(['openApplication']);
<?
endif;
