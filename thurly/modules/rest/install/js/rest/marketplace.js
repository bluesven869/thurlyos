...
BX.rest.Marketplace = (function(){
	...
	var ajaxPath = "/thurly/tools/rest.php";
	...
	return {
		install: function(params)
		{
			...
			var popup = BX.PopupWindowManager.create("BXAppInstallPopup|" + params.url, null, {
				...
				content: '<div style="width:450px;height:230px; background: url(/thurly/js/rest/images/loader.gif) no-repeat center;"></div>',
				events: {
		...
		open: function(placementConfig, category)
		{
			...
			var url = '/marketplace/category/'+BX.util.urlencode(category)+'/';
