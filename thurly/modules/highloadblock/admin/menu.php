...
if (!\Thurly\Main\Loader::includeModule('highloadblock'))
{
	return false;
}
...
// items
$items = array();
$res = \Thurly\Highloadblock\HighloadBlockTable::getList(array(
...
{
	$rights = \Thurly\HighloadBlock\HighloadBlockRightsTable::getOperationsName(array_keys($items));
	if (!empty($rights))
	{
