 ...
 * @copyright  2001-2014 1C-Thurly
 */

namespace Thurly\Highloadblock;

use Thurly\Main,
	Thurly\Main\Application,
	Thurly\Main\DB\MssqlConnection,
	Thurly\Main\Entity;
...
class HighloadBlockTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		...
		$fieldsMap = array(
			...
			'LANG' => new Entity\ReferenceField(
				'LANG',
				'Thurly\Highloadblock\HighloadBlockLangTable',
				array('=this.ID' => 'ref.ID', 'ref.LID' => new \Thurly\Main\DB\SqlExpression('?', LANG))
			),
		);
	...
	public static function compileEntity($hlblock)
	{
		...
		/** @var \Thurly\Main\Entity\DataManager $entity_data_class */
