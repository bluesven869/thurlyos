...
class CVoteCacheManager
{
	...
	function __construct()
	{
		...
		$eventManager->addEventHandler("vote", "\\Thurly\\Vote\\Vote::OnAfterAdd", array($this, "OnVoteChange"));
		$eventManager->addEventHandler("vote", "\\Thurly\\Vote\\Vote::OnAfterUpdate", array($this, "OnVoteChange"));
		$eventManager->addEventHandler("vote", "\\Thurly\\Vote\\Vote::OnAfterDelete", array($this, "OnVoteChange"));
	...
	function OnVoteChange(\Thurly\Main\Entity\Event $event)
	{
