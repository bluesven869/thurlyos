...
require_once ($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/admin_tools.php");
require_once ($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/main/filter_tools.php");
require_once ($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/vote/vote_tools.php");
require_once ($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/vote/classes/".strtolower($DB->type)."/channel.php");
...
CModule::AddAutoloadClasses("vote", array(
	...
	"thurly\\vote\\answertable" => "lib/answer.php",
	"thurly\\vote\\answer" => "lib/answer.php",
	"thurly\\vote\\attachtable" => "lib/attach.php",
	"thurly\\vote\\attach" => "lib/attach.php",
	"thurly\\vote\\attachment\\attach" => "lib/attachment/attach.php",
	"thurly\\vote\\attachment\\blogpostconnector" => "lib/attachment/blogpostconnector.php",
	"thurly\\vote\\attachment\\connector" => "lib/attachment/connector.php",
	"thurly\\vote\\attachment\\controller" => "lib/attachment/controller.php",
	"thurly\\vote\\attachment\\defaultconnector" => "lib/attachment/defaultconnector.php",
	"thurly\\vote\\attachment\\forummessageconnector" => "lib/attachment/forummessageconnector.php",
	"thurly\\vote\\base\\baseobject" => "lib/base/baseobject.php",
	"thurly\\vote\\base\\controller" => "lib/base/controller.php",
	"thurly\\vote\\base\\diag" => "lib/base/diag.php",
	"thurly\\vote\\channeltable" => "lib/channel.php",
	"thurly\\vote\\channelgrouptable" => "lib/channel.php",
	"thurly\\vote\\channelsitetable" => "lib/channel.php",
	"thurly\\vote\\channel" => "lib/channel.php",
	"thurly\\vote\\dbresult" => "lib/dbresult.php",
	"thurly\\vote\\voteeventtable" => "lib/event.php",
	"thurly\\vote\\eventtable" => "lib/event.php",
	"thurly\\vote\\eventquestiontable" => "lib/event.php",
	"thurly\\vote\\eventanswertable" => "lib/event.php",
	"thurly\\vote\\event" => "lib/event.php",
	"thurly\\vote\\questiontable" => "lib/question.php",
	"thurly\\vote\\question" => "lib/question.php",
	"thurly\\vote\\uf\\manager" => "lib/uf/manager.php",
	"thurly\\vote\\uf\\voteusertype" => "lib/uf/voteusertype.php",
	"thurly\\vote\\usertable" => "lib/user.php",
	"thurly\\vote\\voteeventquestiontable" => "lib/user.php",
	"thurly\\vote\\voteeventanswertable" => "lib/user.php",
	"thurly\\vote\\voteeventanswer" => "lib/user.php",
	"thurly\\vote\\user" => "lib/user.php",
	"thurly\\vote\\votetable" => "lib/vote.php",
	"thurly\\vote\\vote" => "lib/vote.php"
));
