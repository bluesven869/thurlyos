...
$context = new CAdminContextMenu(array(
	array(
		...
		"LINK"	=> ($vote->canEdit($USER->GetID()) ? "/thurly/admin/vote_edit.php?lang=".LANGUAGE_ID."&ID=".$voteId : "/thurly/admin/vote_preview.php?lang=".LANGUAGE_ID."&VOTE_ID=".$voteId),
		"ICON" => "btn_list"
	),
	array(
		"TEXT"	=> GetMessage("VOTE_VIEW_RESULTS"),
		"LINK"	=> "/thurly/admin/vote_results.php?lang=".LANGUAGE_ID."&VOTE_ID=".$voteId,
	))
);
$context->Show();
