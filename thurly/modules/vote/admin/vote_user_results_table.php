...
if ($VOTE_RIGHT=="W" && $request->getRequestMethod() == "GET" && (strlen($request->getQuery("save")) > 0 || strlen($request->getQuery("apply")) > 0) && check_thurly_sessid())
{
...
$context = new CAdminContextMenu(array(
	array(
		...
		"LINK"	=> "/thurly/admin/vote_user_votes_table.php?lang=".LANGUAGE_ID."&VOTE_ID=".$VOTE_ID,
		"ICON" => "btn_list"
	)
));
$context->Show();
