...
HTML;
	...
	$row->AddActions(array(
		...
		array("ICON"=>"delete", "TEXT"=>GetMessage("MAIN_ADMIN_MENU_DELETE"), "ACTION"=>"if(confirm('".GetMessage("VOTE_CONFIRM_DEL_QUESTION")."')) window.location='vote_question_list.php?lang=".LANGUAGE_ID."&VOTE_ID=$voteId&action=delete&ID=$f_ID&".thurly_sessid_get()."'")
	));
}
...
<?
$oFilter->Buttons(array("table_id"=>$sTableID, "url"=>"/thurly/admin/vote_question_list.php?lang=".LANGUAGE_ID."&VOTE_ID=$voteId", "form"=>"form1"));
$oFilter->End();
?>
</form>
<?
