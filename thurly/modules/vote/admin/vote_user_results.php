...
if ($REQUEST_METHOD=="GET" && (strlen($save)>0 || $apply)&& $VOTE_RIGHT=="W" && $EVENT_ID>0 && check_thurly_sessid())
{
...
$aMenu = array(
	array(
		...
		"LINK"	=> "/thurly/admin/vote_user_votes.php?lang=".LANGUAGE_ID
	)
);
...
********************************************************************/
		...
		?><font class="h2"><b><?echo $arVote["TITLE"];?></b></font><br><img src="/thurly/images/1.gif" width="1" height="6" border=0 alt=""><?
		endif;
