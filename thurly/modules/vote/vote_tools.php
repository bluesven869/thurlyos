...
{
	return \Thurly\Vote\User::getCurrent()->isVotedFor($voteId);
}
			...
			if ($APPLICATION->GetShowIncludeAreas())
			{
				...
				if (CModule::IncludeModule("fileman"))
				{
					$arIcons[] = Array(
								...
								"SRC" => "/thurly/images/vote/panel/edit_template.gif",
					...
					$arIcons[] = Array(
								...
								"SRC" => "/thurly/images/vote/panel/edit_file.gif",
								"ALT" => GetMessage("VOTE_PUBLIC_ICON_HANDLER")
							);
				}
				$arIcons[] = Array(
							"URL" => "/thurly/admin/vote_edit.php?lang=".LANGUAGE_ID."&ID=".$VOTE_ID,
							"SRC" => "/thurly/images/vote/panel/edit_vote.gif",
