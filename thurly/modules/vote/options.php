...
if ($VOTE_RIGHT>="R")
{
	...
	if ($REQUEST_METHOD=="GET" && $VOTE_RIGHT=="W" && strlen($RestoreDefaults)>0 && check_thurly_sessid())
	{
	...
	if($REQUEST_METHOD=="POST" && strlen($Update)>0 && $VOTE_RIGHT=="W" && check_thurly_sessid())
	{
