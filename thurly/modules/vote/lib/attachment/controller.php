...
use Thurly\Vote\EventTable;
use Thurly\Vote\User;


Loc::loadMessages(__FILE__);

class Controller extends \Thurly\Vote\Base\Controller
{
	/**
	 * @var $attach Attach
	 */
	...
	protected static function getVoted(array $cacheParams, array $pageParams)
	{
		...
		if(\Thurly\Main\Config\Option::get("main", "component_cache_on", "Y") == "Y" && $cache->initCache($cacheTtl, $cacheId, $cacheDir))
		{
