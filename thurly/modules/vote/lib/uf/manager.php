...
use Thurly\Vote\Attachment\DefaultConnector;
use Thurly\Vote\Attachment\BlogPostConnector;
use Thurly\Vote\Attachment\ForumMessageConnector;
	...
	public function loadFromVoteId($id)
	{
		...
		if(!isset($this->loadedAttachedObjects[$id1]))
		{
			...
			$attach = Attach::loadFromVoteId(array(
				"ENTITY_ID" => ($this->params["ENTITY_VALUE_ID"] ?: $this->params["VALUE_ID"]), // http://hg.office.thurly.ru/repos/modules/rev/b614a075ce64
