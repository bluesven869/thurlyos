...
class ChannelTable extends Entity\DataManager
{
	...
	public static function getMap()
	{
		return array(
			...
			'PERMISSION' => array(
				'data_type' => '\Thurly\Vote\ChannelGroupTable',
				'reference' => array(
			...
			'SITE' => array(
				'data_type' => '\Thurly\Vote\ChannelSiteTable',
				'reference' => array(
					'=this.ID' => 'ref.CHANNEL_ID',
				),
				'join_type' => 'LEFT',
...
class Channel extends BaseObject implements \ArrayAccess
{
	...
	public function init()
	{
		if (($data = self::getById($this->id)->fetch()) && !empty($data))
			...
			throw new \Thurly\Main\ObjectNotFoundException(GetMessage("V_CHANNEL_IS_NOT_FOUND", "channel is not found"));
	}
	/**
	 * @param array $parameters Array of query parameters.
	 * @return \Thurly\Main\DB\Result|\CDBResult
	 * @throws \Thurly\Main\ArgumentException
	 */
