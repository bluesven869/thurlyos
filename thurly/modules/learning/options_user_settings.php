...
<?endif?>
	...
	<tr valign="top">
		<td align="right"></td>
		<td>
			<a href="/thurly/admin/learn_certification_admin.php?lang=<?=LANG?>&amp;filter_user=<?=$ID?>&amp;set_filter=Y"><?=GetMessage("learning_CERTIFICATION")?></a><br />
			<a href="/thurly/admin/learn_gradebook_admin.php?lang=<?=LANG?>&amp;filter_user=<?=$ID?>&amp;set_filter=Y"><?=GetMessage("learning_GRADEBOOK")?></a>
		</td>
	</tr>
<?endif;?>