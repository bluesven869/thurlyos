...
Class learning extends CModule
{
	...
	function InstallDB($arParams = array())
	{
		...
		{
			$this->errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/db/".strtolower($DB->type)."/install.sql");
	...
	function UnInstallDB($arParams = array())
	{
		...
		{
			$this->errors = $DB->RunSQLBatch($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/db/".strtolower($DB->type)."/uninstall.sql");
	...
	function InstallEvents()
	{
		...
		if($ar["C"] <= 0)
		{
			include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/events/set_events.php");
		}
		return true;
	}
	...
	{
		global $DB;
		include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/events/del_events.php");
		return true;
	}
	...
	function InstallFiles($arParams = array())
	{
		...
		{
			//Admin files
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin", false);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/images", $_SERVER["DOCUMENT_ROOT"]."/thurly/images/learning", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/public/js", $_SERVER["DOCUMENT_ROOT"]."/thurly/js", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/js", $_SERVER["DOCUMENT_ROOT"]."/thurly/js", true, true);

			//Theme
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/themes", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/components", $_SERVER["DOCUMENT_ROOT"]."/thurly/components", True, True);
		}
		//copy public scripts
		$arSITE_ID = Array();
		$sites = CLang::GetList($by, $order, Array("ACTIVE"=>"Y"));
		while($site = $sites->Fetch())
		{
			if($_REQUEST["copy_".$site["LID"]] == "Y" && !empty($_REQUEST["path_".$site["LID"]]))
			{
				...
				CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/public/site/$ldir/", $DOC_ROOT.$_REQUEST["path_".$site["LID"]], true,true);
			}
		}
		
		if (!file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/templates/learning/"))
		{
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/public/template/", $_SERVER["DOCUMENT_ROOT"]."/thurly/templates/learning/", true, true);
		}
		...
		if(!empty($arSITE_ID))
		{
			...
			//Copy Template
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/public/template/", $_SERVER["DOCUMENT_ROOT"]."/thurly/templates/".$_REQUEST["template_id"]."/", true, true);
	...
	{
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/admin/", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/themes/.default/", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes/.default");//css
		DeleteDirFilesEx("/thurly/themes/.default/icons/learning/");//icons
		DeleteDirFilesEx("/thurly/images/learning/");//images
		DeleteDirFilesEx("/thurly/js/learning/");//scripts
		return true;
	}
	...
	function DoInstall()
	{
		...
		if($step < 2)
		{
			$APPLICATION->IncludeAdminFile(GetMessage("LEARNING_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/step1.php");
		}
		elseif($step==2)
		{
			$this->InstallFiles();
			...
			$APPLICATION->IncludeAdminFile(GetMessage("LEARNING_INSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/step2.php");
		}
	}
	...
	function DoUninstall()
	{
		...
		if($step < 2)
		{
			$APPLICATION->IncludeAdminFile(GetMessage("LEARNING_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/unstep1.php");
		}
		elseif($step == 2)
		{
			...
			$GLOBALS["errors"] = $this->errors;
			$APPLICATION->IncludeAdminFile(GetMessage("LEARNING_UNINSTALL_TITLE"), $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/install/unstep2.php");
		}
	}
