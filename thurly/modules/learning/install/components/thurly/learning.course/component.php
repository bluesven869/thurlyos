...
if ($contextLessonId > 0)
{
	if (CLearnAccessMacroses::CanUserAddLessonToParentLesson(array('parent_lesson_id' => $contextLessonId)))
	{
		$arMenuButtons[] = array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/learn_unilesson_edit.php?lang=" . LANGUAGE_ID
	...
	if (CLearnAccessMacroses::CanUserEditLesson(array('lesson_id' => $contextLessonId)))
	{
		$arMenuButtons[] = array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/learn_test_edit.php?lang=" . LANGUAGE_ID
						. "&COURSE_ID=".$arParams["COURSE_ID"]
	...
	if (CLearnAccessMacroses::CanUserAddLessonWithoutParentLesson())
	{
		$arMenuButtons[] = array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/learn_course_edit.php?lang=" . LANGUAGE_ID
						. "&bxpublic=Y&from_module=learning&return_url="
	...
	if (CLearnAccessMacroses::CanUserEditLesson(array('lesson_id' => $contextLessonId)))
	{
		$arMenuButtons[] = array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/learn_question_edit.php?lang=" . LANGUAGE_ID
						. "&COURSE_ID=" . $arParams["COURSE_ID"]
