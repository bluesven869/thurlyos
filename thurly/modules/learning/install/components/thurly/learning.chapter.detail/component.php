	...
	$arAreaButtons = array(
		array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/learn_unilesson_edit.php"
						. "?LESSON_ID=" . $arParams["CHAPTER_ID"]
						. '&' . $strUrlencodedLessonPath
						. "&lang=" . LANGUAGE_ID 
						. "&COURSE_ID=" . $arParams["COURSE_ID"]
		...
		array(
			...
			"URL" => "javascript:if(confirm('".GetMessage("LEARNING_COURSES_CHAPTER_DELETE_CONF")."'))jsUtils.Redirect([], '".CUtil::JSEscape("/thurly/admin/learn_unilesson_admin.php?ID=" . $arParams["CHAPTER_ID"] . "&action=delete&lang=".LANGUAGE_ID."&".thurly_sessid_get()."&COURSE_ID=".$arParams["COURSE_ID"]).(strlen($deleteReturnUrl) ? "&return_url=".urlencode($deleteReturnUrl) : "")."')",
