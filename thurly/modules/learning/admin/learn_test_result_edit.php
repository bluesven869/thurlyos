	...
	else
	{
		...
		if(strlen($apply)<=0)
		{
			if(strlen($return_url)>0)
				...
				LocalRedirect("/thurly/admin/learn_test_result_admin.php?lang=".LANG."&ATTEMPT_ID=".$ATTEMPT_ID.GetFilterParams("filter_", false));
		}
		LocalRedirect("/thurly/admin/learn_test_result_edit.php?lang=".LANG."&ID=".$ID."&ATTEMPT_ID=".$ATTEMPT_ID.GetFilterParams("filter_", false));
	}
}
