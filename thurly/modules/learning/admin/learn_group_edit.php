...
$APPLICATION->AddHeadScript('/thurly/js/learning/learning_edit.js');

require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/learning/admin_tools_user_selector.php");
	...
	else
	{
		...
		if(strlen($apply)<=0)
		{
			if(strlen($return_url)>0)
				...
				LocalRedirect("/thurly/admin/learn_group_admin.php?lang=".LANG.GetFilterParams("filter_", false));
		}

		LocalRedirect("/thurly/admin/learn_group_edit.php?lang=".LANG."&ID=".$ID.GetFilterParams("filter_", false));
	}
}
			...
			<div style="padding:0px;">
				...
				if ($ID == 0)
				{
					...
					(<a href="javascript:void(0);" class="bx-action-href"
						onclick="window.open('/thurly/admin/learn_unilesson_admin.php?lang=<?php echo LANGUAGE_ID;
