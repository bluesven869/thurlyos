...
$APPLICATION->AddHeadScript('/thurly/js/learning/rights_edit.js');
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && strlen($Update)>0 && check_thurly_sessid())
{
	...
	if ( ! $was_errors )
	{
		...
		if (strlen($apply) <= 0)
		{
			...
			else
			{
				...
				LocalRedirect(
					"/thurly/admin/learn_unilesson_admin.php?lang=".LANG.
		...
		LocalRedirect("/thurly/admin/learn_unilesson_edit.php?lang=" . LANG 
...
$tabControl->Buttons(
	array(
		...
		"back_url" => "/thurly/admin/learn_unilesson_admin.php?lang=". LANG
			. $uriParentLessonPath
			. GetFilterParams("filter_", false)
		)
	);
