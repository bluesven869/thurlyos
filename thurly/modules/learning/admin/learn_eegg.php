<?php
require_once($_SERVER['DOCUMENT_ROOT'] . '/thurly/modules/main/include/prolog_admin_before.php');	// first system's prolog
require_once($_SERVER['DOCUMENT_ROOT'] . '/thurly/modules/learning/prolog.php');	// init module
require_once($_SERVER['DOCUMENT_ROOT'] . '/thurly/modules/learning/include.php');	// module's prolog
...
try
{
	...
	if (isset($_REQUEST['return_url']) && (strlen($_REQUEST['return_url']) > 0) && check_thurly_sessid())
