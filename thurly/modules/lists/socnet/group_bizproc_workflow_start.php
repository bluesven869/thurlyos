...
include($_SERVER["DOCUMENT_ROOT"]."/thurly/components/thurly/socialnetwork_group/templates/.default/util_group_menu.php");
include($_SERVER["DOCUMENT_ROOT"]."/thurly/components/thurly/socialnetwork_group/templates/.default/util_group_profile.php");
?>
<?$APPLICATION->IncludeComponent("thurly:lists.element.navchain", ".default", array(
...
<?$APPLICATION->IncludeComponent("thurly:bizproc.workflow.start", ".default", array(
	"MODULE_ID" => "lists",
