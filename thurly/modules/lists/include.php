...
CModule::AddAutoloadClasses(
	...
	array(
		...
		"thurly\\lists\\importer" => "lib/importer.php",
		"thurly\\lists\\bizprocdocumentlists" => "lib/bizprocdocumentlists.php",
	)
);

CJSCore::RegisterExt('lists', array(
	'js' => '/thurly/js/lists/js/lists.js',
	'css' => '/thurly/js/lists/css/lists.css',
