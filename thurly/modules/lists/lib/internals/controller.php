...
namespace Thurly\Lists\Internals;

use Thurly\Lists\Internals\Error\Error;
use Thurly\Lists\Internals\Error\ErrorCollection;
use Thurly\Lists\Internals\Error\IErrorable;
...
abstract class Controller implements IErrorable
{
	...
	protected function checkAction()
	{
		...
		if($description['check_csrf_token'] === true || ($this->request->isPost() && !isset($description['check_csrf_token'])))
		{
			...
			if(!check_thurly_sessid() && !check_thurly_sessid('token_sid'))
			{
