...
*/
	...
	function OnParseSocNetComponentPath(&$arUrlTemplates, &$arCustomPagesPath, $arParams)
	{
		...
		if(!$base_path)
		{
			if(file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/php_interface/lists/".SITE_ID."/group_lists.php"))
				$base_path = "/thurly/php_interface/lists/".SITE_ID."/";
			elseif(file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/php_interface/lists/group_lists.php"))
				$base_path = "/thurly/php_interface/lists/";
			else
				$base_path = "/thurly/modules/lists/socnet/";
		}
