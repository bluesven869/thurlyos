...
{
	Thurly\Main\Localization\Loc::loadMessages($_SERVER["DOCUMENT_ROOT"].'/thurly/components/thurly/lists.file/component.php');

	if (!Thurly\Main\Loader::includeModule('lists'))
