...
class ListsSelectElementComponent extends CThurlyComponent
{
	...
	protected function getIblockData()
	{
		...
		while($list = $lists->fetch())
		{
			if(CLists::getLiveFeed($list['ID']))
			{
				...
				{
					$this->arResult['LIST_DATA']['PICTURE'] = "<img src=\"/thurly/images/lists/default.png\" width=\"36\" height=\"30\" border=\"0\" />";
					$this->arResult['LIST_DATA']['PICTURE_SMALL'] = "<img src=\"/thurly/images/lists/default.png\" width=\"19\" height=\"16\" border=\"0\" />";
				}
			}
		}
	}
