...
class ListExportExcelComponent extends CThurlyComponent
{
	protected $listsPerm;
	...
	protected function createDataExcel()
	{
		...
		foreach ($arListFields as $fieldId => $arField)
		{
			...
			$preparedField = Thurly\Lists\Field::prepareFieldDataForFilter($arField);
		...
		while($obElement = $rsElements->GetNextElement())
		{
			...
			foreach($this->arResult["FIELDS"] as $fieldId => $field)
			{
				...
				$data[$fieldId] = \Thurly\Lists\Field::renderField($field);
			}
