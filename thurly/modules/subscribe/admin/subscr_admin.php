...
while($arRes = $rsData->NavNext(true, "f_")):
	...
	if($f_USER_ID > 0)
		$strUser = "[<a class='tablebodylink' href=\"/thurly/admin/user_edit.php?ID=".$f_USER_ID."&amp;lang=".LANG."\" title=\"".GetMessage("subscr_user_edit_title")."\">".$f_USER_ID."</a>] (".$f_USER_LOGIN.") ".$f_USER_NAME." ".$f_USER_LAST_NAME;
	else
