		...
		if ($zr=$z->Fetch())
		{
			...
			if ($F_RIGHT>=20 || ($F_RIGHT>=15 && $arrResult["USER_ID"]==$USER->GetID()))
			{
				...
				if (in_array("EDIT",$arrRESULT_PERMISSION)) // имеем право на просмотр
				{
					...
					IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/form/include.php");
					...
					if ($APPLICATION->GetShowIncludeAreas())
					{
						...
						if (CModule::IncludeModule("fileman"))
						{
							$arIcons[] =
									Array(						
										"URL" => "/thurly/admin/fileman_file_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&full_src=Y&path=". urlencode($path.$template),
										"SRC" => "/thurly/images/form/panel/edit_template.gif",
										"ALT" => GetMessage("FORM_PUBLIC_ICON_TEMPLATE")
									);
							$arrUrl = parse_url($_SERVER["REQUEST_URI"]);
							$arIcons[] =
									Array(						
										"URL" => "/thurly/admin/fileman_file_edit.php?lang=".LANGUAGE_ID."&site=".SITE_ID."&full_src=Y&path=". urlencode($arrUrl["path"]),
										"SRC" => "/thurly/images/form/panel/edit_file.gif",
										"ALT" => GetMessage("FORM_PUBLIC_ICON_HANDLER")
									);
						}
						$arIcons[] =
								Array(						
									"URL" => "/thurly/admin/form_edit.php?lang=".LANGUAGE_ID."&ID=".$WEB_FORM_ID,
									"SRC" => "/thurly/images/form/panel/edit_form.gif",
