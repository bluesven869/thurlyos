...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/form/errors.php");
...
CModule::AddAutoloadClasses(
	...
	array(
		...
		"Thurly\\Form\\SenderEventHandler" => "lib/senderconnector.php",
		"Thurly\\Form\\SenderConnectorForm" => "lib/senderconnector.php",
	)
);
...
$path = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/form/validators";
$handle = opendir($path);
if ($handle)
{
