...
$MESS["FORM_FILTER_ANSWER_TEXT"] = "the filter field is used to filter values in square brackets,<br>value of the <a title='See where this parameter is used' class='smalltextlink' href='/thurly/admin/form_field_edit.php?lang=en&WEB_FORM_ID=#FORM_ID#&additional=N#param'>parameter</a> [ <font class=\"pointed\">ANSWER_TEXT</font> ] is printed in square brackets.";
$MESS["FORM_FILTER_ANSWER_VALUE"] = "the filter field is used to filter values in round brackets,<br>value of the <a title='See where this parameter is used' class='smalltextlink' href='/thurly/admin/form_field_edit.php?lang=en&WEB_FORM_ID=#FORM_ID#&additional=N#param'>parameter</a> [ <font class=\"required\">ANSWER_VALUE</font> ] is printed in round brackets.";
