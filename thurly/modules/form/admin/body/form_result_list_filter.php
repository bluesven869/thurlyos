...
<?if ($F_RIGHT>=25) : ?>
<tr>
	<td valign="center" nowrap colspan="2" class="selectedbody"><img src="/thurly/images/1.gif" width="1" height="7" border=0 alt=""><br><font class="tableheadtext"><b>&nbsp;<?=GetMessage("FORM_ENTERED_BY_GUEST")?></b></font><br><img src="/thurly/images/1.gif" width="1" height="7" border=0 alt=""><br></td>
</tr>
<?endif;?>
<?
endif;
