...
if (intval($copy_id)>0 && $F_RIGHT >= 30 && check_thurly_sessid())
{
...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if ($F_RIGHT>=30)
	{
		$arActions[] = array(
			...
			"ACTION"=>$lAdmin->ActionRedirect("form_field_list.php?copy_id=$f_ID&lang=".LANGUAGE_ID."&WEB_FORM_ID=$WEB_FORM_ID&additional=$additional&".thurly_sessid_get()),
