...
if ($copy_id > 0 && $F_RIGHT >= 30 && check_thurly_sessid())
{
...
if ((strlen($_REQUEST['save']) > 0 || strlen($_REQUEST['apply']) > 0) && $_SERVER['REQUEST_METHOD']=="POST" && $F_RIGHT>=30 && check_thurly_sessid())
{
...
if ($additional!="Y")
{
	$aMenu[] = array(
		...
		"LINK"			=> "/thurly/admin/form_field_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID,
		"TEXT_PARAM"	=> " [<a title=".GetMessage("FORM_ADD_QUESTION")."  href='/thurly/admin/form_field_edit.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."'>+</a>]",
...
else
{
	$aMenu[] = array(
		...
		"LINK"			=> "/thurly/admin/form_field_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."&additional=Y",
		"TEXT_PARAM"	=> " [<a title=".GetMessage("FORM_ADD_FIELD")."  href='/thurly/admin/form_field_edit.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."&additional=Y'>+</a>]",
...
if ($F_RIGHT>=30 && $ID>0)
{
	...
	if ($additional=="Y")
	{
		...
		$aMenu[] = array(
			...
			"LINK"	=> "form_field_edit.php?ID=".$ID."&amp;copy_id=".$ID."&lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID. "&additional=Y&".thurly_sessid_get()
			);
		...
		$aMenu[] = array(
			...
			"LINK"	=> "javascript:if(confirm('".GetMessage("FORM_CONFIRM_DELETE_FIELD")."'))window.location='form_field_list.php?action=delete&ID=".$ID."&WEB_FORM_ID=".$WEB_FORM_ID."&".thurly_sessid_get()."&lang=".LANGUAGE_ID."&additional=Y';",
			);
	}
	else
	{
		...
		$aMenu[] = array(
			...
			"LINK"	=> "form_field_edit.php?ID=".$ID."&amp;copy_id=".$ID."&lang=".LANGUAGE_ID. "&WEB_FORM_ID=".$WEB_FORM_ID."&".thurly_sessid_get()
			);
		...
		$aMenu[] = array(
			...
			"LINK"	=> "javascript:if(confirm('".GetMessage("FORM_CONFIRM_DELETE_QUESTION")."'))window.location='form_field_list.php?action=delete&ID=".$ID."&WEB_FORM_ID=".$WEB_FORM_ID."&".thurly_sessid_get()."&lang=".LANGUAGE_ID."';",
			"WARNING"=>"Y"
			);
	}
...
$aMenu[] = array(
	...
	"LINK"			=> "/thurly/admin/form_status_list.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID,
	"TEXT_PARAM"	=> " [<a title=".GetMessage("FORM_ADD_STATUS")."  href='/thurly/admin/form_status_edit.php?lang=".LANGUAGE_ID."&WEB_FORM_ID=".$WEB_FORM_ID."'>+</a>]",
...
\Thurly\Main\Localization\Loc::loadMessages(dirname(__FILE__).'/../form_validator_props.php');
?>
	</script>
	<script>
var _global_BX_UTF = <?if (defined('BX_UTF') && BX_UTF === true):?>true<?else:?>false<?endif?>;
	</script>
	<script src="/thurly/js/form/form_validators.js?<?=@filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/js/form/form_validators.js')?>"></script>
	<script language="JavaScript">
BX.message({
...
?>
	...
	?>
	<tr>
		<td><?echo GetMessage("FORM_FILTER_FOR_USER")?><br><img src="/thurly/images/form/mouse.gif" width="44" height="21" border=0 alt="" /></td>
		<td><?
	...
	<tr>
		<td><?echo GetMessage("FORM_FILTER_FOR_ANSWER_TEXT")?><br><img src="/thurly/images/form/mouse.gif" width="44" height="21" border=0 alt=""></td>
		<td><?
	...
	<tr>
		<td><?echo GetMessage("FORM_FILTER_FOR_ANSWER_VALUE")?><br><img src="/thurly/images/form/mouse.gif" width="44" height="21" border=0 alt=""></td>
		<td><?
	...
	?>
	<tr>
		<td><?echo GetMessage("FORM_FILTER_TYPE")?>:<br><img src="/thurly/images/form/mouse.gif" width="44" height="21" border=0 alt="" /></td>
		<td><?
