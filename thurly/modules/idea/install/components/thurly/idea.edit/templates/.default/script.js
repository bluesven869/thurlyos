;(function(window){
	...
	BX.Idea.onEditorInitedBefore = function(editor)
	{
		...
		var cutCss = "\nimg.bxed-cut{background: transparent url('/thurly/images/blog/editor/cut_image.gif') left top repeat-x; margin: 2px; width: 100%; height: 12px;}\n";
		...
		editor.AddButton({
			...
			src : '/thurly/images/blog/editor/cut_button.png',
			toolbarSort : 205,
			handler : function()
			{
				var
