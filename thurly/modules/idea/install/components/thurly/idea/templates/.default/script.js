;(function(window){
	...
	window["JSPublicIdea"] = {
		...
		{
			BX.ajax({
				url: this.RequestURL + '?AJAX=IDEA&ACTION=GET_STATUS_LIST&sessid='+BX.thurly_sessid(),
				method: 'GET',
				dataType: 'json',
				processData: true,
		...
		{
			BX.ajax({
				url: this.RequestURL + '?AJAX=IDEA&ACTION=SET_STATUS&IDEA_ID=' + IdeaId + '&STATUS_ID=' + StatusId + '&sessid=' + BX.thurly_sessid(),
				method: 'GET',
				dataType: 'json',
				processData: true,
				onsuccess: function(data){
		...
		{
			BX.ajax({
				url: this.RequestURL + '?AJAX=IDEA&ACTION=SUBSCRIBE&IDEA_ID=' + IdeaId + '&sessid=' + BX.thurly_sessid(),
				method: 'GET',
				dataType: 'json',
				processData: true,
				onsuccess: function(data){
		...
		{
			BX.ajax({
				url: this.RequestURL + '?AJAX=IDEA&ACTION=UNSUBSCRIBE&IDEA_ID=' + IdeaId + '&sessid=' + BX.thurly_sessid(),
				method: 'GET',
				dataType: 'json',
				processData: true,
				onsuccess: function(data){
