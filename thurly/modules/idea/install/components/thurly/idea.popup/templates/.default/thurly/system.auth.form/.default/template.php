...
<?if ($arResult["CAPTCHA_CODE"]):?>
		<tr>
			...
			<img src="/thurly/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" /><br /><br />
...
<?
$APPLICATION->IncludeComponent("thurly:socserv.auth.form", "icons", 
	array(
