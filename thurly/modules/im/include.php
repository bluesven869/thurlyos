...
CModule::AddAutoloadClasses(
	...
	array(
		...
		"\\Thurly\\Im\\ChatTable" => "lib/model/chat.php",
		"\\Thurly\\Im\\MessageTable" => "lib/model/message.php",
		"\\Thurly\\Im\\MessageParamTable" => "lib/model/messageparam.php",
		"\\Thurly\\Im\\RecentTable" => "lib/model/recent.php",
		"\\Thurly\\Im\\RelationTable" => "lib/model/relation.php",
		"\\Thurly\\Im\\StatusTable" => "lib/model/status.php",
	)
);
...
CJSCore::RegisterExt('im_common', array(
	'js' => '/thurly/js/im/common.js',
	'css' => '/thurly/js/im/css/common.css',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_common.php',
	'rel' => array('ls', 'ajax', 'date', 'fx', 'user', 'restclient', 'phone_number')
));

CJSCore::RegisterExt('im_phone_call_view', array(
	'js' => '/thurly/js/im/phone_call_view.js',
	'css' => array('/thurly/js/im/css/phone_call_view.css', '/thurly/components/thurly/crm.card.show/templates/.default/style.css'),
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_phone_call_view.php',
	'rel' => array('applayout', 'crm_form_loader')
));

CJSCore::RegisterExt('im_web', array(
	'js' => '/thurly/js/im/im.js',
	'css' => '/thurly/js/im/css/im.css',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_im.php',
	'rel' => $jsCoreRel
));
...
CJSCore::RegisterExt('im_mobile', array(
	'js' => '/thurly/js/im/mobile.js',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_mobile.php',
	'rel' => $jsCoreRelMobile
));

CJSCore::RegisterExt('im_mobile_dialog', array(
	'js' => '/thurly/js/im/mobile_dialog.js',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_mobile.php',
	'rel' => $jsCoreRelMobile
));

CJSCore::RegisterExt('im_window', array(
	'js' => '/thurly/js/im/window.js',
	'css' => '/thurly/js/im/css/window.css',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_window.php',
	'rel' => Array('popup', 'fx', 'json', 'translit'),
));

CJSCore::RegisterExt('meetecho_janus', array(
	'js' => '/thurly/js/im/webrtc/janus.js'
));

CJSCore::RegisterExt('im_call', array(
	'js' => '/thurly/js/im/call.js',
	'css' => '/thurly/js/im/css/call.css',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_call.php',
	'rel' => Array('webrtc_adapter', 'meetecho_janus')
));

CJSCore::RegisterExt('im_desktop', array(
	'js' => '/thurly/js/im/desktop.js',
	'lang' => '/thurly/modules/im/lang/'.LANGUAGE_ID.'/js_desktop.php',
	'rel' => array('im_page', 'im_call'),
));

$GLOBALS["APPLICATION"]->AddJSKernelInfo('im', array('/thurly/js/im/common.js', '/thurly/js/im/window.js', '/thurly/js/im/im.js'));
$GLOBALS["APPLICATION"]->AddCSSKernelInfo('im', array('/thurly/js/im/css/common.css', '/thurly/js/im/css/window.css', '/thurly/js/im/css/im.css'));
?>