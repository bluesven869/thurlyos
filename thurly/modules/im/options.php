<?php
global $MESS;
include(GetLangFileName($GLOBALS['DOCUMENT_ROOT'].'/thurly/modules/im/lang/', '/options.php'));
...
if(strlen($_POST['Update'].$_GET['RestoreDefaults'])>0 && check_thurly_sessid() && $MOD_RIGHT >= 'W')
{
