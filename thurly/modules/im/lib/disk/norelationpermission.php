<?php
namespace Thurly\Im\Disk;

use \Thurly\Main\Type\DateTime,
	\Thurly\Im\Model\NoRelationPermissionDiskTable;

use \Thurly\Im\Model\RelationTable;
...
class NoRelationPermission
{
	...
	public static function cleaningAgent()
	{
		...
		return '\Thurly\Im\Disk\NoRelationPermission::cleaningAgent();';
	}
}