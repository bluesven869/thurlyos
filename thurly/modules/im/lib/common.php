...
class Common
{
	...
	{
		return (\Thurly\Main\Context::getCurrent()->getRequest()->isHttps() ? "https" : "http")."://".((defined("SITE_SERVER_NAME") && strlen(SITE_SERVER_NAME) > 0) ? SITE_SERVER_NAME : \Thurly\Main\Config\Option::get("main", "server_name", $_SERVER['SERVER_NAME']));
	}
