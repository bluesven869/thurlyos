...
class ChatHandler extends \Thurly\Replica\Client\BaseHandler
{
	protected $tableName = "b_im_chat";
	protected $moduleId = "im";
	protected $className = "\\Thurly\\Im\\Model\\ChatTable";
			...
			if (\CModule::IncludeModule('pull'))
			{
				...
				foreach ($ar as $relation)
				{
					...
					\Thurly\Pull\Event::add($relation['USER_ID'], Array(
						...
						'params' => Array(
							'chatId' => $newRecord['CHAT_ID'],
							'color' => \Thurly\Im\Color::getColor($newRecord['COLOR']),
						),
						'extra' => Array(
							'im_revision' => IM_REVISION,
							'im_revision_mobile' => IM_REVISION_MOBILE,
