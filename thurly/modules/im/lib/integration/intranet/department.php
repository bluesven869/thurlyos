<?php
namespace Thurly\Im\Integration\Intranet;
...
class Department
{
	...
	{
		return \Thurly\Main\Loader::includeModule('intranet') && \Thurly\Main\Loader::includeModule("iblock") && \Thurly\Main\Loader::includeModule("socialnetwork");
	}
	...
	public static function getList()
	{
		...
		if (\Thurly\Im\User::getInstance()->isExtranet())
			return Array();

		$departmentIblockId = (int)\Thurly\Main\Config\Option::get('intranet', 'iblock_structure', 0);
