...
class Localize
{
	...
	{
		$types = Array(
			'FILE_LIB_CHAT' => '/thurly/modules/imopenlines/lib/chat.php',
		);
	...
	public static function get($type, $phraseCode = null, $lang = null)
	{
		...
		{
			self::$MESS[$type][$lang] = \Thurly\Main\Localization\Loc::loadLanguageFile($_SERVER['DOCUMENT_ROOT'].$path, $lang);
		}
