...
class Alias
{
	...
	public static function add(array $fields)
	{
		...
		$result = \Thurly\Im\Model\AliasTable::add(Array(
			'ALIAS' => $alias,
	...
	{
		$alias = \Thurly\Im\Alias::prepareAlias(substr(uniqid(),-6));
		$fields['ALIAS'] = $alias;
	...
	public static function update($id, $fields)
	{
		...
		\Thurly\Im\Model\AliasTable::update($id, $update);
	...
	public static function delete($id, $filter = self::FILTER_BY_ID)
	{
		...
		\Thurly\Im\Model\AliasTable::delete($aliasData['ID']);
