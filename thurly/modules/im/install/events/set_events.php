...
{
	$lid = $lang["LID"];
	IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/im/install/events/set_events.php", $lid);
	...
	if(count($arSites) > 0)
	{
		...
		if (defined('BX24_HOST_NAME') || \Thurly\Main\Context::getCurrent()->getRequest()->isHttps())
		{
