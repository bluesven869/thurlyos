...
if (isset($_GET['alias']))
{
	$widgetUserLangPath = $_SERVER['DOCUMENT_ROOT'].'/thurly/modules/im/lang/';
	if (
...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/im/install/public/desktop_app/router.php");

$APPLICATION->SetTitle(GetMessage("IM_ROUTER_PAGE_TITLE"));
$APPLICATION->IncludeComponent("thurly:im.router", "", Array(), false, Array("HIDE_ICONS" => "Y"));
