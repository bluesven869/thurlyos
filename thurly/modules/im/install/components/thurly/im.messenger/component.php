...
$arResult['BOT'] = \Thurly\Im\Bot::getListForJs();
$arResult['COMMAND'] = \Thurly\Im\Command::getListForJs();
$arResult['TEXTAREA_ICON'] = \Thurly\Im\App::getListForJs();
...
$arResult['OL_OPERATOR'] = CModule::IncludeModule('imopenlines') && count(\Thurly\ImOpenLines\Config::getQueueList($USER->GetID())) > 0;
...
$arResult['PATH_TO_LF'] = IsModuleInstalled('intranet') && \Thurly\Main\IO\File::isFileExists(\Thurly\Main\Application::getDocumentRoot().'/stream/index.php')? '/stream/': '/';
