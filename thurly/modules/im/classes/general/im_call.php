...
class CIMCall
{
	...
	public static function Invite($arParams)
	{
		...
		else
		{
			...
			if (!$arConfig['CALL_TO_GROUP'] && CModule::IncludeModule('pull') && CPullOptions::GetPushStatus())
			{
				...
				\Thurly\Pull\Push::add(array_keys($arUserToConnect), Array(
					'module_id' => 'im',
					'push' => Array(
						'message' => $pushText,
						'expiry' => 0,
	...
	public static function Answer($arParams)
	{
		...
		{
			\Thurly\Pull\Push::add($arConfig['USER_ID'], Array(
				'module_id' => 'im',
				'push' => Array(
					'expiry' => 0,
					'advanced_params' => Array(
			...
			\Thurly\Pull\Push::add($arConfig['RECIPIENT_ID'], Array(
				'module_id' => 'im',
				'push' => Array(
					'expiry' => 0,
					'advanced_params' => Array(
	...
	public static function Command($chatId, $recipientId, $command, $params = Array())
	{
		...
		\Thurly\Pull\Event::add($recipientId, Array(
			'module_id' => 'im',
			'command' => 'call',
			'expiry' => 600,
			'params' => $params,
