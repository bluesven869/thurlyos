...
class CIMMail
{
	public static function MailNotifyAgent()
	{
		...
		foreach($arUnsendNotify as $id => $arNotify)
		{
			...
			if ($arNotify['TO_EXTERNAL_AUTH_ID'] == \Thurly\Im\Bot::EXTERNAL_AUTH_ID || $arNotify['TO_EXTERNAL_AUTH_ID'] == "network")
			{
	...
	public static function MailMessageAgent()
	{
		...
		foreach($arUnsendMessage as $id => $arMessage)
		{
			...
			if ($arMessage['TO_EXTERNAL_AUTH_ID'] == \Thurly\Im\Bot::EXTERNAL_AUTH_ID || $arMessage['TO_EXTERNAL_AUTH_ID'] == "network")
			{
