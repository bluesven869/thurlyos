...
<script>
	BX.ready(function() {
		...
		var config = <?=\Thurly\Main\Web\Json::encode(array(
			'serviceUrl' => '/thurly/components/thurly/bizproc.document/ajax.php',
		...
		var workflows = <?=\Thurly\Main\Web\Json::encode($workflows)?>;
