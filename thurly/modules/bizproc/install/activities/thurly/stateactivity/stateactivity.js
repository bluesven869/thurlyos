...
StateActivity = function()
{
	...
	ob.Draw = function (divC)
	{
		...
		c.width = '5';
		c.style.background = 'url(/thurly/images/bizproc/stat_hl.gif)';

		var d111 = r.insertCell(-1);
		//d111.width = '100%';
		d111.noWrap = 'nowrap';
		d111.style.background = 'url(/thurly/images/bizproc/stat_hbg.gif)';
		d111.style.height = '24px';

		c = r.insertCell(-1);
		c.width = '5';
		c.style.background = 'url(/thurly/images/bizproc/stat_hr.gif)';
		...
		c = r.insertCell(-1);
		c.style.background = 'url(/thurly/images/bizproc/stat_l.gif) left top repeat-y';

		var d2 = r.insertCell(-1);

		c = r.insertCell(-1);
		c.style.background = 'url(/thurly/images/bizproc/stat_r.gif) right top repeat-y';
		...
		addlnk.innerHTML = BPMESS['STATEACT_ADD']+' <img src="/thurly/images/bizproc/add.gif" border="0">';
		...
		for(var i=0; i<ob.childActivities.length; i++)
		{
			...
			cmdC.style.background = 'url(/thurly/images/bizproc/state'+ic+'.gif) center center no-repeat';
			...
			cmdC.width = 20;
			cmdC.height = 12;
			cmdC.style.background = 'url(/thurly/images/bizproc/state_set.gif) center center no-repeat';
			...
			cmdC.width = 12;
			cmdC.height = 12;
			cmdC.style.background = 'url(/thurly/images/bizproc/state_del.gif) center center no-repeat';
		...
		c = r.insertCell(-1);
		c.width = '5';
		c.style.background = 'url(/thurly/images/bizproc/stat_bl.gif)';

		c = r.insertCell(-1);
		c.style.background = 'url(/thurly/images/bizproc/stat_b.gif)';
		c.height = '5';

		c = r.insertCell(-1);
		c.width = '5';
		c.style.background = 'url(/thurly/images/bizproc/stat_br.gif)';
	};
