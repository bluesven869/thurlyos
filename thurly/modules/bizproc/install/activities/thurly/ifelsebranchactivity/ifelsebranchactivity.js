...
IfElseBranchActivity = function()
{
	...
	ob.Draw = function (container)
	{
		...
		d.style.margin = '5px';
		d.innerHTML = '<div style="background: url(/thurly/images/bizproc/cond_bg.gif);"><div style="background: url(/thurly/images/bizproc/cond_r.gif) right top no-repeat;"><div style="background: url(/thurly/images/bizproc/cond_l.gif) left top no-repeat; height: 23px; overflow-y: hidden;"><div style="padding-top: 5px; font-size: 12px; height: 23px; overflow-y: hidden; padding-right: 5px;"></div></div></div></div>';
	...
	/*
		...
		*/
		...
		setimg.width = '12';
		setimg.height = '12';
		setimg.src = '/thurly/images/bizproc/act_button_sett_gray.gif';
