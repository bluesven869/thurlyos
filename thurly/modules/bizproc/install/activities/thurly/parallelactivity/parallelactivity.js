...
ParallelActivity = function()
{
	...
	ob.delBranch = function (e)
	{
		...
		if(this.ind == 0)
		{
			...
			tt.rows[0].cells[1].style.background = 'url(/thurly/images/bizproc/act_line_bg.gif) 50% bottom repeat-x';
		...
		if(this.ind == ob.childActivities.length)
		{
			...
			tt.rows[0].cells[0].width = "50%";
			tt.rows[0].cells[1].width = "50%";
			tt.rows[0].cells[0].style.background = 'url(/thurly/images/bizproc/act_line_bg.gif) 50% bottom repeat-x';
	...
	ob.DrawVLine = function (i)
	{
		if(i!=0 && i!=ob.childActivities.length-1)
		{
			...
			ob.childsContainer.rows[0].cells[i].style.background = 'url(/thurly/images/bizproc/act_line_bg.gif) 50% bottom repeat-x';
			ob.childsContainer.rows[3].cells[i].style.background = 'url(/thurly/images/bizproc/act_line_bg.gif) 50% bottom repeat-x';
		}

		ob.childsContainer.rows[1].cells[i].style.background = 'url(/thurly/images/bizproc/act_line_bg.gif) 50% top repeat-y';
		ob.childsContainer.rows[2].cells[i].style.background = 'url(/thurly/images/bizproc/act_line_bg.gif) 50% top repeat-y';
		...
		im.src="/thurly/images/bizproc/del_br.gif";
		im.height="14";
		im.width="14";
...
/*
		...
		{
			this.src="/thurly/images/bizproc/parallel_del.gif";
		};

		im.onmouseout = function ()
		{
			this.src="/thurly/images/bizproc/parallel_del_light.gif";
		};
*/
	}
	...
	ob.Draw = function (container)
	{
		...
		if(!ob.activityContent)
		{
			...
			act.rows[0].cells[0].style.background = 'url('+(ob.Icon?ob.Icon:'/thurly/images/bizproc/act_icon.gif')+') 2px 2px no-repeat';
			...
			act.rows[0].cells[2].style.background = 'url(/thurly/images/bizproc/add_br.gif) left center no-repeat';
