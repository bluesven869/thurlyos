<?php
namespace Thurly\Bizproc;

use Thurly\Bizproc\BaseType\Base;
use Thurly\Main;

/**
 * Class FieldType
 * @package Thurly\Bizproc
 */
class FieldType
{
	...
	/** @var \Thurly\Bizproc\BaseType\Base $typeClass */
	protected $typeClass;
	...
	{
		if (is_subclass_of($typeClass, '\Thurly\Bizproc\BaseType\Base'))
		{
			$this->typeClass = $typeClass;
		}
		else
	...
	{
		return array(
			static::BOOL => '\Thurly\Bizproc\BaseType\BoolType',
			static::DATE => '\Thurly\Bizproc\BaseType\Date',
			static::DATETIME => '\Thurly\Bizproc\BaseType\Datetime',
			static::DOUBLE => '\Thurly\Bizproc\BaseType\Double',
			static::FILE => '\Thurly\Bizproc\BaseType\File',
			static::INT => '\Thurly\Bizproc\BaseType\IntType',
			static::SELECT => '\Thurly\Bizproc\BaseType\Select',
			static::STRING => '\Thurly\Bizproc\BaseType\StringType',
			static::TEXT => '\Thurly\Bizproc\BaseType\Text',
			static::USER => '\Thurly\Bizproc\BaseType\User',
			static::INTERNALSELECT => '\Thurly\Bizproc\BaseType\InternalSelect',
		);
	}
