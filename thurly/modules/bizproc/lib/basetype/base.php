...
class Base
{
	...
	{
		return static::convertValueSingle($fieldType, $value, '\Thurly\Bizproc\BaseType\StringType');
	}
	...
	protected static function renderControlSelectorButton($controlId, FieldType $fieldType, $selectorMode = '')
	{
		...
		return '<input type="button" value="..." onclick="BPAShowSelector(\''
			...
			.htmlspecialcharsbx(\Thurly\Main\Web\Json::encode($fieldType ? $fieldType->getDocumentType() : null)).');"'
