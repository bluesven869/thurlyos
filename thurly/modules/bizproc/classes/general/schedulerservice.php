<?
use Thurly\Bizproc\SchedulerEventTable;
	...
	extends CBPRuntimeService
{
	...
	{
		$result = (int) \Thurly\Main\Config\Option::get('bizproc', 'delay_min_limit', 0);
		if (!$withType)
			return $result;
		$type = 's';
		if ($result > 0)
	...
	public static function setDelayMinLimit($limit, $type = 's')
	{
		...
		\Thurly\Main\Config\Option::set('bizproc', 'delay_min_limit', $limit);
	}
