<?
include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/bizproc/classes/general/runtimeservice.php");
...
$objectName.GetFieldInputControlInternal = function(type, value, name, func, als, subtypeFunctionName, mode)
{
	...
	BX.ajax.post(
		'/thurly/tools/bizproc_get_field.php',
		{
...
$objectName.GetFieldInputValue = function(type, name, func)
{
	...
	BX.ajax.post('/thurly/tools/bizproc_set_field.php', s, function(v){v = $objectName._PrepareResponse(v); func(v);});
}
