				...
				if (is_array($fieldValue))
				{
					...
					foreach ($fieldValue as $r)
					{
						...
						if ($arImg = $dbImg->Fetch())
							$result[] = "[url=/thurly/tools/bizproc_show_file.php?f=".urlencode($arImg["FILE_NAME"])."&i=".$r."]".htmlspecialcharsbx($arImg["ORIGINAL_NAME"])."[/url]";
					}
				}
				else
				{
					...
					if ($arImg = $dbImg->Fetch())
						$result = "[url=/thurly/tools/bizproc_show_file.php?f=".urlencode($arImg["FILE_NAME"])."&i=".$fieldValue."]".htmlspecialcharsbx($arImg["ORIGINAL_NAME"])."[/url]";
				}
				break;
			case "L":
