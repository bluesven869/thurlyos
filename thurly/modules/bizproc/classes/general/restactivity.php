...
use \Thurly\Bizproc\RestActivityTable;
use \Thurly\Rest\Sqs;
	...
	implements IBPEventActivity, IBPActivityExternalEventListener
{
	...
	public function Execute()
	{
		...
		if (!Loader::includeModule('rest') || !\Thurly\Rest\OAuthService::getEngine()->isRegistered())
		...
		$auth = array(
			...
			\Thurly\Rest\OAuth\Auth::PARAM_LOCAL_USER => $userId,
			"application_token" => \CRestUtil::getApplicationToken($application),
		);

		$this->eventId = \Thurly\Main\Security\Random::getString(32, true);
	...
	public static function renderPropertiesDialog(\Thurly\Bizproc\Activity\PropertiesDialog $dialog)
	{
