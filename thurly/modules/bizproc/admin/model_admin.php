...
if (!\Thurly\Main\Loader::includeModule("bizproc"))
{
...
while($dbrs = $rsIBlocks->NavNext(true, "f_"))
{
	...
	)
	{
		$arActions[] = array(
			...
			"ACTION"=>"window.location='/thurly/admin/iblock_bizproc_workflow_admin.php?document_type=iblock_".$f_ID."&lang=".LANGUAGE_ID."';"
		);
	}
