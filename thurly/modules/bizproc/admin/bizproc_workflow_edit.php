...
// AJAX
//////////////////////////////////////////
$back_url = "/thurly/admin/".MODULE_ID."_bizproc_workflow_admin.php?lang=".LANGUAGE_ID."&document_type=".$document_type."&back_url_list=".$_REQUEST["back_url_list"];
if($_SERVER['REQUEST_METHOD']=='POST' && $_REQUEST['saveajax']=='Y')
{
	...
	?>
	<script>
	window.location = '<?=($_REQUEST["apply"]=="Y"?"/thurly/admin/".MODULE_ID."_bizproc_workflow_edit.php?lang=".LANGUAGE_ID."&ID=".$ID."&back_url_list=".AddSlashes($_REQUEST["back_url_list"]) : AddSlashes($back_url))?>';
	</script>
	<?
	die();
}
...
$aMenu[] = array(
	...
	"LINK"=>"/thurly/admin/".MODULE_ID."_bizproc_workflow_admin.php?lang=".LANGUAGE_ID."&document_type=".AddSlashes($document_type)."",
	"ICON"=>"btn_list",
);
...
$arSubMenu[] = array(
	...
	"ACTION"	=> "if(confirm('".GetMessage("BIZPROC_WFEDIT_MENU_ADD_WARN")."'))window.location='/thurly/admin/".MODULE_ID."_bizproc_workflow_edit.php?lang=".LANGUAGE_ID."&init=statemachine&document_type=".AddSlashes($document_type)."';"
);

$arSubMenu[] = array(
	"TEXT"	=> GetMessage("BIZPROC_WFEDIT_MENU_ADD_SEQ"),
	"ACTION"	=> "if(confirm('".GetMessage("BIZPROC_WFEDIT_MENU_ADD_WARN")."'))window.location='/thurly/admin/".MODULE_ID."_bizproc_workflow_edit.php?lang=".LANGUAGE_ID."&document_type=".AddSlashes($document_type)."';"
);
...
function BCPSaveTemplate(save)
{
	...
	// TODO: add sessid
	jsExtLoader.startPost('/thurly/admin/<?=MODULE_ID?>_bizproc_workflow_edit.php?<?=($ID>0?"ID=".$ID."&":"")?>'+
...
{
	jsPopup.ShowDialog("/thurly/admin/<?=MODULE_ID?>_bizproc_wf_settings.php?mode=public&bxpublic=Y&lang=<?=LANGUAGE_ID?>", {width: 700, height: 400, resize: true,
		'postData':
			'workflowTemplateName=' 		+ encodeURIComponent(workflowTemplateName) + '&' +
			'workflowTemplateDescription=' 	+ encodeURIComponent(workflowTemplateDescription) + '&' +
			'workflowTemplateAutostart=' 	+ encodeURIComponent(workflowTemplateAutostart) + '&' +
