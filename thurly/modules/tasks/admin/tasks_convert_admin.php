...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/tasks/include.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/tasks/prolog.php");
...
if (CModule::IncludeModule("intranet") && CModule::IncludeModule("tasks"))
{
	...
	echo "<form action=\"/thurly/admin/module_admin.php\"><input type=\"hidden\" name=\"lang\" value=\"".LANG."\" /><input type=\"submit\" value=\"".GetMessage("MOD_BACK")."\" />";
}
