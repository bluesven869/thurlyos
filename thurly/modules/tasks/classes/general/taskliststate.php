...
class CTaskListState
{
	...
	private function __construct($userId)
	{
		...
		if (
			...
			&&
			\Thurly\Tasks\Util\User::isAuthorized()
		)
		{
			$this->loggedInUserId = (int) \Thurly\Tasks\Util\User::getId();
...
//		// gantt by default once, to impress user
//		$ganttPerformed = CUserOptions::GetOption('tasks', 'gant_performed');
//		if(!$ganttPerformed)
//		{
//			$this->setViewMode(static::VIEW_MODE_GANTT);
//			$this->saveState();
//		}
	}
	...
	/**
	 * @param $roleId
	 * @deprecated Use \Thurly\Tasks\Internals\Counter\Role::getRoleName
	 * @return string
	 */
