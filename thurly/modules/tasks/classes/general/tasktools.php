...
class CTasksTools
{
	...
	{
		return \Thurly\Tasks\Util\User::getOccurAsId();
	}
	...
	{
		return \Thurly\Tasks\Util\User::setOccurAsId($userId);
	}
	...
	{
		return \Thurly\Tasks\Util\User::getTimeZoneOffset($userId);
	}
	...
	{
		return \Thurly\Tasks\Util::generateUUID($brackets);
	}
	...
	public static function FixForumCommentURL($arData)
	{
		...
		{
			$messageUrl = \Thurly\Tasks\Integration\Forum\Comment::makeUrl($messageUrl, $arData['ENTITY_ID']);
		}	
	...
	{
		return \Thurly\Tasks\Util\User::isAdmin($userId);
	}
	...
	{
		return \Thurly\Tasks\Integration\ThurlyOS\User::isAdmin($userId);
	}
	...
	{
		return \Thurly\Tasks\Util\User::isSuper($userId);
	}
	...
	{
		return \Thurly\Tasks\Util\User::getAdminId();
	}
