...
final class ProjectDependence extends \Thurly\Tasks\Manager
{
	const OUTGOING = 	0x01;
	const INGOING = 	0x02;
	const ALL = 		0x03;
	...
	public static function getListByParentEntity($userId, $taskId, array $parameters = array())
	{
		...
		{
			throw new \Thurly\Main\NotImplementedException('Only INGOING');
		}
		if(!$parameters['DIRECT'])
		{
			throw new \Thurly\Main\NotImplementedException('Only DIRECT');
		}
