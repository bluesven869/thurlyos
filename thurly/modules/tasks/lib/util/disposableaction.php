 ...
 *
	...
	{
		\CAgent::AddAgent('\Thurly\Tasks\Util\DisposableAction::reCreateUserFields();', 'tasks', 'N', 100, '', 'Y', GetTime(time() + 180, "FULL"), 100, false, false);
	}
 *
 */
...
class DisposableAction
{
	...
	public static function reCreateUserFields()
	{
		...
		\Thurly\Tasks\Util\UserField\Task::getScheme(0, $adminId, LANGUAGE_ID, true);
		\Thurly\Tasks\Util\UserField\Task\Template::getScheme(0, $adminId, LANGUAGE_ID, true);
	}
