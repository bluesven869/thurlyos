...
namespace Thurly\Tasks\Util\Type;

final class DateTime extends \Thurly\Main\Type\DateTime
{
	...
	public static function createFromObjectOrString($value)
	{
		if(!($value instanceof static))
		{
			...
			elseif($value instanceof \Thurly\Main\Type\DateTime)
			{
	...
	// unused?
	public static function createFromInstance(\Thurly\Main\Type\DateTime $date)
	{
	 ...
	 * @see \Thurly\Tasks\Util\Notification\Task::getDayStartDateTime()
	...
	public static function createFrom($time, $offset = null)
	{
		...
		elseif($time instanceof \Thurly\Main\Type\DateTime)
		{
			$time = $time->toString();
			if($offset === 0)
			{
