...
namespace Thurly\Tasks\Util\Error;

use \Thurly\Tasks\Util\Error;

class Collection extends \Thurly\Main\Type\Dictionary // todo: extends \Thurly\Tasks\Util\Type\Dictionary
{
	/**
	 * @deprecated
	 */
	 ...
	 * todo: provide add() from \Thurly\Main\Error, with default type == FATAL
	 *
	...
	public function add($codeOrInstance, $message = '', $type = false, $additionalData = null)
	{
		...
		if(is_object($codeOrInstance))
		{
			...
			elseif($codeOrInstance instanceof \Thurly\Main\Error)
			{
	 ...
	 *
	 * @deprecated
	 * @see \Thurly\Tasks\Util\Error\Collection::load
	 */
