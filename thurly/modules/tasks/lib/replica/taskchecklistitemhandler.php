...
class TaskChecklistItemHandler extends \Thurly\Replica\Client\BaseHandler
{
	protected $tableName = "b_tasks_checklist_items";
	protected $moduleId = "tasks";
	protected $className = "\\Thurly\\Tasks\\Internals\\Task\\CheckListTable";
	 ...
	 *
	 * @param \Thurly\Main\Event $event Contains two parameters: 0 - moved item, 1 - move position.
	 *
	 * @return void
	 * @see \CTaskCheckListItem::moveItem()
	 * @see \Thurly\Tasks\Replica\TaskChecklistItemHandler::onCheckListItemMoveItem()
	 */
	function onExecuteCheckListItemMoveItem(\Thurly\Main\Event $event)
	{
