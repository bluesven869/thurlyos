...
final class Helper extends \Thurly\Tasks\Internals\DataBase\Helper\Common
{
	public static function getTruncateTextFunction($columnName)
	{
		return "SUBSTRING(".$columnName.", 1, 1024)";
	}
	...
	protected static function changeAutoIncrementRestrictions($tableName, $way)
	{
		...
		Main\HttpApplication::getConnection()->query('SET IDENTITY_INSERT '.$dbHelper->forSql($tableName).' '.($way ? 'ON' : 'OFF'));
	}
