...
abstract class Manager
{
	...
	public static function getCode($prefix = false)
	{
		...
		{
			throw new \Thurly\Main\SystemException('Cannot identify sub-entity code');
		}
	...
	protected static function checkCanReadTaskThrowException($userId, $taskId)
	{
		...
		{
			throw new \Thurly\Tasks\AccessDeniedException();
		}
	}
	...
	public static function normalizeData($data)
	{
		...
		{
			return \Thurly\Tasks\Util\Type::normalizeArray($data);
		}
