...
class Util
{
	...
	{
		$parser = \Thurly\Tasks\Integration\Forum::getParser($parameters);
		if($parser == null)
		{
			$parser = \Thurly\Tasks\Integration\SocialNetwork::getParser($parameters);
		}
		if($parser == null)
		{
	...
	public static function log($info)
	{
		...
		if(is_subclass_of($info, '\\Thurly\\Main\\SystemException'))
		{
