...
namespace Thurly\Tasks\Dispatcher\PublicAction;

use Thurly\Bizproc\BaseType\Datetime;
use Thurly\Tasks\Item;
use Thurly\Tasks\Manager;
use Thurly\Tasks\Util;

final class Task extends \Thurly\Tasks\Dispatcher\RestrictedAction
{
	/**
	 * Get a task
	 */
	public function get($id, array $parameters = array())
	{
		...
		// todo: move to \Thurly\Tasks\Item\Task (don`t forget ENTITY_SELECT + CAN)
//		$select = array();
...
//		}
//
//		$template = new \Thurly\Tasks\Item\Task($id);
//
//		return array(
...
//		);
	...
	public function find(array $parameters = array())
	{
		...
		$data = array();
		$result = \Thurly\Tasks\Item\Task::find($parameters);
	 ...
	 * Get a list of tasks
	 * @deprecated
	 * @see \Thurly\Tasks\Dispatcher\PublicAction\Task::find
	 */
