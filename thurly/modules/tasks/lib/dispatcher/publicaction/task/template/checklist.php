...
namespace Thurly\Tasks\Dispatcher\PublicAction\Task\Template;
...
final class CheckList extends \Thurly\Tasks\Dispatcher\PublicAction
{
	/**
	...
	public function add(array $data, array $parameters = array())
	{
		...
		if($this->errors->checkNoFatals())
		{
			...
			{
				$display = $data['TITLE'];
				$display = \Thurly\Tasks\UI::sanitizeString($display, array('a'=>array('href'), 'img'=>array('src')));
				$display = \Thurly\Tasks\UI::convertBBCodeToHtml($display, array('PRESET'=>'BASIC'));
