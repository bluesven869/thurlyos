...
namespace Thurly\Tasks\Integration\Socialnetwork\UI;

use \Thurly\Main\Localization\Loc;

Loc::loadMessages(__FILE__);

final class Task extends \Thurly\Tasks\Integration\Socialnetwork
{
	/**
	...
	public static function getActionPath($groupId = 0, $userId = 0, $siteId = '')
	{
		...
		if(\Thurly\Tasks\Integration\Extranet::isExtranetSite())
		{
	...
	/**
	 * Formats task entity to show in the Live Feed. Eventually, just call the component thurly:tasks.task.livefeed
	 *
	 * @param $arFields
	 * @param $arParams
	 * @return array
	...
	public static function formatFeedEntry($arFields, $arParams)
	{
		...
		$arResult = array(
			...
			'CACHED_CSS_PATH' => '/thurly/js/tasks/css/tasks.css'
		);
