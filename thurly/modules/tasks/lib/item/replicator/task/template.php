...
namespace Thurly\Tasks\Item\Replicator\Task;

use Thurly\Tasks\Item;
use Thurly\Tasks\Item\Result;
use Thurly\Tasks\Util\Collection;

class Template extends \Thurly\Tasks\Item\Replicator
{
	protected static function getItemClass()
	{
		return '\\Thurly\\Tasks\\Item\\Task\\Template';
	}

	protected static function getConverterClass()
	{
		return '\\Thurly\\Tasks\\Item\\Converter\\Task\\Template\\ToTemplate';
	}
