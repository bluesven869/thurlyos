...
namespace Thurly\Tasks\Item\Access\Task;
...
final class Template extends \Thurly\Tasks\Item\Access
{
	/**
	...
	public static function grantAccessLevel($templateId, $groupCode, $level, array $parameters = array())
	{
		...
		if($result->isSuccess())
		{
			...
			$saveResult = new \Thurly\Tasks\Util\Result();
	 ...
	 * See
	 * \Thurly\Tasks\Internals\RunTime\Task\Template::getAccessCheckSql()
