...
class ProjectDependence extends \Thurly\Tasks\Item\Field\Collection\Item
{
	protected static function getItemClass()
	{
		return \Thurly\Tasks\Item\Task\ProjectDependence::getClass();
	}

	/**
	 * todo: implement this properly
	 * @see \Thurly\Tasks\Manager\Task\ProjectDependence
	 *
	 * @param $value
	 * @param $key
	...
	{
		return new \Thurly\Tasks\Util\Result();
	}
...
//		if($itemId)
//		{
//			// todo: use \Thurly\Tasks\Internals\Helper\Task\Template\Dependence here, because
//			// todo: tree functional of \Thurly\Tasks\Internals\Task\Template\DependenceTable is deprecated, it is non-extensible, buggy and
