...
use Thurly\Tasks\Internals\Task\TemplateTable;
use Thurly\Tasks\Item\Field\Collection;
use Thurly\Tasks\Item\Result;
use Thurly\Tasks\Item\Task\Template\Field;
use Thurly\Tasks\Item\Field\Scalar;
use Thurly\Tasks\Util\Replicator;
use Thurly\Tasks\Item\SystemLog;
use Thurly\Tasks\Util\User;
use Thurly\Tasks\Item\Access;

use Thurly\Tasks\Item\Converter\Task\Template\ToTemplate as TemplateToTemplate;
use Thurly\Tasks\Item\Converter\Task\Template\ToTask as TemplateToTask;

Loc::loadMessages(__FILE__);

final class Template extends \Thurly\Tasks\Item
{
	...
	{
		return \Thurly\Tasks\Util\UserField\Task\Template::getClass();
	}
...
//			}
	 ...
	 * data from $this
	 *
	 * @return \Thurly\Tasks\Item\Converter\Result
	 */
