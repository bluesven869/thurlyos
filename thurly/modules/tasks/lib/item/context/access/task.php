...
namespace Thurly\Tasks\Item\Context\Access;
...
final class Task extends \Thurly\Tasks\Item\Context\Access
{
	/**
	 * Alters query parameters to check access rights on database side
	 *
	 * @param mixed[]|\Thurly\Main\Entity\Query query parameters or query itself
	...
	private function getSubordinate($userId)
	{
		...
		{
			$cache[$userId] = array_flip(\Thurly\Tasks\Integration\Intranet\User::getSubordinate($userId, null, true));
		}
