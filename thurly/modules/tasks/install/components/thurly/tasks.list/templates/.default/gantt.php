...
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/gantt-view.js");
...
BX.message({
	...
	*/
	...
	var tasksListAjaxUrl = "/thurly/components/thurly/tasks.list/ajax.php?SITE_ID=<?php echo SITE_ID?><?php echo $arResult["TASK_TYPE"] == "group" ? "&GROUP_ID=".$arParams["GROUP_ID"] : ""?>";
	...
	var query = new BX.Tasks.Util.Query({
		url: '/thurly/components/thurly/tasks.task.list/ajax.php'
	});
