...
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/resizecolumns.js");
$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/main/dd.js');
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/movecolumns.js");
...
// for sure
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].BX_ROOT.'/modules/tasks/install/components/thurly/tasks.task.detail.parts/templates/default/buttons/template.php');
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].BX_ROOT.'/modules/tasks/install/components/thurly/tasks.task.detail.parts/templates/flat/buttons/template.php');
