...
// commented out probably wrong script $GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.task.edit/templates/.default/script.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/script.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/table-view.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/js/tasks/task-reminders.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/js/tasks/task-iframe-popup.js");

$GLOBALS['APPLICATION']->SetAdditionalCSS("/thurly/js/intranet/intranet-common.css");
$GLOBALS['APPLICATION']->SetAdditionalCSS("/thurly/js/main/core/css/core_popup.css");
$GLOBALS['APPLICATION']->SetAdditionalCSS("/thurly/js/tasks/css/tasks.css");
...
if (!defined('TASKS_MUL_INCLUDED')):
	$APPLICATION->IncludeComponent("thurly:main.user.link",
		'',
		array(
			"AJAX_ONLY" => "Y",
...
var arFilter = {};
var arOrder = {};
var tasksListAjaxUrl = "/thurly/components/thurly/tasks.list/ajax.php?SITE_ID=<?php echo SITE_ID?><?php echo $arResult["TASK_TYPE"] == "group" ? "&GROUP_ID=".$arParams["GROUP_ID"] : ""?>&nt=<?php echo urlencode($arParams['NAME_TEMPLATE']); ?>";
...
BX.ready(function() {
	...
	{
		<?php
		if (defined('SITE_TEMPLATE_ID') && (SITE_TEMPLATE_ID === 'thurlyos'))
		{
	...
	tasksRemindersPopUp = new BX.TaskReminders.create("tasks-reminder-popup", BX("task-reminder-link"), reminders, <?php echo $arResult["TASK"]["DEADLINE"] ? "\"".CUtil::JSEscape($arResult["TASK"]["DEADLINE"])."\"" : "false" ?>, {
		events: {
			onRemindersSave: function (reminders)
			{
				...
				var data = {
					mode : "reminders",
					sessid : BX.message("thurly_sessid"),
...
<div class="webform task-detail">
	...
	<div class="webform-round-corners webform-main-block webform-main-block-topless webform-main-block-bottomless">
		<div class="webform-content">
			...
			<?php
			$APPLICATION->IncludeComponent(
				"thurly:tasks.task.detail.parts",
				".default",
				array(
					'MODE'                 => 'VIEW TASK',
							...
							<?php if ($arResult["TASK"]["FILES"] || $arResult["TASK"]["FORUM_FILES"]):?>
								...
								<div class="task-detail-files-list">
									...
									foreach($arResult["TASK"]["FILES"] as $key=>$file)
									{
										...
										<div class="task-detail-file webform-field-upload-list"
											...
											><a id="<?php echo $linkId; ?>" 
												href="/thurly/components/thurly/tasks.task.detail/show_file.php?fid=<?php echo $file["ID"]?>" 
									...
									foreach($arResult["TASK"]["FORUM_FILES"] as $file):?>
										<?php $i++?>
										<div class="task-detail-file"><span class="task-detail-file-number"><?php echo $i?>.</span><span class="task-detail-file-info"><a href="#message<?php echo $file["MESSAGE_ID"]?>" class="task-detail-file-comment"/><a class="task-detail-file-link" target="_blank" href="/thurly/components/thurly/forum.interface/show_file.php?fid=<?php echo $file["ID"]?>"><?php echo $file["ORIGINAL_NAME"]?></a><span class="task-detail-file-size">(<?php echo CFile::FormatSize($file["FILE_SIZE"])?>)</span></span></div>
									<?php endforeach?>
								</div>
							<?php else:?>
							&nbsp;
							...
							<tr>
								...
								if ($arUserField['USER_TYPE']['USER_TYPE_ID'] === 'file')
								{
									...
									foreach ($arUserField['VALUE'] as $fileId)
									{
										...
										if ($isImage)
										{
											$arFile['SRC'] = "/thurly/components/thurly/tasks.task.detail/show_file.php?fid=" . $arFile['ID'] . "&amp;TASK_ID=" . (int) $arResult['TASK']['ID'];
										...
										else
										{
											...
											<span class="task-detail-file-info"><a 
												href="/thurly/components/thurly/tasks.task.detail/show_file.php?fid=<?php echo $arFile['ID']; ?>&amp;TASK_ID=<?php echo (int) $arResult['TASK']['ID']; ?>"
				...
				<tbody>
					...
					<?php if (sizeof($arResult["PREV_TASKS"])):?>
						...
						<?php foreach($arResult["PREV_TASKS"] as $task):?>
							...
							<?php endif?>
							<?php tasksRenderListItem($task, $arResult["CHILDREN_COUNT"]["PARENT_".$task["ID"]], $arPaths, 0, false, false, SITE_ID, 0, true, false, "thurly:tasks.list.item", ".default", $arParams["NAME_TEMPLATE"])?>
						<?php endforeach?>
					<?php endif?>
				</tbody>
			</table>
	...
	<div class="task-comments-and-log" <?php if ($arResult['IS_IFRAME']) echo ' style="width:630px;"' ?>>
		...
		<div class="task-comments-block task-comments-block-selected" id="task-comments-block">
			...
			else
			{
				...
				$APPLICATION->IncludeComponent("thurly:forum.comments", "thurlyos", array(
						...
						"DATE_TIME_FORMAT" => \Thurly\Tasks\UI::getDateTimeFormat(),
						...
						<td class="task-log-what-column"><span class="task-log-what"><?php
							switch($record["FIELD"])
							{
								...
								case "END_DATE_PLAN":
									...
									{
										print(\Thurly\Tasks\UI::formatDateTime($record['FROM_VALUE'], '^'.\Thurly\Tasks\UI::getDateTimeFormat()));
									}
									...
									{
										print(\Thurly\Tasks\UI::formatDateTime($record['TO_VALUE'], '^'.\Thurly\Tasks\UI::getDateTimeFormat()));
									}
									break;
							...
							<td class="task-time-spent-column">
								...
								switch ($time['SOURCE'])
								{
									...
									case CTaskElapsedItem::SOURCE_MANUAL:
										echo ' <img border="0" style="position:relative; top:3px;" src="/thurly/components/thurly/tasks.task.detail/templates/.default/images/s01.png" title="' . GetMessage("TASKS_ELAPSED_SOURCE_MANUAL") . '">';
									break;

									default:
									case CTaskElapsedItem::SOURCE_UNDEFINED:
										echo ' <img border="0" style="position:relative; top:3px;" src="/thurly/components/thurly/tasks.task.detail/templates/.default/images/s02.png" title="' . GetMessage("TASKS_ELAPSED_SOURCE_UNDEFINED") . '">';
									break;
								}
							?></span></td>
								...
								<div class="wrap-edit-nav">
									...
									<?php if ($time['META:CAN_REMOVE'] || $time['META:CAN_MODIFY']):?>
										<span class="task-edit-nav">
											...
											{
												?>
												<a class="task-table-remove" onclick="return confirm('<?=GetMessage("TASKS_ELAPSED_REMOVE_CONFIRM")?>')" href="<?php echo $APPLICATION->GetCurPageParam("ACTION=elapsed_delete&ELAPSED_ID=".$time["ID"]."&".thurly_sessid_get(), array("sessid", "ACTION"));?>"></a>
												<?php
											}
											?>
										</span>
