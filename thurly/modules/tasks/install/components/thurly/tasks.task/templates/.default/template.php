...
if($arParams["ENABLE_MENU_TOOLBAR"])
{
	$APPLICATION->IncludeComponent(
		'thurly:tasks.interface.topmenu',
		'.default',
		array(
	...
	$APPLICATION->IncludeComponent(
		'thurly:tasks.interface.filter.buttons',
		'.default',
		array(
			'SECTION' => 'EDIT_TASK',
...
<?if(!$hasFatals):?>
	...
	<?if($arResult['COMPONENT_DATA']['EVENT_TYPE'] == 'ADD' && !empty($arResult['DATA']['EVENT_TASK'])):?>
		<div class="task-message-label">
			...
			<?if($arResult['DATA']['EVENT_TASK']['ID'] != $arResult['DATA']['TASK']['ID']):?>
				<a href="<?=\Thurly\Tasks\UI\Task::makeActionUrl($arParams['PATH_TO_TASKS_TASK'], $arResult['DATA']['EVENT_TASK']['ID'], 'view');?>" target="_blank"><?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_VIEW_TASK');?></a>
			<?endif?>
		</div>
	<?endif?>
	...
	$request = \Thurly\Main\Context::getCurrent()->getRequest()->toArray();
	?>
	...
	<div id="bx-component-scope-<?=$templateId?>" class="task-form tasks">
        ...
        <?else:?>
			...
			<input data-bx-id="task-edit-csrf" type="hidden" name="sessid" value="<?=thurly_sessid()?>" />
                    ...
                    <div>
                        <div class="task-options-item task-options-item-destination">
                            ...
                            <div class="task-options-item-open-inner">
								<?
								$APPLICATION->IncludeComponent(
									'thurly:tasks.widget.member.selector',
									'',
									array(
										...
										'DATA' => $arResult['DATA']['TASK']['SE_RESPONSIBLE'],
								...
								?>
								<div class="bx-event-message bx-event-message-yellow" id="responsible-id-message" style="display:none"></div>

                                <span class="task-dashed-link task-dashed-link-add tasks-additional-block-link">
                                    <span class="task-dashed-link-inner" data-bx-id="task-edit-toggler" data-target="originator"><?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_ORIGINATOR')?></span> <span class="task-dashed-link-inner" data-bx-id="task-edit-toggler" data-target="accomplice"><?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_ACCOMPLICES')?></span> <span class="task-dashed-link-inner" data-bx-id="task-edit-toggler" data-target="auditor"><?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_AUDITORS')?></span>
                                </span>
                            ...
                            <div class="task-options-item-open-inner">
								...
								$APPLICATION->IncludeComponent(
									...
									array(
										...
										'DATA' => array($arResult['DATA']['TASK']['SE_ORIGINATOR']),
										'PATH_TO_USER_PROFILE' => $arParams['PATH_TO_USER_PROFILE'],
							...
							<div class="task-options-item-open-inner">
								...
								$APPLICATION->IncludeComponent(
									...
									array(
										...
										'DATA' => $arResult['DATA']['TASK']['SE_ACCOMPLICE'],
										'PATH_TO_USER_PROFILE' => $arParams['PATH_TO_USER_PROFILE'],
									),
									false,
									array("HIDE_ICONS" => "Y", "ACTIVE_COMPONENT" => "Y")
                            ...
                            <div class="task-options-item-open-inner">
								...
								$APPLICATION->IncludeComponent(
									...
									array(
										...
										'DATA' => $arResult['DATA']['TASK']['SE_AUDITOR'],
										'PATH_TO_USER_PROFILE' => $arParams['PATH_TO_USER_PROFILE'],
									),
									false,
									array("HIDE_ICONS" => "Y", "ACTIVE_COMPONENT" => "Y")
                            ...
                            <div data-bx-id="task-edit-options" data-block-name="<?=$blockName?>" class="pinable-block task-openable-block <?=$blockClasses[$blockName]?>">
                                <div class="task-options-settings-block">
                                    ...
                                    <div class="task-options-field-container">
										...
										<?
										$canCustomizeCalendar = !$arResult['AUX_DATA']['USER']['IS_EXTRANET_USER'] && $arResult['COMPONENT_DATA']['MODULES']['thurlyos'];
										$options = array(
											array(
                        ...
                        <div data-bx-id="task-edit-<?=$blockNameJs?>-block" data-block-name="<?=$blockName?>" class="pinable-block task-options-item task-options-item-<?=$blockNameJs?><?=$itemOpenClass?>">
                            ...
                            <?elseif($blockName == 'TIMEMAN'):?>
		                        ...
		                        <div class="task-options-item-open-inner">
		                            ...
		                            <?$APPLICATION->IncludeComponent(
			                            'thurly:tasks.widget.timeestimate',
			                            '',
			                            array(
				                            'INPUT_PREFIX' => $inputPrefix,
                            ...
                            <?elseif($blockName == Manager\Task::SE_PREFIX.'TEMPLATE'):?>
                                ...
                                <div data-bx-id="task-edit-replication-block" class="task-options-item-open-inner <?/*=($replicationOn ? '' : 'mode-replication-off')*/?>">
                                    ...
                                    <div data-bx-id="task-edit-replication-panel" class="task-options-repeat task-openable-block<?=($replicationOn ? '' : ' invisible')?>">
	                                    ...
	                                    <?$APPLICATION->IncludeComponent(
		                                    'thurly:tasks.widget.replication',
		                                    '',
		                                    array(
                            ...
                            <?elseif($blockName == 'UF_CRM_TASK'):?>
                                ...
                                <div class="task-options-item-open-inner task-edit-crm-block">
                                    ...
                                    \Thurly\Tasks\Util\UserField\UI::showEdit($crmUf);
									?>
                                </div>
                                ...
                                <div class="task-options-item-open-inner">
                                    ...
                                    <span id="bx-component-scope-parenttask-<?=$templateId?>" class="task-options-destination-wrap task-item-set-empty-true">
                                        ...
                                        <div data-bx-id="task-item-set-picker-content" class="hidden-soft">
                                            <?$APPLICATION->IncludeComponent(
                                                "thurly:tasks.task.selector", ".default", array(
                                                "MULTIPLE" => "N",
                                                "NAME" => "parenttask",
                            ...
                            <?elseif($blockName == Manager\Task::SE_PREFIX.'TAG'):?>
                                ...
                                <div class="task-options-item-open-inner">
	                                ...
	                                <?$APPLICATION->IncludeComponent(
		                                'thurly:tasks.widget.tag.selector',
		                                '',
		                                array(
			                                'INPUT_PREFIX' => $inputPrefix.'['.$blockName.']',
                            ...
                            <?elseif($blockName == 'USER_FIELDS'):?>
                                ...
                                <div class="task-options-item-open-inner">
	                                ...
	                                <?$APPLICATION->IncludeComponent(
		                                "thurly:tasks.userfield.panel",
		                                "",
		                                array(
			                                'EXCLUDE' => array(
				                                \Thurly\Tasks\Integration\Disk\UserField::getMainSysUFCode(),
				                                \Thurly\Tasks\Integration\CRM\UserField::getMainSysUFCode(),
			                                ),
			                                'DATA' => $taskData,
			                                'ENTITY_CODE' => 'TASK',
			                                'INPUT_PREFIX' => $inputPrefix,
			...
			<?if($arParams['ENABLE_FOOTER']):?>
				...
				<div data-bx-id="task-edit-footer" class="webform-buttons task-edit-footer-fixed pinable-block <?=($arResult['TEMPLATE_DATA']['FOOTER_PINNED'] ? 'pinned' : '')?>">
	                ...
	                <div class="tasks-form-footer-container">
						...
						<?$satChecked = $request['SAVE_AS_TEMPLATE'] == 'Y' || $taskData['REPLICATE'] == 'Y';?>
	                    ...
	                    <button data-bx-id="task-edit-submit" class="webform-small-button webform-small-button-accept">
		                ...
		                <?if(!intval($taskData['ID'])):?>
	                        <button data-bx-id="task-edit-submit" name="STAY_AT_PAGE" value="1" class="webform-small-button webform-small-button-transparent">
	                            <span class="webform-small-button-text"><?=Loc::getMessage('TASKS_TASK_COMPONENT_TEMPLATE_ADD_TASK_AND_OPEN_AGAIN')?></span>
	                        </button>
	                    <?endif?>

	                    <a
							class="webform-button-link"
	...
	<script>
        ...
        var options = <?=\Thurly\Tasks\UI::toJSObject(array(
