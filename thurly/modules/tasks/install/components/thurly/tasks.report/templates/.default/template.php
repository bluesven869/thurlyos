...
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/tasks.report/templates/.default/script.js");
		...
		<div class="task-filter-extra-pages">
			<ul class="task-filter-items">
				<li class="task-filter-item task-filter-item-selected">
					<a href="<?php echo CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_REPORTS"], array());?>" class="task-filter-item-link"><span class="task-filter-item-left"></span><span class="task-filter-item-text"><?php echo GetMessage("TASKS_REPORT_REPORTS")?></span><span class="task-filter-item-number"></span></a>
				</li>
				<li class="task-filter-item">
					<a href="<?php echo CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_TASKS"], array());?>" class="task-filter-item-link"><span class="task-filter-item-left"></span><span class="task-filter-item-text"><?php echo GetMessage("TASKS_REPORT_TASKS")?></span></a>
				</li>
				<li class="task-filter-item">
					<a href="<?php echo CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_TEMPLATES"], array());?>" class="task-filter-item-link"><span class="task-filter-item-left"></span><span class="task-filter-item-text"><?php echo GetMessage("TASKS_REPORT_TEMPLATES")?></span><span class="task-filter-item-number"><?php echo CTaskTemplates::GetCount()?></span></a>
				</li>
...
<div class="task-title-buttons task-detail-title-buttons"><span class="task-report-title-checkbox"><input class="textbox" type="checkbox" id="task-title-checkbox" onclick="BX.toggleClass(BX('task-report-table'), 'task-report-table-full')" /><label for="task-title-checkbox"><?php echo GetMessage("TASKS_REPORT_SHOW_ALL")?></label></span><?php if ($arParams["BACK_TO_TASKS"] != "N"):?><span class="task-title-button-separator"></span><a class="task-title-button task-title-button-back" href="<?php echo CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_TASKS"], array());?>"><i class="task-title-button-back-icon"></i><span class="task-title-button-back-text"><?php echo GetMessage("TASKS_ADD_BACK_TO_TASKS_LIST")?></span></a><?php endif?></div>
<?php $this->EndViewTarget();?>
