...
<? if (!$isThurlyOSTemplate): ?>
	...
	<div class="tasks-interface-filter-container">
		...
		<div
			class="pagetitle-container<? if (!$isThurlyOSTemplate): ?> pagetitle-container-light<? endif ?> pagetitle-flexible-space">
...
<?php if ($arParams['SHOW_USER_SORT'] == 'Y' ||
	...
	<script type="text/javascript">
		(function()
		{
			...
			<?php
			$instance = \CTaskListState::getInstance(\Thurly\Tasks\Util\User::getId());
			...
			<?php
			$sortFields = \Thurly\Tasks\Ui\Controls\Column::getFieldsForSorting();
			?>
