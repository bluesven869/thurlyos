...
elseif ($arParams['SECTION'] == 'VIEW_TASK')
{
	...
	<span class="webform-small-button-separate-wrap">
		<a class="webform-small-button webform-small-button-blue" href="<?= HtmlFilter::encode($button['URL']);?>" id="<?= HtmlFilter::encode($button['ID']);?>-btn">
			<?= HtmlFilter::encode($button['NAME']);?>
		</a>
		<span class="webform-small-button-right-part" id="<?= HtmlFilter::encode($button['ID']);?>"></span>
	</span>
	<?
}?>
