...
BX.Tasks.QuickForm = function(formContainerId, parameters)
{
	...
	this.query = new BX.Tasks.Util.Query({url: "/thurly/components/thurly/tasks.task.list/ajax.php"});
...
BX.Tasks.QuickForm.prototype.insertIntoGantt = function(json, position)
{
	...
	if (json.projectId && !ganttChart.getProjectById(json.projectId) && this.parameters.currentGroupId === 0)
	{
