var tasksDetailPartsNS = {
	tasksListAjaxUrl : '/thurly/components/thurly/tasks.list/ajax.php?SITE_ID=' + BX.message('SITE_ID'),
	detailsAjaxUrl   : '/thurly/components/thurly/tasks.task.detail/ajax.php?SITE_ID=' + BX.message('SITE_ID'),
