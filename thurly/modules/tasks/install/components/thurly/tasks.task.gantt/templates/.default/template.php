...
$APPLICATION->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/script.js");
$APPLICATION->AddHeadScript("/thurly/components/thurly/tasks.list/templates/.default/gantt-view.js");
$APPLICATION->AddHeadScript("/thurly/js/tasks/task-iframe-popup.js");

$APPLICATION->SetAdditionalCSS("/thurly/js/intranet/intranet-common.css");
$APPLICATION->SetAdditionalCSS("/thurly/js/tasks/css/tasks.css");
...
{
	$APPLICATION->IncludeComponent("thurly:tasks.util.process",
		'',
		array(),
		false,
		array("HIDE_ICONS" => "Y")
...
$cs = \Thurly\Tasks\UI::translateCalendarSettings($arResult['CALENDAR_SETTINGS']);
...
{
	CThurlyOS::initLicenseInfoPopupJS("tasks");
}
...
<script type="text/javascript">
    ...
    var tasksListAjaxUrl = "/thurly/components/thurly/tasks.list/ajax.php?SITE_ID=<?php echo SITE_ID?><?=$arParams['GROUP_ID'] ? "&GROUP_ID=" . $arParams["GROUP_ID"] : ""?>";
    ...
    var query = new BX.Tasks.Util.Query({
        url: '/thurly/components/thurly/tasks.task.gantt/ajax.php'
    });
...
<?php $APPLICATION->IncludeComponent(
	...
	array(
		...
		'USE_GROUP_BY_GROUPS' => $arParams['NEED_GROUP_BY_GROUPS'] ? 'Y' : 'N',
		'SHOW_USER_SORT' => 'Y',
