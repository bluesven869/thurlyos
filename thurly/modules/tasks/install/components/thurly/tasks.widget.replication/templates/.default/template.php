	...
	<div id="<?=$helper->getScopeId()?>" class="tasks task-options-repeat">
				...
				<div class="task-options-field">
	                ...
	                <span class="task-options-inp-container task-options-inp-container-period">
	                    <select name="<?=$prefix?>[MONTHLY_WEEK_DAY]" class="js-id-replication-monthly-week-day task-options-inp">
							<?/** do not reorder weekday numbers, because strtotime() accepts 0 - monday, 6 - sunday, @see \Thurly\Tasks\Util\Replicator\Task\FromTemplate::getNextTime() */?>
							<?for($k = 0; $k <= 6; $k++):?>
		...
		<div class="task-options-field">
			<div class="task-options-field task-options-field-left">
				...
				<span class="js-id-hint-help task-options-timezone-indicator"><?=Loc::getMessage('TASKS_TTDP_REPLICATION_TZ_HINT', array('#TIMEZONE#' => \Thurly\Tasks\UI::formatTimezoneOffsetUTC($tzOffset)))?></span>
