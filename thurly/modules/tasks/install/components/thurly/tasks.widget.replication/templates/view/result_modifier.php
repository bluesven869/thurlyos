...
$arResult['HELPER'] = $helper = new \Thurly\Tasks\UI\Component\TemplateHelper('TasksWidgetReplicationView', $this, array(
...
$arParams['PATH_TO_TEMPLATES_TEMPLATE'] = \Thurly\Tasks\UI\Task\Template::makeActionUrl($helper->findParameterValue('PATH_TO_TEMPLATES_TEMPLATE'), $arParams['ENTITY_ID'], 'view');
