...
{
	$lid = $lang["LID"];
	IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/tasks/install/events.php", $lid);
	...
	if(count($arSites) > 0)
	{
		...
		$emess->Add(array(
			...
			"EMAIL_TO" => "#EMAIL_TO#",
			"SUBJECT" => "#TASK_TITLE#",
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:tasks.mail.task\",\"\",Array(\"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"USER_RECEIVER\" => \"{#RECIPIENT_ID#}\",\"ID\" => \"{#TASK_ID#}\"));?>",
			"BODY_TYPE" => "html",
		...
		$emess->Add(array(
			...
			"EMAIL_TO" => "#EMAIL_TO#",
			"SUBJECT" => "#TASK_TITLE#",
			"MESSAGE" => "<?EventMessageThemeCompiler::includeComponent(\"thurly:tasks.mail.task\",\"\",Array(\"ENTITY\" => \"COMMENT\", \"EMAIL_TO\" => \"{#EMAIL_TO#}\",\"USER_RECEIVER\" => \"{#RECIPIENT_ID#}\",\"ID\" => \"{#TASK_ID#}\"));?>",
			"BODY_TYPE" => "html",
			"SITE_TEMPLATE_ID" => "mail_user"
		));
