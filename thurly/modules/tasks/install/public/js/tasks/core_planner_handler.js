...
BX.CTasksPlannerSelector.prototype.Show = function()
{
	if (!this.isReady)
	{
		...
		return BX.ajax.get('/thurly/tools/tasks_planner.php', {action:'list', suffix: suffix, sessid: BX.thurly_sessid(), site_id: BX.message('SITE_ID')}, BX.proxy(this.Ready, this));
	}
