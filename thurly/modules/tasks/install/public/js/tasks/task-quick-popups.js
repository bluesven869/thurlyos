...
BX.Tasks.lwPopup = {
	ajaxUrl : '/thurly/components/thurly/tasks.list/ajax.php',
	onTaskAdded : null,
	...
	__initSelectors : function(arParams)
	{
		...
		BX.ajax({
			method      : 'POST',
			dataType    : 'html',
			url         : '/thurly/components/thurly/tasks.iframe.popup/ajax_loader.php?SITE_ID=' + BX.message('SITE_ID'),
			data        :  ajaxData,
			processData :  true,
			autoAuth    :  true,
			...
			__delayedSetContent : function(delay)
			{
				...
				else
				{
					...
					BX.ajax({
						method      : 'POST',
						dataType    : 'html',
						url         : '/thurly/components/thurly/tasks.iframe.popup/ajax_loader.php?SITE_ID=' + BX.message('SITE_ID') + urlParams,
						data        :  ajaxData,
						processData :  true,
						autoAuth    :  true,
						//async       :  false,
