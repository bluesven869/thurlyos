		...
		if (!deadline) {
			...
			if (tmpDeadline !== null) {
				...
				BX.adjust(deadlineSpan, {
					text: "(" + BX.date.format(BX.date.convertThurlyFormat(BX.message('FORMAT_DATETIME')), this.deadline) + ")"
			...
			var reminderNode = BX.create("div" , {
				...
				children: [
					...
					BX.create("span", {
						...
						children: [
							BX.create("span", {
								text: BX.date.format(BX.date.convertThurlyFormat(BX.message('FORMAT_DATETIME')), this.reminders[i].date) +
