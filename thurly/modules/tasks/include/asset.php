...
$assets = array(
	 ...
	 * 'css' => [['condition' => function(){return *some condition*;}, 'file' => '/thurly/js/tasks/css/media.css']];
	 */
	array(
		'code' => 'tasks',
		'js'  => array(
	...
	array(
		...
		'rel' => array('popup', 'date', 'task_info_popup', 'task_calendar', 'task_date', 'dnd'),
...
\Thurly\Main\Page\Asset::getInstance()->addCssKernelInfo("tasks", array(
	$assetRoot.'css/core_planner_handler.css',
));

\Thurly\Main\Page\Asset::getInstance()->addJsKernelInfo("tasks", array(
