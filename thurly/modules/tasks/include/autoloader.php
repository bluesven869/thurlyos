...
CModule::AddAutoloadClasses(
	...
	array(
		...
		'Thurly\Tasks\Internals\DataBase\Helper'    => "lib/internals/database/helper/".ToLower($DBType).".php",
		'\Thurly\Tasks\Internals\DataBase\Helper'   => "lib/internals/database/helper/".ToLower($DBType).".php",

		'\Thurly\Tasks\ActionNotAllowedException'				=> "lib/exception.php",
		'\Thurly\Tasks\ActionFailedException'					=> "lib/exception.php",
		'\Thurly\Tasks\AccessDeniedException'					=> "lib/exception.php",
		'\Thurly\Tasks\ActionRestrictedException'				=> "lib/exception.php",

		'\Thurly\Tasks\Internals\DataBase\Tree\NodeNotFoundException'			=> "lib/internals/database/tree/exception.php",
		'\Thurly\Tasks\Internals\DataBase\Tree\TargetNodeNotFoundException'		=> "lib/internals/database/tree/exception.php",
		'\Thurly\Tasks\Internals\DataBase\Tree\ParentNodeNotFoundException'		=> "lib/internals/database/tree/exception.php",
		'\Thurly\Tasks\Internals\DataBase\Tree\LinkExistsException'				=> "lib/internals/database/tree/exception.php",
		'\Thurly\Tasks\Internals\DataBase\Tree\LinkNotExistException'			=> "lib/internals/database/tree/exception.php",

		'\Thurly\Tasks\Dispatcher\EntityNotFoundException'		=> "lib/dispatcher/exception.php",
		'\Thurly\Tasks\Dispatcher\MethodNotFoundException'		=> "lib/dispatcher/exception.php",
		'\Thurly\Tasks\Dispatcher\BadQueryException'			=> "lib/dispatcher/exception.php",
	)
);