...
class CLdapUtil
{
	...
	public static function OnAfterUserAuthorizeHandler()
	{
		...
		{
			$authNet = COption::GetOptionString("ldap", 'thurlyvm_auth_net', '');
	...
	{
		return self::thurlyVMAuthorize();
	}

	public static function thurlyVMAuthorize()
	{
		if(defined("LDAP_NO_PORT_REDIRECTION"))
			return false;
	...
	public static function isThurlyVMAuthSupported()
	{
	...
	public static function SetThurlyVMAuthSupport($setOption=false, $netAndMask=false)
	{
		...
		if($setOption)
			COption::SetOptionString("ldap", "thurlyvm_auth_support", "Y");

		if($netAndMask)
			COption::SetOptionString("ldap", "thurlyvm_auth_net", $netAndMask);
	}

	public static function UnSetThurlyVMAuthSupport($unSetOption=false)
	{
		...
		if($unSetOption)
			COption::SetOptionString("ldap", "thurlyvm_auth_support", "N");
	}
	...
	public static function getTargetPort($serverPort = false)
	{
		...
		$vmAuth = COption::GetOptionString("ldap", "thurlyvm_auth_support","N") == "Y";
