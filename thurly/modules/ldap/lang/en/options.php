...
$MESS["LDAP_THURLYVM_BLOCK"] = "Redirect NTLM Authentication to Ports 8890 and 8891";
$MESS["LDAP_THURLYVM_SUPPORT"] = "Redirect NTLM authentication";
$MESS["LDAP_THURLYVM_NET"] = "Restrict NTLM redirection to this subnet:";
$MESS["LDAP_THURLYVM_HINT"] = "Specify here the subnet whose users will be redirected when authenticating via NTLM.<br> For example: <b>192.168.1.0/24</b> or <b>192.168.1.0/255.255.255.0</b>.<br>Separate multiple IP ranges with a semicolon.<br> Leave the field empty to redirect all users.";
