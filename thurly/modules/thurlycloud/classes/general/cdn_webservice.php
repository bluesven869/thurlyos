...
class CThurlyCloudCDNWebService extends CThurlyCloudWebService
{
	private $domain = "";
	private $https = null;
	...
	protected function getActionURL($arParams = /*.(array[string]string).*/ array())
	{
		...
		$url = COption::GetOptionString("thurlycloud", "cdn_policy_url");
	 ...
	 *
	 */
	public function actionQuota() /*. throws CThurlyCloudException .*/
	{
	 ...
	 *
	 */
	public function actionStop() /*. throws CThurlyCloudException .*/
	{
	 ...
	 *
	 */
	public function actionGetConfig() /*. throws CThurlyCloudException .*/
	{
		return $this->action("");
	}
}
