...
$APPLICATION->SetAdditionalCSS('/thurly/gadgets/thurly/thurlycloud_monitoring/styles.css');
$converter = CBXPunycode::GetConverter();
$saleIncluded = CModule::IncludeModule('sale');

$intervalLang = array(
	"sale" => array(
		7 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT1_WEEK"),
		30 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT1_MONTH"),
		90 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT1_QUARTER"),
		365 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT1_YEAR"),
	),
	"uptime" => array(
		7 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT2_WEEK"),
		30 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT2_MONTH"),
		90 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT2_QUARTER"),
		365 => GetMessage("GD_THURLYCLOUD_MONITOR_MESS_ALERT2_YEAR"),
	),
);

$uptime = "";
$testCount = 0;
/** @var CThurlyCloudMonitoringTest $testAlert */
$testAlert = null;
$testDomain = "";
$bAlert = false;
...
if ($bAlert)
{
	...
	elseif ($testCount === 1 && HasMessage("GD_THURLYCLOUD_MONITOR_".strtoupper($testAlert->getName())))
	{
		$uptimeRate = 1;
		$resultText = FormatDate("ddiff", time(), $testAlert->getResult());
		$sumHtml = GetMessage("GD_THURLYCLOUD_MONITOR_".strtoupper($testAlert->getName()), array(
	...
	{
		$sumHtml = GetMessage("GD_THURLYCLOUD_MONITOR_PROBLEMS", array(
			"#COUNT#" => $testCount,
		));
	}
}
...
<div class="bx-gadgets-content-layout-inspector">
	<div class="bx-gadgets-title"><?echo GetMessage("GD_THURLYCLOUD_MONITOR")?></div>
	<div class="bx-gadget-bottom-cont bx-gadget-bottom-button-cont bx-gadget-mark-cont">
<?
	if ($uptimeRate < 1)
	{
?>
		<a class="bx-gadget-button" href="/thurly/admin/thurlycloud_monitoring_admin.php?lang=<?echo LANGUAGE_ID?>&amp;referer=gadget">
			<div class="bx-gadget-button-lamp"></div>
			<div class="bx-gadget-button-text"><?echo GetMessage("GD_THURLYCLOUD_MONITOR_BTN_ALERT")?></div>
		</a>
...
?>
		<a class="bx-gadget-button" href="/thurly/admin/thurlycloud_monitoring_admin.php?lang=<?echo LANGUAGE_ID?>&amp;referer=gadget">
			<div class="bx-gadget-button-lamp"></div>
			<div class="bx-gadget-button-text"><?echo GetMessage("GD_THURLYCLOUD_MONITOR_BTN_OK")?></div>
		</a>
...
<?
	...
	else
	{
		...
		<div class="bx-gadget-mark"><?echo GetMessage("GD_THURLYCLOUD_MONITOR_MESS_OK")?></div>
	<?
	}
?>
	</div>
