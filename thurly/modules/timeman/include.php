...
CJSCore::RegisterExt('timeman', array(
	...
	'css' => array(
		'/thurly/js/timeman/css/core_timeman.css',
		'/thurly/themes/.default/clock.css'
	),
	'lang' => '/thurly/modules/timeman/lang/'.LANGUAGE_ID.'/js_core_timeman.php',
	'rel' => array('ajax', 'timer', 'popup', 'ls', 'planner')
));

\Thurly\Main\Page\Asset::getInstance()->groupJs('calendar_planner_handler', 'timeman');
\Thurly\Main\Page\Asset::getInstance()->groupCss('calendar_planner_handler', 'timeman');
