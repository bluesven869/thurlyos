	...
	foreach ($arTABLES as $table_name)
	{
		...
		case "orm":
			...
			if (count($tableParts) > 1)
				array_shift($tableParts);
			$className = \Thurly\Main\Entity\Base::snake2camel(implode("_", $tableParts));
			...
			echo "File: /thurly/modules/".$moduleName."/lib/".strtolower($className).".php";
			echo "<hr>";
			echo "<pre>";
			echo "&lt;", "?", "php\n";
			echo "namespace Thurly\\".$moduleNamespace.";\n";
			echo "\n";
			echo "use Thurly\\Main,\n";
			echo "	Thurly\\Main\\Localization\\Loc;\n";
			...
			foreach ($arParents as $columnName => $parentInfo)
			{
				...
				$parentClassName = \Thurly\Main\Entity\Base::snake2camel(implode("_", $parentTableParts));

				$columnName = preg_replace("/_ID\$/", "", $columnName);
				echo " * &lt;li&gt; ".$columnName
					." reference to {@link \\Thurly\\".$parentModuleNamespace
					."\\".$parentClassName."Table}"
					."\n";
			}
			echo " * &lt;/ul&gt;\n";
			echo " *\n";
			echo " * @package Thurly\\".$moduleNamespace."\n";
			echo " *"."*/\n";
			echo "\n";
			...
			foreach ($arFields as $columnName => $columnInfo)
			{
				...
				{
					$validateFunctionName = "validate".\Thurly\Main\Entity\Base::snake2camel($columnName);
			...
			foreach ($arParents as $columnName => $parentInfo)
			{
				...
				echo "\t\t\t\t'data_type' => 'Thurly\\".$parentModuleNamespace."\\".$parentClassName."',\n";
			...
			echo "}\n";
			echo "</pre>";
			echo "File: /thurly/modules/".$moduleName."/lang/ru/lib/".strtolower($className).".php";
			echo "<hr>";
			echo "<pre>";
			echo "&lt;", "?\n";
