...
while ($arRes = $rsData->NavNext(true, "f_"))
{
	...
	if ($f_FILE_NAME != "")
	{
		...
		if (
			...
			$row->AddViewField("FILE_NAME", '<a target="blank" href="/thurly/admin/fileman_file_view.php?path='.urlencode(substr($f_FILE_PATH, $DOCUMENT_ROOT_LEN)).'&lang='.LANGUAGE_ID.'">'.$f_FILE_NAME.'</a>');
	}
	if ($f_OP_MODE == "R")
	...
	if ($f_BASE_DIR === "/thurly/managed_cache/")
		$BASE_DIR = GetMessage("PERFMON_CACHE_MANAGED");
	elseif ($f_BASE_DIR === "/thurly/cache/")
