...
class CReport
{
	...
	public static function GetList($owner = '')
	{
		...
		return Thurly\Report\ReportTable::getList(array(
		...
		foreach ($strChains as $k => $v)
		{
			if (is_array($v))
			{
				...
				try
				{
					...
					{
						throw new \Thurly\Main\SystemException('', 100);
					}
				}
				catch (Exception $e)
				{
...
class BXUserException extends \Thurly\Main\SystemException
{}
class BXFormException extends \Thurly\Main\SystemException
{}
