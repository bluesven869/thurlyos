...
use Thurly\Report\Internals\Controller;
use Thurly\Main\Error;
use Thurly\Report\Sharing;
use Thurly\Report\RightsManager;

require_once($_SERVER['DOCUMENT_ROOT'].'/thurly/modules/main/include/prolog_before.php');

if (!Loader::IncludeModule('report') || !\Thurly\Main\Application::getInstance()->getContext()
...
class ReportListAjaxController extends Controller
{
	...
	protected function processActionChangeSharing()
	{
		...
		$sharing = new Thurly\Report\Sharing($reportId);
