			...
			<table cellspacing="0" class="reports-list-table"
				...
				<? foreach($arResult['SHARED_REPORT'] as $listItem): ?>
					<?
						...
						{
							case Thurly\Report\RightsManager::ACCESS_READ:
								$accessMark = 'r';
								break;
							case Thurly\Report\RightsManager::ACCESS_EDIT:
								$accessMark = 'e';
								break;
							case Thurly\Report\RightsManager::ACCESS_FULL:
								$accessMark = 'f';
								break;
						}
					?>
					<tr class="reports-list-item" data-item="<?=$listItem['CREATED_BY']?>">
						...
						<td  class="reports-date-column reports-last-column">
							<?= ($listItem['CREATED_DATE'] instanceof \Thurly\Main\Type\DateTime ||
								$listItem['CREATED_DATE'] instanceof \Thurly\Main\Type\Date) ?
