		...
		public function ReceiveMessage($senderJId, array $arMessage, CXMPPClient $senderClient)
		{
			...
			if ($type == "get")
			{
				...
				if ($arUser)
				{
					...
					{
						$photoType = "image/gif";
						if (File_Exists($_SERVER["DOCUMENT_ROOT"]."/thurly/images/socialnetwork/nopic_user_150.gif"))
						{
							$photo = File_Get_Contents($_SERVER["DOCUMENT_ROOT"]."/thurly/images/socialnetwork/nopic_user_150.gif");
							$photo = Base64_Encode($photo);
						}
					}
