...
class CXMPPServer
{
	...
	protected function Initialize()
	{
		...
		$this->thurlyosMode = ($GLOBALS["argc"] > 1 ? $GLOBALS["argv"][1] == "thurlyos" : false);
	...
	var $logFile;
	var $logFileName = "/thurly/modules/xmppd.log";
	var $logLevel = 0;
	...
	public function IsThurlyOSMode()
	{
		return $this->thurlyosMode;
	}
}
?>