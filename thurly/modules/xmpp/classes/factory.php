<?
include_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/xmpp/classes/interface.php");

class CXMPPFactory
{
	private $classesDir = "/thurly/modules/xmpp/classes/factory_classes";
	...
	public function OnSocNetMessagesAdd($ID, $arFields)
	{
		...
		if (CXMPPUtility::IsThurlyOSMode())
