...
Class xmpp extends CModule
{
	...
	function InstallDB($arParams = array())
	{
		...
		RegisterModuleDependences("main", "OnApplicationsBuildList", "main", '\Thurly\Xmpp\XmppApplication', "onApplicationsBuildList", 100, "modules/xmpp/lib/xmppapplication.php"); // main here is not a mistake
	...
	function UnInstallDB($arParams = array())
	{
		...
		UnRegisterModuleDependences("main", "OnApplicationsBuildList", "main", '\Thurly\Xmpp\XmppApplication', "onApplicationsBuildList", "modules/xmpp/lib/xmppapplication.php"); // main here is not a mistake
	...
	function InstallFiles()
	{
		...
		{
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/xmpp/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin", true, true);
			CopyDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/xmpp/install/themes", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes", true, true);
		}
		return true;
	}
	...
	{
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/xmpp/install/admin", $_SERVER["DOCUMENT_ROOT"]."/thurly/admin");
		DeleteDirFiles($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/xmpp/install/themes", $_SERVER["DOCUMENT_ROOT"]."/thurly/themes");
	...
	function DoInstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("XMPP_INSTALL_TITLE"), $DOCUMENT_ROOT."/thurly/modules/xmpp/install/step.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(GetMessage("XMPP_UNINSTALL_TITLE"), $DOCUMENT_ROOT."/thurly/modules/xmpp/install/unstep.php");
	}
}
?>
