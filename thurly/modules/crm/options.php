...
global $MESS;
include(GetLangFileName($GLOBALS['DOCUMENT_ROOT'].'/thurly/modules/crm/lang/', '/options.php'));
...
if($MOD_RIGHT>='R'):
	...
	ob_start();
	$GLOBALS["APPLICATION"]->IncludeComponent('thurly:intranet.user.selector',
		'',
		array(
	...
	$arOptionsPath = array(
		...
		array('path_to_lead_details', GetMessage('CRM_OPTIONS_PATH_TO_LEAD_DETAILS'), '/crm/lead/details/#lead_id#/', Array('text', '40')),
		...
		array('path_to_lead_widget', GetMessage('CRM_OPTIONS_PATH_TO_LEAD_WIDGET'), '/crm/lead/widget/', Array('text', '40')),
		array('path_to_lead_kanban', GetMessage('CRM_OPTIONS_PATH_TO_LEAD_KANBAN'), '/crm/lead/kanban/', Array('text', '40')),
		...
		array('path_to_deal_details', GetMessage('CRM_OPTIONS_PATH_TO_DEAL_DETAILS'), '/crm/deal/details/#deal_id#/', Array('text', '40')),
		...
		array('path_to_deal_kanban', GetMessage('CRM_OPTIONS_PATH_TO_DEAL_KANBAN'), '/crm/deal/kanban/', Array('text', '40')),
		...
		array('path_to_quote_kanban', GetMessage('CRM_OPTIONS_PATH_TO_QUOTE_KANBAN'), '/crm/quote/kanban/', Array('text', '40')),
		...
		array('path_to_contact_details', GetMessage('CRM_OPTIONS_PATH_TO_CONTACT_DETAILS'), '/crm/contact/details/#contact_id#/', Array('text', '40')),
		array('path_to_contact_import', GetMessage('CRM_OPTIONS_PATH_TO_CONTACT_IMPORT'), '/crm/contact/import/', Array('text', '40')),
		array('path_to_contact_widget', GetMessage('CRM_OPTIONS_PATH_TO_CONTACT_WIDGET'), '/crm/contact/widget/', Array('text', '40')),
		...
		array('path_to_company_details', GetMessage('CRM_OPTIONS_PATH_TO_COMPANY_DETAILS'), '/crm/company/details/#company_id#/', Array('text', '40')),
		array('path_to_company_import', GetMessage('CRM_OPTIONS_PATH_TO_COMPANY_IMPORT'), '/crm/company/import/', Array('text', '40')),
		array('path_to_company_widget', GetMessage('CRM_OPTIONS_PATH_TO_COMPANY_WIDGET'), '/crm/company/widget/', Array('text', '40')),
		...
		array('path_to_invoice_recur', GetMessage('CRM_OPTIONS_PATH_TO_INVOICE_RECUR'), '/crm/invoice/recur/', Array('text', '40')),
		array('path_to_invoice_recur_show', GetMessage('CRM_OPTIONS_PATH_TO_INVOICE_RECUR_SHOW'), '/crm/invoice/recur/show/#invoice_id#/', Array('text', '40')),
		array('path_to_invoice_recur_edit', GetMessage('CRM_OPTIONS_PATH_TO_INVOICE_RECUR_EDIT'), '/crm/invoice/recur/edit/#invoice_id#/', Array('text', '40')),		
		...
		array('path_to_invoice_widget', GetMessage('CRM_OPTIONS_PATH_TO_INVOICE_WIDGET'), '/crm/invoice/widget/', Array('text', '40')),
		array('path_to_invoice_kanban', GetMessage('CRM_OPTIONS_PATH_TO_INVOICE_KANBAN'), '/crm/invoice/kanban/', Array('text', '40')),
		...
		array('path_to_deal_category_list', GetMessage('CRM_OPTIONS_PATH_TO_DEAL_CATEGORY_LIST'), '/crm/configs/deal_category/', Array('text', '40')),
		array('path_to_deal_category_edit', GetMessage('CRM_OPTIONS_PATH_TO_DEAL_CATEGORY_EDIT'), '/crm/configs/deal_category/&open_edit=#category_id#', Array('text', '40')),
		array('path_to_webform_list', GetMessage('CRM_OPTIONS_PATH_TO_WEBFORM_LIST'), '/crm/webform/list/', Array('text', '40')),
		array('path_to_webform_edit', GetMessage('CRM_OPTIONS_PATH_TO_WEBFORM_EDIT'), '/crm/webform/edit/#form_id#/', Array('text', '40')),
		array('path_to_webform_fill', GetMessage('CRM_OPTIONS_PATH_TO_WEBFORM_FILL'), '/pub/form/#form_code#/#form_sec#/', Array('text', '40')),
		array('path_to_button_list', GetMessage('CRM_OPTIONS_PATH_TO_BUTTON_LIST'), '/crm/button/', Array('text', '40')),
		array('path_to_button_edit', GetMessage('CRM_OPTIONS_PATH_TO_BUTTON_EDIT'), '/crm/button/edit/#id#/', Array('text', '40')),
...
if($MOD_RIGHT>='Y' || $USER->IsAdmin()):
	...
	if ($REQUEST_METHOD=='GET' && strlen($RestoreDefaults)>0 && check_thurly_sessid())
	{
		COption::RemoveOption($module_id);
	}

	if($REQUEST_METHOD=='POST' && strlen($Update)>0 && check_thurly_sessid())
	{
...
function RestoreDefaults()
{
	if(confirm('<?echo AddSlashes(GetMessage('MAIN_HINT_RESTORE_DEFAULTS_WARNING'))?>'))
		window.location = "<?echo $APPLICATION->GetCurPage()?>?RestoreDefaults=Y&lang=<?echo LANG?>&mid=<?echo urlencode($mid)."&".thurly_sessid_get();?>";
}
</script>
