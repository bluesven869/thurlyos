...
{
	$schemeID = \Thurly\Crm\Conversion\QuoteConversionConfig::getCurrentSchemeID();
	...
	$arResult['BUTTONS'][] = array(
		...
		'PARAMS' => array(
			...
			'SCHEME_ID' => $schemeID,
			'SCHEME_NAME' => \Thurly\Crm\Conversion\QuoteConversionScheme::resolveName($schemeID),
			'SCHEME_DESCRIPTION' => \Thurly\Crm\Conversion\QuoteConversionScheme::getDescription($schemeID),
