...
{
	AddEventHandler('crm', 'onCrmQuoteListItemBuildMenu', array('\Thurly\Crm\CallList\CallList', 'handleOnCrmQuoteListItemBuildMenu'));
}
...
if (!$bInternal)
{
	...
	$arResult['FILTER'] = array(
		...
		array(
			...
			'name' => GetMessage('CRM_COLUMN_STATUS_ID'),
			'default' => true,
		...
		array(
			'id' => 'LEAD_ID',
			'name' => GetMessage('CRM_COLUMN_LEAD_LIST'),
			'type' => 'custom_entity',
			'selector' => array(
				'TYPE' => 'crm_entity',
				'DATA' => array(
		...
		array(
			'id' => 'DEAL_ID',
			'name' => GetMessage('CRM_COLUMN_DEAL_LIST'),
			'type' => 'custom_entity',
			'selector' => array(
				'TYPE' => 'crm_entity',
				'DATA' => array(
		...
		array(
			'id' => 'MYCOMPANY_ID',
			'name' => GetMessage('CRM_COLUMN_MYCOMPANY_LIST'),
			'type' => 'custom_entity',
			'selector' => array(
				'TYPE' => 'crm_entity',
				'DATA' => array(
		...
		array('id' => 'MYCOMPANY_TITLE', 'name' => GetMessage('CRM_COLUMN_MYCOMPANY_TITLE1')),
	...
	{
		if(CCrmQuote::GetSemanticID($statusID) === Thurly\Crm\PhaseSemantics::PROCESS)
		{
