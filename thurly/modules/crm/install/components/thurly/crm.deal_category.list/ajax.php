...
if($mode === 'SAVE')
{
	...
	if($isDeafult)
	{
		Thurly\Crm\Category\DealCategory::setDefaultCategoryName(
	...
	elseif($itemID > 0)
	{
		try
		{
			Thurly\Crm\Category\DealCategory::update($itemID, $fields);
		}
	...
	else
	{
		try
		{
			$itemID = Thurly\Crm\Category\DealCategory::add($fields);
		}
