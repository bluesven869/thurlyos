...
{
	$config = \Thurly\Crm\Conversion\LeadConversionManager::create(array(
		'IS_RC' => $arResult['isReturnCustomer']
	))->getConfig();
...
$schemeID = \Thurly\Crm\Conversion\LeadConversionManager::create(array(
	'IS_RC' => $arResult['isReturnCustomer']
))->getCurrentSchemeID();
