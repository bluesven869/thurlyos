...
if (!CModule::IncludeModule('crm') || !CCrmSecurityHelper::IsAuthorized() || !check_thurly_sessid() || $_SERVER['REQUEST_METHOD'] != 'POST')
{
	die();
}
...
if($action === 'INDEX')
{
	...
	if($pathToShow === '')
	{
		$pathToShow = COption::GetOptionString('crm', 'path_to_lead_show');
	}
