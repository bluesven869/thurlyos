...
?>
<form action="/thurly/components/thurly/crm.activity.subscribe.add/component.ajax.php" target="add_sbscribe" name="load_form" method="post" enctype="multipart/form-data">
<?=thurly_sessid_post()?>
