...
$APPLICATION->IncludeComponent(
	'thurly:crm.config.locations.menu',
	'',
	array(
...
if(CSaleLocation::isLocationProEnabled() && !isset($_REQUEST['PARENT_ID']))
{
	$_REQUEST['PARENT_ID'] = '0';
}

$APPLICATION->IncludeComponent(
	'thurly:crm.config.locations.list'.(CSaleLocation::isLocationProEnabled() ? '.v2' : ''),
	'',
	array(
		'PATH_TO_LOCATIONS_LIST' => $arResult['PATH_TO_LOCATIONS_LIST'],
		'PATH_TO_LOCATIONS_ADD' => $arResult['PATH_TO_LOCATIONS_ADD'],
