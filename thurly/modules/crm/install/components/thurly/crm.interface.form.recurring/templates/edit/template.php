...
use Thurly\Crm\Recurring\Manager;
use Thurly\Crm\Recurring\Calculator;
use Thurly\Crm\Recurring\Entity\Base;
use Thurly\Crm\Recurring\Entity\Invoice;
					...
					<div class="crm-recur-options-field crm-recur-options-field-left">
						...
						<label class="crm-recur-options-inp-container">
							<select id="yearly-week-day" name="ENTITY_CATEGORY_ID" class="crm-recur-options-inp">
								...
								{
									?>
									<option value="<?=$id?>" <?if($data['CATEGORY_ID'] == $id):?>selected<?endif?>><?=$name?></option>
									<?
								}
								?>
							</select>
