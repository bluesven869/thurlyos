...
if ($id)
{
	$timelineData = Thurly\Crm\Timeline\Entity\TimelineTable::getById($id);
...
$fileFields = $GLOBALS['USER_FIELD_MANAGER']->GetUserFields(\Thurly\Crm\Timeline\CommentController::UF_FIELD_NAME, $id);
if (isset($fileFields['UF_CRM_COMMENT_FILES']))
{
	$fileFields['UF_CRM_COMMENT_FILES']['~EDIT_FORM_LABEL'] = \Thurly\Crm\Timeline\CommentController::UF_COMMENT_FILE_NAME;
