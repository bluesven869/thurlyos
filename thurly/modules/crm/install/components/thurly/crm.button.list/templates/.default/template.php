...
<?
	if ($arResult['PERM_CAN_EDIT'])
	{
		...
		?>
			<a id="CRM_BUTTON_LIST_ADD" href="<?=htmlspecialcharsbx($arResult['PATH_TO_BUTTON_NEW'])?>" class="webform-small-button webform-small-button-blue bx24-top-toolbar-add">
