...
<div class="b24-integration-container">
	...
	<div class="b24-list-subtitle">
		<?=Loc::getMessage("CRM_1C_START_REPORT_INFO_TEXT")?>
	</div>
	<ul class="b24-report-list">
		...
		<li class="b24-integration-list-item b24-integration-count-block-4"><?=Loc::getMessage("CRM_1C_START_REPORT_INFO_4")?></li>
		<li class="b24-integration-list-item b24-integration-count-block-5"><?=Loc::getMessage("CRM_1C_START_REPORT_INFO_5")?></li>
	</ul>
	<div class="b24-integration-border"></div>
</div><!--b24-integration-container-->
