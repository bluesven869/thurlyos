...
if (!CModule::IncludeModule('crm') || !CCrmSecurityHelper::IsAuthorized() || !check_thurly_sessid())
{
	die();
}
...
$ajaxLoaderParams = array(
	'url' => '/thurly/components/thurly/crm.requisite.list/lazyload.ajax.php?&site='.SITE_ID.'&'.thurly_sessid_get(),
	'method' => 'POST',
	'dataType' => 'ajax',
