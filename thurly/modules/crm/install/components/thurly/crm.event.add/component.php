...
if($entityTypeID === CCrmOwnerType::Undefined
	|| !\Thurly\Crm\Security\EntityAuthorization::checkUpdatePermission($entityTypeID, $entityID, $CCrmPerms)
)
{
			...
			case 'LEAD':
			{
				if (isset($_POST['STATUS_ID']))
				{
						...
						&& $arPrevious['STATUS_ID'] !== $statusID)
					{
						...
						//Region automation
						\Thurly\Crm\Automation\Factory::runOnStatusChanged(\CCrmOwnerType::Lead, $entityID);
						//end region
					}
				}
			...
			case 'DEAL':
				if (isset($_POST['STAGE_ID']))
				{
						...
						&& $arPrevious['STAGE_ID'] !== $stageID)
					{
						...
						//Region automation
						\Thurly\Crm\Automation\Factory::runOnStatusChanged(\CCrmOwnerType::Deal, $entityID);
						//end region
					}
				}
			break;
