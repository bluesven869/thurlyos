...
$asset->addJs('/thurly/js/main/utils.js');
$asset->addJs('/thurly/js/main/popup_menu.js');
...
if(!Thurly\Main\Grid\Context::isInternalRequest() && isset($arParams['~FILTER']) && isset($arParams['~FILTER_PRESETS']))
{
