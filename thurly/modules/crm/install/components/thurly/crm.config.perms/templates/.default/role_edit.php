...
$APPLICATION->IncludeComponent(
	'thurly:crm.config.perms.role.edit',
	'',
	Array(
...
BX.ready(
	function()
	{
		...
		var mgr = BX.CrmEntityAccessManager.create("mgr", { serviceUrl: "<?=SITE_DIR?>thurly/components/thurly/crm.config.perms/ajax.php?&<?=thurly_sessid_get()?>" });
		//COMPANY
		BX.addCustomEvent(
			mgr,
