if (typeof(CrmAdsLeadAds) === "undefined")
{
	...
	CrmAdsLeadAds .prototype = {
		...
		btnState: {
			...
			classNameWait: 'webform-small-button-wait',
			classNameSend: 'webform-small-button-blue',
			...
			changeFieldsEnable: function()
			{
				...
				this.caller.uiNodes.account.disabled = isDisabled;
