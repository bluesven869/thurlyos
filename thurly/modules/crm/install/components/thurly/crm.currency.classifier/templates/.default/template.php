...
$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/crm.entity.editor/templates/.default/style.css");
$APPLICATION->SetAdditionalCSS("/thurly/js/crm/css/slider.css");
?>
...
<form method="POST" id="currency_add" name="currency_add">
	...
	<input id="current_form_mode" name="current_form_mode" type="hidden" value="<?= $arResult['CURRENT_FORM_MODE']?>">
	<input id="target_form_mode" name="target_form_mode" type="hidden" value="<?= $arResult['TARGET_FORM_MODE']?>">
