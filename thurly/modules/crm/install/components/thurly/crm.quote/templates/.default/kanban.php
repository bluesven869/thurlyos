...
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.quote.menu/component.php');
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.quote.list/templates/.default/template.php');
