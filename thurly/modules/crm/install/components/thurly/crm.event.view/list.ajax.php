...
if(!function_exists('__CrmEventViewEndResonse'))
{
	function __CrmEventViewEndResonse($result)
	{
...
{
	__CrmEventViewEndResonse(array('ERROR' => 'Could not include crm module.'));
}

$userPerms = CCrmPerms::GetCurrentUserPermissions();
if(!CCrmPerms::IsAuthorized())
{
	__CrmEventViewEndResonse(array('ERROR' => 'Access denied.'));
}
...
if ($action === 'GET_ROW_COUNT')
{
	...
	{
		__CrmEventViewEndResonse(array('DATA' => array('TEXT' => '')));
	}
	...
	__CrmEventViewEndResonse(array('DATA' => array('TEXT' => $text)));
}
?>