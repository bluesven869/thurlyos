...
$arResult['PATH_TO_EVENT_DELETE'] =  CHTTP::urlAddParams($arParams['PATH_TO_EVENT_LIST'], array('sessid' => thurly_sessid()));
...
$restriction = \Thurly\Crm\Restriction\RestrictionManager::getHistoryViewRestriction();
		...
		while($arFile = $rsFile->Fetch())
		{
			$arFiles[$i++] = array(
				...
				'PATH' => CComponentEngine::MakePathFromTemplate(
					'/thurly/components/thurly/crm.event.view/show_file.php?eventId=#event_id#&fileId=#file_id#',
