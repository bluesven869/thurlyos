...
$arFields['COMPANY_IDS'] = \Thurly\Crm\Binding\ContactCompanyTable::getContactCompanyIDs($arResult['ELEMENT_ID']);
...
if (CCrmCompany::CheckReadPermission(0, $userPermissions))
{
	$arResult['FIELDS']['tab_1'][] = array(
		...
		'componentParams' => array(
			...
			'LOADER' => array(
				'URL' => '/thurly/components/thurly/crm.company.show/ajax.php?siteID='.SITE_ID.'&'.thurly_sessid_get()
			),
