...
<div class="crm-config-external-plugins-platform-container">
	...
	<div class="crm-config-external-plugins-platform">
		...
		<div class="crm-config-external-plugins-platform-item icon-1c-thurly">
			<a href="<?= $uri->addParams(array('cms' => '1cthurly'))->getUri()?>" class="crm-config-external-plugins-platform-icon"></a>
		</div>
		<?endif;*/?>
