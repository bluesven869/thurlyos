...
foreach($arResult['TAX_RATES'] as $key => &$arTaxRate)
{
	...
	if($arResult['CAN_EDIT'])
	{
		...
		$taxRateEditDialog = "javascript:(new BX.CDialog({'content_url':'/thurly/components/thurly/crm.config.tax.rate.edit/box.php?FORM_ID=".$arParams['TAX_FORM_ID']."&TAX_ID=".$arResult['TAX_ID']."&ID=".$key."', 'width':'".$width."', 'height':'".$height."', 'resizable':".$resizable." })).Show(); return false;";
