...
function ExtSaleGetRemoteForm(externalSaleId, action, id)
{
	...
	if (action == "CREATE")
		url = "/thurly/tools/crm_sale_proxy.php?" + externalSaleId + "/thurly/admin/sale_order_new.php?param=1";
	else if (action == "EDIT")
		url = "/thurly/tools/crm_sale_proxy.php?" + externalSaleId + "/thurly/admin/sale_order_new.php?ID=" + id;
	else if (action == "VIEW")
		url = "/thurly/tools/crm_sale_proxy.php?" + externalSaleId + "/thurly/admin/sale_order_detail.php?ID=" + id;
	else if (action == "PRINT")
		url = "/thurly/tools/crm_sale_proxy.php?" + externalSaleId + "/thurly/admin/sale_order_print.php?ID=" + id;
