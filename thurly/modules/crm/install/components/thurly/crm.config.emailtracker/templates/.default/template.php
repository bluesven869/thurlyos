			...
			<div id="mail-set-third" class="mail-set-third-wrap" style="display: block; ">
				<div class="mail-set-third">
					...
					<? if (!empty($arParams['MAILBOX'])): ?>
						...
						<? $lastMailCheck = \Thurly\Main\Config\Option::get('mail', 'last_mail_check', null, SITE_ID); ?>
						<? $lastMailCheckSuccess = \Thurly\Main\Config\Option::get('mail', 'last_mail_check_success', null, SITE_ID); ?>
