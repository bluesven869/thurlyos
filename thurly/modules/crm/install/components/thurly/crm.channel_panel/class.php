...
use Thurly\Crm\Integration\Channel\EmailTracker;
use Thurly\Crm\Integration\Channel\VoxImplantTracker;
use Thurly\Crm\Integration\Channel\IMOpenLineTracker;

Loc::loadMessages(__FILE__);

class CCrmChannelPanelComponent extends CThurlyComponent
{
	//region Fields
	/** @var int  */
	protected $userID = 0;
