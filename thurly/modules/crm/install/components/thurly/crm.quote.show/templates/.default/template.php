...
if($arResult['ENABLE_DISK'])
{
	CCrmComponentHelper::RegisterScriptLink('/thurly/js/crm/disk_uploader.js');
	$APPLICATION->SetAdditionalCSS('/thurly/js/disk/css/legacy_uf_common.css');
}
if($arResult['ENABLE_WEBDAV'])
{
	$APPLICATION->SetAdditionalCSS('/thurly/components/thurly/webdav/templates/.default/style.css');
	$APPLICATION->SetAdditionalCSS('/thurly/components/thurly/webdav.user.field/templates/.default/style.css');
	$APPLICATION->SetAdditionalCSS('/thurly/js/webdav/css/file_dialog.css');

	CCrmComponentHelper::RegisterScriptLink('/thurly/js/main/core/core_dd.js');
	CCrmComponentHelper::RegisterScriptLink('/thurly/js/main/file_upload_agent.js');
	CCrmComponentHelper::RegisterScriptLink('/thurly/js/webdav/file_dialog.js');
	CCrmComponentHelper::RegisterScriptLink('/thurly/js/crm/webdav_uploader.js');
}
...
$APPLICATION->IncludeComponent(
	'thurly:crm.entity.quickpanelview',
	'',
	array(
		...
		'SERVICE_URL' => '/thurly/components/thurly/crm.quote.show/ajax.php?'.thurly_sessid_get(),
		'SHOW_SETTINGS' => 'Y'
	),
	$component,
	array('HIDE_ICONS' => 'Y')
...
$APPLICATION->AddHeadScript('/thurly/js/crm/instant_editor.js');
...
$scriptSettings = array(
	...
	'url' => '/thurly/components/thurly/crm.quote.show/ajax.php?'.thurly_sessid_get(),
	'callToFormat' => CCrmCallToUrl::GetFormat(CCrmCallToUrl::Thurly),
	'messages' => array(
	...
	'filesFieldSettings' => array(
		...
		'serviceUrl' => '/thurly/components/thurly/crm.quote.edit/ajax.php?siteID='.SITE_ID.'&'.thurly_sessid_get(),
		'messages' => array(
	...
	BX.ready(function(){
		...
		BX.CrmEntityTreeDispatcher.create(
			'dispatcher<?= CUtil::JSEscape($treeDispatcherID)?>',
			{
				...
				serviceUrl: '/thurly/components/thurly/crm.entity.tree/ajax.php?<?=thurly_sessid_get()?>',
