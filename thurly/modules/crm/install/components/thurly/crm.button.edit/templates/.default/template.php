...
$serverAddress = \Thurly\Crm\SiteButton\ResourceManager::getServerAddress();
...
CJSCore::Init(array('clipboard', 'uploader', 'avatar_editor', 'color_picker'));
...
<script>
	BX.ready(function(){
		new CrmButtonEditor(<?=Json::encode(array(
			...
			'isItemWasAdded' => $arResult['IS_ITEM_WAS_ADDED'],
...
<?$this->SetViewTarget('pagetitle', 5);?>
	<a id="CRM_BUTTON_EDIT_TO_LIST" href="<?=htmlspecialcharsbx($arResult['PATH_TO_BUTTON_LIST'])?>" class="crm-button-edit-list-back"><?=Loc::getMessage('CRM_WEBFORM_EDIT_SELECT_BACK_TO_BUTTON_LIST1')?></a>
<?$this->EndViewTarget();?>
		...
		<div id="BUTTON_COLOR_CONTAINER">
			<div class="crm-button-edit-sidebar-button-preview-container">
				<div id="BUTTON_VIEW_CONTAINER" class="crm-button-edit-sidebar-button-preview-inner">
					<?
					$APPLICATION->IncludeComponent("thurly:crm.button.button", ".default", array(
						'PREVIEW' => true,
						'LOCATION' => 1,
	...
	?>
		...
		<div class="crm-button-edit-left-send-container">
			<div class="crm-button-edit-left-send-inner">
				<?if ($arParams['IFRAME']):?>
					<input id="CRM_BUTTON_APPLY" type="submit" name="submit_apply" class="ui-btn ui-btn-success" value="<?=Loc::getMessage('CRM_WEBFORM_EDIT_APPLY')?>">
				<?else:?>
					<input id="CRM_BUTTON_SAVE" type="submit" class="ui-btn ui-btn-success" value="<?=Loc::getMessage('CRM_WEBFORM_EDIT_SAVE')?>">
					<input id="CRM_BUTTON_APPLY" type="submit" name="submit_apply" class="ui-btn ui-btn-light-border" value="<?=Loc::getMessage('CRM_WEBFORM_EDIT_APPLY')?>">
				<?endif;?>
				<a id="CRM_BUTTON_EDIT_TO_LIST_BOTTOM" href="<?=htmlspecialcharsbx($arResult['PATH_TO_BUTTON_LIST'])?>" class="ui-btn ui-btn-link"><?=Loc::getMessage('CRM_WEBFORM_EDIT_SELECT_BACK_TO_LIST')?></a>
			</div>
...
function getCrmButtonEditTemplateConnector($replace = array())
{
	...
	<label class="crm-button-edit-channel-lines-social-label" for="items_openline_config_%lineid%_%connector%">
		<span data-hint="" class="crm-button-edit-channel-lines-social-item connector-icon connector-icon-%connector%"></span>
