...
use Thurly\Crm\SiteButton\Manager;
use Thurly\Crm\SiteButton\ChannelManager;
use Thurly\Crm\SiteButton\Button;
use Thurly\Crm\SiteButton\Internals;
use Thurly\Crm\SiteButton\WorkTime;
...
class CCrmSiteButtonEditComponent extends \CThurlyComponent
{
	...
	protected function processPostItems($items)
	{
		...
		foreach ($typeList as $typeItem)
		{
			...
			{
				$config = \Thurly\Crm\SiteButton\Channel\ChannelOpenLine::getConfigFromPost($item);
				$externalIdTmp = array();
	...
	protected function redirectToDetail($urlAdd = array())
	{
		...
		if ($this->arParams['IFRAME'] && $this->isItemWasAdded)
		{
	...
	public function prepareResult()
	{
		...
		$this->arResult['SCRIPT'] = \Thurly\Crm\SiteButton\Script::getScript($this->button);
