...
use Thurly\Crm\Counter\EntityCounter;
use Thurly\Crm\Counter\EntityCounterType;
use Thurly\Crm\Counter\EntityCounterFactory;

Loc::loadMessages(__FILE__);

class CCrmEntityCounterPanelComponent extends CThurlyComponent
{
	/** @var int */
	protected $userID = 0;
	/** @var string */
	...
	protected function initialize()
	{
		...
		$this->arResult['ENTITY_NUMBER_DECLENSIONS'] = \Thurly\Crm\MessageHelper::getEntityNumberDeclensionMessages($this->entityTypeID);
