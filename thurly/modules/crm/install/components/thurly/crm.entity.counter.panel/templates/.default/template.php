...
\Thurly\Main\Page\Asset::getInstance()->addJs('/thurly/js/crm/counter.js');
			...
			function()
			{
				BX.CrmEntityCounterPanel.create(
					"<?=CUtil::JSEscape($guid)?>",
					{
						...
						serviceUrl: "<?='/thurly/components/thurly/crm.entity.counter.panel/ajax.php?'.thurly_sessid_get()?>",
