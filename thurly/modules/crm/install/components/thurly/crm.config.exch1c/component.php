...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['CRM_EXCH1C_ENABLE']) && check_thurly_sessid())
{
...
$arResult['EXCH_1C_INFORMATION_URL'] = ($GLOBALS['APPLICATION']->IsHTTPS() ? 'https://' : 'http://').'www.thurlyos.ru/blogs/howto/integration1c.php';
