						...
						<div class="crm-config-ps-list-widget-content-amt">
							<div class="crm-config-ps-list-widget-content-image">
								<a href="<?=$paySystem['PATH_TO_PS_EDIT'];?>">
									...
									{
										$logo = '/thurly/images/sale/sale_payments/'.$paySystem["HANDLER"].'.png';
										if (!\Thurly\Main\IO\File::isFileExists($_SERVER['DOCUMENT_ROOT'].$logo))
										{
											$logo = '/thurly/images/sale/sale_payments/default.png';
										}
									}
