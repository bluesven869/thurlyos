				...
				if(BX.type.isNotEmptyString(nodeId))
				{
					var node = BX.CrmWidgetSlotNode.create(
						nodeId,
						{
							...
							enableThurlyOSHelper: this.getSetting("enableThurlyOSHelper", false),
...
if(typeof(BX.CrmWidgetSlotNode) === "undefined")
{
	...
	BX.CrmWidgetSlotNode.prototype =
	{
		...
		{
			var enableThurlyOSHelper = this.getSetting("enableThurlyOSHelper", false);
			var helpUrl = this.getSetting("helpUrl");
			if(enableThurlyOSHelper && BX.type.isNotEmptyString(helpUrl))
			{
