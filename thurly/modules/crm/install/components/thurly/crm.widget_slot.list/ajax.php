...
if($action == 'SAVE_BINDINGS')
{
	...
	$bindingMap = Thurly\Crm\Statistics\StatisticFieldBindingMap::createFromArray($bindings);
	if($bindingMap->getCount() > Thurly\Crm\Statistics\StatisticEntryManager::getSlotLimit())
	{
		__ajaxEndJsonResonse(array('ERROR' => 'Slot limit is exceeded.'));
	}

	Thurly\Crm\Statistics\StatisticEntryManager::setSlotBindingMap($ID, $bindingMap);
