			...
			<?if(!$arResult['HIDE_DESC_FZ152']):?>
				...
				<div class="crm-webform-list-info-inner">
					...
					<div class="crm-webform-list-info-list-container">
						...
						<a onclick="BX.Helper.show('redirect=detail&HD_ID=5791365'); return false;" href="https://helpdesk.thurlyos.ru/?url=open/5791365/" target="_blank">
				...
				<div class="crm-webform-list-widget-content">
					<div class="crm-webform-list-widget-content-amt">
						<?foreach ($item['ADS_FORM'] as $adsFormService):
							...
							?>
							<span data-bx-crm-webform-ads-btn="<?=htmlspecialcharsbx($adsFormService['TYPE'])?>" data-bx-ads-name="<?=htmlspecialcharsbx($adsFormService['NAME'])?>" data-hint="<?=Loc::getMessage('CRM_WEBFORM_LIST_ADS_FORM_DESC_HINT')?>" class="crm-webform-list-widget-content-lead-ads">
								<?=Loc::getMessage('CRM_WEBFORM_LIST_ADS_FORM_STATUS_ON_FACEBOOK')?>
							</span>
							<?
							endif;
						endforeach;?>
...
?>
	<span id="webform_filter_active" class="webform-small-button webform-small-button-transparent webform-small-button-dropdown">
	...
	<a id="CRM_WEBFORM_LIST_ADD" href="<?=htmlspecialcharsbx($arResult['PATH_TO_WEB_FORM_NEW'])?>" class="webform-small-button webform-small-button-blue">
