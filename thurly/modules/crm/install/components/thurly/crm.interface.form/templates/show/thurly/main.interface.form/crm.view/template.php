				...
				<?endif;
						...
						case 'crm_activity_list':
										...
										function()
										{
											BX.CrmFormTabLazyLoader.create(
												"<?=CUtil::JSEscape($prefix).'_activities'?>",
												{
													...
													serviceUrl: "/thurly/components/thurly/crm.activity.list/lazyload.ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>",
							...
							else
							{
								...
								$APPLICATION->IncludeComponent('thurly:crm.activity.list',
						...
						case 'crm_event_view':
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.event.view',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_deal_list':
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.deal.list',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_quote_list':
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.quote.list',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_invoice_list':
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.invoice.list',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_company_list':
										...
										function()
										{
											BX.CrmFormTabLazyLoader.create(
												"<?=CUtil::JSEscape($prefix).'_company'?>",
												{
													...
													serviceUrl: "/thurly/components/thurly/crm.company.list/lazyload.ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>",
													formID: "<?=CUtil::JSEscape($arParams['FORM_ID'])?>",
													tabID: "tab_company",
													params: <?=CUtil::PhpToJSObject($componentData)?>
												}
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.company.list',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_contact_list':
										...
										function()
										{
											BX.CrmFormTabLazyLoader.create(
												"<?=CUtil::JSEscape($prefix).'_contact'?>",
												{
													...
													serviceUrl: "/thurly/components/thurly/crm.contact.list/lazyload.ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>",
													formID: "<?=CUtil::JSEscape($arParams['FORM_ID'])?>",
													tabID: "tab_contact",
													params: <?=CUtil::PhpToJSObject($componentData)?>
												}
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.contact.list',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_lists_element':
							...
							$serviceUrl = '/thurly/components/thurly/lists.element.attached.crm/lazyload.ajax.php?&site='
								.SITE_ID.'&'.thurly_sessid_get().'';
							if($enableLazyLoad === true)
							{
							?>
							...
							{
								$APPLICATION->IncludeComponent('thurly:lists.element.attached.crm',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y')
						...
						case 'crm_requisite_list':
										...
										function()
										{
											BX.CrmFormTabLazyLoader.create(
												"<?=CUtil::JSEscape($prefix).'_requisite'?>",
												{
													...
													serviceUrl: "/thurly/components/thurly/crm.requisite.list/lazyload.ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>",
													formID: "<?=CUtil::JSEscape($arParams['FORM_ID'])?>",
													tabID: "tab_requisite",
													params: <?=CUtil::PhpToJSObject($componentData)?>
												}
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.requisite.list',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
						...
						case 'crm_automation':
							...
							else
							{
								//Disable control panel in internal mode
								$componentParams['ENABLE_CONTROL_PANEL'] = false;
								$APPLICATION->IncludeComponent('thurly:crm.automation',
									isset($componentData['template']) ? $componentData['template'] : '',
									$componentParams,
									false,
									array('HIDE_ICONS' => 'Y', 'ACTIVE_COMPONENT'=>'Y')
