...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'TABS' => $arResult['TABS'],
		'SERVICE_URL' => '/thurly/components/thurly/crm.company.details/ajax.php?action=convert&'.thurly_sessid_get(),
		'EDITOR' => array(
			'GUID' => "{$guid}_editor",
			...
			'SERVICE_URL' => '/thurly/components/thurly/crm.company.details/ajax.php?'.thurly_sessid_get(),
