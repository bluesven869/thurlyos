...
?><script type="text/javascript">
	BX.ready(
		function()
		{
			BX.CrmDealCategory.infos = <?=CUtil::PhpToJSObject(Thurly\Crm\Category\DealCategory::getJavaScriptInfos())?>;
...
?><div class="bx-crm-view"><?
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'PATH_TO_DEMO_DATA' => $_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.deal/templates/.default/widget',
