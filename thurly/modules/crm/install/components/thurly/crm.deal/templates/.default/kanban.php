...
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.deal.menu/component.php');
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.deal.list/templates/.default/template.php');
...
// check accessable
if (!Thurly\Crm\Integration\ThurlyOSManager::isAccessEnabled(\CCrmOwnerType::Deal))
{
...
else
{
	...
	$APPLICATION->IncludeComponent(
		'thurly:crm.deal_category.panel',
		$isThurlyOSTemplate ? 'tiny' : '',
		array(
