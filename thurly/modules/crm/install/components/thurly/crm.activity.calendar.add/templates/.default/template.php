...
?>
<form action="/thurly/components/thurly/crm.activity.calendar.add/component.ajax.php" target="add_calendarfr" name="load_form" method="post" enctype="multipart/form-data" style="padding-top: 10px;">
<?
if (!empty($arResult['ERROR_MESSAGE']))
{
