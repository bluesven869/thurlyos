...
<?
	...
	{
		$config['selected'] = \Thurly\Crm\Automation\Helper::prepareDiskAttachments(
			$dialog->getCurrentValue($attachment['FieldName'])
		);
	}
	else
	{
		$config['selected'] = \Thurly\Crm\Automation\Helper::prepareFileAttachments(
...
<script>
	...
	BX.ready(function ()
	{
		...
		var mailboxes = <?=\Thurly\Main\Web\Json::encode($mailboxes);?>;
