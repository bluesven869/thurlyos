...
{
	$messageTextValue = htmlspecialcharsback($messageTextValue);
}
...
$from = isset($map['From']) ? $map['From'] : null;
...
<div style="display:none;">
	<?
	$APPLICATION->IncludeComponent('thurly:main.mail.confirm', '');
	?>
</div>
<tr>
...
<tr>
	...
	<td width="60%">
		...
		{
			$object = \Thurly\Disk\File::loadById($fileId);
			if ($object)
			{
		...
		<?
			...
			), $fileValues, true, \Thurly\Bizproc\FieldType::RENDER_MODE_DESIGNER);
		?>
		</div>
	</td>
</tr>
