BX.CrmDiskUploader = function()
{
	...
	this._uploadFileUrl = "/thurly/tools/disk/uf.php?action=uploadfile";
	this._selectFileUrl = "/thurly/tools/disk/uf.php?action=selectFile";
...
BX.CrmDiskUploader.prototype =
{
	...
	prepareEditLayout: function(parent)
	{
		...
		this._form.appendChild(
			BX.create("INPUT",
				{ props: { type: "hidden", name: "sessid", value: BX.thurly_sessid() } }
			)
		);
