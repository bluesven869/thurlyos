...
$arPSCorrespondence = array(
		...
		"SELLER_DIR_POS" => array(
				...
				"VALUE" => Loc::getMessage("SBLP_Q_FR_DIR_POS_SUPPLI_VAL", null, $lng),
				"TYPE" => "",
				"GROUP" => "SELLER_COMPANY",
				"SORT" => 1500
			),
		"SELLER_ACC_POS" => array(
				...
				"VALUE" => Loc::getMessage("SBLP_Q_FR_ACC_POS_SUPPLI_VAL", null, $lng),
				"TYPE" => "",
				"GROUP" => "SELLER_COMPANY",
				"SORT" => 1600
			),
		...
		"QUOTE_FR_HEADER_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_HEADER_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'GENERAL_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_FR_TOTAL_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_TOTAL_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'GENERAL_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_FR_SIGN_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_SIGN_SHOW"),
				"DESCR" => "",
				"VALUE" => 'Y',
				"GROUP" => 'SELLER_COMPANY',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_FR_COLUMN_NUMBER_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_NUMBER_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_NUMBER_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 4600
			),
		"QUOTE_FR_COLUMN_NUMBER_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 100,
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
		...
		"QUOTE_FR_COLUMN_NUMBER_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "CHECKBOX",
		...
		"QUOTE_FR_COLUMN_NAME_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_NAME_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_NAME_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 4900
			),
		"QUOTE_FR_COLUMN_NAME_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 200,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_NAME_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_QUANTITY_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_QUANTITY_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_QUANTITY_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5200
			),
		"QUOTE_FR_COLUMN_QUANTITY_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 300,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_QUANTITY_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_MEASURE_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_MEASURE_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_MEASURE_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5500
			),
		"QUOTE_FR_COLUMN_MEASURE_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 400,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_MEASURE_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_PRICE_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_PRICE_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_PRICE_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 5800
			),
		"QUOTE_FR_COLUMN_PRICE_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 500,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_PRICE_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_VAT_RATE_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_VAT_RATE_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_VAT_RATE_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6100
			),
		"QUOTE_FR_COLUMN_VAT_RATE_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 600,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_VAT_RATE_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_DISCOUNT_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_DISCOUNT_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_DISCOUNT_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6400
			),
		"QUOTE_FR_COLUMN_DISCOUNT_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 700,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_DISCOUNT_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_SUM_TITLE" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_TITLE").'"'.Loc::getMessage("SBLP_Q_FR_COLUMN_SUM_VALUE", null, $lng).'"',
				"DESCR" => "",
				"VALUE" => Loc::getMessage("SBLP_Q_FR_COLUMN_SUM_VALUE", null, $lng),
				"GROUP" => 'COLUMN_SETTINGS',
				"TYPE" => "",
				"SORT" => 6700
			),
		"QUOTE_FR_COLUMN_SUM_SORT" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SORT"),
				"DESCR" => "",
				"VALUE" => 800,
				"GROUP" => 'COLUMN_SETTINGS',
		...
		"QUOTE_FR_COLUMN_SUM_SHOW" => array(
				"NAME" => Loc::getMessage("SBLP_Q_FR_COLUMN_SHOW"),
				"DESCR" => "",
				"VALUE" => "Y",
				"GROUP" => 'COLUMN_SETTINGS',
