...
(
	...
	INDEX IX_LEAD_5 (BIRTHDAY_SORT, ASSIGNED_BY_ID, ID),
	INDEX IX_LEAD_6 (BIRTHDATE, ID),
	INDEX IX_LEAD_7 (HAS_PHONE, ID),
	INDEX IX_LEAD_8 (HAS_EMAIL, ID),
	INDEX IX_LEAD_9 (HAS_PHONE, HAS_EMAIL, ID),
	INDEX IX_LEAD_10 (STATUS_SEMANTIC_ID, ID),
	INDEX IX_LEAD_11 (ASSIGNED_BY_ID, STATUS_SEMANTIC_ID, ID),
...
(
	...
	INDEX IX_DEAL_4 (CATEGORY_ID, ID),
	INDEX IX_DEAL_5 (STAGE_SEMANTIC_ID, ID),
	INDEX IX_DEAL_6 (IS_NEW, ID),
	INDEX IX_DEAL_7 (ASSIGNED_BY_ID, STAGE_SEMANTIC_ID, CATEGORY_ID, ID),
	INDEX IX_DEAL_8 (WEBFORM_ID),
	INDEX IX_DEAL_9 (DATE_CREATE, STAGE_SEMANTIC_ID, ID),
...
(
	...
	INDEX IX_CONTACT_BDAY (BIRTHDAY_SORT, ASSIGNED_BY_ID, ID),
	INDEX IX_CONTACT_BDATE (BIRTHDATE, ID),
	INDEX IX_CONTACT_COMPANY (COMPANY_ID, ID),
	INDEX IX_CONTACT_PHONE (HAS_PHONE, ID),
	INDEX IX_CONTACT_EMAIL (HAS_EMAIL, ID),
	INDEX IX_CONTACT_COMM (HAS_PHONE, HAS_EMAIL, ID),
...
(
	...
	INDEX IX_COMPANY_PHONE (HAS_PHONE, ID),
	INDEX IX_COMPANY_EMAIL (HAS_EMAIL, ID),
	INDEX IX_COMPANY_COMM (HAS_PHONE, HAS_EMAIL, ID),
	INDEX IX_COMPANY_ISMY (IS_MY_COMPANY),
...
(
	...
	INDEX IX_B_CRM_EVENT_3 (CREATED_BY_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_act(
	...
	INDEX IX_B_CRM_ACT_7 (OWNER_ID, OWNER_TYPE_ID, TYPE_ID, COMPLETED, DEADLINE, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_act_comm(
	...
	INDEX IX_B_CRM_ACT_COMM_2(ENTITY_ID, ENTITY_TYPE_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_dp_org_mcd(
	...
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_DP_ORG_MCD_1(TITLE(255), ENTITY_TYPE_ID, ENTITY_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_dp_comm_mcd(
	...
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_DP_COMM_MCD_1(TYPE, VALUE(255), ENTITY_TYPE_ID, ENTITY_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_dp_rq_mcd(
	...
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_DP_RQ_MCD_1(RQ_FIELD_NAME, RQ_COUNTRY_ID, VALUE(32), ENTITY_TYPE_ID, ENTITY_ID, ID),
	INDEX IX_B_CRM_DP_RQ_MCD_2(ENTITY_TYPE_ID, ENTITY_ID, RQ_FIELD_NAME, RQ_COUNTRY_ID, ID)
);
...
CREATE TABLE IF NOT EXISTS b_crm_dp_bd_mcd(
	...
	VALUE VARCHAR(32) NOT NULL,
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_DP_BD_MCD_1(BD_FIELD_NAME, BD_COUNTRY_ID, VALUE(32), ENTITY_TYPE_ID, ENTITY_ID, ID),
	INDEX IX_B_CRM_DP_BD_MCD_2(ENTITY_TYPE_ID, ENTITY_ID, BD_FIELD_NAME, BD_COUNTRY_ID, ID)
);
...
CREATE TABLE IF NOT EXISTS b_crm_addr(
	...
	INDEX IX_B_CRM_ADDR_9(ANCHOR_TYPE_ID, TYPE_ID, ADDRESS_2, ANCHOR_ID),
...
CREATE TABLE IF NOT EXISTS b_crm_lead_status_history(
	...
	IS_JUNK CHAR(1) NULL,
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_LEAD_SHX_1(OWNER_ID, TYPE_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_lead_sum_stat(
	...
	INDEX IX_B_CRM_LEAD_SSTAT_2(SOURCE_ID, OWNER_ID, CREATED_DATE)
);
...
CREATE TABLE IF NOT EXISTS b_crm_lead_act_stat(
	...
	INDEX IX_B_CRM_LEAD_ASTAT_3(IS_JUNK, OWNER_ID, DEADLINE_DATE),
...
CREATE TABLE IF NOT EXISTS b_crm_inv_status_history(
	...
	IS_JUNK CHAR(1) NULL,
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_INV_SHX_1(ACTIVITY_DATE, OWNER_ID, ID),
	INDEX IX_B_CRM_INV_SHX_2(TYPE_ID, CREATED_DATE, STATUS_ID, OWNER_ID, RESPONSIBLE_ID),
	INDEX IX_B_CRM_INV_SHX_3(STATUS_SEMANTIC_ID, ACTIVITY_DATE, OWNER_ID, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_invoice_sum_stat(
	...
	INDEX IX_B_CRM_INV_SSTAT_3(STATUS_SEMANTIC_ID, PAY_BEFORE_DATE, OWNER_ID, CREATED_DATE),
	INDEX IX_B_CRM_INV_SSTAT_4(COMPANY_ID, STATUS_SEMANTIC_ID, IS_PAID_INTIME, OWNER_ID, CREATED_DATE),
	INDEX IX_B_CRM_INV_SSTAT_5(CONTACT_ID, STATUS_SEMANTIC_ID, IS_PAID_INTIME, OWNER_ID, CREATED_DATE)
);
...
CREATE TABLE IF NOT EXISTS b_crm_requisite(
	...
	PRIMARY KEY (ID),
	INDEX IX_B_CRM_REQUISITE_1 (ENTITY_ID, ENTITY_TYPE_ID, SORT, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_bank_detail(
	...
	PRIMARY KEY (ID),
	INDEX IX_B_CRM_BANK_DETAIL_1 (ENTITY_ID, ENTITY_TYPE_ID, SORT, ID),
...
CREATE TABLE IF NOT EXISTS b_crm_webform_view (
  FORM_ID int(18) NOT NULL,
  DATE_CREATE datetime NULL
);
...
CREATE TABLE IF NOT EXISTS b_crm_webform_result (
  ...
  PRIMARY KEY (ID),
  INDEX IX_B_CRM_WEBFORM_RESULT (FORM_ID),
...
CREATE TABLE IF NOT EXISTS b_crm_deal_category(
	...
	SORT INT NOT NULL,
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_DEAL_CAT_1(SORT, ID),
	INDEX IX_B_CRM_DEAL_CAT_2(IS_LOCKED, SORT, ID)
);
...
CREATE TABLE b_crm_utm (
	...
	INDEX IX_B_CRM_UTM(ENTITY_TYPE_ID, ENTITY_ID, CODE, VALUE)
);
...
CREATE TABLE b_crm_timeline(
	ID INT(18) NOT NULL AUTO_INCREMENT,
	TYPE_ID TINYINT(1) UNSIGNED NOT NULL,
	TYPE_CATEGORY_ID TINYINT(1) UNSIGNED,
	CREATED DATETIME NOT NULL,
	AUTHOR_ID INT(1) UNSIGNED NULL,
	ASSOCIATED_ENTITY_ID INT(1),
	...
	SETTINGS TEXT NULL,
	PRIMARY KEY (ID),
	INDEX IX_B_CRM_TIMELINE_1(CREATED, ID),
	INDEX IX_B_CRM_TIMELINE_2(ASSOCIATED_ENTITY_ID, ASSOCIATED_ENTITY_TYPE_ID),
	INDEX IX_B_CRM_TIMELINE_3(TYPE_ID, ID)
);
...
CREATE TABLE b_crm_timeline_bind(
	...
	INDEX IX_B_CRM_TIMELINE_BIND_1(ENTITY_ID, ENTITY_TYPE_ID),
...
CREATE TABLE IF NOT EXISTS b_crm_wait (
	...
	COMPLETED CHAR(1) NOT NULL DEFAULT 'N',
	PRIMARY KEY(ID),
	INDEX IX_B_CRM_WAIT_1(OWNER_ID, OWNER_TYPE_ID, COMPLETED, ID)
);
