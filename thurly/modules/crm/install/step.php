...
<table class="list-table">
	...
	<tr><td><span class="required">*</span><?=GetMessage("WIKI_CREATE_NEW_IBLOCK_NAME")?>: </td><td><input type="text" name="iblock_name" value="<?=htmlspecialchars($_REQUEST["iblock_name"])?>" /></td></tr>
	...
	<tr><td><span class="required">*</span><?=GetMessage("WIKI_CREATE_NEW_FORUM_NAME")?>: </td><td><input type="text" name="forum_name" value="<?=htmlspecialchars($_REQUEST["forum_name"])?>" /></td>
	</tr>
	</tbody>					
	<?
	endif;
	if (IsModuleInstalled("socialnetwork")):
		...
		<tr><td><span class="required">*</span><?=GetMessage("WIKI_CREATE_NEW_SOCNET_IBLOCK_NAME")?>: </td><td><input type="text" name="socnet_iblock_name" value="<?=htmlspecialchars($_REQUEST["socnet_iblock_name"])?>" /></td></tr>
		<tr><td><span class="required">*</span><?=GetMessage("WIKI_CREATE_NEW_SOCNET_IBLOCK_TYPE")?>: </td><td>
			...
			<label for="create_iblock_type_y"><?=GetMessage("WIKI_CREATE")?>: </label> 
			<span class="required">*</span><?=GetMessage("WIKI_ID")?> (ID): 
				<input type="text" name="socnet_iblock_type_name" value="<?=htmlspecialchars($_REQUEST["socnet_iblock_type_name"])?>" <?=($_REQUEST["create_socnet_iblock_type"] != "Y" ? "disabled='disabled'" : "")?>/><br />
			</td></tr>
		</tbody><?
		endif;
		if (IsModuleInstalled("forum") && CModule::IncludeModule("forum") && $GLOBALS["APPLICATION"]->GetGroupRight("forum") >= "W"):
		...
		<tr><td><span class="required">*</span><?=GetMessage("WIKI_CREATE_NEW_SOCNET_FORUM_NAME")?>: </td><td><input type="text" name="socnet_forum_name" value="<?=htmlspecialchars($_REQUEST["socnet_forum_name"])?>" /></td>
		</tr>
		</tbody>					
		<?
		endif;
