...
class QuoteSearchContentRebuildAgent extends EntitySearchContentRebuildAgent
{
	/** @var QuoteSearchContentRebuildAgent|null */
	...
	public static function getInstance()
	{
		...
		{
			self::$instance = new QuoteSearchContentRebuildAgent();
		}
	...
	{
		Option::set('crm', '~CRM_REBUILD_QUOTE_SEARCH_CONTENT_PROGRESS', serialize($data));
	}
	public function getTotalCount()
	{
		return \CCrmQuote::GetList(array(), array('CHECK_PERMISSIONS' => 'N'), array(), false);
	}
	...
	{
		$builder = SearchContentBuilderFactory::create(\CCrmOwnerType::Quote);
