...
class ContactSearchContentRebuildAgent extends EntitySearchContentRebuildAgent
{
	/** @var ContactSearchContentRebuildAgent|null */
	...
	public static function getInstance()
	{
		...
		{
			self::$instance = new ContactSearchContentRebuildAgent();
		}
	...
	{
		return Option::get('crm', '~CRM_REBUILD_CONTACT_SEARCH_CONTENT', 'N') === 'Y';
	}
	public function enable($enable)
	{
		...
		if($enable)
		{
			Option::set('crm', '~CRM_REBUILD_CONTACT_SEARCH_CONTENT', 'Y');
		}
		else
		{
			Option::delete('crm', array('name' => '~CRM_REBUILD_CONTACT_SEARCH_CONTENT'));
		}
		Option::delete('crm', array('name' => '~CRM_REBUILD_CONTACT_SEARCH_CONTENT_PROGRESS'));
	}
	public function getProgressData()
	{
		$s = Option::get('crm', '~CRM_REBUILD_CONTACT_SEARCH_CONTENT_PROGRESS',  '');
	...
	{
		Option::set('crm', '~CRM_REBUILD_CONTACT_SEARCH_CONTENT_PROGRESS', serialize($data));
	}
	...
	{
		$builder = SearchContentBuilderFactory::create(\CCrmOwnerType::Contact);
