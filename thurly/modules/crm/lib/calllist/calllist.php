...
namespace Thurly\Crm\CallList;

use Thurly\Crm\CallList\Internals\CallListCreatedTable;
use Thurly\Crm\CallList\Internals\CallListItemTable;
use Thurly\Crm\CallList\Internals\CallListTable;
...
final class CallList
{
	...
	public function completeAssociatedActivity()
	{
		$filter = array(
			...
			'PROVIDER_ID' => \Thurly\Crm\Activity\Provider\CallList::getId(),
			'PROVIDER_TYPE_ID' => \Thurly\Crm\Activity\Provider\CallList::TYPE_CALL_LIST,
	...
	public function applyOriginalFilter()
	{
		...
		$filterOptions = new \Thurly\Main\UI\Filter\Options($gridId);
	...
	protected static function getEntitiesFromGridId($entityType, $gridId)
	{
		...
		if($entityType != \CCrmOwnerType::InvoiceName && isset($gridFilter['FIND']))
		{
	...
	{
		$filterOptions = new \Thurly\Main\UI\Filter\Options($gridId, array());
	...
	public static function isAvailable()
	{
		...
		return \Thurly\ThurlyOS\Feature::isFeatureEnabled('crm_call_list');
	}
	...
	public static function getLicensePopupContent()
	{
		...
		$text = '<p>'.Loc::getMessage('CRM_CALL_LIST_LICENSE_POPUP_CONTENT').'</p> 
			...
			<strong>'.GetMessage('CRM_CALL_LIST_LICENSE_POPUP_FOOTER').'</strong>';
		return $text;
	}
	...
	public static function getProLink()
	{
		if(LANGUAGE_ID == "ru" || LANGUAGE_ID == "kz" || LANGUAGE_ID == "by")
			return "https://www.thurlyos.ru/pro/crm.php";
		else if(LANGUAGE_ID == "de")
			return "https://www.thurlyos.de/pro/crm.php";
		else if(LANGUAGE_ID == "ua")
			return "https://www.thurlyos.ua/pro/crm.php";
		else
