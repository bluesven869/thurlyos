...
class SaleManager
{
	...
	{
		\Thurly\Main\Config\Option::set('crm', 'check_vat_zero', '0', '');
		...
		\Thurly\Main\Config\Option::set('crm', 'check_vat_zero', '-1', '');
		if ($languageID == 'ru')
		{
			\Thurly\Main\Config\Option::set('crm', 'check_vat_zero', '-2', '');
			...
			{
				\Thurly\Main\Config\Option::set('crm', 'check_vat_zero', '-3', '');
				$fields = array(
					'ACTIVE' => 'Y',
					'SORT' => '100',
				...
				\Thurly\Main\Config\Option::set('crm', 'check_vat_zero', $vatID, '');
			}
		}
	}
}