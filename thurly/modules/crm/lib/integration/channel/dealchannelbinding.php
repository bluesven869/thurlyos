...
use Thurly\Main;
use Thurly\Crm\Statistics\DealChannelStatisticEntry;

/**
 * Class DealChannelBinding
 * Managing of Deal bindings to external channels.
 * @package Thurly\Crm\Integration\Channel
 */
class DealChannelBinding
{
	/**
	...
	public static function copy($srcEntityTypeID, $srcEntityID, $dstEntityID)
	{
