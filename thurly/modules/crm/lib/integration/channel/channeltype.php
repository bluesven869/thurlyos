...
class ChannelType
{
	...
	const EXTERNAL_THURLY_NAME = 'EXTERNAL_THURLY';
	...
	public static function resolveName($typeID)
	{
		...
		if($typeID === self::EXTERNAL_THURLY)
		{
			return self::EXTERNAL_THURLY_NAME;
		}
	...
	public static function resolveID($typeName)
	{
		...
		if($typeName === self::EXTERNAL_THURLY_NAME)
		{
			return self::EXTERNAL_THURLY;
		}
