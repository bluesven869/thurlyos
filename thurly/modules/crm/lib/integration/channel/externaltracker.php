	...
	protected static function getSupportedTypeMap()
	{
		...
		return(
			self::$supportedTypeMap = array(
				...
				ChannelType::EXTERNAL_THURLY => CCrmExternalChannelType::ThurlyName,
