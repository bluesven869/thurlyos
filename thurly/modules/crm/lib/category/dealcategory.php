<?php
namespace Thurly\Crm\Category;
use Thurly\Main;
use Thurly\Main\Type\Date;
use Thurly\Main\Entity\Query;
use Thurly\Crm\Restriction\RestrictionManager;
use Thurly\Crm\Category\Entity\DealCategoryTable;
use Thurly\Crm\DealTable;
use Thurly\Crm\Color\DealStageColorScheme;
use Thurly\Crm\Entry\AddException;
use Thurly\Crm\Entry\UpdateException;
use Thurly\Crm\Entry\DeleteException;
...
class DealCategory
{
	 ...
	 * @return int
	 * @throws \Thurly\Crm\Entry\AddException
	 */
	 ...
	 * @return void
	 * @throws \Thurly\Crm\Entry\UpdateException
	 */
	 ...
	 * @param int $ID Entry ID.
	 * @return void
	 * @throws \Thurly\Crm\Entry\DeleteException
	 */
