...
use Thurly\Crm\Integration\VoxImplantManager;
use Thurly\Main;
...
use Thurly\Voximplant\ConfigTable;
...
class Call extends Base
{
	...
	public static function getFirstPhoneNumber($entityTypeId, $entityId)
	{
		$cursor = \CCrmFieldMulti::GetList(
			array('ID' => 'asc'),
			array('ENTITY_ID' => \CCrmOwnerType::ResolveName($entityTypeId), 'ELEMENT_ID' => $entityId, 'TYPE_ID' =>  \CCrmFieldMulti::PHONE)
		);
