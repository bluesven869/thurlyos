...
use Thurly\Faceid\AgreementTable;
...
class Visit extends Base
{
	...
	public static function isAvailable()
	{
		...
		{
			return  \Thurly\FaceId\FaceId::isAvailable();
		}
		else
		{
			return \CThurlyOS::getLicensePrefix() !== 'ua' && \CThurlyOS::getLicensePrefix() !== 'kz';
		}
	}
