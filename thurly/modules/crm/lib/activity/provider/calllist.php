...
namespace Thurly\Crm\Activity\Provider;
...
class CallList extends Base
{
	...
	public static function getPlannerActions(array $params = null)
	{
		...
		else if(\Thurly\Crm\CallList\CallList::isAvailable())
		{
			return array(
				array(
	...
	public static function prepareToolbarButtons(array &$buttons, array $params = null)
	{
		...
		else
		{
			$buttons[] = array(
				...
				'ONCLICK' => "B24.licenseInfoPopup.show('call-list-limit-popup', '".\CUtil::JSEscape(\Thurly\Crm\CallList\CallList::getLicensePopupHeader())."', '".\CUtil::JSEscape(\Thurly\Crm\CallList\CallList::getLicensePopupContent())."');",
				'ICON' => "btn-new"
			);
			return 1;
		}
