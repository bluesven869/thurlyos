...
use Thurly\Crm\ExternalChannelConnectorTable;
use Thurly\Crm\Rest\CCrmExternalChannelActivityType;
use Thurly\Crm\Rest\CCrmExternalChannelConnector;
use Thurly\Crm\Rest\CCrmExternalChannelImport;
use Thurly\Crm\Rest\CCrmExternalChannelType;
...
class ExternalChannel extends Base
{
	...
	{
		return \Thurly\Main\Loader::includeModule("rest");
	}
	...
	public static function getRenderUrl($typeId = CCrmExternalChannelType::OneCName)
	{
		...
		switch($typeId)
		{
			...
			case CCrmExternalChannelType::OneCName:
				...
				{
					$res = \Thurly\Rest\AppTable::getList(array(
