...
class Script
{
	...
	protected $loaderPath = '/thurly/js/crm/form_loader.js';
	protected $formPath;
	...
	public static function getCrmButtonWidget($formId, $params = array())
	{
		...
		global $APPLICATION;
		$APPLICATION->IncludeComponent("thurly:crm.button.webform", ".default", array(
			'FORM_ID' => $formId,
	...
	public static function getCrmButtonWidgetShower($formId, $lang = null)
	{
		...
		$url = self::getDomain() . '/thurly/js/crm/form_loader.js';
		return '
			(function(w,d,u,b){w[\'ThurlyOSFormObject\']=b;w[b] = w[b] || function(){arguments[0].ref=u;
			...
			(function(w,b){				
				params = {
					"id":"' . $formId . '","lang":"' . $lang .'","sec":"' . $sec . '","type":"inline", 
				...
				if(w[\'ThurlyOSFormLoader\'] && !ThurlyOSFormLoader.isFormExisted(params)) 
				{
					params.ref = "' . $url . '";
					ThurlyOSFormLoader.preLoad(params);
				}
				else
				{
					w[b](params);
