<?php
namespace Thurly\Crm\Widget\Custom;

use Thurly\Crm\Widget\Custom\Entity\SaleTargetTable;
use Thurly\Main;
...
class SaleTarget
{
	...
	public function getActiveUsers()
	{
		...
		$result = \Thurly\Crm\DealTable::getList(array(
	...
	private function getUsers(array $userIds)
	{
		...
		$dbRes = \CUser::getList(($by = "ID"), ($order = "ASC"),
			array("ID" => implode("|", array_unique($userIds))),
