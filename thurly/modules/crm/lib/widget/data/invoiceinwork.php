...
use Thurly\Crm\History\Entity\InvoiceStatusHistoryTable;
...
class InvoiceInWork extends InvoiceDataSource
{
	...
	*/
	...
	public function prepareEntityListFilter(array $filterParams)
	{
		...
		$semanticID = ($fieldName === 'COUNT_OWED' || $fieldName === 'SUM_OWED_TOTAL')
			? PhaseSemantics::PROCESS : PhaseSemantics::UNDEFINED;
