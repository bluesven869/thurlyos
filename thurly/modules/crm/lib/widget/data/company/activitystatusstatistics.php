...
use Thurly\Crm\Statistics\Entity\CompanyActivityStatusStatisticsTable;

class ActivityStatusStatistics extends DataSource
{
	const TYPE_NAME = 'COMPANY_ACTIVITY_STATUS_STATS';
	...
	*/
	...
	public function getList(array $params)
	{
		...
		$query = new Query(CompanyActivityStatusStatisticsTable::getEntity());
	...
	public static function getPresets()
	{
		...
		foreach ($categories as $categoryId => $presetPrefix)
		{
			$result[] =	array(
				...
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STATUS_STAT_TOTAL'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STATUS_STAT_UNANSWERED_QTY'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STATUS_STAT_ANSWERED_QTY'),
	...
	{
		$sourceKey = \CCrmOwnerType::CompanyName.':'.self::GROUP_BY_STATUS;
		...
		$groupings[$sourceKey] = array(
			'entity' => \CCrmOwnerType::CompanyName,
			'title' => GetMessage('CRM_COMPANY_ACTIVITY_STATUS_STAT_GROUP_BY_STATUS'),
