...
use Thurly\Crm\Activity\StatisticsMark;
...
use Thurly\Crm\Statistics\Entity\CompanyActivityMarkStatisticsTable;

class ActivityMarkStatistics extends DataSource
{
	const TYPE_NAME = 'COMPANY_ACTIVITY_MARK_STATS';
	...
	*/
	...
	{
		$sourceKey = \CCrmOwnerType::CompanyName.':'.self::GROUP_BY_SOURCE;
		...
		$groupings[$sourceKey] = array(
			'entity' => \CCrmOwnerType::CompanyName,
			'title' => GetMessage('CRM_COMPANY_ACTIVITY_MARK_STAT_GROUP_BY_SOURCE'),
			'name' => self::GROUP_BY_SOURCE
		);
		$sourceKey = \CCrmOwnerType::CompanyName.':'.self::GROUP_BY_MARK;
		if(isset($groupings[$sourceKey]))
		{
			return;
		}
		...
		$groupings[$sourceKey] = array(
			'entity' => \CCrmOwnerType::CompanyName,
			'title' => GetMessage('CRM_COMPANY_ACTIVITY_MARK_STAT_GROUP_BY_MARK'),
