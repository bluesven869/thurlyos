...
use Thurly\Crm\Widget\Data\DealDataSource;
use Thurly\Main;
...
{
	const TYPE_NAME = 'COMPANY_DEAL_SUM_STATS';
	...
	public function getList(array $params)
	{
		...
		)
		{
			...
			$query->addFilter('=CD.COMPANY_ID', $filter->getContextEntityID());
		}
	...
	public static function getPresets()
	{
		...
		$result = array(
			array(
				...
				'title' => GetMessage('CRM_COMPANY_DEAL_SUM_STAT_PRESET_SUM_TOTAL'),
			...
			array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_DEAL_SUM_STAT_PRESET_SUCCESS_SUM'),
			...
			array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_DEAL_SUM_STAT_PRESET_PROCESS_SUM'),
			...
			array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_DEAL_SUM_STAT_PRESET_LOST_SUM'),
	...
	public function prepareEntityListFilter(array $filterParams)
	{
		...
		if (isset($filterParams['ENTITY_ID']))
		{
			...
			$query->addFilter('=CD.COMPANY_ID', (int)$filterParams['ENTITY_ID']);
		}
