...
use Thurly\Crm\Activity\CommunicationStatistics;
use Thurly\Crm\Activity\StatisticsStream;
...
use Thurly\Crm\Statistics\Entity\CompanyActivityStreamStatisticsTable;

class ActivityStreamStatistics extends DataSource
{
	const TYPE_NAME = 'COMPANY_ACTIVITY_STREAM_STATS';
	...
	*/
	...
	public static function getPresets()
	{
		...
		foreach ($categories as $categoryId => $presetPrefix)
		{
			$result[] =	array(
				...
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STREAM_STAT_TOTAL'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STREAM_STAT_INCOMING_QTY'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STREAM_STAT_OUTGOING_QTY'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STREAM_STAT_REVERSING_QTY'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::CompanyName,
				'title' => GetMessage('CRM_COMPANY_ACTIVITY_STREAM_STAT_MISSING_QTY'),
	...
	{
		$sourceKey = \CCrmOwnerType::CompanyName.':'.self::GROUP_BY_STREAM;
		...
		$groupings[$sourceKey] = array(
			'entity' => \CCrmOwnerType::CompanyName,
			'title' => GetMessage('CRM_COMPANY_ACTIVITY_STREAM_STAT_GROUP_BY_STREAM'),
