...
use Thurly\Crm\Widget\Custom\SaleTarget;
use Thurly\Main;
...
class DealSaleTarget extends DealDataSource
{
	...
	public static function getCurrentValues(array $configuration)
	{
		...
		$subQuery->addFilter('>=END_DATE', Main\Type\DateTime::createFromTimestamp($periodLeftBorder));
		$subQuery->addFilter('<=END_DATE',Main\Type\DateTime::createFromTimestamp( $periodRightBorder));
