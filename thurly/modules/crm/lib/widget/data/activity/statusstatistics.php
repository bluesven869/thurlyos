...
use Thurly\Crm\Activity\StatisticsStatus;
...
use Thurly\Crm\Statistics\Entity\ActivityStatisticsTable;

class StatusStatistics extends DataSource
{
	const TYPE_NAME = 'ACTIVITY_STATUS_STATS';
	...
	*/
	...
	public static function getPresets()
	{
		...
		foreach ($categories as $categoryId => $presetPrefix)
		{
			$result[] =	array(
				...
				'title' => GetMessage('CRM_ACTIVITY_ACTIVITY_STATUS_STAT_TOTAL'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::ActivityName,
				'title' => GetMessage('CRM_ACTIVITY_ACTIVITY_STATUS_STAT_UNANSWERED_QTY'),
			...
			$result[] =	array(
				'entity' => \CCrmOwnerType::ActivityName,
				'title' => GetMessage('CRM_ACTIVITY_ACTIVITY_STATUS_STAT_ANSWERED_QTY'),
	...
	{
		$sourceKey = \CCrmOwnerType::ActivityName.':'.self::GROUP_BY_STATUS;
		...
		$groupings[$sourceKey] = array(
			'entity' => \CCrmOwnerType::ActivityName,
			'title' => GetMessage('CRM_ACTIVITY_ACTIVITY_STATUS_STAT_GROUP_BY_STATUS'),
