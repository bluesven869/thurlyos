...
use Thurly\Crm\Statistics\Entity\ContactActivityStatisticsTable;

class ActivityStatistics extends DataSource
{
	const TYPE_NAME = 'CONTACT_ACTIVITY_STATS';
	...
	*/
	...
	public static function getPresets()
	{
		...
		$result[] =	array(
			...
			'title' => GetMessage('CRM_CONTACT_ACTIVITY_STAT_PROVIDER_PRESET'),
	...
	public static function prepareCategories(array &$categories)
	{
		...
		foreach ($providers as $provider)
		{
			...
			if(isset($categories[\CCrmOwnerType::ContactName.$categoryId]))
			{
				continue;
			}
			...
			{
				$categories[\CCrmOwnerType::ContactName.$categoryId] = array(
					'entity' => \CCrmOwnerType::ContactName,
					'title' => Main\Localization\Loc::getMessage('CRM_CONTACT_ACTIVITY_STAT_PROVIDER_CATEGORY',
	...
	{
		$sourceKey = \CCrmOwnerType::ContactName.':'.self::GROUP_BY_PROVIDER_ID;
		...
		$groupings[$sourceKey] = array(
			'entity' => \CCrmOwnerType::ContactName,
			'title' => GetMessage('CRM_CONTACT_ACTIVITY_STAT_GROUP_BY_PROVIDER'),
