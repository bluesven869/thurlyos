<?php
namespace Thurly\Crm\Widget\Data\Contact;

use Thurly\Crm\Widget\Data\DataContext;
use Thurly\Crm\Widget\Data\InvoiceDataSource;
use Thurly\Main;
...
use Thurly\Crm\Statistics\Entity\InvoiceSumStatisticsTable;

class InvoiceSumStatistics extends InvoiceDataSource
{
	const TYPE_NAME = 'CONTACT_INVOICE_SUM_STATS';
	...
	public function getList(array $params)
	{
		...
		{
			$subQuery->addFilter('=CONTACT_ID', $filter->getContextEntityID());
		}
	...
	public static function getPresets()
	{
		...
		$result = array(
			array(
				...
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_PROCESS_COUNT'),
			...
			array(
				'entity' => \CCrmOwnerType::ContactName,
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_PROCESS_SUM'),
			...
			array(
				'entity' => \CCrmOwnerType::ContactName,
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_SUCCESS_COUNT'),
			...
			array(
				'entity' => \CCrmOwnerType::ContactName,
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_SUCCESS_SUM'),
			...
			array(
				'entity' => \CCrmOwnerType::ContactName,
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_OVERALL_COUNT'),
			...
			array(
				'entity' => \CCrmOwnerType::ContactName,
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_OVERALL_SUM'),
			...
			array(
				'entity' => \CCrmOwnerType::ContactName,
				'title' => GetMessage('CRM_CONTACT_INVOICE_SUM_STAT_PRESET_PAID_INTIME_COUNT'),
	...
	public function prepareEntityListFilter(array $filterParams)
	{
		...
		{
			$query->addFilter('=CONTACT_ID', (int)$filterParams['ENTITY_ID']);
		}
