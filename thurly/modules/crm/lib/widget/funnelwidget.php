<?php
namespace Thurly\Crm\Widget;

use Thurly\Main;
use Thurly\Crm\History\HistoryEntryType;
use Thurly\Crm\Widget\Data\DealStageHistory;
use Thurly\Crm\Widget\Data\LeadStatusHistory;
use Thurly\Crm\Widget\Data\InvoiceStatusHistory;
