...
use Thurly\Crm\Automation\Target\BaseTarget;
use Thurly\Main;
...
abstract class BaseTrigger
{
	...
	{
		if ($this->target === null)
			throw new Main\InvalidOperationException('Entity must be set by setEntity method.');
		return $this->target;
	}
	...
	protected function applyTrigger(array $trigger)
	{
		...
		$target->getRuntime()->onEntityStatusChanged();
	...
	abstract function checkApplyRules(array $trigger);
