...
class Preset
{
	...
	{
		if (\Thurly\Crm\WebForm\Preset::checkVersion())
		{
			$formPreset = new \Thurly\Crm\WebForm\Preset();
			$formPreset->install();
		}

		if (Loader::includeModule('imopenlines') && \Thurly\ImOpenlines\Preset::checkVersion())
		{
			$formPreset = new \Thurly\ImOpenlines\Preset();
			$formPreset->install();
		}
	}
	...
	{
		$serverAddress = ResourceManager::getServerAddress() . '/thurly/components/thurly/crm.button.edit/templates/.default/images/';
