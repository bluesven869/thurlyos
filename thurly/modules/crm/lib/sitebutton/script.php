...
use Thurly\Crm\SiteButton\Internals\ButtonTable;
...
class Script
{
	...
	const LOADER_PATH = '/thurly/js/crm/button_loader.js';
	...
	protected $resources = array(
		array(
			'name' => 'style.css',
			'type' => 'text/css',
			'path' => '/thurly/components/thurly/crm.button.button/templates/.default/style.css',
		),
		array(
			'name' => 'webform_style.css',
			'type' => 'text/css',
			'path' => '/thurly/components/thurly/crm.button.webform/templates/.default/style.css',
		),
		array(
			'name' => 'guest_tracker.js',
			'type' => 'text/javascript',
			'path' => '/thurly/js/crm/guest_tracker.js',
	...
	/*
		ThurlyOSButtonLoader.init({
			resources: [
				'/thurly/components/thurly/crm.button.button/templates/.default/style.css'
			],
			delay: 0,
			widgets: [
				{
	...
	{
		return (bool) Loader::includeModule('thurlyos');
	}
	...
	public static function getResourceLoader($buttonId, Button $button = null)
	{
		...
		return array(
			array(
				...
				'provider_function' => '\\Thurly\\Crm\\SiteButton\\Script::getResourceLoader',
	...
	public static function getResourceFiles($fileName = null)
	{
		...
		for ($i = 0; $i < $resourcesLength; $i++)
		{
			...
			$resources[$i]['provider_function'] = '\\Thurly\\Crm\\SiteButton\\Script::getResourceFiles';
