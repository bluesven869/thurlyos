...
use Thurly\Crm\SiteButton\Channel\iProvider;
...
class ChannelManager
{
	...
	protected static function getChannels()
	{
		...
		$providers = array(
			'\Thurly\Crm\SiteButton\Channel\ChannelOpenLine',
			'\Thurly\Crm\SiteButton\Channel\ChannelWebForm',
			'\Thurly\Crm\SiteButton\Channel\ChannelCallback',
		);
