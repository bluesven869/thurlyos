...
namespace Thurly\Crm\SiteButton\Channel;

use Thurly\Main\Loader;
use Thurly\Main\Localization\Loc;
use Thurly\ImOpenLines\Common;
use Thurly\Imopenlines\Model\ConfigTable;
use Thurly\ImConnector\Connector;
use Thurly\ImOpenLines\LiveChatManager;
use Thurly\Imopenlines\Model\LivechatTable;

Loc::loadMessages(__FILE__);

/**
 * Class ChannelOpenLine
 * @package Thurly\Crm\SiteButton\Channel
 */
class ChannelOpenLine implements iProvider
{
	...
	public static function getWidgets($id, $removeCopyright = true, $lang = null, array $config = array())
	{
		...
		Loc::loadMessages(\Thurly\Main\Application::getDocumentRoot() . '/thurly/modules/imconnector/lib/connector.php');
	...
	public static function getResources()
	{
		...
		return array(
			array(
				...
				'type' => 'text/css',
				'path' => '/thurly/js/imconnector/icon.css',
			)
		);
	}
