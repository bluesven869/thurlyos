			...
			return array(
				array(
					...
					'SETTINGS' => array(
						...
						'URL' => '/thurly/components/thurly/crm.deal.list/list.ajax.php?'.thurly_sessid_get()
					)
				)
			);
		}
			...
			return array(
				array(
					...
					'SETTINGS' => array(
						...
						'SUMMARY' => GetMessage('CRM_STAT_MGR_REBUILD_STATISTICS_DLG_SUMMARY'),
						'ACTION' => 'REBUILD_STATISTICS',
						'URL' => '/thurly/components/thurly/crm.lead.list/list.ajax.php?'.thurly_sessid_get()
					)
				)
			);
		}
			...
			return array(
				array(
					...
					'SETTINGS' => array(
						...
						'SUMMARY' => GetMessage('CRM_STAT_MGR_REBUILD_STATISTICS_DLG_SUMMARY'),
						'ACTION' => 'REBUILD_STATISTICS',
						'URL' => '/thurly/components/thurly/crm.invoice.list/list.ajax.php?'.thurly_sessid_get()
					)
				)
			);
		}
			...
			return array(
				array(
					...
					'SETTINGS' => array(
						...
						'URL' => '/thurly/components/thurly/crm.company.list/list.ajax.php?'.thurly_sessid_get()
					)
				)
			);
		}
			...
			return array(
				array(
					...
					'SETTINGS' => array(
						...
						'SUMMARY' => GetMessage('CRM_STAT_MGR_REBUILD_STATISTICS_DLG_SUMMARY'),
						'ACTION' => 'REBUILD_ACT_STATISTICS',
						'URL' => '/thurly/components/thurly/crm.contact.list/list.ajax.php?'.thurly_sessid_get()
					)
				)
			);
		}
			...
			return array(
				array(
					...
					'SETTINGS' => array(
						...
						'SUMMARY' => GetMessage('CRM_STAT_MGR_REBUILD_STATISTICS_DLG_SUMMARY'),
						'ACTION' => 'REBUILD_ACT_STATISTICS',
						'URL' => '/thurly/components/thurly/crm.activity.list/list.ajax.php?'.thurly_sessid_get()
					)
				)
			);
		}
