...
class ContactGrowthStatisticsTable  extends Entity\DataManager
{
	...
	*/
	...
	{
		return 'b_crm_contact_growth_stat';
	}
	/**
	* @return array
	*/
	...
	*/
	public static function deleteByOwner($ownerID)
	{
		...
		Main\Application::getConnection()->queryExecute("DELETE FROM b_crm_contact_growth_stat WHERE OWNER_ID = {$ownerID}");
	}
	/**
	* @return void
	*/
	public static function synchronize($ownerID, array $data)
	{
		...
		Main\Application::getConnection()->queryExecute(
			"UPDATE b_crm_contact_growth_stat SET RESPONSIBLE_ID = {$userID} WHERE OWNER_ID = {$ownerID}"
		);
	}
}