...
class ContactActivityStatusStatisticsTable  extends Entity\DataManager
{
	/**
	* @return string
	*/
	...
	{
		return 'b_crm_contact_act_sts_stat';
	}
	/**
	* @return array
	*/
	...
	*/
	public static function deleteByOwner($ownerID)
	{
		...
		Main\Application::getConnection()->queryExecute("DELETE FROM b_crm_contact_act_sts_stat WHERE OWNER_ID = {$ownerID}");
	}
	/**
	* @return void
	*/
	public static function synchronize($ownerID, array $data)
	{
		...
		Main\Application::getConnection()->queryExecute(
			"UPDATE b_crm_contact_act_sts_stat SET RESPONSIBLE_ID = {$userID} WHERE OWNER_ID = {$ownerID}"
		);
	}
}