...
use Thurly\Main;
use Thurly\Crm\CommunicationType;
...
class DuplicateIndexType
{
	...
	const COMMUNICATION_THURLY24 = 	0x100;
	...
	const COMMUNICATION = 			0x8003FC; 	/*  COMMUNICATION_PHONE|COMMUNICATION_EMAIL|COMMUNICATION_FACEBOOK|COMMUNICATION_TELEGRAM|COMMUNICATION_VK|COMMUNICATION_SKYPE|COMMUNICATION_THURLY24|COMMUNICATION_OPENLINE|COMMUNICATION_VIBER */
	const DENOMINATION = 			0x3; 		/*  PERSON|ORGANIZATION  */
	const ALL = 					0xF0FFFF;	/*  PERSON|ORGANIZATION|COMMUNICATION_PHONE|COMMUNICATION_EMAIL|COMMUNICATION_FACEBOOK|COMMUNICATION_TELEGRAM|COMMUNICATION_VK|COMMUNICATION_SKYPE|COMMUNICATION_THURLY24|COMMUNICATION_OPENLINE|COMMUNICATION_VIBER|RQ_INN|RQ_OGRN|RQ_OGRNIP|RQ_BIN|RQ_EDRPOU|RQ_VAT_ID|RQ_ACC_NUM|RQ_IBAN|RQ_IIK  */
	...
	const COMMUNICATION_THURLY24_NAME = 'COMMUNICATION_THURLY24';
	...
	public static function isDefined($typeID)
	{
		...
		return $typeID === self::PERSON
			...
			|| $typeID === self::COMMUNICATION_THURLY24
	...
	public static function resolveName($typeID)
	{
		...
		if(($typeID & self::COMMUNICATION_THURLY24) !== 0)
		{
			$results[] = self::COMMUNICATION_THURLY24_NAME;
		}
	...
	private static function innerResolveID($typeName)
	{
		...
		if($typeName ===  self::COMMUNICATION_THURLY24_NAME)
		{
			return self::COMMUNICATION_THURLY24;
		}
	...
	public static function getAllDescriptions()
	{
		if(!self::$allDescriptions[LANGUAGE_ID])
		{
			...
			self::$allDescriptions[LANGUAGE_ID] = array(
				...
				self::COMMUNICATION_THURLY24 => array('' => GetMessage('CRM_DUP_INDEX_TYPE_COMM_THURLY24')),
	...
	public static function splitType($typeID)
	{
		...
		if(($typeID & self::COMMUNICATION_THURLY24) !== 0)
		{
			$result[] = self::COMMUNICATION_THURLY24;
		}
		if(($typeID & self::COMMUNICATION_OPENLINE) !== 0)
		{
	...
	public static function convertFromCommunicationType($commTypeID)
	{
		...
		elseif($commTypeID === CommunicationType::THURLY24)
		{
			return self::COMMUNICATION_THURLY24;
		}
	...
	public static function convertToCommunicationType($typeID)
	{
		...
		elseif($typeID === self::COMMUNICATION_THURLY24)
		{
			return CommunicationType::THURLY24;
		}
