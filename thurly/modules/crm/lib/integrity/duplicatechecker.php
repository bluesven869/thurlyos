...
abstract class DuplicateChecker
{
	...
	abstract public function findDuplicates(\Thurly\Crm\EntityAdapter $adapter, DuplicateSearchParams $params);
	public function findMultifieldDuplicates($type, \Thurly\Crm\EntityAdapter $adapter, DuplicateSearchParams $params)
	{
		if(!is_string($type))
		{
	...
	public function findRequisiteDuplicates(\Thurly\Crm\EntityAdapter $adapter, DuplicateSearchParams $params)
	{
		$dups = array();
	...
	public function findBankDetailDuplicates(\Thurly\Crm\EntityAdapter $adapter, DuplicateSearchParams $params)
	{
		$dups = array();
