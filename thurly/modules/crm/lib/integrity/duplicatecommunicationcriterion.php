...
class DuplicateCommunicationCriterion extends DuplicateCriterion
{
	...
	public static function getMultifieldsValues(array $multifields, $communicationType)
	{
		...
		elseif($communicationType === CommunicationType::THURLY24_NAME)
		{
			return self::extractMultifieldsValues($multifields, \CCrmFieldMulti::IM, 'THURLY24');
		}
	...
	*/
	...
	public function getIndexTypeID()
	{
		...
		elseif($this->communicationType === CommunicationType::THURLY24_NAME)
		{
			return DuplicateIndexType::COMMUNICATION_THURLY24;
		}
	...
	public static function resolveTypeByIndexTypeID($indexTypeID)
	{
		...
		elseif($indexTypeID === DuplicateIndexType::COMMUNICATION_THURLY24)
		{
			return CommunicationType::THURLY24_NAME;
		}
