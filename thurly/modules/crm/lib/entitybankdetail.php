...
class EntityBankDetail
{
	...
	public function getFieldsTitles($countryId = 0)
	{
		...
		Loc::loadMessages(Main\Application::getDocumentRoot().'/thurly/modules/crm/lib/bankdetail.php');
			...
			foreach (array_keys($countryIds) as $countryId)
			{
				...
				if (!empty($langId))
				{
					$messages = Loc::loadLanguageFile(
						Main\Application::getDocumentRoot().'/thurly/modules/crm/lib/bankdetail.php',
						$langId
					);
