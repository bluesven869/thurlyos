...
class CCrmOwnerType
{
		...
		switch($typeID)
		{
			case self::Lead:
			{
				...
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_lead_list', '/crm/lead/list/', false),
					array()
				);
			}
			case self::Contact:
			{
				...
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_contact_list', '/crm/contact/list/', false),
					array()
				);
			}
			case self::Company:
			{
				...
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_company_list', '/crm/company/list/', false),
					array()
				);
			}
			case self::Deal:
			{
				...
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_deal_list', '/crm/deal/list/', false),
					array()
				);
			}
			case self::Activity:
			{
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_activity_list', '/crm/activity/', false),
					array()
				);
			}
			case self::Invoice:
			{
				...
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_invoice_list', '/crm/invoice/list/', false),
					array()
				);
			}
			case self::Quote:
			{
				...
				return CComponentEngine::MakePathFromTemplate(
					Thurly\Main\Config\Option::get('crm', 'path_to_quote_list', '/crm/quote/list/', false),
					array()
				);
			}
		}
	...
	public static function GetCaption($typeID, $ID, $checkRights = true, array $options = null)
	{
		...
		switch($typeID)
		{
			...
			{
				$arRes = isset($options['FIELDS']) ? $options['FIELDS'] : null;
				if(!is_array($arRes) && (!$checkRights || Thurly\Crm\Category\DealCategory::checkReadPermission()))
				{
					$arRes = Thurly\Crm\Category\DealCategory::get($ID);
				}
			...
			case self::CustomActivityType:
			{
				...
				if(!is_array($arRes))
				{
					$arRes = Thurly\Crm\Activity\CustomType::get($ID);
				}
