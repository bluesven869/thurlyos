	...
	implements IBPWorkflowDocument
{
	...
	static public function PrepareDocument(array &$arFields)
	{
		...
		$arFields['CONTACT_IDS'] = \Thurly\Crm\Binding\DealContactTable::getDealContactIDs($arFields['ID']);
	}
	...
	static public function UpdateDocument($documentId, $arFields)
	{
		...
		//Region automation
		if ($stageChanged)
			\Thurly\Crm\Automation\Factory::runOnStatusChanged(\CCrmOwnerType::Deal, $arDocumentID['ID']);
		//End region
