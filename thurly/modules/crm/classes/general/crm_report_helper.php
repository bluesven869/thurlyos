...
class CCrmReportManager
{
	...
	public static function getReportData($reportID)
	{
		...
		return $reportID > 0
			? Thurly\Report\ReportTable::getById($reportID)->fetch():
			null;
	}
}
...
abstract class CCrmReportHelperBase extends CReportHelper
{
	...
	public static function appendDateTimeUserFieldsAsShort(\Thurly\Main\Entity\Base $entity)
	{
		/** @global CDatabase $DB */
		global $DB;
		...
		{
			if (in_array($field->getName(), array('LEAD_BY', 'COMPANY_BY', 'CONTACT_BY'), true) && $field instanceof Thurly\Main\Entity\ReferenceField)
			{
				self::appendDateTimeUserFieldsAsShort($field->getRefEntity());
			}
			else if ($field instanceof Thurly\Main\Entity\ExpressionField)
			{
	...
	public static function appendTextUserFieldsAsTrimmed(\Thurly\Main\Entity\Base $entity)
	{
		/** @global string $DBType */
		global $DBType;
			...
			foreach ($value as $v)
			{
				if (!empty($v))
				{
					try
					{
						...
						$v = new Thurly\Main\Type\DateTime($v, \Thurly\Main\UserFieldTable::MULTIPLE_DATETIME_FORMAT);
					}
					catch (Main\ObjectException $e)
					{
						...
						try
						{
							$v = new Thurly\Main\Type\DateTime($v);
						}
						catch (Main\ObjectException $e)
						{
							//try short format
							$v = Thurly\Main\Type\DateTime::createFromUserTime($v);
						}
					}
					$result[] = $v;
				}
	...
	public static function getCurrentVersion()
	{
		...
		include($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/crm/install/version.php");
	...
	{
		if ($field->getRefEntityName() == '\Thurly\Crm\Company')
		{
			// CrmCompany
		...
		elseif ($field->getRefEntityName() == '\Thurly\Crm\Contact')
		{
			// CrmContact
			if ($filterElement['value'])
			{
		...
		elseif ($field->getRefEntityName() == '\Thurly\Crm\Invoice')
		{
			// CrmInvoice
			if ($filterElement['value'])
			{
		...
		elseif ($field->getRefEntityName() == '\Thurly\Crm\Deal')
		{
			// CrmDeal
			if ($filterElement['value'])
			{
		...
		elseif ($field->getRefEntityName() == '\Thurly\Crm\Lead')
		{
			// CrmLead
			if ($filterElement['value'])
			{
	...
	{
		$name = Thurly\Crm\Category\DealCategory::getName($categoryID);
	...
	{
		$name = Thurly\Crm\Category\DealCategory::getStageName($code);
		return $htmlEncode ? htmlspecialcharsbx($name) : $name;
	}
...
class CCrmReportHelper extends CCrmReportHelperBase
{
	...
	public static function setRuntimeFields(\Thurly\Main\Entity\Base $entity, $sqlTimeInterval)
	{
		...
		$reports = array(
			'11.0.6' => array(
				...
				array(
					...
					'mark_default' => 8,
					'settings' => unserialize('a:10:{s:6:"entity";s:15:"Thurly\Crm\Deal";s:6:"period";a:2:{s:4:"type";s:5:"month";s:5:"value";N;}s:6:"select";a:5:{i:8;a:1:{s:4:"name";s:8:"STAGE_ID";}i:7;a:3:{s:4:"name";s:2:"ID";s:5:"alias";s:0:"";s:4:"aggr";s:14:"COUNT_DISTINCT";}i:12;a:4:{s:4:"name";s:2:"ID";s:5:"alias";s:0:"";s:4:"aggr";s:14:"COUNT_DISTINCT";s:5:"prcnt";s:11:"self_column";}i:9;a:3:{s:4:"name";s:19:"OPPORTUNITY_ACCOUNT";s:5:"alias";s:0:"";s:4:"aggr";s:3:"SUM";}i:11;a:3:{s:4:"name";s:15:"RECEIVED_AMOUNT";s:5:"alias";s:0:"";s:4:"aggr";s:3:"SUM";}}s:6:"filter";a:1:{i:0;a:7:{i:0;a:5:{s:4:"type";s:5:"field";s:4:"name";s:7:"TYPE_ID";s:7:"compare";s:5:"EQUAL";s:5:"value";s:0:"";s:10:"changeable";s:1:"1";}i:1;a:5:{s:4:"type";s:5:"field";s:4:"name";s:36:"COMPANY_BY.COMPANY_TYPE_BY.STATUS_ID";s:7:"compare";s:5:"EQUAL";s:5:"value";s:0:"";s:10:"changeable";s:1:"1";}i:2;a:5:{s:4:"type";s:5:"field";s:4:"name";s:10:"COMPANY_BY";s:7:"compare";s:5:"EQUAL";s:5:"value";s:0:"";s:10:"changeable";s:1:"1";}i:3;a:5:{s:4:"type";s:5:"field";s:4:"name";s:28:"CONTACT_BY.TYPE_BY.STATUS_ID";s:7:"compare";s:5:"EQUAL";s:5:"value";s:0:"";s:10:"changeable";s:1:"1";}i:4;a:5:{s:4:"type";s:5:"field";s:4:"name";s:10:"CONTACT_BY";s:7:"compare";s:5:"EQUAL";s:5:"value";s:0:"";s:10:"changeable";s:1:"1";}i:5;a:5:{s:4:"type";s:5:"field";s:4:"name";s:11:"ASSIGNED_BY";s:7:"compare";s:5:"EQUAL";s:5:"value";s:0:"";s:10:"changeable";s:1:"1";}s:5:"LOGIC";s:3:"AND";}}s:4:"sort";i:8;s:9:"sort_type";s:3:"ASC";s:5:"limit";N;s:12:"red_neg_vals";b:0;s:13:"grouping_mode";b:0;s:5:"chart";a:4:{s:7:"display";b:1;s:4:"type";s:3:"bar";s:8:"x_column";i:8;s:9:"y_columns";a:1:{i:0;i:7;}}}')
				)
			)
		);
