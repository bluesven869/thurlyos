...
class CCrmMobileHelper
{
	...
	{
		$addressLabels = Thurly\Crm\EntityAddress::getShortLabels();
	...
	public static function getContactFields($includeUserFields = true)
	{
		...
		$fields = array(
			...
			'FULL_ADDRESS' => array('id' => 'FULL_ADDRESS', 'name' => Thurly\Crm\EntityAddress::getFullAddressLabel(), 'sort' => false, 'default' => false, 'editable' => false),
	...
	public static function PrepareContactItem(&$item, &$params, $enums = array())
	{
		...
		$item['FULL_ADDRESS'] = Thurly\Crm\Format\ContactAddressFormatter::format(
			array(
			...
			array('SEPARATOR' => Thurly\Crm\Format\AddressSeparator::HtmlLineBreak)
		);
	...
	public static function PrepareContactData(&$fields)
	{
		...
		{
			$listImageInfo = array('src' => SITE_DIR.'thurly/templates/mobile_app/images/crm/no_contact_small.png?ver=1');
			$viewImageInfo = array('src' => SITE_DIR.'thurly/templates/mobile_app/images/crm/no_contact_big.png?ver=1');
		}
	...
	{
		$addressLabels = Thurly\Crm\EntityAddress::getShortLabels();
		$regAddressLabels = Thurly\Crm\EntityAddress::getShortLabels(Thurly\Crm\EntityAddress::Registered);
	...
	public static function getCompanyFields($includeUserFields = true)
	{
		...
		//	'TITLE' => array('id' => 'TITLE', 'name' => GetMessage('CRM_COLUMN_COMPANY_TITLE')),
			...
			'FULL_ADDRESS' => array('id' => 'FULL_ADDRESS', 'name' => Thurly\Crm\EntityAddress::getFullAddressLabel()),
			'FULL_REG_ADDRESS' => array('id' => 'FULL_REG_ADDRESS', 'name' => Thurly\Crm\EntityAddress::getFullAddressLabel(Thurly\Crm\EntityAddress::Registered)),
	...
	public static function PrepareCompanyData(&$fields)
	{
		...
		{
			$viewImageInfo = array('src' => SITE_DIR.'thurly/templates/mobile_app/images/crm/no_company_big.png?ver=1');
			$listImageInfo = array('src' => SITE_DIR.'thurly/templates/mobile_app/images/crm/no_company_small.png?ver=1');
		}
	...
	public static function PrepareCompanyImageUrl(&$fields, $size)
	{
		...
		return $url !== ''
			? $url : SITE_DIR.'thurly/templates/mobile_app/images/crm/no_company_small.png?ver=1';
	}
	...
	public static function PrepareContactImageUrl(&$fields, $size)
	{
		...
		return $url !== ''
			? $url : SITE_DIR.'thurly/templates/mobile_app/images/crm/no_contact_small.png?ver=1';
	}
	...
	public static function PrepareLeadItem(&$item, &$params, $enums = array())
	{
		...
		{
			$item['FULL_ADDRESS'] = Thurly\Crm\Format\LeadAddressFormatter::format(
				array(
					'ADDRESS' => $item['ADDRESS'],
					'ADDRESS_2' => $item['ADDRESS_2'],
					'ADDRESS_CITY' => $item['ADDRESS_CITY'],
	...
	public static function PrepareLeadData(&$fields)
	{
		return array(
			...
			'ASSIGNED_BY_SHOW_URL' => isset($fields['ASSIGNED_BY_SHOW_URL']) ? $fields['ASSIGNED_BY_SHOW_URL'] : '',
			'SHOW_URL' => isset($fields['SHOW_URL']) ? $fields['SHOW_URL'] : '',
			//'LIST_IMAGE_URL' => SITE_DIR.'thurly/templates/mobile_app/images/crm/no_lead_small.png?ver=1',
			'LIST_IMAGE_URL' => '',
			//'VIEW_IMAGE_URL' => SITE_DIR.'thurly/templates/mobile_app/images/crm/no_lead_big.png?ver=1'
			'VIEW_IMAGE_URL' => ''
		);
	}
	...
	public static function PrepareActivityData(&$fields)
	{
		...
		$imageUrl = $imageFileName !== ''
			? SITE_DIR.'thurly/templates/mobile_app/images/crm/'.$imageFileName.'.png?ver=1'
			: '';
	...
	{
		return SITE_DIR.'thurly/templates/mobile_app/images/crm/no_contact_big.png?ver=1';
	}
	public static function GetCompanyViewImageStub()
	{
		return SITE_DIR.'thurly/templates/mobile_app/images/crm/no_company_big.png?ver=1';
	}
	public static function GetLeadViewImageStub()
	{
		return SITE_DIR.'thurly/templates/mobile_app/images/crm/no_lead_big.png?ver=1';
	}
	public static function GetLeadListImageStub()
	{
		return SITE_DIR.'thurly/templates/mobile_app/images/crm/no_lead_small.png?ver=1';
	}
	...
	public static function prepareAudioField(&$item, $ownerType)
	{
		...
		{
			if ($call['STORAGE_TYPE_ID'] != Thurly\Crm\Integration\StorageType::Disk)
				return;
