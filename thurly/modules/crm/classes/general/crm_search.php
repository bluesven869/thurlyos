...
class CCrmSearch
{
	...
	static public function UpdateSearch($arFilter, $ENTITY_TYPE, $bOverWrite = false)
	{
		...
		{
			self::$arMess[$ENTITY_TYPE] = \Thurly\Main\Localization\Loc::loadLanguageFile(
				$_SERVER['DOCUMENT_ROOT'].BX_ROOT.'/components/thurly/crm.'.strtolower($ENTITY_TYPE).'.show/component.php'
			);
		}
