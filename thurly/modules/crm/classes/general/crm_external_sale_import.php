...
class CCrmExternalSaleImport
{
	...
	private $path = "/thurly/admin/1c_exchange.php";
	...
	{
		return \Thurly\Main\Config\Option::get('crm', 'enable_sale_import_trace', 'N') === 'Y';
	}

	public static function EnableTrace($enable)
	{
		\Thurly\Main\Config\Option::set('crm', 'enable_sale_import_trace', $enable ? 'Y' : 'N');
	}
	...
	function AddMessage2Log($text)
	{
		...
		$maxLogSize = 10000;
		$readSize = 2048;
		$logFile = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/crm_import.log";
		$logFileTmp = $_SERVER["DOCUMENT_ROOT"]."/thurly/modules/crm_import1.log";
