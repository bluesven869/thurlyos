	...
	implements IBPWorkflowDocument
{
	...
	static public function CreateDocument($parentDocumentId, $arFields)
	{
		...
		{
			$presetID = \Thurly\Crm\EntityRequisite::getDefaultPresetId(CCrmOwnerType::Company);
			if($presetID > 0)
			{
				$converter = new \Thurly\Crm\Requisite\AddressRequisiteConverter(CCrmOwnerType::Company, $presetID, false);
	...
	{
		$arFields['CONTACT_ID'] = \Thurly\Crm\Binding\ContactCompanyTable::getCompanyContactIDs($arFields['ID']);
	}
