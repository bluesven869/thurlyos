...
class Giphy extends Base
{
	...
	public static function sendAnswer($messageId, $messageFields)
	{
		...
		if (!empty($messageFields['KEYBOARD']))
		{
			...
			$keyboard = \Thurly\Im\Bot\Keyboard::getKeyboardByJson($keyboard, Array("#RETRY#" => Loc::getMessage("IMBOT_GIPHY_COMMAND_GIPHY_RETRY")));
		}
	...
	{
		$controllerUrl = 'https://marta.thurly.info/iframe/giphy.php';
