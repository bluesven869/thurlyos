...
<script type="text/javascript">
	BX.ready(
		function()
		{
			var formId = "<?=$arResult['FORM_ID']?>";
			BX.remove(BX("bxForm_" + formId + "_expand_link"));
			var config = BX.CrmVCardImportConfig.create(
				"crm_contact_vcard_import_config",
				{
					formId: formId,
