...
class CrmWebFormEditTemplate
{
	...
	{
		$typeList = \Thurly\Crm\WebForm\Internals\FieldTable::getTypeList();
		$typeStringList = \Thurly\Crm\WebForm\Helper::getFieldStringTypes();
	...
	{
		$typeList = \Thurly\Crm\WebForm\Helper::getFieldStringTypes();
		$typesString = '';
...
function GetCrmWebFormFieldDependencyTemplate($params)
{
	...
	$actionList = array(
		array(
			...
			'VALUE' => \Thurly\Crm\WebForm\Internals\FieldDependenceTable::ACTION_ENUM_SHOW
		),
		array(
			'CAPTION' => Loc::getMessage('CRM_WEBFORM_EDIT_TMPL_DEP_HIDE'),
			'VALUE' => \Thurly\Crm\WebForm\Internals\FieldDependenceTable::ACTION_ENUM_HIDE
		),
	);
	...
	for($i = 0; $i < $actionListCount; $i++)
	{
		...
		if($actionList[$i]['SELECTED'] && $actionList[$i]['VALUE'] == \Thurly\Crm\WebForm\Internals\FieldDependenceTable::ACTION_ENUM_HIDE)
		{
