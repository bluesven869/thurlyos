...
use Thurly\Crm\Statistics\Entity\CompanyActivityStatisticsTable;
use Thurly\Crm\Statistics\Entity\ContactActivityStatisticsTable;
use Thurly\Crm\Statistics\Entity\DealSumStatisticsTable;
use Thurly\Main;
...
class CrmClientPortraitComponent extends \CThurlyComponent
{
	...
	public function executeComponent()
	{
		...
		$dealCategories = \Thurly\Crm\Category\DealCategory::getSelectListItems();
	...
	protected function getLoadManualTarget($dealCategoryId = null)
	{
		...
		{
			$this->manualTargetOptions = \Thurly\Main\Config\Option::get('crm', 'portrait_'.strtolower($this->getEntityType()));
