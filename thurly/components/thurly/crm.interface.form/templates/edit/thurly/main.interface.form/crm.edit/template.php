					...
					BX.ready(
							function()
							{
								var entitySelectorId = CRM.Set(
									...
									'',
									<?=CUtil::PhpToJsObject(CCrmEntitySelectorHelper::PreparePopupItems($entityType, false, isset($params['NAME_TEMPLATE']) ? $params['NAME_TEMPLATE'] : \Thurly\Crm\Format\PersonNameFormatter::getFormat()))?>,
									false,
									false,
