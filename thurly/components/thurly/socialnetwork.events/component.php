...
{
	/***********************  ACTIONS  *******************************/
	if ($_REQUEST["EventType"] == "FriendRequest" && check_thurly_sessid() && IntVal($_REQUEST["eventID"]) > 0)
	{
		$errorMessage = "";
	...
	elseif ($_REQUEST["EventType"] == "GroupRequest" && check_thurly_sessid() && IntVal($_REQUEST["eventID"]) > 0)
	{
		$errorMessage = "";
	...
	elseif ($_REQUEST["EventType"] == "Message" && check_thurly_sessid() && IntVal($_REQUEST["eventID"]) > 0)
	{
		$errorMessage = "";
	...
	elseif ($_REQUEST["EventType"] == "Message" && check_thurly_sessid() && IntVal($_REQUEST["userID"]) > 0)
	{
		$errorMessage = "";
	...
	if (!$bFound)
	{
		...
		if ($arUserRequests = $dbUserRequests->GetNext())
		{
			...
			$arImage = CSocNetTools::InitImage($arUserRequests["FIRST_USER_PERSONAL_PHOTO"], 150, "/thurly/images/socialnetwork/nopic_user_150.gif", 150, $pu, $canViewProfile);
			...
			$arResult["Urls"]["FriendAdd"] = htmlspecialcharsbx($APPLICATION->GetCurUri("EventType=FriendRequest&eventID=".$arUserRequests["ID"]."&action=add&".thurly_sessid_get().""));
			$arResult["Urls"]["FriendReject"] = htmlspecialcharsbx($APPLICATION->GetCurUri("EventType=FriendRequest&eventID=".$arUserRequests["ID"]."&action=reject&".thurly_sessid_get().""));
		}
	}
	...
	if (!$bFound)
	{
		...
		if ($arUserRequests = $dbUserRequests->GetNext())
		{
			...
			$arImage = CSocNetTools::InitImage($arUserRequests["INITIATED_BY_USER_PHOTO"], 150, "/thurly/images/socialnetwork/nopic_user_150.gif", 150, $pu, $canViewProfileU);
			...
			$arImageG = CSocNetTools::InitImage($arUserRequests["GROUP_IMAGE_ID"], 150, "/thurly/images/socialnetwork/nopic_group_150.gif", 150, $pg, $canViewProfileG);
			...
			$arResult["Urls"]["FriendAdd"] = htmlspecialcharsbx($APPLICATION->GetCurUri("EventType=GroupRequest&eventID=".$arUserRequests["ID"]."&action=add&".thurly_sessid_get().""));
			$arResult["Urls"]["FriendReject"] = htmlspecialcharsbx($APPLICATION->GetCurUri("EventType=GroupRequest&eventID=".$arUserRequests["ID"]."&action=reject&".thurly_sessid_get().""));
		}
	}
	...
	if (!$bFound)
	{
		...
		if ($arUserRequests = $dbUserRequests->GetNext())
		{
			...
			$arImage = CSocNetTools::InitImage($arUserRequests["FROM_USER_PERSONAL_PHOTO"], 150, "/thurly/images/socialnetwork/nopic_user_150.gif", 150, $pu, $canViewProfile);
			...
			$arResult["Urls"]["Close"] = htmlspecialcharsbx($APPLICATION->GetCurUri("EventType=Message&eventID=".$arUserRequests["ID"]."&action=close&".thurly_sessid_get().""));
			...
			$arResult["Urls"]["Ban"]["Link"] = htmlspecialcharsbx($APPLICATION->GetCurUri("EventType=Message&userID=".$arUserRequests["FROM_USER_ID"]."&action=ban&".thurly_sessid_get().""));
		}
	}
