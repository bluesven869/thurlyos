...
if ($GLOBALS["USER"]->IsAuthorized())
{
	...
	include_once($_SERVER['DOCUMENT_ROOT']."/thurly/components/thurly/intranet.tasks/init.php");
	...
	if (StrLen($arResult["FatalError"]) <= 0)
	{
		...
		else
		{
			...
			$arResult["Urls"]["DeleteView"] = $arResult["Urls"]["ChangeView"]."0&".thurly_sessid_get()."&action=delete_view&del_view_id=".$arResult["CurrentView"];
		}
	}
