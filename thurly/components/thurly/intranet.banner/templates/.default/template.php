...
?>
<?if ($arParams['ALLOW_CLOSE'] == 'Y'):?><script type="text/javascript">if (null == window.phpVars) window.phpVars = {}; if (!window.phpVars.thurly_sessid) window.phpVars.thurly_sessid='<?=thurly_sessid()?>';</script><?endif;?>
