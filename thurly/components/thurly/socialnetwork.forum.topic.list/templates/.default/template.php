...
if (!$this->__component->__parent || empty($this->__component->__parent->__name)):
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/forum/templates/.default/style.css');
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/forum/templates/.default/themes/blue/style.css');
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/forum/templates/.default/styles/additional.css');
endif;
IncludeAJAX();
$GLOBALS["APPLICATION"]->AddHeadScript("/thurly/js/main/utils.js");
$GLOBALS['APPLICATION']->AddHeadString('<script src="/thurly/components/thurly/forum.interface/templates/.default/script.js"></script>', true);
$GLOBALS['APPLICATION']->AddHeadString('<script src="/thurly/components/thurly/forum.interface/templates/popup/script.js"></script>', true);
...
?>
	...
	<?if($arResult["USER"]["SUBSCRIBE"]=="Y"):?>
		<a rel="nofollow" title="<?=GetMessage("F_UNSUBSCRIBE_TO_NEW_POSTS")?>" href="<?=$APPLICATION->GetCurPageParam("ACTION=FORUM_UNSUBSCRIBE&".thurly_sessid_get(), array("ACTION", "sessid"))?>"><?=GetMessage("F_UNSUBSCRIBE")?></a>
	<?else:?>
		<a rel="nofollow" title="<?=GetMessage("F_SUBSCRIBE_TO_NEW_POSTS")?>" href="<?=$APPLICATION->GetCurPageParam("ACTION=FORUM_SUBSCRIBE&".thurly_sessid_get(), array("ACTION", "sessid"))?>"><?=GetMessage("F_SUBSCRIBE")?></a>
	<?endif?>
	</noindex></span>
<?
endif;
...
<tr valign="top">
	...
	?>
		<select name="EMAIL_FORUM_MAILBOX" onchange="ChMBx(this)" id="EI_0">
			...
			<?endforeach?>
		</select> <a href="/thurly/admin/mail_mailbox_admin.php?lang=<?=LANGUAGE_ID?>" target="_blank"><?echo GetMessage("FTL_EMAIL_MAILBOX_LINK")?></a>
	</td>
</tr>
...
function ChMBAcc()
{
	...
	var url = '/thurly/admin/mail_check_mailbox.php?lang=<?=LANGUAGE_ID?>';
