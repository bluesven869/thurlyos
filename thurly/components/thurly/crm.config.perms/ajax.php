...
if(!function_exists('__CrmConfigPermsEndResonse'))
{
	function __CrmConfigPermsEndResonse($result)
	{
...
{
	__CrmConfigPermsEndResonse(array('ERROR' => 'Could not include crm module.'));
}
...
if($action === 'REBUILD_ENTITY_ATTRS')
{
	...
	if($entityTypeName === '')
	{
		__CrmConfigPermsEndResonse(array('ERROR' => 'Entity type is not specified.'));
	}

	$entityTypeID = CCrmOwnerType::ResolveID($entityTypeName);
	if($entityTypeID === CCrmOwnerType::Undefined)
	{
		__CrmConfigPermsEndResonse(array('ERROR' => 'Undefined entity type is specified.'));
	}
