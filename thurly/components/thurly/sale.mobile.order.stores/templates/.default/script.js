__ThurlySaleMOS = function(params)
{
...
__ThurlySaleMOS.prototype.makeStoreInpId = function(storeId)
{
	return "STORE_"+storeId+"_QUANTITY";
};

__ThurlySaleMOS.prototype.checkQuantities = function(qByStoresId)
{
	var summ = 0;
...
__ThurlySaleMOS.prototype.getQuantities = function()
{
	var value = '',
		input,
		aResult = {};
...
__ThurlySaleMOS.prototype.setQuantities = function(qByStore)
{
	for (var i = this.aStoresIds.length - 1; i >= 0; i--)
	{
...
__ThurlySaleMOS.prototype.close = function()
{
