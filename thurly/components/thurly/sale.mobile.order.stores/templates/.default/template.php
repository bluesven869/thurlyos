...
<script type="text/javascript">
	...
	var bsmos = new __ThurlySaleMOS(listParams);
	...
	app.addButtons({
		...
		saveButton:
		{
			...
			callback: function()
			{
				...
				app.onCustomEvent("onThurlySaleMOSResult", {
	...
	BX.addCustomEvent('onThurlySaleMOSGetInfo', function (params){
		bsmos.setQuantities(params);
	});

	app.onCustomEvent("onThurlySaleMOSLoaded", {
		"productId" : "<?=$arParams["PRODUCT_DATA"]["ID"]?>"
	});
