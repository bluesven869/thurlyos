...
class CTasksDepartmentsOverviewComponent extends CThurlyComponent
{
	...
	public function initGroupImage($groupPath, $imageId, $imageSize = 100)
	{
		...
		$arImage = CSocNetTools::InitImage($imageId, $imageSize, "/thurly/images/socialnetwork/nopic_group_100.gif", $imageSize, $groupPath, true);
	...
	private function processParams()
	{
		...
		$user = \Thurly\Tasks\Util\User::getId();
		if($user)
		{
