...
class CSaleWS extends IWebService
{
	...
	function GetLiveFeedData($site_id = "", $lang = "en")
	{
		...
		CComponentUtil::__IncludeLang("/thurly/components/thurly/webservice.sale/", "/component_1.php", $lang);
		...
		$arResult = array(
			...
			"URL" => htmlspecialchars($protocol."://".$server_name."/thurly/admin/sale_stat.php?lang=".$lang)
		);
	...
	function GetWebServiceDesc()
	{
		...
		$wsdesc->wsname = "thurly.webservice.sale";
...
$arParams["WEBSERVICE_NAME"] = "thurly.webservice.sale";
