...
$MESS["CRM_1C_START_EXCHANGE_INFO_3"] = "Use 1C to pay invoices, ship orders, edit invoice products and values. All these data will be synchronized to CRM.";
$MESS["CRM_1C_START_EXCHANGE_INFO_4"] = "When data is updated on CRM side, all changes will be synchronized to 1C.";
$MESS["CRM_1C_START_EXCHANGE_NOTICE"] = "Product exchange is one-way: all changes made to products in 1C will be reflected in CRM.";
