...
else
{
	foreach($arResult['LEAD'] as &$arLead)
	{
		...
		echo '<script type="text/javascript">BX.tooltip("LEAD_', $arLead['~ID'], '", "', $linkID,'", "/thurly/components/thurly/crm.lead.show/card.ajax.php", "crm_balloon_no_photo", true);</script>';
		echo '</div>';
