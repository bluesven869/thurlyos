...
else
{
	...
	{
		require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/classes/".$GLOBALS["DBType"]."/cml2.php");
	...
	elseif(($_GET["mode"] == "import") && $ABS_FILE_NAME)
	{
		...
		require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/iblock/classes/".$GLOBALS["DBType"]."/cml2.php");
		if ($NS['STEP'] >= 4)
			require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/classes/general/cml2.php");
...
//print_r($NS);
	...
	\Thurly\Intranet\Internals\UserSubordinationTable::performReInitialization();
	\Thurly\Intranet\Internals\UserToDepartmentTable::performReInitialization();
}
