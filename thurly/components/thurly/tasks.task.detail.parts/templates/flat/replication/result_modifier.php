...
// set data defaults
if(!\Thurly\Tasks\Util\Type::isIterable($arResult['TEMPLATE_DATA']['DATA']))
{
...
if(!array_key_exists('TIMEZONE_OFFSET', $arResult['TEMPLATE_DATA']['DATA']))
{
	...
	$arResult['TEMPLATE_DATA']['DATA']['TIMEZONE_OFFSET'] = \Thurly\Tasks\Util\User::getTimeZoneOffset($user);
}
$arResult['TEMPLATE_DATA']['UTC_TIME_ZONE_OFFSET'] = \Thurly\Tasks\Util::getServerTimeZoneOffset() + intval($arResult['TEMPLATE_DATA']['DATA']['TIMEZONE_OFFSET']);