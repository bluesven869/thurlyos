...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'SERVICE_URL' => '/thurly/components/thurly/crm.invoice.show/ajax.php?'.thurly_sessid_get(),
		...
		function()
		{
			...
			var instantEditor = BX.CrmInstantEditor.create(
				'<?=CUtil::JSEscape($instantEditorID)?>',
				{
					...
					url: '/thurly/components/thurly/crm.invoice.show/ajax.php?<?=thurly_sessid_get()?>',
