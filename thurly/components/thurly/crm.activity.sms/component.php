...
$arResult['SMS_MESSAGE'] = \Thurly\Crm\Integration\SmsManager::getMessageFields($activity['ASSOCIATED_ENTITY_ID']);
$arResult['SMS_MESSAGE_STATUS_DESCRIPTIONS'] = \Thurly\Crm\Integration\SmsManager::getMessageStatusDescriptions();
$arResult['SMS_MESSAGE_STATUS_IS_ERROR'] = \Thurly\Crm\Integration\SmsManager::isMessageErrorStatus($arResult['SMS_MESSAGE']['STATUS_ID']);
