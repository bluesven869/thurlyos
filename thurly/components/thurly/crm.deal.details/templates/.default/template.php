...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'TABS' => $arResult['TABS'],
		'SERVICE_URL' => '/thurly/components/thurly/crm.deal.details/ajax.php?action=convert&'.thurly_sessid_get(),
		'EDITOR' => array(
			'GUID' => "{$guid}_editor",
			...
			'SERVICE_URL' => '/thurly/components/thurly/crm.deal.details/ajax.php?'.thurly_sessid_get(),
...
?><script type="text/javascript">
		BX.ready(
			function()
			{
				...
				{
					serviceUrl: "<?='/thurly/components/thurly/crm.deal.details/ajax.php?action=convert&'.thurly_sessid_get()?>",
