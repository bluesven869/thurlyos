...
$arAllOptions = array(
		\Thurly\Crm\Rest\CCrmExternalChannelImportPreset::PRESET_PERSON_TYPE_COMPANY => GetMessage('CRM_TRACKER_SETTINGS_COMPANY'),
		\Thurly\Crm\Rest\CCrmExternalChannelImportPreset::PRESET_PERSON_TYPE_PERSON => GetMessage('CRM_TRACKER_SETTINGS_CONTACT')
);
