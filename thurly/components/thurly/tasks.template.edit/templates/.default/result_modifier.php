...
// make template`s checklist items sutable for thurly:tasks.task.detail.parts to swallow
...
$arResult['BX24_MODE'] = \Thurly\Main\ModuleManager::isModuleInstalled('thurlyos');