			...
			BX.Crm.RequisiteFormManager.create(componentId,
				{
					...
					formLoaderUrl: "/thurly/components/thurly/crm.requisite.edit/innerform.ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>",
					serviceUrl: "/thurly/components/thurly/crm.requisite.edit/ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>"
				}
			);
