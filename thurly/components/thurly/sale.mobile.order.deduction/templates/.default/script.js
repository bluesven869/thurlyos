__ThurlySaleMODE = function(params)
{
	for(var key in params)
		this[key] = params[key];
};

__ThurlySaleMODE.prototype.setProductStores = function(params)
{
...
__ThurlySaleMODE.prototype.setProductBarcodes = function(params)
{
...
__ThurlySaleMODE.prototype.getProductStores = function(productId)
{
	result = {};
...
__ThurlySaleMODE.prototype.getProductInfo = function(productId)
{
	var result = {};
...
__ThurlySaleMODE.prototype.deductOrder = function(params)
{
	var _this = this,
		postData = {
...
__ThurlySaleMODE.prototype.getUndoReason = function()
{
	var result = '',
...
__ThurlySaleMODE.prototype.makeFastButton = function(Id, url)
{
	var el = BX(Id);
