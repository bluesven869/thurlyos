BX.namespace('BX.Mobile.Tasks.View.Thurly');
...
BX.Mobile.Tasks.View.Thurly.taskgroups = function(opts, nf){

	this.parentConstruct(BX.Mobile.Tasks.View.Thurly.taskgroups, opts);
	...
	this.handleInitStack(nf, BX.Mobile.Tasks.View.Thurly.taskgroups, opts);
}
BX.extend(BX.Mobile.Tasks.View.Thurly.taskgroups, BX.Mobile.Tasks.widget);

// the following functions can be overrided with inheritance
BX.merge(BX.Mobile.Tasks.View.Thurly.taskgroups.prototype, {
