...
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("page", "tasks.roles");
...
BX.ready(function(){
	...
	app.hidePopupLoader();
	BX['taskgroups'] = new BX.Mobile.Tasks.View.Thurly.taskgroups({scope: BX('tasks-all-items')});
