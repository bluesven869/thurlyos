...
?>
		<li>
			<a id="bx_socserv_icon_<?=$service["ID"]?>" class="<?=\Thurly\Main\Text\HtmlFilter::encode($service["ICON"])?> bx-authform-social-icon" href="javascript:void(0)" onclick="<?=\Thurly\Main\Text\HtmlFilter::encode($onclick)?>" title="<?=\Thurly\Main\Text\HtmlFilter::encode($service["NAME"])?>"></a>
