...
<script type="text/javascript">
	BX.ready(function() {
		BX.Lists['<?=$arResult['JS_OBJECT']?>'] = new BX.Lists.ListsElementAttachedCrm({
			...
			listElementTemplateUrl: <?=\Thurly\Main\Web\Json::encode($arResult['LIST_ELEMENT_TEMPLATE_URL'])?>,
			fieldsForSetValue: <?=\Thurly\Main\Web\Json::encode($arResult['FIELDS_FOR_SET_VALUE'])?>,
			backEndUrl: '<?=$componentPath.'/lazyload.ajax.php?&site='.SITE_ID.'&'.thurly_sessid_get().''?>'
		});
		BX.message({
