...
$arParams["USER_ID"] = intval($arParams["USER_ID"]) > 0 ? intval($arParams["USER_ID"]) : \Thurly\Tasks\Util\User::getId();
...
else
{
	...
	elseif ($arParams["USER_ID"] != \Thurly\Tasks\Util\User::getId())
	{
...
$rsSections = CIBlockSection::GetList(array(), array("IBLOCK_ID"=> $IBlockID, "UF_HEAD"=>\Thurly\Tasks\Util\User::getId(), 'ACTIVE' => 'Y'), false, array('UF_HEAD'));
