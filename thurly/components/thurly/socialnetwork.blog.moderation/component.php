	...
	)
	{
		...
		if($arResult["perms"] >= Permissions::MODERATE)
		{
			...
			while($arPost = $dbPost->GetNext())
			{
				...
				$arPost["urlToPub"] = htmlspecialcharsex($APPLICATION->GetCurPageParam("pub_id=".$arPost["ID"]."&".thurly_sessid_get(), Array("del_id", "sessid", "success", "pub_id")));
				...
				{
					$arPost["urlToDelete"] = htmlspecialcharsex($APPLICATION->GetCurPageParam("del_id=".$arPost["ID"]."&".thurly_sessid_get(), Array("del_id", "sessid", "success", "pub_id")));
