;(function(window) {
	...
	BX.Sale.EbayCategories = {
		...
		init: function(params)
		{
			...
			BX.Sale.EbayCategories.thurlyPropsSelectName = params.thurlyPropsSelectName;
			BX.Sale.EbayCategories.siteId = params.siteId;
			BX.Sale.EbayCategories.thurlyCategoryId = params.thurlyCategoryId;
		...
		setVariations: function(categoryName, variationsList)
		{
			...
			variationsBlock.firstElementChild.lastElementChild.name = BX.Sale.EbayCategories.thurlyPropsSelectName + "[]";
		...
		showCreatePropertyDialog: function(params)
		{
			...
			(new BX.CDialog({
				'title': BX.message("SALE_EBAY_SEC_JS_CREATE_NEW_CATEGORY_PROP"),
				'content_url': '/thurly/admin/iblock_edit_property.php?lang='+BX.message('LANGUAGE_ID')+'&propedit='+ID+'&bxpublic=Y&receiver=obIBProps&return_url=section_edit',
		...
		linkPropertyToCategory: function(thurlyCategoryId, properyId)
		{
			var data = {
				'thurlyCategoryId': thurlyCategoryId,
				'properyId': properyId,
		...
		{
			if(!BX.Sale.EbayCategories.thurlyCategoryId)
				return;

			var data = {
				'thurlyCategoryId': BX.Sale.EbayCategories.thurlyCategoryId,
