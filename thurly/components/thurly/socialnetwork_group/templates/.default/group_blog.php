...
$APPLICATION->IncludeComponent(
	"thurly:socialnetwork.blog.menu",
	"",
	Array(
...
if(COption::GetOptionString("blog", "socNetNewPerms", "N") == "N" && $USER->IsAdmin() && !file_exists($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/thurlyos"))
{
	?>
