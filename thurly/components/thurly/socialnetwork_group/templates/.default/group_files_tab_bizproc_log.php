...
$sBPListUrl = CComponentEngine::MakePathFromTemplate($arResult["PATH_TO_GROUP_FILES_ELEMENT"], 
				array("group_id"=>$arResult["GROUP"]["ID"], "element_id" => $arResult["ELEMENT"]["ID"]));
...
<?
$APPLICATION->IncludeComponent("thurly:bizproc.document", "webdav.bizproc.document", Array(
...
?>
    ...
    <br />
<?
$APPLICATION->IncludeComponent("thurly:bizproc.log", "webdav.bizproc.log", Array(
    "MODULE_ID" => $arResult["VARIABLES"]["MODULE_ID"], 
    "ENTITY" => $arResult["VARIABLES"]["ENTITY"], 
    "COMPONENT_VERSION" => 2,
    "DOCUMENT_TYPE" => $arResult["VARIABLES"]["DOCUMENT_TYPE"], 
