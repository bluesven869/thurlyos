...
elseif (\Thurly\Main\ModuleManager::isModuleInstalled('intranet'))
{
	$page = 'user_projects';
}
else
...
$APPLICATION->IncludeComponent(
	"thurly:socialnetwork.user_groups", 
	"", 
	Array(
		...
		"PAGE" => $page,
		"USE_PROJECTS" => (\Thurly\Main\ModuleManager::isModuleInstalled('intranet') ? 'Y' : 'N'),
		...
		"USE_UI_FILTER" => (SITE_TEMPLATE_ID == 'thurlyos' ? "Y" : "N")
	),
	$component 
);
?>