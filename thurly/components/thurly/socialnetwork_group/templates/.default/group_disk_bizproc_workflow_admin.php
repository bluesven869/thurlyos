...
$storage = \Thurly\Disk\Driver::getInstance()->getStorageByGroupId($arResult['VARIABLES']['group_id']);
...
<?
$APPLICATION->IncludeComponent("thurly:disk.bizproc.list", ".default", Array(
