				...
				"data" => array(
					...
					"items" => array(
						array(
							...
							"values" => array(
								array(
									"USER" => GetMessage("CRM_INVOICE_WGT_DATA_EMPLOYEE_1"),
									"SUM_IN_WORK_SUM_TOTAL" => "23000",
									"SUM_SUCCESSFUL_SUM_TOTAL" => "12000",
									"SUM_OVERDUE_SUM_TOTAL"=> "3000",
									"SUM_OWED_SUM_TOTAL" => "2000"
								),
								array(
									"USER" => GetMessage("CRM_INVOICE_WGT_DATA_EMPLOYEE_2"),
									"SUM_IN_WORK_SUM_TOTAL" => "28000",
									"SUM_SUCCESSFUL_SUM_TOTAL" => "15000",
									"SUM_OVERDUE_SUM_TOTAL"=> "2000",
									"SUM_OWED_SUM_TOTAL" => "3000"
								),
								array(
									"USER" => GetMessage("CRM_INVOICE_WGT_DATA_EMPLOYEE_3"),
									"SUM_IN_WORK_SUM_TOTAL" => "19000",
									"SUM_SUCCESSFUL_SUM_TOTAL" => "8000",
									"SUM_OVERDUE_SUM_TOTAL"=> "1000",
									"SUM_OWED_SUM_TOTAL" => "1000"
								)
							)
						)
					)
					...
					"items" => array(
						array(
							...
							"values" => array(
								array(
									"USER" => GetMessage("CRM_INVOICE_WGT_DATA_EMPLOYEE_1"),
									"TOTAL_INVOICE_SUM" => "23000",
									"TOTAL_OWED" => "2000"
								),
								array(
									"USER" => GetMessage("CRM_INVOICE_WGT_DATA_EMPLOYEE_2"),
									"TOTAL_INVOICE_SUM" => "28000",
									"TOTAL_OWED" => "3000"
								),
								array(
									"USER" => GetMessage("CRM_INVOICE_WGT_DATA_EMPLOYEE_3"),
									"TOTAL_INVOICE_SUM" => "19000",
									"TOTAL_OWED" => "1000"
								)
							)
						)
