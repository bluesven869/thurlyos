...
else
{
	...
	while ($arMessages = $dbMessages->GetNext())
	{
		...
		$arImage = CSocNetTools::InitImage($arMessages["PERSONAL_PHOTO"], 100, "/thurly/images/socialnetwork/nopic_user_100.gif", 100, $pu, $canViewProfile);
		...
		$arResult["Events"][] = array(
			...
			"BAN_LINK" => htmlspecialcharsbx($APPLICATION->GetCurUri("userID=".$arMessages["ID"]."&action=ban&".thurly_sessid_get()."")),
