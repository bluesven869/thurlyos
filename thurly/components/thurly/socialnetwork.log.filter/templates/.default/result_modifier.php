...
)
{
	...
	if ($arParams["USE_SONET_GROUPS"] != "N")
	{
		$arResult["TO_DEST"]["ITEMS"]["SONETGROUPS"] = \Thurly\Socialnetwork\ComponentHelper::getSonetGroupAvailable();
	}
...
{
	$arResult["EnableFulltextSearch"] = \Thurly\Socialnetwork\LogIndexTable::getEntity()->fullTextIndexEnabled("CONTENT");
