...
//					}
	...
	$APPLICATION->AddHeadScript('/thurly/components/thurly/intranet.user.selector.new/templates/.default/users.js');
	$APPLICATION->AddHeadScript('/thurly/components/thurly/socialnetwork.group.selector/templates/.default/script.js');
	
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/intranet.user.selector.new/templates/.default/style.css");
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/socialnetwork.group.selector/templates/.default/style.css");
