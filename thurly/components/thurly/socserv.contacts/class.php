...
use Thurly\Socialservices\ContactConnectTable;
use Thurly\Socialservices\ContactTable;


class CSocservContactsComponent extends CThurlyComponent
{
				...
				'runtime' => array(
					new \Thurly\Main\Entity\ReferenceField(
						...
						array(
							...
							"=ref.CONNECT_TYPE" => new \Thurly\Main\DB\SqlExpression(
