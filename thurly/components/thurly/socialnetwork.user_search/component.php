...
$arResult["Urls"]["UserSearch"] = (\Thurly\Main\ModuleManager::isModuleInstalled('intranet') ? $APPLICATION->GetCurPage() : CComponentEngine::MakePathFromTemplate($arParams["PATH_TO_SEARCH_INNER"], array()));
...
if ($arResult["ShowResults"])
{
	...
	else
	{
		...
		while ($arUser = $dbUsers->GetNext())
		{
			...
			$arImage = CSocNetTools::InitImage($arUser["PERSONAL_PHOTO"], $iSize, "/thurly/images/socialnetwork/nopic_user_".$iSize.".gif", $iSize, $arUser["URL"], $arUser["SHOW_PROFILE_LINK"]);
