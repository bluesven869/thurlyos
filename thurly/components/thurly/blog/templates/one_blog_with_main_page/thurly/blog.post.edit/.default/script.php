...
print ($i%18==0) ? "<tr>" : "";
print "<td bgcolor='$t_curCOL' onmousedown=\"alterfont('$t_curCOL','COLOR')\"><img src=/thurly/images/1.gif border=0 width=10 height=10></td>";
}
?>
</table>
</td>
...
blogVars = {'templatePath' : '/thurly/components/thurly/blog.post.edit/templates/.default/'};
