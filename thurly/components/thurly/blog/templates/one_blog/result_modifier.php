...
$arThemes = array();
$dir = trim(preg_replace("'[\\\\/]+'", "/", $_SERVER["DOCUMENT_ROOT"]."/thurly/components/thurly/blog/templates/.default/themes/"));
...
{
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/blog/templates/.default/themes/'.$arParams["THEME"].'/style.css');
}
?>