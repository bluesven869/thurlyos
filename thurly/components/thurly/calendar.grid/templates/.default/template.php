...
<? if ($arParams["SHOW_FILTER"]):?>
	<div id="<?= $arResult['ID']?>-search-container" class="pagetitle-container pagetitle-flexible-space<?= $isThurlyOSTemplate ? '' : ' calendar-default-search-wrap' ?>">
	<?
	// Reset filter to default state
	$filterOption = new \Thurly\Main\UI\Filter\Options($arParams["FILTER_ID"]);
	$filterOption->reset();
	...
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"THEME" => $isThurlyOSTemplate ? "DEFAULT" : "BORDER"
		),
		$component,
...
<? endif;?>
<div id="<?= $arResult['ID']?>-buttons-container" class="pagetitle-container pagetitle-align-right-container<?= $isThurlyOSTemplate ? '' : ' calendar-default-buttons-container' ?>"></div>
<?
if($isThurlyOSTemplate)
{
	$this->EndViewTarget();
...
<?
$stepperHtml = \Thurly\Main\Update\Stepper::getHtml(array("calendar" => array('Thurly\Calendar\Update\IndexCalendar')),\Thurly\Main\Localization\Loc::getMessage("EC_CALENDAR_INDEX"));
if ($stepperHtml)
{
...
<?$spotlight = new \Thurly\Main\UI\Spotlight("CALENDAR_NEW_SYNC");?>
...
{
	$spotlightList = new \Thurly\Main\UI\Spotlight("CALENDAR_NEW_LIST");
