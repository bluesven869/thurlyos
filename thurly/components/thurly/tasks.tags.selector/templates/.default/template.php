	...
	tasksTagsPopUp = new BX.TagsWindow.create("task-tags-popup", null, tags, {
		events : {
			"onSaveButtonClick" : function(tagsWindow) {
				...
				var url = "/thurly/components/thurly/tasks.tags.selector/ajax.php";
...
<?php if (!isset($arParams["SILENT"]) || $arParams["SILENT"] != "Y"):?>
	...
	<span id="task-tags-line" class="task-tags-line"><?php echo implode(", ", $arResult["VALUE"])?>&nbsp;&nbsp;</span><span class="task-dashed-link"><span class="task-dashed-link-inner" id="task-tags-link"><?=GetMessage("TASKS_TAGS_CHANGE")?></span></span>
	<?php else:?>
