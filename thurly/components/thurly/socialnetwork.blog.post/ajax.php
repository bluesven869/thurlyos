...
if (
	...
	|| !\Thurly\Main\Loader::includeModule('blog')
)
{
...
$postItem = \Thurly\Blog\Item\Post::getById($postId);
if (!$postItem)
{
...
if ($action == 'get_data')
{
	...
	else
	{
		if (!$logId)
		{
			$perms = \Thurly\Blog\Item\Permissions::DENY;
		}
		elseif (
	...
	$isShareForbidden = \Thurly\Socialnetwork\ComponentHelper::getBlogPostLimitedViewStatus(array(
		'logId' => intval($logId),
