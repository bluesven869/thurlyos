...
Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.activity.email/class.php');

class CrmActivityEmailBodyComponent extends CThurlyComponent
{
	...
	public function executeComponent()
	{
		...
		\CThurlyComponent::includeComponentClass('thurly:crm.activity.email');
