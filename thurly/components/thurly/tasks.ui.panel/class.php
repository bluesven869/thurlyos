...
class TasksUiPanelComponent extends CThurlyComponent
{
	protected $userId = 0;
	...
	protected function init()
	{
		...
		if (($this->userId = (int) \Thurly\Tasks\Util\User::getId()) <= 0)
		{
			return false;
		}
	...
	public function executeComponent()
	{
		...
		$this->arResult['BX24_RU_ZONE'] = \Thurly\Main\ModuleManager::isModuleInstalled('thurlyos')
											&& preg_match('/^(ru)_/', \Thurly\Main\Config\Option::get('main', '~controller_group_name', ''));
