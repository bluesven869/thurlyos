...
{
	$APPLICATION->SetTitle(\Thurly\Main\Localization\Loc::getMessage("OL_STAT_TITLE", Array('#LINE_NAME#' => htmlspecialcharsbx($arResult['LINE_NAME']))));
}
...
if($isThurlyOSTemplate)
{
	...
	if($isAdmin)
	{
		echo Thurly\Imopenlines\Ui\Helper::getStatisticStepper();
	}
}
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"AJAX_ID" => CAjax::GetComponentID('thurly:imopenlines.statistics.detail', '.default', '')
	),
	$component, array("HIDE_ICONS" => "Y")
);

\Thurly\Imopenlines\Ui\Helper::renderCustomSelectors($arResult['FILTER_ID'], $arResult['FILTER']);
?>