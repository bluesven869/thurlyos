...
{
	echo '<img src="/thurly/components/thurly/map.google.search/templates/.default/images/preview.png" border="0" />';
}
else
{
	?>
	...
	<?
	$APPLICATION->IncludeComponent('thurly:map.google.system', '.default', $arParams, null, array('HIDE_ICONS' => 'Y'));
	?>
		</div>
