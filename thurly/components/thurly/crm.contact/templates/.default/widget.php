...
?><div class="bx-crm-view"><?
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			'PATH_TO_WIDGET' => isset($arResult['PATH_TO_CONTACT_WIDGET']) ? $arResult['PATH_TO_CONTACT_WIDGET'] : '',
			'PATH_TO_LIST' => isset($arResult['PATH_TO_CONTACT_LIST']) ? $arResult['PATH_TO_CONTACT_LIST'] : '',
			'PATH_TO_DEMO_DATA' => $_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/crm.contact/templates/.default/widget',
