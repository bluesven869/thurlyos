...
if (CLearnAccessMacroses::CanUserAddLessonWithoutParentLesson() || $USER->IsAdmin())
{
	$arAreaButtons = array(
		array(
			...
			"URL" => 'javascript:'.$APPLICATION->GetPopupLink(
				array(
					"URL" => "/thurly/admin/learn_course_edit.php?lang=".LANGUAGE_ID."&bxpublic=Y&from_module=learning",
					"PARAMS" => array(
	...
	if(CModule::IncludeModule("intranet") && is_object($GLOBALS['INTRANET_TOOLBAR']))
	{
		$GLOBALS['INTRANET_TOOLBAR']->AddButton(array(
			...
			'ICON' => 'add',
			'HREF' => '/thurly/admin/learn_course_edit.php?lang='.LANGUAGE_ID,
			'SORT' => '100',
		));
		$GLOBALS['INTRANET_TOOLBAR']->AddButton(array(
			...
			'ICON' => 'settings',
			'HREF' => '/thurly/admin/learn_unilesson_admin.php?lang=' . LANGUAGE_ID . '&PARENT_LESSON_ID=-1',
			'SORT' => '200',
		));
	}
}
