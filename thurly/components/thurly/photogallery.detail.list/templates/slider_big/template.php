...
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/photogallery/templates/.default/script.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/photogallery.detail.list/templates/slide_show/script_player.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/photogallery.detail.list/templates/slider_big/script_slider.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/photogallery.detail.list/templates/slider_big/script_effects.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/photogallery.detail.list/templates/slider_big/script_cursor.js");
if ($arParams["USE_RATING"] == "Y"):
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/iblock.vote/ajax/style.css');
	if ($this->__component->__parent && is_file($_SERVER['DOCUMENT_ROOT'].$this->__component->__parent->__template->__folder."/thurly/iblock.vote/ajax/script.js"))
	{
		$GLOBALS['APPLICATION']->AddHeadScript($this->__component->__parent->__template->__folder."/thurly/iblock.vote/ajax/script.js");
	}
	else
	{
		$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/iblock.vote/ajax/script.js");
	}
endif;
CAjax::Init();
...
{
	$GLOBALS['APPLICATION']->AddHeadScript('/thurly/js/main/admin_tools.js');
