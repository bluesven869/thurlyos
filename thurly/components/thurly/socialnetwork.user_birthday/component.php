				...
				if ($dbFriends)
				{
					...
					while ($arFriends = $dbFriends->GetNext())
					{
						...
						if (intval($arParams["THUMBNAIL_LIST_SIZE"]) > 0)
						{
							...
							$arImage = CSocNetTools::InitImage($arFriends["PERSONAL_PHOTO"], $arParams["THUMBNAIL_LIST_SIZE"], "/thurly/images/socialnetwork/nopic_30x30.gif", 30, $pu, $canViewProfile);
						}
						else // old 
							$arImage = CSocNetTools::InitImage($arFriends["PERSONAL_PHOTO"], 50, "/thurly/images/socialnetwork/nopic_user_50.gif", 50, $pu, $canViewProfile);
