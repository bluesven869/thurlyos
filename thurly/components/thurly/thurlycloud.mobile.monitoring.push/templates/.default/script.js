__thurlyCloudPush = function(params) {

	for(var key in params)
		this[key] = params[key];
};

__thurlyCloudPush.prototype.makeFastButton = function(Id, url)
{
	var el = BX(Id);
...
__thurlyCloudPush.prototype.close = function()
{
	if(app.enableInVersion(8))
...
__thurlyCloudPush.prototype.getOptions = function()
{
...
__thurlyCloudPush.prototype.save = function()
{
