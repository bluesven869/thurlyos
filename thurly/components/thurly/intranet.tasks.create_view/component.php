...
else
{
	...
	include($_SERVER['DOCUMENT_ROOT']."/thurly/components/thurly/intranet.tasks/init.php");
	...
	if (StrLen($arResult["FatalError"]) <= 0)
	{
		$arUserTemplatesList = CComponentUtil::GetTemplatesList("thurly:intranet.tasks.view", SITE_TEMPLATE_ID);
