...
foreach ($properties as $name => $property):
	...
	$title = \Thurly\Bizproc\RestActivityTable::getLocalization($property['NAME'], LANGUAGE_ID);
	...
	<div class="crm-automation-popup-settings">
		<span class="crm-automation-popup-settings-title crm-automation-popup-settings-title-top crm-automation-popup-settings-title-autocomplete"><?=htmlspecialcharsbx($title)?>: </span>
		<?
		switch ($property['TYPE'])
		{
			case 'bool':
				...
				?>
				<select class="crm-automation-popup-settings-dropdown <?=$multiple?'multiple':''?>" name="<?=htmlspecialcharsbx($name)?>">
			...
			case 'datetime':
				foreach ($values as $value):
				?>
				<input name="<?=htmlspecialcharsbx($name)?>" type="text" class="crm-automation-popup-input crm-automation-popup-input-calendar <?=$multiple?'multiple':''?>"
			...
			case 'int':
				foreach ($values as $value):
				?>
				<input name="<?=htmlspecialcharsbx($name)?>" type="text" class="crm-automation-popup-input crm-automation-popup-input-numeric <?=$multiple?'multiple':''?>"
					value="<?=htmlspecialcharsbx($value)?>"
					placeholder="<?=htmlspecialcharsbx(!empty($property['DESCRIPTION']) ? $property['DESCRIPTION'] : '')?>"
					data-role="inline-selector-target"
				>
			...
			case 'select':
				...
				?>
				<select class="crm-automation-popup-settings-dropdown<?=$multiple?'-multiple':''?>" name="<?=htmlspecialcharsbx($name)?>" <?=$multiple ? 'multiple="multiple"' : ''?>>
					<?if (!$multiple):?><option value=""><?=GetMessage('CRM_AUTOMATION_NOT_SELECTED')?></option><?endif;?>
					<?
			...
			case 'string':
				foreach ($values as $value):
				?>
				<input name="<?=htmlspecialcharsbx($name)?>" type="text" class="crm-automation-popup-input <?=$multiple?'multiple':''?>"
					value="<?=htmlspecialcharsbx($value)?>"
					placeholder="<?=htmlspecialcharsbx(!empty($property['DESCRIPTION']) ? $property['DESCRIPTION'] : '')?>"
					data-role="inline-selector-target"
				>
			...
			case 'text':
				...
				<textarea name="<?=htmlspecialcharsbx($name)?>"
					class="crm-automation-popup-textarea <?=$multiple?'multiple':''?>"
					placeholder="<?=htmlspecialcharsbx(!empty($property['DESCRIPTION']) ? $property['DESCRIPTION'] : '')?>"
					data-role="inline-selector-target"
		...
		<div>
			<a onclick="BPRobotSetField.cloneControl('<?=CUtil::JSEscape($property['TYPE'])?>', '<?=CUtil::JSEscape($name)?>', this.parentNode); return false;" class="crm-automation-popup-settings-link crm-automation-popup-settings-link-thin">
				<?=htmlspecialcharsbx(GetMessage('CRM_AUTOMATION_ADD_MULTIPLE'))?>
			</a>
		</div>
		<?endif;?>
	</div>
	...
	BX.ready(function()
	{
		window.BPRobotSetField = {
			...
			createBoolNode: function(name)
			{
				...
				div.innerHTML = '<select class="crm-automation-popup-settings-dropdown multiple" name="'+ name + '">'
				+ '<option value=""><?=GetMessageJS('CRM_AUTOMATION_NOT_SELECTED')?></option>'
			...
			createDateNode: function(name, type)
			{
				...
				div.innerHTML = '<input name="'+name+'" type="text" class="crm-automation-popup-input crm-automation-popup-input-calendar multiple"'
			...
			createNumericNode: function(name, type)
			{
				...
				div.innerHTML = '<input name="'+name+'" type="text" class="crm-automation-popup-input crm-automation-popup-input-numeric multiple"'
					+ ' data-role="inline-selector-target">';
			...
			createStringNode: function(name)
			{
				...
				div.innerHTML = '<input name="'+name+'" type="text" class="crm-automation-popup-input multiple>"'
					+ ' data-role="inline-selector-target">';
			...
			createTextNode: function(name)
			{
				...
				div.innerHTML = '<textarea name="'+name+'" class="crm-automation-popup-textarea multiple" data-role="inline-selector-target"></textarea>';
