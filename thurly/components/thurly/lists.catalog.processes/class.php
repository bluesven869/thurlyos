...
class ListsCatalogProcessesComponent extends CThurlyComponent
{
	/** @var  array */
	...
	protected function loadDataProcesses()
	{
		...
		try
		{
			...
			\Thurly\Lists\Importer::loadDataProcesses($defaultLang, true, $this->arResult['SYSTEM_PROCESSES']);
			\Thurly\Lists\Importer::loadDataProcesses($defaultLang, false, $this->arResult['USER_PROCESSES']);
