...
{
	$APPLICATION->AddHeadScript('/thurly/components/thurly/intranet.tasks/js/dialogs.js');
	$redStar = "<span class='red_star'>*</span>";

	$APPLICATION->IncludeComponent(
		"thurly:intranet.tasks.view",
		...
		<table class="intask-edit-dlg-frame">
			<tr>
				<td class="intask-title-cell" colspan="2">
					<table cellPadding="0" cellSpacing="0"><tr><td style="width: 10px; padding-left: 3px;"><img class="intask-iconkit intask-dd-dot" src="/thurly/images/1.gif"></td><td class="intask-edit-dlg-title" id="intask_folder_dialog_title"></td><td id="intask_folder_dialog_close" class="intask-close" title="<?= GetMessage("INTST_CLOSE") ?>"><img class="intask-iconkit" src="/thurly/images/1.gif"></td></tr></table>
				</td>
			<tr>
