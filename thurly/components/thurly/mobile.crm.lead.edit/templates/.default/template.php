	...
	var menu = new BXMobileApp.UI.Menu({
		items: [
			<?if ($arResult["IS_EDIT_PERMITTED"]):?>
			{
				...
				image: "/thurly/js/mobile/images/edit.png",
			...
			<?if ($arResult["IS_DELETE_PERMITTED"]):?>
			{
				...
				image: "/thurly/js/mobile/images/del.png",
				action: BX.proxy(function()
				{
			...
			<?if ($arResult["IS_EDIT_PERMITTED"]):?>
			{
				...
				image: "/thurly/js/mobile/images/base.png",
				action: BX.proxy(function()
				{
					BX.message({
...

			{
				...
				image: "/thurly/js/mobile/images/history.png",
				action: BX.proxy(function()
				{
			...
			},
			{
				...
				image: "/thurly/js/mobile/images/activity.png",
				action: BX.proxy(function()
				{
