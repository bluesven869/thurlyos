...
\Thurly\Main\Page\Asset::getInstance()->addJs('/thurly/js/crm/slider.js');
\Thurly\Main\Page\Asset::getInstance()->addJs('/thurly/js/crm/requisite.js');
\Thurly\Main\Page\Asset::getInstance()->addCss('/thurly/js/crm/css/slider.css');
...
{
	\Thurly\Main\Page\Asset::getInstance()->addCss("/thurly/themes/.default/thurlyos/crm-entity-show.css");
}
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'USER_FIELD_SERVICE_URL' => '/thurly/components/thurly/crm.requisite.edit/uf.ajax.php?siteID='.SITE_ID.'&'.thurly_sessid_get(),
		'IS_NEW' => $elementID <= 0,
	...
	BX.ready(function()
	{
		...
		BX.Crm.RequisiteSliderEditor.create(
			formId,
			{
				...
				entityId: <?=$entityID?>,
				formId: formId,
				formSumbitUrl: "/thurly/components/thurly/crm.requisite.edit/popup.ajax.php?&site=<?=SITE_ID?>&<?=thurly_sessid_get()?>",
...
if($arResult['DUPLICATE_CONTROL']['ENABLED'] && !$arResult['NEED_CLOSE_POPUP'])
{
	...
	BX.ready(function()
	{
		...
		var dupController = BX.CrmDupController.create(
			dupControllerId,
			{
				"serviceUrl": "/thurly/components/thurly/crm.requisite.edit/ajax.php?&<?=thurly_sessid_get()?>",
