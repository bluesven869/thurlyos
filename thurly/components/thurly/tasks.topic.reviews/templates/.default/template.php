...
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/forum.interface/templates/popup/script.js");
$GLOBALS['APPLICATION']->AddHeadScript("/thurly/components/thurly/forum.interface/templates/.default/script.js");
		...
		<div id="task-comments-form" class="task-comments-form">
			<?php
				...
				$LHE->Show(array(
					...
					'bBBParseImageSize' => true,
					'documentCSS' => '
						body blockquote.bx-quote { width: 90%; padding: 10px 17px !important; background:url("/thurly/js/tasks/css/images/quote-gray.png") no-repeat left top #F7F7F7; color:#7D7D7D !important; margin:0 !important; }
		...
		<?php if ($arResult["SHOW_PANEL_ATTACH_IMG"] == "Y"):?>
			<div class="reviews-reply-field reviews-reply-field-upload">
				...
				<div class="reviews-uploaded-file">
					...
					<?php echo $sFileSize?> ( <a href="/thurly/components/thurly/forum.interface/show_file.php?action=download&amp;fid=<?php echo $key?>"><?php echo GetMessage("F_DOWNLOAD")?> </a> ) </label>
				</div>
				<?php endforeach?>
				<?php endif?>
				...
				<div class="task-comment-info">
					...
					<?if ($arParams["SHOW_RATING"] == "Y") {?>
						<div class="task-comments-rating rating_vote_graphic">
							...
							$GLOBALS["APPLICATION"]->IncludeComponent( "thurly:rating.vote", $arParams["RATING_TYPE"], $arRatingParams, $component, array("HIDE_ICONS" => "Y"));
							?>
						</div>
					<? } ?>
