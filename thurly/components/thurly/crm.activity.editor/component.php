...
if($flashPlayerUrl === '')
{
	$flashPlayerUrl = CComponentEngine::makePathFromTemplate('#SITE_DIR#thurly/components/thurly/player/mediaplayer/player');
}
...
{
	$flashPlayerApiUrl = CComponentEngine::makePathFromTemplate('#SITE_DIR#thurly/components/thurly/player/mediaplayer/jwplayer.js');
}
$arResult['FLASH_PLAYER_API_URL'] = $flashPlayerApiUrl;

$arResult['CREATE_EVENT_URL'] = CComponentEngine::makePathFromTemplate('#SITE_DIR#thurly/components/thurly/crm.event.add/box.php');
