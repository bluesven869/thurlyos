...
CCrmComponentHelper::RegisterScriptLink('/thurly/js/crm/activity.js');
CCrmComponentHelper::RegisterScriptLink('/thurly/js/crm/crm.js');
CCrmComponentHelper::RegisterScriptLink('/thurly/js/crm/communication_search.js');
