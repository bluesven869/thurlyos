...
?><?$APPLICATION->IncludeComponent("thurly:forum.statistic", "", 
	Array(
...
if ($arInfo != false):
?><div class='forum_post_form'><?$APPLICATION->IncludeComponent("thurly:forum.post_form", "", 
	Array(
		"FID"	=>	$arInfo["FID"],
		"TID"	=>	$arInfo["TID"],
		"MID"	=>	0,
