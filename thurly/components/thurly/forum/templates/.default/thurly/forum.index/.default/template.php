...
$arResult["USER"]["HIDDEN_GROUPS"] = explode("/", $_COOKIE[COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_FORUM_GROUP"]);
...
?>
							<span class="forum-footer-option forum-footer-markread<?=($arParams["SHOW_RSS"] == "Y" ? "" : " forum-footer-option-first")?>"><?
								?><noindex><a rel="nofollow" <?
									...
									?>onclick="return this.href+=('&sessid='+BX.thurly_sessid());";><?
