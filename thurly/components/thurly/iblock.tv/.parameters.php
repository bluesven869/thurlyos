...
$arComponentParameters = array(
	"GROUPS" => array(
		"SETTINGS" => array(
			"NAME" => GetMessage("THURLYTV_GROUP_SETTINGS"),
			"SORT" => 20
		),
		"PREVIEW_TV" => array(
			"NAME" => GetMessage("THURLYTV_GROUP_PREVIEW_TV"),
			"SORT" => 40
		),
		"PREVIEW_TV_LIST" => array(
			"NAME" => GetMessage("THURLYTV_GROUP_PREVIEW_TV_PLAYER"),
			"SORT" => 60
		),
		"STAT" => array(
			"NAME" => GetMessage("THURLYTV_SETTING_STAT"),
			"SORT" => 60
		),
	),
	"PARAMETERS" => array(
		"DEFAULT_SMALL_IMAGE" => Array(
			...
			"NAME" => GetMessage("THURLYTV_SETTING_DEFAULT_SMALL_IMAGE"),
			"TYPE" => "FILE",
			"DEFAULT" => "/thurly/components/thurly/iblock.tv/templates/.default/images/default_small.png",
			"SORT" => 10,
		),

		"DEFAULT_BIG_IMAGE" => Array(
			"PARENT" => "PREVIEW_TV_LIST",
			"NAME" => GetMessage("THURLYTV_SETTING_DEFAULT_BIG_IMAGE"),
			"TYPE" => "FILE",
			"DEFAULT" => "/thurly/components/thurly/iblock.tv/templates/.default/images/default_big.png",
			"SORT" => 20,
		),
		...
		"IBLOCK_TYPE" => Array(
			"PARENT" => "SETTINGS",
			"NAME" => GetMessage("THURLYTV_SETTING_IBLOCK_TYPE"),
			"TYPE" => "LIST",
			"VALUES" => $arIBTypes,
			"DEFAULT" => "",
			"REFRESH" => "Y",
		...
		"IBLOCK_ID" => Array(
			"PARENT" => "SETTINGS",
			"NAME" => GetMessage("THURLYTV_SETTING_IBLOCK_ID"),
			"TYPE" => "LIST",
			"VALUES" => $arIBlocks,
			"DEFAULT" => "",
			"REFRESH" => "Y",
		...
		"ALLOW_SWF" => Array(
			"PARENT" => "SETTINGS",
			"NAME" => GetMessage("THURLYTV_SETTING_ALLOW_SWF"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "N",
			"SORT" => 25,
		),
		...
		"SHOW_COUNTER_EVENT" => Array(
			"PARENT" => "STAT",
			"NAME" => GetMessage("THURLYTV_SETTING_SHOW_COUNTER_EVENT"),
			"TYPE" => "CHECKBOX",
			"VALUE" => "Y",
			"DEFAULT" => "N",
		),
...
if(isset($arCurrentValues["IBLOCK_ID"]) && intval($arCurrentValues["IBLOCK_ID"])>0)
{
	...
	$arComponentParameters["PARAMETERS"]["PATH_TO_FILE"] = Array(
		"PARENT" => "SETTINGS",
		"NAME" => GetMessage("THURLYTV_SETTING_PATH_TO_FILE"),
		"TYPE" => "LIST",
		"VALUES" => $arProperties,
		"DEFAULT" => "",
		"SORT" => 40,
	...
	$arComponentParameters["PARAMETERS"]["DURATION"] = Array(
		"PARENT" => "SETTINGS",
		"NAME" => GetMessage("THURLYTV_SETTING_DURATION"),
		"TYPE" => "LIST",
		"VALUES" => $arProperties,
		"DEFAULT" => "",
		"SORT" => 50,
	...
	$arComponentParameters["PARAMETERS"]["WIDTH"] = Array(
		"PARENT" => "PREVIEW_TV",
		"NAME" => GetMessage("THURLYTV_SETTING_PREVIEW_WIDTH"),
		"TYPE" => "STRING",
		"DEFAULT" => "400",
		"SORT" => 10,
	);
	...
	$arComponentParameters["PARAMETERS"]["HEIGHT"] = Array(
		"PARENT" => "PREVIEW_TV",
		"NAME" => GetMessage("THURLYTV_SETTING_PREVIEW_HEIGHT"),
		"TYPE" => "STRING",
		"DEFAULT" => "300",
		"SORT" => 20,
	);
	...
	$arComponentParameters["PARAMETERS"]["LOGO"] = Array(
		"PARENT" => "PREVIEW_TV",
		"NAME" => GetMessage("THURLYTV_SETTING_LOGO"),
		"TYPE" => "FILE",
		"DEFAULT" => "",
		"SORT" => 25,
		"DEFAULT" => "/thurly/components/thurly/iblock.tv/templates/.default/images/logo.png"
	);
	...
	$arComponentParameters["PARAMETERS"]["SECTION_ID"] = Array(
		"PARENT" => "PREVIEW_TV",
		"NAME" => GetMessage("THURLYTV_SETTING_PREVIEW_TV_SECTION"),
		"TYPE" => "LIST",
	...
	if(isset($arCurrentValues["SECTION_ID"]) && intval($arCurrentValues["SECTION_ID"])>0)
	{
		...
		$arComponentParameters["PARAMETERS"]["ELEMENT_ID"] = Array(
			"PARENT" => "PREVIEW_TV",
			"NAME" => GetMessage("THURLYTV_SETTING_PREVIEW_TV_ELEMENT"),
			"TYPE" => "LIST",
...
if(IsModuleInstalled('statistic'))
{
	$arComponentParameters["PARAMETERS"]["STAT_EVENT"] = Array(
		"PARENT" => "STAT",
		"NAME" => GetMessage("THURLYTV_SETTING_STAT_EVENT"),
		"TYPE" => "CHECKBOX",
		"VALUE" => "Y",
		"DEFAULT" => "N",
		"REFRESH" => "Y",
	...
	if(isset($arCurrentValues["STAT_EVENT"]) && $arCurrentValues["STAT_EVENT"] == "Y")
	{
		$arComponentParameters["PARAMETERS"]["STAT_EVENT1"] = Array(
			"PARENT" => "STAT",
			"NAME" => GetMessage("THURLYTV_SETTING_STAT_EVENT1"),
			"TYPE" => "STRING",
			"DEFAULT" => "player",
		);
		$arComponentParameters["PARAMETERS"]["STAT_EVENT2"] = Array(
			"PARENT" => "STAT",
			"NAME" => GetMessage("THURLYTV_SETTING_STAT_EVENT2"),
			"TYPE" => "STRING",
