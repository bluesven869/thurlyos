...
<div class="tracker-agreement-shadow">
	<div class="tracker-agreement-popup">
		...
		<div class="tracker-agreement-popup-button">
			<div id="faceid-agreement-accept" class="webform-small-button webform-small-button-accept tracker-agreement-popup-button-item"><?=Loc::getMessage('FACEID_TRACKERWD_CMP_AGR_BUTTON')?></div>
		</div>
	</div>
</div>
