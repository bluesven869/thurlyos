...
use \Thurly\Vote\Base\Diag;

class CVoteUfComponent extends \CThurlyComponent
{
	...
	public function __construct($component = null)
	{
		...
		$this->errorCollection = new \Thurly\Main\ErrorCollection();
	}
	...
	public function executeComponent()
	{
		try
		{
			\Thurly\Main\Loader::includeModule("vote");
	...
	protected function prepareParams()
	{
		...
		if (empty($this->arParams["arUserField"]))
			throw new \Thurly\Main\ArgumentNullException("arUserField");

		$this->userFieldManager = \Thurly\Vote\Uf\Manager::getInstance($this->arParams["arUserField"]);
		...
		else
		{
			...
			if (!empty($result))
			{
				...
				/**
				 * @var $attach \Thurly\Vote\Attachment\Attach
				 */
