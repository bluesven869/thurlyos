...
{
	var q = window.top != window.self ? GetInput_<?=$name_x; ?>(top.document) : GetInput_<?=$name_x; ?>();
	q.value = value;
	if (BX)
...
BX.loadCSS("/thurly/components/thurly/intranet.user.search/templates/.default/style.css");
<? } ?>
