...
JCEmployeeSelectControl.prototype.Show = function(arParams)
{
	...
	var url = '/thurly/components/thurly/intranet.user.search/ajax.php?lang=' + this.arParams.LANGUAGE_ID + '&win_id=' +this.arParams.WIN.id + '&SITE_ID=' + this.arParams.SITE_ID + '&IS_EXTRANET=' + this.arParams.IS_EXTRANET + '&sessid=' + this.arParams.SESSID + '&nt=' + this.arParams.NAME_TEMPLATE;
