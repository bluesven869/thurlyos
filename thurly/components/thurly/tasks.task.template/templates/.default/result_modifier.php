...
$arResult['TEMPLATE_DATA']['BLOCKS'] = array(
	...
	'SE_AUDITOR' => array(
		'FILLED' => !$template['AUDITORS']->isEmpty(),
	),
	'SE_ACCOMPLICE' => array(
		'FILLED' => !$template['ACCOMPLICES']->isEmpty(),
	),
	'DATE_PLAN' => array(
	...
	'TAG' => array(
		'FILLED' => !$template['SE_TAG']->isEmpty(),
	),
	'USER_FIELDS' => array(
		'FILLED' => $ufFilled,
	),
	'RELATED_TASK' => array(
		'FILLED' => !$template['DEPENDS_ON']->isEmpty()
	),
	'ACCESS' => array(
		'FILLED' => $accessFilled
	),
...
$arResult['JS_DATA']['deadline'] = $helper->detectUnitType($template['DEADLINE_AFTER']);
$arResult['JS_DATA']['startDate'] = $helper->detectUnitType($template['START_DATE_PLAN_AFTER']);
$arResult['JS_DATA']['duration'] = $helper->detectUnitType($template['END_DATE_PLAN_AFTER'] - $template['START_DATE_PLAN_AFTER']);