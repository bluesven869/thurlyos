...
<script>
	<?if((string) $arParams['LOGIC_INSTANCE_CODE'] != ''):?>BX['<?=CUtil::JSEscape($arParams['LOGIC_INSTANCE_CODE'])?>']<?/*temporal solution*/?> = <?endif?>new BX.Mobile.Tasks.View.Thurly.taskgroups({scope: BX('tasks-all-items')});
</script>
