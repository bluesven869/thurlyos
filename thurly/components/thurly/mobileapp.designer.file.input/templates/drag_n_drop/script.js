...
window.BlogBFileDialog = function(arParams)
{
	...
	if (!!BX.FileUploadAgent) {
		...
		BX.debug('/thurly/components/thurly/main.file.input/templates/drag_n_drop/script.js: BX.FileUploadAgent is not defined.' +
			' You need to load /thurly/js/main/file_upload_agent.js');
	}
}
...
window.BlogBFileDialogDispatcher = function(controller)
{
	...
	BX.loadScript('/thurly/js/main/core/core_dd.js', BX.delegate(function() {
...
window.BlogBFileDialogUploader = function(arParams, agent)
{
	...
	BX.loadScript('/thurly/js/main/core/core_dd.js', BX.delegate(
		function() {
...
window.MFIDD = function(params){
	BX.loadCSS('/thurly/components/thurly/main.file.input/templates/drag_n_drop/style.css');
	if (! BX.browser.IsIE())
	{
