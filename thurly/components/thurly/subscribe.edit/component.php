...
$sLastLogin = ${COption::GetOptionString("main", "cookie_name", "THURLY_SM")."_LOGIN"};
...
$arWarning = array();
$bVarsFromForm = false;
if($_SERVER["REQUEST_METHOD"] == "POST" && !empty($_REQUEST["PostAction"]) && check_thurly_sessid())
{
	$bDoSubscribe = true;
	$bVarsFromForm = true;
...
//*************************
if($ID > 0 && (($_REQUEST["action"] == "unsubscribe") || check_thurly_sessid()))
{
