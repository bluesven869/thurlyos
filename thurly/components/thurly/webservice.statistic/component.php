...
class CStatisticWS extends IWebService
{
	...
	function GetLiveFeedData($site_id = "", $lang = "en")
	{
		...
		CComponentUtil::__IncludeLang("/thurly/components/thurly/webservice.statistic/", "/component_1.php", $lang);
		...
		$arResult = array(
			...
			"URL" => htmlspecialchars($protocol."://".$server_name."/thurly/admin/stat_list.php?lang=".$lang)
		);
	...
	function GetWebServiceDesc()
	{
		...
		$wsdesc->wsname = "thurly.webservice.statistic";
...
$arParams["WEBSERVICE_NAME"] = "thurly.webservice.statistic";
