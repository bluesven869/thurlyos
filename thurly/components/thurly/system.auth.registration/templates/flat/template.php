...
$APPLICATION->SetAdditionalCSS("/thurly/css/main/system.auth/flat/style.css");
?>
...
<?if ($arResult["USE_CAPTCHA"] == "Y"):?>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-captcha"><img src="/thurly/tools/captcha.php?captcha_sid=<?=$arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" /></div>
			<div class="bx-authform-input-container">
...
<?endif?>
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<?$APPLICATION->IncludeComponent("thurly:main.userconsent.request", "",
					array(
