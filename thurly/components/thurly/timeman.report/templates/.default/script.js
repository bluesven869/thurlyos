...
JCTimeManReport.prototype.loadAbsence = function()
{
	...
	var url =  '/thurly/components/thurly/intranet.absence.calendar/ajax.php?MODE=GET&TS_START=' + parseInt(TS_START.valueOf()/1000) + '&TS_FINISH=' + (parseInt(TS_FINISH.valueOf()/1000)-1) + '&SHORT_EVENTS=N&USERS_ALL=N&current_data_id=1111&site_id=' + this.SETTINGS.SITE_ID + '&sessid=' + BX.thurly_sessid() + '&rnd=' + Math.random();
