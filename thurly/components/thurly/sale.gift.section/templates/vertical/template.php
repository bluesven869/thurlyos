...
if (!empty($arResult['ITEMS']))
{
	...
	<div class="bx_item_list_you_looked_vertical col1 <? echo $templateData['TEMPLATE_CLASS']; ?>">
	<? if(empty($arParams['HIDE_BLOCK_TITLE']) || $arParams['HIDE_BLOCK_TITLE'] !== 'Y'){ ?><div class="bx_item_list_title"><? echo ($arParams['BLOCK_TITLE']? htmlspecialcharsbx($arParams['BLOCK_TITLE']) : GetMessage('SGS_TPL_BLOCK_TITLE_DEFAULT')) ?></div><? } ?>
		...
		<div class="bx_catalog_item_controls"><?
			if ($arItem['CAN_BUY'])
			{
				...
				<div class="bx_catalog_item_controls_blocktwo">
					<a class="bx_medium bx_bt_button" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" rel="nofollow">
	...
	?>
		<script type="text/javascript">
			var <? echo $strObName; ?> =
			new JCSaleGiftSection(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
		</script><?
	}
	else // Wth Sku
	{
	?>
		<div class="bx_catalog_item_controls no_touch">
			...
			?>
			<div class="bx_catalog_item_controls_blocktwo">
				<a class="bx_bt_button bx_medium" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><?
					echo('' != $arParams['MESS_BTN_DETAIL'] ? $arParams['MESS_BTN_DETAIL'] : GetMessage('CVP_TPL_MESS_BTN_DETAIL'));
					?></a>
			</div>
			<div style="clear: both;"></div>
