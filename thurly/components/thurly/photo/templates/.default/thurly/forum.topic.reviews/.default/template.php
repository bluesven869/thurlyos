	...
	?><table cellspacing="0" border="0" class="reviews-post-table <?=($iCount == 1 ? "reviews-post-first " : "")?><?
		...
		if ($arParams["SHOW_AVATAR"] != "N")
		{
			...
			<div class="review-avatar"><?
				...
				else: ?><img src="/thurly/components/thurly/forum.topic.reviews/templates/.default/images/noavatar.gif" border="0" /><? endif;
			?></div>
		<?
		}
		?>
		...
		if ($arParams["SHOW_RATING"] == "Y")
		{
			...
			<div class="review-rating rating_vote_graphic">
				...
				$APPLICATION->IncludeComponent( "thurly:rating.vote", $arParams["RATING_TYPE"], $arRatingParams, $component, array("HIDE_ICONS" => "Y"));
				?>
			</div>
		<?
		}
