...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'USE_CHART' => true,
		'STEXPORT_PARAMS' => array('serviceUrl' => '/thurly/components/thurly/tasks.report.view/stexport.ajax.php')
	),
	false
);

$entity = Thurly\Main\Entity\Base::getInstance('Thurly\Tasks\TaskTable');
