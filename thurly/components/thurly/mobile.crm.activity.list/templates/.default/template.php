...
$searchTitle = !$isFiltered
	? GetMessage('M_CRM_ACTIVITY_LIST_FILTER_NONE')
	: ($arResult['GRID_FILTER_NAME'] !== '' ? $arResult['GRID_FILTER_NAME'] : GetMessage('M_CRM_ACTIVITY_LIST_FILTER_CUSTOM'));
	...
	BX.ready(
		function()
		{
			...
			?>filterPresets.push(
				{
					id: 'clear_filter',
					name: '<?=GetMessageJS('M_CRM_ACTIVITY_LIST_FILTER_NONE')?>',
					fields: {}
				});
			BX.CrmActivityListView.messages =
			{
				notFiltered: '<?=GetMessageJS('M_CRM_ACTIVITY_LIST_FILTER_NONE')?>',
