...
if(!empty($arResult["users"]))
{
	foreach($arResult["users"] as $id => $item)
	{
		...
		<table width="100%">
			<tr>
				<td valign="top"><div class="bx-m-user-image-big"><img src="<?=($item["PERSONAL_PHOTO_B"]? $item["PERSONAL_PHOTO_B"]["src"]: "/thurly/images/intranet/employees/nopic_user_50_noborder.gif")?>"/></div></td>
