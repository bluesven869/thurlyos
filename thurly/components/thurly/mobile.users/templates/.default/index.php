...
if(!empty($arResult["users"]))
{
	...
	foreach($arResult["users"] as $id => $item)
	{
		...
		?>
			...
			<table width="100%">
				<tr>
					<td><a href="<?=$item["URL"]?>"><div class="bx-m-user-image"><img src="<?=($item["PERSONAL_PHOTO"]? $item["PERSONAL_PHOTO_S"]["src"]: "/thurly/images/intranet/employees/nopic_user_50_noborder.gif")?>"/></div></a></td>
