...
class CCheckAuthWS extends IWebService
{
	...
	function GetWebServiceDesc()
	{
		...
		$wsdesc->wsname = "thurly.webservice.checkauth";
	...
	{
		global $APPLICATION;
		$client = new CSOAPClient( "thurly.soap", $APPLICATION->GetCurPage() );
...
$arParams["WEBSERVICE_NAME"] = "thurly.webservice.checkauth";
