...
CThurlyComponent::includeComponentClass($componentName);
...
if ($eshop = \Thurly\Main\ModuleManager::isModuleInstalled('thurly.eshop'))
{
...
$dir = $_SERVER["DOCUMENT_ROOT"]."/thurly/css/main/themes/";
if (is_dir($dir))
{
...
if (!isset($arCurrentValues['SHOW_DISCOUNT_PERCENT']) || $arCurrentValues['SHOW_DISCOUNT_PERCENT'] === 'Y')
{
	$arTemplateParameters['DISCOUNT_PERCENT_POSITION'] = array(
		...
		'TYPE' => 'CUSTOM',
		'JS_FILE' => CThurlyBasketComponent::getSettingsScript($componentPath, 'position'),
...
$arTemplateParameters['PRODUCT_BLOCKS_ORDER'] = array(
	...
	'TYPE' => 'CUSTOM',
	'JS_FILE' => CThurlyBasketComponent::getSettingsScript($componentPath, 'dragdrop_order'),
...
if (\Thurly\Main\Loader::includeModule('catalog'))
{
	...
	$iterator = \Thurly\Catalog\CatalogIblockTable::getList(array(
