...
if($entityTypeID === CCrmOwnerType::Lead)
{
	...
	if($entity)
	{
		$arResult['ENTITY_IMAGE_URL'] = SITE_DIR.'thurly/templates/mobile_app/images/crm/no_lead_big.png?ver=1';
...
elseif($entityTypeID === CCrmOwnerType::Contact)
{
	...
	if($entity)
	{
		...
		{
			$arResult['ENTITY_IMAGE_URL'] = SITE_DIR.'thurly/templates/mobile_app/images/crm/no_contact_big.png?ver=1';
		}
...
elseif($entityTypeID === CCrmOwnerType::Company)
{
	...
	if($entity)
	{
		...
		{
			$arResult['ENTITY_IMAGE_URL'] = SITE_DIR.'thurly/templates/mobile_app/images/crm/no_company_big.png?ver=1';
		}
