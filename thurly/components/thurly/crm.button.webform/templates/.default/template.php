...
?>
<div class="bx-crm-widget-form-config-wrapper">
		...
		<div class="bx-crm-widget-form-config-sidebar-inner">
			<div class="bx-crm-widget-form-config-sidebar-header">
				...
				<span class="bx-crm-widget-form-config-sidebar-close">
					<span class="bx-crm-widget-form-config-sidebar-close-item" onclick="BX.SiteButton.removeClass(document.getElementById('bx24_form_container_<?=htmlspecialcharsbx($arResult['FORM_ID'])?>'), 'open-sidebar'); BX.SiteButton.onWidgetClose();"></span>
				</span>
			</div>
			...
			<div class="bx-crm-widget-form-config-sidebar-chat-container">
				...
				<div class="bx-crm-widget-form-config-sidebar-logo">
					<a target="_blank" href="<?=htmlspecialcharsbx($arResult['REF_LINK'])?>">
						...
						<span class="bx-crm-widget-form-config-sidebar-logo-bx"><?=Loc::getMessage('CRM_BUTTON_WEBFORM_WIDGET_LOGO_THURLY')?></span>
						<span class="bx-crm-widget-form-config-sidebar-logo-24">Group</span>
