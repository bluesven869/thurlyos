...
<div class="blog-post-preview">
	<table class="blog-post-preview-info">
		<tr>
			<td>
				<div class="blog-post-preview-header-icon">
					<img src="<?=(isset($arResult["arUser"]["PERSONAL_PHOTO_resized"]["src"]) && strlen($arResult["arUser"]["PERSONAL_PHOTO_resized"]["src"]) > 0 ? $arResult["arUser"]["PERSONAL_PHOTO_resized"]["src"] : "/thurly/images/1.gif")?>" width="<?=$arParams["AVATAR_SIZE"]?>" height="<?=$arParams["AVATAR_SIZE"]?>">
				</div>
			</td>
			<td>
