...
__IncludeLang($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/map.google.view/lang/'.LANGUAGE_ID.'/settings.php');
...
?>
<script type="text/javascript" src="/thurly/components/thurly/map.google.view/settings/settings_load.js"></script>
