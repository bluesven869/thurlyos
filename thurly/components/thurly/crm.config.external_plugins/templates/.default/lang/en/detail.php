<?php
$MESS['CRM_CONFIG_PLG_TITLE'] = "Handle Your Web Store's Orders in ThurlyOS";
$MESS['CRM_CONFIG_PLG_TITLE_1CTHURLY'] = '1C Thurly';
...
$MESS['CRM_CONFIG_PLG_DESC'] = "Connect your web store to ThurlyOS to have a new activity created whenever a new order appears in the CRM. Make your web store another source of sales information.";
$MESS['CRM_CONFIG_PLG_DESC2'] = "Use ThurlyOS to increase conversion rate and manage customers!";
...
$MESS['CRM_CONFIG_PLG_STEP4_2'] = "Every new order will now be registered in ThurlyOS as a new activity, the respective customer recorded as a client in the CRM.";
