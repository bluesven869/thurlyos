...
$showRecurring = \Thurly\Crm\Recurring\Manager::isAllowedExpose(\Thurly\Crm\Recurring\Manager::DEAL);
...
if($componentPage === 'list' || $componentPage === 'recur_category' || $componentPage === 'category' || $componentPage === 'kanbancategory')
{
	...
	elseif(($componentPage === 'category' || $componentPage === 'kanbancategory') && $categoryID >= 0 && $categoryID !== $currentCategoryID)
	{
...
if (!$showRecurring)
	$arResult['RESTRICTED_RECURRING'] = 'Y';
