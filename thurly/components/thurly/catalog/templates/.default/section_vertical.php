				...
				if (!empty($arRecomData) && $arParams['USE_GIFTS_SECTION'] === 'Y')
				{
					...
					if (!isset($arParams['GIFTS_SECTION_LIST_HIDE_BLOCK_TITLE']) || $arParams['GIFTS_SECTION_LIST_HIDE_BLOCK_TITLE'] !== 'Y')
					{
						...
						<div class="catalog-block-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">
							<?=($arParams['GIFTS_SECTION_LIST_BLOCK_TITLE'] ?: \Thurly\Main\Localization\Loc::getMessage('CT_GIFTS_SECTION_LIST_BLOCK_TITLE_DEFAULT'))?>
						</div>
						<?
					}

					CThurlyComponent::includeComponentClass('thurly:sale.products.gift.section');
					$APPLICATION->IncludeComponent(
						...
						array(
							...
							'PRODUCT_ROW_VARIANTS' => \Thurly\Main\Web\Json::encode(
