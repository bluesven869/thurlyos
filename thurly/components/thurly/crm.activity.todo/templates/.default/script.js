if (typeof(BX.CrmActivityTodo) === 'undefined')
{
	BX.CrmActivityTodo = function(settings)
	{
		...
		this._ajaxPath = settings.ajax_path || '/thurly/components/thurly/crm.activity.todo/ajax.php';
		this._ajaxPlannerPath = settings.ajax_planner_path || '/thurly/components/thurly/crm.activity.planner/ajax.php?site_id=' + BX.message('SITE_ID');
