...
class PresetEditComponent extends \CThurlyComponent
{
	...
	protected function prepareListHeaders()
	{
		$this->listHeaders = array(
			...
			array('id' => 'IN_SHORT_LIST', 'name' => GetMessage('CRM_PRESET_FIELD_IN_SHORT_LIST'), 'sort' => 'IN_SHORT_LIST', 'default' => true, 'editable' => array('items' => array('Y' => GetMessage('MAIN_YES'), 'N' => GetMessage('MAIN_NO'))), 'type' => 'list'),
		);
