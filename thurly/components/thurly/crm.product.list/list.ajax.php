...
if(!function_exists('__CrmProductListEndResonse'))
{
	function __CrmProductListEndResonse($result)
	{
...
{
	__CrmProductListEndResonse(null);
}
...
$measureInfos = \Thurly\Crm\Measure::getProductMeasures($arProductId);
...
if ($bResultWithValue)
{
	...
	__CrmProductListEndResonse($arResponse);
}
else
{
	__CrmProductListEndResonse($arData);
}
?>
