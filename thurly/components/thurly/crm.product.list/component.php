	...
	else if ($arElement['TYPE'] === 'P')
	{
		...
		$arElement['PATH_TO_PRODUCT_DELETE'] =
			CHTTP::urlAddParams(
				...
				array('action_'.$arResult['GRID_ID'] => 'delete', 'ID' => $arElement['TYPE'].$arElement['ID'], 'sessid' => thurly_sessid())
			);
...
$productMeasureInfos = \Thurly\Crm\Measure::getProductMeasures($arProductId);
