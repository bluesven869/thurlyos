...
class ProductSearchComponent extends \CThurlyComponent
{
	...
	public function onPrepareComponentParams($params)
	{
		...
		$this->simpleSearch = (string)\Thurly\Main\Config\Option::get('catalog', 'product_form_simple_search') == 'Y';
	...
	{
		return \Thurly\Main\Application::getInstance()->getContext()->getRequest()->isAdminSection();
	}
	...
	protected function getIblockList()
	{
		if ($this->iblockList === null)
		{
			...
			$showOffersIBlock = \Thurly\Main\Config\Option::get('catalog', 'product_form_show_offers_iblock');
			...
			if (!empty($ids))
			{
				...
				{
					$siteTable = new \Thurly\Iblock\IblockSiteTable();
