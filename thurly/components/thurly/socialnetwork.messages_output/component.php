...
else
{
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST" && (strlen($_POST["do_delete"]) > 0) && check_thurly_sessid())
	{
		$errorMessage = "";
	...
	while ($arMessages = $dbMessages->GetNext())
	{
		...
		$arImage = CSocNetTools::InitImage($arMessages["TO_USER_PERSONAL_PHOTO"], 150, "/thurly/images/socialnetwork/nopic_user_150.gif", 150, $pu, $canViewProfile);
