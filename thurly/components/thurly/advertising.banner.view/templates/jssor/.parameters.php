...
if ($arCurrentValues['EXTENDED_MODE'] == 'N')
{
	$arTemplateParameters["PARAMETERS"]["PRESET"] = Array(
		...
		"TYPE" => "PRESET",
		"IMAGES" => array(
			'1' => '/thurly/themes/.default/icons/advertising/preset1.jpg',
			'2' => '/thurly/themes/.default/icons/advertising/preset2.jpg',
			'3' => '/thurly/themes/.default/icons/advertising/preset3.jpg',
			'4' => '/thurly/themes/.default/icons/advertising/preset4.jpg'
		),
		"DEFAULT" => 1,
		"SORT" => 45
	);
