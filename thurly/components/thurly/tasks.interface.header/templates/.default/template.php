...
$showQuickForm = $arParams['SHOW_QUICK_FORM'] === "Y" && \Thurly\Tasks\Util\Restriction::canManageTask();

$APPLICATION->IncludeComponent(
	'thurly:tasks.interface.filter',
	'',
	array(
		'FILTER_ID' => $arParams[ "FILTER_ID" ],
		'GRID_ID' => $arParams[ "GRID_ID" ],
...
<?php $APPLICATION->IncludeComponent(
	'thurly:tasks.interface.toolbar',
	'',
	array(
		'USER_ID' => $arParams[ 'USER_ID' ],
		'GROUP_ID' => $arParams[ 'GROUP_ID' ],
...
{
	$APPLICATION->IncludeComponent(
		'thurly:tasks.interface.quick.form',
		'',
		array(
			'FILTER_ID' => $arParams[ "FILTER_ID" ],
			'GRID_ID' => $arParams[ "GRID_ID" ],
