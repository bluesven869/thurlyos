...
)
{
	...
	if (is_array($arParams['INPUT_VALUE']))
	{
		...
		{
			$arFile['URL'] = CHTTP::URN2URI($APPLICATION->GetCurPageParam("mfi_mode=down&fileID=".$arFile['ID']."&cid=".$arResult['CONTROL_UID']."&".thurly_sessid_get(), array("mfi_mode", "fileID", "cid")));
