...
?>
<form <?=isset($_REQUEST['AJAX'])?'style="display: none"':''?> id="intranet-ustat-tell-about-form" action="/thurly/urlrewrite.php?SEF_APPLICATION_CUR_PAGE_URL=<?=str_replace("%23", "#", urlencode($arParams["PATH_TO_POST"]))?>" method="POST">
<?=thurly_sessid_post()?>
