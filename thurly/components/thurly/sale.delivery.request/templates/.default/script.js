			...
			onsuccess: function(result)
			{
				...
				if(result)
				{
					if(result.RESULT !== 'ERROR')
					{
						...
						{
							window.location.href = BX.Sale.Delivery.Request.Component.ajaxUrl+'?action=downloadFile&fileName='+encodeURI(result.FILE_NAME)+'&filePath='+encodeURI(result.FILE_PATH)+'&sessid='+BX.thurly_sessid();
						}
