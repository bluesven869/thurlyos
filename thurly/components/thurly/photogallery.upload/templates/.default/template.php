...
$APPLICATION->AddHeadScript("/thurly/components/thurly/photogallery/templates/.default/script.js");
$APPLICATION->AddHeadScript("/thurly/components/thurly/photogallery.interface/templates/.default/script.js");
$APPLICATION->AddHeadScript("/thurly/components/thurly/search.tags.input/templates/.default/script.js");

if (!$this->__component->__parent || strpos($this->__component->__parent->__name, "photogallery") === false)
{
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/photogallery/templates/.default/style.css");
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/photogallery/templates/.default/themes/gray/style.css");
}

$APPLICATION->AddHeadString('<link href="/thurly/components/thurly/search.tags.input/templates/.default/style.css" type="text/css" rel="stylesheet" />', true);
		...
		<div class="bxiu-watermark-image">
			<div id="{$arParams["id"]}_wmark_preview_cont" class="bxiu-watermark-preview">
				<div class="bxiu-watermark-image-preview">
					<img class="bxiu-watermark-image-preview" id="watermark_img_preview{$arParams["id"]}" src="/thurly/images/1.gif"/>
				</div>
...
if($arParams["SHOW_MAGIC_QUOTES_NOTICE_ADMIN"])
	echo GetMessage("MAGIC_QUOTES_NOTICE_ADMIN", array("#URL#" => "/thurly/admin/site_checker.php"))."<br/><br/>";
