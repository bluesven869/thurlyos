...
?>
<script type="text/html" data-template="widget-saletarget-main" data-categories="<?=htmlspecialcharsbx(\Thurly\Main\Web\Json::encode($arResult['DEAL_CATEGORIES']))?>">
...
<script>
	BX.ready(function()
	{
		...
		if (userSelector)
		{
			userSelector.data = <?=\Thurly\Main\Web\Json::encode($arResult['USER_SELECTOR_DATA'])?>;
		}
	});
</script>