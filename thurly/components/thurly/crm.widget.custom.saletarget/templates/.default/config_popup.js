...
BX.Crm.Widget.Custom.SaleTarget.ConfigPopup = (function(BX)
{
	...
	ConfigPopup.prototype = {
		loadData: function(next)
		{
			...
			BX.ajax(
				{
					url: this.ajaxUrl || '/thurly/components/thurly/crm.widget.custom.saletarget/ajax.php',
					method: "POST",
					dataType: "json",
					data: {
		...
		showAccessDeniedDialog: function(response)
		{
			...
			{
				var url = this.ajaxUrl || '/thurly/components/thurly/crm.widget.custom.saletarget/ajax.php';
