...
elseif (!empty($arResult["ELEMENTS_LIST"])):
	...
	$GLOBALS['APPLICATION']->SetAdditionalCSS('/thurly/components/thurly/photogallery.detail.list/templates/.default/style.css');
	$GLOBALS['APPLICATION']->AddHeadScript('/thurly/components/thurly/photogallery.detail.list/templates/.default/script.js');
	include_once(str_replace(array("\\", "//"), "/", $_SERVER['DOCUMENT_ROOT']."/thurly/components/thurly/photogallery.detail.list/templates/.default/template.php"));
?>
