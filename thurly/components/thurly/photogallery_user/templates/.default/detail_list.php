...
********************************************************************/
	...
	{
		if (!empty($_REQUEST["SEF_APPLICATION_CUR_PAGE_URL"]) && file_exists($_SERVER['DOCUMENT_ROOT']."/urlrewrite.php") && check_thurly_sessid())
		...
		<div class="photo-filter-fields">
			<div class="photo-filter-field photo-calendar-field">
				<label for="photo_from"><?=GetMessage("P_SELECT_PHOTO_FROM_PERIOD")?></label>
					<?$APPLICATION->IncludeComponent("thurly:main.calendar", ".default",
						Array(
							"SHOW_INPUT"	=>	"Y",
