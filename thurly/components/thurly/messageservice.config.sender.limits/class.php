...
class MessageServiceConfigSenderLimitsComponent extends CThurlyComponent
{
	public function executeComponent()
	{
		...
		)
		{
			foreach ($_POST['FIELDS'] as $limit => $value)
			{
				...
				\Thurly\MessageService\Sender\Limitation::setDailyLimit($senderId, $fromId, $value['limit']);
			}
		}
		...
		$this->arResult['COLUMNS'] = array(
			...
			array(
				...
				'default' => true,
				'editable' => array(
					'TYPE' => \Thurly\Main\Grid\Editor\Types::NUMBER
				)
			),
			array(
				'id' => 'current',
		...
		$this->arResult['RETRY_TIME'] = \Thurly\MessageService\Sender\Limitation::getRetryTime();
