	...
	>
			...
			<div class="crm-webform-list-widget">
				...
				<div class="crm-webform-list-widget-content">
					<div class="crm-webform-list-widget-content-amt">
						...
						<div class="crm-webform-list-widget-content-title"><?=Loc::getMessage('OL_COMPONENT_LIST_COUNT_DIALOG')?></div>
						...
						<div class="crm-webform-list-widget-content-attempt">
							...
							<span class="crm-webform-list-widget-content-attempt-success" style="margin-left: 25px;">
								<span class="crm-webform-list-widget-content-attempt-success-element"><?=Loc::getMessage('OL_COMPONENT_LIST_COUNT_MESSAGE')?></span>
		...
		<div class="crm-webform-list-widget-container crm-webform-list-widget-right">
			...
			<div class="crm-webform-list-inner-info-container">
					...
					<div class="crm-webform-list-social-inner">
						...
						<span class="crm-webform-list-social-icon-container">
							<?foreach ($line['ACTIVE_CONNECTORS'] as $id=>$name):?>
								...
								?> href="<?=str_replace('#ID#', $line['ID'], $arResult['PATH_TO_EDIT'])?>#configure<?=$id?>" class="crm-webform-list-social-icon connector-icon connector-icon-<?=$id?> connector-icon-22" title="<?=$name?>"></<?
								if($line['CAN_EDIT_CONNECTOR']):?>a<?else:?>span<?endif;
								?>>
							<?endforeach;?>
						</span>
				...
				<div class="crm-webform-list-inner-block crm-webform-list-member-container">
					<div class="crm-webform-list-member-inner">
						<span class="crm-webform-list-member-text"><?=Loc::getMessage('OL_COMPONENT_LIST_QUEUE')?> <?=count($line['QUEUE']); ?></span>
					</div>
				</div>
				<?/*
				<div class="crm-webform-list-member-container">
					<div class="crm-webform-list-member-inner">
						<span class="crm-webform-list-member-text"><?=Loc::getMessage('OL_COMPONENT_LIST_QUEUE')?></span>
			...
			<div class="crm-webform-list-button-settings-container">
				<a href="<?=str_replace('#ID#', $line['ID'], $arResult['PATH_TO_EDIT'])?>" class="webform-small-button webform-small-button-transparent crm-webform-list-button-settings">
					<?if(empty($line["CAN_EDIT_CONNECTOR"])):?>
		...
		(new CrmWebFormList(<?=Json::encode(
			array(
				...
				'mess' => array(
					...
					'dlgBtnApply' => Loc::getMessage('OL_COMPONENT_LIST_APPLY'),
					...
					'dlgActiveCountLimitedText' => Loc::getMessage('OL_COMPONENT_LIST_POPUP_LIMITED_TEXT')
				)
			))?>
		));
	});
