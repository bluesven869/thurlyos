...
use Thurly\Crm\WebForm\Internals;
use Thurly\Crm\WebForm\Script;
use Thurly\Crm\WebForm\Form;
use Thurly\Crm\WebForm\Preset;
...
class CCrmWebFormListComponent extends \CThurlyComponent
{
	...
	public function prepareResult()
	{
		...
		if (Context::getCurrent()->getLanguage() == 'ru' && !(ModuleManager::isModuleInstalled('thurlyos') && \CThurlyOS::getPortalZone() == 'ua'))
		{
	...
	protected function getFormCountByActivity($isActive = true)
	{
		...
		$query->addSelect(new \Thurly\Main\Entity\ExpressionField('CNT', 'COUNT(1)'));
