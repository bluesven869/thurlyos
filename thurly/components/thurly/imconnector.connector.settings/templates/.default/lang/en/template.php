...
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_TITLE_LIVECHAT"] = "Website live chat box";
$MESS["IMCONNECTOR_COMPONENT_CONNECTOR_SETTINGS_DESCRIPTION_LIVECHAT"] = "<p class=\"im-connector-settings-header-description\">Install free live chat widget on your website and communicate with your clients real time from any location.</p>

    <ul class=\"im-connector-settings-header-list\">

     <li class=\"im-connector-settings-header-list-item\">works for any website, embed code provided</li>

     <li class=\"im-connector-settings-header-list-item\">easy to customize and set display conditions </li>

     <li class=\"im-connector-settings-header-list-item\">incoming messages distributed among agents according to your queue rules</li>
...
<br><br>
The \"Professional\" plan has no restriction on the number of Open Channels at all.";
