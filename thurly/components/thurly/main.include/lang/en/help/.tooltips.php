...
$MESS ['EDIT_TEMPLATE_TIP'] = "Select here the required page template (which are stored in /thurly/templates/.default/page_templates/). You can select <b><i>other</i> and specify the full path to the required template.";
