...
$toolbarButtons[] = array(
	...
	'ONCLICK' => "javascript:(new BX.CDialog({'content_url':'/thurly/components/thurly/crm.config.tax.rate.edit/box.php?FORM_ID=".strtoupper($arResult['FORM_ID'])."&TAX_ID=".$arResult['TAX_ID']."', 'width':'".$width."', 'height':'".$height."', 'resizable':".$resizable." })).Show()",
	'ICON' => 'btn-new'
);
...
if(intval($taxID) > 0)
{
	...
	$APPLICATION->IncludeComponent(
		'thurly:crm.config.tax.rate.list',
		'',
		array(
