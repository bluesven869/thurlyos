...
else
{
	...
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/main.post.form/templates/.default/style.css");
	$APPLICATION->SetAdditionalCSS("/thurly/components/thurly/socialnetwork.blog.post.edit/templates/.default/style.css");
								...
								<div class="social-group-create-options-item-column-right">
									<div class="social-group-create-options-item-column-one">
										<div class="social-group-create-link-upload<?=(in_array("GROUP_IMAGE_ID", $arResult["ErrorFields"]) ? " sonet-group-create-popup-field-upload-error" : "")?>"><?
											$APPLICATION->IncludeComponent('thurly:main.file.input', '.default', array(
