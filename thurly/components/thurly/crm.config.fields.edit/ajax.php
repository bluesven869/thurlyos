...
if(!function_exists('__CrmConfigFieldEditEndResonse'))
{
	function __CrmConfigFieldEditEndResonse($result)
	{
...
if($action === 'ADD_FIELD')
{
	...
	{
		__CrmConfigFieldEditEndResonse(array('ERROR' => implode("\n", $errorMessages)));
	}
	...
	\Thurly\Crm\UserField\UserFieldHistory::processCreation(CCrmOwnerType::ResolveIDByUFEntityID($entityID), $fieldID);
