...
if (!\Thurly\Main\Loader::includeModule("faceid") || !\Thurly\Main\Loader::includeModule("rest"))
	return;
...
class FaceId1CComponent extends CThurlyComponent
{
	/**
	 * Start Component
	 */
	public function executeComponent()
	{
		...
		{
			$this->arResult['FACE_KART_AVAILABLE'] = \Thurly\FaceId\FaceCard::isAvailableByUser($authResult['user_id']);
		}
