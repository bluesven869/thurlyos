		...
		<?if (Count($arResult["ITEMS"]) > 0):?>
			<?foreach ($arResult["ITEMS"] as $arItem):?>
				<tr class="intask-row<?=(($iCount % 2) == 0 ? " selected" : "")?>" onmouseover="this.className+=' intask-row-over';" onmouseout="this.className=this.className.replace(' intask-row-over', '');" ondblclick="window.location='<?= CUtil::addslashes($arItem["URI"]) ?>'">
					...
					<td class="intask-cell" valign="top" align="center"><a href="<?= $arItem["URI"] ?>"><img src="/thurly/components/thurly/intranet.reserve_meeting.search/templates/.default/images/element_edit.gif" width="20" height="20" border="0" alt=""></a></td>
				</tr>
				<?$iCount++;?>
			<?endforeach;?>
		<?else:?>
