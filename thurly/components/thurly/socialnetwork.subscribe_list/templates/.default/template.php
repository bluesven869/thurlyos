...
<!--
	BX.message({
		sonetSLGetPath: '<?=CUtil::JSEscape('/thurly/components/thurly/socialnetwork.subscribe_list/ajax.php')?>',
		sonetSLSessid: '<?=thurly_sessid_get()?>',
	...
	foreach ($arResult["arSocNetAllowedSubscribeEntityTypes"] as $entity_type):
		...
		)
		{
			...
			<tr>
				...
				<table width="100%">
				<tr>
					<td class="subscribe-list-header-left"><img src="/thurly/images/1.gif" width="2" height="29"></td>
					...
					?></b></td>
					<td class="subscribe-list-header-right"><img src="/thurly/images/1.gif" width="2" height="29"></td>
				</tr>
				</table>
				</td>
			</tr>
