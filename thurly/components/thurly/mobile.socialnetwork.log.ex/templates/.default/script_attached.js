...
{
	if ((node = BX(node)) && node && !node.hasAttribute("done"))
	{
		node.checked = true;
...
*/
	...
	)
	{
			...
			BX.ready(function()
			{
				if (app.enableInVersion(3))
				{
					oMSL.listPageMenuItems.push({
						...
						image: "/thurly/templates/mobile_app/images/lenta/menu/pencil.png",
						action: function()
						{
						...
						if (app.enableInVersion(3))
						{
							...
							if (BX.message('MSLMenuItemWork'))
							{
								oMSL.listPageMenuItems.push({
									...
									image: "/thurly/templates/mobile_app/images/lenta/menu/work.png",
									arrowFlag: true,
									action: function() {
										app.loadPageBlank({
							...
							oMSL.listPageMenuItems.push({
								...
								image: "/thurly/templates/mobile_app/images/lenta/menu/favorite.png",
								arrowFlag: true,
								action: function() {
									app.loadPageBlank({
							...
							oMSL.listPageMenuItems.push({
								...
								image: "/thurly/templates/mobile_app/images/lenta/menu/mine.png",
								arrowFlag: true,
								action: function() {
									app.loadPageBlank({
							...
							oMSL.listPageMenuItems.push({
								...
								image: "/thurly/templates/mobile_app/images/lenta/menu/important.png",
								arrowFlag: true,
								action: function() {
									app.loadPageBlank({
							...
							if (BX.message('MSLMenuItemBizproc'))
							{
								oMSL.listPageMenuItems.push({
									...
									image: "/thurly/templates/mobile_app/images/lenta/menu/workflow.png",
									arrowFlag: true,
									action: function() {
										app.loadPageBlank({
							...
							oMSL.listPageMenuItems.push({
								...
								image: "/thurly/templates/mobile_app/images/lenta/menu/n_refresh.png",
								arrowFlag: false,
								action: function() {
							...
							if (oMSL.bUseFollow)
							{
								oMSL.listPageMenuItems.push({
									...
									image: "/thurly/templates/mobile_app/images/lenta/menu/glasses.png",
									arrowFlag: false,
									feature: 'follow',
									action: function() {
							...
							if (oMSL.bShowExpertMode)
							{
								oMSL.listPageMenuItems.push({
									...
									image: "/thurly/templates/mobile_app/images/lenta/menu/expert.png",
									arrowFlag: false,
									feature: 'expert',
									action: function() {
										oMSL.setExpertMode({
								...
								BXMobileApp.UI.Page.SlidingPanel.show({
									...
									buttons:
									{
										addButton: {
											...
											image: "/thurly/templates/mobile_app/images/lenta/slider/addpost.png?1",
											callback: function () {
												if (app.enableInVersion(12))
												{
													app.exec('showPostForm', oMSL.showNewPostForm());
										...
										favoritesButton: {
											...
											image: "/thurly/templates/mobile_app/images/lenta/slider/favorites.png?2",
											callback: function () {
												app.loadPageBlank({
													url: (BX.message('MobileSiteDir') ? BX.message('MobileSiteDir') : '/') + "mobile/index.php?favorites=Y",
													cache: false,
		...
		{
			BX.MobileUI.addCopyableDialog(BX("lenta_wrapper_global"), "post-item-copyable", "post-item-copytext", oMSL.getCopyText);
		}
	}
	else if (bEmptyPage)
	{
		...
		BX.ready(function()
		{
			...
			if (window.platform != "android")
			{
				BX.MobileUI.addCopyableDialog(BX("lenta_wrapper"), "post-item-copyable", "post-item-copytext", oMSL.getCopyText);
				BX.MobileUI.addCopyableDialog(BX("post-comments-wrap"), "post-comment-block", "post-comment-text", oMSL.getCopyText);
			}
		});
	}
	else if (
	...
	if (!bAjaxCall)
	{
		BX.ready(function()
		{
			...
			)
			{
				...
				{
					BXMobileApp.addCustomEvent("onUpdateSocnetCounters", oMSL.onUpdateSocnetCountersHandler);
					BXMobileApp.addCustomEvent("onUpdateUserCounters", oMSL.onUpdateCounterHandler);
					BXMobileApp.addCustomEvent("onImUpdateCounter", oMSL.onImUpdateCounterHandler); // old
					BXMobileApp.addCustomEvent("onSetLFCounter", oMSL.onSetLFCounter);

					BXMobileApp.addCustomEvent("onPull-main", BX.delegate(function(data)
					{
						if (
							data.command == 'user_counter'
							&& data.params[BX.message("SITE_ID")]
							&& typeof data.params[BX.message("SITE_ID")][strCounterType] != 'undefined'
						)
						{
							BX.removeCustomEvent("onUpdateSocnetCounters", oMSL.onUpdateSocnetCountersHandler);
							BX.removeCustomEvent("onUpdateUserCounters", oMSL.onUpdateCounterHandler);
							BX.removeCustomEvent("onImUpdateCounter", oMSL.onImUpdateCounterHandler); // old

							oMSL.bCounterReceived = true;
							oMSL.changeCounter(
								parseInt(data.params[BX.message("SITE_ID")][strCounterType]),
								0,
								(data.extra && typeof data.extra.server_time_unix != 'undefined' ? data.extra.server_time_unix: 0)
							);
						}
					}, this));

					setTimeout(function() {
						if (!oMSL.bCounterReceived)
						{
							BXMobileApp.onCustomEvent('onGetLFCounter', {
								counterType: strCounterType
							}, true);
	...
	BMAjaxWrapper.Wrap({
		...
		callback: function(data)
		{
			...
			)
			{
				...
				if (bScroll)
				{
					ThurlyAnimation.animate({
						duration : 1000,
						start : { scroll : document.body.scrollTop },
						finish : { scroll : 0 },
						transition : ThurlyAnimation.makeEaseOut(ThurlyAnimation.transitions.quart),
						step : function(state)
						{
...
ThurlyMSL.prototype.registerScripts = function(path)
{
...
ThurlyMSL.prototype.loadScripts = function()
{
...
ThurlyMSL.prototype.pullDownAndRefresh = function()
{
	app.exec("pullDownLoadingStart");
	window.isPullDownLocked = true;
	__MSLRefresh(true);
...
ThurlyMSL.prototype.shareBlogPost = function(data)
{
//	alert(JSON.stringify(data));
};

ThurlyMSL.prototype.deleteBlogPost = function(data)
{
	app.confirm({
...
ThurlyMSL.prototype.getBlogPostData = function(post_id, callbackFunc)
{
...
ThurlyMSL.prototype.getCommentData = function(params, callbackFunc)
{
...
ThurlyMSL.prototype.openBlogPostPage = function(obBlogPost)
{
	if (
...
ThurlyMSL.prototype.editBlogPost = function(data)
{
	if (app.enableInVersion(12))
	{
...
ThurlyMSL.prototype.drawDetailPage = function(data)
{
	var bReopen = false;
...
ThurlyMSL.prototype.drawDetailPageText = function(data)
{
	var postScripts = '';
...
ThurlyMSL.prototype.onLogEntryPostUpdated = function(data)
{
	var postScripts = '';
...
ThurlyMSL.prototype.changeCounter = function(cnt, zeroTS, serverTime)
{
...
ThurlyMSL.prototype.editComment = function(params)
{
...
ThurlyMSL.prototype.deleteComment = function(params)
{
	...
	if (commentType == 'blog')
	{
		...
		BMAjaxWrapper.Wrap({
			'type': 'html',
			'method': 'GET',
			'url': commentVarURL + '&sessid=' + BX.thurly_sessid() + '&delete_comment_id=' + params.commentId,
			'data': '',
...
ThurlyMSL.prototype.hideComment = function(commentNode, commentType)
{
...
ThurlyMSL.prototype.createCommentInputForm = function(params)
{
	if (app.enableInVersion(10))
	{
...
ThurlyMSL.prototype.onPullComment = function(data)
{
	if (
...
ThurlyMSL.prototype.drawPullComment = function(params)
{
...
ThurlyMSL.prototype.showNewPullComment = function(params, nodeId)
{
	if(!BX(nodeId))
	{
...
ThurlyMSL.prototype.parseAndExecCode = function(text, timeout, bExec, bReturnScripts)
{
	if (
		typeof text != 'string'
		|| text.length <= 0
...
ThurlyMSL.prototype.replaceUserPath = function(text)
{
	if (
		typeof text != 'string'
		|| text.length <= 0
...
ThurlyMSL.prototype.createCommentMenu = function(commentNode, arComment, voteId)
{
...
ThurlyMSL.prototype.showCommentMenu = function(arButtons)
{
...
ThurlyMSL.prototype.showTextPanelMenu = function()
{
	var action = new BXMobileApp.UI.ActionSheet({
			buttons: [
				{
...
ThurlyMSL.prototype.InitDetail = function(params)
{
...
ThurlyMSL.prototype.showNewComment = function(params)
{
...
ThurlyMSL.prototype.showPreviewComment = function(text)
{
	if (!text)
		return false;
...
ThurlyMSL.prototype.showCommentWait = function(params)
{
...
ThurlyMSL.prototype.showCommentAlert = function(params)
{
	var commentType = (typeof (params.commentType) != 'undefined' && params.commentType == 'blog' ? 'blog' : 'log');
...
ThurlyMSL.prototype.alertPreviewComment = function(params)
{
	var commentId = (typeof (params.commentId) != 'undefined' && params.commentId ? params.commentId : 0);
	var commentType = (typeof (params.commentType) != 'undefined' && params.commentType == 'blog' ? 'blog' : 'log');
	var text = (typeof (params.text) != 'undefined' && params.text ? params.text : '');
...
ThurlyMSL.prototype.showCommentProgressBar = function(commentNode)
{
	if (
	...
	oMSL.commentProgressBarAnimation = ThurlyAnimation.animate({
		...
		transition: ThurlyAnimation.makeEaseOut(ThurlyAnimation.transitions.linear),
		step : function(state)
		{
...
ThurlyMSL.prototype.hideCommentProgressBar = function(loadingId, commentNode)
{
	if (
		typeof (commentNode) == 'undefined'
		|| !BX(commentNode)
...
ThurlyMSL.prototype.setFollow = function(params)
{
...
ThurlyMSL.prototype.setFollowDefault = function(params)
{
...
ThurlyMSL.prototype.setExpertMode = function(params)
{
	if (typeof params.value == 'undefined')
	{
		return;
...
ThurlyMSL.prototype.changeListMode = function(post_data, successCallbackFunc, failCallbackFunc)
{
	app.showPopupLoader({text:""});
...
ThurlyMSL.prototype.incrementCounters = function(logId)
{
...
ThurlyMSL.prototype.getComment = function(params)
{
	var url = '';
...
ThurlyMSL.prototype.uploadCommentFile = function(fileURI)
{
...
ThurlyMSL.prototype.sendCommentWriting = function(xmlId, text)
{
...
ThurlyMSL.prototype.endCommentWriting = function(xmlId)
{
	xmlId = (typeof (xmlId) != 'undefined' ? xmlId : '');
...
ThurlyMSL.prototype.setFocusOnComments = function(type)
{
...
ThurlyMSL.prototype.setFocusOnCommentForm = function()
{
	if (app.enableInVersion(10))
	{
...
ThurlyMSL.prototype.buildDetailPageMenu = function(data)
{
	var menuItems = [];
	...
	)
	{
		menuItems.push({
			...
			image: "/thurly/templates/mobile_app/images/lenta/menu/eye.png",
			action: function()
			{
				oMSL.setFollow({
					logId: oMSL.logId,
	...
	if (oMSL.bUseTasks)
	{
		menuItems.push({
			...
			image: "/thurly/templates/mobile_app/images/lenta/menu/n_check.png",
			action: function()
			{
				oMSL.createTask({
					entityType: 'BLOG_POST',
					entityId: parseInt(data.post_id)
				});
				return false;
			},
			arrowFlag: false
...
ThurlyMSL.prototype.showPageMenu = function(type)
{
...
ThurlyMSL.prototype.setFollowMenuItemName = function()
{
	var menuItem = false;
...
ThurlyMSL.prototype.setDefaultFollowMenuItemName = function()
{
	var menuItem = false;
...
ThurlyMSL.prototype.setExpertModeMenuItemName = function()
{
	var menuItem = false;
	for(var i = 0; i < this.listPageMenuItems.length; i++)
	{
...
ThurlyMSL.prototype.replyToComment = function(userId, userName, event)
{
...
ThurlyMSL.prototype.buildCommentRatingNode = function(arComment, anchor_id)
{
	var you_like_class = (
...
ThurlyMSL.prototype.buildCommentReplyNode = function(arComment)
{
	return BX.create('DIV', {
		props: {
...
ThurlyMSL.prototype.drawRatingFooter = function(ratingFooterText)
{
	if (BX('rating-footer'))
	{
...
ThurlyMSL.prototype.parseMentions = function(text)
{
	var parsedText = text;
...
ThurlyMSL.prototype.unParseMentions = function(text)
{
...
ThurlyMSL.prototype.expandText = function(id)
{
	var checkBlock = (
		typeof id == 'undefined'
		|| id == null
...
ThurlyMSL.prototype.showEmptyCommentsBlockWaiter = function(el, enable)
{
	enable = !!enable;
	if (!BX(el))
	{
...
ThurlyMSL.prototype.showEmptyCommentsBlockFailed = function(el, ts, bPullDown, bMoveBottom, data)
{
	if (!BX(el))
	{
		return;
...
ThurlyMSL.prototype.showMoreComments = function(params)
{
...
ThurlyMSL.prototype.afterEdit = function(postResponseData, logId) // in livefeed only
{
...
ThurlyMSL.prototype.onMPFSent = function(post_data, groupID)
{
	if (
	...
	BMAjaxWrapper.Wrap({
		type: 'json',
		method: 'POST',
		url: (typeof post_data.ajaxUrl != 'undefined' ? post_data.ajaxUrl : oMSL.curUrl),
		data: post_data.data,
		processData : true,
		callback: function(post_response_data)
		{
...
ThurlyMSL.prototype.onLogEntryFavorites = function(log_id, page_id)
{
	var favoritesBlock = BX('log_entry_favorites_' + log_id);
...
ThurlyMSL.prototype.onLogEntryCommentAdd = function(log_id, iValue) // for the feed
{
	var val, old_value;
...
ThurlyMSL.prototype.onLogEntryCommentView = function(logId, contentId) // for the feed
{

};

ThurlyMSL.prototype.onLogEntryRatingLike = function(params)
{
...
ThurlyMSL.prototype.recalcRatingFooter = function(params)
{
	...
	if (params.voteAction == 'plus')
	{
		...
		else
		{
			...
			else if (params.obYouAndOthersNode.style.display != 'block')
			{
...
ThurlyMSL.prototype.showRatingFooterNode = function(code, obNodeSet)
{
...
ThurlyMSL.prototype.getUsersTitleByCount = function(val)
{
	return (
		val % 10 == 1
...
ThurlyMSL.prototype.onLogCommentRatingLike = function(params)
{
	var rating_id = params.ratingId;
...
ThurlyMSL.prototype.checkVisibility = function(image)
{
	var img = image.node;
...
ThurlyMSL.prototype.checkImageOffset = function(img)
{
...
ThurlyMSL.prototype.isPostFull = function()
{
	var checkBlock = (
...
ThurlyMSL.prototype.isImageFromPost = function(image)
{
...
ThurlyMSL.prototype.isUserCurrent = function(userId)
{
	return (userId == BX.message('USER_ID'));
};

ThurlyMSL.prototype.checkNodesHeight = function()
{
...
ThurlyMSL.prototype.initScroll = function(enable, process_waiter)
{
	enable = !!enable;
...
ThurlyMSL.prototype.onScrollDetail = function()
{
	oMSL.iLastActivityDate = Math.round(new Date().getTime() / 1000);
};

ThurlyMSL.prototype.getComments = function(params)
{
	var ts = params.ts;
						...
						BMAjaxWrapper.Wrap({
							...
							callback: function(get_form_data) // ts?
							{
								...
								if (get_form_data.length > 0)
								{
									...
									formWrap.innerHTML = get_form_data;
								}
								else
								{
...
ThurlyMSL.prototype.formatTaskDescription = function(taskDescription, livefeedUrl, entityType)
{
	...
	{
		result += '<br><br>' + BX.message('MSLCreateTaskEntityLink').replace('#ENTITY#', '[URL=' + livefeedUrl + ']' + BX.message('MSLCreateTaskEntityLink' + entityType) + '[/URL]');
	}

	return result;
};

ThurlyMSL.prototype.createTask = function(params)
{
	app.showPopupLoader();
	...
	BX.ajax({
		...
		onsuccess: BX.proxy(function(data)
		{
			...
			{
				var taskDescription = oMSL.formatTaskDescription(data.DESCRIPTION, data.LIVEFEED_URL, params.entityType);
				var taskData = {
					TITLE: data.TITLE,
...
ThurlyMSL.prototype.createTaskSetContentSuccess = function(taskId)
{
	app.confirm({
...
ThurlyMSL.prototype.createTaskSetContentFailure = function(errors)
{
	app.alert({
...
ThurlyMSL.prototype.setPostFormParams = function(params)
{
...
ThurlyMSL.prototype.setPostFormExtraData = function(params)
{
	if (typeof params == 'object')
	{
		for (var key in params)
...
ThurlyMSL.prototype.setPostFormExtraDataArray = function(oExtraData)
{
	var ob = null;
...
ThurlyMSL.prototype.getPostFormExtraData = function()
{
	return oMSL.newPostFormExtraData;
};

ThurlyMSL.prototype.showNewPostForm = function(params)
{
	var entityType = (
...
ThurlyMSL.prototype.findDestinationCallBack = function(element, index, array)
{
	return (element.id == this.value);
};

ThurlyMSL.prototype.addPostFormDestination = function(selectedDestinations, params)
{
	if (
		typeof params == 'undefined'
...
ThurlyMSL.prototype.getPostFormAttachButton = function()
{
...
ThurlyMSL.prototype.getPostFormMentionButton = function()
{
	return {
		dataSource: {
...
ThurlyMSL.prototype.getPostFormAttachFileSettings = function()
{
	return {
		resize: [
			40,
...
ThurlyMSL.prototype.getPostFormRecipientsDataSource = function()
{
	return {
		return_full_mode: "YES",
...
ThurlyMSL.prototype.buildPostFormFiles = function(postData, attachedFiles, params)
{
...
ThurlyMSL.prototype.buildPostFormDestinations = function(postData, selectedRecipients, hiddenRecipients, params)
{
	var prefix = null;
	var id = null;
	var name = null;
...
ThurlyMSL.prototype.buildSelectedDestinations = function(postData, selectedDestinations)
{
	if (
...
ThurlyMSL.prototype.buildPostFormRequestStub = function(params)
{
	var oRequest = null;
...
ThurlyMSL.prototype.showPostError = function(params)
{
...
ThurlyMSL.prototype.clearPostFormDestination = function(selectedDestinations, groupID)
{
	if (
...
ThurlyMSL.prototype.processAjaxBlock = function(block, params)
{
	if (
		!params
		|| typeof params.type == 'undefined'
...
ThurlyMSL.prototype.showNotifier = function(cnt)
{
	cnt = parseInt(cnt);
	cnt_cent = cnt % 100;
...
ThurlyMSL.prototype.hideNotifier = function()
{
...
ThurlyMSL.prototype.showRefreshNeededNotifier = function()
{
	BX.removeClass(BX("lenta_notifier"), "lenta-notifier-shown");
...
ThurlyMSL.prototype.hideRefreshNeededNotifier = function()
{
	var refreshNeededBlock = BX("lenta_notifier_2");
	if (refreshNeededBlock)
	{
...
ThurlyMSL.prototype.onUpdateSocnetCountersHandler = function(params)
{
	oMSL.bCounterReceived = true;
	oMSL.changeCounter(parseInt(params[strCounterType]));
};

ThurlyMSL.prototype.onUpdateCounterHandler = function(params)
{
...
ThurlyMSL.prototype.onImUpdateCounterHandler = function(params)
{
	oMSL.bCounterReceived = true;
...
ThurlyMSL.prototype.onSetLFCounter = function(ob)
{
	if (
		typeof ob.value != 'undefined'
		&& parseInt(ob.value) >= 0
	)
	{
		oMSL.bCounterReceived = true;
		oMSL.changeCounter(
			parseInt(ob.value),
			(typeof ob.zeroCounterTs != 'undefined' ? parseInt(ob.zeroCounterTs) : null)
		);
	}
};

ThurlyMSL.prototype.registerBlocksToCheck = function()
{
	var rootNode = null;
...
ThurlyMSL.prototype.onMobilePlayerError = function(player, src)
{
...
ThurlyMSL.prototype.getCopyText = function(block)
{
	...
	return decodeHtml(BX.util.strip_tags(block.innerHTML.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, '').replace(/<br\s*[\/]?>/gi, "~~~---~~~").replace(/~~~---~~~/g, "\n")));
};
