...
require_once($_SERVER["DOCUMENT_ROOT"]."/thurly/components/thurly/mobile.socialnetwork.log.ex/include.php");
...
{
	$arParams["PATH_TO_SMILE"] = "/thurly/images/socialnetwork/smile/";
}
...
$arParams["SET_LOG_COUNTER"] = (
	...
	&& (
		(
			!$arResult["AJAX_CALL"] 
			&& \Thurly\Main\Page\Frame::isAjaxRequest()
		)
		|| $arResult["RELOAD"]
	)
		? "Y" 
...
$arResult["extranetSiteId"] = (
	\Thurly\Main\ModuleManager::isModuleInstalled('extranet')
		? \Thurly\Main\Config\Option::get('extranet', 'extranet_site', false)
		: false
);
