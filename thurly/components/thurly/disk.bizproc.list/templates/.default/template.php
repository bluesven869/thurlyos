...
<div class='wd-help-list selected'>
	<?=str_replace("#HREF#",'"'.$APPLICATION->getCurPageParam("action=createDefault&".thurly_sessid_get(), array("action", "sessid")).'"',Loc::getMessage("WD_EMPTY"))?>
</div>
<? else:
...
if($arResult['CREATE_NEW_TEMPLATES']):?>
	<br />
	<?=str_replace("#HREF#",'"'.$APPLICATION->getCurPageParam("action=createDefault&".thurly_sessid_get(), array("action", "sessid")).'"',Loc::getMessage("WD_EMPTY_NEW"))?>
<? endif;
