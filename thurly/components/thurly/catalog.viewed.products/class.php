 ...
 */
class CCatalogViewedProductsComponent extends CThurlyComponent
{
	 ...
	 * @throws void|Thurly\Main\SystemException
	 */
	...
	protected function getItems()
	{
		...
		foreach (array_keys($this->arParams['SHOW_PRODUCTS']) as $iblock)
		{
			...
			while ($element = $elementIterator->GetNext())
			{
				...
				$ipropValues = new \Thurly\Iblock\InheritedProperty\ElementValues($element["IBLOCK_ID"], $element["ID"]);
