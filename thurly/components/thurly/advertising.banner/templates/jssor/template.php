...
<?
	$this->addExternalCss("/thurly/themes/.default/banner.css");
	$this->addExternalJS("/thurly/components/thurly/advertising.banner/templates/jssor/jssor.slider.min.js");
...
<style>
	...
	.jssorb21 div, .jssorb21 div:hover, .jssorb21 .av {
		...
		color: white;
		font-size: 12px;
		background: url(/thurly/components/thurly/advertising.banner/templates/jssor/images/b21.png) no-repeat;
		overflow: hidden;
		cursor: pointer;
	}
	...
	.jssora21l, .jssora21r {
		...
		height: 55px;
		cursor: pointer;
		background: url(/thurly/components/thurly/advertising.banner/templates/jssor/images/a21.png) center no-repeat;
		overflow: hidden;
	}
...
<div id="slider_container_<?=$arResult['ID']?>" style="position: relative; margin: 0 auto;
	...
	<div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
		...
		<div style="display: block;
            position: absolute; top: 0px; left: 0px;width: 100%;height:100%;
            background: url(/thurly/components/thurly/advertising.banner/templates/jssor/images/loading.gif) no-repeat center center;">
		</div>
	</div>
