...
<?
	global $APPLICATION;
	$this->addExternalCss("/thurly/components/thurly/advertising.banner/templates/nivo/nivo-slider.css");
	$this->addExternalCss("/thurly/components/thurly/advertising.banner/templates/nivo/themes/default/default.css");
	$this->addExternalCss("/thurly/themes/.default/banner.css");
	if ($arParams['JQUERY'] == 'Y' || isset($arParams['PREVIEW']))
		CJSCore::Init(array("jquery2"));
	$this->addExternalJs("/thurly/components/thurly/advertising.banner/templates/nivo/jquery.nivo.slider.pack.js");
