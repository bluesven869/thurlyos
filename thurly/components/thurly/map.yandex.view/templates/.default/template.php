...
?>
<img src="/thurly/components/thurly/map.yandex.view/templates/.default/images/screenshot.png" border="0" />
<?
else:
...
<?
	$APPLICATION->IncludeComponent('thurly:map.yandex.system', '.default', $arTransParams, false, array('HIDE_ICONS' => 'Y'));
?>
	</div>
</div>
<?
