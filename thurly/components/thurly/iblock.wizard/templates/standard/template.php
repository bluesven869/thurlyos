...
<tr>
	<th background="<?=$templateFolder?>/images/top_fill.gif" style="border:none;background-repeat: repeat-x" align=center valign=middle width=60><img src="<?=$templateFolder?>/images/icon.gif"><br><img src="/thurly/images/1.gif" height=1 width=60></th>
...
?>
<tr>
	<td style="border-left:none;border-bottom:none;border-right:none"><img src="/thurly/images/1.gif" height=40 width=4></td>
...
<tr>
	<td style="border:none"><img src="/thurly/images/1.gif" width=1 height=1></td>
