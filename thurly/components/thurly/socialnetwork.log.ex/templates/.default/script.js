...
window.__socOnUCFormSubmit =  function(obj, post_data) {
	...
	post_data["sessid"] = BX.thurly_sessid();
...
ThurlyLF.prototype.initOnce = function(params)
{
...
ThurlyLF.prototype.init = function(params)
{
...
ThurlyLF.prototype.initScroll = function()
{
...
ThurlyLF.prototype.onFeedScroll = function()
{
	// Live Feed Paging
...
ThurlyLF.prototype.onFeedKeyDown = function(e)
{
	if (e == null)
	{
		e = window.event;
...
ThurlyLF.prototype.onFeedKeyUp = function(e)
{
	if (e == null)
	{
		e = window.event;
...
ThurlyLF.prototype.getNextPage = function()
{
...
ThurlyLF.prototype.refresh = function(params, filterPromise)
{
	if (this.bLoadStarted)
	{
		return;
...
ThurlyLF.prototype.showRefreshFade = function()
{
...
ThurlyLF.prototype.hideRefreshFade = function()
{
...
ThurlyLF.prototype._onAnimationEnd = function(event)
{
	if (
...
ThurlyLF.prototype.recalcMoreButton = function()
{
	var
		i = null,
		arPos = null;
...
ThurlyLF.prototype.showRefreshError = function()
{
	this.bLockCounterAnimate = false;
...
ThurlyLF.prototype.LazyLoadCheckVisibility = function(image) // to check if expanded or not
{
	var img = image.node;
...
ThurlyLF.prototype.processAjaxBlock = function(block, nodeId, insertHidden)
{
	if (!block)
	{
		return;
...
ThurlyLF.prototype.clearContainerExternal = function(mode)
{
	var
		counterNode = null,
		counterNodeWaiter = null,
...
ThurlyLF.prototype.clearContainerExternalNew = function()
{
	this.logAjaxMode = 'new';
};

ThurlyLF.prototype.clearContainerExternalMore = function()
{
	this.logAjaxMode = 'more';
};

ThurlyLF.prototype.createTask = function(params)
{
	this.createTaskPopup = new BX.PopupWindow("BXCTP", null, {
		...
		events: {
			onAfterPopupShow: BX.proxy(function()
			{
				...
				BX.ajax({
					url: '/thurly/components/thurly/socialnetwork.log.ex/ajax.php',
					method: 'POST',
					dataType: 'json',
					data: {
						sessid : BX.thurly_sessid(),
...
ThurlyLF.prototype.createTaskSetContentSuccess = function(taskId)
{
	oLF.createTaskSetContent(BX.create('DIV', {
		children: [
			BX.create('DIV', {
		...
		new BX.PopupWindowButton({
			...
			events : {
				click : BX.proxy(function() {
					...
					if (
						typeof BX.ThurlyOS != 'undefined'
						&& typeof BX.ThurlyOS.PageSlider != 'undefined'
					)
					{
						BX.ThurlyOS.PageSlider.open(taskLink);
					}
					else
					{
...
ThurlyLF.prototype.createTaskSetContentFailure = function(errors)
{
	oLF.createTaskSetContent(BX.create('DIV', {
		children: [
			BX.create('DIV', {
...
ThurlyLF.prototype.createTaskSetContent = function(contentNode)
{
	if (BX('BXCTP_content'))
	{
...
ThurlyLF.prototype.formatTaskDescription = function(taskDescription, livefeedUrl, entityType)
{
...
ThurlyLF.prototype.registerViewAreaList = function()
{
	var
...
ThurlyLF.prototype.clickTag = function(tagValue)
{
	var result = false;
