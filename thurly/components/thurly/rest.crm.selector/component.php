 ...
 * @deprecated
 *
 * use thurly:crm.entity.selector.ajax
 */
	...
	while($arRes = $obRes->Fetch())
	{
		...
		$arResult['ELEMENT'][] = array(
			...
			'url' => \CComponentEngine::MakePathFromTemplate(
				\Thurly\Main\Config\Option::get('crm', 'path_to_lead_show'),
				array(
					'lead_id' => $arRes['ID']
				)
			),
...
if(in_array('contact', $arParams['ENTITY_TYPE']))
{
	...
	while($arRes = $obRes->Fetch())
	{
		...
		$arResult['ELEMENT'][] = array(
			...
			'id' => $arRes['SID'],
			'url' => \CComponentEngine::MakePathFromTemplate(
				\Thurly\Main\Config\Option::get('crm', 'path_to_contact_show'),
...
if(in_array('company', $arParams['ENTITY_TYPE']))
{
	...
	while($arRes = $obRes->Fetch())
	{
		...
		$arResult['ELEMENT'][] = array(
			...
			'id' => $arRes['SID'],
			'url' => \CComponentEngine::MakePathFromTemplate(
				\Thurly\Main\Config\Option::get('crm', 'path_to_company_show'),
				array(
					'company_id' => $arRes['ID']
				)
			),
...
if(in_array('deal', $arParams['ENTITY_TYPE']))
{
	...
	while($arRes = $obRes->Fetch())
	{
		...
		$arResult['ELEMENT'][] = array(
			...
			'id' => $arRes['SID'],
			'url' => \CComponentEngine::MakePathFromTemplate(
				\Thurly\Main\Config\Option::get('crm', 'path_to_deal_show'),
				array(
					'deal_id' => $arRes['ID']
				)
			),
...
if(in_array('quote', $arParams['ENTITY_TYPE']))
{
	...
	while($arRes = $obRes->Fetch())
	{
		...
		$arResult['ELEMENT'][] = array(
			...
			'id' => $arRes['SID'],
			'url' => \CComponentEngine::MakePathFromTemplate(
				\Thurly\Main\Config\Option::get('crm', 'path_to_quote_show'),
				array(
					'quote_id' => $arRes['ID']
				)
			),
