...
if($arResult['SHOW_ACTIVITIES']):
	$APPLICATION->IncludeComponent(
		'thurly:crm.livefeed.activity.list',
		'',
		array(
...
$APPLICATION->IncludeComponent(
	'thurly:crm.entity.birthday.nearest',
	SITE_TEMPLATE_ID === 'thurlyos' ? 'widget' : '',
...
if($arResult['ENABLE_MESSAGE_ADD']):
	$APPLICATION->IncludeComponent('thurly:crm.socialnetwork.log_event.edit',
			'',
			array(
