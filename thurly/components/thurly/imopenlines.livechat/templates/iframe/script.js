			...
			BX.adjust(this.popupMessengerBodyLiveChatForm, {children: [
				BX.create("div", { props : { className : "bx-messenger-livechat-form-wrap" }, children: [
					...
					BX.create("div", { props : { className : "bx-messenger-livechat-form-input-wrap" }, children: [
						...
						BX.create("input", { attrs: {name: showCustomPhoneInput? "": "phone", placeholder: BX.message('IMOL_LIVECHAT_FORM_INPUT_PHONE')}, props : { className : "bx-messenger-livechat-form-input bx-messenger-livechat-form-input-phone" }, events: {keydown: BX.delegate(function(){
							if (event.keyCode == 13)
							{
...
function ImExtendLinesLivechatFormSend(params)
{
	...
	BX.ajax({
		...
		dataType: 'json',
		timeout: 60,
		data: {'COMMAND': 'sendLivechatForm', 'CHAT_ID' : chatId, 'FORM' : formId, 'FIELDS' : params, 'IM_OPEN_LINES_CLIENT' : 'Y', 'IM_AJAX_CALL' : 'Y', 'sessid': BX.thurly_sessid()},
