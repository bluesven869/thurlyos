...
$storage = \Thurly\Disk\Driver::getInstance()->getStorageByUserId($arResult['VARIABLES']['user_id']);
if(!$storage)
{
	$storage = \Thurly\Disk\Driver::getInstance()->addUserStorage($arResult['VARIABLES']['user_id']);
}
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="0">
		<tr>
			<td>
				...
				<?php
				$APPLICATION->IncludeComponent(
					'thurly:disk.external.link.list',
					'',
