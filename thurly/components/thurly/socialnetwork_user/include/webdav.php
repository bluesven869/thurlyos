...
$arParams["FILES_PATH_TO_SMILE"] = "/thurly/images/forum/smile/";
	...
	if ($componentPage == "user_files" || $componentPage == "group_files")
	{
		...
		if ($ob->arParams['is_file'])
		{
			if(\Thurly\Main\Config\Option::get('disk', 'successfully_converted', false) && CModule::includeModule('disk'))
			{
				...
				/** @var \Thurly\Disk\File $diskFile */
				$diskFile = \Thurly\Disk\File::load(array('XML_ID' => $ob->arParams['element_array']['ID']), array('STORAGE'));
				if($diskFile)
				{
