...
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("page", "tasks.filter");
...
\Thurly\Main\Data\AppCacheManifest::getInstance()->addAdditionalParam("version", "v1.2");
