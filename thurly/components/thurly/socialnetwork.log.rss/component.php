...
if ($arParams["ENTITY_TYPE"] == SONET_ENTITY_GROUP)
{
	...
	$arResult["PICTURE"] = CSocNetTools::InitImage($arGroup["IMAGE_ID"], 100, "/thurly/images/socialnetwork/nopic_group_100.gif", 100, "", false);
...
else
{
	...
	if ($arUser = $rsUser->GetNext())
	{
		...
		$arResult["PICTURE"] = CSocNetTools::InitImage($arUser["PERSONAL_PHOTO"], 100, "/thurly/images/socialnetwork/nopic_user_100.gif", 100, "", false);
		$arResult["PICTURE"]["FILE"]["SRC"] = __RSSCheckServerName($arResult["PICTURE"]["FILE"]["SRC"], $arResult["SERVER_NAME"]);		
