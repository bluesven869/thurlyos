...
?>
<img src="/thurly/components/thurly/map.yandex.search/templates/.default/images/screenshot.png" border="0" />
<?
else:
?>
...
<?
	...
	$APPLICATION->IncludeComponent('thurly:map.yandex.system', '.default', $arParams, null, array('HIDE_ICONS' => 'Y'));
?>
	</div>
