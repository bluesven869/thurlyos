...
<head>
	...
	<title><?= Loc::getMessage('DISK_EXT_LINK_FOLDER_TITLE') ?></title>
	...
	<? if(!$arResult['PROTECTED_BY_PASSWORD']){ ?>
		...
		<meta content="<?= Loc::getMessage('DISK_EXT_LINK_OPEN_FOLDER_GRAPH_MADE_BY_B24') ?>" property="og:description"/>
	<? } ?>
	<?
	$APPLICATION->ShowCSS();
...
<body style="background: none;">
	<div class="bx-shared-wrap">
		...
		<div class="disk-object-container">
			...
			<div class="disk-object-info-btn-wrap">
				<div class="disk-object-info-container">
					<div class="disk-object-size-container">
						<span class="disk-object-size"><?= Loc::getMessage('DISK_EXT_LINK_FILE_SIZE') ?>:</span>
						<span class="disk-object-size-number"><?= CFile::formatSize($arResult['FOLDER']['SIZE']) ?></span>
					</div>
					<div class="disk-object-changed-container">
						<span class="disk-object-changed"><?= Loc::getMessage('DISK_EXT_LINK_FILE_UPDATE_TIME') ?>:</span>
				...
				<div class="disk-object-button-container">
					<a href="<?= $arResult['FOLDER']['DOWNLOAD_URL'] ?>" class="bx-disk-btn bx-disk-btn-big bx-disk-btn-green disk-object-download-button"><?= Loc::getMessage('DISK_EXT_LINK_FOLDER_DOWNLOAD') ?></a>
				</div>
				<? } ?>
			</div>
			...
			<?
			$APPLICATION->includeComponent('thurly:disk.interface.toolbar', '', array(
			...
			?>
				...
				$APPLICATION->IncludeComponent(
					...
					array(
						...
						'FOOTER' => array(
							array(
								'title' => \Thurly\Main\Localization\Loc::getMessage('DISK_LABEL_GRID_TOTAL'),
