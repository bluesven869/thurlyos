			...
			<table class="bx-shared-body-container">
				<tr>
					<td class="bx-shared-body-previewblock tac">
						...
						<div style="font-size: 14px;color: #535c69;"><?= $arResult['ERROR_MESSAGE']?: Loc::getMessage('DISK_EXT_LINK_DESCRIPTION') ?></div>
					</td>
				</tr>
			</table>
		</div>
		<?php if(isModuleInstalled('thurlyos') && \Thurly\Main\Loader::includeModule('intranet')) { ?>
