		...
		array(
			...
			'EXTENSION' => array(
				...
				'CONFIG' => array(
					...
					'serviceUrl' => '/thurly/components/thurly/crm.event.view/list.ajax.php?siteID='.SITE_ID.'&'.thurly_sessid_get(),
	...
	BX.ready(
		function()
		{
			...
			BX.CrmEventListManager.create("<?=CUtil::JSEscape($managerID)?>",
				{
					addItemUrl: "/thurly/components/thurly/crm.event.add/box.php",
