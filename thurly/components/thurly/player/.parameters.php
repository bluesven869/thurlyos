...
if ($arCurrentValues["USE_PLAYLIST"] == 'Y')
{
	...
	$arParams["PLAYLIST_DIALOG"] = Array(
		...
		"TYPE" => "CUSTOM",
		"JS_FILE" => "/thurly/components/thurly/player/js/prop_playlist_edit.js",
...
if ($type == 'flv')
{
	$arParams["SKIN_PATH"] = Array(
		...
		"FD_TARGET" => "D",
		"FD_UPLOAD" => false,
		"DEFAULT" => "/thurly/components/thurly/player/mediaplayer/skins",
		"REFRESH" => "Y",
		"HIDDEN" => $hidden,
	);

	if ($arCurrentValues['SKIN_PATH'] == "/thurly/components/thurly/player/videojs/skins")
		$arCurrentValues['SKIN_PATH'] = "/thurly/components/thurly/player/mediaplayer/skins";
	$arSkins = getSkinsEx($arCurrentValues['SKIN_PATH'] ? $arCurrentValues['SKIN_PATH'] : "/thurly/components/thurly/player/mediaplayer/skins");

	$arParams["SKIN"] = Array(
		"PARENT" => "APPEARANCE",
		"NAME" => GetMessage("PC_PAR_SKIN"),
		"TYPE" => "CUSTOM",
		"JS_FILE" => "/thurly/components/thurly/player/js/prop_skin_selector.js",
...
if ($type == 'videojs' || $type == 'auto')
{
	...
	$arParams["SKIN_PATH"] = Array(
		...
		"FD_TARGET" => "D",
		"FD_UPLOAD" => false,
		"DEFAULT" => "/thurly/components/thurly/player/videojs/skins",
		"REFRESH" => "Y",
		"HIDDEN" => $hidden,
	);

	if ($arCurrentValues['SKIN_PATH'] == "/thurly/components/thurly/player/mediaplayer/skins")
		$arCurrentValues['SKIN_PATH'] = "/thurly/components/thurly/player/videojs/skins";

	$arSkins = getSkinsEx($arCurrentValues['SKIN_PATH'] ? $arCurrentValues['SKIN_PATH'] : "/thurly/components/thurly/player/videojs/skins");
	...
	$arParams["SKIN"] = Array(
		...
		"JS_DATA" => CUtil::PhpToJSObject(array($arSkins, array(
			...
			array ('defaultImage' => '/thurly/components/thurly/player/images/default_skin_videojs.jpg')
		)),
		"DEFAULT" => "",
		"HIDDEN" => $hidden,
	);
