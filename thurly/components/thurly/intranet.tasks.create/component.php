...
include_once($_SERVER['DOCUMENT_ROOT']."/thurly/modules/intranet/classes/general/tasks_document.php");
include_once($_SERVER['DOCUMENT_ROOT']."/thurly/modules/intranet/classes/general/tasks.php");
