...
<?if ($arResult['AJAX_MODE'] == 'Y'):?>
	BX.loadCSS('/thurly/components/thurly/rating.vote/templates/like/popup.css');
	BX.loadCSS('/thurly/components/thurly/rating.vote/templates/like_graphic/style.css');
	BX.loadScript('/thurly/js/main/rating_like.js', function() {
<?endif;?>
