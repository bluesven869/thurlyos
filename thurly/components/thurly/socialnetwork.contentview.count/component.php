...
$arResult['AVAILABLE'] = \Thurly\Socialnetwork\Item\UserContentView::getAvailability();
...
if (!empty($arParams['CONTENT_ID']))
{
	...
	{
		$userPage = \Thurly\Main\Config\Option::get('socialnetwork', 'user_page', SITE_DIR.'company/personal/');
