...
else
{
	if(!defined("BX_SM_DEFAULT"))
	{
		...
		<script type="text/javascript" src="/thurly/components/thurly/socialnetwork.menu/script.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/socialnetwork.menu/script.js');?>"></script>
