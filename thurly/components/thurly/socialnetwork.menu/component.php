...
include_once($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/socialnetwork.menu/include.php');
...
if(!$errorMessage && $USER->IsAuthorized() && $arResult["PERMISSION"] > "R")
{
	...
	elseif($_SERVER['REQUEST_METHOD'] == 'POST' && array_key_exists("sm_action", $_REQUEST) && $_REQUEST["sm_action"] == "add" && check_thurly_sessid())
	{
...
$arThemes = array();
$sTemplateDirFull = preg_replace("'[\\\\/]+'", "/", $_SERVER['DOCUMENT_ROOT']."/thurly/components/thurly/socialnetwork.menu/templates/.default/themes/");
