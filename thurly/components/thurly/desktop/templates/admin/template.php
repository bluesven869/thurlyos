...
if(!defined("BX_GADGET_DEFAULT"))
{
	...
	if($arResult["PERMISSION"] > "R"):?>
		...
		<script type="text/javascript" src="/thurly/components/thurly/desktop/templates/admin/script_admin.js?v=<?=filemtime($_SERVER['DOCUMENT_ROOT'].'/thurly/components/thurly/desktop/templates/admin/script_admin.js');?>"></script>	
	<?endif?>
	<?
}
