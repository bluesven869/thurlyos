...
ThurlySUG.prototype.init = function(params)
{
...
ThurlySUG.prototype.sendRequest = function(params)
{
	if (
	...
	BX.ajax({
		url: '/thurly/components/thurly/socialnetwork.user_groups/ajax.php',
		method: 'POST',
		dataType: 'json',
		data: {
...
ThurlySUG.prototype.showRequestWait = function(target)
{
	BX.addClass(target, 'popup-window-button-wait');
};

ThurlySUG.prototype.closeRequestWait = function(target)
{
	BX.removeClass(target, 'popup-window-button-wait');
};

ThurlySUG.prototype.setFavorites = function(node, active)
{
	if (BX(node))
	{
...
ThurlySUG.prototype.setRequestSent = function(node, sentNode, role)
{
	if (BX(node))
	{
...
ThurlySUG.prototype.showRequestSent = function(sentNode)
{
	if (BX(sentNode))
	{
		BX.addClass(sentNode, 'sonet-groups-group-desc-container-active');
...
ThurlySUG.prototype.showError = function(errorText)
{
...
ThurlySUG.prototype.showSortMenu = function(params)
{
...
ThurlySUG.prototype.selectSortMenuItem = function(params)
{
...
ThurlySUG.prototype.setSortMenuItemText = function(params)
{
	BX(params.valueNode).innerHTML = params.text;
};

ThurlySUG.prototype.refresh = function(params, filterPromise)
{
...
ThurlySUG.prototype.showRefreshFade = function()
{
	if (
...
ThurlySUG.prototype.hideRefreshFade = function()
{
...
ThurlySUG.prototype.showRefreshError = function()
{
};
/*
ThurlySUG.prototype._onAnimationEnd = function(event)
{
	if (
...
*/
ThurlySUG.prototype.processAjaxBlock = function(block)
{
	if (!block)
	{
		return;
...
ThurlySUG.prototype.initKeyboardPageNavigation = function(navId)
{
...
ThurlySUG.prototype.processNavigation = function()
{
...
ThurlySUG.prototype.clickNavigation = function(link)
{
	this.refresh({
