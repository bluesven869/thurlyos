...
<script type="text/javascript">
	BX.ready(
		function()
		{
			...
			{
				process: "<?=Thurly\Crm\Color\PhaseColorScheme::PROCESS_COLOR?>",
				success: "<?=Thurly\Crm\Color\PhaseColorScheme::SUCCESS_COLOR?>",
				failure: "<?=Thurly\Crm\Color\PhaseColorScheme::FAILURE_COLOR?>",
				apology: "<?=Thurly\Crm\Color\PhaseColorScheme::FAILURE_COLOR?>"
			};
