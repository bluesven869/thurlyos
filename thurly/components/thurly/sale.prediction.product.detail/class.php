...
class CSalePredictionProductDetailComponent extends CThurlyComponent
{
	...
	public function executeComponent()
	{
		...
		else
		{
			...
			$manager = Thurly\Sale\Discount\Prediction\Manager::getInstance();
			$basket = \Thurly\Sale\Basket::loadItemsForFUser(\Thurly\Sale\Fuser::getId(), SITE_ID)->getOrderableItems();
