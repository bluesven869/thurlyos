...
<?
$APPLICATION->IncludeComponent("thurly:socserv.auth.form",
	"flat",
	array(
...
<?if($arResult["CAPTCHA_CODE"]):?>
		...
		<div class="bx-authform-formgroup-container dbg_captha">
			...
			<div class="bx-captcha"><img src="/thurly/tools/captcha.php?captcha_sid=<?echo $arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" /></div>
			<div class="bx-authform-input-container">
