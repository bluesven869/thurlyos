	...
	foreach ($arResult['COLUMNS_IDS'] as $columnId)
	{
		...
		switch($columnId)
		{
			...
			case CTaskColumnList::COLUMN_TIME_ESTIMATE:
				echo \Thurly\Tasks\UI::formatTimeAmount($task['TIME_ESTIMATE']);
			break;

			case CTaskColumnList::COLUMN_TIME_SPENT_IN_LOGS:
				echo \Thurly\Tasks\UI::formatTimeAmount($task['TIME_SPENT_IN_LOGS']);
			break;
			...
			case CTaskColumnList::COLUMN_UF_CRM:
				...
				$crmFieldName = \Thurly\Tasks\Integration\CRM\UserField::getMainSysUFCode();
