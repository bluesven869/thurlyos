...
?>
	<div class="photo-controls">
		<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("view_mode=view&".thurly_sessid_get(), array("view_mode", "sessid"), false)?>"<?
...
?>
	<div class="photo-controls">
		<noindex><a rel="nofollow" href="<?=$APPLICATION->GetCurPageParam("view_mode=edit&".thurly_sessid_get(), array("view_mode", "sessid"), false)?>" <?
...
function ChangeText(obj)
{
	...
	if (<?=intVal($GLOBALS["USER"]->GetId())?> > 0)
	{
		...
		CPHttpRequest.Send(TID, '/thurly/components/thurly/photogallery.detail.list/user_settings.php', {"picture_sight":obj.value, "sessid":'<?=thurly_sessid()?>'});
	}
	else
	{
