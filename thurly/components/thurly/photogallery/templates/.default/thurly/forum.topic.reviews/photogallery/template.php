...
<?/* CAPTHCA */if (strLen($arResult["CAPTCHA_CODE"]) > 0):?>
		<div class="photo-forum-capcha-cont">
			<img class="photo-forum-capcha-img" src="/thurly/tools/captcha.php?captcha_code=<?=$arResult["CAPTCHA_CODE"]?>" alt="<?=GetMessage("F_CAPTCHA_TITLE")?>"/>
