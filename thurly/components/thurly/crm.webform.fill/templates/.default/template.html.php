<?
\Thurly\Main\Page\Asset::getInstance()->addCss('/thurly/css/main/bootstrap.css');
...
<!--							</fieldset>-->
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 crm-webform-bottom-logo-container">
				<a class="crm-webform-bottom-link" href="https://www.thurlyos.ru/?c=192.168.1.138" target="_blank">
