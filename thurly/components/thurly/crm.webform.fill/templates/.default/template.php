...
$this->addExternalCss('/thurly/css/main/font-awesome.css');
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 crm-webform-bottom-logo-container">
				<a class="crm-webform-bottom-link" href="<?=$arResult['CUSTOMIZATION']['REF_LINK']?>" target="_blank">
					...
					<span class="crm-webform-bottom-logo-bx"><?=Loc::getMessage('CRM_WEBFORM_FILL_COPYRIGHT_THURLY')?></span>
					<span class="crm-webform-bottom-logo-24">Group</span>
