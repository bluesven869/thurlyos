...
<?php $APPLICATION->IncludeComponent(
	...
	array(
		...
		'EFFECTIVE_COUNTER'=>$arResult['JS_DATA']['stat']['MY_RATIO']
	),
	$component,
...
<!--			</div>-->
			...
			<a href="<?=$arParams['PATH_TO_TASK_ADD']?>" class="webform-small-button webform-small-button-blue webform-small-button-add sonet-groups-add-button">
	...
	<div class="task-report-row task-report-row-50-50">
		<div class="task-report-container">
			<div class="task-report-container-title">
				<span class="task-report-container-title-text"><?=GetMessage('TASKS_MY_EFFECTIVE')?></span>
			...
			<div class="task-report-container-help">
				<a href="<?=GetMessage('TASKS_EFFECTIVE_HELP_URL');?>">
		...
		<div class="task-report-container task-report-container-widget">
			...
			<div class="task-report-widget-row task-report-widget-50-50">
				...
				<div class="task-report-widget-container task-report-widget-container-yellow">
					...
					<div class="task-report-widget-container-content js-id-effective-violation"></div>
