...
class BizprocWorkflowStart extends \CThurlyComponent
{
	...
	public function executeComponent()
	{
		...
		if ($this->arParams["AUTO_EXECUTE_TYPE"] === null && !check_thurly_sessid())
		{
			$arError[] = array(
				"id" => "access_denied",
		...
		while ($arWorkflowTemplate = $dbWorkflowTemplate->GetNext())
		{
			...
			$this->arResult["TEMPLATES"][$arWorkflowTemplate["ID"]]["URL"] =
				htmlspecialcharsex($GLOBALS['APPLICATION']->GetCurPageParam(
					"workflow_template_id=".$arWorkflowTemplate["ID"].'&'.thurly_sessid_get(),
