...
if (CModule::IncludeModule('webservice'))
{
	...
	if (count($arParams["ORG_LIST"])<=0 || !$arParams["ORG_LIST"][0])
	{
	...
	{		
		...
		$arParams["PR_NAMESPACE"]=($arParams["PR_NAMESPACE"]=="")? "http://www.1c-thurly.ru": $arParams["PR_NAMESPACE"];
		...
		if (!$arResult["RESULT"]['ERROR'])
		{
			...
			$req->user_agent = "THURLY SOAP Client";
