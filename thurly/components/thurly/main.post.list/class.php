...
final class MainPostList extends CThurlyComponent
{
	...
	public function __construct($component = null)
	{
		...
		$this->sign = (new \Thurly\Main\Security\Sign\Signer());
	}
	...
	protected function buildComment(&$res)
	{
		...
		if (is_array($res["FILES"]))
		{
			...
			if (!empty($images))
			{
				...
				?><script>ThurlyMobile.LazyLoad.registerImages(<?=CUtil::PhpToJSObject($ids)?>, oMSL.checkVisibility);</script><?
				?></div><?
