...
{
	BX.CommentAux.init({
		currentUserSonetGroupIdList: <?=CUtil::PhpToJSObject(\Thurly\Socialnetwork\ComponentHelper::getUserSonetGroupIdList($USER->GetID(), SITE_ID))?>,
		mobile: false,
