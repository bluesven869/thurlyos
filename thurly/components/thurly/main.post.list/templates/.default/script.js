;(function(){
	...
	window.FCList.prototype = {
		url : {
			activity : '/thurly/components/thurly/main.post.list/activity.php'
		},
		destroy : function()
		{
			var ii, node;
	...
	*     "messageFields" => array(
	...
	window["fcParseTemplate"] = function(data, params, txt) {
		...
		if (!!res && !!data["messageFields"])
		{
			...
			replacement = {
				...
				"AUTHOR_AVATAR" : (!!res["AUTHOR"]["AVATAR"] ? res["AUTHOR"]["AVATAR"] : '/thurly/images/1.gif'),
	...
	window["fcPull"] = function(ENTITY_XML_ID, data) {
		BX.ajax({
			url: '/thurly/components/thurly/main.post.list/templates/.default/component_epilog.php',
			method: 'POST',
			data: {
				AJAX_POST :  "Y",
