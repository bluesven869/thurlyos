function BxInterfaceGrid(table_id)
{
	...
	this.SaveColumns = function(columns)
	{
		...
		BX.ajax.get('/thurly/components'+_this.vars.component_path+'/settings.php?GRID_ID='+_this.table_id+'&action=showcolumns&columns='+sCols+'&sessid='+_this.vars.sessid, function(){_this.Reload()});
	};
