...
{ 
	$APPLICATION->IncludeComponent("thurly:im.messenger", "", Array(), null, array("HIDE_ICONS" => "Y")); 
	return; 
}
...
$GLOBALS["APPLICATION"]->AddHeadScript("/thurly/components/thurly/socialnetwork.events_dyn/templates/.default/script_ed.js");
...
<!--
	BX.message({
		sonetDynevMsgGetPath: '<?=CUtil::JSEscape('/thurly/components/thurly/socialnetwork.events_dyn/get_message_2.php')?>',
		sonetDynevMsgSetPath: '<?=CUtil::JSEscape('/thurly/components/thurly/socialnetwork.events_dyn/set_message_2.php')?>',
		sonetDynevSessid: '<?=thurly_sessid_get()?>',
