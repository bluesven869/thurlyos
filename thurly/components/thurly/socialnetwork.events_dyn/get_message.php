...
if(CModule::IncludeModule("socialnetwork"))
{
	...
	{
		$parser = new CSocNetTextParser(LANGUAGE_ID, "/thurly/images/socialnetwork/smile/");
		...
		if (!$bFound)
		{
			...
			if ($arUserRequests = $dbUserRequests->GetNext())
			{
				...
				$arImage = CSocNetTools::InitImage($arUserRequests["FIRST_USER_PERSONAL_PHOTO"], $ImageSize, "/thurly/images/socialnetwork/nopic_user_".$ImageSize.".gif", $ImageSize, $pu, $canViewProfile);
...
//				$arData[3] = $arUserRequests["FIRST_USER_NAME"]." ".$arUserRequests["FIRST_USER_LAST_NAME"]; //3
		...
		if (!$bFound)
		{
			...
			if ($arUserRequests = $dbUserRequests->GetNext())
			{
				...
				$arImage = CSocNetTools::InitImage($arUserRequests["INITIATED_BY_USER_PHOTO"], $ImageSize, "/thurly/images/socialnetwork/nopic_user_".$ImageSize.".gif", $ImageSize, $pu, $canViewProfileU);
				...
				$arImageG = CSocNetTools::InitImage($arUserRequests["GROUP_IMAGE_ID"], $ImageSize, "/thurly/images/socialnetwork/nopic_group_".$ImageSize.".gif", $ImageSize, $pg, $canViewProfileG);
...
//				$arData[3] = $arUserRequests["INITIATED_BY_USER_NAME"]." ".$arUserRequests["INITIATED_BY_USER_LAST_NAME"]; //3
		...
		if (!$bFound)
		{
			...
			if ($arUserRequests = $dbUserRequests->GetNext())
			{
				...
				$arImage = CSocNetTools::InitImage($arUserRequests["FROM_USER_PERSONAL_PHOTO"], $ImageSize, "/thurly/images/socialnetwork/nopic_user_".$ImageSize.".gif", $ImageSize, $pu, $canViewProfile);
