...
if(CModule::IncludeModule("socialnetwork"))
{
	...
	else
	{
		...
		$parser = new CSocNetTextParser($arSite["LANGUAGE_ID"], "/thurly/images/socialnetwork/smile/");
		...
		if ($bGet)
		{
			...
			while ($arUserRequests = $dbUserRequests->GetNext())
			{
				...
				$arTmpData["IMAGE_USER"] = "/thurly/images/1.gif";
			...
			while ($arUserRequests = $dbUserRequests->GetNext())
			{
				...
				$arTmpData["IMAGE_GROUP"] = "/thurly/images/1.gif";
