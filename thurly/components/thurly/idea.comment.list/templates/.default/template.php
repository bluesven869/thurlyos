		...
		<div class="blog-comment-fields">
			...
			<div class="blog-comment-buttons">
								<?if($arResult["IDEA_MODERATOR"]):?>
									...
									<input type="checkbox" value="Y" name="BIND_OFFICIAL_ANSWER" id="BIND_THURLY_ANSWER"><label for="BIND_THURLY_ANSWER"><?=GetMessage("BPC_BIND_THURLY_ANSWER")?></label>
									<br clear="both"/>
								<?else:?>
									<input tabindex="10" value="<?=GetMessage("B_B_MS_SEND")?>" type="submit" name="post">
								<?endif;?>
		...
		if($comment["SHOW_AS_HIDDEN"] == "Y" || $comment["PUBLISH_STATUS"] == BLOG_PUBLISH_STATUS_PUBLISH || $comment["SHOW_SCREENNED"] == "Y" || $comment["ID"] == "preview")
		{
			...
			{?>
				...
				<div class="blog-comment-content-common">
					...
					{
						?>
						<span class="blog-comment-bind"><a href="<?=$comment["urlToBind"]."&".thurly_sessid_get()?>"><?=GetMessage("BPC_MES_BIND")?></a></span>
						<?
					}
