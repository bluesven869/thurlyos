...
?>
			...
			switch($key)
			{
				...
				case 'PERSONAL_PHOTO':
					if (!$arResult['USERS'][$i][$key]) $arResult['USERS'][$i][$key] = '<div class="bx-user-image-default-100"></div>';
				break;
			...
			if ($LINK_KEY == $key)
				$arResult['USERS'][$i][$key] = $GLOBALS["APPLICATION"]->IncludeComponent("thurly:main.user.link",
					'',
					array(
