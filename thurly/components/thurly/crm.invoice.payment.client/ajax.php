...
if (!check_thurly_sessid() || !($request->isPost()))
{
	die();
}
...
CThurlyComponent::includeComponentClass("thurly:crm.invoice.payment.client");

$orderPayment = new CrmInvoicePaymentClientComponent();
$orderPayment->initComponent('thurly:crm.invoice.payment.client');
