...
BX.ready(function(){
	...
	BX.Tasks.filterV2.pathToEngineScript = '<?php
		echo CUtil::GetAdditionalFileURL('/thurly/components/thurly/tasks.filter.v2/templates/constructor/engine.js');
	?>';
});
</script>
