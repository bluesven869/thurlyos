...
class PresetListComponent extends \CThurlyComponent
{
	...
	protected function parseParams()
	{
		...
		if (!\Thurly\Crm\EntityPreset::checkEntityType($this->entityTypeId))
		{
		...
		$entityTypes = \Thurly\Crm\EntityPreset::getEntityTypes();
	...
	{
		Loc::loadMessages($_SERVER['DOCUMENT_ROOT'].'/thurly/modules/crm/lib/preset.php');
