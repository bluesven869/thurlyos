...
// call API
$rawData = \Thurly\Intranet\UStat\UStat::getDepartmentGraphData(
...
{
	$sectionInvolvement = \Thurly\Intranet\UStat\UStat::getSectionInvolvement(0, $sectionField, $fromDate, $toDate, $interval);
}
...
if ($interval == 'hour' && $arParams['PERIOD'] !== 'custom_day')
{
	...
	$currentActivity = \Thurly\Intranet\UStat\UStat::getCurrentActivity(0, $sectionField);
...
if ($sectionField == 'TOTAL')
{
	$sumInvolvement = \Thurly\Intranet\UStat\UStat::getDepartmentSummaryInvolvement(0, $fromDate, $toDate, $interval);
}
...
$sectionList = array(
	'Thurly\Intranet\UStat\SocnetEventHandler',
	'Thurly\Intranet\UStat\LikesEventHandler',
	'Thurly\Intranet\UStat\TasksEventHandler',
	'Thurly\Intranet\UStat\ImEventHandler',
	'Thurly\Intranet\UStat\DiskEventHandler',
	'Thurly\Intranet\UStat\MobileEventHandler',
	'Thurly\Intranet\UStat\CrmEventHandler'
);
...
$sectionInvolvement = \Thurly\Intranet\UStat\UStat::getSectionsSummaryInvolvement($fromDate, $toDate, $interval);
...
// get users rating
$usersData = \Thurly\Intranet\UStat\UStat::getUsersGraphData($USER->getId(), $fromDate, $toDate, $interval, $sectionField);
...
if ($USER->IsAdmin()
	|| CModule::IncludeModule("thurlyos") && CThurlyOS::IsPortalAdmin($USER->GetID())
	|| in_array((int)$USER->getId(), \Thurly\Intranet\UStat\UStat::getHeadsOfDepartments(), true)
)
{
	$allowTellAbout = true;
}
