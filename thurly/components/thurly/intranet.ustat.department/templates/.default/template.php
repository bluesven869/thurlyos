...
<? endif ?>
	...
	graph2.customBullet = BX.getCDNPath('/thurly/components/thurly/intranet.ustat/images/bullet-green.png?1407');
				...
				<table class="pulse-info-table">
					<tr>
						<td class="pulse-info-cell pulse-info-cell-top">
							...
							<div class="pulse-info-title"><?if (IsModuleInstalled("thurlyos")) echo htmlspecialcharsbx(COption::GetOptionString("thurlyos", "site_title", "")); else echo htmlspecialcharsbx(COption::GetOptionString("main", "site_name", ""));?></div>
						</td>
