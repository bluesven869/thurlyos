...
use Thurly\Crm\Activity\CustomType;

Loc::loadMessages(__FILE__);

class CCrmActivityCustomTypeComponent extends CThurlyComponent
{
	//region Fields
	/** @var int */
	protected $userID = 0;
	...
	/** @var Thurly\Main\UI\PageNavigation|null */
			...
			else
			{
				...
				if(!empty($IDs) || $allRows)
				{
					foreach($IDs as $ID)
					{
						...
						catch(Thurly\Crm\Entry\DeleteException $e)
						{
