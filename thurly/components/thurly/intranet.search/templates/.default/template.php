...
<div class="bx-users-filter">
	...
	<?
	$arFilterValues = $APPLICATION->IncludeComponent("thurly:intranet.structure.selector", "simple", $arParams, $component, array('HIDE_ICONS' => 'Y'));
	?>
	</div>
	<div class="bx-users-selector-filter" id="bx_users_filter_adv"<?echo $current_filter == 'adv' ? '' : ' style="display: none;"'?>>
	<?
	$arFilterValues = $APPLICATION->IncludeComponent("thurly:intranet.structure.selector", "advanced", $arParams, $component, array('HIDE_ICONS' => 'Y'));
	?>
	</div>
</div>
<br />
...
$APPLICATION->IncludeComponent("thurly:intranet.structure.list", ($arParams['CURRENT_VIEW'] == 'list' ? $arParams['LIST_VIEW'] : ($arParams['TABLE_VIEW']!=''?$arParams['TABLE_VIEW']:'')), $arParams, $component, array('HIDE_ICONS' => 'Y'));
?>