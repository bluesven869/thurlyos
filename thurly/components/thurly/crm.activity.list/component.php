...
if($enableWidgetFilter)
{
	...
	if($dataSourceName !== '')
	{
		...
		try
		{
			$dataSource = Thurly\Crm\Widget\Data\DataSourceFactory::create(array('name' => $dataSourceName), $currentUserID, true);
		}
...
Thurly\Crm\Search\SearchEnvironment::convertEntityFilterValues(CCrmOwnerType::Activity, $arFilter);
...
if($_SERVER['REQUEST_METHOD'] === 'GET' && !Thurly\Main\Grid\Context::isInternalRequest())
{
