...
if (!empty($arResult["ELEMENTS"]) && CModule::IncludeModule("iblock"))
{
	...
	$useCatalogTab = (string)\Thurly\Main\Config\Option::get('catalog', 'show_catalog_tab_with_offers') == 'Y';
	...
	while($arElement = $rsElements->Fetch())
	{
		...
		if ($arElement["CATALOG_TYPE"] != \Thurly\Catalog\ProductTable::TYPE_SKU || $useCatalogTab)
