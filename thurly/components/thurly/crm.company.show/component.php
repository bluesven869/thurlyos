...
if (CCrmContact::CheckReadPermission(0, $userPermissions))
{
	$arResult['FIELDS']['tab_1'][] = array(
		...
		'componentParams' => array(
			...
			'ENTITY_IDS' => \Thurly\Crm\Binding\ContactCompanyTable::getCompanyContactIDs($arResult['ELEMENT_ID']),
			'ENTITIES_INPUT_NAME' => 'CONTACT_ID',
			'ENABLE_REQUISITES'=> false,
			'ENABLE_LAZY_LOAD'=> true,
			'LOADER' => array(
				'URL' => '/thurly/components/thurly/crm.contact.show/ajax.php?siteID='.SITE_ID.'&'.thurly_sessid_get()
			),
