...
$arParams['SWF'] = '/thurly/components/thurly/photogallery.imagerotator/templates/.default/imagerotator';
...
$flashvars = '';
$flashvars = bxRotatorAddFlashvar($flashvars, 'file', $APPLICATION->GetCurPageParam("image_rotator=get_xml&h=".$hash.'&'.thurly_sessid_get(), array("clear_cache", "thurly_include_areas", "thurly_show_mode", "back_url_admin", "bx_photo_ajax", "sessid"), false));$flashvars = bxRotatorAddFlashvar($flashvars, 'width', $arParams['WIDTH']);
