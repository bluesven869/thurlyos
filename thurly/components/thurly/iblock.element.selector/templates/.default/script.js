...
BX.Iblock.IblockElementSelector = (function ()
{
	...
	IblockElementSelector.prototype.init = function ()
	{
		...
		this.ajaxUrl = '/thurly/components/thurly/iblock.element.selector/ajax.php';
	...
	IblockElementSelector.prototype.search = function()
	{
		...
		if(this.searchInput.value.length > 0)
		{
			...
			this.url = this.ajaxUrl + '?sessid='+BX.thurly_sessid()+'&mode=search&iblockId='+this.iblockId+'&string='+
