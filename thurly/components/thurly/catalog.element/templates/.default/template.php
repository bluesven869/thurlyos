...
$this->addExternalCss('/thurly/css/main/bootstrap.css');
...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-fluid">
										...
										<div data-entity="main-button-container">
											...
											if ($showSubscribe)
											{
												...
												<div class="product-item-detail-info-container">
													<?
													$APPLICATION->IncludeComponent(
														'thurly:catalog.product.subscribe',
														'',
														array(
					...
					if ($arResult['OFFER_GROUP'])
					{
						foreach ($arResult['OFFER_GROUP_VALUES'] as $offerId)
						{
							...
							<span id="<?=$itemIds['OFFER_GROUP'].$offerId?>" style="display: none;">
								<?
								$APPLICATION->IncludeComponent(
									'thurly:catalog.set.constructor',
									'.default',
									array(
		...
		<div class="row">
			<div class="col-xs-12">
				<?
				if ($arResult['CATALOG'] && $actualItem['CAN_BUY'] && \Thurly\Main\ModuleManager::isModuleInstalled('sale'))
				{
					$APPLICATION->IncludeComponent(
				...
				if ($arResult['CATALOG'] && $arParams['USE_GIFTS_DETAIL'] == 'Y' && \Thurly\Main\ModuleManager::isModuleInstalled('sale'))
				{
					?>
					<div data-entity="parent-container">
						...
						CThurlyComponent::includeComponentClass('thurly:sale.products.gift');
						$APPLICATION->IncludeComponent(
							'thurly:sale.products.gift',
							'.default',
							array(
								...
								'DEFERRED_PRODUCT_ROW_VARIANTS' => \Thurly\Main\Web\Json::encode(
				...
				if ($arResult['CATALOG'] && $arParams['USE_GIFTS_MAIN_PR_SECTION_LIST'] == 'Y' && \Thurly\Main\ModuleManager::isModuleInstalled('sale'))
				{
					?>
					<div data-entity="parent-container">
						<?
						...
						$APPLICATION->IncludeComponent(
							'thurly:sale.gift.main.products',
							'.default',
							array(
