...
Loc::loadLanguageFile($_SERVER['DOCUMENT_ROOT'].'/thurly/modules/bizproc/install/tools/bizproc_do_task_ajax.php');
...
if ($_SERVER["REQUEST_METHOD"] != "POST" || !$user->IsAuthorized() || !check_thurly_sessid())
{
	$result['SUCCESS'] = false;
