...
use Thurly\Sale\Cashbox\ReportManager;
...
{
	$processedCheckIds = Cashbox\CashboxThurly::applyPrintResult($data);
	...
	{
		$cashboxList = Cashbox\CashboxThurly::getCashboxList($data);
