...
{
	case "list":
		$APPLICATION->IncludeComponent('thurly:mobile.crm.activity.list', '', array(
	...
	case "fields":
		...
		$APPLICATION->IncludeComponent("thurly:mobile.interface.fields", "", array(
			"GRID_ID" => "mobile_crm_activity_list",
			"ALL_FIELDS" => $fields,
	...
	case "sort":
		...
		$APPLICATION->IncludeComponent("thurly:mobile.interface.sort", "", array(
			"GRID_ID" => "mobile_crm_activity_list",
	...
	case "filter":
		...
		$APPLICATION->IncludeComponent("thurly:mobile.interface.filter", "", array(
			"GRID_ID" => "mobile_crm_activity_list",
			"FIELDS" => $filterFields,
	...
	case "edit":
		$APPLICATION->IncludeComponent(
			'thurly:mobile.crm.activity.edit',
			'',
			array(
