...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/about/index.php");
$APPLICATION->SetTitle(GetMessage("ABOUT_TITLE"));
?>

<?$APPLICATION->IncludeComponent("thurly:news.list", "official", Array(
	"IBLOCK_TYPE"	=>	"news",
	"IBLOCK_ID"	=>	"2",
	"NEWS_COUNT"	=>	"10",
