...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/intranet/public/about/official.php");
$APPLICATION->SetTitle(GetMessage("ABOUT_TITLE"));
?>

<?$APPLICATION->IncludeComponent("thurly:news.detail", "official", Array(
	"IBLOCK_TYPE"	=>	"news",
	"IBLOCK_ID"	=>	"2",
