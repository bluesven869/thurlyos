...
?><?$APPLICATION->IncludeComponent("thurly:socialnetwork_group", "", array(
	...
	"PATH_TO_GROUP_CREATE" =>"/extranet/contacts/personal/user/#user_id#/groups/create/",
	...
	"PATH_TO_BIZPROC_TASK" => "/extranet/contacts/personal/user/#user_id#/bizproc/#id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/extranet/contacts/personal/user/#user_id#/bizproc/",
	"SEF_MODE" => "Y",
