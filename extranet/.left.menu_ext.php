...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/thurly/modules/extranet/public/.left.menu_ext.php");
...
*/
	if (
		...
		$aMenuB24[] = Array(
			...
			"/extranet/contacts/personal/user/".$USER_ID. ($diskEnabled? "/disk/path/" : "/files/lib/"),
			Array(),
			Array(),
	...
	if (
		...
		$aMenuB24[] = Array(
			...
			"/extranet/contacts/personal/user/".$USER_ID."/photo/",
			Array(),
			Array(),
