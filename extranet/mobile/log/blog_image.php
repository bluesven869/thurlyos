...
if ($fid > 0)
{
	...
	if ($db_img_arr)
	{
		...
		?><img width="<?=intval($arDestinationSize["width"]/2)?>" height="<?=intval($arDestinationSize["height"]/2)?>" src="/thurly/components/thurly/blog/show_file.php?fid=<?=$bfid?>&width=<?=$width?>&height=<?=$height?>" alt="" title=""><?
	}
