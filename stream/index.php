...
if(CModule::IncludeModule('calendar')):
	$APPLICATION->IncludeComponent("thurly:calendar.events.list", "widget", array(
		"CALENDAR_TYPE" => "user",
		"B_CUR_USER_LIST" => "Y",
		"INIT_DATE" => "",
...
{
	$APPLICATION->IncludeComponent("thurly:socialnetwork.blog.blog", "important",
		Array(
			"BLOG_URL" => "",
...
<?$APPLICATION->IncludeComponent("thurly:blog.popular_posts", "widget", array(
	"GROUP_ID" => 1,
